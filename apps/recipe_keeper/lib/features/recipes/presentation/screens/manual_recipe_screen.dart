...
/// Screen for creating a manual recipe
/// 
...
class _ManualRecipeScreenState extends ConsumerState<ManualRecipeScreen> {
  ...
  Future<void> _saveRecipe() async {
    ...
    try {
      ...
      // Generate unique ID for manual recipe
      final recipeId = 'manual://${DateTime.now().millisecondsSinceEpoch}';
      ...
      final saved = repository.getById(recipeId);
