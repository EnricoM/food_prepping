...
// Path: <root>
class TranslationsAn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <an>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAn _root = this; // ignore: unused_field

	@override 
	TranslationsAn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAn app = _TranslationsAppAn._(_root);
	@override late final _TranslationsHomeAn home = _TranslationsHomeAn._(_root);
	@override late final _TranslationsCommonAn common = _TranslationsCommonAn._(_root);
	@override late final _TranslationsSettingsAn settings = _TranslationsSettingsAn._(_root);
	@override late final _TranslationsRecipesAn recipes = _TranslationsRecipesAn._(_root);
	@override late final _TranslationsRecipeDetailAn recipeDetail = _TranslationsRecipeDetailAn._(_root);
	@override late final _TranslationsFiltersAn filters = _TranslationsFiltersAn._(_root);
	@override late final _TranslationsShoppingListAn shoppingList = _TranslationsShoppingListAn._(_root);
	@override late final _TranslationsMealPlanAn mealPlan = _TranslationsMealPlanAn._(_root);
	@override late final _TranslationsInventoryAn inventory = _TranslationsInventoryAn._(_root);
	@override late final _TranslationsBarcodeScanAn barcodeScan = _TranslationsBarcodeScanAn._(_root);
	@override late final _TranslationsReceiptScanAn receiptScan = _TranslationsReceiptScanAn._(_root);
	@override late final _TranslationsBatchCookingAn batchCooking = _TranslationsBatchCookingAn._(_root);
	@override late final _TranslationsVisitedDomainsAn visitedDomains = _TranslationsVisitedDomainsAn._(_root);
	@override late final _TranslationsDomainDiscoveryAn domainDiscovery = _TranslationsDomainDiscoveryAn._(_root);
	@override late final _TranslationsInventorySuggestionsAn inventorySuggestions = _TranslationsInventorySuggestionsAn._(_root);
	@override late final _TranslationsUpgradeAn upgrade = _TranslationsUpgradeAn._(_root);
	@override late final _TranslationsTourAn tour = _TranslationsTourAn._(_root);
	@override late final _TranslationsManualRecipeAn manualRecipe = _TranslationsManualRecipeAn._(_root);
	@override late final _TranslationsRecipeEditAn recipeEdit = _TranslationsRecipeEditAn._(_root);
	@override late final _TranslationsErrorsAn errors = _TranslationsErrorsAn._(_root);
}

// Path: app
class _TranslationsAppAn extends TranslationsAppEn {
	_TranslationsAppAn._(TranslationsAn root) : this._root = root, super.internal(root);

	final TranslationsAn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAn extends TranslationsHomeEn {
	_TranslationsHomeAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAn extends TranslationsCommonEn {
	_TranslationsCommonAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAn extends TranslationsSettingsEn {
	_TranslationsSettingsAn._(TranslationsAn root) : this._root = root, super.internal(root);

	final TranslationsAn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAn measurements = _TranslationsSettingsMeasurementsAn._(_root);
	@override late final _TranslationsSettingsDataManagementAn dataManagement = _TranslationsSettingsDataManagementAn._(_root);
	@override late final _TranslationsSettingsVersionAn version = _TranslationsSettingsVersionAn._(_root);
}

// Path: recipes
class _TranslationsRecipesAn extends TranslationsRecipesEn {
	_TranslationsRecipesAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAn._(TranslationsAn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAn nutrition = _TranslationsRecipeDetailNutritionAn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAn prepAhead = _TranslationsRecipeDetailPrepAheadAn._(_root);
...
// Path: filters
class _TranslationsFiltersAn extends TranslationsFiltersEn {
	_TranslationsFiltersAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAn extends TranslationsShoppingListEn {
	_TranslationsShoppingListAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAn extends TranslationsMealPlanEn {
	_TranslationsMealPlanAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAn extends TranslationsInventoryEn {
	_TranslationsInventoryAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAn extends TranslationsUpgradeEn {
	_TranslationsUpgradeAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAn extends TranslationsTourEn {
	_TranslationsTourAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAn extends TranslationsErrorsEn {
	_TranslationsErrorsAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAn._(TranslationsAn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAn metric = _TranslationsSettingsMeasurementsMetricAn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAn imperial = _TranslationsSettingsMeasurementsImperialAn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAn._(TranslationsAn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <an>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAn {
