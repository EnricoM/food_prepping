...
// Path: <root>
class TranslationsMk extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMk({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	// Translations
	@override late final _TranslationsAppMk app = _TranslationsAppMk._(_root);
	@override late final _TranslationsHomeMk home = _TranslationsHomeMk._(_root);
	@override late final _TranslationsCommonMk common = _TranslationsCommonMk._(_root);
	@override late final _TranslationsSettingsMk settings = _TranslationsSettingsMk._(_root);
	@override late final _TranslationsRecipesMk recipes = _TranslationsRecipesMk._(_root);
	@override late final _TranslationsRecipeDetailMk recipeDetail = _TranslationsRecipeDetailMk._(_root);
	@override late final _TranslationsFiltersMk filters = _TranslationsFiltersMk._(_root);
	@override late final _TranslationsShoppingListMk shoppingList = _TranslationsShoppingListMk._(_root);
	@override late final _TranslationsMealPlanMk mealPlan = _TranslationsMealPlanMk._(_root);
	@override late final _TranslationsInventoryMk inventory = _TranslationsInventoryMk._(_root);
	@override late final _TranslationsBarcodeScanMk barcodeScan = _TranslationsBarcodeScanMk._(_root);
	@override late final _TranslationsReceiptScanMk receiptScan = _TranslationsReceiptScanMk._(_root);
	@override late final _TranslationsBatchCookingMk batchCooking = _TranslationsBatchCookingMk._(_root);
	@override late final _TranslationsVisitedDomainsMk visitedDomains = _TranslationsVisitedDomainsMk._(_root);
	@override late final _TranslationsDomainDiscoveryMk domainDiscovery = _TranslationsDomainDiscoveryMk._(_root);
	@override late final _TranslationsInventorySuggestionsMk inventorySuggestions = _TranslationsInventorySuggestionsMk._(_root);
	@override late final _TranslationsUpgradeMk upgrade = _TranslationsUpgradeMk._(_root);
	@override late final _TranslationsTourMk tour = _TranslationsTourMk._(_root);
	@override late final _TranslationsManualRecipeMk manualRecipe = _TranslationsManualRecipeMk._(_root);
	@override late final _TranslationsRecipeEditMk recipeEdit = _TranslationsRecipeEditMk._(_root);
	@override late final _TranslationsErrorsMk errors = _TranslationsErrorsMk._(_root);
}

// Path: app
class _TranslationsAppMk extends TranslationsAppEn {
	_TranslationsAppMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeMk extends TranslationsHomeEn {
	_TranslationsHomeMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMk extends TranslationsCommonEn {
	_TranslationsCommonMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMk extends TranslationsSettingsEn {
	_TranslationsSettingsMk._(TranslationsMk root) : this._root = root, super.internal(root);

	final TranslationsMk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMk measurements = _TranslationsSettingsMeasurementsMk._(_root);
	@override late final _TranslationsSettingsDataManagementMk dataManagement = _TranslationsSettingsDataManagementMk._(_root);
	@override late final _TranslationsSettingsVersionMk version = _TranslationsSettingsVersionMk._(_root);
}

// Path: recipes
class _TranslationsRecipesMk extends TranslationsRecipesEn {
	_TranslationsRecipesMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMk._(TranslationsMk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMk nutrition = _TranslationsRecipeDetailNutritionMk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMk prepAhead = _TranslationsRecipeDetailPrepAheadMk._(_root);
...
// Path: filters
class _TranslationsFiltersMk extends TranslationsFiltersEn {
	_TranslationsFiltersMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMk extends TranslationsShoppingListEn {
	_TranslationsShoppingListMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMk extends TranslationsMealPlanEn {
	_TranslationsMealPlanMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMk extends TranslationsInventoryEn {
	_TranslationsInventoryMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMk extends TranslationsUpgradeEn {
	_TranslationsUpgradeMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMk extends TranslationsTourEn {
	_TranslationsTourMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMk extends TranslationsErrorsEn {
	_TranslationsErrorsMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMk._(TranslationsMk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMk metric = _TranslationsSettingsMeasurementsMetricMk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMk imperial = _TranslationsSettingsMeasurementsImperialMk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMk._(TranslationsMk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMk._(TranslationsMk root) : this._root = root, super.internal(root);
