...
// Path: <root>
class TranslationsAv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <av>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAv _root = this; // ignore: unused_field

	@override 
	TranslationsAv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAv app = _TranslationsAppAv._(_root);
	@override late final _TranslationsHomeAv home = _TranslationsHomeAv._(_root);
	@override late final _TranslationsCommonAv common = _TranslationsCommonAv._(_root);
	@override late final _TranslationsSettingsAv settings = _TranslationsSettingsAv._(_root);
	@override late final _TranslationsRecipesAv recipes = _TranslationsRecipesAv._(_root);
	@override late final _TranslationsRecipeDetailAv recipeDetail = _TranslationsRecipeDetailAv._(_root);
	@override late final _TranslationsFiltersAv filters = _TranslationsFiltersAv._(_root);
	@override late final _TranslationsShoppingListAv shoppingList = _TranslationsShoppingListAv._(_root);
	@override late final _TranslationsMealPlanAv mealPlan = _TranslationsMealPlanAv._(_root);
	@override late final _TranslationsInventoryAv inventory = _TranslationsInventoryAv._(_root);
	@override late final _TranslationsBarcodeScanAv barcodeScan = _TranslationsBarcodeScanAv._(_root);
	@override late final _TranslationsReceiptScanAv receiptScan = _TranslationsReceiptScanAv._(_root);
	@override late final _TranslationsBatchCookingAv batchCooking = _TranslationsBatchCookingAv._(_root);
	@override late final _TranslationsVisitedDomainsAv visitedDomains = _TranslationsVisitedDomainsAv._(_root);
	@override late final _TranslationsDomainDiscoveryAv domainDiscovery = _TranslationsDomainDiscoveryAv._(_root);
	@override late final _TranslationsInventorySuggestionsAv inventorySuggestions = _TranslationsInventorySuggestionsAv._(_root);
	@override late final _TranslationsUpgradeAv upgrade = _TranslationsUpgradeAv._(_root);
	@override late final _TranslationsTourAv tour = _TranslationsTourAv._(_root);
	@override late final _TranslationsManualRecipeAv manualRecipe = _TranslationsManualRecipeAv._(_root);
	@override late final _TranslationsRecipeEditAv recipeEdit = _TranslationsRecipeEditAv._(_root);
	@override late final _TranslationsErrorsAv errors = _TranslationsErrorsAv._(_root);
}

// Path: app
class _TranslationsAppAv extends TranslationsAppEn {
	_TranslationsAppAv._(TranslationsAv root) : this._root = root, super.internal(root);

	final TranslationsAv _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAv extends TranslationsHomeEn {
	_TranslationsHomeAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAv extends TranslationsCommonEn {
	_TranslationsCommonAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAv extends TranslationsSettingsEn {
	_TranslationsSettingsAv._(TranslationsAv root) : this._root = root, super.internal(root);

	final TranslationsAv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAv measurements = _TranslationsSettingsMeasurementsAv._(_root);
	@override late final _TranslationsSettingsDataManagementAv dataManagement = _TranslationsSettingsDataManagementAv._(_root);
	@override late final _TranslationsSettingsVersionAv version = _TranslationsSettingsVersionAv._(_root);
}

// Path: recipes
class _TranslationsRecipesAv extends TranslationsRecipesEn {
	_TranslationsRecipesAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAv._(TranslationsAv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAv nutrition = _TranslationsRecipeDetailNutritionAv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAv prepAhead = _TranslationsRecipeDetailPrepAheadAv._(_root);
...
// Path: filters
class _TranslationsFiltersAv extends TranslationsFiltersEn {
	_TranslationsFiltersAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAv extends TranslationsShoppingListEn {
	_TranslationsShoppingListAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAv extends TranslationsMealPlanEn {
	_TranslationsMealPlanAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAv extends TranslationsInventoryEn {
	_TranslationsInventoryAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAv extends TranslationsUpgradeEn {
	_TranslationsUpgradeAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAv extends TranslationsTourEn {
	_TranslationsTourAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAv extends TranslationsErrorsEn {
	_TranslationsErrorsAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAv._(TranslationsAv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAv metric = _TranslationsSettingsMeasurementsMetricAv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAv imperial = _TranslationsSettingsMeasurementsImperialAv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAv._(TranslationsAv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <av>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAv {
