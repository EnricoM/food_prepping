...
// Path: <root>
class TranslationsPi extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsPi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <pi>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsPi _root = this; // ignore: unused_field

	@override 
	TranslationsPi $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsPi(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppPi app = _TranslationsAppPi._(_root);
	@override late final _TranslationsHomePi home = _TranslationsHomePi._(_root);
	@override late final _TranslationsCommonPi common = _TranslationsCommonPi._(_root);
	@override late final _TranslationsSettingsPi settings = _TranslationsSettingsPi._(_root);
	@override late final _TranslationsRecipesPi recipes = _TranslationsRecipesPi._(_root);
	@override late final _TranslationsRecipeDetailPi recipeDetail = _TranslationsRecipeDetailPi._(_root);
	@override late final _TranslationsFiltersPi filters = _TranslationsFiltersPi._(_root);
	@override late final _TranslationsShoppingListPi shoppingList = _TranslationsShoppingListPi._(_root);
	@override late final _TranslationsMealPlanPi mealPlan = _TranslationsMealPlanPi._(_root);
	@override late final _TranslationsInventoryPi inventory = _TranslationsInventoryPi._(_root);
	@override late final _TranslationsBarcodeScanPi barcodeScan = _TranslationsBarcodeScanPi._(_root);
	@override late final _TranslationsReceiptScanPi receiptScan = _TranslationsReceiptScanPi._(_root);
	@override late final _TranslationsBatchCookingPi batchCooking = _TranslationsBatchCookingPi._(_root);
	@override late final _TranslationsVisitedDomainsPi visitedDomains = _TranslationsVisitedDomainsPi._(_root);
	@override late final _TranslationsDomainDiscoveryPi domainDiscovery = _TranslationsDomainDiscoveryPi._(_root);
	@override late final _TranslationsInventorySuggestionsPi inventorySuggestions = _TranslationsInventorySuggestionsPi._(_root);
	@override late final _TranslationsUpgradePi upgrade = _TranslationsUpgradePi._(_root);
	@override late final _TranslationsTourPi tour = _TranslationsTourPi._(_root);
	@override late final _TranslationsManualRecipePi manualRecipe = _TranslationsManualRecipePi._(_root);
	@override late final _TranslationsRecipeEditPi recipeEdit = _TranslationsRecipeEditPi._(_root);
	@override late final _TranslationsErrorsPi errors = _TranslationsErrorsPi._(_root);
}

// Path: app
class _TranslationsAppPi extends TranslationsAppEn {
	_TranslationsAppPi._(TranslationsPi root) : this._root = root, super.internal(root);

	final TranslationsPi _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomePi extends TranslationsHomeEn {
	_TranslationsHomePi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonPi extends TranslationsCommonEn {
	_TranslationsCommonPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsPi extends TranslationsSettingsEn {
	_TranslationsSettingsPi._(TranslationsPi root) : this._root = root, super.internal(root);

	final TranslationsPi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsPi measurements = _TranslationsSettingsMeasurementsPi._(_root);
	@override late final _TranslationsSettingsDataManagementPi dataManagement = _TranslationsSettingsDataManagementPi._(_root);
	@override late final _TranslationsSettingsVersionPi version = _TranslationsSettingsVersionPi._(_root);
}

// Path: recipes
class _TranslationsRecipesPi extends TranslationsRecipesEn {
	_TranslationsRecipesPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPi._(TranslationsPi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPi nutrition = _TranslationsRecipeDetailNutritionPi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPi prepAhead = _TranslationsRecipeDetailPrepAheadPi._(_root);
...
// Path: filters
class _TranslationsFiltersPi extends TranslationsFiltersEn {
	_TranslationsFiltersPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPi extends TranslationsShoppingListEn {
	_TranslationsShoppingListPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPi extends TranslationsMealPlanEn {
	_TranslationsMealPlanPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPi extends TranslationsInventoryEn {
	_TranslationsInventoryPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePi extends TranslationsUpgradeEn {
	_TranslationsUpgradePi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPi extends TranslationsTourEn {
	_TranslationsTourPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsPi extends TranslationsErrorsEn {
	_TranslationsErrorsPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPi._(TranslationsPi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPi metric = _TranslationsSettingsMeasurementsMetricPi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPi imperial = _TranslationsSettingsMeasurementsImperialPi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPi._(TranslationsPi root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <pi>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsPi {
