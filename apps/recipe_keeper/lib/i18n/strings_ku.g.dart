...
class TranslationsKu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppKu app = _TranslationsAppKu._(_root);
	...
	@override late final _TranslationsRecipesKu recipes = _TranslationsRecipesKu._(_root);
	@override late final _TranslationsRecipeDetailKu recipeDetail = _TranslationsRecipeDetailKu._(_root);
	@override late final _TranslationsFiltersKu filters = _TranslationsFiltersKu._(_root);
	@override late final _TranslationsShoppingListKu shoppingList = _TranslationsShoppingListKu._(_root);
	@override late final _TranslationsMealPlanKu mealPlan = _TranslationsMealPlanKu._(_root);
	@override late final _TranslationsInventoryKu inventory = _TranslationsInventoryKu._(_root);
	@override late final _TranslationsBarcodeScanKu barcodeScan = _TranslationsBarcodeScanKu._(_root);
	@override late final _TranslationsReceiptScanKu receiptScan = _TranslationsReceiptScanKu._(_root);
	@override late final _TranslationsBatchCookingKu batchCooking = _TranslationsBatchCookingKu._(_root);
	@override late final _TranslationsVisitedDomainsKu visitedDomains = _TranslationsVisitedDomainsKu._(_root);
	@override late final _TranslationsDomainDiscoveryKu domainDiscovery = _TranslationsDomainDiscoveryKu._(_root);
	@override late final _TranslationsInventorySuggestionsKu inventorySuggestions = _TranslationsInventorySuggestionsKu._(_root);
	@override late final _TranslationsUpgradeKu upgrade = _TranslationsUpgradeKu._(_root);
	@override late final _TranslationsTourKu tour = _TranslationsTourKu._(_root);
	@override late final _TranslationsManualRecipeKu manualRecipe = _TranslationsManualRecipeKu._(_root);
	@override late final _TranslationsRecipeEditKu recipeEdit = _TranslationsRecipeEditKu._(_root);
	@override late final _TranslationsErrorsKu errors = _TranslationsErrorsKu._(_root);
}

// Path: app
class _TranslationsAppKu extends TranslationsAppEn {
	_TranslationsAppKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsKu extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsKu measurements = _TranslationsSettingsMeasurementsKu._(_root);
	@override late final _TranslationsSettingsDataManagementKu dataManagement = _TranslationsSettingsDataManagementKu._(_root);
	@override late final _TranslationsSettingsVersionKu version = _TranslationsSettingsVersionKu._(_root);
}

// Path: recipes
class _TranslationsRecipesKu extends TranslationsRecipesEn {
	_TranslationsRecipesKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKu._(TranslationsKu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKu nutrition = _TranslationsRecipeDetailNutritionKu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKu prepAhead = _TranslationsRecipeDetailPrepAheadKu._(_root);
...
// Path: filters
class _TranslationsFiltersKu extends TranslationsFiltersEn {
	_TranslationsFiltersKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKu extends TranslationsShoppingListEn {
	_TranslationsShoppingListKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKu extends TranslationsMealPlanEn {
	_TranslationsMealPlanKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKu extends TranslationsInventoryEn {
	_TranslationsInventoryKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKu extends TranslationsUpgradeEn {
	_TranslationsUpgradeKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKu extends TranslationsTourEn {
	_TranslationsTourKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKu extends TranslationsErrorsEn {
	_TranslationsErrorsKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKu._(TranslationsKu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKu metric = _TranslationsSettingsMeasurementsMetricKu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKu imperial = _TranslationsSettingsMeasurementsImperialKu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKu._(TranslationsKu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKu._(TranslationsKu root) : this._root = root, super.internal(root);
