...
class TranslationsRo extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesRo recipes = _TranslationsRecipesRo._(_root);
	@override late final _TranslationsRecipeDetailRo recipeDetail = _TranslationsRecipeDetailRo._(_root);
	@override late final _TranslationsFiltersRo filters = _TranslationsFiltersRo._(_root);
	@override late final _TranslationsShoppingListRo shoppingList = _TranslationsShoppingListRo._(_root);
	@override late final _TranslationsMealPlanRo mealPlan = _TranslationsMealPlanRo._(_root);
	@override late final _TranslationsInventoryRo inventory = _TranslationsInventoryRo._(_root);
	@override late final _TranslationsBarcodeScanRo barcodeScan = _TranslationsBarcodeScanRo._(_root);
	@override late final _TranslationsReceiptScanRo receiptScan = _TranslationsReceiptScanRo._(_root);
	@override late final _TranslationsBatchCookingRo batchCooking = _TranslationsBatchCookingRo._(_root);
	@override late final _TranslationsVisitedDomainsRo visitedDomains = _TranslationsVisitedDomainsRo._(_root);
	@override late final _TranslationsDomainDiscoveryRo domainDiscovery = _TranslationsDomainDiscoveryRo._(_root);
	@override late final _TranslationsInventorySuggestionsRo inventorySuggestions = _TranslationsInventorySuggestionsRo._(_root);
	@override late final _TranslationsUpgradeRo upgrade = _TranslationsUpgradeRo._(_root);
	@override late final _TranslationsTourRo tour = _TranslationsTourRo._(_root);
	@override late final _TranslationsManualRecipeRo manualRecipe = _TranslationsManualRecipeRo._(_root);
	@override late final _TranslationsRecipeEditRo recipeEdit = _TranslationsRecipeEditRo._(_root);
	@override late final _TranslationsErrorsRo errors = _TranslationsErrorsRo._(_root);
}

// Path: app
class _TranslationsAppRo extends TranslationsAppEn {
	_TranslationsAppRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsRo extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsRo measurements = _TranslationsSettingsMeasurementsRo._(_root);
	@override late final _TranslationsSettingsDataManagementRo dataManagement = _TranslationsSettingsDataManagementRo._(_root);
	@override late final _TranslationsSettingsVersionRo version = _TranslationsSettingsVersionRo._(_root);
}

// Path: recipes
class _TranslationsRecipesRo extends TranslationsRecipesEn {
	_TranslationsRecipesRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailRo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailRo._(TranslationsRo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionRo nutrition = _TranslationsRecipeDetailNutritionRo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadRo prepAhead = _TranslationsRecipeDetailPrepAheadRo._(_root);
...
// Path: filters
class _TranslationsFiltersRo extends TranslationsFiltersEn {
	_TranslationsFiltersRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListRo extends TranslationsShoppingListEn {
	_TranslationsShoppingListRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanRo extends TranslationsMealPlanEn {
	_TranslationsMealPlanRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryRo extends TranslationsInventoryEn {
	_TranslationsInventoryRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanRo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanRo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingRo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsRo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryRo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsRo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeRo extends TranslationsUpgradeEn {
	_TranslationsUpgradeRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourRo extends TranslationsTourEn {
	_TranslationsTourRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeRo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditRo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsRo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsRo._(TranslationsRo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricRo metric = _TranslationsSettingsMeasurementsMetricRo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialRo imperial = _TranslationsSettingsMeasurementsImperialRo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementRo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionRo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionRo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadRo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricRo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricRo._(TranslationsRo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialRo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialRo._(TranslationsRo root) : this._root = root, super.internal(root);
