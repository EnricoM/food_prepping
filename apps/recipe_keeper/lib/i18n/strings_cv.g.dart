...
// Path: <root>
class TranslationsCv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	@override 
	TranslationsCv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCv app = _TranslationsAppCv._(_root);
	@override late final _TranslationsHomeCv home = _TranslationsHomeCv._(_root);
	@override late final _TranslationsCommonCv common = _TranslationsCommonCv._(_root);
	@override late final _TranslationsSettingsCv settings = _TranslationsSettingsCv._(_root);
	@override late final _TranslationsRecipesCv recipes = _TranslationsRecipesCv._(_root);
	@override late final _TranslationsRecipeDetailCv recipeDetail = _TranslationsRecipeDetailCv._(_root);
	@override late final _TranslationsFiltersCv filters = _TranslationsFiltersCv._(_root);
	@override late final _TranslationsShoppingListCv shoppingList = _TranslationsShoppingListCv._(_root);
	@override late final _TranslationsMealPlanCv mealPlan = _TranslationsMealPlanCv._(_root);
	@override late final _TranslationsInventoryCv inventory = _TranslationsInventoryCv._(_root);
	@override late final _TranslationsBarcodeScanCv barcodeScan = _TranslationsBarcodeScanCv._(_root);
	@override late final _TranslationsReceiptScanCv receiptScan = _TranslationsReceiptScanCv._(_root);
	@override late final _TranslationsBatchCookingCv batchCooking = _TranslationsBatchCookingCv._(_root);
	@override late final _TranslationsVisitedDomainsCv visitedDomains = _TranslationsVisitedDomainsCv._(_root);
	@override late final _TranslationsDomainDiscoveryCv domainDiscovery = _TranslationsDomainDiscoveryCv._(_root);
	@override late final _TranslationsInventorySuggestionsCv inventorySuggestions = _TranslationsInventorySuggestionsCv._(_root);
	@override late final _TranslationsUpgradeCv upgrade = _TranslationsUpgradeCv._(_root);
	@override late final _TranslationsTourCv tour = _TranslationsTourCv._(_root);
	@override late final _TranslationsManualRecipeCv manualRecipe = _TranslationsManualRecipeCv._(_root);
	@override late final _TranslationsRecipeEditCv recipeEdit = _TranslationsRecipeEditCv._(_root);
	@override late final _TranslationsErrorsCv errors = _TranslationsErrorsCv._(_root);
}

// Path: app
class _TranslationsAppCv extends TranslationsAppEn {
	_TranslationsAppCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeCv extends TranslationsHomeEn {
	_TranslationsHomeCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCv extends TranslationsCommonEn {
	_TranslationsCommonCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCv extends TranslationsSettingsEn {
	_TranslationsSettingsCv._(TranslationsCv root) : this._root = root, super.internal(root);

	final TranslationsCv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCv measurements = _TranslationsSettingsMeasurementsCv._(_root);
	@override late final _TranslationsSettingsDataManagementCv dataManagement = _TranslationsSettingsDataManagementCv._(_root);
	@override late final _TranslationsSettingsVersionCv version = _TranslationsSettingsVersionCv._(_root);
}

// Path: recipes
class _TranslationsRecipesCv extends TranslationsRecipesEn {
	_TranslationsRecipesCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCv._(TranslationsCv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCv nutrition = _TranslationsRecipeDetailNutritionCv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCv prepAhead = _TranslationsRecipeDetailPrepAheadCv._(_root);
...
// Path: filters
class _TranslationsFiltersCv extends TranslationsFiltersEn {
	_TranslationsFiltersCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCv extends TranslationsShoppingListEn {
	_TranslationsShoppingListCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCv extends TranslationsMealPlanEn {
	_TranslationsMealPlanCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCv extends TranslationsInventoryEn {
	_TranslationsInventoryCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCv extends TranslationsUpgradeEn {
	_TranslationsUpgradeCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCv extends TranslationsTourEn {
	_TranslationsTourCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCv extends TranslationsErrorsEn {
	_TranslationsErrorsCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCv._(TranslationsCv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCv metric = _TranslationsSettingsMeasurementsMetricCv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCv imperial = _TranslationsSettingsMeasurementsImperialCv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCv._(TranslationsCv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <cv>.
