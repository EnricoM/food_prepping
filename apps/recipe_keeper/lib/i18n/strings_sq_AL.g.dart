...
// Path: <root>
class TranslationsSqAl extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSqAl({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.sqAl,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <sq-AL>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSqAl _root = this; // ignore: unused_field

	@override 
	TranslationsSqAl $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSqAl(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSqAl app = _TranslationsAppSqAl._(_root);
	@override late final _TranslationsHomeSqAl home = _TranslationsHomeSqAl._(_root);
	@override late final _TranslationsCommonSqAl common = _TranslationsCommonSqAl._(_root);
	@override late final _TranslationsSettingsSqAl settings = _TranslationsSettingsSqAl._(_root);
	@override late final _TranslationsRecipesSqAl recipes = _TranslationsRecipesSqAl._(_root);
	@override late final _TranslationsRecipeDetailSqAl recipeDetail = _TranslationsRecipeDetailSqAl._(_root);
	@override late final _TranslationsFiltersSqAl filters = _TranslationsFiltersSqAl._(_root);
	@override late final _TranslationsShoppingListSqAl shoppingList = _TranslationsShoppingListSqAl._(_root);
	@override late final _TranslationsMealPlanSqAl mealPlan = _TranslationsMealPlanSqAl._(_root);
	@override late final _TranslationsInventorySqAl inventory = _TranslationsInventorySqAl._(_root);
	@override late final _TranslationsBarcodeScanSqAl barcodeScan = _TranslationsBarcodeScanSqAl._(_root);
	@override late final _TranslationsReceiptScanSqAl receiptScan = _TranslationsReceiptScanSqAl._(_root);
	@override late final _TranslationsBatchCookingSqAl batchCooking = _TranslationsBatchCookingSqAl._(_root);
	@override late final _TranslationsVisitedDomainsSqAl visitedDomains = _TranslationsVisitedDomainsSqAl._(_root);
	@override late final _TranslationsDomainDiscoverySqAl domainDiscovery = _TranslationsDomainDiscoverySqAl._(_root);
	@override late final _TranslationsInventorySuggestionsSqAl inventorySuggestions = _TranslationsInventorySuggestionsSqAl._(_root);
	@override late final _TranslationsUpgradeSqAl upgrade = _TranslationsUpgradeSqAl._(_root);
	@override late final _TranslationsTourSqAl tour = _TranslationsTourSqAl._(_root);
	@override late final _TranslationsManualRecipeSqAl manualRecipe = _TranslationsManualRecipeSqAl._(_root);
	@override late final _TranslationsRecipeEditSqAl recipeEdit = _TranslationsRecipeEditSqAl._(_root);
	@override late final _TranslationsErrorsSqAl errors = _TranslationsErrorsSqAl._(_root);
}

// Path: app
class _TranslationsAppSqAl extends TranslationsAppEn {
	_TranslationsAppSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);

	final TranslationsSqAl _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSqAl extends TranslationsHomeEn {
	_TranslationsHomeSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSqAl extends TranslationsCommonEn {
	_TranslationsCommonSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSqAl extends TranslationsSettingsEn {
	_TranslationsSettingsSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);

	final TranslationsSqAl _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSqAl measurements = _TranslationsSettingsMeasurementsSqAl._(_root);
	@override late final _TranslationsSettingsDataManagementSqAl dataManagement = _TranslationsSettingsDataManagementSqAl._(_root);
	@override late final _TranslationsSettingsVersionSqAl version = _TranslationsSettingsVersionSqAl._(_root);
}

// Path: recipes
class _TranslationsRecipesSqAl extends TranslationsRecipesEn {
	_TranslationsRecipesSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSqAl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSqAl nutrition = _TranslationsRecipeDetailNutritionSqAl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSqAl prepAhead = _TranslationsRecipeDetailPrepAheadSqAl._(_root);
...
// Path: filters
class _TranslationsFiltersSqAl extends TranslationsFiltersEn {
	_TranslationsFiltersSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSqAl extends TranslationsShoppingListEn {
	_TranslationsShoppingListSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSqAl extends TranslationsMealPlanEn {
	_TranslationsMealPlanSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySqAl extends TranslationsInventoryEn {
	_TranslationsInventorySqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSqAl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSqAl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSqAl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSqAl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySqAl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSqAl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSqAl extends TranslationsUpgradeEn {
	_TranslationsUpgradeSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSqAl extends TranslationsTourEn {
	_TranslationsTourSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSqAl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSqAl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSqAl extends TranslationsErrorsEn {
	_TranslationsErrorsSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSqAl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSqAl metric = _TranslationsSettingsMeasurementsMetricSqAl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSqAl imperial = _TranslationsSettingsMeasurementsImperialSqAl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSqAl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSqAl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSqAl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSqAl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSqAl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSqAl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSqAl._(TranslationsSqAl root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sq-AL>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSqAl {
