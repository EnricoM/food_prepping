...
// Path: <root>
class TranslationsLb extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLb({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	@override 
	TranslationsLb $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLb(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLb app = _TranslationsAppLb._(_root);
	@override late final _TranslationsHomeLb home = _TranslationsHomeLb._(_root);
	@override late final _TranslationsCommonLb common = _TranslationsCommonLb._(_root);
	@override late final _TranslationsSettingsLb settings = _TranslationsSettingsLb._(_root);
	@override late final _TranslationsRecipesLb recipes = _TranslationsRecipesLb._(_root);
	@override late final _TranslationsRecipeDetailLb recipeDetail = _TranslationsRecipeDetailLb._(_root);
	@override late final _TranslationsFiltersLb filters = _TranslationsFiltersLb._(_root);
	@override late final _TranslationsShoppingListLb shoppingList = _TranslationsShoppingListLb._(_root);
	@override late final _TranslationsMealPlanLb mealPlan = _TranslationsMealPlanLb._(_root);
	@override late final _TranslationsInventoryLb inventory = _TranslationsInventoryLb._(_root);
	@override late final _TranslationsBarcodeScanLb barcodeScan = _TranslationsBarcodeScanLb._(_root);
	@override late final _TranslationsReceiptScanLb receiptScan = _TranslationsReceiptScanLb._(_root);
	@override late final _TranslationsBatchCookingLb batchCooking = _TranslationsBatchCookingLb._(_root);
	@override late final _TranslationsVisitedDomainsLb visitedDomains = _TranslationsVisitedDomainsLb._(_root);
	@override late final _TranslationsDomainDiscoveryLb domainDiscovery = _TranslationsDomainDiscoveryLb._(_root);
	@override late final _TranslationsInventorySuggestionsLb inventorySuggestions = _TranslationsInventorySuggestionsLb._(_root);
	@override late final _TranslationsUpgradeLb upgrade = _TranslationsUpgradeLb._(_root);
	@override late final _TranslationsTourLb tour = _TranslationsTourLb._(_root);
	@override late final _TranslationsManualRecipeLb manualRecipe = _TranslationsManualRecipeLb._(_root);
	@override late final _TranslationsRecipeEditLb recipeEdit = _TranslationsRecipeEditLb._(_root);
	@override late final _TranslationsErrorsLb errors = _TranslationsErrorsLb._(_root);
}

// Path: app
class _TranslationsAppLb extends TranslationsAppEn {
	_TranslationsAppLb._(TranslationsLb root) : this._root = root, super.internal(root);

	final TranslationsLb _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeLb extends TranslationsHomeEn {
	_TranslationsHomeLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLb extends TranslationsCommonEn {
	_TranslationsCommonLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLb extends TranslationsSettingsEn {
	_TranslationsSettingsLb._(TranslationsLb root) : this._root = root, super.internal(root);

	final TranslationsLb _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLb measurements = _TranslationsSettingsMeasurementsLb._(_root);
	@override late final _TranslationsSettingsDataManagementLb dataManagement = _TranslationsSettingsDataManagementLb._(_root);
	@override late final _TranslationsSettingsVersionLb version = _TranslationsSettingsVersionLb._(_root);
}

// Path: recipes
class _TranslationsRecipesLb extends TranslationsRecipesEn {
	_TranslationsRecipesLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLb extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLb._(TranslationsLb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLb nutrition = _TranslationsRecipeDetailNutritionLb._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLb prepAhead = _TranslationsRecipeDetailPrepAheadLb._(_root);
...
// Path: filters
class _TranslationsFiltersLb extends TranslationsFiltersEn {
	_TranslationsFiltersLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLb extends TranslationsShoppingListEn {
	_TranslationsShoppingListLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLb extends TranslationsMealPlanEn {
	_TranslationsMealPlanLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLb extends TranslationsInventoryEn {
	_TranslationsInventoryLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLb extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLb extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLb extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLb extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLb extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLb extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLb extends TranslationsUpgradeEn {
	_TranslationsUpgradeLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLb extends TranslationsTourEn {
	_TranslationsTourLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLb extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLb extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLb extends TranslationsErrorsEn {
	_TranslationsErrorsLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLb extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLb._(TranslationsLb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLb metric = _TranslationsSettingsMeasurementsMetricLb._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLb imperial = _TranslationsSettingsMeasurementsImperialLb._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLb extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLb extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLb extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLb extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLb extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLb extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLb._(TranslationsLb root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <lb>.
