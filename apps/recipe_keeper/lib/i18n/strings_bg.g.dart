...
class TranslationsBg extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsHomeBg home = _TranslationsHomeBg._(_root);
	...
	@override late final _TranslationsRecipesBg recipes = _TranslationsRecipesBg._(_root);
	@override late final _TranslationsRecipeDetailBg recipeDetail = _TranslationsRecipeDetailBg._(_root);
	@override late final _TranslationsFiltersBg filters = _TranslationsFiltersBg._(_root);
	@override late final _TranslationsShoppingListBg shoppingList = _TranslationsShoppingListBg._(_root);
	@override late final _TranslationsMealPlanBg mealPlan = _TranslationsMealPlanBg._(_root);
	@override late final _TranslationsInventoryBg inventory = _TranslationsInventoryBg._(_root);
	@override late final _TranslationsBarcodeScanBg barcodeScan = _TranslationsBarcodeScanBg._(_root);
	@override late final _TranslationsReceiptScanBg receiptScan = _TranslationsReceiptScanBg._(_root);
	@override late final _TranslationsBatchCookingBg batchCooking = _TranslationsBatchCookingBg._(_root);
	@override late final _TranslationsVisitedDomainsBg visitedDomains = _TranslationsVisitedDomainsBg._(_root);
	@override late final _TranslationsDomainDiscoveryBg domainDiscovery = _TranslationsDomainDiscoveryBg._(_root);
	@override late final _TranslationsInventorySuggestionsBg inventorySuggestions = _TranslationsInventorySuggestionsBg._(_root);
	@override late final _TranslationsUpgradeBg upgrade = _TranslationsUpgradeBg._(_root);
	@override late final _TranslationsTourBg tour = _TranslationsTourBg._(_root);
	@override late final _TranslationsManualRecipeBg manualRecipe = _TranslationsManualRecipeBg._(_root);
	@override late final _TranslationsRecipeEditBg recipeEdit = _TranslationsRecipeEditBg._(_root);
...
// Path: home
class _TranslationsHomeBg extends TranslationsHomeEn {
	_TranslationsHomeBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsBg extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsBg measurements = _TranslationsSettingsMeasurementsBg._(_root);
	@override late final _TranslationsSettingsDataManagementBg dataManagement = _TranslationsSettingsDataManagementBg._(_root);
	@override late final _TranslationsSettingsVersionBg version = _TranslationsSettingsVersionBg._(_root);
}

// Path: recipes
class _TranslationsRecipesBg extends TranslationsRecipesEn {
	_TranslationsRecipesBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBg._(TranslationsBg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBg nutrition = _TranslationsRecipeDetailNutritionBg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBg prepAhead = _TranslationsRecipeDetailPrepAheadBg._(_root);
...
// Path: filters
class _TranslationsFiltersBg extends TranslationsFiltersEn {
	_TranslationsFiltersBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBg extends TranslationsShoppingListEn {
	_TranslationsShoppingListBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBg extends TranslationsMealPlanEn {
	_TranslationsMealPlanBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBg extends TranslationsInventoryEn {
	_TranslationsInventoryBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBg extends TranslationsUpgradeEn {
	_TranslationsUpgradeBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBg extends TranslationsTourEn {
	_TranslationsTourBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBg._(TranslationsBg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBg metric = _TranslationsSettingsMeasurementsMetricBg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBg imperial = _TranslationsSettingsMeasurementsImperialBg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBg._(TranslationsBg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBg._(TranslationsBg root) : this._root = root, super.internal(root);
