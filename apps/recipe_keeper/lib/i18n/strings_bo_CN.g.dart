...
// Path: <root>
class TranslationsBoCn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsBoCn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.boCn,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <bo-CN>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsBoCn _root = this; // ignore: unused_field

	@override 
	TranslationsBoCn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsBoCn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppBoCn app = _TranslationsAppBoCn._(_root);
	@override late final _TranslationsHomeBoCn home = _TranslationsHomeBoCn._(_root);
	@override late final _TranslationsCommonBoCn common = _TranslationsCommonBoCn._(_root);
	@override late final _TranslationsSettingsBoCn settings = _TranslationsSettingsBoCn._(_root);
	@override late final _TranslationsRecipesBoCn recipes = _TranslationsRecipesBoCn._(_root);
	@override late final _TranslationsRecipeDetailBoCn recipeDetail = _TranslationsRecipeDetailBoCn._(_root);
	@override late final _TranslationsFiltersBoCn filters = _TranslationsFiltersBoCn._(_root);
	@override late final _TranslationsShoppingListBoCn shoppingList = _TranslationsShoppingListBoCn._(_root);
	@override late final _TranslationsMealPlanBoCn mealPlan = _TranslationsMealPlanBoCn._(_root);
	@override late final _TranslationsInventoryBoCn inventory = _TranslationsInventoryBoCn._(_root);
	@override late final _TranslationsBarcodeScanBoCn barcodeScan = _TranslationsBarcodeScanBoCn._(_root);
	@override late final _TranslationsReceiptScanBoCn receiptScan = _TranslationsReceiptScanBoCn._(_root);
	@override late final _TranslationsBatchCookingBoCn batchCooking = _TranslationsBatchCookingBoCn._(_root);
	@override late final _TranslationsVisitedDomainsBoCn visitedDomains = _TranslationsVisitedDomainsBoCn._(_root);
	@override late final _TranslationsDomainDiscoveryBoCn domainDiscovery = _TranslationsDomainDiscoveryBoCn._(_root);
	@override late final _TranslationsInventorySuggestionsBoCn inventorySuggestions = _TranslationsInventorySuggestionsBoCn._(_root);
	@override late final _TranslationsUpgradeBoCn upgrade = _TranslationsUpgradeBoCn._(_root);
	@override late final _TranslationsTourBoCn tour = _TranslationsTourBoCn._(_root);
	@override late final _TranslationsManualRecipeBoCn manualRecipe = _TranslationsManualRecipeBoCn._(_root);
	@override late final _TranslationsRecipeEditBoCn recipeEdit = _TranslationsRecipeEditBoCn._(_root);
	@override late final _TranslationsErrorsBoCn errors = _TranslationsErrorsBoCn._(_root);
}

// Path: app
class _TranslationsAppBoCn extends TranslationsAppEn {
	_TranslationsAppBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);

	final TranslationsBoCn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeBoCn extends TranslationsHomeEn {
	_TranslationsHomeBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBoCn extends TranslationsCommonEn {
	_TranslationsCommonBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBoCn extends TranslationsSettingsEn {
	_TranslationsSettingsBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);

	final TranslationsBoCn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBoCn measurements = _TranslationsSettingsMeasurementsBoCn._(_root);
	@override late final _TranslationsSettingsDataManagementBoCn dataManagement = _TranslationsSettingsDataManagementBoCn._(_root);
	@override late final _TranslationsSettingsVersionBoCn version = _TranslationsSettingsVersionBoCn._(_root);
}

// Path: recipes
class _TranslationsRecipesBoCn extends TranslationsRecipesEn {
	_TranslationsRecipesBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBoCn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBoCn nutrition = _TranslationsRecipeDetailNutritionBoCn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBoCn prepAhead = _TranslationsRecipeDetailPrepAheadBoCn._(_root);
...
// Path: filters
class _TranslationsFiltersBoCn extends TranslationsFiltersEn {
	_TranslationsFiltersBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBoCn extends TranslationsShoppingListEn {
	_TranslationsShoppingListBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBoCn extends TranslationsMealPlanEn {
	_TranslationsMealPlanBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBoCn extends TranslationsInventoryEn {
	_TranslationsInventoryBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBoCn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBoCn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBoCn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBoCn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBoCn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBoCn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBoCn extends TranslationsUpgradeEn {
	_TranslationsUpgradeBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBoCn extends TranslationsTourEn {
	_TranslationsTourBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBoCn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBoCn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBoCn extends TranslationsErrorsEn {
	_TranslationsErrorsBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBoCn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBoCn metric = _TranslationsSettingsMeasurementsMetricBoCn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBoCn imperial = _TranslationsSettingsMeasurementsImperialBoCn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBoCn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBoCn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBoCn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBoCn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBoCn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBoCn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBoCn._(TranslationsBoCn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <bo-CN>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsBoCn {
