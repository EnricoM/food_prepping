...
// Path: <root>
class TranslationsBa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsBa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ba>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsBa _root = this; // ignore: unused_field

	@override 
	TranslationsBa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsBa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppBa app = _TranslationsAppBa._(_root);
	@override late final _TranslationsHomeBa home = _TranslationsHomeBa._(_root);
	@override late final _TranslationsCommonBa common = _TranslationsCommonBa._(_root);
	@override late final _TranslationsSettingsBa settings = _TranslationsSettingsBa._(_root);
	@override late final _TranslationsRecipesBa recipes = _TranslationsRecipesBa._(_root);
	@override late final _TranslationsRecipeDetailBa recipeDetail = _TranslationsRecipeDetailBa._(_root);
	@override late final _TranslationsFiltersBa filters = _TranslationsFiltersBa._(_root);
	@override late final _TranslationsShoppingListBa shoppingList = _TranslationsShoppingListBa._(_root);
	@override late final _TranslationsMealPlanBa mealPlan = _TranslationsMealPlanBa._(_root);
	@override late final _TranslationsInventoryBa inventory = _TranslationsInventoryBa._(_root);
	@override late final _TranslationsBarcodeScanBa barcodeScan = _TranslationsBarcodeScanBa._(_root);
	@override late final _TranslationsReceiptScanBa receiptScan = _TranslationsReceiptScanBa._(_root);
	@override late final _TranslationsBatchCookingBa batchCooking = _TranslationsBatchCookingBa._(_root);
	@override late final _TranslationsVisitedDomainsBa visitedDomains = _TranslationsVisitedDomainsBa._(_root);
	@override late final _TranslationsDomainDiscoveryBa domainDiscovery = _TranslationsDomainDiscoveryBa._(_root);
	@override late final _TranslationsInventorySuggestionsBa inventorySuggestions = _TranslationsInventorySuggestionsBa._(_root);
	@override late final _TranslationsUpgradeBa upgrade = _TranslationsUpgradeBa._(_root);
	@override late final _TranslationsTourBa tour = _TranslationsTourBa._(_root);
	@override late final _TranslationsManualRecipeBa manualRecipe = _TranslationsManualRecipeBa._(_root);
	@override late final _TranslationsRecipeEditBa recipeEdit = _TranslationsRecipeEditBa._(_root);
	@override late final _TranslationsErrorsBa errors = _TranslationsErrorsBa._(_root);
}

// Path: app
class _TranslationsAppBa extends TranslationsAppEn {
	_TranslationsAppBa._(TranslationsBa root) : this._root = root, super.internal(root);

	final TranslationsBa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeBa extends TranslationsHomeEn {
	_TranslationsHomeBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBa extends TranslationsCommonEn {
	_TranslationsCommonBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBa extends TranslationsSettingsEn {
	_TranslationsSettingsBa._(TranslationsBa root) : this._root = root, super.internal(root);

	final TranslationsBa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBa measurements = _TranslationsSettingsMeasurementsBa._(_root);
	@override late final _TranslationsSettingsDataManagementBa dataManagement = _TranslationsSettingsDataManagementBa._(_root);
	@override late final _TranslationsSettingsVersionBa version = _TranslationsSettingsVersionBa._(_root);
}

// Path: recipes
class _TranslationsRecipesBa extends TranslationsRecipesEn {
	_TranslationsRecipesBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBa._(TranslationsBa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBa nutrition = _TranslationsRecipeDetailNutritionBa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBa prepAhead = _TranslationsRecipeDetailPrepAheadBa._(_root);
...
// Path: filters
class _TranslationsFiltersBa extends TranslationsFiltersEn {
	_TranslationsFiltersBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBa extends TranslationsShoppingListEn {
	_TranslationsShoppingListBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBa extends TranslationsMealPlanEn {
	_TranslationsMealPlanBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBa extends TranslationsInventoryEn {
	_TranslationsInventoryBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBa extends TranslationsUpgradeEn {
	_TranslationsUpgradeBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBa extends TranslationsTourEn {
	_TranslationsTourBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBa extends TranslationsErrorsEn {
	_TranslationsErrorsBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBa._(TranslationsBa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBa metric = _TranslationsSettingsMeasurementsMetricBa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBa imperial = _TranslationsSettingsMeasurementsImperialBa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBa._(TranslationsBa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ba>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsBa {
