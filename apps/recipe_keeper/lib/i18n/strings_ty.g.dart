...
// Path: <root>
class TranslationsTy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ty>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTy _root = this; // ignore: unused_field

	@override 
	TranslationsTy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTy app = _TranslationsAppTy._(_root);
	@override late final _TranslationsHomeTy home = _TranslationsHomeTy._(_root);
	@override late final _TranslationsCommonTy common = _TranslationsCommonTy._(_root);
	@override late final _TranslationsSettingsTy settings = _TranslationsSettingsTy._(_root);
	@override late final _TranslationsRecipesTy recipes = _TranslationsRecipesTy._(_root);
	@override late final _TranslationsRecipeDetailTy recipeDetail = _TranslationsRecipeDetailTy._(_root);
	@override late final _TranslationsFiltersTy filters = _TranslationsFiltersTy._(_root);
	@override late final _TranslationsShoppingListTy shoppingList = _TranslationsShoppingListTy._(_root);
	@override late final _TranslationsMealPlanTy mealPlan = _TranslationsMealPlanTy._(_root);
	@override late final _TranslationsInventoryTy inventory = _TranslationsInventoryTy._(_root);
	@override late final _TranslationsBarcodeScanTy barcodeScan = _TranslationsBarcodeScanTy._(_root);
	@override late final _TranslationsReceiptScanTy receiptScan = _TranslationsReceiptScanTy._(_root);
	@override late final _TranslationsBatchCookingTy batchCooking = _TranslationsBatchCookingTy._(_root);
	@override late final _TranslationsVisitedDomainsTy visitedDomains = _TranslationsVisitedDomainsTy._(_root);
	@override late final _TranslationsDomainDiscoveryTy domainDiscovery = _TranslationsDomainDiscoveryTy._(_root);
	@override late final _TranslationsInventorySuggestionsTy inventorySuggestions = _TranslationsInventorySuggestionsTy._(_root);
	@override late final _TranslationsUpgradeTy upgrade = _TranslationsUpgradeTy._(_root);
	@override late final _TranslationsTourTy tour = _TranslationsTourTy._(_root);
	@override late final _TranslationsManualRecipeTy manualRecipe = _TranslationsManualRecipeTy._(_root);
	@override late final _TranslationsRecipeEditTy recipeEdit = _TranslationsRecipeEditTy._(_root);
	@override late final _TranslationsErrorsTy errors = _TranslationsErrorsTy._(_root);
}

// Path: app
class _TranslationsAppTy extends TranslationsAppEn {
	_TranslationsAppTy._(TranslationsTy root) : this._root = root, super.internal(root);

	final TranslationsTy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTy extends TranslationsHomeEn {
	_TranslationsHomeTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTy extends TranslationsCommonEn {
	_TranslationsCommonTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTy extends TranslationsSettingsEn {
	_TranslationsSettingsTy._(TranslationsTy root) : this._root = root, super.internal(root);

	final TranslationsTy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTy measurements = _TranslationsSettingsMeasurementsTy._(_root);
	@override late final _TranslationsSettingsDataManagementTy dataManagement = _TranslationsSettingsDataManagementTy._(_root);
	@override late final _TranslationsSettingsVersionTy version = _TranslationsSettingsVersionTy._(_root);
}

// Path: recipes
class _TranslationsRecipesTy extends TranslationsRecipesEn {
	_TranslationsRecipesTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTy._(TranslationsTy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTy nutrition = _TranslationsRecipeDetailNutritionTy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTy prepAhead = _TranslationsRecipeDetailPrepAheadTy._(_root);
...
// Path: filters
class _TranslationsFiltersTy extends TranslationsFiltersEn {
	_TranslationsFiltersTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTy extends TranslationsShoppingListEn {
	_TranslationsShoppingListTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTy extends TranslationsMealPlanEn {
	_TranslationsMealPlanTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTy extends TranslationsInventoryEn {
	_TranslationsInventoryTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTy extends TranslationsUpgradeEn {
	_TranslationsUpgradeTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTy extends TranslationsTourEn {
	_TranslationsTourTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTy extends TranslationsErrorsEn {
	_TranslationsErrorsTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTy._(TranslationsTy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTy metric = _TranslationsSettingsMeasurementsMetricTy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTy imperial = _TranslationsSettingsMeasurementsImperialTy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTy._(TranslationsTy root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ty>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTy {
