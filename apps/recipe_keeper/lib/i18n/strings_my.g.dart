...
class TranslationsMy extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppMy app = _TranslationsAppMy._(_root);
	@override late final _TranslationsHomeMy home = _TranslationsHomeMy._(_root);
	@override late final _TranslationsCommonMy common = _TranslationsCommonMy._(_root);
	@override late final _TranslationsSettingsMy settings = _TranslationsSettingsMy._(_root);
	@override late final _TranslationsRecipesMy recipes = _TranslationsRecipesMy._(_root);
	@override late final _TranslationsRecipeDetailMy recipeDetail = _TranslationsRecipeDetailMy._(_root);
	@override late final _TranslationsFiltersMy filters = _TranslationsFiltersMy._(_root);
	@override late final _TranslationsShoppingListMy shoppingList = _TranslationsShoppingListMy._(_root);
	@override late final _TranslationsMealPlanMy mealPlan = _TranslationsMealPlanMy._(_root);
	@override late final _TranslationsInventoryMy inventory = _TranslationsInventoryMy._(_root);
	@override late final _TranslationsBarcodeScanMy barcodeScan = _TranslationsBarcodeScanMy._(_root);
	@override late final _TranslationsReceiptScanMy receiptScan = _TranslationsReceiptScanMy._(_root);
	@override late final _TranslationsBatchCookingMy batchCooking = _TranslationsBatchCookingMy._(_root);
	@override late final _TranslationsVisitedDomainsMy visitedDomains = _TranslationsVisitedDomainsMy._(_root);
	@override late final _TranslationsDomainDiscoveryMy domainDiscovery = _TranslationsDomainDiscoveryMy._(_root);
	@override late final _TranslationsInventorySuggestionsMy inventorySuggestions = _TranslationsInventorySuggestionsMy._(_root);
	@override late final _TranslationsUpgradeMy upgrade = _TranslationsUpgradeMy._(_root);
	@override late final _TranslationsTourMy tour = _TranslationsTourMy._(_root);
	@override late final _TranslationsManualRecipeMy manualRecipe = _TranslationsManualRecipeMy._(_root);
	@override late final _TranslationsRecipeEditMy recipeEdit = _TranslationsRecipeEditMy._(_root);
	@override late final _TranslationsErrorsMy errors = _TranslationsErrorsMy._(_root);
}

// Path: app
class _TranslationsAppMy extends TranslationsAppEn {
	_TranslationsAppMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeMy extends TranslationsHomeEn {
	_TranslationsHomeMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMy extends TranslationsCommonEn {
	_TranslationsCommonMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMy extends TranslationsSettingsEn {
	_TranslationsSettingsMy._(TranslationsMy root) : this._root = root, super.internal(root);

	final TranslationsMy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMy measurements = _TranslationsSettingsMeasurementsMy._(_root);
	@override late final _TranslationsSettingsDataManagementMy dataManagement = _TranslationsSettingsDataManagementMy._(_root);
	@override late final _TranslationsSettingsVersionMy version = _TranslationsSettingsVersionMy._(_root);
}

// Path: recipes
class _TranslationsRecipesMy extends TranslationsRecipesEn {
	_TranslationsRecipesMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMy._(TranslationsMy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMy nutrition = _TranslationsRecipeDetailNutritionMy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMy prepAhead = _TranslationsRecipeDetailPrepAheadMy._(_root);
...
// Path: filters
class _TranslationsFiltersMy extends TranslationsFiltersEn {
	_TranslationsFiltersMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMy extends TranslationsShoppingListEn {
	_TranslationsShoppingListMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMy extends TranslationsMealPlanEn {
	_TranslationsMealPlanMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMy extends TranslationsInventoryEn {
	_TranslationsInventoryMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMy extends TranslationsUpgradeEn {
	_TranslationsUpgradeMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMy extends TranslationsTourEn {
	_TranslationsTourMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMy extends TranslationsErrorsEn {
	_TranslationsErrorsMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMy._(TranslationsMy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMy metric = _TranslationsSettingsMeasurementsMetricMy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMy imperial = _TranslationsSettingsMeasurementsImperialMy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMy._(TranslationsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMy._(TranslationsMy root) : this._root = root, super.internal(root);
