...
class TranslationsPl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesPl recipes = _TranslationsRecipesPl._(_root);
	@override late final _TranslationsRecipeDetailPl recipeDetail = _TranslationsRecipeDetailPl._(_root);
	@override late final _TranslationsFiltersPl filters = _TranslationsFiltersPl._(_root);
	@override late final _TranslationsShoppingListPl shoppingList = _TranslationsShoppingListPl._(_root);
	@override late final _TranslationsMealPlanPl mealPlan = _TranslationsMealPlanPl._(_root);
	@override late final _TranslationsInventoryPl inventory = _TranslationsInventoryPl._(_root);
	@override late final _TranslationsBarcodeScanPl barcodeScan = _TranslationsBarcodeScanPl._(_root);
	@override late final _TranslationsReceiptScanPl receiptScan = _TranslationsReceiptScanPl._(_root);
	@override late final _TranslationsBatchCookingPl batchCooking = _TranslationsBatchCookingPl._(_root);
	@override late final _TranslationsVisitedDomainsPl visitedDomains = _TranslationsVisitedDomainsPl._(_root);
	@override late final _TranslationsDomainDiscoveryPl domainDiscovery = _TranslationsDomainDiscoveryPl._(_root);
	@override late final _TranslationsInventorySuggestionsPl inventorySuggestions = _TranslationsInventorySuggestionsPl._(_root);
	@override late final _TranslationsUpgradePl upgrade = _TranslationsUpgradePl._(_root);
	@override late final _TranslationsTourPl tour = _TranslationsTourPl._(_root);
	@override late final _TranslationsManualRecipePl manualRecipe = _TranslationsManualRecipePl._(_root);
	@override late final _TranslationsRecipeEditPl recipeEdit = _TranslationsRecipeEditPl._(_root);
...
class _TranslationsSettingsPl extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsPl measurements = _TranslationsSettingsMeasurementsPl._(_root);
	@override late final _TranslationsSettingsDataManagementPl dataManagement = _TranslationsSettingsDataManagementPl._(_root);
	@override late final _TranslationsSettingsVersionPl version = _TranslationsSettingsVersionPl._(_root);
}

// Path: recipes
class _TranslationsRecipesPl extends TranslationsRecipesEn {
	_TranslationsRecipesPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPl._(TranslationsPl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPl nutrition = _TranslationsRecipeDetailNutritionPl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPl prepAhead = _TranslationsRecipeDetailPrepAheadPl._(_root);
...
// Path: filters
class _TranslationsFiltersPl extends TranslationsFiltersEn {
	_TranslationsFiltersPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPl extends TranslationsShoppingListEn {
	_TranslationsShoppingListPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPl extends TranslationsMealPlanEn {
	_TranslationsMealPlanPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPl extends TranslationsInventoryEn {
	_TranslationsInventoryPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePl extends TranslationsUpgradeEn {
	_TranslationsUpgradePl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPl extends TranslationsTourEn {
	_TranslationsTourPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePl._(TranslationsPl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPl._(TranslationsPl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPl metric = _TranslationsSettingsMeasurementsMetricPl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPl imperial = _TranslationsSettingsMeasurementsImperialPl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPl._(TranslationsPl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPl._(TranslationsPl root) : this._root = root, super.internal(root);
