...
// Path: <root>
class TranslationsBeBy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsBeBy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.beBy,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <be-BY>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsBeBy _root = this; // ignore: unused_field

	@override 
	TranslationsBeBy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsBeBy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppBeBy app = _TranslationsAppBeBy._(_root);
	@override late final _TranslationsHomeBeBy home = _TranslationsHomeBeBy._(_root);
	@override late final _TranslationsCommonBeBy common = _TranslationsCommonBeBy._(_root);
	@override late final _TranslationsSettingsBeBy settings = _TranslationsSettingsBeBy._(_root);
	@override late final _TranslationsRecipesBeBy recipes = _TranslationsRecipesBeBy._(_root);
	@override late final _TranslationsRecipeDetailBeBy recipeDetail = _TranslationsRecipeDetailBeBy._(_root);
	@override late final _TranslationsFiltersBeBy filters = _TranslationsFiltersBeBy._(_root);
	@override late final _TranslationsShoppingListBeBy shoppingList = _TranslationsShoppingListBeBy._(_root);
	@override late final _TranslationsMealPlanBeBy mealPlan = _TranslationsMealPlanBeBy._(_root);
	@override late final _TranslationsInventoryBeBy inventory = _TranslationsInventoryBeBy._(_root);
	@override late final _TranslationsBarcodeScanBeBy barcodeScan = _TranslationsBarcodeScanBeBy._(_root);
	@override late final _TranslationsReceiptScanBeBy receiptScan = _TranslationsReceiptScanBeBy._(_root);
	@override late final _TranslationsBatchCookingBeBy batchCooking = _TranslationsBatchCookingBeBy._(_root);
	@override late final _TranslationsVisitedDomainsBeBy visitedDomains = _TranslationsVisitedDomainsBeBy._(_root);
	@override late final _TranslationsDomainDiscoveryBeBy domainDiscovery = _TranslationsDomainDiscoveryBeBy._(_root);
	@override late final _TranslationsInventorySuggestionsBeBy inventorySuggestions = _TranslationsInventorySuggestionsBeBy._(_root);
	@override late final _TranslationsUpgradeBeBy upgrade = _TranslationsUpgradeBeBy._(_root);
	@override late final _TranslationsTourBeBy tour = _TranslationsTourBeBy._(_root);
	@override late final _TranslationsManualRecipeBeBy manualRecipe = _TranslationsManualRecipeBeBy._(_root);
	@override late final _TranslationsRecipeEditBeBy recipeEdit = _TranslationsRecipeEditBeBy._(_root);
	@override late final _TranslationsErrorsBeBy errors = _TranslationsErrorsBeBy._(_root);
}

// Path: app
class _TranslationsAppBeBy extends TranslationsAppEn {
	_TranslationsAppBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);

	final TranslationsBeBy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeBeBy extends TranslationsHomeEn {
	_TranslationsHomeBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBeBy extends TranslationsCommonEn {
	_TranslationsCommonBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBeBy extends TranslationsSettingsEn {
	_TranslationsSettingsBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);

	final TranslationsBeBy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBeBy measurements = _TranslationsSettingsMeasurementsBeBy._(_root);
	@override late final _TranslationsSettingsDataManagementBeBy dataManagement = _TranslationsSettingsDataManagementBeBy._(_root);
	@override late final _TranslationsSettingsVersionBeBy version = _TranslationsSettingsVersionBeBy._(_root);
}

// Path: recipes
class _TranslationsRecipesBeBy extends TranslationsRecipesEn {
	_TranslationsRecipesBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBeBy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBeBy nutrition = _TranslationsRecipeDetailNutritionBeBy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBeBy prepAhead = _TranslationsRecipeDetailPrepAheadBeBy._(_root);
...
// Path: filters
class _TranslationsFiltersBeBy extends TranslationsFiltersEn {
	_TranslationsFiltersBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBeBy extends TranslationsShoppingListEn {
	_TranslationsShoppingListBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBeBy extends TranslationsMealPlanEn {
	_TranslationsMealPlanBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBeBy extends TranslationsInventoryEn {
	_TranslationsInventoryBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBeBy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBeBy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBeBy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBeBy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBeBy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBeBy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBeBy extends TranslationsUpgradeEn {
	_TranslationsUpgradeBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBeBy extends TranslationsTourEn {
	_TranslationsTourBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBeBy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBeBy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBeBy extends TranslationsErrorsEn {
	_TranslationsErrorsBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBeBy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBeBy metric = _TranslationsSettingsMeasurementsMetricBeBy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBeBy imperial = _TranslationsSettingsMeasurementsImperialBeBy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBeBy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBeBy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBeBy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBeBy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBeBy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBeBy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBeBy._(TranslationsBeBy root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <be-BY>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsBeBy {
