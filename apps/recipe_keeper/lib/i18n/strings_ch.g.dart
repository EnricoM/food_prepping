...
// Path: <root>
class TranslationsCh extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppCh app = _TranslationsAppCh._(_root);
	...
	@override late final _TranslationsSettingsCh settings = _TranslationsSettingsCh._(_root);
	@override late final _TranslationsRecipesCh recipes = _TranslationsRecipesCh._(_root);
	@override late final _TranslationsRecipeDetailCh recipeDetail = _TranslationsRecipeDetailCh._(_root);
	@override late final _TranslationsFiltersCh filters = _TranslationsFiltersCh._(_root);
	@override late final _TranslationsShoppingListCh shoppingList = _TranslationsShoppingListCh._(_root);
	@override late final _TranslationsMealPlanCh mealPlan = _TranslationsMealPlanCh._(_root);
	@override late final _TranslationsInventoryCh inventory = _TranslationsInventoryCh._(_root);
	@override late final _TranslationsBarcodeScanCh barcodeScan = _TranslationsBarcodeScanCh._(_root);
	@override late final _TranslationsReceiptScanCh receiptScan = _TranslationsReceiptScanCh._(_root);
	@override late final _TranslationsBatchCookingCh batchCooking = _TranslationsBatchCookingCh._(_root);
	@override late final _TranslationsVisitedDomainsCh visitedDomains = _TranslationsVisitedDomainsCh._(_root);
	@override late final _TranslationsDomainDiscoveryCh domainDiscovery = _TranslationsDomainDiscoveryCh._(_root);
	@override late final _TranslationsInventorySuggestionsCh inventorySuggestions = _TranslationsInventorySuggestionsCh._(_root);
	@override late final _TranslationsUpgradeCh upgrade = _TranslationsUpgradeCh._(_root);
	@override late final _TranslationsTourCh tour = _TranslationsTourCh._(_root);
	@override late final _TranslationsManualRecipeCh manualRecipe = _TranslationsManualRecipeCh._(_root);
	@override late final _TranslationsRecipeEditCh recipeEdit = _TranslationsRecipeEditCh._(_root);
	@override late final _TranslationsErrorsCh errors = _TranslationsErrorsCh._(_root);
}

// Path: app
class _TranslationsAppCh extends TranslationsAppEn {
	_TranslationsAppCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeCh extends TranslationsHomeEn {
	_TranslationsHomeCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCh extends TranslationsCommonEn {
	_TranslationsCommonCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCh extends TranslationsSettingsEn {
	_TranslationsSettingsCh._(TranslationsCh root) : this._root = root, super.internal(root);

	final TranslationsCh _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCh measurements = _TranslationsSettingsMeasurementsCh._(_root);
	@override late final _TranslationsSettingsDataManagementCh dataManagement = _TranslationsSettingsDataManagementCh._(_root);
	@override late final _TranslationsSettingsVersionCh version = _TranslationsSettingsVersionCh._(_root);
}

// Path: recipes
class _TranslationsRecipesCh extends TranslationsRecipesEn {
	_TranslationsRecipesCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCh extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCh._(TranslationsCh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCh nutrition = _TranslationsRecipeDetailNutritionCh._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCh prepAhead = _TranslationsRecipeDetailPrepAheadCh._(_root);
...
// Path: filters
class _TranslationsFiltersCh extends TranslationsFiltersEn {
	_TranslationsFiltersCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCh extends TranslationsShoppingListEn {
	_TranslationsShoppingListCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCh extends TranslationsMealPlanEn {
	_TranslationsMealPlanCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCh extends TranslationsInventoryEn {
	_TranslationsInventoryCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCh extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCh extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCh extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCh extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCh extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCh extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCh extends TranslationsUpgradeEn {
	_TranslationsUpgradeCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCh extends TranslationsTourEn {
	_TranslationsTourCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCh extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCh extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCh extends TranslationsErrorsEn {
	_TranslationsErrorsCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCh extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCh._(TranslationsCh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCh metric = _TranslationsSettingsMeasurementsMetricCh._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCh imperial = _TranslationsSettingsMeasurementsImperialCh._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCh extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCh extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCh extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCh extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCh extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCh._(TranslationsCh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCh extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCh._(TranslationsCh root) : this._root = root, super.internal(root);
