...
// Path: <root>
class TranslationsSiLk extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSiLk({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.siLk,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <si-LK>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSiLk _root = this; // ignore: unused_field

	@override 
	TranslationsSiLk $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSiLk(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSiLk app = _TranslationsAppSiLk._(_root);
	@override late final _TranslationsHomeSiLk home = _TranslationsHomeSiLk._(_root);
	@override late final _TranslationsCommonSiLk common = _TranslationsCommonSiLk._(_root);
	@override late final _TranslationsSettingsSiLk settings = _TranslationsSettingsSiLk._(_root);
	@override late final _TranslationsRecipesSiLk recipes = _TranslationsRecipesSiLk._(_root);
	@override late final _TranslationsRecipeDetailSiLk recipeDetail = _TranslationsRecipeDetailSiLk._(_root);
	@override late final _TranslationsFiltersSiLk filters = _TranslationsFiltersSiLk._(_root);
	@override late final _TranslationsShoppingListSiLk shoppingList = _TranslationsShoppingListSiLk._(_root);
	@override late final _TranslationsMealPlanSiLk mealPlan = _TranslationsMealPlanSiLk._(_root);
	@override late final _TranslationsInventorySiLk inventory = _TranslationsInventorySiLk._(_root);
	@override late final _TranslationsBarcodeScanSiLk barcodeScan = _TranslationsBarcodeScanSiLk._(_root);
	@override late final _TranslationsReceiptScanSiLk receiptScan = _TranslationsReceiptScanSiLk._(_root);
	@override late final _TranslationsBatchCookingSiLk batchCooking = _TranslationsBatchCookingSiLk._(_root);
	@override late final _TranslationsVisitedDomainsSiLk visitedDomains = _TranslationsVisitedDomainsSiLk._(_root);
	@override late final _TranslationsDomainDiscoverySiLk domainDiscovery = _TranslationsDomainDiscoverySiLk._(_root);
	@override late final _TranslationsInventorySuggestionsSiLk inventorySuggestions = _TranslationsInventorySuggestionsSiLk._(_root);
	@override late final _TranslationsUpgradeSiLk upgrade = _TranslationsUpgradeSiLk._(_root);
	@override late final _TranslationsTourSiLk tour = _TranslationsTourSiLk._(_root);
	@override late final _TranslationsManualRecipeSiLk manualRecipe = _TranslationsManualRecipeSiLk._(_root);
	@override late final _TranslationsRecipeEditSiLk recipeEdit = _TranslationsRecipeEditSiLk._(_root);
	@override late final _TranslationsErrorsSiLk errors = _TranslationsErrorsSiLk._(_root);
}

// Path: app
class _TranslationsAppSiLk extends TranslationsAppEn {
	_TranslationsAppSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);

	final TranslationsSiLk _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSiLk extends TranslationsHomeEn {
	_TranslationsHomeSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSiLk extends TranslationsCommonEn {
	_TranslationsCommonSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSiLk extends TranslationsSettingsEn {
	_TranslationsSettingsSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);

	final TranslationsSiLk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSiLk measurements = _TranslationsSettingsMeasurementsSiLk._(_root);
	@override late final _TranslationsSettingsDataManagementSiLk dataManagement = _TranslationsSettingsDataManagementSiLk._(_root);
	@override late final _TranslationsSettingsVersionSiLk version = _TranslationsSettingsVersionSiLk._(_root);
}

// Path: recipes
class _TranslationsRecipesSiLk extends TranslationsRecipesEn {
	_TranslationsRecipesSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSiLk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSiLk nutrition = _TranslationsRecipeDetailNutritionSiLk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSiLk prepAhead = _TranslationsRecipeDetailPrepAheadSiLk._(_root);
...
// Path: filters
class _TranslationsFiltersSiLk extends TranslationsFiltersEn {
	_TranslationsFiltersSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSiLk extends TranslationsShoppingListEn {
	_TranslationsShoppingListSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSiLk extends TranslationsMealPlanEn {
	_TranslationsMealPlanSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySiLk extends TranslationsInventoryEn {
	_TranslationsInventorySiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSiLk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSiLk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSiLk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSiLk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySiLk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSiLk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSiLk extends TranslationsUpgradeEn {
	_TranslationsUpgradeSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSiLk extends TranslationsTourEn {
	_TranslationsTourSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSiLk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSiLk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSiLk extends TranslationsErrorsEn {
	_TranslationsErrorsSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSiLk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSiLk metric = _TranslationsSettingsMeasurementsMetricSiLk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSiLk imperial = _TranslationsSettingsMeasurementsImperialSiLk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSiLk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSiLk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSiLk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSiLk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSiLk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSiLk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSiLk._(TranslationsSiLk root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <si-LK>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSiLk {
