...
// Path: <root>
class TranslationsCu extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <cu>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsCu _root = this; // ignore: unused_field

	@override 
	TranslationsCu $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCu(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCu app = _TranslationsAppCu._(_root);
	@override late final _TranslationsHomeCu home = _TranslationsHomeCu._(_root);
	@override late final _TranslationsCommonCu common = _TranslationsCommonCu._(_root);
	@override late final _TranslationsSettingsCu settings = _TranslationsSettingsCu._(_root);
	@override late final _TranslationsRecipesCu recipes = _TranslationsRecipesCu._(_root);
	@override late final _TranslationsRecipeDetailCu recipeDetail = _TranslationsRecipeDetailCu._(_root);
	@override late final _TranslationsFiltersCu filters = _TranslationsFiltersCu._(_root);
	@override late final _TranslationsShoppingListCu shoppingList = _TranslationsShoppingListCu._(_root);
	@override late final _TranslationsMealPlanCu mealPlan = _TranslationsMealPlanCu._(_root);
	@override late final _TranslationsInventoryCu inventory = _TranslationsInventoryCu._(_root);
	@override late final _TranslationsBarcodeScanCu barcodeScan = _TranslationsBarcodeScanCu._(_root);
	@override late final _TranslationsReceiptScanCu receiptScan = _TranslationsReceiptScanCu._(_root);
	@override late final _TranslationsBatchCookingCu batchCooking = _TranslationsBatchCookingCu._(_root);
	@override late final _TranslationsVisitedDomainsCu visitedDomains = _TranslationsVisitedDomainsCu._(_root);
	@override late final _TranslationsDomainDiscoveryCu domainDiscovery = _TranslationsDomainDiscoveryCu._(_root);
	@override late final _TranslationsInventorySuggestionsCu inventorySuggestions = _TranslationsInventorySuggestionsCu._(_root);
	@override late final _TranslationsUpgradeCu upgrade = _TranslationsUpgradeCu._(_root);
	@override late final _TranslationsTourCu tour = _TranslationsTourCu._(_root);
	@override late final _TranslationsManualRecipeCu manualRecipe = _TranslationsManualRecipeCu._(_root);
	@override late final _TranslationsRecipeEditCu recipeEdit = _TranslationsRecipeEditCu._(_root);
	@override late final _TranslationsErrorsCu errors = _TranslationsErrorsCu._(_root);
}

// Path: app
class _TranslationsAppCu extends TranslationsAppEn {
	_TranslationsAppCu._(TranslationsCu root) : this._root = root, super.internal(root);

	final TranslationsCu _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeCu extends TranslationsHomeEn {
	_TranslationsHomeCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCu extends TranslationsCommonEn {
	_TranslationsCommonCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCu extends TranslationsSettingsEn {
	_TranslationsSettingsCu._(TranslationsCu root) : this._root = root, super.internal(root);

	final TranslationsCu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCu measurements = _TranslationsSettingsMeasurementsCu._(_root);
	@override late final _TranslationsSettingsDataManagementCu dataManagement = _TranslationsSettingsDataManagementCu._(_root);
	@override late final _TranslationsSettingsVersionCu version = _TranslationsSettingsVersionCu._(_root);
}

// Path: recipes
class _TranslationsRecipesCu extends TranslationsRecipesEn {
	_TranslationsRecipesCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCu._(TranslationsCu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCu nutrition = _TranslationsRecipeDetailNutritionCu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCu prepAhead = _TranslationsRecipeDetailPrepAheadCu._(_root);
...
// Path: filters
class _TranslationsFiltersCu extends TranslationsFiltersEn {
	_TranslationsFiltersCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCu extends TranslationsShoppingListEn {
	_TranslationsShoppingListCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCu extends TranslationsMealPlanEn {
	_TranslationsMealPlanCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCu extends TranslationsInventoryEn {
	_TranslationsInventoryCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCu extends TranslationsUpgradeEn {
	_TranslationsUpgradeCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCu extends TranslationsTourEn {
	_TranslationsTourCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCu extends TranslationsErrorsEn {
	_TranslationsErrorsCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCu._(TranslationsCu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCu metric = _TranslationsSettingsMeasurementsMetricCu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCu imperial = _TranslationsSettingsMeasurementsImperialCu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCu._(TranslationsCu root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <cu>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsCu {
