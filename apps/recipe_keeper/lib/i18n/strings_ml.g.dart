...
class TranslationsMl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesMl recipes = _TranslationsRecipesMl._(_root);
	@override late final _TranslationsRecipeDetailMl recipeDetail = _TranslationsRecipeDetailMl._(_root);
	@override late final _TranslationsFiltersMl filters = _TranslationsFiltersMl._(_root);
	@override late final _TranslationsShoppingListMl shoppingList = _TranslationsShoppingListMl._(_root);
	@override late final _TranslationsMealPlanMl mealPlan = _TranslationsMealPlanMl._(_root);
	@override late final _TranslationsInventoryMl inventory = _TranslationsInventoryMl._(_root);
	@override late final _TranslationsBarcodeScanMl barcodeScan = _TranslationsBarcodeScanMl._(_root);
	@override late final _TranslationsReceiptScanMl receiptScan = _TranslationsReceiptScanMl._(_root);
	@override late final _TranslationsBatchCookingMl batchCooking = _TranslationsBatchCookingMl._(_root);
	@override late final _TranslationsVisitedDomainsMl visitedDomains = _TranslationsVisitedDomainsMl._(_root);
	@override late final _TranslationsDomainDiscoveryMl domainDiscovery = _TranslationsDomainDiscoveryMl._(_root);
	@override late final _TranslationsInventorySuggestionsMl inventorySuggestions = _TranslationsInventorySuggestionsMl._(_root);
	@override late final _TranslationsUpgradeMl upgrade = _TranslationsUpgradeMl._(_root);
	@override late final _TranslationsTourMl tour = _TranslationsTourMl._(_root);
	@override late final _TranslationsManualRecipeMl manualRecipe = _TranslationsManualRecipeMl._(_root);
	@override late final _TranslationsRecipeEditMl recipeEdit = _TranslationsRecipeEditMl._(_root);
	@override late final _TranslationsErrorsMl errors = _TranslationsErrorsMl._(_root);
}
...
class _TranslationsSettingsMl extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsMl measurements = _TranslationsSettingsMeasurementsMl._(_root);
	@override late final _TranslationsSettingsDataManagementMl dataManagement = _TranslationsSettingsDataManagementMl._(_root);
	@override late final _TranslationsSettingsVersionMl version = _TranslationsSettingsVersionMl._(_root);
}

// Path: recipes
class _TranslationsRecipesMl extends TranslationsRecipesEn {
	_TranslationsRecipesMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMl._(TranslationsMl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMl nutrition = _TranslationsRecipeDetailNutritionMl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMl prepAhead = _TranslationsRecipeDetailPrepAheadMl._(_root);
...
// Path: filters
class _TranslationsFiltersMl extends TranslationsFiltersEn {
	_TranslationsFiltersMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMl extends TranslationsShoppingListEn {
	_TranslationsShoppingListMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMl extends TranslationsMealPlanEn {
	_TranslationsMealPlanMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMl extends TranslationsInventoryEn {
	_TranslationsInventoryMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMl extends TranslationsUpgradeEn {
	_TranslationsUpgradeMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMl extends TranslationsTourEn {
	_TranslationsTourMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMl extends TranslationsErrorsEn {
	_TranslationsErrorsMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMl._(TranslationsMl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMl metric = _TranslationsSettingsMeasurementsMetricMl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMl imperial = _TranslationsSettingsMeasurementsImperialMl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMl._(TranslationsMl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMl._(TranslationsMl root) : this._root = root, super.internal(root);
