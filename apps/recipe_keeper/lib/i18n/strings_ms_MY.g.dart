...
// Path: <root>
class TranslationsMsMy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMsMy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.msMy,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ms-MY>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMsMy _root = this; // ignore: unused_field

	@override 
	TranslationsMsMy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMsMy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMsMy app = _TranslationsAppMsMy._(_root);
	@override late final _TranslationsHomeMsMy home = _TranslationsHomeMsMy._(_root);
	@override late final _TranslationsCommonMsMy common = _TranslationsCommonMsMy._(_root);
	@override late final _TranslationsSettingsMsMy settings = _TranslationsSettingsMsMy._(_root);
	@override late final _TranslationsRecipesMsMy recipes = _TranslationsRecipesMsMy._(_root);
	@override late final _TranslationsRecipeDetailMsMy recipeDetail = _TranslationsRecipeDetailMsMy._(_root);
	@override late final _TranslationsFiltersMsMy filters = _TranslationsFiltersMsMy._(_root);
	@override late final _TranslationsShoppingListMsMy shoppingList = _TranslationsShoppingListMsMy._(_root);
	@override late final _TranslationsMealPlanMsMy mealPlan = _TranslationsMealPlanMsMy._(_root);
	@override late final _TranslationsInventoryMsMy inventory = _TranslationsInventoryMsMy._(_root);
	@override late final _TranslationsBarcodeScanMsMy barcodeScan = _TranslationsBarcodeScanMsMy._(_root);
	@override late final _TranslationsReceiptScanMsMy receiptScan = _TranslationsReceiptScanMsMy._(_root);
	@override late final _TranslationsBatchCookingMsMy batchCooking = _TranslationsBatchCookingMsMy._(_root);
	@override late final _TranslationsVisitedDomainsMsMy visitedDomains = _TranslationsVisitedDomainsMsMy._(_root);
	@override late final _TranslationsDomainDiscoveryMsMy domainDiscovery = _TranslationsDomainDiscoveryMsMy._(_root);
	@override late final _TranslationsInventorySuggestionsMsMy inventorySuggestions = _TranslationsInventorySuggestionsMsMy._(_root);
	@override late final _TranslationsUpgradeMsMy upgrade = _TranslationsUpgradeMsMy._(_root);
	@override late final _TranslationsTourMsMy tour = _TranslationsTourMsMy._(_root);
	@override late final _TranslationsManualRecipeMsMy manualRecipe = _TranslationsManualRecipeMsMy._(_root);
	@override late final _TranslationsRecipeEditMsMy recipeEdit = _TranslationsRecipeEditMsMy._(_root);
	@override late final _TranslationsErrorsMsMy errors = _TranslationsErrorsMsMy._(_root);
}

// Path: app
class _TranslationsAppMsMy extends TranslationsAppEn {
	_TranslationsAppMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);

	final TranslationsMsMy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMsMy extends TranslationsHomeEn {
	_TranslationsHomeMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMsMy extends TranslationsCommonEn {
	_TranslationsCommonMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMsMy extends TranslationsSettingsEn {
	_TranslationsSettingsMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);

	final TranslationsMsMy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMsMy measurements = _TranslationsSettingsMeasurementsMsMy._(_root);
	@override late final _TranslationsSettingsDataManagementMsMy dataManagement = _TranslationsSettingsDataManagementMsMy._(_root);
	@override late final _TranslationsSettingsVersionMsMy version = _TranslationsSettingsVersionMsMy._(_root);
}

// Path: recipes
class _TranslationsRecipesMsMy extends TranslationsRecipesEn {
	_TranslationsRecipesMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMsMy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMsMy nutrition = _TranslationsRecipeDetailNutritionMsMy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMsMy prepAhead = _TranslationsRecipeDetailPrepAheadMsMy._(_root);
...
// Path: filters
class _TranslationsFiltersMsMy extends TranslationsFiltersEn {
	_TranslationsFiltersMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMsMy extends TranslationsShoppingListEn {
	_TranslationsShoppingListMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMsMy extends TranslationsMealPlanEn {
	_TranslationsMealPlanMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMsMy extends TranslationsInventoryEn {
	_TranslationsInventoryMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMsMy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMsMy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMsMy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMsMy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMsMy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMsMy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMsMy extends TranslationsUpgradeEn {
	_TranslationsUpgradeMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMsMy extends TranslationsTourEn {
	_TranslationsTourMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMsMy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMsMy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMsMy extends TranslationsErrorsEn {
	_TranslationsErrorsMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMsMy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMsMy metric = _TranslationsSettingsMeasurementsMetricMsMy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMsMy imperial = _TranslationsSettingsMeasurementsImperialMsMy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMsMy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMsMy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMsMy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMsMy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMsMy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMsMy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMsMy._(TranslationsMsMy root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ms-MY>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMsMy {
