...
// Path: <root>
class TranslationsCo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <co>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsCo _root = this; // ignore: unused_field

	@override 
	TranslationsCo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCo app = _TranslationsAppCo._(_root);
	@override late final _TranslationsHomeCo home = _TranslationsHomeCo._(_root);
	@override late final _TranslationsCommonCo common = _TranslationsCommonCo._(_root);
	@override late final _TranslationsSettingsCo settings = _TranslationsSettingsCo._(_root);
	@override late final _TranslationsRecipesCo recipes = _TranslationsRecipesCo._(_root);
	@override late final _TranslationsRecipeDetailCo recipeDetail = _TranslationsRecipeDetailCo._(_root);
	@override late final _TranslationsFiltersCo filters = _TranslationsFiltersCo._(_root);
	@override late final _TranslationsShoppingListCo shoppingList = _TranslationsShoppingListCo._(_root);
	@override late final _TranslationsMealPlanCo mealPlan = _TranslationsMealPlanCo._(_root);
	@override late final _TranslationsInventoryCo inventory = _TranslationsInventoryCo._(_root);
	@override late final _TranslationsBarcodeScanCo barcodeScan = _TranslationsBarcodeScanCo._(_root);
	@override late final _TranslationsReceiptScanCo receiptScan = _TranslationsReceiptScanCo._(_root);
	@override late final _TranslationsBatchCookingCo batchCooking = _TranslationsBatchCookingCo._(_root);
	@override late final _TranslationsVisitedDomainsCo visitedDomains = _TranslationsVisitedDomainsCo._(_root);
	@override late final _TranslationsDomainDiscoveryCo domainDiscovery = _TranslationsDomainDiscoveryCo._(_root);
	@override late final _TranslationsInventorySuggestionsCo inventorySuggestions = _TranslationsInventorySuggestionsCo._(_root);
	@override late final _TranslationsUpgradeCo upgrade = _TranslationsUpgradeCo._(_root);
	@override late final _TranslationsTourCo tour = _TranslationsTourCo._(_root);
	@override late final _TranslationsManualRecipeCo manualRecipe = _TranslationsManualRecipeCo._(_root);
	@override late final _TranslationsRecipeEditCo recipeEdit = _TranslationsRecipeEditCo._(_root);
	@override late final _TranslationsErrorsCo errors = _TranslationsErrorsCo._(_root);
}

// Path: app
class _TranslationsAppCo extends TranslationsAppEn {
	_TranslationsAppCo._(TranslationsCo root) : this._root = root, super.internal(root);

	final TranslationsCo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeCo extends TranslationsHomeEn {
	_TranslationsHomeCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCo extends TranslationsCommonEn {
	_TranslationsCommonCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCo extends TranslationsSettingsEn {
	_TranslationsSettingsCo._(TranslationsCo root) : this._root = root, super.internal(root);

	final TranslationsCo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCo measurements = _TranslationsSettingsMeasurementsCo._(_root);
	@override late final _TranslationsSettingsDataManagementCo dataManagement = _TranslationsSettingsDataManagementCo._(_root);
	@override late final _TranslationsSettingsVersionCo version = _TranslationsSettingsVersionCo._(_root);
}

// Path: recipes
class _TranslationsRecipesCo extends TranslationsRecipesEn {
	_TranslationsRecipesCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCo._(TranslationsCo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCo nutrition = _TranslationsRecipeDetailNutritionCo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCo prepAhead = _TranslationsRecipeDetailPrepAheadCo._(_root);
...
// Path: filters
class _TranslationsFiltersCo extends TranslationsFiltersEn {
	_TranslationsFiltersCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCo extends TranslationsShoppingListEn {
	_TranslationsShoppingListCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCo extends TranslationsMealPlanEn {
	_TranslationsMealPlanCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCo extends TranslationsInventoryEn {
	_TranslationsInventoryCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCo extends TranslationsUpgradeEn {
	_TranslationsUpgradeCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCo extends TranslationsTourEn {
	_TranslationsTourCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCo extends TranslationsErrorsEn {
	_TranslationsErrorsCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCo._(TranslationsCo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCo metric = _TranslationsSettingsMeasurementsMetricCo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCo imperial = _TranslationsSettingsMeasurementsImperialCo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCo._(TranslationsCo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <co>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsCo {
