...
class TranslationsZhTw extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesZhTw recipes = _TranslationsRecipesZhTw._(_root);
	@override late final _TranslationsRecipeDetailZhTw recipeDetail = _TranslationsRecipeDetailZhTw._(_root);
	@override late final _TranslationsFiltersZhTw filters = _TranslationsFiltersZhTw._(_root);
	@override late final _TranslationsShoppingListZhTw shoppingList = _TranslationsShoppingListZhTw._(_root);
	@override late final _TranslationsMealPlanZhTw mealPlan = _TranslationsMealPlanZhTw._(_root);
	@override late final _TranslationsInventoryZhTw inventory = _TranslationsInventoryZhTw._(_root);
	@override late final _TranslationsBarcodeScanZhTw barcodeScan = _TranslationsBarcodeScanZhTw._(_root);
	@override late final _TranslationsReceiptScanZhTw receiptScan = _TranslationsReceiptScanZhTw._(_root);
	@override late final _TranslationsBatchCookingZhTw batchCooking = _TranslationsBatchCookingZhTw._(_root);
	@override late final _TranslationsVisitedDomainsZhTw visitedDomains = _TranslationsVisitedDomainsZhTw._(_root);
	@override late final _TranslationsDomainDiscoveryZhTw domainDiscovery = _TranslationsDomainDiscoveryZhTw._(_root);
	@override late final _TranslationsInventorySuggestionsZhTw inventorySuggestions = _TranslationsInventorySuggestionsZhTw._(_root);
	@override late final _TranslationsUpgradeZhTw upgrade = _TranslationsUpgradeZhTw._(_root);
	@override late final _TranslationsTourZhTw tour = _TranslationsTourZhTw._(_root);
	@override late final _TranslationsManualRecipeZhTw manualRecipe = _TranslationsManualRecipeZhTw._(_root);
	@override late final _TranslationsRecipeEditZhTw recipeEdit = _TranslationsRecipeEditZhTw._(_root);
	@override late final _TranslationsErrorsZhTw errors = _TranslationsErrorsZhTw._(_root);
}

// Path: app
class _TranslationsAppZhTw extends TranslationsAppEn {
	_TranslationsAppZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsZhTw extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsZhTw measurements = _TranslationsSettingsMeasurementsZhTw._(_root);
	@override late final _TranslationsSettingsDataManagementZhTw dataManagement = _TranslationsSettingsDataManagementZhTw._(_root);
	@override late final _TranslationsSettingsVersionZhTw version = _TranslationsSettingsVersionZhTw._(_root);
}

// Path: recipes
class _TranslationsRecipesZhTw extends TranslationsRecipesEn {
	_TranslationsRecipesZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZhTw extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionZhTw nutrition = _TranslationsRecipeDetailNutritionZhTw._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadZhTw prepAhead = _TranslationsRecipeDetailPrepAheadZhTw._(_root);
...
// Path: filters
class _TranslationsFiltersZhTw extends TranslationsFiltersEn {
	_TranslationsFiltersZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListZhTw extends TranslationsShoppingListEn {
	_TranslationsShoppingListZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanZhTw extends TranslationsMealPlanEn {
	_TranslationsMealPlanZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryZhTw extends TranslationsInventoryEn {
	_TranslationsInventoryZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZhTw extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanZhTw extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingZhTw extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZhTw extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryZhTw extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsZhTw extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeZhTw extends TranslationsUpgradeEn {
	_TranslationsUpgradeZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourZhTw extends TranslationsTourEn {
	_TranslationsTourZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZhTw extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZhTw extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsZhTw extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricZhTw metric = _TranslationsSettingsMeasurementsMetricZhTw._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialZhTw imperial = _TranslationsSettingsMeasurementsImperialZhTw._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementZhTw extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionZhTw extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionZhTw extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadZhTw extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricZhTw extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialZhTw extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZhTw._(TranslationsZhTw root) : this._root = root, super.internal(root);
