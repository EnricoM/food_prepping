...
class TranslationsMr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesMr recipes = _TranslationsRecipesMr._(_root);
	@override late final _TranslationsRecipeDetailMr recipeDetail = _TranslationsRecipeDetailMr._(_root);
	@override late final _TranslationsFiltersMr filters = _TranslationsFiltersMr._(_root);
	@override late final _TranslationsShoppingListMr shoppingList = _TranslationsShoppingListMr._(_root);
	@override late final _TranslationsMealPlanMr mealPlan = _TranslationsMealPlanMr._(_root);
	@override late final _TranslationsInventoryMr inventory = _TranslationsInventoryMr._(_root);
	@override late final _TranslationsBarcodeScanMr barcodeScan = _TranslationsBarcodeScanMr._(_root);
	@override late final _TranslationsReceiptScanMr receiptScan = _TranslationsReceiptScanMr._(_root);
	@override late final _TranslationsBatchCookingMr batchCooking = _TranslationsBatchCookingMr._(_root);
	@override late final _TranslationsVisitedDomainsMr visitedDomains = _TranslationsVisitedDomainsMr._(_root);
	@override late final _TranslationsDomainDiscoveryMr domainDiscovery = _TranslationsDomainDiscoveryMr._(_root);
	@override late final _TranslationsInventorySuggestionsMr inventorySuggestions = _TranslationsInventorySuggestionsMr._(_root);
	@override late final _TranslationsUpgradeMr upgrade = _TranslationsUpgradeMr._(_root);
	@override late final _TranslationsTourMr tour = _TranslationsTourMr._(_root);
	@override late final _TranslationsManualRecipeMr manualRecipe = _TranslationsManualRecipeMr._(_root);
	@override late final _TranslationsRecipeEditMr recipeEdit = _TranslationsRecipeEditMr._(_root);
...
class _TranslationsSettingsMr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsMr measurements = _TranslationsSettingsMeasurementsMr._(_root);
	@override late final _TranslationsSettingsDataManagementMr dataManagement = _TranslationsSettingsDataManagementMr._(_root);
	@override late final _TranslationsSettingsVersionMr version = _TranslationsSettingsVersionMr._(_root);
}

// Path: recipes
class _TranslationsRecipesMr extends TranslationsRecipesEn {
	_TranslationsRecipesMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMr._(TranslationsMr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMr nutrition = _TranslationsRecipeDetailNutritionMr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMr prepAhead = _TranslationsRecipeDetailPrepAheadMr._(_root);
...
// Path: filters
class _TranslationsFiltersMr extends TranslationsFiltersEn {
	_TranslationsFiltersMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMr extends TranslationsShoppingListEn {
	_TranslationsShoppingListMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMr extends TranslationsMealPlanEn {
	_TranslationsMealPlanMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMr extends TranslationsInventoryEn {
	_TranslationsInventoryMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMr extends TranslationsUpgradeEn {
	_TranslationsUpgradeMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMr extends TranslationsTourEn {
	_TranslationsTourMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMr extends TranslationsErrorsEn {
	_TranslationsErrorsMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMr._(TranslationsMr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMr metric = _TranslationsSettingsMeasurementsMetricMr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMr imperial = _TranslationsSettingsMeasurementsImperialMr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMr._(TranslationsMr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMr._(TranslationsMr root) : this._root = root, super.internal(root);
