...
// Path: <root>
class TranslationsLt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	@override 
	TranslationsLt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLt app = _TranslationsAppLt._(_root);
	@override late final _TranslationsHomeLt home = _TranslationsHomeLt._(_root);
	@override late final _TranslationsCommonLt common = _TranslationsCommonLt._(_root);
	@override late final _TranslationsSettingsLt settings = _TranslationsSettingsLt._(_root);
	@override late final _TranslationsRecipesLt recipes = _TranslationsRecipesLt._(_root);
	@override late final _TranslationsRecipeDetailLt recipeDetail = _TranslationsRecipeDetailLt._(_root);
	@override late final _TranslationsFiltersLt filters = _TranslationsFiltersLt._(_root);
	@override late final _TranslationsShoppingListLt shoppingList = _TranslationsShoppingListLt._(_root);
	@override late final _TranslationsMealPlanLt mealPlan = _TranslationsMealPlanLt._(_root);
	@override late final _TranslationsInventoryLt inventory = _TranslationsInventoryLt._(_root);
	@override late final _TranslationsBarcodeScanLt barcodeScan = _TranslationsBarcodeScanLt._(_root);
	@override late final _TranslationsReceiptScanLt receiptScan = _TranslationsReceiptScanLt._(_root);
	@override late final _TranslationsBatchCookingLt batchCooking = _TranslationsBatchCookingLt._(_root);
	@override late final _TranslationsVisitedDomainsLt visitedDomains = _TranslationsVisitedDomainsLt._(_root);
	@override late final _TranslationsDomainDiscoveryLt domainDiscovery = _TranslationsDomainDiscoveryLt._(_root);
	@override late final _TranslationsInventorySuggestionsLt inventorySuggestions = _TranslationsInventorySuggestionsLt._(_root);
	@override late final _TranslationsUpgradeLt upgrade = _TranslationsUpgradeLt._(_root);
	@override late final _TranslationsTourLt tour = _TranslationsTourLt._(_root);
	@override late final _TranslationsManualRecipeLt manualRecipe = _TranslationsManualRecipeLt._(_root);
	@override late final _TranslationsRecipeEditLt recipeEdit = _TranslationsRecipeEditLt._(_root);
	@override late final _TranslationsErrorsLt errors = _TranslationsErrorsLt._(_root);
}

// Path: app
class _TranslationsAppLt extends TranslationsAppEn {
	_TranslationsAppLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeLt extends TranslationsHomeEn {
	_TranslationsHomeLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLt extends TranslationsCommonEn {
	_TranslationsCommonLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLt extends TranslationsSettingsEn {
	_TranslationsSettingsLt._(TranslationsLt root) : this._root = root, super.internal(root);

	final TranslationsLt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLt measurements = _TranslationsSettingsMeasurementsLt._(_root);
	@override late final _TranslationsSettingsDataManagementLt dataManagement = _TranslationsSettingsDataManagementLt._(_root);
	@override late final _TranslationsSettingsVersionLt version = _TranslationsSettingsVersionLt._(_root);
}

// Path: recipes
class _TranslationsRecipesLt extends TranslationsRecipesEn {
	_TranslationsRecipesLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLt._(TranslationsLt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLt nutrition = _TranslationsRecipeDetailNutritionLt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLt prepAhead = _TranslationsRecipeDetailPrepAheadLt._(_root);
...
// Path: filters
class _TranslationsFiltersLt extends TranslationsFiltersEn {
	_TranslationsFiltersLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLt extends TranslationsShoppingListEn {
	_TranslationsShoppingListLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLt extends TranslationsMealPlanEn {
	_TranslationsMealPlanLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLt extends TranslationsInventoryEn {
	_TranslationsInventoryLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLt extends TranslationsUpgradeEn {
	_TranslationsUpgradeLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLt extends TranslationsTourEn {
	_TranslationsTourLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLt._(TranslationsLt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLt metric = _TranslationsSettingsMeasurementsMetricLt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLt imperial = _TranslationsSettingsMeasurementsImperialLt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLt._(TranslationsLt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLt._(TranslationsLt root) : this._root = root, super.internal(root);
