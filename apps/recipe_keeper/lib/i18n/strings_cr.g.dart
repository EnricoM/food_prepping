...
// Path: <root>
class TranslationsCr extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCr({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <cr>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsCr _root = this; // ignore: unused_field

	@override 
	TranslationsCr $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCr(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCr app = _TranslationsAppCr._(_root);
	@override late final _TranslationsHomeCr home = _TranslationsHomeCr._(_root);
	@override late final _TranslationsCommonCr common = _TranslationsCommonCr._(_root);
	@override late final _TranslationsSettingsCr settings = _TranslationsSettingsCr._(_root);
	@override late final _TranslationsRecipesCr recipes = _TranslationsRecipesCr._(_root);
	@override late final _TranslationsRecipeDetailCr recipeDetail = _TranslationsRecipeDetailCr._(_root);
	@override late final _TranslationsFiltersCr filters = _TranslationsFiltersCr._(_root);
	@override late final _TranslationsShoppingListCr shoppingList = _TranslationsShoppingListCr._(_root);
	@override late final _TranslationsMealPlanCr mealPlan = _TranslationsMealPlanCr._(_root);
	@override late final _TranslationsInventoryCr inventory = _TranslationsInventoryCr._(_root);
	@override late final _TranslationsBarcodeScanCr barcodeScan = _TranslationsBarcodeScanCr._(_root);
	@override late final _TranslationsReceiptScanCr receiptScan = _TranslationsReceiptScanCr._(_root);
	@override late final _TranslationsBatchCookingCr batchCooking = _TranslationsBatchCookingCr._(_root);
	@override late final _TranslationsVisitedDomainsCr visitedDomains = _TranslationsVisitedDomainsCr._(_root);
	@override late final _TranslationsDomainDiscoveryCr domainDiscovery = _TranslationsDomainDiscoveryCr._(_root);
	@override late final _TranslationsInventorySuggestionsCr inventorySuggestions = _TranslationsInventorySuggestionsCr._(_root);
	@override late final _TranslationsUpgradeCr upgrade = _TranslationsUpgradeCr._(_root);
	@override late final _TranslationsTourCr tour = _TranslationsTourCr._(_root);
	@override late final _TranslationsManualRecipeCr manualRecipe = _TranslationsManualRecipeCr._(_root);
	@override late final _TranslationsRecipeEditCr recipeEdit = _TranslationsRecipeEditCr._(_root);
	@override late final _TranslationsErrorsCr errors = _TranslationsErrorsCr._(_root);
}

// Path: app
class _TranslationsAppCr extends TranslationsAppEn {
	_TranslationsAppCr._(TranslationsCr root) : this._root = root, super.internal(root);

	final TranslationsCr _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeCr extends TranslationsHomeEn {
	_TranslationsHomeCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCr extends TranslationsCommonEn {
	_TranslationsCommonCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCr extends TranslationsSettingsEn {
	_TranslationsSettingsCr._(TranslationsCr root) : this._root = root, super.internal(root);

	final TranslationsCr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCr measurements = _TranslationsSettingsMeasurementsCr._(_root);
	@override late final _TranslationsSettingsDataManagementCr dataManagement = _TranslationsSettingsDataManagementCr._(_root);
	@override late final _TranslationsSettingsVersionCr version = _TranslationsSettingsVersionCr._(_root);
}

// Path: recipes
class _TranslationsRecipesCr extends TranslationsRecipesEn {
	_TranslationsRecipesCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCr._(TranslationsCr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCr nutrition = _TranslationsRecipeDetailNutritionCr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCr prepAhead = _TranslationsRecipeDetailPrepAheadCr._(_root);
...
// Path: filters
class _TranslationsFiltersCr extends TranslationsFiltersEn {
	_TranslationsFiltersCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCr extends TranslationsShoppingListEn {
	_TranslationsShoppingListCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCr extends TranslationsMealPlanEn {
	_TranslationsMealPlanCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCr extends TranslationsInventoryEn {
	_TranslationsInventoryCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCr extends TranslationsUpgradeEn {
	_TranslationsUpgradeCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCr extends TranslationsTourEn {
	_TranslationsTourCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCr extends TranslationsErrorsEn {
	_TranslationsErrorsCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCr._(TranslationsCr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCr metric = _TranslationsSettingsMeasurementsMetricCr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCr imperial = _TranslationsSettingsMeasurementsImperialCr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCr._(TranslationsCr root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <cr>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsCr {
