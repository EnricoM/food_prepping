...
// Path: <root>
class TranslationsZuZa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsZuZa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.zuZa,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <zu-ZA>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsZuZa _root = this; // ignore: unused_field

	@override 
	TranslationsZuZa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsZuZa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppZuZa app = _TranslationsAppZuZa._(_root);
	@override late final _TranslationsHomeZuZa home = _TranslationsHomeZuZa._(_root);
	@override late final _TranslationsCommonZuZa common = _TranslationsCommonZuZa._(_root);
	@override late final _TranslationsSettingsZuZa settings = _TranslationsSettingsZuZa._(_root);
	@override late final _TranslationsRecipesZuZa recipes = _TranslationsRecipesZuZa._(_root);
	@override late final _TranslationsRecipeDetailZuZa recipeDetail = _TranslationsRecipeDetailZuZa._(_root);
	@override late final _TranslationsFiltersZuZa filters = _TranslationsFiltersZuZa._(_root);
	@override late final _TranslationsShoppingListZuZa shoppingList = _TranslationsShoppingListZuZa._(_root);
	@override late final _TranslationsMealPlanZuZa mealPlan = _TranslationsMealPlanZuZa._(_root);
	@override late final _TranslationsInventoryZuZa inventory = _TranslationsInventoryZuZa._(_root);
	@override late final _TranslationsBarcodeScanZuZa barcodeScan = _TranslationsBarcodeScanZuZa._(_root);
	@override late final _TranslationsReceiptScanZuZa receiptScan = _TranslationsReceiptScanZuZa._(_root);
	@override late final _TranslationsBatchCookingZuZa batchCooking = _TranslationsBatchCookingZuZa._(_root);
	@override late final _TranslationsVisitedDomainsZuZa visitedDomains = _TranslationsVisitedDomainsZuZa._(_root);
	@override late final _TranslationsDomainDiscoveryZuZa domainDiscovery = _TranslationsDomainDiscoveryZuZa._(_root);
	@override late final _TranslationsInventorySuggestionsZuZa inventorySuggestions = _TranslationsInventorySuggestionsZuZa._(_root);
	@override late final _TranslationsUpgradeZuZa upgrade = _TranslationsUpgradeZuZa._(_root);
	@override late final _TranslationsTourZuZa tour = _TranslationsTourZuZa._(_root);
	@override late final _TranslationsManualRecipeZuZa manualRecipe = _TranslationsManualRecipeZuZa._(_root);
	@override late final _TranslationsRecipeEditZuZa recipeEdit = _TranslationsRecipeEditZuZa._(_root);
	@override late final _TranslationsErrorsZuZa errors = _TranslationsErrorsZuZa._(_root);
}

// Path: app
class _TranslationsAppZuZa extends TranslationsAppEn {
	_TranslationsAppZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);

	final TranslationsZuZa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeZuZa extends TranslationsHomeEn {
	_TranslationsHomeZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonZuZa extends TranslationsCommonEn {
	_TranslationsCommonZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsZuZa extends TranslationsSettingsEn {
	_TranslationsSettingsZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);

	final TranslationsZuZa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsZuZa measurements = _TranslationsSettingsMeasurementsZuZa._(_root);
	@override late final _TranslationsSettingsDataManagementZuZa dataManagement = _TranslationsSettingsDataManagementZuZa._(_root);
	@override late final _TranslationsSettingsVersionZuZa version = _TranslationsSettingsVersionZuZa._(_root);
}

// Path: recipes
class _TranslationsRecipesZuZa extends TranslationsRecipesEn {
	_TranslationsRecipesZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZuZa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionZuZa nutrition = _TranslationsRecipeDetailNutritionZuZa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadZuZa prepAhead = _TranslationsRecipeDetailPrepAheadZuZa._(_root);
...
// Path: filters
class _TranslationsFiltersZuZa extends TranslationsFiltersEn {
	_TranslationsFiltersZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListZuZa extends TranslationsShoppingListEn {
	_TranslationsShoppingListZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanZuZa extends TranslationsMealPlanEn {
	_TranslationsMealPlanZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryZuZa extends TranslationsInventoryEn {
	_TranslationsInventoryZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZuZa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanZuZa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingZuZa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZuZa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryZuZa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsZuZa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeZuZa extends TranslationsUpgradeEn {
	_TranslationsUpgradeZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourZuZa extends TranslationsTourEn {
	_TranslationsTourZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZuZa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZuZa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsZuZa extends TranslationsErrorsEn {
	_TranslationsErrorsZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsZuZa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricZuZa metric = _TranslationsSettingsMeasurementsMetricZuZa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialZuZa imperial = _TranslationsSettingsMeasurementsImperialZuZa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementZuZa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionZuZa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionZuZa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadZuZa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricZuZa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialZuZa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZuZa._(TranslationsZuZa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <zu-ZA>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsZuZa {
