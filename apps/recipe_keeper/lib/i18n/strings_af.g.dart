...
// Path: <root>
class TranslationsAf extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppAf app = _TranslationsAppAf._(_root);
	@override late final _TranslationsHomeAf home = _TranslationsHomeAf._(_root);
	@override late final _TranslationsCommonAf common = _TranslationsCommonAf._(_root);
	@override late final _TranslationsSettingsAf settings = _TranslationsSettingsAf._(_root);
	@override late final _TranslationsRecipesAf recipes = _TranslationsRecipesAf._(_root);
	@override late final _TranslationsRecipeDetailAf recipeDetail = _TranslationsRecipeDetailAf._(_root);
	@override late final _TranslationsFiltersAf filters = _TranslationsFiltersAf._(_root);
	@override late final _TranslationsShoppingListAf shoppingList = _TranslationsShoppingListAf._(_root);
	@override late final _TranslationsMealPlanAf mealPlan = _TranslationsMealPlanAf._(_root);
	@override late final _TranslationsInventoryAf inventory = _TranslationsInventoryAf._(_root);
	@override late final _TranslationsBarcodeScanAf barcodeScan = _TranslationsBarcodeScanAf._(_root);
	@override late final _TranslationsReceiptScanAf receiptScan = _TranslationsReceiptScanAf._(_root);
	@override late final _TranslationsBatchCookingAf batchCooking = _TranslationsBatchCookingAf._(_root);
	@override late final _TranslationsVisitedDomainsAf visitedDomains = _TranslationsVisitedDomainsAf._(_root);
	@override late final _TranslationsDomainDiscoveryAf domainDiscovery = _TranslationsDomainDiscoveryAf._(_root);
	@override late final _TranslationsInventorySuggestionsAf inventorySuggestions = _TranslationsInventorySuggestionsAf._(_root);
	@override late final _TranslationsUpgradeAf upgrade = _TranslationsUpgradeAf._(_root);
	@override late final _TranslationsTourAf tour = _TranslationsTourAf._(_root);
	@override late final _TranslationsManualRecipeAf manualRecipe = _TranslationsManualRecipeAf._(_root);
	@override late final _TranslationsRecipeEditAf recipeEdit = _TranslationsRecipeEditAf._(_root);
	@override late final _TranslationsErrorsAf errors = _TranslationsErrorsAf._(_root);
}

// Path: app
class _TranslationsAppAf extends TranslationsAppEn {
	_TranslationsAppAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeAf extends TranslationsHomeEn {
	_TranslationsHomeAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAf extends TranslationsCommonEn {
	_TranslationsCommonAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsAf extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsAf measurements = _TranslationsSettingsMeasurementsAf._(_root);
	@override late final _TranslationsSettingsDataManagementAf dataManagement = _TranslationsSettingsDataManagementAf._(_root);
	@override late final _TranslationsSettingsVersionAf version = _TranslationsSettingsVersionAf._(_root);
}

// Path: recipes
class _TranslationsRecipesAf extends TranslationsRecipesEn {
	_TranslationsRecipesAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAf extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAf._(TranslationsAf root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAf nutrition = _TranslationsRecipeDetailNutritionAf._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAf prepAhead = _TranslationsRecipeDetailPrepAheadAf._(_root);
...
// Path: filters
class _TranslationsFiltersAf extends TranslationsFiltersEn {
	_TranslationsFiltersAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAf extends TranslationsShoppingListEn {
	_TranslationsShoppingListAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAf extends TranslationsMealPlanEn {
	_TranslationsMealPlanAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAf extends TranslationsInventoryEn {
	_TranslationsInventoryAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAf extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAf extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAf extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAf extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAf extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAf extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAf extends TranslationsUpgradeEn {
	_TranslationsUpgradeAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAf extends TranslationsTourEn {
	_TranslationsTourAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAf extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAf extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAf extends TranslationsErrorsEn {
	_TranslationsErrorsAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAf extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAf._(TranslationsAf root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAf metric = _TranslationsSettingsMeasurementsMetricAf._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAf imperial = _TranslationsSettingsMeasurementsImperialAf._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAf extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAf extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAf extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAf extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAf extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAf._(TranslationsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAf extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAf._(TranslationsAf root) : this._root = root, super.internal(root);
