...
class TranslationsPt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesPt recipes = _TranslationsRecipesPt._(_root);
	@override late final _TranslationsRecipeDetailPt recipeDetail = _TranslationsRecipeDetailPt._(_root);
	@override late final _TranslationsFiltersPt filters = _TranslationsFiltersPt._(_root);
	@override late final _TranslationsShoppingListPt shoppingList = _TranslationsShoppingListPt._(_root);
	@override late final _TranslationsMealPlanPt mealPlan = _TranslationsMealPlanPt._(_root);
	@override late final _TranslationsInventoryPt inventory = _TranslationsInventoryPt._(_root);
	@override late final _TranslationsBarcodeScanPt barcodeScan = _TranslationsBarcodeScanPt._(_root);
	@override late final _TranslationsReceiptScanPt receiptScan = _TranslationsReceiptScanPt._(_root);
	@override late final _TranslationsBatchCookingPt batchCooking = _TranslationsBatchCookingPt._(_root);
	@override late final _TranslationsVisitedDomainsPt visitedDomains = _TranslationsVisitedDomainsPt._(_root);
	@override late final _TranslationsDomainDiscoveryPt domainDiscovery = _TranslationsDomainDiscoveryPt._(_root);
	@override late final _TranslationsInventorySuggestionsPt inventorySuggestions = _TranslationsInventorySuggestionsPt._(_root);
	@override late final _TranslationsUpgradePt upgrade = _TranslationsUpgradePt._(_root);
	@override late final _TranslationsTourPt tour = _TranslationsTourPt._(_root);
	@override late final _TranslationsManualRecipePt manualRecipe = _TranslationsManualRecipePt._(_root);
	@override late final _TranslationsRecipeEditPt recipeEdit = _TranslationsRecipeEditPt._(_root);
...
class _TranslationsSettingsPt extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsPt measurements = _TranslationsSettingsMeasurementsPt._(_root);
	@override late final _TranslationsSettingsDataManagementPt dataManagement = _TranslationsSettingsDataManagementPt._(_root);
	@override late final _TranslationsSettingsVersionPt version = _TranslationsSettingsVersionPt._(_root);
}

// Path: recipes
class _TranslationsRecipesPt extends TranslationsRecipesEn {
	_TranslationsRecipesPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPt._(TranslationsPt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPt nutrition = _TranslationsRecipeDetailNutritionPt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPt prepAhead = _TranslationsRecipeDetailPrepAheadPt._(_root);
...
// Path: filters
class _TranslationsFiltersPt extends TranslationsFiltersEn {
	_TranslationsFiltersPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPt extends TranslationsShoppingListEn {
	_TranslationsShoppingListPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPt extends TranslationsMealPlanEn {
	_TranslationsMealPlanPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPt extends TranslationsInventoryEn {
	_TranslationsInventoryPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePt extends TranslationsUpgradeEn {
	_TranslationsUpgradePt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPt extends TranslationsTourEn {
	_TranslationsTourPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePt._(TranslationsPt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPt._(TranslationsPt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPt metric = _TranslationsSettingsMeasurementsMetricPt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPt imperial = _TranslationsSettingsMeasurementsImperialPt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPt._(TranslationsPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPt._(TranslationsPt root) : this._root = root, super.internal(root);
