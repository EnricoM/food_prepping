...
// Path: <root>
class TranslationsSwTz extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSwTz({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.swTz,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <sw-TZ>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSwTz _root = this; // ignore: unused_field

	@override 
	TranslationsSwTz $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSwTz(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSwTz app = _TranslationsAppSwTz._(_root);
	@override late final _TranslationsHomeSwTz home = _TranslationsHomeSwTz._(_root);
	@override late final _TranslationsCommonSwTz common = _TranslationsCommonSwTz._(_root);
	@override late final _TranslationsSettingsSwTz settings = _TranslationsSettingsSwTz._(_root);
	@override late final _TranslationsRecipesSwTz recipes = _TranslationsRecipesSwTz._(_root);
	@override late final _TranslationsRecipeDetailSwTz recipeDetail = _TranslationsRecipeDetailSwTz._(_root);
	@override late final _TranslationsFiltersSwTz filters = _TranslationsFiltersSwTz._(_root);
	@override late final _TranslationsShoppingListSwTz shoppingList = _TranslationsShoppingListSwTz._(_root);
	@override late final _TranslationsMealPlanSwTz mealPlan = _TranslationsMealPlanSwTz._(_root);
	@override late final _TranslationsInventorySwTz inventory = _TranslationsInventorySwTz._(_root);
	@override late final _TranslationsBarcodeScanSwTz barcodeScan = _TranslationsBarcodeScanSwTz._(_root);
	@override late final _TranslationsReceiptScanSwTz receiptScan = _TranslationsReceiptScanSwTz._(_root);
	@override late final _TranslationsBatchCookingSwTz batchCooking = _TranslationsBatchCookingSwTz._(_root);
	@override late final _TranslationsVisitedDomainsSwTz visitedDomains = _TranslationsVisitedDomainsSwTz._(_root);
	@override late final _TranslationsDomainDiscoverySwTz domainDiscovery = _TranslationsDomainDiscoverySwTz._(_root);
	@override late final _TranslationsInventorySuggestionsSwTz inventorySuggestions = _TranslationsInventorySuggestionsSwTz._(_root);
	@override late final _TranslationsUpgradeSwTz upgrade = _TranslationsUpgradeSwTz._(_root);
	@override late final _TranslationsTourSwTz tour = _TranslationsTourSwTz._(_root);
	@override late final _TranslationsManualRecipeSwTz manualRecipe = _TranslationsManualRecipeSwTz._(_root);
	@override late final _TranslationsRecipeEditSwTz recipeEdit = _TranslationsRecipeEditSwTz._(_root);
	@override late final _TranslationsErrorsSwTz errors = _TranslationsErrorsSwTz._(_root);
}

// Path: app
class _TranslationsAppSwTz extends TranslationsAppEn {
	_TranslationsAppSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);

	final TranslationsSwTz _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSwTz extends TranslationsHomeEn {
	_TranslationsHomeSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSwTz extends TranslationsCommonEn {
	_TranslationsCommonSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSwTz extends TranslationsSettingsEn {
	_TranslationsSettingsSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);

	final TranslationsSwTz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSwTz measurements = _TranslationsSettingsMeasurementsSwTz._(_root);
	@override late final _TranslationsSettingsDataManagementSwTz dataManagement = _TranslationsSettingsDataManagementSwTz._(_root);
	@override late final _TranslationsSettingsVersionSwTz version = _TranslationsSettingsVersionSwTz._(_root);
}

// Path: recipes
class _TranslationsRecipesSwTz extends TranslationsRecipesEn {
	_TranslationsRecipesSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSwTz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSwTz nutrition = _TranslationsRecipeDetailNutritionSwTz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSwTz prepAhead = _TranslationsRecipeDetailPrepAheadSwTz._(_root);
...
// Path: filters
class _TranslationsFiltersSwTz extends TranslationsFiltersEn {
	_TranslationsFiltersSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSwTz extends TranslationsShoppingListEn {
	_TranslationsShoppingListSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSwTz extends TranslationsMealPlanEn {
	_TranslationsMealPlanSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySwTz extends TranslationsInventoryEn {
	_TranslationsInventorySwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSwTz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSwTz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSwTz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSwTz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySwTz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSwTz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSwTz extends TranslationsUpgradeEn {
	_TranslationsUpgradeSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSwTz extends TranslationsTourEn {
	_TranslationsTourSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSwTz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSwTz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSwTz extends TranslationsErrorsEn {
	_TranslationsErrorsSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSwTz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSwTz metric = _TranslationsSettingsMeasurementsMetricSwTz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSwTz imperial = _TranslationsSettingsMeasurementsImperialSwTz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSwTz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSwTz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSwTz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSwTz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSwTz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSwTz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSwTz._(TranslationsSwTz root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sw-TZ>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSwTz {
