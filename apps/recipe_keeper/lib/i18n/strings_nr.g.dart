...
// Path: <root>
class TranslationsNr extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNr({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <nr>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNr _root = this; // ignore: unused_field

	@override 
	TranslationsNr $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNr(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNr app = _TranslationsAppNr._(_root);
	@override late final _TranslationsHomeNr home = _TranslationsHomeNr._(_root);
	@override late final _TranslationsCommonNr common = _TranslationsCommonNr._(_root);
	@override late final _TranslationsSettingsNr settings = _TranslationsSettingsNr._(_root);
	@override late final _TranslationsRecipesNr recipes = _TranslationsRecipesNr._(_root);
	@override late final _TranslationsRecipeDetailNr recipeDetail = _TranslationsRecipeDetailNr._(_root);
	@override late final _TranslationsFiltersNr filters = _TranslationsFiltersNr._(_root);
	@override late final _TranslationsShoppingListNr shoppingList = _TranslationsShoppingListNr._(_root);
	@override late final _TranslationsMealPlanNr mealPlan = _TranslationsMealPlanNr._(_root);
	@override late final _TranslationsInventoryNr inventory = _TranslationsInventoryNr._(_root);
	@override late final _TranslationsBarcodeScanNr barcodeScan = _TranslationsBarcodeScanNr._(_root);
	@override late final _TranslationsReceiptScanNr receiptScan = _TranslationsReceiptScanNr._(_root);
	@override late final _TranslationsBatchCookingNr batchCooking = _TranslationsBatchCookingNr._(_root);
	@override late final _TranslationsVisitedDomainsNr visitedDomains = _TranslationsVisitedDomainsNr._(_root);
	@override late final _TranslationsDomainDiscoveryNr domainDiscovery = _TranslationsDomainDiscoveryNr._(_root);
	@override late final _TranslationsInventorySuggestionsNr inventorySuggestions = _TranslationsInventorySuggestionsNr._(_root);
	@override late final _TranslationsUpgradeNr upgrade = _TranslationsUpgradeNr._(_root);
	@override late final _TranslationsTourNr tour = _TranslationsTourNr._(_root);
	@override late final _TranslationsManualRecipeNr manualRecipe = _TranslationsManualRecipeNr._(_root);
	@override late final _TranslationsRecipeEditNr recipeEdit = _TranslationsRecipeEditNr._(_root);
	@override late final _TranslationsErrorsNr errors = _TranslationsErrorsNr._(_root);
}

// Path: app
class _TranslationsAppNr extends TranslationsAppEn {
	_TranslationsAppNr._(TranslationsNr root) : this._root = root, super.internal(root);

	final TranslationsNr _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNr extends TranslationsHomeEn {
	_TranslationsHomeNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNr extends TranslationsCommonEn {
	_TranslationsCommonNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNr extends TranslationsSettingsEn {
	_TranslationsSettingsNr._(TranslationsNr root) : this._root = root, super.internal(root);

	final TranslationsNr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNr measurements = _TranslationsSettingsMeasurementsNr._(_root);
	@override late final _TranslationsSettingsDataManagementNr dataManagement = _TranslationsSettingsDataManagementNr._(_root);
	@override late final _TranslationsSettingsVersionNr version = _TranslationsSettingsVersionNr._(_root);
}

// Path: recipes
class _TranslationsRecipesNr extends TranslationsRecipesEn {
	_TranslationsRecipesNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNr._(TranslationsNr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNr nutrition = _TranslationsRecipeDetailNutritionNr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNr prepAhead = _TranslationsRecipeDetailPrepAheadNr._(_root);
...
// Path: filters
class _TranslationsFiltersNr extends TranslationsFiltersEn {
	_TranslationsFiltersNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNr extends TranslationsShoppingListEn {
	_TranslationsShoppingListNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNr extends TranslationsMealPlanEn {
	_TranslationsMealPlanNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNr extends TranslationsInventoryEn {
	_TranslationsInventoryNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNr extends TranslationsUpgradeEn {
	_TranslationsUpgradeNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNr extends TranslationsTourEn {
	_TranslationsTourNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNr extends TranslationsErrorsEn {
	_TranslationsErrorsNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNr._(TranslationsNr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNr metric = _TranslationsSettingsMeasurementsMetricNr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNr imperial = _TranslationsSettingsMeasurementsImperialNr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNr._(TranslationsNr root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <nr>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNr {
