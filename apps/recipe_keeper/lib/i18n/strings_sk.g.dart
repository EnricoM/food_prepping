...
class TranslationsSk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppSk app = _TranslationsAppSk._(_root);
	@override late final _TranslationsHomeSk home = _TranslationsHomeSk._(_root);
	@override late final _TranslationsCommonSk common = _TranslationsCommonSk._(_root);
	@override late final _TranslationsSettingsSk settings = _TranslationsSettingsSk._(_root);
	@override late final _TranslationsRecipesSk recipes = _TranslationsRecipesSk._(_root);
	@override late final _TranslationsRecipeDetailSk recipeDetail = _TranslationsRecipeDetailSk._(_root);
	@override late final _TranslationsFiltersSk filters = _TranslationsFiltersSk._(_root);
	@override late final _TranslationsShoppingListSk shoppingList = _TranslationsShoppingListSk._(_root);
	@override late final _TranslationsMealPlanSk mealPlan = _TranslationsMealPlanSk._(_root);
	@override late final _TranslationsInventorySk inventory = _TranslationsInventorySk._(_root);
	@override late final _TranslationsBarcodeScanSk barcodeScan = _TranslationsBarcodeScanSk._(_root);
	@override late final _TranslationsReceiptScanSk receiptScan = _TranslationsReceiptScanSk._(_root);
	@override late final _TranslationsBatchCookingSk batchCooking = _TranslationsBatchCookingSk._(_root);
	@override late final _TranslationsVisitedDomainsSk visitedDomains = _TranslationsVisitedDomainsSk._(_root);
	@override late final _TranslationsDomainDiscoverySk domainDiscovery = _TranslationsDomainDiscoverySk._(_root);
	@override late final _TranslationsInventorySuggestionsSk inventorySuggestions = _TranslationsInventorySuggestionsSk._(_root);
	@override late final _TranslationsUpgradeSk upgrade = _TranslationsUpgradeSk._(_root);
	@override late final _TranslationsTourSk tour = _TranslationsTourSk._(_root);
	@override late final _TranslationsManualRecipeSk manualRecipe = _TranslationsManualRecipeSk._(_root);
	@override late final _TranslationsRecipeEditSk recipeEdit = _TranslationsRecipeEditSk._(_root);
	@override late final _TranslationsErrorsSk errors = _TranslationsErrorsSk._(_root);
}

// Path: app
class _TranslationsAppSk extends TranslationsAppEn {
	_TranslationsAppSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeSk extends TranslationsHomeEn {
	_TranslationsHomeSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSk extends TranslationsCommonEn {
	_TranslationsCommonSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSk extends TranslationsSettingsEn {
	_TranslationsSettingsSk._(TranslationsSk root) : this._root = root, super.internal(root);

	final TranslationsSk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSk measurements = _TranslationsSettingsMeasurementsSk._(_root);
	@override late final _TranslationsSettingsDataManagementSk dataManagement = _TranslationsSettingsDataManagementSk._(_root);
	@override late final _TranslationsSettingsVersionSk version = _TranslationsSettingsVersionSk._(_root);
}

// Path: recipes
class _TranslationsRecipesSk extends TranslationsRecipesEn {
	_TranslationsRecipesSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSk._(TranslationsSk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSk nutrition = _TranslationsRecipeDetailNutritionSk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSk prepAhead = _TranslationsRecipeDetailPrepAheadSk._(_root);
...
// Path: filters
class _TranslationsFiltersSk extends TranslationsFiltersEn {
	_TranslationsFiltersSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSk extends TranslationsShoppingListEn {
	_TranslationsShoppingListSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSk extends TranslationsMealPlanEn {
	_TranslationsMealPlanSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySk extends TranslationsInventoryEn {
	_TranslationsInventorySk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSk extends TranslationsUpgradeEn {
	_TranslationsUpgradeSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSk extends TranslationsTourEn {
	_TranslationsTourSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSk._(TranslationsSk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSk metric = _TranslationsSettingsMeasurementsMetricSk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSk imperial = _TranslationsSettingsMeasurementsImperialSk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSk._(TranslationsSk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSk._(TranslationsSk root) : this._root = root, super.internal(root);
