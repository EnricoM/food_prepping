...
// Path: <root>
class TranslationsFj extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsFj({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <fj>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsFj _root = this; // ignore: unused_field

	@override 
	TranslationsFj $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsFj(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppFj app = _TranslationsAppFj._(_root);
	@override late final _TranslationsHomeFj home = _TranslationsHomeFj._(_root);
	@override late final _TranslationsCommonFj common = _TranslationsCommonFj._(_root);
	@override late final _TranslationsSettingsFj settings = _TranslationsSettingsFj._(_root);
	@override late final _TranslationsRecipesFj recipes = _TranslationsRecipesFj._(_root);
	@override late final _TranslationsRecipeDetailFj recipeDetail = _TranslationsRecipeDetailFj._(_root);
	@override late final _TranslationsFiltersFj filters = _TranslationsFiltersFj._(_root);
	@override late final _TranslationsShoppingListFj shoppingList = _TranslationsShoppingListFj._(_root);
	@override late final _TranslationsMealPlanFj mealPlan = _TranslationsMealPlanFj._(_root);
	@override late final _TranslationsInventoryFj inventory = _TranslationsInventoryFj._(_root);
	@override late final _TranslationsBarcodeScanFj barcodeScan = _TranslationsBarcodeScanFj._(_root);
	@override late final _TranslationsReceiptScanFj receiptScan = _TranslationsReceiptScanFj._(_root);
	@override late final _TranslationsBatchCookingFj batchCooking = _TranslationsBatchCookingFj._(_root);
	@override late final _TranslationsVisitedDomainsFj visitedDomains = _TranslationsVisitedDomainsFj._(_root);
	@override late final _TranslationsDomainDiscoveryFj domainDiscovery = _TranslationsDomainDiscoveryFj._(_root);
	@override late final _TranslationsInventorySuggestionsFj inventorySuggestions = _TranslationsInventorySuggestionsFj._(_root);
	@override late final _TranslationsUpgradeFj upgrade = _TranslationsUpgradeFj._(_root);
	@override late final _TranslationsTourFj tour = _TranslationsTourFj._(_root);
	@override late final _TranslationsManualRecipeFj manualRecipe = _TranslationsManualRecipeFj._(_root);
	@override late final _TranslationsRecipeEditFj recipeEdit = _TranslationsRecipeEditFj._(_root);
	@override late final _TranslationsErrorsFj errors = _TranslationsErrorsFj._(_root);
}

// Path: app
class _TranslationsAppFj extends TranslationsAppEn {
	_TranslationsAppFj._(TranslationsFj root) : this._root = root, super.internal(root);

	final TranslationsFj _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeFj extends TranslationsHomeEn {
	_TranslationsHomeFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonFj extends TranslationsCommonEn {
	_TranslationsCommonFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsFj extends TranslationsSettingsEn {
	_TranslationsSettingsFj._(TranslationsFj root) : this._root = root, super.internal(root);

	final TranslationsFj _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsFj measurements = _TranslationsSettingsMeasurementsFj._(_root);
	@override late final _TranslationsSettingsDataManagementFj dataManagement = _TranslationsSettingsDataManagementFj._(_root);
	@override late final _TranslationsSettingsVersionFj version = _TranslationsSettingsVersionFj._(_root);
}

// Path: recipes
class _TranslationsRecipesFj extends TranslationsRecipesEn {
	_TranslationsRecipesFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFj extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFj._(TranslationsFj root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFj nutrition = _TranslationsRecipeDetailNutritionFj._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFj prepAhead = _TranslationsRecipeDetailPrepAheadFj._(_root);
...
// Path: filters
class _TranslationsFiltersFj extends TranslationsFiltersEn {
	_TranslationsFiltersFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFj extends TranslationsShoppingListEn {
	_TranslationsShoppingListFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFj extends TranslationsMealPlanEn {
	_TranslationsMealPlanFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFj extends TranslationsInventoryEn {
	_TranslationsInventoryFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFj extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFj extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFj extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFj extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFj extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFj extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFj extends TranslationsUpgradeEn {
	_TranslationsUpgradeFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFj extends TranslationsTourEn {
	_TranslationsTourFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFj extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFj extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsFj extends TranslationsErrorsEn {
	_TranslationsErrorsFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFj extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFj._(TranslationsFj root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFj metric = _TranslationsSettingsMeasurementsMetricFj._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFj imperial = _TranslationsSettingsMeasurementsImperialFj._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFj extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFj extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFj extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFj extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFj extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFj extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFj._(TranslationsFj root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <fj>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsFj {
