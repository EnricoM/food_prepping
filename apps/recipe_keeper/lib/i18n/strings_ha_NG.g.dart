...
// Path: <root>
class TranslationsHaNg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsHaNg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.haNg,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ha-NG>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsHaNg _root = this; // ignore: unused_field

	@override 
	TranslationsHaNg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsHaNg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppHaNg app = _TranslationsAppHaNg._(_root);
	@override late final _TranslationsHomeHaNg home = _TranslationsHomeHaNg._(_root);
	@override late final _TranslationsCommonHaNg common = _TranslationsCommonHaNg._(_root);
	@override late final _TranslationsSettingsHaNg settings = _TranslationsSettingsHaNg._(_root);
	@override late final _TranslationsRecipesHaNg recipes = _TranslationsRecipesHaNg._(_root);
	@override late final _TranslationsRecipeDetailHaNg recipeDetail = _TranslationsRecipeDetailHaNg._(_root);
	@override late final _TranslationsFiltersHaNg filters = _TranslationsFiltersHaNg._(_root);
	@override late final _TranslationsShoppingListHaNg shoppingList = _TranslationsShoppingListHaNg._(_root);
	@override late final _TranslationsMealPlanHaNg mealPlan = _TranslationsMealPlanHaNg._(_root);
	@override late final _TranslationsInventoryHaNg inventory = _TranslationsInventoryHaNg._(_root);
	@override late final _TranslationsBarcodeScanHaNg barcodeScan = _TranslationsBarcodeScanHaNg._(_root);
	@override late final _TranslationsReceiptScanHaNg receiptScan = _TranslationsReceiptScanHaNg._(_root);
	@override late final _TranslationsBatchCookingHaNg batchCooking = _TranslationsBatchCookingHaNg._(_root);
	@override late final _TranslationsVisitedDomainsHaNg visitedDomains = _TranslationsVisitedDomainsHaNg._(_root);
	@override late final _TranslationsDomainDiscoveryHaNg domainDiscovery = _TranslationsDomainDiscoveryHaNg._(_root);
	@override late final _TranslationsInventorySuggestionsHaNg inventorySuggestions = _TranslationsInventorySuggestionsHaNg._(_root);
	@override late final _TranslationsUpgradeHaNg upgrade = _TranslationsUpgradeHaNg._(_root);
	@override late final _TranslationsTourHaNg tour = _TranslationsTourHaNg._(_root);
	@override late final _TranslationsManualRecipeHaNg manualRecipe = _TranslationsManualRecipeHaNg._(_root);
	@override late final _TranslationsRecipeEditHaNg recipeEdit = _TranslationsRecipeEditHaNg._(_root);
	@override late final _TranslationsErrorsHaNg errors = _TranslationsErrorsHaNg._(_root);
}

// Path: app
class _TranslationsAppHaNg extends TranslationsAppEn {
	_TranslationsAppHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);

	final TranslationsHaNg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeHaNg extends TranslationsHomeEn {
	_TranslationsHomeHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHaNg extends TranslationsCommonEn {
	_TranslationsCommonHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHaNg extends TranslationsSettingsEn {
	_TranslationsSettingsHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);

	final TranslationsHaNg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHaNg measurements = _TranslationsSettingsMeasurementsHaNg._(_root);
	@override late final _TranslationsSettingsDataManagementHaNg dataManagement = _TranslationsSettingsDataManagementHaNg._(_root);
	@override late final _TranslationsSettingsVersionHaNg version = _TranslationsSettingsVersionHaNg._(_root);
}

// Path: recipes
class _TranslationsRecipesHaNg extends TranslationsRecipesEn {
	_TranslationsRecipesHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHaNg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHaNg nutrition = _TranslationsRecipeDetailNutritionHaNg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHaNg prepAhead = _TranslationsRecipeDetailPrepAheadHaNg._(_root);
...
// Path: filters
class _TranslationsFiltersHaNg extends TranslationsFiltersEn {
	_TranslationsFiltersHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHaNg extends TranslationsShoppingListEn {
	_TranslationsShoppingListHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHaNg extends TranslationsMealPlanEn {
	_TranslationsMealPlanHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHaNg extends TranslationsInventoryEn {
	_TranslationsInventoryHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHaNg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHaNg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHaNg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHaNg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHaNg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHaNg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHaNg extends TranslationsUpgradeEn {
	_TranslationsUpgradeHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHaNg extends TranslationsTourEn {
	_TranslationsTourHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHaNg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHaNg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsHaNg extends TranslationsErrorsEn {
	_TranslationsErrorsHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHaNg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHaNg metric = _TranslationsSettingsMeasurementsMetricHaNg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHaNg imperial = _TranslationsSettingsMeasurementsImperialHaNg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHaNg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHaNg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHaNg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHaNg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHaNg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHaNg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHaNg._(TranslationsHaNg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ha-NG>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsHaNg {
