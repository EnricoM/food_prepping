...
// Path: <root>
class TranslationsAk extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAk({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ak>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAk _root = this; // ignore: unused_field

	@override 
	TranslationsAk $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAk(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAk app = _TranslationsAppAk._(_root);
	@override late final _TranslationsHomeAk home = _TranslationsHomeAk._(_root);
	@override late final _TranslationsCommonAk common = _TranslationsCommonAk._(_root);
	@override late final _TranslationsSettingsAk settings = _TranslationsSettingsAk._(_root);
	@override late final _TranslationsRecipesAk recipes = _TranslationsRecipesAk._(_root);
	@override late final _TranslationsRecipeDetailAk recipeDetail = _TranslationsRecipeDetailAk._(_root);
	@override late final _TranslationsFiltersAk filters = _TranslationsFiltersAk._(_root);
	@override late final _TranslationsShoppingListAk shoppingList = _TranslationsShoppingListAk._(_root);
	@override late final _TranslationsMealPlanAk mealPlan = _TranslationsMealPlanAk._(_root);
	@override late final _TranslationsInventoryAk inventory = _TranslationsInventoryAk._(_root);
	@override late final _TranslationsBarcodeScanAk barcodeScan = _TranslationsBarcodeScanAk._(_root);
	@override late final _TranslationsReceiptScanAk receiptScan = _TranslationsReceiptScanAk._(_root);
	@override late final _TranslationsBatchCookingAk batchCooking = _TranslationsBatchCookingAk._(_root);
	@override late final _TranslationsVisitedDomainsAk visitedDomains = _TranslationsVisitedDomainsAk._(_root);
	@override late final _TranslationsDomainDiscoveryAk domainDiscovery = _TranslationsDomainDiscoveryAk._(_root);
	@override late final _TranslationsInventorySuggestionsAk inventorySuggestions = _TranslationsInventorySuggestionsAk._(_root);
	@override late final _TranslationsUpgradeAk upgrade = _TranslationsUpgradeAk._(_root);
	@override late final _TranslationsTourAk tour = _TranslationsTourAk._(_root);
	@override late final _TranslationsManualRecipeAk manualRecipe = _TranslationsManualRecipeAk._(_root);
	@override late final _TranslationsRecipeEditAk recipeEdit = _TranslationsRecipeEditAk._(_root);
	@override late final _TranslationsErrorsAk errors = _TranslationsErrorsAk._(_root);
}

// Path: app
class _TranslationsAppAk extends TranslationsAppEn {
	_TranslationsAppAk._(TranslationsAk root) : this._root = root, super.internal(root);

	final TranslationsAk _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAk extends TranslationsHomeEn {
	_TranslationsHomeAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAk extends TranslationsCommonEn {
	_TranslationsCommonAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAk extends TranslationsSettingsEn {
	_TranslationsSettingsAk._(TranslationsAk root) : this._root = root, super.internal(root);

	final TranslationsAk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAk measurements = _TranslationsSettingsMeasurementsAk._(_root);
	@override late final _TranslationsSettingsDataManagementAk dataManagement = _TranslationsSettingsDataManagementAk._(_root);
	@override late final _TranslationsSettingsVersionAk version = _TranslationsSettingsVersionAk._(_root);
}

// Path: recipes
class _TranslationsRecipesAk extends TranslationsRecipesEn {
	_TranslationsRecipesAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAk._(TranslationsAk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAk nutrition = _TranslationsRecipeDetailNutritionAk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAk prepAhead = _TranslationsRecipeDetailPrepAheadAk._(_root);
...
// Path: filters
class _TranslationsFiltersAk extends TranslationsFiltersEn {
	_TranslationsFiltersAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAk extends TranslationsShoppingListEn {
	_TranslationsShoppingListAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAk extends TranslationsMealPlanEn {
	_TranslationsMealPlanAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAk extends TranslationsInventoryEn {
	_TranslationsInventoryAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAk extends TranslationsUpgradeEn {
	_TranslationsUpgradeAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAk extends TranslationsTourEn {
	_TranslationsTourAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAk extends TranslationsErrorsEn {
	_TranslationsErrorsAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAk._(TranslationsAk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAk metric = _TranslationsSettingsMeasurementsMetricAk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAk imperial = _TranslationsSettingsMeasurementsImperialAk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAk._(TranslationsAk root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ak>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAk {
