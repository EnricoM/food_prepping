...
// Path: <root>
class TranslationsWa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsWa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <wa>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsWa _root = this; // ignore: unused_field

	@override 
	TranslationsWa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsWa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppWa app = _TranslationsAppWa._(_root);
	@override late final _TranslationsHomeWa home = _TranslationsHomeWa._(_root);
	@override late final _TranslationsCommonWa common = _TranslationsCommonWa._(_root);
	@override late final _TranslationsSettingsWa settings = _TranslationsSettingsWa._(_root);
	@override late final _TranslationsRecipesWa recipes = _TranslationsRecipesWa._(_root);
	@override late final _TranslationsRecipeDetailWa recipeDetail = _TranslationsRecipeDetailWa._(_root);
	@override late final _TranslationsFiltersWa filters = _TranslationsFiltersWa._(_root);
	@override late final _TranslationsShoppingListWa shoppingList = _TranslationsShoppingListWa._(_root);
	@override late final _TranslationsMealPlanWa mealPlan = _TranslationsMealPlanWa._(_root);
	@override late final _TranslationsInventoryWa inventory = _TranslationsInventoryWa._(_root);
	@override late final _TranslationsBarcodeScanWa barcodeScan = _TranslationsBarcodeScanWa._(_root);
	@override late final _TranslationsReceiptScanWa receiptScan = _TranslationsReceiptScanWa._(_root);
	@override late final _TranslationsBatchCookingWa batchCooking = _TranslationsBatchCookingWa._(_root);
	@override late final _TranslationsVisitedDomainsWa visitedDomains = _TranslationsVisitedDomainsWa._(_root);
	@override late final _TranslationsDomainDiscoveryWa domainDiscovery = _TranslationsDomainDiscoveryWa._(_root);
	@override late final _TranslationsInventorySuggestionsWa inventorySuggestions = _TranslationsInventorySuggestionsWa._(_root);
	@override late final _TranslationsUpgradeWa upgrade = _TranslationsUpgradeWa._(_root);
	@override late final _TranslationsTourWa tour = _TranslationsTourWa._(_root);
	@override late final _TranslationsManualRecipeWa manualRecipe = _TranslationsManualRecipeWa._(_root);
	@override late final _TranslationsRecipeEditWa recipeEdit = _TranslationsRecipeEditWa._(_root);
	@override late final _TranslationsErrorsWa errors = _TranslationsErrorsWa._(_root);
}

// Path: app
class _TranslationsAppWa extends TranslationsAppEn {
	_TranslationsAppWa._(TranslationsWa root) : this._root = root, super.internal(root);

	final TranslationsWa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeWa extends TranslationsHomeEn {
	_TranslationsHomeWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonWa extends TranslationsCommonEn {
	_TranslationsCommonWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsWa extends TranslationsSettingsEn {
	_TranslationsSettingsWa._(TranslationsWa root) : this._root = root, super.internal(root);

	final TranslationsWa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsWa measurements = _TranslationsSettingsMeasurementsWa._(_root);
	@override late final _TranslationsSettingsDataManagementWa dataManagement = _TranslationsSettingsDataManagementWa._(_root);
	@override late final _TranslationsSettingsVersionWa version = _TranslationsSettingsVersionWa._(_root);
}

// Path: recipes
class _TranslationsRecipesWa extends TranslationsRecipesEn {
	_TranslationsRecipesWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailWa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailWa._(TranslationsWa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionWa nutrition = _TranslationsRecipeDetailNutritionWa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadWa prepAhead = _TranslationsRecipeDetailPrepAheadWa._(_root);
...
// Path: filters
class _TranslationsFiltersWa extends TranslationsFiltersEn {
	_TranslationsFiltersWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListWa extends TranslationsShoppingListEn {
	_TranslationsShoppingListWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanWa extends TranslationsMealPlanEn {
	_TranslationsMealPlanWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryWa extends TranslationsInventoryEn {
	_TranslationsInventoryWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanWa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanWa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingWa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsWa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryWa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsWa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeWa extends TranslationsUpgradeEn {
	_TranslationsUpgradeWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourWa extends TranslationsTourEn {
	_TranslationsTourWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeWa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditWa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsWa extends TranslationsErrorsEn {
	_TranslationsErrorsWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsWa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsWa._(TranslationsWa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricWa metric = _TranslationsSettingsMeasurementsMetricWa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialWa imperial = _TranslationsSettingsMeasurementsImperialWa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementWa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionWa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionWa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadWa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricWa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialWa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialWa._(TranslationsWa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <wa>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsWa {
