...
class TranslationsMlIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppMlIn app = _TranslationsAppMlIn._(_root);
	@override late final _TranslationsHomeMlIn home = _TranslationsHomeMlIn._(_root);
	@override late final _TranslationsCommonMlIn common = _TranslationsCommonMlIn._(_root);
	@override late final _TranslationsSettingsMlIn settings = _TranslationsSettingsMlIn._(_root);
	@override late final _TranslationsRecipesMlIn recipes = _TranslationsRecipesMlIn._(_root);
	@override late final _TranslationsRecipeDetailMlIn recipeDetail = _TranslationsRecipeDetailMlIn._(_root);
	@override late final _TranslationsFiltersMlIn filters = _TranslationsFiltersMlIn._(_root);
	@override late final _TranslationsShoppingListMlIn shoppingList = _TranslationsShoppingListMlIn._(_root);
	@override late final _TranslationsMealPlanMlIn mealPlan = _TranslationsMealPlanMlIn._(_root);
	@override late final _TranslationsInventoryMlIn inventory = _TranslationsInventoryMlIn._(_root);
	@override late final _TranslationsBarcodeScanMlIn barcodeScan = _TranslationsBarcodeScanMlIn._(_root);
	@override late final _TranslationsReceiptScanMlIn receiptScan = _TranslationsReceiptScanMlIn._(_root);
	@override late final _TranslationsBatchCookingMlIn batchCooking = _TranslationsBatchCookingMlIn._(_root);
	@override late final _TranslationsVisitedDomainsMlIn visitedDomains = _TranslationsVisitedDomainsMlIn._(_root);
	@override late final _TranslationsDomainDiscoveryMlIn domainDiscovery = _TranslationsDomainDiscoveryMlIn._(_root);
	@override late final _TranslationsInventorySuggestionsMlIn inventorySuggestions = _TranslationsInventorySuggestionsMlIn._(_root);
	@override late final _TranslationsUpgradeMlIn upgrade = _TranslationsUpgradeMlIn._(_root);
	@override late final _TranslationsTourMlIn tour = _TranslationsTourMlIn._(_root);
	@override late final _TranslationsManualRecipeMlIn manualRecipe = _TranslationsManualRecipeMlIn._(_root);
	@override late final _TranslationsRecipeEditMlIn recipeEdit = _TranslationsRecipeEditMlIn._(_root);
	@override late final _TranslationsErrorsMlIn errors = _TranslationsErrorsMlIn._(_root);
}

// Path: app
class _TranslationsAppMlIn extends TranslationsAppEn {
	_TranslationsAppMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);

	final TranslationsMlIn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMlIn extends TranslationsHomeEn {
	_TranslationsHomeMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMlIn extends TranslationsCommonEn {
	_TranslationsCommonMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMlIn extends TranslationsSettingsEn {
	_TranslationsSettingsMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);

	final TranslationsMlIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMlIn measurements = _TranslationsSettingsMeasurementsMlIn._(_root);
	@override late final _TranslationsSettingsDataManagementMlIn dataManagement = _TranslationsSettingsDataManagementMlIn._(_root);
	@override late final _TranslationsSettingsVersionMlIn version = _TranslationsSettingsVersionMlIn._(_root);
}

// Path: recipes
class _TranslationsRecipesMlIn extends TranslationsRecipesEn {
	_TranslationsRecipesMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMlIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMlIn nutrition = _TranslationsRecipeDetailNutritionMlIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMlIn prepAhead = _TranslationsRecipeDetailPrepAheadMlIn._(_root);
...
// Path: filters
class _TranslationsFiltersMlIn extends TranslationsFiltersEn {
	_TranslationsFiltersMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMlIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMlIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMlIn extends TranslationsInventoryEn {
	_TranslationsInventoryMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMlIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMlIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMlIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMlIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMlIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMlIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMlIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMlIn extends TranslationsTourEn {
	_TranslationsTourMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMlIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMlIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMlIn extends TranslationsErrorsEn {
	_TranslationsErrorsMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMlIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMlIn metric = _TranslationsSettingsMeasurementsMetricMlIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMlIn imperial = _TranslationsSettingsMeasurementsImperialMlIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMlIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMlIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMlIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMlIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMlIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMlIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMlIn._(TranslationsMlIn root) : this._root = root, super.internal(root);
