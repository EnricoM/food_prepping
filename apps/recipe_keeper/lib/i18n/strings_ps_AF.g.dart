...
// Path: <root>
class TranslationsPsAf extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsPsAf({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.psAf,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ps-AF>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsPsAf _root = this; // ignore: unused_field

	@override 
	TranslationsPsAf $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsPsAf(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppPsAf app = _TranslationsAppPsAf._(_root);
	@override late final _TranslationsHomePsAf home = _TranslationsHomePsAf._(_root);
	@override late final _TranslationsCommonPsAf common = _TranslationsCommonPsAf._(_root);
	@override late final _TranslationsSettingsPsAf settings = _TranslationsSettingsPsAf._(_root);
	@override late final _TranslationsRecipesPsAf recipes = _TranslationsRecipesPsAf._(_root);
	@override late final _TranslationsRecipeDetailPsAf recipeDetail = _TranslationsRecipeDetailPsAf._(_root);
	@override late final _TranslationsFiltersPsAf filters = _TranslationsFiltersPsAf._(_root);
	@override late final _TranslationsShoppingListPsAf shoppingList = _TranslationsShoppingListPsAf._(_root);
	@override late final _TranslationsMealPlanPsAf mealPlan = _TranslationsMealPlanPsAf._(_root);
	@override late final _TranslationsInventoryPsAf inventory = _TranslationsInventoryPsAf._(_root);
	@override late final _TranslationsBarcodeScanPsAf barcodeScan = _TranslationsBarcodeScanPsAf._(_root);
	@override late final _TranslationsReceiptScanPsAf receiptScan = _TranslationsReceiptScanPsAf._(_root);
	@override late final _TranslationsBatchCookingPsAf batchCooking = _TranslationsBatchCookingPsAf._(_root);
	@override late final _TranslationsVisitedDomainsPsAf visitedDomains = _TranslationsVisitedDomainsPsAf._(_root);
	@override late final _TranslationsDomainDiscoveryPsAf domainDiscovery = _TranslationsDomainDiscoveryPsAf._(_root);
	@override late final _TranslationsInventorySuggestionsPsAf inventorySuggestions = _TranslationsInventorySuggestionsPsAf._(_root);
	@override late final _TranslationsUpgradePsAf upgrade = _TranslationsUpgradePsAf._(_root);
	@override late final _TranslationsTourPsAf tour = _TranslationsTourPsAf._(_root);
	@override late final _TranslationsManualRecipePsAf manualRecipe = _TranslationsManualRecipePsAf._(_root);
	@override late final _TranslationsRecipeEditPsAf recipeEdit = _TranslationsRecipeEditPsAf._(_root);
	@override late final _TranslationsErrorsPsAf errors = _TranslationsErrorsPsAf._(_root);
}

// Path: app
class _TranslationsAppPsAf extends TranslationsAppEn {
	_TranslationsAppPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);

	final TranslationsPsAf _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomePsAf extends TranslationsHomeEn {
	_TranslationsHomePsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonPsAf extends TranslationsCommonEn {
	_TranslationsCommonPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsPsAf extends TranslationsSettingsEn {
	_TranslationsSettingsPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);

	final TranslationsPsAf _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsPsAf measurements = _TranslationsSettingsMeasurementsPsAf._(_root);
	@override late final _TranslationsSettingsDataManagementPsAf dataManagement = _TranslationsSettingsDataManagementPsAf._(_root);
	@override late final _TranslationsSettingsVersionPsAf version = _TranslationsSettingsVersionPsAf._(_root);
}

// Path: recipes
class _TranslationsRecipesPsAf extends TranslationsRecipesEn {
	_TranslationsRecipesPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPsAf extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPsAf nutrition = _TranslationsRecipeDetailNutritionPsAf._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPsAf prepAhead = _TranslationsRecipeDetailPrepAheadPsAf._(_root);
...
// Path: filters
class _TranslationsFiltersPsAf extends TranslationsFiltersEn {
	_TranslationsFiltersPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPsAf extends TranslationsShoppingListEn {
	_TranslationsShoppingListPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPsAf extends TranslationsMealPlanEn {
	_TranslationsMealPlanPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPsAf extends TranslationsInventoryEn {
	_TranslationsInventoryPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPsAf extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPsAf extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPsAf extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPsAf extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPsAf extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPsAf extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePsAf extends TranslationsUpgradeEn {
	_TranslationsUpgradePsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPsAf extends TranslationsTourEn {
	_TranslationsTourPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePsAf extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPsAf extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsPsAf extends TranslationsErrorsEn {
	_TranslationsErrorsPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPsAf extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPsAf metric = _TranslationsSettingsMeasurementsMetricPsAf._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPsAf imperial = _TranslationsSettingsMeasurementsImperialPsAf._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPsAf extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPsAf extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPsAf extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPsAf extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPsAf extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPsAf extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPsAf._(TranslationsPsAf root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ps-AF>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsPsAf {
