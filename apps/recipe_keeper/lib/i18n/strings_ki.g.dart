...
// Path: <root>
class TranslationsKi extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ki>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKi _root = this; // ignore: unused_field

	@override 
	TranslationsKi $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKi(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKi app = _TranslationsAppKi._(_root);
	@override late final _TranslationsHomeKi home = _TranslationsHomeKi._(_root);
	@override late final _TranslationsCommonKi common = _TranslationsCommonKi._(_root);
	@override late final _TranslationsSettingsKi settings = _TranslationsSettingsKi._(_root);
	@override late final _TranslationsRecipesKi recipes = _TranslationsRecipesKi._(_root);
	@override late final _TranslationsRecipeDetailKi recipeDetail = _TranslationsRecipeDetailKi._(_root);
	@override late final _TranslationsFiltersKi filters = _TranslationsFiltersKi._(_root);
	@override late final _TranslationsShoppingListKi shoppingList = _TranslationsShoppingListKi._(_root);
	@override late final _TranslationsMealPlanKi mealPlan = _TranslationsMealPlanKi._(_root);
	@override late final _TranslationsInventoryKi inventory = _TranslationsInventoryKi._(_root);
	@override late final _TranslationsBarcodeScanKi barcodeScan = _TranslationsBarcodeScanKi._(_root);
	@override late final _TranslationsReceiptScanKi receiptScan = _TranslationsReceiptScanKi._(_root);
	@override late final _TranslationsBatchCookingKi batchCooking = _TranslationsBatchCookingKi._(_root);
	@override late final _TranslationsVisitedDomainsKi visitedDomains = _TranslationsVisitedDomainsKi._(_root);
	@override late final _TranslationsDomainDiscoveryKi domainDiscovery = _TranslationsDomainDiscoveryKi._(_root);
	@override late final _TranslationsInventorySuggestionsKi inventorySuggestions = _TranslationsInventorySuggestionsKi._(_root);
	@override late final _TranslationsUpgradeKi upgrade = _TranslationsUpgradeKi._(_root);
	@override late final _TranslationsTourKi tour = _TranslationsTourKi._(_root);
	@override late final _TranslationsManualRecipeKi manualRecipe = _TranslationsManualRecipeKi._(_root);
	@override late final _TranslationsRecipeEditKi recipeEdit = _TranslationsRecipeEditKi._(_root);
	@override late final _TranslationsErrorsKi errors = _TranslationsErrorsKi._(_root);
}

// Path: app
class _TranslationsAppKi extends TranslationsAppEn {
	_TranslationsAppKi._(TranslationsKi root) : this._root = root, super.internal(root);

	final TranslationsKi _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKi extends TranslationsHomeEn {
	_TranslationsHomeKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKi extends TranslationsCommonEn {
	_TranslationsCommonKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKi extends TranslationsSettingsEn {
	_TranslationsSettingsKi._(TranslationsKi root) : this._root = root, super.internal(root);

	final TranslationsKi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKi measurements = _TranslationsSettingsMeasurementsKi._(_root);
	@override late final _TranslationsSettingsDataManagementKi dataManagement = _TranslationsSettingsDataManagementKi._(_root);
	@override late final _TranslationsSettingsVersionKi version = _TranslationsSettingsVersionKi._(_root);
}

// Path: recipes
class _TranslationsRecipesKi extends TranslationsRecipesEn {
	_TranslationsRecipesKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKi._(TranslationsKi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKi nutrition = _TranslationsRecipeDetailNutritionKi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKi prepAhead = _TranslationsRecipeDetailPrepAheadKi._(_root);
...
// Path: filters
class _TranslationsFiltersKi extends TranslationsFiltersEn {
	_TranslationsFiltersKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKi extends TranslationsShoppingListEn {
	_TranslationsShoppingListKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKi extends TranslationsMealPlanEn {
	_TranslationsMealPlanKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKi extends TranslationsInventoryEn {
	_TranslationsInventoryKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKi extends TranslationsUpgradeEn {
	_TranslationsUpgradeKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKi extends TranslationsTourEn {
	_TranslationsTourKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKi extends TranslationsErrorsEn {
	_TranslationsErrorsKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKi._(TranslationsKi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKi metric = _TranslationsSettingsMeasurementsMetricKi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKi imperial = _TranslationsSettingsMeasurementsImperialKi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKi._(TranslationsKi root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ki>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKi {
