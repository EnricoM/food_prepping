...
// Path: <root>
class TranslationsKmKh extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKmKh({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.kmKh,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <km-KH>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKmKh _root = this; // ignore: unused_field

	@override 
	TranslationsKmKh $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKmKh(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKmKh app = _TranslationsAppKmKh._(_root);
	@override late final _TranslationsHomeKmKh home = _TranslationsHomeKmKh._(_root);
	@override late final _TranslationsCommonKmKh common = _TranslationsCommonKmKh._(_root);
	@override late final _TranslationsSettingsKmKh settings = _TranslationsSettingsKmKh._(_root);
	@override late final _TranslationsRecipesKmKh recipes = _TranslationsRecipesKmKh._(_root);
	@override late final _TranslationsRecipeDetailKmKh recipeDetail = _TranslationsRecipeDetailKmKh._(_root);
	@override late final _TranslationsFiltersKmKh filters = _TranslationsFiltersKmKh._(_root);
	@override late final _TranslationsShoppingListKmKh shoppingList = _TranslationsShoppingListKmKh._(_root);
	@override late final _TranslationsMealPlanKmKh mealPlan = _TranslationsMealPlanKmKh._(_root);
	@override late final _TranslationsInventoryKmKh inventory = _TranslationsInventoryKmKh._(_root);
	@override late final _TranslationsBarcodeScanKmKh barcodeScan = _TranslationsBarcodeScanKmKh._(_root);
	@override late final _TranslationsReceiptScanKmKh receiptScan = _TranslationsReceiptScanKmKh._(_root);
	@override late final _TranslationsBatchCookingKmKh batchCooking = _TranslationsBatchCookingKmKh._(_root);
	@override late final _TranslationsVisitedDomainsKmKh visitedDomains = _TranslationsVisitedDomainsKmKh._(_root);
	@override late final _TranslationsDomainDiscoveryKmKh domainDiscovery = _TranslationsDomainDiscoveryKmKh._(_root);
	@override late final _TranslationsInventorySuggestionsKmKh inventorySuggestions = _TranslationsInventorySuggestionsKmKh._(_root);
	@override late final _TranslationsUpgradeKmKh upgrade = _TranslationsUpgradeKmKh._(_root);
	@override late final _TranslationsTourKmKh tour = _TranslationsTourKmKh._(_root);
	@override late final _TranslationsManualRecipeKmKh manualRecipe = _TranslationsManualRecipeKmKh._(_root);
	@override late final _TranslationsRecipeEditKmKh recipeEdit = _TranslationsRecipeEditKmKh._(_root);
	@override late final _TranslationsErrorsKmKh errors = _TranslationsErrorsKmKh._(_root);
}

// Path: app
class _TranslationsAppKmKh extends TranslationsAppEn {
	_TranslationsAppKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);

	final TranslationsKmKh _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKmKh extends TranslationsHomeEn {
	_TranslationsHomeKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKmKh extends TranslationsCommonEn {
	_TranslationsCommonKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKmKh extends TranslationsSettingsEn {
	_TranslationsSettingsKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);

	final TranslationsKmKh _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKmKh measurements = _TranslationsSettingsMeasurementsKmKh._(_root);
	@override late final _TranslationsSettingsDataManagementKmKh dataManagement = _TranslationsSettingsDataManagementKmKh._(_root);
	@override late final _TranslationsSettingsVersionKmKh version = _TranslationsSettingsVersionKmKh._(_root);
}

// Path: recipes
class _TranslationsRecipesKmKh extends TranslationsRecipesEn {
	_TranslationsRecipesKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKmKh extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKmKh nutrition = _TranslationsRecipeDetailNutritionKmKh._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKmKh prepAhead = _TranslationsRecipeDetailPrepAheadKmKh._(_root);
...
// Path: filters
class _TranslationsFiltersKmKh extends TranslationsFiltersEn {
	_TranslationsFiltersKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKmKh extends TranslationsShoppingListEn {
	_TranslationsShoppingListKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKmKh extends TranslationsMealPlanEn {
	_TranslationsMealPlanKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKmKh extends TranslationsInventoryEn {
	_TranslationsInventoryKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKmKh extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKmKh extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKmKh extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKmKh extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKmKh extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKmKh extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKmKh extends TranslationsUpgradeEn {
	_TranslationsUpgradeKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKmKh extends TranslationsTourEn {
	_TranslationsTourKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKmKh extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKmKh extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKmKh extends TranslationsErrorsEn {
	_TranslationsErrorsKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKmKh extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKmKh metric = _TranslationsSettingsMeasurementsMetricKmKh._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKmKh imperial = _TranslationsSettingsMeasurementsImperialKmKh._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKmKh extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKmKh extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKmKh extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKmKh extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKmKh extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKmKh extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKmKh._(TranslationsKmKh root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <km-KH>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKmKh {
