...
class TranslationsGu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesGu recipes = _TranslationsRecipesGu._(_root);
	@override late final _TranslationsRecipeDetailGu recipeDetail = _TranslationsRecipeDetailGu._(_root);
	@override late final _TranslationsFiltersGu filters = _TranslationsFiltersGu._(_root);
	@override late final _TranslationsShoppingListGu shoppingList = _TranslationsShoppingListGu._(_root);
	@override late final _TranslationsMealPlanGu mealPlan = _TranslationsMealPlanGu._(_root);
	@override late final _TranslationsInventoryGu inventory = _TranslationsInventoryGu._(_root);
	@override late final _TranslationsBarcodeScanGu barcodeScan = _TranslationsBarcodeScanGu._(_root);
	@override late final _TranslationsReceiptScanGu receiptScan = _TranslationsReceiptScanGu._(_root);
	@override late final _TranslationsBatchCookingGu batchCooking = _TranslationsBatchCookingGu._(_root);
	@override late final _TranslationsVisitedDomainsGu visitedDomains = _TranslationsVisitedDomainsGu._(_root);
	@override late final _TranslationsDomainDiscoveryGu domainDiscovery = _TranslationsDomainDiscoveryGu._(_root);
	@override late final _TranslationsInventorySuggestionsGu inventorySuggestions = _TranslationsInventorySuggestionsGu._(_root);
	@override late final _TranslationsUpgradeGu upgrade = _TranslationsUpgradeGu._(_root);
	@override late final _TranslationsTourGu tour = _TranslationsTourGu._(_root);
	@override late final _TranslationsManualRecipeGu manualRecipe = _TranslationsManualRecipeGu._(_root);
	@override late final _TranslationsRecipeEditGu recipeEdit = _TranslationsRecipeEditGu._(_root);
...
class _TranslationsSettingsGu extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsGu measurements = _TranslationsSettingsMeasurementsGu._(_root);
	@override late final _TranslationsSettingsDataManagementGu dataManagement = _TranslationsSettingsDataManagementGu._(_root);
	@override late final _TranslationsSettingsVersionGu version = _TranslationsSettingsVersionGu._(_root);
}

// Path: recipes
class _TranslationsRecipesGu extends TranslationsRecipesEn {
	_TranslationsRecipesGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGu._(TranslationsGu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGu nutrition = _TranslationsRecipeDetailNutritionGu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGu prepAhead = _TranslationsRecipeDetailPrepAheadGu._(_root);
...
// Path: filters
class _TranslationsFiltersGu extends TranslationsFiltersEn {
	_TranslationsFiltersGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGu extends TranslationsShoppingListEn {
	_TranslationsShoppingListGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGu extends TranslationsMealPlanEn {
	_TranslationsMealPlanGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGu extends TranslationsInventoryEn {
	_TranslationsInventoryGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGu extends TranslationsUpgradeEn {
	_TranslationsUpgradeGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGu extends TranslationsTourEn {
	_TranslationsTourGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGu._(TranslationsGu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGu metric = _TranslationsSettingsMeasurementsMetricGu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGu imperial = _TranslationsSettingsMeasurementsImperialGu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGu._(TranslationsGu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGu._(TranslationsGu root) : this._root = root, super.internal(root);
