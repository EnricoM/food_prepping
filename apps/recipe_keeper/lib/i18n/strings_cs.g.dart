...
class TranslationsCs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppCs app = _TranslationsAppCs._(_root);
	...
	@override late final _TranslationsRecipesCs recipes = _TranslationsRecipesCs._(_root);
	@override late final _TranslationsRecipeDetailCs recipeDetail = _TranslationsRecipeDetailCs._(_root);
	@override late final _TranslationsFiltersCs filters = _TranslationsFiltersCs._(_root);
	@override late final _TranslationsShoppingListCs shoppingList = _TranslationsShoppingListCs._(_root);
	@override late final _TranslationsMealPlanCs mealPlan = _TranslationsMealPlanCs._(_root);
	@override late final _TranslationsInventoryCs inventory = _TranslationsInventoryCs._(_root);
	@override late final _TranslationsBarcodeScanCs barcodeScan = _TranslationsBarcodeScanCs._(_root);
	@override late final _TranslationsReceiptScanCs receiptScan = _TranslationsReceiptScanCs._(_root);
	@override late final _TranslationsBatchCookingCs batchCooking = _TranslationsBatchCookingCs._(_root);
	@override late final _TranslationsVisitedDomainsCs visitedDomains = _TranslationsVisitedDomainsCs._(_root);
	@override late final _TranslationsDomainDiscoveryCs domainDiscovery = _TranslationsDomainDiscoveryCs._(_root);
	@override late final _TranslationsInventorySuggestionsCs inventorySuggestions = _TranslationsInventorySuggestionsCs._(_root);
	@override late final _TranslationsUpgradeCs upgrade = _TranslationsUpgradeCs._(_root);
	@override late final _TranslationsTourCs tour = _TranslationsTourCs._(_root);
	@override late final _TranslationsManualRecipeCs manualRecipe = _TranslationsManualRecipeCs._(_root);
	@override late final _TranslationsRecipeEditCs recipeEdit = _TranslationsRecipeEditCs._(_root);
	@override late final _TranslationsErrorsCs errors = _TranslationsErrorsCs._(_root);
}

// Path: app
class _TranslationsAppCs extends TranslationsAppEn {
	_TranslationsAppCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsCs extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsCs measurements = _TranslationsSettingsMeasurementsCs._(_root);
	@override late final _TranslationsSettingsDataManagementCs dataManagement = _TranslationsSettingsDataManagementCs._(_root);
	@override late final _TranslationsSettingsVersionCs version = _TranslationsSettingsVersionCs._(_root);
}

// Path: recipes
class _TranslationsRecipesCs extends TranslationsRecipesEn {
	_TranslationsRecipesCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCs._(TranslationsCs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCs nutrition = _TranslationsRecipeDetailNutritionCs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCs prepAhead = _TranslationsRecipeDetailPrepAheadCs._(_root);
...
// Path: filters
class _TranslationsFiltersCs extends TranslationsFiltersEn {
	_TranslationsFiltersCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCs extends TranslationsShoppingListEn {
	_TranslationsShoppingListCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCs extends TranslationsMealPlanEn {
	_TranslationsMealPlanCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCs extends TranslationsInventoryEn {
	_TranslationsInventoryCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCs extends TranslationsUpgradeEn {
	_TranslationsUpgradeCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCs extends TranslationsTourEn {
	_TranslationsTourCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCs._(TranslationsCs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCs metric = _TranslationsSettingsMeasurementsMetricCs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCs imperial = _TranslationsSettingsMeasurementsImperialCs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCs._(TranslationsCs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCs._(TranslationsCs root) : this._root = root, super.internal(root);
