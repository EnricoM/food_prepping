...
// Path: <root>
class TranslationsYo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsYo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <yo>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsYo _root = this; // ignore: unused_field

	@override 
	TranslationsYo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsYo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppYo app = _TranslationsAppYo._(_root);
	@override late final _TranslationsHomeYo home = _TranslationsHomeYo._(_root);
	@override late final _TranslationsCommonYo common = _TranslationsCommonYo._(_root);
	@override late final _TranslationsSettingsYo settings = _TranslationsSettingsYo._(_root);
	@override late final _TranslationsRecipesYo recipes = _TranslationsRecipesYo._(_root);
	@override late final _TranslationsRecipeDetailYo recipeDetail = _TranslationsRecipeDetailYo._(_root);
	@override late final _TranslationsFiltersYo filters = _TranslationsFiltersYo._(_root);
	@override late final _TranslationsShoppingListYo shoppingList = _TranslationsShoppingListYo._(_root);
	@override late final _TranslationsMealPlanYo mealPlan = _TranslationsMealPlanYo._(_root);
	@override late final _TranslationsInventoryYo inventory = _TranslationsInventoryYo._(_root);
	@override late final _TranslationsBarcodeScanYo barcodeScan = _TranslationsBarcodeScanYo._(_root);
	@override late final _TranslationsReceiptScanYo receiptScan = _TranslationsReceiptScanYo._(_root);
	@override late final _TranslationsBatchCookingYo batchCooking = _TranslationsBatchCookingYo._(_root);
	@override late final _TranslationsVisitedDomainsYo visitedDomains = _TranslationsVisitedDomainsYo._(_root);
	@override late final _TranslationsDomainDiscoveryYo domainDiscovery = _TranslationsDomainDiscoveryYo._(_root);
	@override late final _TranslationsInventorySuggestionsYo inventorySuggestions = _TranslationsInventorySuggestionsYo._(_root);
	@override late final _TranslationsUpgradeYo upgrade = _TranslationsUpgradeYo._(_root);
	@override late final _TranslationsTourYo tour = _TranslationsTourYo._(_root);
	@override late final _TranslationsManualRecipeYo manualRecipe = _TranslationsManualRecipeYo._(_root);
	@override late final _TranslationsRecipeEditYo recipeEdit = _TranslationsRecipeEditYo._(_root);
	@override late final _TranslationsErrorsYo errors = _TranslationsErrorsYo._(_root);
}

// Path: app
class _TranslationsAppYo extends TranslationsAppEn {
	_TranslationsAppYo._(TranslationsYo root) : this._root = root, super.internal(root);

	final TranslationsYo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeYo extends TranslationsHomeEn {
	_TranslationsHomeYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonYo extends TranslationsCommonEn {
	_TranslationsCommonYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsYo extends TranslationsSettingsEn {
	_TranslationsSettingsYo._(TranslationsYo root) : this._root = root, super.internal(root);

	final TranslationsYo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsYo measurements = _TranslationsSettingsMeasurementsYo._(_root);
	@override late final _TranslationsSettingsDataManagementYo dataManagement = _TranslationsSettingsDataManagementYo._(_root);
	@override late final _TranslationsSettingsVersionYo version = _TranslationsSettingsVersionYo._(_root);
}

// Path: recipes
class _TranslationsRecipesYo extends TranslationsRecipesEn {
	_TranslationsRecipesYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailYo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailYo._(TranslationsYo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionYo nutrition = _TranslationsRecipeDetailNutritionYo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadYo prepAhead = _TranslationsRecipeDetailPrepAheadYo._(_root);
...
// Path: filters
class _TranslationsFiltersYo extends TranslationsFiltersEn {
	_TranslationsFiltersYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListYo extends TranslationsShoppingListEn {
	_TranslationsShoppingListYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanYo extends TranslationsMealPlanEn {
	_TranslationsMealPlanYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryYo extends TranslationsInventoryEn {
	_TranslationsInventoryYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanYo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanYo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingYo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsYo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryYo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsYo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeYo extends TranslationsUpgradeEn {
	_TranslationsUpgradeYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourYo extends TranslationsTourEn {
	_TranslationsTourYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeYo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditYo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsYo extends TranslationsErrorsEn {
	_TranslationsErrorsYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsYo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsYo._(TranslationsYo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricYo metric = _TranslationsSettingsMeasurementsMetricYo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialYo imperial = _TranslationsSettingsMeasurementsImperialYo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementYo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionYo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionYo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadYo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricYo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialYo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialYo._(TranslationsYo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <yo>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsYo {
