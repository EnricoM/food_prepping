...
// Path: <root>
class TranslationsHz extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsHz({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <hz>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsHz _root = this; // ignore: unused_field

	@override 
	TranslationsHz $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsHz(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppHz app = _TranslationsAppHz._(_root);
	@override late final _TranslationsHomeHz home = _TranslationsHomeHz._(_root);
	@override late final _TranslationsCommonHz common = _TranslationsCommonHz._(_root);
	@override late final _TranslationsSettingsHz settings = _TranslationsSettingsHz._(_root);
	@override late final _TranslationsRecipesHz recipes = _TranslationsRecipesHz._(_root);
	@override late final _TranslationsRecipeDetailHz recipeDetail = _TranslationsRecipeDetailHz._(_root);
	@override late final _TranslationsFiltersHz filters = _TranslationsFiltersHz._(_root);
	@override late final _TranslationsShoppingListHz shoppingList = _TranslationsShoppingListHz._(_root);
	@override late final _TranslationsMealPlanHz mealPlan = _TranslationsMealPlanHz._(_root);
	@override late final _TranslationsInventoryHz inventory = _TranslationsInventoryHz._(_root);
	@override late final _TranslationsBarcodeScanHz barcodeScan = _TranslationsBarcodeScanHz._(_root);
	@override late final _TranslationsReceiptScanHz receiptScan = _TranslationsReceiptScanHz._(_root);
	@override late final _TranslationsBatchCookingHz batchCooking = _TranslationsBatchCookingHz._(_root);
	@override late final _TranslationsVisitedDomainsHz visitedDomains = _TranslationsVisitedDomainsHz._(_root);
	@override late final _TranslationsDomainDiscoveryHz domainDiscovery = _TranslationsDomainDiscoveryHz._(_root);
	@override late final _TranslationsInventorySuggestionsHz inventorySuggestions = _TranslationsInventorySuggestionsHz._(_root);
	@override late final _TranslationsUpgradeHz upgrade = _TranslationsUpgradeHz._(_root);
	@override late final _TranslationsTourHz tour = _TranslationsTourHz._(_root);
	@override late final _TranslationsManualRecipeHz manualRecipe = _TranslationsManualRecipeHz._(_root);
	@override late final _TranslationsRecipeEditHz recipeEdit = _TranslationsRecipeEditHz._(_root);
	@override late final _TranslationsErrorsHz errors = _TranslationsErrorsHz._(_root);
}

// Path: app
class _TranslationsAppHz extends TranslationsAppEn {
	_TranslationsAppHz._(TranslationsHz root) : this._root = root, super.internal(root);

	final TranslationsHz _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeHz extends TranslationsHomeEn {
	_TranslationsHomeHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHz extends TranslationsCommonEn {
	_TranslationsCommonHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHz extends TranslationsSettingsEn {
	_TranslationsSettingsHz._(TranslationsHz root) : this._root = root, super.internal(root);

	final TranslationsHz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHz measurements = _TranslationsSettingsMeasurementsHz._(_root);
	@override late final _TranslationsSettingsDataManagementHz dataManagement = _TranslationsSettingsDataManagementHz._(_root);
	@override late final _TranslationsSettingsVersionHz version = _TranslationsSettingsVersionHz._(_root);
}

// Path: recipes
class _TranslationsRecipesHz extends TranslationsRecipesEn {
	_TranslationsRecipesHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHz._(TranslationsHz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHz nutrition = _TranslationsRecipeDetailNutritionHz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHz prepAhead = _TranslationsRecipeDetailPrepAheadHz._(_root);
...
// Path: filters
class _TranslationsFiltersHz extends TranslationsFiltersEn {
	_TranslationsFiltersHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHz extends TranslationsShoppingListEn {
	_TranslationsShoppingListHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHz extends TranslationsMealPlanEn {
	_TranslationsMealPlanHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHz extends TranslationsInventoryEn {
	_TranslationsInventoryHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHz extends TranslationsUpgradeEn {
	_TranslationsUpgradeHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHz extends TranslationsTourEn {
	_TranslationsTourHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsHz extends TranslationsErrorsEn {
	_TranslationsErrorsHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHz._(TranslationsHz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHz metric = _TranslationsSettingsMeasurementsMetricHz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHz imperial = _TranslationsSettingsMeasurementsImperialHz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHz._(TranslationsHz root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <hz>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsHz {
