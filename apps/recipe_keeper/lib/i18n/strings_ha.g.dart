...
// Path: <root>
class TranslationsHa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsHa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ha>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsHa _root = this; // ignore: unused_field

	@override 
	TranslationsHa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsHa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppHa app = _TranslationsAppHa._(_root);
	@override late final _TranslationsHomeHa home = _TranslationsHomeHa._(_root);
	@override late final _TranslationsCommonHa common = _TranslationsCommonHa._(_root);
	@override late final _TranslationsSettingsHa settings = _TranslationsSettingsHa._(_root);
	@override late final _TranslationsRecipesHa recipes = _TranslationsRecipesHa._(_root);
	@override late final _TranslationsRecipeDetailHa recipeDetail = _TranslationsRecipeDetailHa._(_root);
	@override late final _TranslationsFiltersHa filters = _TranslationsFiltersHa._(_root);
	@override late final _TranslationsShoppingListHa shoppingList = _TranslationsShoppingListHa._(_root);
	@override late final _TranslationsMealPlanHa mealPlan = _TranslationsMealPlanHa._(_root);
	@override late final _TranslationsInventoryHa inventory = _TranslationsInventoryHa._(_root);
	@override late final _TranslationsBarcodeScanHa barcodeScan = _TranslationsBarcodeScanHa._(_root);
	@override late final _TranslationsReceiptScanHa receiptScan = _TranslationsReceiptScanHa._(_root);
	@override late final _TranslationsBatchCookingHa batchCooking = _TranslationsBatchCookingHa._(_root);
	@override late final _TranslationsVisitedDomainsHa visitedDomains = _TranslationsVisitedDomainsHa._(_root);
	@override late final _TranslationsDomainDiscoveryHa domainDiscovery = _TranslationsDomainDiscoveryHa._(_root);
	@override late final _TranslationsInventorySuggestionsHa inventorySuggestions = _TranslationsInventorySuggestionsHa._(_root);
	@override late final _TranslationsUpgradeHa upgrade = _TranslationsUpgradeHa._(_root);
	@override late final _TranslationsTourHa tour = _TranslationsTourHa._(_root);
	@override late final _TranslationsManualRecipeHa manualRecipe = _TranslationsManualRecipeHa._(_root);
	@override late final _TranslationsRecipeEditHa recipeEdit = _TranslationsRecipeEditHa._(_root);
	@override late final _TranslationsErrorsHa errors = _TranslationsErrorsHa._(_root);
}

// Path: app
class _TranslationsAppHa extends TranslationsAppEn {
	_TranslationsAppHa._(TranslationsHa root) : this._root = root, super.internal(root);

	final TranslationsHa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeHa extends TranslationsHomeEn {
	_TranslationsHomeHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHa extends TranslationsCommonEn {
	_TranslationsCommonHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHa extends TranslationsSettingsEn {
	_TranslationsSettingsHa._(TranslationsHa root) : this._root = root, super.internal(root);

	final TranslationsHa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHa measurements = _TranslationsSettingsMeasurementsHa._(_root);
	@override late final _TranslationsSettingsDataManagementHa dataManagement = _TranslationsSettingsDataManagementHa._(_root);
	@override late final _TranslationsSettingsVersionHa version = _TranslationsSettingsVersionHa._(_root);
}

// Path: recipes
class _TranslationsRecipesHa extends TranslationsRecipesEn {
	_TranslationsRecipesHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHa._(TranslationsHa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHa nutrition = _TranslationsRecipeDetailNutritionHa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHa prepAhead = _TranslationsRecipeDetailPrepAheadHa._(_root);
...
// Path: filters
class _TranslationsFiltersHa extends TranslationsFiltersEn {
	_TranslationsFiltersHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHa extends TranslationsShoppingListEn {
	_TranslationsShoppingListHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHa extends TranslationsMealPlanEn {
	_TranslationsMealPlanHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHa extends TranslationsInventoryEn {
	_TranslationsInventoryHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHa extends TranslationsUpgradeEn {
	_TranslationsUpgradeHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHa extends TranslationsTourEn {
	_TranslationsTourHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsHa extends TranslationsErrorsEn {
	_TranslationsErrorsHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHa._(TranslationsHa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHa metric = _TranslationsSettingsMeasurementsMetricHa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHa imperial = _TranslationsSettingsMeasurementsImperialHa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHa._(TranslationsHa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ha>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsHa {
