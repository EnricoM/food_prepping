...
class TranslationsTaIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppTaIn app = _TranslationsAppTaIn._(_root);
	@override late final _TranslationsHomeTaIn home = _TranslationsHomeTaIn._(_root);
	@override late final _TranslationsCommonTaIn common = _TranslationsCommonTaIn._(_root);
	@override late final _TranslationsSettingsTaIn settings = _TranslationsSettingsTaIn._(_root);
	@override late final _TranslationsRecipesTaIn recipes = _TranslationsRecipesTaIn._(_root);
	@override late final _TranslationsRecipeDetailTaIn recipeDetail = _TranslationsRecipeDetailTaIn._(_root);
	@override late final _TranslationsFiltersTaIn filters = _TranslationsFiltersTaIn._(_root);
	@override late final _TranslationsShoppingListTaIn shoppingList = _TranslationsShoppingListTaIn._(_root);
	@override late final _TranslationsMealPlanTaIn mealPlan = _TranslationsMealPlanTaIn._(_root);
	@override late final _TranslationsInventoryTaIn inventory = _TranslationsInventoryTaIn._(_root);
	@override late final _TranslationsBarcodeScanTaIn barcodeScan = _TranslationsBarcodeScanTaIn._(_root);
	@override late final _TranslationsReceiptScanTaIn receiptScan = _TranslationsReceiptScanTaIn._(_root);
	@override late final _TranslationsBatchCookingTaIn batchCooking = _TranslationsBatchCookingTaIn._(_root);
	@override late final _TranslationsVisitedDomainsTaIn visitedDomains = _TranslationsVisitedDomainsTaIn._(_root);
	@override late final _TranslationsDomainDiscoveryTaIn domainDiscovery = _TranslationsDomainDiscoveryTaIn._(_root);
	@override late final _TranslationsInventorySuggestionsTaIn inventorySuggestions = _TranslationsInventorySuggestionsTaIn._(_root);
	@override late final _TranslationsUpgradeTaIn upgrade = _TranslationsUpgradeTaIn._(_root);
	@override late final _TranslationsTourTaIn tour = _TranslationsTourTaIn._(_root);
	@override late final _TranslationsManualRecipeTaIn manualRecipe = _TranslationsManualRecipeTaIn._(_root);
	@override late final _TranslationsRecipeEditTaIn recipeEdit = _TranslationsRecipeEditTaIn._(_root);
	@override late final _TranslationsErrorsTaIn errors = _TranslationsErrorsTaIn._(_root);
}

// Path: app
class _TranslationsAppTaIn extends TranslationsAppEn {
	_TranslationsAppTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);

	final TranslationsTaIn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTaIn extends TranslationsHomeEn {
	_TranslationsHomeTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTaIn extends TranslationsCommonEn {
	_TranslationsCommonTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTaIn extends TranslationsSettingsEn {
	_TranslationsSettingsTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);

	final TranslationsTaIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTaIn measurements = _TranslationsSettingsMeasurementsTaIn._(_root);
	@override late final _TranslationsSettingsDataManagementTaIn dataManagement = _TranslationsSettingsDataManagementTaIn._(_root);
	@override late final _TranslationsSettingsVersionTaIn version = _TranslationsSettingsVersionTaIn._(_root);
}

// Path: recipes
class _TranslationsRecipesTaIn extends TranslationsRecipesEn {
	_TranslationsRecipesTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTaIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTaIn nutrition = _TranslationsRecipeDetailNutritionTaIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTaIn prepAhead = _TranslationsRecipeDetailPrepAheadTaIn._(_root);
...
// Path: filters
class _TranslationsFiltersTaIn extends TranslationsFiltersEn {
	_TranslationsFiltersTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTaIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTaIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTaIn extends TranslationsInventoryEn {
	_TranslationsInventoryTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTaIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTaIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTaIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTaIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTaIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTaIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTaIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTaIn extends TranslationsTourEn {
	_TranslationsTourTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTaIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTaIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTaIn extends TranslationsErrorsEn {
	_TranslationsErrorsTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTaIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTaIn metric = _TranslationsSettingsMeasurementsMetricTaIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTaIn imperial = _TranslationsSettingsMeasurementsImperialTaIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTaIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTaIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTaIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTaIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTaIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTaIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTaIn._(TranslationsTaIn root) : this._root = root, super.internal(root);
