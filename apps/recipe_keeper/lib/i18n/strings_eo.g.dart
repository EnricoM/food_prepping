...
class TranslationsEo extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppEo app = _TranslationsAppEo._(_root);
	...
	@override late final _TranslationsRecipesEo recipes = _TranslationsRecipesEo._(_root);
	@override late final _TranslationsRecipeDetailEo recipeDetail = _TranslationsRecipeDetailEo._(_root);
	@override late final _TranslationsFiltersEo filters = _TranslationsFiltersEo._(_root);
	@override late final _TranslationsShoppingListEo shoppingList = _TranslationsShoppingListEo._(_root);
	@override late final _TranslationsMealPlanEo mealPlan = _TranslationsMealPlanEo._(_root);
	@override late final _TranslationsInventoryEo inventory = _TranslationsInventoryEo._(_root);
	@override late final _TranslationsBarcodeScanEo barcodeScan = _TranslationsBarcodeScanEo._(_root);
	@override late final _TranslationsReceiptScanEo receiptScan = _TranslationsReceiptScanEo._(_root);
	@override late final _TranslationsBatchCookingEo batchCooking = _TranslationsBatchCookingEo._(_root);
	@override late final _TranslationsVisitedDomainsEo visitedDomains = _TranslationsVisitedDomainsEo._(_root);
	@override late final _TranslationsDomainDiscoveryEo domainDiscovery = _TranslationsDomainDiscoveryEo._(_root);
	@override late final _TranslationsInventorySuggestionsEo inventorySuggestions = _TranslationsInventorySuggestionsEo._(_root);
	@override late final _TranslationsUpgradeEo upgrade = _TranslationsUpgradeEo._(_root);
	@override late final _TranslationsTourEo tour = _TranslationsTourEo._(_root);
	@override late final _TranslationsManualRecipeEo manualRecipe = _TranslationsManualRecipeEo._(_root);
	@override late final _TranslationsRecipeEditEo recipeEdit = _TranslationsRecipeEditEo._(_root);
	@override late final _TranslationsErrorsEo errors = _TranslationsErrorsEo._(_root);
}

// Path: app
class _TranslationsAppEo extends TranslationsAppEn {
	_TranslationsAppEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsEo extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsEo measurements = _TranslationsSettingsMeasurementsEo._(_root);
	@override late final _TranslationsSettingsDataManagementEo dataManagement = _TranslationsSettingsDataManagementEo._(_root);
	@override late final _TranslationsSettingsVersionEo version = _TranslationsSettingsVersionEo._(_root);
}

// Path: recipes
class _TranslationsRecipesEo extends TranslationsRecipesEn {
	_TranslationsRecipesEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEo._(TranslationsEo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEo nutrition = _TranslationsRecipeDetailNutritionEo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEo prepAhead = _TranslationsRecipeDetailPrepAheadEo._(_root);
...
// Path: filters
class _TranslationsFiltersEo extends TranslationsFiltersEn {
	_TranslationsFiltersEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEo extends TranslationsShoppingListEn {
	_TranslationsShoppingListEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEo extends TranslationsMealPlanEn {
	_TranslationsMealPlanEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEo extends TranslationsInventoryEn {
	_TranslationsInventoryEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEo extends TranslationsUpgradeEn {
	_TranslationsUpgradeEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEo extends TranslationsTourEn {
	_TranslationsTourEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEo extends TranslationsErrorsEn {
	_TranslationsErrorsEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEo._(TranslationsEo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEo metric = _TranslationsSettingsMeasurementsMetricEo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEo imperial = _TranslationsSettingsMeasurementsImperialEo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEo._(TranslationsEo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEo._(TranslationsEo root) : this._root = root, super.internal(root);
