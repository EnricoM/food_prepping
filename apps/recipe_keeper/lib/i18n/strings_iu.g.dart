...
// Path: <root>
class TranslationsIu extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsIu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <iu>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsIu _root = this; // ignore: unused_field

	@override 
	TranslationsIu $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsIu(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppIu app = _TranslationsAppIu._(_root);
	@override late final _TranslationsHomeIu home = _TranslationsHomeIu._(_root);
	@override late final _TranslationsCommonIu common = _TranslationsCommonIu._(_root);
	@override late final _TranslationsSettingsIu settings = _TranslationsSettingsIu._(_root);
	@override late final _TranslationsRecipesIu recipes = _TranslationsRecipesIu._(_root);
	@override late final _TranslationsRecipeDetailIu recipeDetail = _TranslationsRecipeDetailIu._(_root);
	@override late final _TranslationsFiltersIu filters = _TranslationsFiltersIu._(_root);
	@override late final _TranslationsShoppingListIu shoppingList = _TranslationsShoppingListIu._(_root);
	@override late final _TranslationsMealPlanIu mealPlan = _TranslationsMealPlanIu._(_root);
	@override late final _TranslationsInventoryIu inventory = _TranslationsInventoryIu._(_root);
	@override late final _TranslationsBarcodeScanIu barcodeScan = _TranslationsBarcodeScanIu._(_root);
	@override late final _TranslationsReceiptScanIu receiptScan = _TranslationsReceiptScanIu._(_root);
	@override late final _TranslationsBatchCookingIu batchCooking = _TranslationsBatchCookingIu._(_root);
	@override late final _TranslationsVisitedDomainsIu visitedDomains = _TranslationsVisitedDomainsIu._(_root);
	@override late final _TranslationsDomainDiscoveryIu domainDiscovery = _TranslationsDomainDiscoveryIu._(_root);
	@override late final _TranslationsInventorySuggestionsIu inventorySuggestions = _TranslationsInventorySuggestionsIu._(_root);
	@override late final _TranslationsUpgradeIu upgrade = _TranslationsUpgradeIu._(_root);
	@override late final _TranslationsTourIu tour = _TranslationsTourIu._(_root);
	@override late final _TranslationsManualRecipeIu manualRecipe = _TranslationsManualRecipeIu._(_root);
	@override late final _TranslationsRecipeEditIu recipeEdit = _TranslationsRecipeEditIu._(_root);
	@override late final _TranslationsErrorsIu errors = _TranslationsErrorsIu._(_root);
}

// Path: app
class _TranslationsAppIu extends TranslationsAppEn {
	_TranslationsAppIu._(TranslationsIu root) : this._root = root, super.internal(root);

	final TranslationsIu _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIu extends TranslationsHomeEn {
	_TranslationsHomeIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIu extends TranslationsCommonEn {
	_TranslationsCommonIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIu extends TranslationsSettingsEn {
	_TranslationsSettingsIu._(TranslationsIu root) : this._root = root, super.internal(root);

	final TranslationsIu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIu measurements = _TranslationsSettingsMeasurementsIu._(_root);
	@override late final _TranslationsSettingsDataManagementIu dataManagement = _TranslationsSettingsDataManagementIu._(_root);
	@override late final _TranslationsSettingsVersionIu version = _TranslationsSettingsVersionIu._(_root);
}

// Path: recipes
class _TranslationsRecipesIu extends TranslationsRecipesEn {
	_TranslationsRecipesIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIu._(TranslationsIu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIu nutrition = _TranslationsRecipeDetailNutritionIu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIu prepAhead = _TranslationsRecipeDetailPrepAheadIu._(_root);
...
// Path: filters
class _TranslationsFiltersIu extends TranslationsFiltersEn {
	_TranslationsFiltersIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIu extends TranslationsShoppingListEn {
	_TranslationsShoppingListIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIu extends TranslationsMealPlanEn {
	_TranslationsMealPlanIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIu extends TranslationsInventoryEn {
	_TranslationsInventoryIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIu extends TranslationsUpgradeEn {
	_TranslationsUpgradeIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIu extends TranslationsTourEn {
	_TranslationsTourIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIu extends TranslationsErrorsEn {
	_TranslationsErrorsIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIu._(TranslationsIu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIu metric = _TranslationsSettingsMeasurementsMetricIu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIu imperial = _TranslationsSettingsMeasurementsImperialIu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIu._(TranslationsIu root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <iu>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsIu {
