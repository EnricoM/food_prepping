...
class TranslationsGuIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppGuIn app = _TranslationsAppGuIn._(_root);
	@override late final _TranslationsHomeGuIn home = _TranslationsHomeGuIn._(_root);
	@override late final _TranslationsCommonGuIn common = _TranslationsCommonGuIn._(_root);
	@override late final _TranslationsSettingsGuIn settings = _TranslationsSettingsGuIn._(_root);
	@override late final _TranslationsRecipesGuIn recipes = _TranslationsRecipesGuIn._(_root);
	@override late final _TranslationsRecipeDetailGuIn recipeDetail = _TranslationsRecipeDetailGuIn._(_root);
	@override late final _TranslationsFiltersGuIn filters = _TranslationsFiltersGuIn._(_root);
	@override late final _TranslationsShoppingListGuIn shoppingList = _TranslationsShoppingListGuIn._(_root);
	@override late final _TranslationsMealPlanGuIn mealPlan = _TranslationsMealPlanGuIn._(_root);
	@override late final _TranslationsInventoryGuIn inventory = _TranslationsInventoryGuIn._(_root);
	@override late final _TranslationsBarcodeScanGuIn barcodeScan = _TranslationsBarcodeScanGuIn._(_root);
	@override late final _TranslationsReceiptScanGuIn receiptScan = _TranslationsReceiptScanGuIn._(_root);
	@override late final _TranslationsBatchCookingGuIn batchCooking = _TranslationsBatchCookingGuIn._(_root);
	@override late final _TranslationsVisitedDomainsGuIn visitedDomains = _TranslationsVisitedDomainsGuIn._(_root);
	@override late final _TranslationsDomainDiscoveryGuIn domainDiscovery = _TranslationsDomainDiscoveryGuIn._(_root);
	@override late final _TranslationsInventorySuggestionsGuIn inventorySuggestions = _TranslationsInventorySuggestionsGuIn._(_root);
	@override late final _TranslationsUpgradeGuIn upgrade = _TranslationsUpgradeGuIn._(_root);
	@override late final _TranslationsTourGuIn tour = _TranslationsTourGuIn._(_root);
	@override late final _TranslationsManualRecipeGuIn manualRecipe = _TranslationsManualRecipeGuIn._(_root);
	@override late final _TranslationsRecipeEditGuIn recipeEdit = _TranslationsRecipeEditGuIn._(_root);
	@override late final _TranslationsErrorsGuIn errors = _TranslationsErrorsGuIn._(_root);
}

// Path: app
class _TranslationsAppGuIn extends TranslationsAppEn {
	_TranslationsAppGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeGuIn extends TranslationsHomeEn {
	_TranslationsHomeGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonGuIn extends TranslationsCommonEn {
	_TranslationsCommonGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsGuIn extends TranslationsSettingsEn {
	_TranslationsSettingsGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);

	final TranslationsGuIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsGuIn measurements = _TranslationsSettingsMeasurementsGuIn._(_root);
	@override late final _TranslationsSettingsDataManagementGuIn dataManagement = _TranslationsSettingsDataManagementGuIn._(_root);
	@override late final _TranslationsSettingsVersionGuIn version = _TranslationsSettingsVersionGuIn._(_root);
}

// Path: recipes
class _TranslationsRecipesGuIn extends TranslationsRecipesEn {
	_TranslationsRecipesGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGuIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGuIn nutrition = _TranslationsRecipeDetailNutritionGuIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGuIn prepAhead = _TranslationsRecipeDetailPrepAheadGuIn._(_root);
...
// Path: filters
class _TranslationsFiltersGuIn extends TranslationsFiltersEn {
	_TranslationsFiltersGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGuIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGuIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGuIn extends TranslationsInventoryEn {
	_TranslationsInventoryGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGuIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGuIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGuIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGuIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGuIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGuIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGuIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGuIn extends TranslationsTourEn {
	_TranslationsTourGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGuIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGuIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsGuIn extends TranslationsErrorsEn {
	_TranslationsErrorsGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGuIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGuIn metric = _TranslationsSettingsMeasurementsMetricGuIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGuIn imperial = _TranslationsSettingsMeasurementsImperialGuIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGuIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGuIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGuIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGuIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGuIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGuIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGuIn._(TranslationsGuIn root) : this._root = root, super.internal(root);
