...
// Path: <root>
class TranslationsCeb extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCeb({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.ceb,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ceb>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsCeb _root = this; // ignore: unused_field

	@override 
	TranslationsCeb $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCeb(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCeb app = _TranslationsAppCeb._(_root);
	@override late final _TranslationsHomeCeb home = _TranslationsHomeCeb._(_root);
	@override late final _TranslationsCommonCeb common = _TranslationsCommonCeb._(_root);
	@override late final _TranslationsSettingsCeb settings = _TranslationsSettingsCeb._(_root);
	@override late final _TranslationsRecipesCeb recipes = _TranslationsRecipesCeb._(_root);
	@override late final _TranslationsRecipeDetailCeb recipeDetail = _TranslationsRecipeDetailCeb._(_root);
	@override late final _TranslationsFiltersCeb filters = _TranslationsFiltersCeb._(_root);
	@override late final _TranslationsShoppingListCeb shoppingList = _TranslationsShoppingListCeb._(_root);
	@override late final _TranslationsMealPlanCeb mealPlan = _TranslationsMealPlanCeb._(_root);
	@override late final _TranslationsInventoryCeb inventory = _TranslationsInventoryCeb._(_root);
	@override late final _TranslationsBarcodeScanCeb barcodeScan = _TranslationsBarcodeScanCeb._(_root);
	@override late final _TranslationsReceiptScanCeb receiptScan = _TranslationsReceiptScanCeb._(_root);
	@override late final _TranslationsBatchCookingCeb batchCooking = _TranslationsBatchCookingCeb._(_root);
	@override late final _TranslationsVisitedDomainsCeb visitedDomains = _TranslationsVisitedDomainsCeb._(_root);
	@override late final _TranslationsDomainDiscoveryCeb domainDiscovery = _TranslationsDomainDiscoveryCeb._(_root);
	@override late final _TranslationsInventorySuggestionsCeb inventorySuggestions = _TranslationsInventorySuggestionsCeb._(_root);
	@override late final _TranslationsUpgradeCeb upgrade = _TranslationsUpgradeCeb._(_root);
	@override late final _TranslationsTourCeb tour = _TranslationsTourCeb._(_root);
	@override late final _TranslationsManualRecipeCeb manualRecipe = _TranslationsManualRecipeCeb._(_root);
	@override late final _TranslationsRecipeEditCeb recipeEdit = _TranslationsRecipeEditCeb._(_root);
	@override late final _TranslationsErrorsCeb errors = _TranslationsErrorsCeb._(_root);
}

// Path: app
class _TranslationsAppCeb extends TranslationsAppEn {
	_TranslationsAppCeb._(TranslationsCeb root) : this._root = root, super.internal(root);

	final TranslationsCeb _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeCeb extends TranslationsHomeEn {
	_TranslationsHomeCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCeb extends TranslationsCommonEn {
	_TranslationsCommonCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCeb extends TranslationsSettingsEn {
	_TranslationsSettingsCeb._(TranslationsCeb root) : this._root = root, super.internal(root);

	final TranslationsCeb _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCeb measurements = _TranslationsSettingsMeasurementsCeb._(_root);
	@override late final _TranslationsSettingsDataManagementCeb dataManagement = _TranslationsSettingsDataManagementCeb._(_root);
	@override late final _TranslationsSettingsVersionCeb version = _TranslationsSettingsVersionCeb._(_root);
}

// Path: recipes
class _TranslationsRecipesCeb extends TranslationsRecipesEn {
	_TranslationsRecipesCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCeb extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCeb nutrition = _TranslationsRecipeDetailNutritionCeb._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCeb prepAhead = _TranslationsRecipeDetailPrepAheadCeb._(_root);
...
// Path: filters
class _TranslationsFiltersCeb extends TranslationsFiltersEn {
	_TranslationsFiltersCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCeb extends TranslationsShoppingListEn {
	_TranslationsShoppingListCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCeb extends TranslationsMealPlanEn {
	_TranslationsMealPlanCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCeb extends TranslationsInventoryEn {
	_TranslationsInventoryCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCeb extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCeb extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCeb extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCeb extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCeb extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCeb extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCeb extends TranslationsUpgradeEn {
	_TranslationsUpgradeCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCeb extends TranslationsTourEn {
	_TranslationsTourCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCeb extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCeb extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCeb extends TranslationsErrorsEn {
	_TranslationsErrorsCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCeb extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCeb metric = _TranslationsSettingsMeasurementsMetricCeb._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCeb imperial = _TranslationsSettingsMeasurementsImperialCeb._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCeb extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCeb extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCeb extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCeb extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCeb extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCeb extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCeb._(TranslationsCeb root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ceb>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsCeb {
