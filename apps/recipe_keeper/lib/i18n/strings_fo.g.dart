...
// Path: <root>
class TranslationsFo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsFo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <fo>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsFo _root = this; // ignore: unused_field

	@override 
	TranslationsFo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsFo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppFo app = _TranslationsAppFo._(_root);
	@override late final _TranslationsHomeFo home = _TranslationsHomeFo._(_root);
	@override late final _TranslationsCommonFo common = _TranslationsCommonFo._(_root);
	@override late final _TranslationsSettingsFo settings = _TranslationsSettingsFo._(_root);
	@override late final _TranslationsRecipesFo recipes = _TranslationsRecipesFo._(_root);
	@override late final _TranslationsRecipeDetailFo recipeDetail = _TranslationsRecipeDetailFo._(_root);
	@override late final _TranslationsFiltersFo filters = _TranslationsFiltersFo._(_root);
	@override late final _TranslationsShoppingListFo shoppingList = _TranslationsShoppingListFo._(_root);
	@override late final _TranslationsMealPlanFo mealPlan = _TranslationsMealPlanFo._(_root);
	@override late final _TranslationsInventoryFo inventory = _TranslationsInventoryFo._(_root);
	@override late final _TranslationsBarcodeScanFo barcodeScan = _TranslationsBarcodeScanFo._(_root);
	@override late final _TranslationsReceiptScanFo receiptScan = _TranslationsReceiptScanFo._(_root);
	@override late final _TranslationsBatchCookingFo batchCooking = _TranslationsBatchCookingFo._(_root);
	@override late final _TranslationsVisitedDomainsFo visitedDomains = _TranslationsVisitedDomainsFo._(_root);
	@override late final _TranslationsDomainDiscoveryFo domainDiscovery = _TranslationsDomainDiscoveryFo._(_root);
	@override late final _TranslationsInventorySuggestionsFo inventorySuggestions = _TranslationsInventorySuggestionsFo._(_root);
	@override late final _TranslationsUpgradeFo upgrade = _TranslationsUpgradeFo._(_root);
	@override late final _TranslationsTourFo tour = _TranslationsTourFo._(_root);
	@override late final _TranslationsManualRecipeFo manualRecipe = _TranslationsManualRecipeFo._(_root);
	@override late final _TranslationsRecipeEditFo recipeEdit = _TranslationsRecipeEditFo._(_root);
	@override late final _TranslationsErrorsFo errors = _TranslationsErrorsFo._(_root);
}

// Path: app
class _TranslationsAppFo extends TranslationsAppEn {
	_TranslationsAppFo._(TranslationsFo root) : this._root = root, super.internal(root);

	final TranslationsFo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeFo extends TranslationsHomeEn {
	_TranslationsHomeFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonFo extends TranslationsCommonEn {
	_TranslationsCommonFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsFo extends TranslationsSettingsEn {
	_TranslationsSettingsFo._(TranslationsFo root) : this._root = root, super.internal(root);

	final TranslationsFo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsFo measurements = _TranslationsSettingsMeasurementsFo._(_root);
	@override late final _TranslationsSettingsDataManagementFo dataManagement = _TranslationsSettingsDataManagementFo._(_root);
	@override late final _TranslationsSettingsVersionFo version = _TranslationsSettingsVersionFo._(_root);
}

// Path: recipes
class _TranslationsRecipesFo extends TranslationsRecipesEn {
	_TranslationsRecipesFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFo._(TranslationsFo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFo nutrition = _TranslationsRecipeDetailNutritionFo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFo prepAhead = _TranslationsRecipeDetailPrepAheadFo._(_root);
...
// Path: filters
class _TranslationsFiltersFo extends TranslationsFiltersEn {
	_TranslationsFiltersFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFo extends TranslationsShoppingListEn {
	_TranslationsShoppingListFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFo extends TranslationsMealPlanEn {
	_TranslationsMealPlanFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFo extends TranslationsInventoryEn {
	_TranslationsInventoryFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFo extends TranslationsUpgradeEn {
	_TranslationsUpgradeFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFo extends TranslationsTourEn {
	_TranslationsTourFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsFo extends TranslationsErrorsEn {
	_TranslationsErrorsFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFo._(TranslationsFo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFo metric = _TranslationsSettingsMeasurementsMetricFo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFo imperial = _TranslationsSettingsMeasurementsImperialFo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFo._(TranslationsFo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <fo>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsFo {
