...
class TranslationsEsEs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsHomeEsEs home = _TranslationsHomeEsEs._(_root);
	@override late final _TranslationsCommonEsEs common = _TranslationsCommonEsEs._(_root);
	@override late final _TranslationsSettingsEsEs settings = _TranslationsSettingsEsEs._(_root);
	@override late final _TranslationsRecipesEsEs recipes = _TranslationsRecipesEsEs._(_root);
	@override late final _TranslationsRecipeDetailEsEs recipeDetail = _TranslationsRecipeDetailEsEs._(_root);
	@override late final _TranslationsFiltersEsEs filters = _TranslationsFiltersEsEs._(_root);
	@override late final _TranslationsShoppingListEsEs shoppingList = _TranslationsShoppingListEsEs._(_root);
	@override late final _TranslationsMealPlanEsEs mealPlan = _TranslationsMealPlanEsEs._(_root);
	@override late final _TranslationsInventoryEsEs inventory = _TranslationsInventoryEsEs._(_root);
	@override late final _TranslationsBarcodeScanEsEs barcodeScan = _TranslationsBarcodeScanEsEs._(_root);
	@override late final _TranslationsReceiptScanEsEs receiptScan = _TranslationsReceiptScanEsEs._(_root);
	@override late final _TranslationsBatchCookingEsEs batchCooking = _TranslationsBatchCookingEsEs._(_root);
	@override late final _TranslationsVisitedDomainsEsEs visitedDomains = _TranslationsVisitedDomainsEsEs._(_root);
	@override late final _TranslationsDomainDiscoveryEsEs domainDiscovery = _TranslationsDomainDiscoveryEsEs._(_root);
	@override late final _TranslationsInventorySuggestionsEsEs inventorySuggestions = _TranslationsInventorySuggestionsEsEs._(_root);
	@override late final _TranslationsUpgradeEsEs upgrade = _TranslationsUpgradeEsEs._(_root);
	@override late final _TranslationsTourEsEs tour = _TranslationsTourEsEs._(_root);
	@override late final _TranslationsManualRecipeEsEs manualRecipe = _TranslationsManualRecipeEsEs._(_root);
	@override late final _TranslationsRecipeEditEsEs recipeEdit = _TranslationsRecipeEditEsEs._(_root);
	@override late final _TranslationsErrorsEsEs errors = _TranslationsErrorsEsEs._(_root);
}

// Path: app
class _TranslationsAppEsEs extends TranslationsAppEn {
	_TranslationsAppEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeEsEs extends TranslationsHomeEn {
	_TranslationsHomeEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEsEs extends TranslationsCommonEn {
	_TranslationsCommonEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEsEs extends TranslationsSettingsEn {
	_TranslationsSettingsEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);

	final TranslationsEsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEsEs measurements = _TranslationsSettingsMeasurementsEsEs._(_root);
	@override late final _TranslationsSettingsDataManagementEsEs dataManagement = _TranslationsSettingsDataManagementEsEs._(_root);
	@override late final _TranslationsSettingsVersionEsEs version = _TranslationsSettingsVersionEsEs._(_root);
}

// Path: recipes
class _TranslationsRecipesEsEs extends TranslationsRecipesEn {
	_TranslationsRecipesEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEsEs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEsEs nutrition = _TranslationsRecipeDetailNutritionEsEs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEsEs prepAhead = _TranslationsRecipeDetailPrepAheadEsEs._(_root);
...
// Path: filters
class _TranslationsFiltersEsEs extends TranslationsFiltersEn {
	_TranslationsFiltersEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEsEs extends TranslationsShoppingListEn {
	_TranslationsShoppingListEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEsEs extends TranslationsMealPlanEn {
	_TranslationsMealPlanEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEsEs extends TranslationsInventoryEn {
	_TranslationsInventoryEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEsEs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEsEs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEsEs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEsEs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEsEs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEsEs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEsEs extends TranslationsUpgradeEn {
	_TranslationsUpgradeEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEsEs extends TranslationsTourEn {
	_TranslationsTourEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEsEs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEsEs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEsEs extends TranslationsErrorsEn {
	_TranslationsErrorsEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEsEs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEsEs metric = _TranslationsSettingsMeasurementsMetricEsEs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEsEs imperial = _TranslationsSettingsMeasurementsImperialEsEs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEsEs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEsEs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEsEs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEsEs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEsEs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEsEs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEsEs._(TranslationsEsEs root) : this._root = root, super.internal(root);
