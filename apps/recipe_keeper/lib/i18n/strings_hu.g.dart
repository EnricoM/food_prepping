...
class TranslationsHu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppHu app = _TranslationsAppHu._(_root);
	...
	@override late final _TranslationsRecipesHu recipes = _TranslationsRecipesHu._(_root);
	@override late final _TranslationsRecipeDetailHu recipeDetail = _TranslationsRecipeDetailHu._(_root);
	@override late final _TranslationsFiltersHu filters = _TranslationsFiltersHu._(_root);
	@override late final _TranslationsShoppingListHu shoppingList = _TranslationsShoppingListHu._(_root);
	@override late final _TranslationsMealPlanHu mealPlan = _TranslationsMealPlanHu._(_root);
	@override late final _TranslationsInventoryHu inventory = _TranslationsInventoryHu._(_root);
	@override late final _TranslationsBarcodeScanHu barcodeScan = _TranslationsBarcodeScanHu._(_root);
	@override late final _TranslationsReceiptScanHu receiptScan = _TranslationsReceiptScanHu._(_root);
	@override late final _TranslationsBatchCookingHu batchCooking = _TranslationsBatchCookingHu._(_root);
	@override late final _TranslationsVisitedDomainsHu visitedDomains = _TranslationsVisitedDomainsHu._(_root);
	@override late final _TranslationsDomainDiscoveryHu domainDiscovery = _TranslationsDomainDiscoveryHu._(_root);
	@override late final _TranslationsInventorySuggestionsHu inventorySuggestions = _TranslationsInventorySuggestionsHu._(_root);
	@override late final _TranslationsUpgradeHu upgrade = _TranslationsUpgradeHu._(_root);
	@override late final _TranslationsTourHu tour = _TranslationsTourHu._(_root);
	@override late final _TranslationsManualRecipeHu manualRecipe = _TranslationsManualRecipeHu._(_root);
	@override late final _TranslationsRecipeEditHu recipeEdit = _TranslationsRecipeEditHu._(_root);
	@override late final _TranslationsErrorsHu errors = _TranslationsErrorsHu._(_root);
}

// Path: app
class _TranslationsAppHu extends TranslationsAppEn {
	_TranslationsAppHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsHu extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsHu measurements = _TranslationsSettingsMeasurementsHu._(_root);
	@override late final _TranslationsSettingsDataManagementHu dataManagement = _TranslationsSettingsDataManagementHu._(_root);
	@override late final _TranslationsSettingsVersionHu version = _TranslationsSettingsVersionHu._(_root);
}

// Path: recipes
class _TranslationsRecipesHu extends TranslationsRecipesEn {
	_TranslationsRecipesHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHu._(TranslationsHu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHu nutrition = _TranslationsRecipeDetailNutritionHu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHu prepAhead = _TranslationsRecipeDetailPrepAheadHu._(_root);
...
// Path: filters
class _TranslationsFiltersHu extends TranslationsFiltersEn {
	_TranslationsFiltersHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHu extends TranslationsShoppingListEn {
	_TranslationsShoppingListHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHu extends TranslationsMealPlanEn {
	_TranslationsMealPlanHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHu extends TranslationsInventoryEn {
	_TranslationsInventoryHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHu extends TranslationsUpgradeEn {
	_TranslationsUpgradeHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHu extends TranslationsTourEn {
	_TranslationsTourHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHu._(TranslationsHu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHu metric = _TranslationsSettingsMeasurementsMetricHu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHu imperial = _TranslationsSettingsMeasurementsImperialHu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHu._(TranslationsHu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHu._(TranslationsHu root) : this._root = root, super.internal(root);
