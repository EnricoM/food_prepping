...
// Path: <root>
class TranslationsTiEt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTiEt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.tiEt,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ti-ET>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTiEt _root = this; // ignore: unused_field

	@override 
	TranslationsTiEt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTiEt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTiEt app = _TranslationsAppTiEt._(_root);
	@override late final _TranslationsHomeTiEt home = _TranslationsHomeTiEt._(_root);
	@override late final _TranslationsCommonTiEt common = _TranslationsCommonTiEt._(_root);
	@override late final _TranslationsSettingsTiEt settings = _TranslationsSettingsTiEt._(_root);
	@override late final _TranslationsRecipesTiEt recipes = _TranslationsRecipesTiEt._(_root);
	@override late final _TranslationsRecipeDetailTiEt recipeDetail = _TranslationsRecipeDetailTiEt._(_root);
	@override late final _TranslationsFiltersTiEt filters = _TranslationsFiltersTiEt._(_root);
	@override late final _TranslationsShoppingListTiEt shoppingList = _TranslationsShoppingListTiEt._(_root);
	@override late final _TranslationsMealPlanTiEt mealPlan = _TranslationsMealPlanTiEt._(_root);
	@override late final _TranslationsInventoryTiEt inventory = _TranslationsInventoryTiEt._(_root);
	@override late final _TranslationsBarcodeScanTiEt barcodeScan = _TranslationsBarcodeScanTiEt._(_root);
	@override late final _TranslationsReceiptScanTiEt receiptScan = _TranslationsReceiptScanTiEt._(_root);
	@override late final _TranslationsBatchCookingTiEt batchCooking = _TranslationsBatchCookingTiEt._(_root);
	@override late final _TranslationsVisitedDomainsTiEt visitedDomains = _TranslationsVisitedDomainsTiEt._(_root);
	@override late final _TranslationsDomainDiscoveryTiEt domainDiscovery = _TranslationsDomainDiscoveryTiEt._(_root);
	@override late final _TranslationsInventorySuggestionsTiEt inventorySuggestions = _TranslationsInventorySuggestionsTiEt._(_root);
	@override late final _TranslationsUpgradeTiEt upgrade = _TranslationsUpgradeTiEt._(_root);
	@override late final _TranslationsTourTiEt tour = _TranslationsTourTiEt._(_root);
	@override late final _TranslationsManualRecipeTiEt manualRecipe = _TranslationsManualRecipeTiEt._(_root);
	@override late final _TranslationsRecipeEditTiEt recipeEdit = _TranslationsRecipeEditTiEt._(_root);
	@override late final _TranslationsErrorsTiEt errors = _TranslationsErrorsTiEt._(_root);
}

// Path: app
class _TranslationsAppTiEt extends TranslationsAppEn {
	_TranslationsAppTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);

	final TranslationsTiEt _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTiEt extends TranslationsHomeEn {
	_TranslationsHomeTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTiEt extends TranslationsCommonEn {
	_TranslationsCommonTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTiEt extends TranslationsSettingsEn {
	_TranslationsSettingsTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);

	final TranslationsTiEt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTiEt measurements = _TranslationsSettingsMeasurementsTiEt._(_root);
	@override late final _TranslationsSettingsDataManagementTiEt dataManagement = _TranslationsSettingsDataManagementTiEt._(_root);
	@override late final _TranslationsSettingsVersionTiEt version = _TranslationsSettingsVersionTiEt._(_root);
}

// Path: recipes
class _TranslationsRecipesTiEt extends TranslationsRecipesEn {
	_TranslationsRecipesTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTiEt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTiEt nutrition = _TranslationsRecipeDetailNutritionTiEt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTiEt prepAhead = _TranslationsRecipeDetailPrepAheadTiEt._(_root);
...
// Path: filters
class _TranslationsFiltersTiEt extends TranslationsFiltersEn {
	_TranslationsFiltersTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTiEt extends TranslationsShoppingListEn {
	_TranslationsShoppingListTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTiEt extends TranslationsMealPlanEn {
	_TranslationsMealPlanTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTiEt extends TranslationsInventoryEn {
	_TranslationsInventoryTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTiEt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTiEt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTiEt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTiEt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTiEt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTiEt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTiEt extends TranslationsUpgradeEn {
	_TranslationsUpgradeTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTiEt extends TranslationsTourEn {
	_TranslationsTourTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTiEt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTiEt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTiEt extends TranslationsErrorsEn {
	_TranslationsErrorsTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTiEt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTiEt metric = _TranslationsSettingsMeasurementsMetricTiEt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTiEt imperial = _TranslationsSettingsMeasurementsImperialTiEt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTiEt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTiEt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTiEt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTiEt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTiEt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTiEt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTiEt._(TranslationsTiEt root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ti-ET>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTiEt {
