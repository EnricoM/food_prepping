...
class TranslationsBnBd extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppBnBd app = _TranslationsAppBnBd._(_root);
	@override late final _TranslationsHomeBnBd home = _TranslationsHomeBnBd._(_root);
	@override late final _TranslationsCommonBnBd common = _TranslationsCommonBnBd._(_root);
	@override late final _TranslationsSettingsBnBd settings = _TranslationsSettingsBnBd._(_root);
	@override late final _TranslationsRecipesBnBd recipes = _TranslationsRecipesBnBd._(_root);
	@override late final _TranslationsRecipeDetailBnBd recipeDetail = _TranslationsRecipeDetailBnBd._(_root);
	@override late final _TranslationsFiltersBnBd filters = _TranslationsFiltersBnBd._(_root);
	@override late final _TranslationsShoppingListBnBd shoppingList = _TranslationsShoppingListBnBd._(_root);
	@override late final _TranslationsMealPlanBnBd mealPlan = _TranslationsMealPlanBnBd._(_root);
	@override late final _TranslationsInventoryBnBd inventory = _TranslationsInventoryBnBd._(_root);
	@override late final _TranslationsBarcodeScanBnBd barcodeScan = _TranslationsBarcodeScanBnBd._(_root);
	@override late final _TranslationsReceiptScanBnBd receiptScan = _TranslationsReceiptScanBnBd._(_root);
	@override late final _TranslationsBatchCookingBnBd batchCooking = _TranslationsBatchCookingBnBd._(_root);
	@override late final _TranslationsVisitedDomainsBnBd visitedDomains = _TranslationsVisitedDomainsBnBd._(_root);
	@override late final _TranslationsDomainDiscoveryBnBd domainDiscovery = _TranslationsDomainDiscoveryBnBd._(_root);
	@override late final _TranslationsInventorySuggestionsBnBd inventorySuggestions = _TranslationsInventorySuggestionsBnBd._(_root);
	@override late final _TranslationsUpgradeBnBd upgrade = _TranslationsUpgradeBnBd._(_root);
	@override late final _TranslationsTourBnBd tour = _TranslationsTourBnBd._(_root);
	@override late final _TranslationsManualRecipeBnBd manualRecipe = _TranslationsManualRecipeBnBd._(_root);
	@override late final _TranslationsRecipeEditBnBd recipeEdit = _TranslationsRecipeEditBnBd._(_root);
	@override late final _TranslationsErrorsBnBd errors = _TranslationsErrorsBnBd._(_root);
}

// Path: app
class _TranslationsAppBnBd extends TranslationsAppEn {
	_TranslationsAppBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeBnBd extends TranslationsHomeEn {
	_TranslationsHomeBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBnBd extends TranslationsCommonEn {
	_TranslationsCommonBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBnBd extends TranslationsSettingsEn {
	_TranslationsSettingsBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);

	final TranslationsBnBd _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBnBd measurements = _TranslationsSettingsMeasurementsBnBd._(_root);
	@override late final _TranslationsSettingsDataManagementBnBd dataManagement = _TranslationsSettingsDataManagementBnBd._(_root);
	@override late final _TranslationsSettingsVersionBnBd version = _TranslationsSettingsVersionBnBd._(_root);
}

// Path: recipes
class _TranslationsRecipesBnBd extends TranslationsRecipesEn {
	_TranslationsRecipesBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBnBd extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBnBd nutrition = _TranslationsRecipeDetailNutritionBnBd._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBnBd prepAhead = _TranslationsRecipeDetailPrepAheadBnBd._(_root);
...
// Path: filters
class _TranslationsFiltersBnBd extends TranslationsFiltersEn {
	_TranslationsFiltersBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBnBd extends TranslationsShoppingListEn {
	_TranslationsShoppingListBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBnBd extends TranslationsMealPlanEn {
	_TranslationsMealPlanBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBnBd extends TranslationsInventoryEn {
	_TranslationsInventoryBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBnBd extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBnBd extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBnBd extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBnBd extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBnBd extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBnBd extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBnBd extends TranslationsUpgradeEn {
	_TranslationsUpgradeBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBnBd extends TranslationsTourEn {
	_TranslationsTourBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBnBd extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBnBd extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBnBd extends TranslationsErrorsEn {
	_TranslationsErrorsBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBnBd extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBnBd metric = _TranslationsSettingsMeasurementsMetricBnBd._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBnBd imperial = _TranslationsSettingsMeasurementsImperialBnBd._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBnBd extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBnBd extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBnBd extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBnBd extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBnBd extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBnBd extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBnBd._(TranslationsBnBd root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <bn-BD>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsBnBd {
