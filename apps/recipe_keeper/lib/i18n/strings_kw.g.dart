...
// Path: <root>
class TranslationsKw extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKw({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <kw>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKw _root = this; // ignore: unused_field

	@override 
	TranslationsKw $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKw(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKw app = _TranslationsAppKw._(_root);
	@override late final _TranslationsHomeKw home = _TranslationsHomeKw._(_root);
	@override late final _TranslationsCommonKw common = _TranslationsCommonKw._(_root);
	@override late final _TranslationsSettingsKw settings = _TranslationsSettingsKw._(_root);
	@override late final _TranslationsRecipesKw recipes = _TranslationsRecipesKw._(_root);
	@override late final _TranslationsRecipeDetailKw recipeDetail = _TranslationsRecipeDetailKw._(_root);
	@override late final _TranslationsFiltersKw filters = _TranslationsFiltersKw._(_root);
	@override late final _TranslationsShoppingListKw shoppingList = _TranslationsShoppingListKw._(_root);
	@override late final _TranslationsMealPlanKw mealPlan = _TranslationsMealPlanKw._(_root);
	@override late final _TranslationsInventoryKw inventory = _TranslationsInventoryKw._(_root);
	@override late final _TranslationsBarcodeScanKw barcodeScan = _TranslationsBarcodeScanKw._(_root);
	@override late final _TranslationsReceiptScanKw receiptScan = _TranslationsReceiptScanKw._(_root);
	@override late final _TranslationsBatchCookingKw batchCooking = _TranslationsBatchCookingKw._(_root);
	@override late final _TranslationsVisitedDomainsKw visitedDomains = _TranslationsVisitedDomainsKw._(_root);
	@override late final _TranslationsDomainDiscoveryKw domainDiscovery = _TranslationsDomainDiscoveryKw._(_root);
	@override late final _TranslationsInventorySuggestionsKw inventorySuggestions = _TranslationsInventorySuggestionsKw._(_root);
	@override late final _TranslationsUpgradeKw upgrade = _TranslationsUpgradeKw._(_root);
	@override late final _TranslationsTourKw tour = _TranslationsTourKw._(_root);
	@override late final _TranslationsManualRecipeKw manualRecipe = _TranslationsManualRecipeKw._(_root);
	@override late final _TranslationsRecipeEditKw recipeEdit = _TranslationsRecipeEditKw._(_root);
	@override late final _TranslationsErrorsKw errors = _TranslationsErrorsKw._(_root);
}

// Path: app
class _TranslationsAppKw extends TranslationsAppEn {
	_TranslationsAppKw._(TranslationsKw root) : this._root = root, super.internal(root);

	final TranslationsKw _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKw extends TranslationsHomeEn {
	_TranslationsHomeKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKw extends TranslationsCommonEn {
	_TranslationsCommonKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKw extends TranslationsSettingsEn {
	_TranslationsSettingsKw._(TranslationsKw root) : this._root = root, super.internal(root);

	final TranslationsKw _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKw measurements = _TranslationsSettingsMeasurementsKw._(_root);
	@override late final _TranslationsSettingsDataManagementKw dataManagement = _TranslationsSettingsDataManagementKw._(_root);
	@override late final _TranslationsSettingsVersionKw version = _TranslationsSettingsVersionKw._(_root);
}

// Path: recipes
class _TranslationsRecipesKw extends TranslationsRecipesEn {
	_TranslationsRecipesKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKw extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKw._(TranslationsKw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKw nutrition = _TranslationsRecipeDetailNutritionKw._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKw prepAhead = _TranslationsRecipeDetailPrepAheadKw._(_root);
...
// Path: filters
class _TranslationsFiltersKw extends TranslationsFiltersEn {
	_TranslationsFiltersKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKw extends TranslationsShoppingListEn {
	_TranslationsShoppingListKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKw extends TranslationsMealPlanEn {
	_TranslationsMealPlanKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKw extends TranslationsInventoryEn {
	_TranslationsInventoryKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKw extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKw extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKw extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKw extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKw extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKw extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKw extends TranslationsUpgradeEn {
	_TranslationsUpgradeKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKw extends TranslationsTourEn {
	_TranslationsTourKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKw extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKw extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKw extends TranslationsErrorsEn {
	_TranslationsErrorsKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKw extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKw._(TranslationsKw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKw metric = _TranslationsSettingsMeasurementsMetricKw._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKw imperial = _TranslationsSettingsMeasurementsImperialKw._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKw extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKw extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKw extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKw extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKw extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKw extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKw._(TranslationsKw root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kw>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKw {
