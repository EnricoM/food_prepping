...
// Path: <root>
class TranslationsPs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsPs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsPs _root = this; // ignore: unused_field

	@override 
	TranslationsPs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsPs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppPs app = _TranslationsAppPs._(_root);
	@override late final _TranslationsHomePs home = _TranslationsHomePs._(_root);
	@override late final _TranslationsCommonPs common = _TranslationsCommonPs._(_root);
	@override late final _TranslationsSettingsPs settings = _TranslationsSettingsPs._(_root);
	@override late final _TranslationsRecipesPs recipes = _TranslationsRecipesPs._(_root);
	@override late final _TranslationsRecipeDetailPs recipeDetail = _TranslationsRecipeDetailPs._(_root);
	@override late final _TranslationsFiltersPs filters = _TranslationsFiltersPs._(_root);
	@override late final _TranslationsShoppingListPs shoppingList = _TranslationsShoppingListPs._(_root);
	@override late final _TranslationsMealPlanPs mealPlan = _TranslationsMealPlanPs._(_root);
	@override late final _TranslationsInventoryPs inventory = _TranslationsInventoryPs._(_root);
	@override late final _TranslationsBarcodeScanPs barcodeScan = _TranslationsBarcodeScanPs._(_root);
	@override late final _TranslationsReceiptScanPs receiptScan = _TranslationsReceiptScanPs._(_root);
	@override late final _TranslationsBatchCookingPs batchCooking = _TranslationsBatchCookingPs._(_root);
	@override late final _TranslationsVisitedDomainsPs visitedDomains = _TranslationsVisitedDomainsPs._(_root);
	@override late final _TranslationsDomainDiscoveryPs domainDiscovery = _TranslationsDomainDiscoveryPs._(_root);
	@override late final _TranslationsInventorySuggestionsPs inventorySuggestions = _TranslationsInventorySuggestionsPs._(_root);
	@override late final _TranslationsUpgradePs upgrade = _TranslationsUpgradePs._(_root);
	@override late final _TranslationsTourPs tour = _TranslationsTourPs._(_root);
	@override late final _TranslationsManualRecipePs manualRecipe = _TranslationsManualRecipePs._(_root);
	@override late final _TranslationsRecipeEditPs recipeEdit = _TranslationsRecipeEditPs._(_root);
	@override late final _TranslationsErrorsPs errors = _TranslationsErrorsPs._(_root);
}

// Path: app
class _TranslationsAppPs extends TranslationsAppEn {
	_TranslationsAppPs._(TranslationsPs root) : this._root = root, super.internal(root);

	final TranslationsPs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomePs extends TranslationsHomeEn {
	_TranslationsHomePs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonPs extends TranslationsCommonEn {
	_TranslationsCommonPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsPs extends TranslationsSettingsEn {
	_TranslationsSettingsPs._(TranslationsPs root) : this._root = root, super.internal(root);

	final TranslationsPs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsPs measurements = _TranslationsSettingsMeasurementsPs._(_root);
	@override late final _TranslationsSettingsDataManagementPs dataManagement = _TranslationsSettingsDataManagementPs._(_root);
	@override late final _TranslationsSettingsVersionPs version = _TranslationsSettingsVersionPs._(_root);
}

// Path: recipes
class _TranslationsRecipesPs extends TranslationsRecipesEn {
	_TranslationsRecipesPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPs._(TranslationsPs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPs nutrition = _TranslationsRecipeDetailNutritionPs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPs prepAhead = _TranslationsRecipeDetailPrepAheadPs._(_root);
...
// Path: filters
class _TranslationsFiltersPs extends TranslationsFiltersEn {
	_TranslationsFiltersPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPs extends TranslationsShoppingListEn {
	_TranslationsShoppingListPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPs extends TranslationsMealPlanEn {
	_TranslationsMealPlanPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPs extends TranslationsInventoryEn {
	_TranslationsInventoryPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePs extends TranslationsUpgradeEn {
	_TranslationsUpgradePs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPs extends TranslationsTourEn {
	_TranslationsTourPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsPs extends TranslationsErrorsEn {
	_TranslationsErrorsPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPs._(TranslationsPs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPs metric = _TranslationsSettingsMeasurementsMetricPs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPs imperial = _TranslationsSettingsMeasurementsImperialPs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPs._(TranslationsPs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPs._(TranslationsPs root) : this._root = root, super.internal(root);
