...
// Path: <root>
class TranslationsNeNp extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNeNp({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.neNp,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ne-NP>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNeNp _root = this; // ignore: unused_field

	@override 
	TranslationsNeNp $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNeNp(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNeNp app = _TranslationsAppNeNp._(_root);
	@override late final _TranslationsHomeNeNp home = _TranslationsHomeNeNp._(_root);
	@override late final _TranslationsCommonNeNp common = _TranslationsCommonNeNp._(_root);
	@override late final _TranslationsSettingsNeNp settings = _TranslationsSettingsNeNp._(_root);
	@override late final _TranslationsRecipesNeNp recipes = _TranslationsRecipesNeNp._(_root);
	@override late final _TranslationsRecipeDetailNeNp recipeDetail = _TranslationsRecipeDetailNeNp._(_root);
	@override late final _TranslationsFiltersNeNp filters = _TranslationsFiltersNeNp._(_root);
	@override late final _TranslationsShoppingListNeNp shoppingList = _TranslationsShoppingListNeNp._(_root);
	@override late final _TranslationsMealPlanNeNp mealPlan = _TranslationsMealPlanNeNp._(_root);
	@override late final _TranslationsInventoryNeNp inventory = _TranslationsInventoryNeNp._(_root);
	@override late final _TranslationsBarcodeScanNeNp barcodeScan = _TranslationsBarcodeScanNeNp._(_root);
	@override late final _TranslationsReceiptScanNeNp receiptScan = _TranslationsReceiptScanNeNp._(_root);
	@override late final _TranslationsBatchCookingNeNp batchCooking = _TranslationsBatchCookingNeNp._(_root);
	@override late final _TranslationsVisitedDomainsNeNp visitedDomains = _TranslationsVisitedDomainsNeNp._(_root);
	@override late final _TranslationsDomainDiscoveryNeNp domainDiscovery = _TranslationsDomainDiscoveryNeNp._(_root);
	@override late final _TranslationsInventorySuggestionsNeNp inventorySuggestions = _TranslationsInventorySuggestionsNeNp._(_root);
	@override late final _TranslationsUpgradeNeNp upgrade = _TranslationsUpgradeNeNp._(_root);
	@override late final _TranslationsTourNeNp tour = _TranslationsTourNeNp._(_root);
	@override late final _TranslationsManualRecipeNeNp manualRecipe = _TranslationsManualRecipeNeNp._(_root);
	@override late final _TranslationsRecipeEditNeNp recipeEdit = _TranslationsRecipeEditNeNp._(_root);
	@override late final _TranslationsErrorsNeNp errors = _TranslationsErrorsNeNp._(_root);
}

// Path: app
class _TranslationsAppNeNp extends TranslationsAppEn {
	_TranslationsAppNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);

	final TranslationsNeNp _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNeNp extends TranslationsHomeEn {
	_TranslationsHomeNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNeNp extends TranslationsCommonEn {
	_TranslationsCommonNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNeNp extends TranslationsSettingsEn {
	_TranslationsSettingsNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);

	final TranslationsNeNp _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNeNp measurements = _TranslationsSettingsMeasurementsNeNp._(_root);
	@override late final _TranslationsSettingsDataManagementNeNp dataManagement = _TranslationsSettingsDataManagementNeNp._(_root);
	@override late final _TranslationsSettingsVersionNeNp version = _TranslationsSettingsVersionNeNp._(_root);
}

// Path: recipes
class _TranslationsRecipesNeNp extends TranslationsRecipesEn {
	_TranslationsRecipesNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNeNp extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNeNp nutrition = _TranslationsRecipeDetailNutritionNeNp._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNeNp prepAhead = _TranslationsRecipeDetailPrepAheadNeNp._(_root);
...
// Path: filters
class _TranslationsFiltersNeNp extends TranslationsFiltersEn {
	_TranslationsFiltersNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNeNp extends TranslationsShoppingListEn {
	_TranslationsShoppingListNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNeNp extends TranslationsMealPlanEn {
	_TranslationsMealPlanNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNeNp extends TranslationsInventoryEn {
	_TranslationsInventoryNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNeNp extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNeNp extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNeNp extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNeNp extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNeNp extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNeNp extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNeNp extends TranslationsUpgradeEn {
	_TranslationsUpgradeNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNeNp extends TranslationsTourEn {
	_TranslationsTourNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNeNp extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNeNp extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNeNp extends TranslationsErrorsEn {
	_TranslationsErrorsNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNeNp extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNeNp metric = _TranslationsSettingsMeasurementsMetricNeNp._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNeNp imperial = _TranslationsSettingsMeasurementsImperialNeNp._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNeNp extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNeNp extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNeNp extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNeNp extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNeNp extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNeNp extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNeNp._(TranslationsNeNp root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ne-NP>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNeNp {
