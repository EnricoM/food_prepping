...
// Path: <root>
class TranslationsFrCa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsFrCa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.frCa,
		    overrides: overrides ?? {},
	...
	late final TranslationsFrCa _root = this; // ignore: unused_field

	@override 
	TranslationsFrCa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsFrCa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppFrCa app = _TranslationsAppFrCa._(_root);
	@override late final _TranslationsHomeFrCa home = _TranslationsHomeFrCa._(_root);
	@override late final _TranslationsCommonFrCa common = _TranslationsCommonFrCa._(_root);
	@override late final _TranslationsSettingsFrCa settings = _TranslationsSettingsFrCa._(_root);
	@override late final _TranslationsRecipesFrCa recipes = _TranslationsRecipesFrCa._(_root);
	@override late final _TranslationsRecipeDetailFrCa recipeDetail = _TranslationsRecipeDetailFrCa._(_root);
	@override late final _TranslationsFiltersFrCa filters = _TranslationsFiltersFrCa._(_root);
	@override late final _TranslationsShoppingListFrCa shoppingList = _TranslationsShoppingListFrCa._(_root);
	@override late final _TranslationsMealPlanFrCa mealPlan = _TranslationsMealPlanFrCa._(_root);
	@override late final _TranslationsInventoryFrCa inventory = _TranslationsInventoryFrCa._(_root);
	@override late final _TranslationsBarcodeScanFrCa barcodeScan = _TranslationsBarcodeScanFrCa._(_root);
	@override late final _TranslationsReceiptScanFrCa receiptScan = _TranslationsReceiptScanFrCa._(_root);
	@override late final _TranslationsBatchCookingFrCa batchCooking = _TranslationsBatchCookingFrCa._(_root);
	@override late final _TranslationsVisitedDomainsFrCa visitedDomains = _TranslationsVisitedDomainsFrCa._(_root);
	@override late final _TranslationsDomainDiscoveryFrCa domainDiscovery = _TranslationsDomainDiscoveryFrCa._(_root);
	@override late final _TranslationsInventorySuggestionsFrCa inventorySuggestions = _TranslationsInventorySuggestionsFrCa._(_root);
	@override late final _TranslationsUpgradeFrCa upgrade = _TranslationsUpgradeFrCa._(_root);
	@override late final _TranslationsTourFrCa tour = _TranslationsTourFrCa._(_root);
	@override late final _TranslationsManualRecipeFrCa manualRecipe = _TranslationsManualRecipeFrCa._(_root);
	@override late final _TranslationsRecipeEditFrCa recipeEdit = _TranslationsRecipeEditFrCa._(_root);
	@override late final _TranslationsErrorsFrCa errors = _TranslationsErrorsFrCa._(_root);
}

// Path: app
class _TranslationsAppFrCa extends TranslationsAppEn {
	_TranslationsAppFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);

	final TranslationsFrCa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeFrCa extends TranslationsHomeEn {
	_TranslationsHomeFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonFrCa extends TranslationsCommonEn {
	_TranslationsCommonFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsFrCa extends TranslationsSettingsEn {
	_TranslationsSettingsFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);

	final TranslationsFrCa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsFrCa measurements = _TranslationsSettingsMeasurementsFrCa._(_root);
	@override late final _TranslationsSettingsDataManagementFrCa dataManagement = _TranslationsSettingsDataManagementFrCa._(_root);
	@override late final _TranslationsSettingsVersionFrCa version = _TranslationsSettingsVersionFrCa._(_root);
}

// Path: recipes
class _TranslationsRecipesFrCa extends TranslationsRecipesEn {
	_TranslationsRecipesFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFrCa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFrCa nutrition = _TranslationsRecipeDetailNutritionFrCa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFrCa prepAhead = _TranslationsRecipeDetailPrepAheadFrCa._(_root);
...
// Path: filters
class _TranslationsFiltersFrCa extends TranslationsFiltersEn {
	_TranslationsFiltersFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFrCa extends TranslationsShoppingListEn {
	_TranslationsShoppingListFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFrCa extends TranslationsMealPlanEn {
	_TranslationsMealPlanFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFrCa extends TranslationsInventoryEn {
	_TranslationsInventoryFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFrCa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFrCa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFrCa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFrCa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFrCa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFrCa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFrCa extends TranslationsUpgradeEn {
	_TranslationsUpgradeFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFrCa extends TranslationsTourEn {
	_TranslationsTourFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFrCa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFrCa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsFrCa extends TranslationsErrorsEn {
	_TranslationsErrorsFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFrCa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFrCa metric = _TranslationsSettingsMeasurementsMetricFrCa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFrCa imperial = _TranslationsSettingsMeasurementsImperialFrCa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFrCa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFrCa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFrCa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFrCa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFrCa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFrCa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFrCa._(TranslationsFrCa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <fr-CA>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsFrCa {
