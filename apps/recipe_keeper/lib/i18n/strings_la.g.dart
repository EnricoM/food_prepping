...
// Path: <root>
class TranslationsLa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <la>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsLa _root = this; // ignore: unused_field

	@override 
	TranslationsLa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLa app = _TranslationsAppLa._(_root);
	@override late final _TranslationsHomeLa home = _TranslationsHomeLa._(_root);
	@override late final _TranslationsCommonLa common = _TranslationsCommonLa._(_root);
	@override late final _TranslationsSettingsLa settings = _TranslationsSettingsLa._(_root);
	@override late final _TranslationsRecipesLa recipes = _TranslationsRecipesLa._(_root);
	@override late final _TranslationsRecipeDetailLa recipeDetail = _TranslationsRecipeDetailLa._(_root);
	@override late final _TranslationsFiltersLa filters = _TranslationsFiltersLa._(_root);
	@override late final _TranslationsShoppingListLa shoppingList = _TranslationsShoppingListLa._(_root);
	@override late final _TranslationsMealPlanLa mealPlan = _TranslationsMealPlanLa._(_root);
	@override late final _TranslationsInventoryLa inventory = _TranslationsInventoryLa._(_root);
	@override late final _TranslationsBarcodeScanLa barcodeScan = _TranslationsBarcodeScanLa._(_root);
	@override late final _TranslationsReceiptScanLa receiptScan = _TranslationsReceiptScanLa._(_root);
	@override late final _TranslationsBatchCookingLa batchCooking = _TranslationsBatchCookingLa._(_root);
	@override late final _TranslationsVisitedDomainsLa visitedDomains = _TranslationsVisitedDomainsLa._(_root);
	@override late final _TranslationsDomainDiscoveryLa domainDiscovery = _TranslationsDomainDiscoveryLa._(_root);
	@override late final _TranslationsInventorySuggestionsLa inventorySuggestions = _TranslationsInventorySuggestionsLa._(_root);
	@override late final _TranslationsUpgradeLa upgrade = _TranslationsUpgradeLa._(_root);
	@override late final _TranslationsTourLa tour = _TranslationsTourLa._(_root);
	@override late final _TranslationsManualRecipeLa manualRecipe = _TranslationsManualRecipeLa._(_root);
	@override late final _TranslationsRecipeEditLa recipeEdit = _TranslationsRecipeEditLa._(_root);
	@override late final _TranslationsErrorsLa errors = _TranslationsErrorsLa._(_root);
}

// Path: app
class _TranslationsAppLa extends TranslationsAppEn {
	_TranslationsAppLa._(TranslationsLa root) : this._root = root, super.internal(root);

	final TranslationsLa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeLa extends TranslationsHomeEn {
	_TranslationsHomeLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLa extends TranslationsCommonEn {
	_TranslationsCommonLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLa extends TranslationsSettingsEn {
	_TranslationsSettingsLa._(TranslationsLa root) : this._root = root, super.internal(root);

	final TranslationsLa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLa measurements = _TranslationsSettingsMeasurementsLa._(_root);
	@override late final _TranslationsSettingsDataManagementLa dataManagement = _TranslationsSettingsDataManagementLa._(_root);
	@override late final _TranslationsSettingsVersionLa version = _TranslationsSettingsVersionLa._(_root);
}

// Path: recipes
class _TranslationsRecipesLa extends TranslationsRecipesEn {
	_TranslationsRecipesLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLa._(TranslationsLa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLa nutrition = _TranslationsRecipeDetailNutritionLa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLa prepAhead = _TranslationsRecipeDetailPrepAheadLa._(_root);
...
// Path: filters
class _TranslationsFiltersLa extends TranslationsFiltersEn {
	_TranslationsFiltersLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLa extends TranslationsShoppingListEn {
	_TranslationsShoppingListLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLa extends TranslationsMealPlanEn {
	_TranslationsMealPlanLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLa extends TranslationsInventoryEn {
	_TranslationsInventoryLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLa extends TranslationsUpgradeEn {
	_TranslationsUpgradeLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLa extends TranslationsTourEn {
	_TranslationsTourLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLa extends TranslationsErrorsEn {
	_TranslationsErrorsLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLa._(TranslationsLa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLa metric = _TranslationsSettingsMeasurementsMetricLa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLa imperial = _TranslationsSettingsMeasurementsImperialLa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLa._(TranslationsLa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <la>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsLa {
