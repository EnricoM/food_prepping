...
// Path: <root>
class TranslationsBr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppBr app = _TranslationsAppBr._(_root);
	@override late final _TranslationsHomeBr home = _TranslationsHomeBr._(_root);
	@override late final _TranslationsCommonBr common = _TranslationsCommonBr._(_root);
	@override late final _TranslationsSettingsBr settings = _TranslationsSettingsBr._(_root);
	@override late final _TranslationsRecipesBr recipes = _TranslationsRecipesBr._(_root);
	@override late final _TranslationsRecipeDetailBr recipeDetail = _TranslationsRecipeDetailBr._(_root);
	@override late final _TranslationsFiltersBr filters = _TranslationsFiltersBr._(_root);
	@override late final _TranslationsShoppingListBr shoppingList = _TranslationsShoppingListBr._(_root);
	@override late final _TranslationsMealPlanBr mealPlan = _TranslationsMealPlanBr._(_root);
	@override late final _TranslationsInventoryBr inventory = _TranslationsInventoryBr._(_root);
	@override late final _TranslationsBarcodeScanBr barcodeScan = _TranslationsBarcodeScanBr._(_root);
	@override late final _TranslationsReceiptScanBr receiptScan = _TranslationsReceiptScanBr._(_root);
	@override late final _TranslationsBatchCookingBr batchCooking = _TranslationsBatchCookingBr._(_root);
	@override late final _TranslationsVisitedDomainsBr visitedDomains = _TranslationsVisitedDomainsBr._(_root);
	@override late final _TranslationsDomainDiscoveryBr domainDiscovery = _TranslationsDomainDiscoveryBr._(_root);
	@override late final _TranslationsInventorySuggestionsBr inventorySuggestions = _TranslationsInventorySuggestionsBr._(_root);
	@override late final _TranslationsUpgradeBr upgrade = _TranslationsUpgradeBr._(_root);
	@override late final _TranslationsTourBr tour = _TranslationsTourBr._(_root);
	@override late final _TranslationsManualRecipeBr manualRecipe = _TranslationsManualRecipeBr._(_root);
	@override late final _TranslationsRecipeEditBr recipeEdit = _TranslationsRecipeEditBr._(_root);
	@override late final _TranslationsErrorsBr errors = _TranslationsErrorsBr._(_root);
}

// Path: app
class _TranslationsAppBr extends TranslationsAppEn {
	_TranslationsAppBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeBr extends TranslationsHomeEn {
	_TranslationsHomeBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBr extends TranslationsCommonEn {
	_TranslationsCommonBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBr extends TranslationsSettingsEn {
	_TranslationsSettingsBr._(TranslationsBr root) : this._root = root, super.internal(root);

	final TranslationsBr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBr measurements = _TranslationsSettingsMeasurementsBr._(_root);
	@override late final _TranslationsSettingsDataManagementBr dataManagement = _TranslationsSettingsDataManagementBr._(_root);
	@override late final _TranslationsSettingsVersionBr version = _TranslationsSettingsVersionBr._(_root);
}

// Path: recipes
class _TranslationsRecipesBr extends TranslationsRecipesEn {
	_TranslationsRecipesBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBr._(TranslationsBr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBr nutrition = _TranslationsRecipeDetailNutritionBr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBr prepAhead = _TranslationsRecipeDetailPrepAheadBr._(_root);
...
// Path: filters
class _TranslationsFiltersBr extends TranslationsFiltersEn {
	_TranslationsFiltersBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBr extends TranslationsShoppingListEn {
	_TranslationsShoppingListBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBr extends TranslationsMealPlanEn {
	_TranslationsMealPlanBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBr extends TranslationsInventoryEn {
	_TranslationsInventoryBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBr extends TranslationsUpgradeEn {
	_TranslationsUpgradeBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBr extends TranslationsTourEn {
	_TranslationsTourBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBr extends TranslationsErrorsEn {
	_TranslationsErrorsBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBr._(TranslationsBr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBr metric = _TranslationsSettingsMeasurementsMetricBr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBr imperial = _TranslationsSettingsMeasurementsImperialBr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBr._(TranslationsBr root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <br>.
