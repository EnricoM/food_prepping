...
class TranslationsSl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppSl app = _TranslationsAppSl._(_root);
	...
	@override late final _TranslationsRecipesSl recipes = _TranslationsRecipesSl._(_root);
	@override late final _TranslationsRecipeDetailSl recipeDetail = _TranslationsRecipeDetailSl._(_root);
	@override late final _TranslationsFiltersSl filters = _TranslationsFiltersSl._(_root);
	@override late final _TranslationsShoppingListSl shoppingList = _TranslationsShoppingListSl._(_root);
	@override late final _TranslationsMealPlanSl mealPlan = _TranslationsMealPlanSl._(_root);
	@override late final _TranslationsInventorySl inventory = _TranslationsInventorySl._(_root);
	@override late final _TranslationsBarcodeScanSl barcodeScan = _TranslationsBarcodeScanSl._(_root);
	@override late final _TranslationsReceiptScanSl receiptScan = _TranslationsReceiptScanSl._(_root);
	@override late final _TranslationsBatchCookingSl batchCooking = _TranslationsBatchCookingSl._(_root);
	@override late final _TranslationsVisitedDomainsSl visitedDomains = _TranslationsVisitedDomainsSl._(_root);
	@override late final _TranslationsDomainDiscoverySl domainDiscovery = _TranslationsDomainDiscoverySl._(_root);
	@override late final _TranslationsInventorySuggestionsSl inventorySuggestions = _TranslationsInventorySuggestionsSl._(_root);
	@override late final _TranslationsUpgradeSl upgrade = _TranslationsUpgradeSl._(_root);
	@override late final _TranslationsTourSl tour = _TranslationsTourSl._(_root);
	@override late final _TranslationsManualRecipeSl manualRecipe = _TranslationsManualRecipeSl._(_root);
	@override late final _TranslationsRecipeEditSl recipeEdit = _TranslationsRecipeEditSl._(_root);
	@override late final _TranslationsErrorsSl errors = _TranslationsErrorsSl._(_root);
}

// Path: app
class _TranslationsAppSl extends TranslationsAppEn {
	_TranslationsAppSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsSl extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsSl measurements = _TranslationsSettingsMeasurementsSl._(_root);
	@override late final _TranslationsSettingsDataManagementSl dataManagement = _TranslationsSettingsDataManagementSl._(_root);
	@override late final _TranslationsSettingsVersionSl version = _TranslationsSettingsVersionSl._(_root);
}

// Path: recipes
class _TranslationsRecipesSl extends TranslationsRecipesEn {
	_TranslationsRecipesSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSl._(TranslationsSl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSl nutrition = _TranslationsRecipeDetailNutritionSl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSl prepAhead = _TranslationsRecipeDetailPrepAheadSl._(_root);
...
// Path: filters
class _TranslationsFiltersSl extends TranslationsFiltersEn {
	_TranslationsFiltersSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSl extends TranslationsShoppingListEn {
	_TranslationsShoppingListSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSl extends TranslationsMealPlanEn {
	_TranslationsMealPlanSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySl extends TranslationsInventoryEn {
	_TranslationsInventorySl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSl extends TranslationsUpgradeEn {
	_TranslationsUpgradeSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSl extends TranslationsTourEn {
	_TranslationsTourSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSl._(TranslationsSl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSl metric = _TranslationsSettingsMeasurementsMetricSl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSl imperial = _TranslationsSettingsMeasurementsImperialSl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSl._(TranslationsSl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSl._(TranslationsSl root) : this._root = root, super.internal(root);
