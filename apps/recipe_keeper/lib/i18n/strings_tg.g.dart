...
class TranslationsTg extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppTg app = _TranslationsAppTg._(_root);
	...
	@override late final _TranslationsSettingsTg settings = _TranslationsSettingsTg._(_root);
	@override late final _TranslationsRecipesTg recipes = _TranslationsRecipesTg._(_root);
	@override late final _TranslationsRecipeDetailTg recipeDetail = _TranslationsRecipeDetailTg._(_root);
	@override late final _TranslationsFiltersTg filters = _TranslationsFiltersTg._(_root);
	@override late final _TranslationsShoppingListTg shoppingList = _TranslationsShoppingListTg._(_root);
	@override late final _TranslationsMealPlanTg mealPlan = _TranslationsMealPlanTg._(_root);
	@override late final _TranslationsInventoryTg inventory = _TranslationsInventoryTg._(_root);
	@override late final _TranslationsBarcodeScanTg barcodeScan = _TranslationsBarcodeScanTg._(_root);
	@override late final _TranslationsReceiptScanTg receiptScan = _TranslationsReceiptScanTg._(_root);
	@override late final _TranslationsBatchCookingTg batchCooking = _TranslationsBatchCookingTg._(_root);
	@override late final _TranslationsVisitedDomainsTg visitedDomains = _TranslationsVisitedDomainsTg._(_root);
	@override late final _TranslationsDomainDiscoveryTg domainDiscovery = _TranslationsDomainDiscoveryTg._(_root);
	@override late final _TranslationsInventorySuggestionsTg inventorySuggestions = _TranslationsInventorySuggestionsTg._(_root);
	@override late final _TranslationsUpgradeTg upgrade = _TranslationsUpgradeTg._(_root);
	@override late final _TranslationsTourTg tour = _TranslationsTourTg._(_root);
	@override late final _TranslationsManualRecipeTg manualRecipe = _TranslationsManualRecipeTg._(_root);
	@override late final _TranslationsRecipeEditTg recipeEdit = _TranslationsRecipeEditTg._(_root);
	@override late final _TranslationsErrorsTg errors = _TranslationsErrorsTg._(_root);
}

// Path: app
class _TranslationsAppTg extends TranslationsAppEn {
	_TranslationsAppTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeTg extends TranslationsHomeEn {
...
// Path: common
class _TranslationsCommonTg extends TranslationsCommonEn {
...
// Path: settings
class _TranslationsSettingsTg extends TranslationsSettingsEn {
	_TranslationsSettingsTg._(TranslationsTg root) : this._root = root, super.internal(root);

	final TranslationsTg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTg measurements = _TranslationsSettingsMeasurementsTg._(_root);
	@override late final _TranslationsSettingsDataManagementTg dataManagement = _TranslationsSettingsDataManagementTg._(_root);
	@override late final _TranslationsSettingsVersionTg version = _TranslationsSettingsVersionTg._(_root);
}

// Path: recipes
class _TranslationsRecipesTg extends TranslationsRecipesEn {
	_TranslationsRecipesTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTg._(TranslationsTg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTg nutrition = _TranslationsRecipeDetailNutritionTg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTg prepAhead = _TranslationsRecipeDetailPrepAheadTg._(_root);
...
// Path: filters
class _TranslationsFiltersTg extends TranslationsFiltersEn {
	_TranslationsFiltersTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTg extends TranslationsShoppingListEn {
	_TranslationsShoppingListTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTg extends TranslationsMealPlanEn {
	_TranslationsMealPlanTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTg extends TranslationsInventoryEn {
	_TranslationsInventoryTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTg extends TranslationsUpgradeEn {
	_TranslationsUpgradeTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTg extends TranslationsTourEn {
	_TranslationsTourTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTg extends TranslationsErrorsEn {
	_TranslationsErrorsTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTg._(TranslationsTg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTg metric = _TranslationsSettingsMeasurementsMetricTg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTg imperial = _TranslationsSettingsMeasurementsImperialTg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTg._(TranslationsTg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTg._(TranslationsTg root) : this._root = root, super.internal(root);
