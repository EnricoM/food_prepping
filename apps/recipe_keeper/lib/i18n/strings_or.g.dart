...
class TranslationsOr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesOr recipes = _TranslationsRecipesOr._(_root);
	@override late final _TranslationsRecipeDetailOr recipeDetail = _TranslationsRecipeDetailOr._(_root);
	@override late final _TranslationsFiltersOr filters = _TranslationsFiltersOr._(_root);
	@override late final _TranslationsShoppingListOr shoppingList = _TranslationsShoppingListOr._(_root);
	@override late final _TranslationsMealPlanOr mealPlan = _TranslationsMealPlanOr._(_root);
	@override late final _TranslationsInventoryOr inventory = _TranslationsInventoryOr._(_root);
	@override late final _TranslationsBarcodeScanOr barcodeScan = _TranslationsBarcodeScanOr._(_root);
	@override late final _TranslationsReceiptScanOr receiptScan = _TranslationsReceiptScanOr._(_root);
	@override late final _TranslationsBatchCookingOr batchCooking = _TranslationsBatchCookingOr._(_root);
	@override late final _TranslationsVisitedDomainsOr visitedDomains = _TranslationsVisitedDomainsOr._(_root);
	@override late final _TranslationsDomainDiscoveryOr domainDiscovery = _TranslationsDomainDiscoveryOr._(_root);
	@override late final _TranslationsInventorySuggestionsOr inventorySuggestions = _TranslationsInventorySuggestionsOr._(_root);
	@override late final _TranslationsUpgradeOr upgrade = _TranslationsUpgradeOr._(_root);
	@override late final _TranslationsTourOr tour = _TranslationsTourOr._(_root);
	@override late final _TranslationsManualRecipeOr manualRecipe = _TranslationsManualRecipeOr._(_root);
	@override late final _TranslationsRecipeEditOr recipeEdit = _TranslationsRecipeEditOr._(_root);
	@override late final _TranslationsErrorsOr errors = _TranslationsErrorsOr._(_root);
}
...
class _TranslationsSettingsOr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsOr measurements = _TranslationsSettingsMeasurementsOr._(_root);
	@override late final _TranslationsSettingsDataManagementOr dataManagement = _TranslationsSettingsDataManagementOr._(_root);
	@override late final _TranslationsSettingsVersionOr version = _TranslationsSettingsVersionOr._(_root);
}

// Path: recipes
class _TranslationsRecipesOr extends TranslationsRecipesEn {
	_TranslationsRecipesOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailOr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailOr._(TranslationsOr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionOr nutrition = _TranslationsRecipeDetailNutritionOr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadOr prepAhead = _TranslationsRecipeDetailPrepAheadOr._(_root);
...
// Path: filters
class _TranslationsFiltersOr extends TranslationsFiltersEn {
	_TranslationsFiltersOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListOr extends TranslationsShoppingListEn {
	_TranslationsShoppingListOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanOr extends TranslationsMealPlanEn {
	_TranslationsMealPlanOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryOr extends TranslationsInventoryEn {
	_TranslationsInventoryOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanOr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanOr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingOr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsOr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryOr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsOr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeOr extends TranslationsUpgradeEn {
	_TranslationsUpgradeOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourOr extends TranslationsTourEn {
	_TranslationsTourOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeOr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditOr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsOr extends TranslationsErrorsEn {
	_TranslationsErrorsOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsOr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsOr._(TranslationsOr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricOr metric = _TranslationsSettingsMeasurementsMetricOr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialOr imperial = _TranslationsSettingsMeasurementsImperialOr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementOr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionOr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionOr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadOr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricOr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricOr._(TranslationsOr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialOr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialOr._(TranslationsOr root) : this._root = root, super.internal(root);
