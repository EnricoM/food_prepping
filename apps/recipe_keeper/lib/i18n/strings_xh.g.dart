...
// Path: <root>
class TranslationsXh extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsXh({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <xh>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsXh _root = this; // ignore: unused_field

	@override 
	TranslationsXh $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsXh(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppXh app = _TranslationsAppXh._(_root);
	@override late final _TranslationsHomeXh home = _TranslationsHomeXh._(_root);
	@override late final _TranslationsCommonXh common = _TranslationsCommonXh._(_root);
	@override late final _TranslationsSettingsXh settings = _TranslationsSettingsXh._(_root);
	@override late final _TranslationsRecipesXh recipes = _TranslationsRecipesXh._(_root);
	@override late final _TranslationsRecipeDetailXh recipeDetail = _TranslationsRecipeDetailXh._(_root);
	@override late final _TranslationsFiltersXh filters = _TranslationsFiltersXh._(_root);
	@override late final _TranslationsShoppingListXh shoppingList = _TranslationsShoppingListXh._(_root);
	@override late final _TranslationsMealPlanXh mealPlan = _TranslationsMealPlanXh._(_root);
	@override late final _TranslationsInventoryXh inventory = _TranslationsInventoryXh._(_root);
	@override late final _TranslationsBarcodeScanXh barcodeScan = _TranslationsBarcodeScanXh._(_root);
	@override late final _TranslationsReceiptScanXh receiptScan = _TranslationsReceiptScanXh._(_root);
	@override late final _TranslationsBatchCookingXh batchCooking = _TranslationsBatchCookingXh._(_root);
	@override late final _TranslationsVisitedDomainsXh visitedDomains = _TranslationsVisitedDomainsXh._(_root);
	@override late final _TranslationsDomainDiscoveryXh domainDiscovery = _TranslationsDomainDiscoveryXh._(_root);
	@override late final _TranslationsInventorySuggestionsXh inventorySuggestions = _TranslationsInventorySuggestionsXh._(_root);
	@override late final _TranslationsUpgradeXh upgrade = _TranslationsUpgradeXh._(_root);
	@override late final _TranslationsTourXh tour = _TranslationsTourXh._(_root);
	@override late final _TranslationsManualRecipeXh manualRecipe = _TranslationsManualRecipeXh._(_root);
	@override late final _TranslationsRecipeEditXh recipeEdit = _TranslationsRecipeEditXh._(_root);
	@override late final _TranslationsErrorsXh errors = _TranslationsErrorsXh._(_root);
}

// Path: app
class _TranslationsAppXh extends TranslationsAppEn {
	_TranslationsAppXh._(TranslationsXh root) : this._root = root, super.internal(root);

	final TranslationsXh _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeXh extends TranslationsHomeEn {
	_TranslationsHomeXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonXh extends TranslationsCommonEn {
	_TranslationsCommonXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsXh extends TranslationsSettingsEn {
	_TranslationsSettingsXh._(TranslationsXh root) : this._root = root, super.internal(root);

	final TranslationsXh _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsXh measurements = _TranslationsSettingsMeasurementsXh._(_root);
	@override late final _TranslationsSettingsDataManagementXh dataManagement = _TranslationsSettingsDataManagementXh._(_root);
	@override late final _TranslationsSettingsVersionXh version = _TranslationsSettingsVersionXh._(_root);
}

// Path: recipes
class _TranslationsRecipesXh extends TranslationsRecipesEn {
	_TranslationsRecipesXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailXh extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailXh._(TranslationsXh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionXh nutrition = _TranslationsRecipeDetailNutritionXh._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadXh prepAhead = _TranslationsRecipeDetailPrepAheadXh._(_root);
...
// Path: filters
class _TranslationsFiltersXh extends TranslationsFiltersEn {
	_TranslationsFiltersXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListXh extends TranslationsShoppingListEn {
	_TranslationsShoppingListXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanXh extends TranslationsMealPlanEn {
	_TranslationsMealPlanXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryXh extends TranslationsInventoryEn {
	_TranslationsInventoryXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanXh extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanXh extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingXh extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsXh extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryXh extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsXh extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeXh extends TranslationsUpgradeEn {
	_TranslationsUpgradeXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourXh extends TranslationsTourEn {
	_TranslationsTourXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeXh extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditXh extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsXh extends TranslationsErrorsEn {
	_TranslationsErrorsXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsXh extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsXh._(TranslationsXh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricXh metric = _TranslationsSettingsMeasurementsMetricXh._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialXh imperial = _TranslationsSettingsMeasurementsImperialXh._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementXh extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionXh extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionXh extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadXh extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricXh extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialXh extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialXh._(TranslationsXh root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <xh>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsXh {
