...
class TranslationsUz extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppUz app = _TranslationsAppUz._(_root);
	...
	@override late final _TranslationsRecipesUz recipes = _TranslationsRecipesUz._(_root);
	@override late final _TranslationsRecipeDetailUz recipeDetail = _TranslationsRecipeDetailUz._(_root);
	@override late final _TranslationsFiltersUz filters = _TranslationsFiltersUz._(_root);
	@override late final _TranslationsShoppingListUz shoppingList = _TranslationsShoppingListUz._(_root);
	@override late final _TranslationsMealPlanUz mealPlan = _TranslationsMealPlanUz._(_root);
	@override late final _TranslationsInventoryUz inventory = _TranslationsInventoryUz._(_root);
	@override late final _TranslationsBarcodeScanUz barcodeScan = _TranslationsBarcodeScanUz._(_root);
	@override late final _TranslationsReceiptScanUz receiptScan = _TranslationsReceiptScanUz._(_root);
	@override late final _TranslationsBatchCookingUz batchCooking = _TranslationsBatchCookingUz._(_root);
	@override late final _TranslationsVisitedDomainsUz visitedDomains = _TranslationsVisitedDomainsUz._(_root);
	@override late final _TranslationsDomainDiscoveryUz domainDiscovery = _TranslationsDomainDiscoveryUz._(_root);
	@override late final _TranslationsInventorySuggestionsUz inventorySuggestions = _TranslationsInventorySuggestionsUz._(_root);
	@override late final _TranslationsUpgradeUz upgrade = _TranslationsUpgradeUz._(_root);
	@override late final _TranslationsTourUz tour = _TranslationsTourUz._(_root);
	@override late final _TranslationsManualRecipeUz manualRecipe = _TranslationsManualRecipeUz._(_root);
	@override late final _TranslationsRecipeEditUz recipeEdit = _TranslationsRecipeEditUz._(_root);
	@override late final _TranslationsErrorsUz errors = _TranslationsErrorsUz._(_root);
}

// Path: app
class _TranslationsAppUz extends TranslationsAppEn {
	_TranslationsAppUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonUz extends TranslationsCommonEn {
	_TranslationsCommonUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsUz extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsUz measurements = _TranslationsSettingsMeasurementsUz._(_root);
	@override late final _TranslationsSettingsDataManagementUz dataManagement = _TranslationsSettingsDataManagementUz._(_root);
	@override late final _TranslationsSettingsVersionUz version = _TranslationsSettingsVersionUz._(_root);
}

// Path: recipes
class _TranslationsRecipesUz extends TranslationsRecipesEn {
	_TranslationsRecipesUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUz._(TranslationsUz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionUz nutrition = _TranslationsRecipeDetailNutritionUz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadUz prepAhead = _TranslationsRecipeDetailPrepAheadUz._(_root);
...
// Path: filters
class _TranslationsFiltersUz extends TranslationsFiltersEn {
	_TranslationsFiltersUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListUz extends TranslationsShoppingListEn {
	_TranslationsShoppingListUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanUz extends TranslationsMealPlanEn {
	_TranslationsMealPlanUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryUz extends TranslationsInventoryEn {
	_TranslationsInventoryUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanUz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingUz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryUz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsUz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeUz extends TranslationsUpgradeEn {
	_TranslationsUpgradeUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourUz extends TranslationsTourEn {
	_TranslationsTourUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsUz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUz._(TranslationsUz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricUz metric = _TranslationsSettingsMeasurementsMetricUz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialUz imperial = _TranslationsSettingsMeasurementsImperialUz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementUz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionUz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionUz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadUz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricUz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUz._(TranslationsUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialUz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUz._(TranslationsUz root) : this._root = root, super.internal(root);
