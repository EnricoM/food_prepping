...
// Path: <root>
class TranslationsEe extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsEe({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ee>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsEe _root = this; // ignore: unused_field

	@override 
	TranslationsEe $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsEe(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppEe app = _TranslationsAppEe._(_root);
	@override late final _TranslationsHomeEe home = _TranslationsHomeEe._(_root);
	@override late final _TranslationsCommonEe common = _TranslationsCommonEe._(_root);
	@override late final _TranslationsSettingsEe settings = _TranslationsSettingsEe._(_root);
	@override late final _TranslationsRecipesEe recipes = _TranslationsRecipesEe._(_root);
	@override late final _TranslationsRecipeDetailEe recipeDetail = _TranslationsRecipeDetailEe._(_root);
	@override late final _TranslationsFiltersEe filters = _TranslationsFiltersEe._(_root);
	@override late final _TranslationsShoppingListEe shoppingList = _TranslationsShoppingListEe._(_root);
	@override late final _TranslationsMealPlanEe mealPlan = _TranslationsMealPlanEe._(_root);
	@override late final _TranslationsInventoryEe inventory = _TranslationsInventoryEe._(_root);
	@override late final _TranslationsBarcodeScanEe barcodeScan = _TranslationsBarcodeScanEe._(_root);
	@override late final _TranslationsReceiptScanEe receiptScan = _TranslationsReceiptScanEe._(_root);
	@override late final _TranslationsBatchCookingEe batchCooking = _TranslationsBatchCookingEe._(_root);
	@override late final _TranslationsVisitedDomainsEe visitedDomains = _TranslationsVisitedDomainsEe._(_root);
	@override late final _TranslationsDomainDiscoveryEe domainDiscovery = _TranslationsDomainDiscoveryEe._(_root);
	@override late final _TranslationsInventorySuggestionsEe inventorySuggestions = _TranslationsInventorySuggestionsEe._(_root);
	@override late final _TranslationsUpgradeEe upgrade = _TranslationsUpgradeEe._(_root);
	@override late final _TranslationsTourEe tour = _TranslationsTourEe._(_root);
	@override late final _TranslationsManualRecipeEe manualRecipe = _TranslationsManualRecipeEe._(_root);
	@override late final _TranslationsRecipeEditEe recipeEdit = _TranslationsRecipeEditEe._(_root);
	@override late final _TranslationsErrorsEe errors = _TranslationsErrorsEe._(_root);
}

// Path: app
class _TranslationsAppEe extends TranslationsAppEn {
	_TranslationsAppEe._(TranslationsEe root) : this._root = root, super.internal(root);

	final TranslationsEe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeEe extends TranslationsHomeEn {
	_TranslationsHomeEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEe extends TranslationsCommonEn {
	_TranslationsCommonEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEe extends TranslationsSettingsEn {
	_TranslationsSettingsEe._(TranslationsEe root) : this._root = root, super.internal(root);

	final TranslationsEe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEe measurements = _TranslationsSettingsMeasurementsEe._(_root);
	@override late final _TranslationsSettingsDataManagementEe dataManagement = _TranslationsSettingsDataManagementEe._(_root);
	@override late final _TranslationsSettingsVersionEe version = _TranslationsSettingsVersionEe._(_root);
}

// Path: recipes
class _TranslationsRecipesEe extends TranslationsRecipesEn {
	_TranslationsRecipesEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEe._(TranslationsEe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEe nutrition = _TranslationsRecipeDetailNutritionEe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEe prepAhead = _TranslationsRecipeDetailPrepAheadEe._(_root);
...
// Path: filters
class _TranslationsFiltersEe extends TranslationsFiltersEn {
	_TranslationsFiltersEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEe extends TranslationsShoppingListEn {
	_TranslationsShoppingListEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEe extends TranslationsMealPlanEn {
	_TranslationsMealPlanEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEe extends TranslationsInventoryEn {
	_TranslationsInventoryEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEe extends TranslationsUpgradeEn {
	_TranslationsUpgradeEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEe extends TranslationsTourEn {
	_TranslationsTourEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEe extends TranslationsErrorsEn {
	_TranslationsErrorsEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEe._(TranslationsEe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEe metric = _TranslationsSettingsMeasurementsMetricEe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEe imperial = _TranslationsSettingsMeasurementsImperialEe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEe._(TranslationsEe root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ee>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsEe {
