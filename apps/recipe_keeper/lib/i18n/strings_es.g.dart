...
class TranslationsEs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesEs recipes = _TranslationsRecipesEs._(_root);
	@override late final _TranslationsRecipeDetailEs recipeDetail = _TranslationsRecipeDetailEs._(_root);
	@override late final _TranslationsFiltersEs filters = _TranslationsFiltersEs._(_root);
	@override late final _TranslationsShoppingListEs shoppingList = _TranslationsShoppingListEs._(_root);
	@override late final _TranslationsMealPlanEs mealPlan = _TranslationsMealPlanEs._(_root);
	@override late final _TranslationsInventoryEs inventory = _TranslationsInventoryEs._(_root);
	@override late final _TranslationsBarcodeScanEs barcodeScan = _TranslationsBarcodeScanEs._(_root);
	@override late final _TranslationsReceiptScanEs receiptScan = _TranslationsReceiptScanEs._(_root);
	@override late final _TranslationsBatchCookingEs batchCooking = _TranslationsBatchCookingEs._(_root);
	@override late final _TranslationsVisitedDomainsEs visitedDomains = _TranslationsVisitedDomainsEs._(_root);
	@override late final _TranslationsDomainDiscoveryEs domainDiscovery = _TranslationsDomainDiscoveryEs._(_root);
	@override late final _TranslationsInventorySuggestionsEs inventorySuggestions = _TranslationsInventorySuggestionsEs._(_root);
	@override late final _TranslationsUpgradeEs upgrade = _TranslationsUpgradeEs._(_root);
	@override late final _TranslationsTourEs tour = _TranslationsTourEs._(_root);
	@override late final _TranslationsManualRecipeEs manualRecipe = _TranslationsManualRecipeEs._(_root);
	@override late final _TranslationsRecipeEditEs recipeEdit = _TranslationsRecipeEditEs._(_root);
...
class _TranslationsSettingsEs extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsEs measurements = _TranslationsSettingsMeasurementsEs._(_root);
	@override late final _TranslationsSettingsDataManagementEs dataManagement = _TranslationsSettingsDataManagementEs._(_root);
	@override late final _TranslationsSettingsVersionEs version = _TranslationsSettingsVersionEs._(_root);
}

// Path: recipes
class _TranslationsRecipesEs extends TranslationsRecipesEn {
	_TranslationsRecipesEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEs._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEs nutrition = _TranslationsRecipeDetailNutritionEs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEs prepAhead = _TranslationsRecipeDetailPrepAheadEs._(_root);
...
// Path: filters
class _TranslationsFiltersEs extends TranslationsFiltersEn {
	_TranslationsFiltersEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEs extends TranslationsShoppingListEn {
	_TranslationsShoppingListEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEs extends TranslationsMealPlanEn {
	_TranslationsMealPlanEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEs extends TranslationsInventoryEn {
	_TranslationsInventoryEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEs extends TranslationsUpgradeEn {
	_TranslationsUpgradeEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEs extends TranslationsTourEn {
	_TranslationsTourEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEs._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEs metric = _TranslationsSettingsMeasurementsMetricEs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEs imperial = _TranslationsSettingsMeasurementsImperialEs._(_root);
}
...
class _TranslationsSettingsVersionEs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEs._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEs._(TranslationsEs root) : this._root = root, super.internal(root);
