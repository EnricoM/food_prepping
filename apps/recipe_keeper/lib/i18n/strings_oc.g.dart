...
// Path: <root>
class TranslationsOc extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsOc({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <oc>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsOc _root = this; // ignore: unused_field

	@override 
	TranslationsOc $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsOc(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppOc app = _TranslationsAppOc._(_root);
	@override late final _TranslationsHomeOc home = _TranslationsHomeOc._(_root);
	@override late final _TranslationsCommonOc common = _TranslationsCommonOc._(_root);
	@override late final _TranslationsSettingsOc settings = _TranslationsSettingsOc._(_root);
	@override late final _TranslationsRecipesOc recipes = _TranslationsRecipesOc._(_root);
	@override late final _TranslationsRecipeDetailOc recipeDetail = _TranslationsRecipeDetailOc._(_root);
	@override late final _TranslationsFiltersOc filters = _TranslationsFiltersOc._(_root);
	@override late final _TranslationsShoppingListOc shoppingList = _TranslationsShoppingListOc._(_root);
	@override late final _TranslationsMealPlanOc mealPlan = _TranslationsMealPlanOc._(_root);
	@override late final _TranslationsInventoryOc inventory = _TranslationsInventoryOc._(_root);
	@override late final _TranslationsBarcodeScanOc barcodeScan = _TranslationsBarcodeScanOc._(_root);
	@override late final _TranslationsReceiptScanOc receiptScan = _TranslationsReceiptScanOc._(_root);
	@override late final _TranslationsBatchCookingOc batchCooking = _TranslationsBatchCookingOc._(_root);
	@override late final _TranslationsVisitedDomainsOc visitedDomains = _TranslationsVisitedDomainsOc._(_root);
	@override late final _TranslationsDomainDiscoveryOc domainDiscovery = _TranslationsDomainDiscoveryOc._(_root);
	@override late final _TranslationsInventorySuggestionsOc inventorySuggestions = _TranslationsInventorySuggestionsOc._(_root);
	@override late final _TranslationsUpgradeOc upgrade = _TranslationsUpgradeOc._(_root);
	@override late final _TranslationsTourOc tour = _TranslationsTourOc._(_root);
	@override late final _TranslationsManualRecipeOc manualRecipe = _TranslationsManualRecipeOc._(_root);
	@override late final _TranslationsRecipeEditOc recipeEdit = _TranslationsRecipeEditOc._(_root);
	@override late final _TranslationsErrorsOc errors = _TranslationsErrorsOc._(_root);
}

// Path: app
class _TranslationsAppOc extends TranslationsAppEn {
	_TranslationsAppOc._(TranslationsOc root) : this._root = root, super.internal(root);

	final TranslationsOc _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeOc extends TranslationsHomeEn {
	_TranslationsHomeOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonOc extends TranslationsCommonEn {
	_TranslationsCommonOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsOc extends TranslationsSettingsEn {
	_TranslationsSettingsOc._(TranslationsOc root) : this._root = root, super.internal(root);

	final TranslationsOc _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsOc measurements = _TranslationsSettingsMeasurementsOc._(_root);
	@override late final _TranslationsSettingsDataManagementOc dataManagement = _TranslationsSettingsDataManagementOc._(_root);
	@override late final _TranslationsSettingsVersionOc version = _TranslationsSettingsVersionOc._(_root);
}

// Path: recipes
class _TranslationsRecipesOc extends TranslationsRecipesEn {
	_TranslationsRecipesOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailOc extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailOc._(TranslationsOc root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionOc nutrition = _TranslationsRecipeDetailNutritionOc._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadOc prepAhead = _TranslationsRecipeDetailPrepAheadOc._(_root);
...
// Path: filters
class _TranslationsFiltersOc extends TranslationsFiltersEn {
	_TranslationsFiltersOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListOc extends TranslationsShoppingListEn {
	_TranslationsShoppingListOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanOc extends TranslationsMealPlanEn {
	_TranslationsMealPlanOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryOc extends TranslationsInventoryEn {
	_TranslationsInventoryOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanOc extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanOc extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingOc extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsOc extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryOc extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsOc extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeOc extends TranslationsUpgradeEn {
	_TranslationsUpgradeOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourOc extends TranslationsTourEn {
	_TranslationsTourOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeOc extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditOc extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsOc extends TranslationsErrorsEn {
	_TranslationsErrorsOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsOc extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsOc._(TranslationsOc root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricOc metric = _TranslationsSettingsMeasurementsMetricOc._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialOc imperial = _TranslationsSettingsMeasurementsImperialOc._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementOc extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionOc extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionOc extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadOc extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricOc extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialOc extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialOc._(TranslationsOc root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <oc>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsOc {
