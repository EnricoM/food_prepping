...
class TranslationsSv extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesSv recipes = _TranslationsRecipesSv._(_root);
	@override late final _TranslationsRecipeDetailSv recipeDetail = _TranslationsRecipeDetailSv._(_root);
	@override late final _TranslationsFiltersSv filters = _TranslationsFiltersSv._(_root);
	@override late final _TranslationsShoppingListSv shoppingList = _TranslationsShoppingListSv._(_root);
	@override late final _TranslationsMealPlanSv mealPlan = _TranslationsMealPlanSv._(_root);
	@override late final _TranslationsInventorySv inventory = _TranslationsInventorySv._(_root);
	@override late final _TranslationsBarcodeScanSv barcodeScan = _TranslationsBarcodeScanSv._(_root);
	@override late final _TranslationsReceiptScanSv receiptScan = _TranslationsReceiptScanSv._(_root);
	@override late final _TranslationsBatchCookingSv batchCooking = _TranslationsBatchCookingSv._(_root);
	@override late final _TranslationsVisitedDomainsSv visitedDomains = _TranslationsVisitedDomainsSv._(_root);
	@override late final _TranslationsDomainDiscoverySv domainDiscovery = _TranslationsDomainDiscoverySv._(_root);
	@override late final _TranslationsInventorySuggestionsSv inventorySuggestions = _TranslationsInventorySuggestionsSv._(_root);
	@override late final _TranslationsUpgradeSv upgrade = _TranslationsUpgradeSv._(_root);
	@override late final _TranslationsTourSv tour = _TranslationsTourSv._(_root);
	@override late final _TranslationsManualRecipeSv manualRecipe = _TranslationsManualRecipeSv._(_root);
	@override late final _TranslationsRecipeEditSv recipeEdit = _TranslationsRecipeEditSv._(_root);
...
class _TranslationsSettingsSv extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsSv measurements = _TranslationsSettingsMeasurementsSv._(_root);
	@override late final _TranslationsSettingsDataManagementSv dataManagement = _TranslationsSettingsDataManagementSv._(_root);
	@override late final _TranslationsSettingsVersionSv version = _TranslationsSettingsVersionSv._(_root);
}

// Path: recipes
class _TranslationsRecipesSv extends TranslationsRecipesEn {
	_TranslationsRecipesSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSv._(TranslationsSv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSv nutrition = _TranslationsRecipeDetailNutritionSv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSv prepAhead = _TranslationsRecipeDetailPrepAheadSv._(_root);
...
// Path: filters
class _TranslationsFiltersSv extends TranslationsFiltersEn {
	_TranslationsFiltersSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSv extends TranslationsShoppingListEn {
	_TranslationsShoppingListSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSv extends TranslationsMealPlanEn {
	_TranslationsMealPlanSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySv extends TranslationsInventoryEn {
	_TranslationsInventorySv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSv extends TranslationsUpgradeEn {
	_TranslationsUpgradeSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSv extends TranslationsTourEn {
	_TranslationsTourSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSv._(TranslationsSv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSv metric = _TranslationsSettingsMeasurementsMetricSv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSv imperial = _TranslationsSettingsMeasurementsImperialSv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSv._(TranslationsSv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSv._(TranslationsSv root) : this._root = root, super.internal(root);
