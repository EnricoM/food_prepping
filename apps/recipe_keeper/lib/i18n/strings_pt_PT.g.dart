...
class TranslationsPtPt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppPtPt app = _TranslationsAppPtPt._(_root);
	@override late final _TranslationsHomePtPt home = _TranslationsHomePtPt._(_root);
	@override late final _TranslationsCommonPtPt common = _TranslationsCommonPtPt._(_root);
	@override late final _TranslationsSettingsPtPt settings = _TranslationsSettingsPtPt._(_root);
	@override late final _TranslationsRecipesPtPt recipes = _TranslationsRecipesPtPt._(_root);
	@override late final _TranslationsRecipeDetailPtPt recipeDetail = _TranslationsRecipeDetailPtPt._(_root);
	@override late final _TranslationsFiltersPtPt filters = _TranslationsFiltersPtPt._(_root);
	@override late final _TranslationsShoppingListPtPt shoppingList = _TranslationsShoppingListPtPt._(_root);
	@override late final _TranslationsMealPlanPtPt mealPlan = _TranslationsMealPlanPtPt._(_root);
	@override late final _TranslationsInventoryPtPt inventory = _TranslationsInventoryPtPt._(_root);
	@override late final _TranslationsBarcodeScanPtPt barcodeScan = _TranslationsBarcodeScanPtPt._(_root);
	@override late final _TranslationsReceiptScanPtPt receiptScan = _TranslationsReceiptScanPtPt._(_root);
	@override late final _TranslationsBatchCookingPtPt batchCooking = _TranslationsBatchCookingPtPt._(_root);
	@override late final _TranslationsVisitedDomainsPtPt visitedDomains = _TranslationsVisitedDomainsPtPt._(_root);
	@override late final _TranslationsDomainDiscoveryPtPt domainDiscovery = _TranslationsDomainDiscoveryPtPt._(_root);
	@override late final _TranslationsInventorySuggestionsPtPt inventorySuggestions = _TranslationsInventorySuggestionsPtPt._(_root);
	@override late final _TranslationsUpgradePtPt upgrade = _TranslationsUpgradePtPt._(_root);
	@override late final _TranslationsTourPtPt tour = _TranslationsTourPtPt._(_root);
	@override late final _TranslationsManualRecipePtPt manualRecipe = _TranslationsManualRecipePtPt._(_root);
	@override late final _TranslationsRecipeEditPtPt recipeEdit = _TranslationsRecipeEditPtPt._(_root);
	@override late final _TranslationsErrorsPtPt errors = _TranslationsErrorsPtPt._(_root);
}

// Path: app
class _TranslationsAppPtPt extends TranslationsAppEn {
	_TranslationsAppPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomePtPt extends TranslationsHomeEn {
	_TranslationsHomePtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonPtPt extends TranslationsCommonEn {
	_TranslationsCommonPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsPtPt extends TranslationsSettingsEn {
	_TranslationsSettingsPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);

	final TranslationsPtPt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsPtPt measurements = _TranslationsSettingsMeasurementsPtPt._(_root);
	@override late final _TranslationsSettingsDataManagementPtPt dataManagement = _TranslationsSettingsDataManagementPtPt._(_root);
	@override late final _TranslationsSettingsVersionPtPt version = _TranslationsSettingsVersionPtPt._(_root);
}

// Path: recipes
class _TranslationsRecipesPtPt extends TranslationsRecipesEn {
	_TranslationsRecipesPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPtPt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPtPt nutrition = _TranslationsRecipeDetailNutritionPtPt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPtPt prepAhead = _TranslationsRecipeDetailPrepAheadPtPt._(_root);
...
// Path: filters
class _TranslationsFiltersPtPt extends TranslationsFiltersEn {
	_TranslationsFiltersPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPtPt extends TranslationsShoppingListEn {
	_TranslationsShoppingListPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPtPt extends TranslationsMealPlanEn {
	_TranslationsMealPlanPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPtPt extends TranslationsInventoryEn {
	_TranslationsInventoryPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPtPt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPtPt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPtPt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPtPt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPtPt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPtPt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePtPt extends TranslationsUpgradeEn {
	_TranslationsUpgradePtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPtPt extends TranslationsTourEn {
	_TranslationsTourPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePtPt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPtPt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsPtPt extends TranslationsErrorsEn {
	_TranslationsErrorsPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPtPt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPtPt metric = _TranslationsSettingsMeasurementsMetricPtPt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPtPt imperial = _TranslationsSettingsMeasurementsImperialPtPt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPtPt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPtPt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPtPt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPtPt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPtPt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPtPt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPtPt._(TranslationsPtPt root) : this._root = root, super.internal(root);
