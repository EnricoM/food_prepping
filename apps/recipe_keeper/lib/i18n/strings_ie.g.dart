...
// Path: <root>
class TranslationsIe extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsIe({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ie>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsIe _root = this; // ignore: unused_field

	@override 
	TranslationsIe $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsIe(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppIe app = _TranslationsAppIe._(_root);
	@override late final _TranslationsHomeIe home = _TranslationsHomeIe._(_root);
	@override late final _TranslationsCommonIe common = _TranslationsCommonIe._(_root);
	@override late final _TranslationsSettingsIe settings = _TranslationsSettingsIe._(_root);
	@override late final _TranslationsRecipesIe recipes = _TranslationsRecipesIe._(_root);
	@override late final _TranslationsRecipeDetailIe recipeDetail = _TranslationsRecipeDetailIe._(_root);
	@override late final _TranslationsFiltersIe filters = _TranslationsFiltersIe._(_root);
	@override late final _TranslationsShoppingListIe shoppingList = _TranslationsShoppingListIe._(_root);
	@override late final _TranslationsMealPlanIe mealPlan = _TranslationsMealPlanIe._(_root);
	@override late final _TranslationsInventoryIe inventory = _TranslationsInventoryIe._(_root);
	@override late final _TranslationsBarcodeScanIe barcodeScan = _TranslationsBarcodeScanIe._(_root);
	@override late final _TranslationsReceiptScanIe receiptScan = _TranslationsReceiptScanIe._(_root);
	@override late final _TranslationsBatchCookingIe batchCooking = _TranslationsBatchCookingIe._(_root);
	@override late final _TranslationsVisitedDomainsIe visitedDomains = _TranslationsVisitedDomainsIe._(_root);
	@override late final _TranslationsDomainDiscoveryIe domainDiscovery = _TranslationsDomainDiscoveryIe._(_root);
	@override late final _TranslationsInventorySuggestionsIe inventorySuggestions = _TranslationsInventorySuggestionsIe._(_root);
	@override late final _TranslationsUpgradeIe upgrade = _TranslationsUpgradeIe._(_root);
	@override late final _TranslationsTourIe tour = _TranslationsTourIe._(_root);
	@override late final _TranslationsManualRecipeIe manualRecipe = _TranslationsManualRecipeIe._(_root);
	@override late final _TranslationsRecipeEditIe recipeEdit = _TranslationsRecipeEditIe._(_root);
	@override late final _TranslationsErrorsIe errors = _TranslationsErrorsIe._(_root);
}

// Path: app
class _TranslationsAppIe extends TranslationsAppEn {
	_TranslationsAppIe._(TranslationsIe root) : this._root = root, super.internal(root);

	final TranslationsIe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIe extends TranslationsHomeEn {
	_TranslationsHomeIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIe extends TranslationsCommonEn {
	_TranslationsCommonIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIe extends TranslationsSettingsEn {
	_TranslationsSettingsIe._(TranslationsIe root) : this._root = root, super.internal(root);

	final TranslationsIe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIe measurements = _TranslationsSettingsMeasurementsIe._(_root);
	@override late final _TranslationsSettingsDataManagementIe dataManagement = _TranslationsSettingsDataManagementIe._(_root);
	@override late final _TranslationsSettingsVersionIe version = _TranslationsSettingsVersionIe._(_root);
}

// Path: recipes
class _TranslationsRecipesIe extends TranslationsRecipesEn {
	_TranslationsRecipesIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIe._(TranslationsIe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIe nutrition = _TranslationsRecipeDetailNutritionIe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIe prepAhead = _TranslationsRecipeDetailPrepAheadIe._(_root);
...
// Path: filters
class _TranslationsFiltersIe extends TranslationsFiltersEn {
	_TranslationsFiltersIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIe extends TranslationsShoppingListEn {
	_TranslationsShoppingListIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIe extends TranslationsMealPlanEn {
	_TranslationsMealPlanIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIe extends TranslationsInventoryEn {
	_TranslationsInventoryIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIe extends TranslationsUpgradeEn {
	_TranslationsUpgradeIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIe extends TranslationsTourEn {
	_TranslationsTourIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIe extends TranslationsErrorsEn {
	_TranslationsErrorsIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIe._(TranslationsIe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIe metric = _TranslationsSettingsMeasurementsMetricIe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIe imperial = _TranslationsSettingsMeasurementsImperialIe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIe._(TranslationsIe root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ie>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsIe {
