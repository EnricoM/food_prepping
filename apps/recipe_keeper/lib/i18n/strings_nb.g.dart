...
class TranslationsNb extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsHomeNb home = _TranslationsHomeNb._(_root);
	...
	@override late final _TranslationsRecipesNb recipes = _TranslationsRecipesNb._(_root);
	@override late final _TranslationsRecipeDetailNb recipeDetail = _TranslationsRecipeDetailNb._(_root);
	@override late final _TranslationsFiltersNb filters = _TranslationsFiltersNb._(_root);
	@override late final _TranslationsShoppingListNb shoppingList = _TranslationsShoppingListNb._(_root);
	@override late final _TranslationsMealPlanNb mealPlan = _TranslationsMealPlanNb._(_root);
	@override late final _TranslationsInventoryNb inventory = _TranslationsInventoryNb._(_root);
	@override late final _TranslationsBarcodeScanNb barcodeScan = _TranslationsBarcodeScanNb._(_root);
	@override late final _TranslationsReceiptScanNb receiptScan = _TranslationsReceiptScanNb._(_root);
	@override late final _TranslationsBatchCookingNb batchCooking = _TranslationsBatchCookingNb._(_root);
	@override late final _TranslationsVisitedDomainsNb visitedDomains = _TranslationsVisitedDomainsNb._(_root);
	@override late final _TranslationsDomainDiscoveryNb domainDiscovery = _TranslationsDomainDiscoveryNb._(_root);
	@override late final _TranslationsInventorySuggestionsNb inventorySuggestions = _TranslationsInventorySuggestionsNb._(_root);
	@override late final _TranslationsUpgradeNb upgrade = _TranslationsUpgradeNb._(_root);
	@override late final _TranslationsTourNb tour = _TranslationsTourNb._(_root);
	@override late final _TranslationsManualRecipeNb manualRecipe = _TranslationsManualRecipeNb._(_root);
	@override late final _TranslationsRecipeEditNb recipeEdit = _TranslationsRecipeEditNb._(_root);
...
// Path: home
class _TranslationsHomeNb extends TranslationsHomeEn {
	_TranslationsHomeNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsNb extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsNb measurements = _TranslationsSettingsMeasurementsNb._(_root);
	@override late final _TranslationsSettingsDataManagementNb dataManagement = _TranslationsSettingsDataManagementNb._(_root);
	@override late final _TranslationsSettingsVersionNb version = _TranslationsSettingsVersionNb._(_root);
}

// Path: recipes
class _TranslationsRecipesNb extends TranslationsRecipesEn {
	_TranslationsRecipesNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNb extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNb._(TranslationsNb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNb nutrition = _TranslationsRecipeDetailNutritionNb._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNb prepAhead = _TranslationsRecipeDetailPrepAheadNb._(_root);
...
// Path: filters
class _TranslationsFiltersNb extends TranslationsFiltersEn {
	_TranslationsFiltersNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNb extends TranslationsShoppingListEn {
	_TranslationsShoppingListNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNb extends TranslationsMealPlanEn {
	_TranslationsMealPlanNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNb extends TranslationsInventoryEn {
	_TranslationsInventoryNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNb extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNb extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNb extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNb extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNb extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNb extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNb extends TranslationsUpgradeEn {
	_TranslationsUpgradeNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNb extends TranslationsTourEn {
	_TranslationsTourNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNb extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNb extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNb extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNb._(TranslationsNb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNb metric = _TranslationsSettingsMeasurementsMetricNb._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNb imperial = _TranslationsSettingsMeasurementsImperialNb._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNb extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNb extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNb extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNb extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNb extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNb extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNb._(TranslationsNb root) : this._root = root, super.internal(root);
