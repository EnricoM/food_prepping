...
// Path: <root>
class TranslationsTo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <to>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTo _root = this; // ignore: unused_field

	@override 
	TranslationsTo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTo app = _TranslationsAppTo._(_root);
	@override late final _TranslationsHomeTo home = _TranslationsHomeTo._(_root);
	@override late final _TranslationsCommonTo common = _TranslationsCommonTo._(_root);
	@override late final _TranslationsSettingsTo settings = _TranslationsSettingsTo._(_root);
	@override late final _TranslationsRecipesTo recipes = _TranslationsRecipesTo._(_root);
	@override late final _TranslationsRecipeDetailTo recipeDetail = _TranslationsRecipeDetailTo._(_root);
	@override late final _TranslationsFiltersTo filters = _TranslationsFiltersTo._(_root);
	@override late final _TranslationsShoppingListTo shoppingList = _TranslationsShoppingListTo._(_root);
	@override late final _TranslationsMealPlanTo mealPlan = _TranslationsMealPlanTo._(_root);
	@override late final _TranslationsInventoryTo inventory = _TranslationsInventoryTo._(_root);
	@override late final _TranslationsBarcodeScanTo barcodeScan = _TranslationsBarcodeScanTo._(_root);
	@override late final _TranslationsReceiptScanTo receiptScan = _TranslationsReceiptScanTo._(_root);
	@override late final _TranslationsBatchCookingTo batchCooking = _TranslationsBatchCookingTo._(_root);
	@override late final _TranslationsVisitedDomainsTo visitedDomains = _TranslationsVisitedDomainsTo._(_root);
	@override late final _TranslationsDomainDiscoveryTo domainDiscovery = _TranslationsDomainDiscoveryTo._(_root);
	@override late final _TranslationsInventorySuggestionsTo inventorySuggestions = _TranslationsInventorySuggestionsTo._(_root);
	@override late final _TranslationsUpgradeTo upgrade = _TranslationsUpgradeTo._(_root);
	@override late final _TranslationsTourTo tour = _TranslationsTourTo._(_root);
	@override late final _TranslationsManualRecipeTo manualRecipe = _TranslationsManualRecipeTo._(_root);
	@override late final _TranslationsRecipeEditTo recipeEdit = _TranslationsRecipeEditTo._(_root);
	@override late final _TranslationsErrorsTo errors = _TranslationsErrorsTo._(_root);
}

// Path: app
class _TranslationsAppTo extends TranslationsAppEn {
	_TranslationsAppTo._(TranslationsTo root) : this._root = root, super.internal(root);

	final TranslationsTo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTo extends TranslationsHomeEn {
	_TranslationsHomeTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTo extends TranslationsCommonEn {
	_TranslationsCommonTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTo extends TranslationsSettingsEn {
	_TranslationsSettingsTo._(TranslationsTo root) : this._root = root, super.internal(root);

	final TranslationsTo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTo measurements = _TranslationsSettingsMeasurementsTo._(_root);
	@override late final _TranslationsSettingsDataManagementTo dataManagement = _TranslationsSettingsDataManagementTo._(_root);
	@override late final _TranslationsSettingsVersionTo version = _TranslationsSettingsVersionTo._(_root);
}

// Path: recipes
class _TranslationsRecipesTo extends TranslationsRecipesEn {
	_TranslationsRecipesTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTo._(TranslationsTo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTo nutrition = _TranslationsRecipeDetailNutritionTo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTo prepAhead = _TranslationsRecipeDetailPrepAheadTo._(_root);
...
// Path: filters
class _TranslationsFiltersTo extends TranslationsFiltersEn {
	_TranslationsFiltersTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTo extends TranslationsShoppingListEn {
	_TranslationsShoppingListTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTo extends TranslationsMealPlanEn {
	_TranslationsMealPlanTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTo extends TranslationsInventoryEn {
	_TranslationsInventoryTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTo extends TranslationsUpgradeEn {
	_TranslationsUpgradeTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTo extends TranslationsTourEn {
	_TranslationsTourTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTo extends TranslationsErrorsEn {
	_TranslationsErrorsTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTo._(TranslationsTo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTo metric = _TranslationsSettingsMeasurementsMetricTo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTo imperial = _TranslationsSettingsMeasurementsImperialTo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTo._(TranslationsTo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <to>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTo {
