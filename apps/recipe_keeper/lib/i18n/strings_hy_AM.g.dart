...
// Path: <root>
class TranslationsHyAm extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsHyAm({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.hyAm,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <hy-AM>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsHyAm _root = this; // ignore: unused_field

	@override 
	TranslationsHyAm $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsHyAm(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppHyAm app = _TranslationsAppHyAm._(_root);
	@override late final _TranslationsHomeHyAm home = _TranslationsHomeHyAm._(_root);
	@override late final _TranslationsCommonHyAm common = _TranslationsCommonHyAm._(_root);
	@override late final _TranslationsSettingsHyAm settings = _TranslationsSettingsHyAm._(_root);
	@override late final _TranslationsRecipesHyAm recipes = _TranslationsRecipesHyAm._(_root);
	@override late final _TranslationsRecipeDetailHyAm recipeDetail = _TranslationsRecipeDetailHyAm._(_root);
	@override late final _TranslationsFiltersHyAm filters = _TranslationsFiltersHyAm._(_root);
	@override late final _TranslationsShoppingListHyAm shoppingList = _TranslationsShoppingListHyAm._(_root);
	@override late final _TranslationsMealPlanHyAm mealPlan = _TranslationsMealPlanHyAm._(_root);
	@override late final _TranslationsInventoryHyAm inventory = _TranslationsInventoryHyAm._(_root);
	@override late final _TranslationsBarcodeScanHyAm barcodeScan = _TranslationsBarcodeScanHyAm._(_root);
	@override late final _TranslationsReceiptScanHyAm receiptScan = _TranslationsReceiptScanHyAm._(_root);
	@override late final _TranslationsBatchCookingHyAm batchCooking = _TranslationsBatchCookingHyAm._(_root);
	@override late final _TranslationsVisitedDomainsHyAm visitedDomains = _TranslationsVisitedDomainsHyAm._(_root);
	@override late final _TranslationsDomainDiscoveryHyAm domainDiscovery = _TranslationsDomainDiscoveryHyAm._(_root);
	@override late final _TranslationsInventorySuggestionsHyAm inventorySuggestions = _TranslationsInventorySuggestionsHyAm._(_root);
	@override late final _TranslationsUpgradeHyAm upgrade = _TranslationsUpgradeHyAm._(_root);
	@override late final _TranslationsTourHyAm tour = _TranslationsTourHyAm._(_root);
	@override late final _TranslationsManualRecipeHyAm manualRecipe = _TranslationsManualRecipeHyAm._(_root);
	@override late final _TranslationsRecipeEditHyAm recipeEdit = _TranslationsRecipeEditHyAm._(_root);
	@override late final _TranslationsErrorsHyAm errors = _TranslationsErrorsHyAm._(_root);
}

// Path: app
class _TranslationsAppHyAm extends TranslationsAppEn {
	_TranslationsAppHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);

	final TranslationsHyAm _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeHyAm extends TranslationsHomeEn {
	_TranslationsHomeHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHyAm extends TranslationsCommonEn {
	_TranslationsCommonHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHyAm extends TranslationsSettingsEn {
	_TranslationsSettingsHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);

	final TranslationsHyAm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHyAm measurements = _TranslationsSettingsMeasurementsHyAm._(_root);
	@override late final _TranslationsSettingsDataManagementHyAm dataManagement = _TranslationsSettingsDataManagementHyAm._(_root);
	@override late final _TranslationsSettingsVersionHyAm version = _TranslationsSettingsVersionHyAm._(_root);
}

// Path: recipes
class _TranslationsRecipesHyAm extends TranslationsRecipesEn {
	_TranslationsRecipesHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHyAm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHyAm nutrition = _TranslationsRecipeDetailNutritionHyAm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHyAm prepAhead = _TranslationsRecipeDetailPrepAheadHyAm._(_root);
...
// Path: filters
class _TranslationsFiltersHyAm extends TranslationsFiltersEn {
	_TranslationsFiltersHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHyAm extends TranslationsShoppingListEn {
	_TranslationsShoppingListHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHyAm extends TranslationsMealPlanEn {
	_TranslationsMealPlanHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHyAm extends TranslationsInventoryEn {
	_TranslationsInventoryHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHyAm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHyAm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHyAm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHyAm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHyAm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHyAm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHyAm extends TranslationsUpgradeEn {
	_TranslationsUpgradeHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHyAm extends TranslationsTourEn {
	_TranslationsTourHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHyAm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHyAm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsHyAm extends TranslationsErrorsEn {
	_TranslationsErrorsHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHyAm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHyAm metric = _TranslationsSettingsMeasurementsMetricHyAm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHyAm imperial = _TranslationsSettingsMeasurementsImperialHyAm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHyAm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHyAm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHyAm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHyAm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHyAm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHyAm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHyAm._(TranslationsHyAm root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <hy-AM>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsHyAm {
