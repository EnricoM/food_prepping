...
class TranslationsAm extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppAm app = _TranslationsAppAm._(_root);
	@override late final _TranslationsHomeAm home = _TranslationsHomeAm._(_root);
	@override late final _TranslationsCommonAm common = _TranslationsCommonAm._(_root);
	@override late final _TranslationsSettingsAm settings = _TranslationsSettingsAm._(_root);
	@override late final _TranslationsRecipesAm recipes = _TranslationsRecipesAm._(_root);
	@override late final _TranslationsRecipeDetailAm recipeDetail = _TranslationsRecipeDetailAm._(_root);
	@override late final _TranslationsFiltersAm filters = _TranslationsFiltersAm._(_root);
	@override late final _TranslationsShoppingListAm shoppingList = _TranslationsShoppingListAm._(_root);
	@override late final _TranslationsMealPlanAm mealPlan = _TranslationsMealPlanAm._(_root);
	@override late final _TranslationsInventoryAm inventory = _TranslationsInventoryAm._(_root);
	@override late final _TranslationsBarcodeScanAm barcodeScan = _TranslationsBarcodeScanAm._(_root);
	@override late final _TranslationsReceiptScanAm receiptScan = _TranslationsReceiptScanAm._(_root);
	@override late final _TranslationsBatchCookingAm batchCooking = _TranslationsBatchCookingAm._(_root);
	@override late final _TranslationsVisitedDomainsAm visitedDomains = _TranslationsVisitedDomainsAm._(_root);
	@override late final _TranslationsDomainDiscoveryAm domainDiscovery = _TranslationsDomainDiscoveryAm._(_root);
	@override late final _TranslationsInventorySuggestionsAm inventorySuggestions = _TranslationsInventorySuggestionsAm._(_root);
	@override late final _TranslationsUpgradeAm upgrade = _TranslationsUpgradeAm._(_root);
	@override late final _TranslationsTourAm tour = _TranslationsTourAm._(_root);
	@override late final _TranslationsManualRecipeAm manualRecipe = _TranslationsManualRecipeAm._(_root);
	@override late final _TranslationsRecipeEditAm recipeEdit = _TranslationsRecipeEditAm._(_root);
	@override late final _TranslationsErrorsAm errors = _TranslationsErrorsAm._(_root);
}

// Path: app
class _TranslationsAppAm extends TranslationsAppEn {
	_TranslationsAppAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeAm extends TranslationsHomeEn {
	_TranslationsHomeAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAm extends TranslationsCommonEn {
	_TranslationsCommonAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAm extends TranslationsSettingsEn {
	_TranslationsSettingsAm._(TranslationsAm root) : this._root = root, super.internal(root);

	final TranslationsAm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAm measurements = _TranslationsSettingsMeasurementsAm._(_root);
	@override late final _TranslationsSettingsDataManagementAm dataManagement = _TranslationsSettingsDataManagementAm._(_root);
	@override late final _TranslationsSettingsVersionAm version = _TranslationsSettingsVersionAm._(_root);
}

// Path: recipes
class _TranslationsRecipesAm extends TranslationsRecipesEn {
	_TranslationsRecipesAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAm._(TranslationsAm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAm nutrition = _TranslationsRecipeDetailNutritionAm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAm prepAhead = _TranslationsRecipeDetailPrepAheadAm._(_root);
...
// Path: filters
class _TranslationsFiltersAm extends TranslationsFiltersEn {
	_TranslationsFiltersAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAm extends TranslationsShoppingListEn {
	_TranslationsShoppingListAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAm extends TranslationsMealPlanEn {
	_TranslationsMealPlanAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAm extends TranslationsInventoryEn {
	_TranslationsInventoryAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAm extends TranslationsUpgradeEn {
	_TranslationsUpgradeAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAm extends TranslationsTourEn {
	_TranslationsTourAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAm extends TranslationsErrorsEn {
	_TranslationsErrorsAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAm._(TranslationsAm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAm metric = _TranslationsSettingsMeasurementsMetricAm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAm imperial = _TranslationsSettingsMeasurementsImperialAm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAm._(TranslationsAm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAm._(TranslationsAm root) : this._root = root, super.internal(root);
