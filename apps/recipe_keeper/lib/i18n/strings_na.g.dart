...
// Path: <root>
class TranslationsNa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <na>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNa _root = this; // ignore: unused_field

	@override 
	TranslationsNa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNa app = _TranslationsAppNa._(_root);
	@override late final _TranslationsHomeNa home = _TranslationsHomeNa._(_root);
	@override late final _TranslationsCommonNa common = _TranslationsCommonNa._(_root);
	@override late final _TranslationsSettingsNa settings = _TranslationsSettingsNa._(_root);
	@override late final _TranslationsRecipesNa recipes = _TranslationsRecipesNa._(_root);
	@override late final _TranslationsRecipeDetailNa recipeDetail = _TranslationsRecipeDetailNa._(_root);
	@override late final _TranslationsFiltersNa filters = _TranslationsFiltersNa._(_root);
	@override late final _TranslationsShoppingListNa shoppingList = _TranslationsShoppingListNa._(_root);
	@override late final _TranslationsMealPlanNa mealPlan = _TranslationsMealPlanNa._(_root);
	@override late final _TranslationsInventoryNa inventory = _TranslationsInventoryNa._(_root);
	@override late final _TranslationsBarcodeScanNa barcodeScan = _TranslationsBarcodeScanNa._(_root);
	@override late final _TranslationsReceiptScanNa receiptScan = _TranslationsReceiptScanNa._(_root);
	@override late final _TranslationsBatchCookingNa batchCooking = _TranslationsBatchCookingNa._(_root);
	@override late final _TranslationsVisitedDomainsNa visitedDomains = _TranslationsVisitedDomainsNa._(_root);
	@override late final _TranslationsDomainDiscoveryNa domainDiscovery = _TranslationsDomainDiscoveryNa._(_root);
	@override late final _TranslationsInventorySuggestionsNa inventorySuggestions = _TranslationsInventorySuggestionsNa._(_root);
	@override late final _TranslationsUpgradeNa upgrade = _TranslationsUpgradeNa._(_root);
	@override late final _TranslationsTourNa tour = _TranslationsTourNa._(_root);
	@override late final _TranslationsManualRecipeNa manualRecipe = _TranslationsManualRecipeNa._(_root);
	@override late final _TranslationsRecipeEditNa recipeEdit = _TranslationsRecipeEditNa._(_root);
	@override late final _TranslationsErrorsNa errors = _TranslationsErrorsNa._(_root);
}

// Path: app
class _TranslationsAppNa extends TranslationsAppEn {
	_TranslationsAppNa._(TranslationsNa root) : this._root = root, super.internal(root);

	final TranslationsNa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNa extends TranslationsHomeEn {
	_TranslationsHomeNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNa extends TranslationsCommonEn {
	_TranslationsCommonNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNa extends TranslationsSettingsEn {
	_TranslationsSettingsNa._(TranslationsNa root) : this._root = root, super.internal(root);

	final TranslationsNa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNa measurements = _TranslationsSettingsMeasurementsNa._(_root);
	@override late final _TranslationsSettingsDataManagementNa dataManagement = _TranslationsSettingsDataManagementNa._(_root);
	@override late final _TranslationsSettingsVersionNa version = _TranslationsSettingsVersionNa._(_root);
}

// Path: recipes
class _TranslationsRecipesNa extends TranslationsRecipesEn {
	_TranslationsRecipesNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNa._(TranslationsNa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNa nutrition = _TranslationsRecipeDetailNutritionNa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNa prepAhead = _TranslationsRecipeDetailPrepAheadNa._(_root);
...
// Path: filters
class _TranslationsFiltersNa extends TranslationsFiltersEn {
	_TranslationsFiltersNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNa extends TranslationsShoppingListEn {
	_TranslationsShoppingListNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNa extends TranslationsMealPlanEn {
	_TranslationsMealPlanNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNa extends TranslationsInventoryEn {
	_TranslationsInventoryNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNa extends TranslationsUpgradeEn {
	_TranslationsUpgradeNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNa extends TranslationsTourEn {
	_TranslationsTourNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNa extends TranslationsErrorsEn {
	_TranslationsErrorsNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNa._(TranslationsNa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNa metric = _TranslationsSettingsMeasurementsMetricNa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNa imperial = _TranslationsSettingsMeasurementsImperialNa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNa._(TranslationsNa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <na>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNa {
