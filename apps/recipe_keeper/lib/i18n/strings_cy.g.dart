...
// Path: <root>
class TranslationsCy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsCy _root = this; // ignore: unused_field

	@override 
	TranslationsCy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCy app = _TranslationsAppCy._(_root);
	@override late final _TranslationsHomeCy home = _TranslationsHomeCy._(_root);
	@override late final _TranslationsCommonCy common = _TranslationsCommonCy._(_root);
	@override late final _TranslationsSettingsCy settings = _TranslationsSettingsCy._(_root);
	@override late final _TranslationsRecipesCy recipes = _TranslationsRecipesCy._(_root);
	@override late final _TranslationsRecipeDetailCy recipeDetail = _TranslationsRecipeDetailCy._(_root);
	@override late final _TranslationsFiltersCy filters = _TranslationsFiltersCy._(_root);
	@override late final _TranslationsShoppingListCy shoppingList = _TranslationsShoppingListCy._(_root);
	@override late final _TranslationsMealPlanCy mealPlan = _TranslationsMealPlanCy._(_root);
	@override late final _TranslationsInventoryCy inventory = _TranslationsInventoryCy._(_root);
	@override late final _TranslationsBarcodeScanCy barcodeScan = _TranslationsBarcodeScanCy._(_root);
	@override late final _TranslationsReceiptScanCy receiptScan = _TranslationsReceiptScanCy._(_root);
	@override late final _TranslationsBatchCookingCy batchCooking = _TranslationsBatchCookingCy._(_root);
	@override late final _TranslationsVisitedDomainsCy visitedDomains = _TranslationsVisitedDomainsCy._(_root);
	@override late final _TranslationsDomainDiscoveryCy domainDiscovery = _TranslationsDomainDiscoveryCy._(_root);
	@override late final _TranslationsInventorySuggestionsCy inventorySuggestions = _TranslationsInventorySuggestionsCy._(_root);
	@override late final _TranslationsUpgradeCy upgrade = _TranslationsUpgradeCy._(_root);
	@override late final _TranslationsTourCy tour = _TranslationsTourCy._(_root);
	@override late final _TranslationsManualRecipeCy manualRecipe = _TranslationsManualRecipeCy._(_root);
	@override late final _TranslationsRecipeEditCy recipeEdit = _TranslationsRecipeEditCy._(_root);
	@override late final _TranslationsErrorsCy errors = _TranslationsErrorsCy._(_root);
}

// Path: app
class _TranslationsAppCy extends TranslationsAppEn {
	_TranslationsAppCy._(TranslationsCy root) : this._root = root, super.internal(root);

	final TranslationsCy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeCy extends TranslationsHomeEn {
	_TranslationsHomeCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCy extends TranslationsCommonEn {
	_TranslationsCommonCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCy extends TranslationsSettingsEn {
	_TranslationsSettingsCy._(TranslationsCy root) : this._root = root, super.internal(root);

	final TranslationsCy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCy measurements = _TranslationsSettingsMeasurementsCy._(_root);
	@override late final _TranslationsSettingsDataManagementCy dataManagement = _TranslationsSettingsDataManagementCy._(_root);
	@override late final _TranslationsSettingsVersionCy version = _TranslationsSettingsVersionCy._(_root);
}

// Path: recipes
class _TranslationsRecipesCy extends TranslationsRecipesEn {
	_TranslationsRecipesCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCy._(TranslationsCy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCy nutrition = _TranslationsRecipeDetailNutritionCy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCy prepAhead = _TranslationsRecipeDetailPrepAheadCy._(_root);
...
// Path: filters
class _TranslationsFiltersCy extends TranslationsFiltersEn {
	_TranslationsFiltersCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCy extends TranslationsShoppingListEn {
	_TranslationsShoppingListCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCy extends TranslationsMealPlanEn {
	_TranslationsMealPlanCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCy extends TranslationsInventoryEn {
	_TranslationsInventoryCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCy extends TranslationsUpgradeEn {
	_TranslationsUpgradeCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCy extends TranslationsTourEn {
	_TranslationsTourCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCy extends TranslationsErrorsEn {
	_TranslationsErrorsCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCy._(TranslationsCy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCy metric = _TranslationsSettingsMeasurementsMetricCy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCy imperial = _TranslationsSettingsMeasurementsImperialCy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCy._(TranslationsCy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCy._(TranslationsCy root) : this._root = root, super.internal(root);
