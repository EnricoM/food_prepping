...
class TranslationsDa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesDa recipes = _TranslationsRecipesDa._(_root);
	@override late final _TranslationsRecipeDetailDa recipeDetail = _TranslationsRecipeDetailDa._(_root);
	@override late final _TranslationsFiltersDa filters = _TranslationsFiltersDa._(_root);
	@override late final _TranslationsShoppingListDa shoppingList = _TranslationsShoppingListDa._(_root);
	@override late final _TranslationsMealPlanDa mealPlan = _TranslationsMealPlanDa._(_root);
	@override late final _TranslationsInventoryDa inventory = _TranslationsInventoryDa._(_root);
	@override late final _TranslationsBarcodeScanDa barcodeScan = _TranslationsBarcodeScanDa._(_root);
	@override late final _TranslationsReceiptScanDa receiptScan = _TranslationsReceiptScanDa._(_root);
	@override late final _TranslationsBatchCookingDa batchCooking = _TranslationsBatchCookingDa._(_root);
	@override late final _TranslationsVisitedDomainsDa visitedDomains = _TranslationsVisitedDomainsDa._(_root);
	@override late final _TranslationsDomainDiscoveryDa domainDiscovery = _TranslationsDomainDiscoveryDa._(_root);
	@override late final _TranslationsInventorySuggestionsDa inventorySuggestions = _TranslationsInventorySuggestionsDa._(_root);
	@override late final _TranslationsUpgradeDa upgrade = _TranslationsUpgradeDa._(_root);
	@override late final _TranslationsTourDa tour = _TranslationsTourDa._(_root);
	@override late final _TranslationsManualRecipeDa manualRecipe = _TranslationsManualRecipeDa._(_root);
	@override late final _TranslationsRecipeEditDa recipeEdit = _TranslationsRecipeEditDa._(_root);
...
class _TranslationsSettingsDa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsDa measurements = _TranslationsSettingsMeasurementsDa._(_root);
	@override late final _TranslationsSettingsDataManagementDa dataManagement = _TranslationsSettingsDataManagementDa._(_root);
	@override late final _TranslationsSettingsVersionDa version = _TranslationsSettingsVersionDa._(_root);
}

// Path: recipes
class _TranslationsRecipesDa extends TranslationsRecipesEn {
	_TranslationsRecipesDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailDa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailDa._(TranslationsDa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionDa nutrition = _TranslationsRecipeDetailNutritionDa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadDa prepAhead = _TranslationsRecipeDetailPrepAheadDa._(_root);
...
// Path: filters
class _TranslationsFiltersDa extends TranslationsFiltersEn {
	_TranslationsFiltersDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListDa extends TranslationsShoppingListEn {
	_TranslationsShoppingListDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanDa extends TranslationsMealPlanEn {
	_TranslationsMealPlanDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryDa extends TranslationsInventoryEn {
	_TranslationsInventoryDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanDa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanDa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingDa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsDa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryDa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsDa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeDa extends TranslationsUpgradeEn {
	_TranslationsUpgradeDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourDa extends TranslationsTourEn {
	_TranslationsTourDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeDa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditDa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsDa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsDa._(TranslationsDa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricDa metric = _TranslationsSettingsMeasurementsMetricDa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialDa imperial = _TranslationsSettingsMeasurementsImperialDa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementDa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionDa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionDa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadDa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricDa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricDa._(TranslationsDa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialDa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialDa._(TranslationsDa root) : this._root = root, super.internal(root);
