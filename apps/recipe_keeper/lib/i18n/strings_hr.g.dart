...
// Path: <root>
class TranslationsHr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppHr app = _TranslationsAppHr._(_root);
	@override late final _TranslationsHomeHr home = _TranslationsHomeHr._(_root);
	@override late final _TranslationsCommonHr common = _TranslationsCommonHr._(_root);
	@override late final _TranslationsSettingsHr settings = _TranslationsSettingsHr._(_root);
	@override late final _TranslationsRecipesHr recipes = _TranslationsRecipesHr._(_root);
	@override late final _TranslationsRecipeDetailHr recipeDetail = _TranslationsRecipeDetailHr._(_root);
	@override late final _TranslationsFiltersHr filters = _TranslationsFiltersHr._(_root);
	@override late final _TranslationsShoppingListHr shoppingList = _TranslationsShoppingListHr._(_root);
	@override late final _TranslationsMealPlanHr mealPlan = _TranslationsMealPlanHr._(_root);
	@override late final _TranslationsInventoryHr inventory = _TranslationsInventoryHr._(_root);
	@override late final _TranslationsBarcodeScanHr barcodeScan = _TranslationsBarcodeScanHr._(_root);
	@override late final _TranslationsReceiptScanHr receiptScan = _TranslationsReceiptScanHr._(_root);
	@override late final _TranslationsBatchCookingHr batchCooking = _TranslationsBatchCookingHr._(_root);
	@override late final _TranslationsVisitedDomainsHr visitedDomains = _TranslationsVisitedDomainsHr._(_root);
	@override late final _TranslationsDomainDiscoveryHr domainDiscovery = _TranslationsDomainDiscoveryHr._(_root);
	@override late final _TranslationsInventorySuggestionsHr inventorySuggestions = _TranslationsInventorySuggestionsHr._(_root);
	@override late final _TranslationsUpgradeHr upgrade = _TranslationsUpgradeHr._(_root);
	@override late final _TranslationsTourHr tour = _TranslationsTourHr._(_root);
	@override late final _TranslationsManualRecipeHr manualRecipe = _TranslationsManualRecipeHr._(_root);
	@override late final _TranslationsRecipeEditHr recipeEdit = _TranslationsRecipeEditHr._(_root);
	@override late final _TranslationsErrorsHr errors = _TranslationsErrorsHr._(_root);
}

// Path: app
class _TranslationsAppHr extends TranslationsAppEn {
	_TranslationsAppHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeHr extends TranslationsHomeEn {
	_TranslationsHomeHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHr extends TranslationsCommonEn {
	_TranslationsCommonHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHr extends TranslationsSettingsEn {
	_TranslationsSettingsHr._(TranslationsHr root) : this._root = root, super.internal(root);

	final TranslationsHr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHr measurements = _TranslationsSettingsMeasurementsHr._(_root);
	@override late final _TranslationsSettingsDataManagementHr dataManagement = _TranslationsSettingsDataManagementHr._(_root);
	@override late final _TranslationsSettingsVersionHr version = _TranslationsSettingsVersionHr._(_root);
}

// Path: recipes
class _TranslationsRecipesHr extends TranslationsRecipesEn {
	_TranslationsRecipesHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHr._(TranslationsHr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHr nutrition = _TranslationsRecipeDetailNutritionHr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHr prepAhead = _TranslationsRecipeDetailPrepAheadHr._(_root);
...
// Path: filters
class _TranslationsFiltersHr extends TranslationsFiltersEn {
	_TranslationsFiltersHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHr extends TranslationsShoppingListEn {
	_TranslationsShoppingListHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHr extends TranslationsMealPlanEn {
	_TranslationsMealPlanHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHr extends TranslationsInventoryEn {
	_TranslationsInventoryHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHr extends TranslationsUpgradeEn {
	_TranslationsUpgradeHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHr extends TranslationsTourEn {
	_TranslationsTourHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHr._(TranslationsHr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHr metric = _TranslationsSettingsMeasurementsMetricHr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHr imperial = _TranslationsSettingsMeasurementsImperialHr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHr._(TranslationsHr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHr._(TranslationsHr root) : this._root = root, super.internal(root);
