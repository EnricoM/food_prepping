...
// Path: <root>
class TranslationsKg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsKg _root = this; // ignore: unused_field

	@override 
	TranslationsKg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKg app = _TranslationsAppKg._(_root);
	@override late final _TranslationsHomeKg home = _TranslationsHomeKg._(_root);
	@override late final _TranslationsCommonKg common = _TranslationsCommonKg._(_root);
	@override late final _TranslationsSettingsKg settings = _TranslationsSettingsKg._(_root);
	@override late final _TranslationsRecipesKg recipes = _TranslationsRecipesKg._(_root);
	@override late final _TranslationsRecipeDetailKg recipeDetail = _TranslationsRecipeDetailKg._(_root);
	@override late final _TranslationsFiltersKg filters = _TranslationsFiltersKg._(_root);
	@override late final _TranslationsShoppingListKg shoppingList = _TranslationsShoppingListKg._(_root);
	@override late final _TranslationsMealPlanKg mealPlan = _TranslationsMealPlanKg._(_root);
	@override late final _TranslationsInventoryKg inventory = _TranslationsInventoryKg._(_root);
	@override late final _TranslationsBarcodeScanKg barcodeScan = _TranslationsBarcodeScanKg._(_root);
	@override late final _TranslationsReceiptScanKg receiptScan = _TranslationsReceiptScanKg._(_root);
	@override late final _TranslationsBatchCookingKg batchCooking = _TranslationsBatchCookingKg._(_root);
	@override late final _TranslationsVisitedDomainsKg visitedDomains = _TranslationsVisitedDomainsKg._(_root);
	@override late final _TranslationsDomainDiscoveryKg domainDiscovery = _TranslationsDomainDiscoveryKg._(_root);
	@override late final _TranslationsInventorySuggestionsKg inventorySuggestions = _TranslationsInventorySuggestionsKg._(_root);
	@override late final _TranslationsUpgradeKg upgrade = _TranslationsUpgradeKg._(_root);
	@override late final _TranslationsTourKg tour = _TranslationsTourKg._(_root);
	@override late final _TranslationsManualRecipeKg manualRecipe = _TranslationsManualRecipeKg._(_root);
	@override late final _TranslationsRecipeEditKg recipeEdit = _TranslationsRecipeEditKg._(_root);
	@override late final _TranslationsErrorsKg errors = _TranslationsErrorsKg._(_root);
}

// Path: app
class _TranslationsAppKg extends TranslationsAppEn {
	_TranslationsAppKg._(TranslationsKg root) : this._root = root, super.internal(root);

	final TranslationsKg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKg extends TranslationsHomeEn {
	_TranslationsHomeKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKg extends TranslationsCommonEn {
	_TranslationsCommonKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKg extends TranslationsSettingsEn {
	_TranslationsSettingsKg._(TranslationsKg root) : this._root = root, super.internal(root);

	final TranslationsKg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKg measurements = _TranslationsSettingsMeasurementsKg._(_root);
	@override late final _TranslationsSettingsDataManagementKg dataManagement = _TranslationsSettingsDataManagementKg._(_root);
	@override late final _TranslationsSettingsVersionKg version = _TranslationsSettingsVersionKg._(_root);
}

// Path: recipes
class _TranslationsRecipesKg extends TranslationsRecipesEn {
	_TranslationsRecipesKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKg._(TranslationsKg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKg nutrition = _TranslationsRecipeDetailNutritionKg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKg prepAhead = _TranslationsRecipeDetailPrepAheadKg._(_root);
...
// Path: filters
class _TranslationsFiltersKg extends TranslationsFiltersEn {
	_TranslationsFiltersKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKg extends TranslationsShoppingListEn {
	_TranslationsShoppingListKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKg extends TranslationsMealPlanEn {
	_TranslationsMealPlanKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKg extends TranslationsInventoryEn {
	_TranslationsInventoryKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKg extends TranslationsUpgradeEn {
	_TranslationsUpgradeKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKg extends TranslationsTourEn {
	_TranslationsTourKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKg extends TranslationsErrorsEn {
	_TranslationsErrorsKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKg._(TranslationsKg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKg metric = _TranslationsSettingsMeasurementsMetricKg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKg imperial = _TranslationsSettingsMeasurementsImperialKg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKg._(TranslationsKg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kg>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKg {
