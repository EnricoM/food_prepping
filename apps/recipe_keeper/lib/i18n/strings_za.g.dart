...
// Path: <root>
class TranslationsZa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsZa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <za>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsZa _root = this; // ignore: unused_field

	@override 
	TranslationsZa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsZa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppZa app = _TranslationsAppZa._(_root);
	@override late final _TranslationsHomeZa home = _TranslationsHomeZa._(_root);
	@override late final _TranslationsCommonZa common = _TranslationsCommonZa._(_root);
	@override late final _TranslationsSettingsZa settings = _TranslationsSettingsZa._(_root);
	@override late final _TranslationsRecipesZa recipes = _TranslationsRecipesZa._(_root);
	@override late final _TranslationsRecipeDetailZa recipeDetail = _TranslationsRecipeDetailZa._(_root);
	@override late final _TranslationsFiltersZa filters = _TranslationsFiltersZa._(_root);
	@override late final _TranslationsShoppingListZa shoppingList = _TranslationsShoppingListZa._(_root);
	@override late final _TranslationsMealPlanZa mealPlan = _TranslationsMealPlanZa._(_root);
	@override late final _TranslationsInventoryZa inventory = _TranslationsInventoryZa._(_root);
	@override late final _TranslationsBarcodeScanZa barcodeScan = _TranslationsBarcodeScanZa._(_root);
	@override late final _TranslationsReceiptScanZa receiptScan = _TranslationsReceiptScanZa._(_root);
	@override late final _TranslationsBatchCookingZa batchCooking = _TranslationsBatchCookingZa._(_root);
	@override late final _TranslationsVisitedDomainsZa visitedDomains = _TranslationsVisitedDomainsZa._(_root);
	@override late final _TranslationsDomainDiscoveryZa domainDiscovery = _TranslationsDomainDiscoveryZa._(_root);
	@override late final _TranslationsInventorySuggestionsZa inventorySuggestions = _TranslationsInventorySuggestionsZa._(_root);
	@override late final _TranslationsUpgradeZa upgrade = _TranslationsUpgradeZa._(_root);
	@override late final _TranslationsTourZa tour = _TranslationsTourZa._(_root);
	@override late final _TranslationsManualRecipeZa manualRecipe = _TranslationsManualRecipeZa._(_root);
	@override late final _TranslationsRecipeEditZa recipeEdit = _TranslationsRecipeEditZa._(_root);
	@override late final _TranslationsErrorsZa errors = _TranslationsErrorsZa._(_root);
}

// Path: app
class _TranslationsAppZa extends TranslationsAppEn {
	_TranslationsAppZa._(TranslationsZa root) : this._root = root, super.internal(root);

	final TranslationsZa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeZa extends TranslationsHomeEn {
	_TranslationsHomeZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonZa extends TranslationsCommonEn {
	_TranslationsCommonZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsZa extends TranslationsSettingsEn {
	_TranslationsSettingsZa._(TranslationsZa root) : this._root = root, super.internal(root);

	final TranslationsZa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsZa measurements = _TranslationsSettingsMeasurementsZa._(_root);
	@override late final _TranslationsSettingsDataManagementZa dataManagement = _TranslationsSettingsDataManagementZa._(_root);
	@override late final _TranslationsSettingsVersionZa version = _TranslationsSettingsVersionZa._(_root);
}

// Path: recipes
class _TranslationsRecipesZa extends TranslationsRecipesEn {
	_TranslationsRecipesZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZa._(TranslationsZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionZa nutrition = _TranslationsRecipeDetailNutritionZa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadZa prepAhead = _TranslationsRecipeDetailPrepAheadZa._(_root);
...
// Path: filters
class _TranslationsFiltersZa extends TranslationsFiltersEn {
	_TranslationsFiltersZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListZa extends TranslationsShoppingListEn {
	_TranslationsShoppingListZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanZa extends TranslationsMealPlanEn {
	_TranslationsMealPlanZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryZa extends TranslationsInventoryEn {
	_TranslationsInventoryZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanZa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingZa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryZa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsZa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeZa extends TranslationsUpgradeEn {
	_TranslationsUpgradeZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourZa extends TranslationsTourEn {
	_TranslationsTourZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsZa extends TranslationsErrorsEn {
	_TranslationsErrorsZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsZa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZa._(TranslationsZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricZa metric = _TranslationsSettingsMeasurementsMetricZa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialZa imperial = _TranslationsSettingsMeasurementsImperialZa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementZa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionZa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionZa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadZa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricZa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialZa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZa._(TranslationsZa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <za>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsZa {
