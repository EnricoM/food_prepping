...
// Path: <root>
class TranslationsZu extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsZu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsZu _root = this; // ignore: unused_field

	@override 
	TranslationsZu $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsZu(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppZu app = _TranslationsAppZu._(_root);
	@override late final _TranslationsHomeZu home = _TranslationsHomeZu._(_root);
	@override late final _TranslationsCommonZu common = _TranslationsCommonZu._(_root);
	@override late final _TranslationsSettingsZu settings = _TranslationsSettingsZu._(_root);
	@override late final _TranslationsRecipesZu recipes = _TranslationsRecipesZu._(_root);
	@override late final _TranslationsRecipeDetailZu recipeDetail = _TranslationsRecipeDetailZu._(_root);
	@override late final _TranslationsFiltersZu filters = _TranslationsFiltersZu._(_root);
	@override late final _TranslationsShoppingListZu shoppingList = _TranslationsShoppingListZu._(_root);
	@override late final _TranslationsMealPlanZu mealPlan = _TranslationsMealPlanZu._(_root);
	@override late final _TranslationsInventoryZu inventory = _TranslationsInventoryZu._(_root);
	@override late final _TranslationsBarcodeScanZu barcodeScan = _TranslationsBarcodeScanZu._(_root);
	@override late final _TranslationsReceiptScanZu receiptScan = _TranslationsReceiptScanZu._(_root);
	@override late final _TranslationsBatchCookingZu batchCooking = _TranslationsBatchCookingZu._(_root);
	@override late final _TranslationsVisitedDomainsZu visitedDomains = _TranslationsVisitedDomainsZu._(_root);
	@override late final _TranslationsDomainDiscoveryZu domainDiscovery = _TranslationsDomainDiscoveryZu._(_root);
	@override late final _TranslationsInventorySuggestionsZu inventorySuggestions = _TranslationsInventorySuggestionsZu._(_root);
	@override late final _TranslationsUpgradeZu upgrade = _TranslationsUpgradeZu._(_root);
	@override late final _TranslationsTourZu tour = _TranslationsTourZu._(_root);
	@override late final _TranslationsManualRecipeZu manualRecipe = _TranslationsManualRecipeZu._(_root);
	@override late final _TranslationsRecipeEditZu recipeEdit = _TranslationsRecipeEditZu._(_root);
	@override late final _TranslationsErrorsZu errors = _TranslationsErrorsZu._(_root);
}

// Path: app
class _TranslationsAppZu extends TranslationsAppEn {
	_TranslationsAppZu._(TranslationsZu root) : this._root = root, super.internal(root);

	final TranslationsZu _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeZu extends TranslationsHomeEn {
	_TranslationsHomeZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonZu extends TranslationsCommonEn {
	_TranslationsCommonZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsZu extends TranslationsSettingsEn {
	_TranslationsSettingsZu._(TranslationsZu root) : this._root = root, super.internal(root);

	final TranslationsZu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsZu measurements = _TranslationsSettingsMeasurementsZu._(_root);
	@override late final _TranslationsSettingsDataManagementZu dataManagement = _TranslationsSettingsDataManagementZu._(_root);
	@override late final _TranslationsSettingsVersionZu version = _TranslationsSettingsVersionZu._(_root);
}

// Path: recipes
class _TranslationsRecipesZu extends TranslationsRecipesEn {
	_TranslationsRecipesZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZu._(TranslationsZu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionZu nutrition = _TranslationsRecipeDetailNutritionZu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadZu prepAhead = _TranslationsRecipeDetailPrepAheadZu._(_root);
...
// Path: filters
class _TranslationsFiltersZu extends TranslationsFiltersEn {
	_TranslationsFiltersZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListZu extends TranslationsShoppingListEn {
	_TranslationsShoppingListZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanZu extends TranslationsMealPlanEn {
	_TranslationsMealPlanZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryZu extends TranslationsInventoryEn {
	_TranslationsInventoryZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanZu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingZu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryZu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsZu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeZu extends TranslationsUpgradeEn {
	_TranslationsUpgradeZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourZu extends TranslationsTourEn {
	_TranslationsTourZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsZu extends TranslationsErrorsEn {
	_TranslationsErrorsZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsZu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZu._(TranslationsZu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricZu metric = _TranslationsSettingsMeasurementsMetricZu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialZu imperial = _TranslationsSettingsMeasurementsImperialZu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementZu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionZu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionZu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadZu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricZu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZu._(TranslationsZu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialZu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZu._(TranslationsZu root) : this._root = root, super.internal(root);
