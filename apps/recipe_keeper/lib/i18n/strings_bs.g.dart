...
// Path: <root>
class TranslationsBs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppBs app = _TranslationsAppBs._(_root);
	@override late final _TranslationsHomeBs home = _TranslationsHomeBs._(_root);
	@override late final _TranslationsCommonBs common = _TranslationsCommonBs._(_root);
	@override late final _TranslationsSettingsBs settings = _TranslationsSettingsBs._(_root);
	@override late final _TranslationsRecipesBs recipes = _TranslationsRecipesBs._(_root);
	@override late final _TranslationsRecipeDetailBs recipeDetail = _TranslationsRecipeDetailBs._(_root);
	@override late final _TranslationsFiltersBs filters = _TranslationsFiltersBs._(_root);
	@override late final _TranslationsShoppingListBs shoppingList = _TranslationsShoppingListBs._(_root);
	@override late final _TranslationsMealPlanBs mealPlan = _TranslationsMealPlanBs._(_root);
	@override late final _TranslationsInventoryBs inventory = _TranslationsInventoryBs._(_root);
	@override late final _TranslationsBarcodeScanBs barcodeScan = _TranslationsBarcodeScanBs._(_root);
	@override late final _TranslationsReceiptScanBs receiptScan = _TranslationsReceiptScanBs._(_root);
	@override late final _TranslationsBatchCookingBs batchCooking = _TranslationsBatchCookingBs._(_root);
	@override late final _TranslationsVisitedDomainsBs visitedDomains = _TranslationsVisitedDomainsBs._(_root);
	@override late final _TranslationsDomainDiscoveryBs domainDiscovery = _TranslationsDomainDiscoveryBs._(_root);
	@override late final _TranslationsInventorySuggestionsBs inventorySuggestions = _TranslationsInventorySuggestionsBs._(_root);
	@override late final _TranslationsUpgradeBs upgrade = _TranslationsUpgradeBs._(_root);
	@override late final _TranslationsTourBs tour = _TranslationsTourBs._(_root);
	@override late final _TranslationsManualRecipeBs manualRecipe = _TranslationsManualRecipeBs._(_root);
	@override late final _TranslationsRecipeEditBs recipeEdit = _TranslationsRecipeEditBs._(_root);
	@override late final _TranslationsErrorsBs errors = _TranslationsErrorsBs._(_root);
}

// Path: app
class _TranslationsAppBs extends TranslationsAppEn {
	_TranslationsAppBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeBs extends TranslationsHomeEn {
	_TranslationsHomeBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBs extends TranslationsCommonEn {
	_TranslationsCommonBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBs extends TranslationsSettingsEn {
	_TranslationsSettingsBs._(TranslationsBs root) : this._root = root, super.internal(root);

	final TranslationsBs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBs measurements = _TranslationsSettingsMeasurementsBs._(_root);
	@override late final _TranslationsSettingsDataManagementBs dataManagement = _TranslationsSettingsDataManagementBs._(_root);
	@override late final _TranslationsSettingsVersionBs version = _TranslationsSettingsVersionBs._(_root);
}

// Path: recipes
class _TranslationsRecipesBs extends TranslationsRecipesEn {
	_TranslationsRecipesBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBs._(TranslationsBs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBs nutrition = _TranslationsRecipeDetailNutritionBs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBs prepAhead = _TranslationsRecipeDetailPrepAheadBs._(_root);
...
// Path: filters
class _TranslationsFiltersBs extends TranslationsFiltersEn {
	_TranslationsFiltersBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBs extends TranslationsShoppingListEn {
	_TranslationsShoppingListBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBs extends TranslationsMealPlanEn {
	_TranslationsMealPlanBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBs extends TranslationsInventoryEn {
	_TranslationsInventoryBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBs extends TranslationsUpgradeEn {
	_TranslationsUpgradeBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBs extends TranslationsTourEn {
	_TranslationsTourBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBs extends TranslationsErrorsEn {
	_TranslationsErrorsBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBs._(TranslationsBs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBs metric = _TranslationsSettingsMeasurementsMetricBs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBs imperial = _TranslationsSettingsMeasurementsImperialBs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBs._(TranslationsBs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBs._(TranslationsBs root) : this._root = root, super.internal(root);
