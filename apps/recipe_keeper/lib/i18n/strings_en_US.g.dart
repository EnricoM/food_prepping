...
class TranslationsEnUs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesEnUs recipes = _TranslationsRecipesEnUs._(_root);
	@override late final _TranslationsRecipeDetailEnUs recipeDetail = _TranslationsRecipeDetailEnUs._(_root);
	@override late final _TranslationsFiltersEnUs filters = _TranslationsFiltersEnUs._(_root);
	@override late final _TranslationsShoppingListEnUs shoppingList = _TranslationsShoppingListEnUs._(_root);
	@override late final _TranslationsMealPlanEnUs mealPlan = _TranslationsMealPlanEnUs._(_root);
	@override late final _TranslationsInventoryEnUs inventory = _TranslationsInventoryEnUs._(_root);
	@override late final _TranslationsBarcodeScanEnUs barcodeScan = _TranslationsBarcodeScanEnUs._(_root);
	@override late final _TranslationsReceiptScanEnUs receiptScan = _TranslationsReceiptScanEnUs._(_root);
	@override late final _TranslationsBatchCookingEnUs batchCooking = _TranslationsBatchCookingEnUs._(_root);
	@override late final _TranslationsVisitedDomainsEnUs visitedDomains = _TranslationsVisitedDomainsEnUs._(_root);
	@override late final _TranslationsDomainDiscoveryEnUs domainDiscovery = _TranslationsDomainDiscoveryEnUs._(_root);
	@override late final _TranslationsInventorySuggestionsEnUs inventorySuggestions = _TranslationsInventorySuggestionsEnUs._(_root);
	@override late final _TranslationsUpgradeEnUs upgrade = _TranslationsUpgradeEnUs._(_root);
	@override late final _TranslationsTourEnUs tour = _TranslationsTourEnUs._(_root);
	@override late final _TranslationsManualRecipeEnUs manualRecipe = _TranslationsManualRecipeEnUs._(_root);
	@override late final _TranslationsRecipeEditEnUs recipeEdit = _TranslationsRecipeEditEnUs._(_root);
	@override late final _TranslationsErrorsEnUs errors = _TranslationsErrorsEnUs._(_root);
}

// Path: app
class _TranslationsAppEnUs extends TranslationsAppEn {
	_TranslationsAppEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeEnUs extends TranslationsHomeEn {
...
// Path: common
class _TranslationsCommonEnUs extends TranslationsCommonEn {
...
// Path: settings
class _TranslationsSettingsEnUs extends TranslationsSettingsEn {
	_TranslationsSettingsEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);

	final TranslationsEnUs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEnUs measurements = _TranslationsSettingsMeasurementsEnUs._(_root);
	@override late final _TranslationsSettingsDataManagementEnUs dataManagement = _TranslationsSettingsDataManagementEnUs._(_root);
	@override late final _TranslationsSettingsVersionEnUs version = _TranslationsSettingsVersionEnUs._(_root);
}

// Path: recipes
class _TranslationsRecipesEnUs extends TranslationsRecipesEn {
	_TranslationsRecipesEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEnUs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEnUs nutrition = _TranslationsRecipeDetailNutritionEnUs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEnUs prepAhead = _TranslationsRecipeDetailPrepAheadEnUs._(_root);
...
// Path: filters
class _TranslationsFiltersEnUs extends TranslationsFiltersEn {
	_TranslationsFiltersEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEnUs extends TranslationsShoppingListEn {
	_TranslationsShoppingListEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEnUs extends TranslationsMealPlanEn {
	_TranslationsMealPlanEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEnUs extends TranslationsInventoryEn {
	_TranslationsInventoryEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEnUs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEnUs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEnUs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEnUs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEnUs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEnUs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEnUs extends TranslationsUpgradeEn {
	_TranslationsUpgradeEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEnUs extends TranslationsTourEn {
	_TranslationsTourEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEnUs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEnUs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEnUs extends TranslationsErrorsEn {
...
class _TranslationsSettingsMeasurementsEnUs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEnUs metric = _TranslationsSettingsMeasurementsMetricEnUs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEnUs imperial = _TranslationsSettingsMeasurementsImperialEnUs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEnUs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEnUs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEnUs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEnUs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEnUs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEnUs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEnUs._(TranslationsEnUs root) : this._root = root, super.internal(root);
