...
// Path: <root>
class TranslationsSs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ss>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSs _root = this; // ignore: unused_field

	@override 
	TranslationsSs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSs app = _TranslationsAppSs._(_root);
	@override late final _TranslationsHomeSs home = _TranslationsHomeSs._(_root);
	@override late final _TranslationsCommonSs common = _TranslationsCommonSs._(_root);
	@override late final _TranslationsSettingsSs settings = _TranslationsSettingsSs._(_root);
	@override late final _TranslationsRecipesSs recipes = _TranslationsRecipesSs._(_root);
	@override late final _TranslationsRecipeDetailSs recipeDetail = _TranslationsRecipeDetailSs._(_root);
	@override late final _TranslationsFiltersSs filters = _TranslationsFiltersSs._(_root);
	@override late final _TranslationsShoppingListSs shoppingList = _TranslationsShoppingListSs._(_root);
	@override late final _TranslationsMealPlanSs mealPlan = _TranslationsMealPlanSs._(_root);
	@override late final _TranslationsInventorySs inventory = _TranslationsInventorySs._(_root);
	@override late final _TranslationsBarcodeScanSs barcodeScan = _TranslationsBarcodeScanSs._(_root);
	@override late final _TranslationsReceiptScanSs receiptScan = _TranslationsReceiptScanSs._(_root);
	@override late final _TranslationsBatchCookingSs batchCooking = _TranslationsBatchCookingSs._(_root);
	@override late final _TranslationsVisitedDomainsSs visitedDomains = _TranslationsVisitedDomainsSs._(_root);
	@override late final _TranslationsDomainDiscoverySs domainDiscovery = _TranslationsDomainDiscoverySs._(_root);
	@override late final _TranslationsInventorySuggestionsSs inventorySuggestions = _TranslationsInventorySuggestionsSs._(_root);
	@override late final _TranslationsUpgradeSs upgrade = _TranslationsUpgradeSs._(_root);
	@override late final _TranslationsTourSs tour = _TranslationsTourSs._(_root);
	@override late final _TranslationsManualRecipeSs manualRecipe = _TranslationsManualRecipeSs._(_root);
	@override late final _TranslationsRecipeEditSs recipeEdit = _TranslationsRecipeEditSs._(_root);
	@override late final _TranslationsErrorsSs errors = _TranslationsErrorsSs._(_root);
}

// Path: app
class _TranslationsAppSs extends TranslationsAppEn {
	_TranslationsAppSs._(TranslationsSs root) : this._root = root, super.internal(root);

	final TranslationsSs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSs extends TranslationsHomeEn {
	_TranslationsHomeSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSs extends TranslationsCommonEn {
	_TranslationsCommonSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSs extends TranslationsSettingsEn {
	_TranslationsSettingsSs._(TranslationsSs root) : this._root = root, super.internal(root);

	final TranslationsSs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSs measurements = _TranslationsSettingsMeasurementsSs._(_root);
	@override late final _TranslationsSettingsDataManagementSs dataManagement = _TranslationsSettingsDataManagementSs._(_root);
	@override late final _TranslationsSettingsVersionSs version = _TranslationsSettingsVersionSs._(_root);
}

// Path: recipes
class _TranslationsRecipesSs extends TranslationsRecipesEn {
	_TranslationsRecipesSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSs._(TranslationsSs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSs nutrition = _TranslationsRecipeDetailNutritionSs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSs prepAhead = _TranslationsRecipeDetailPrepAheadSs._(_root);
...
// Path: filters
class _TranslationsFiltersSs extends TranslationsFiltersEn {
	_TranslationsFiltersSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSs extends TranslationsShoppingListEn {
	_TranslationsShoppingListSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSs extends TranslationsMealPlanEn {
	_TranslationsMealPlanSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySs extends TranslationsInventoryEn {
	_TranslationsInventorySs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSs extends TranslationsUpgradeEn {
	_TranslationsUpgradeSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSs extends TranslationsTourEn {
	_TranslationsTourSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSs extends TranslationsErrorsEn {
	_TranslationsErrorsSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSs._(TranslationsSs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSs metric = _TranslationsSettingsMeasurementsMetricSs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSs imperial = _TranslationsSettingsMeasurementsImperialSs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSs._(TranslationsSs root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ss>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSs {
