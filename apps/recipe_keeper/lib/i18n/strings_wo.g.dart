...
// Path: <root>
class TranslationsWo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsWo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <wo>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsWo _root = this; // ignore: unused_field

	@override 
	TranslationsWo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsWo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppWo app = _TranslationsAppWo._(_root);
	@override late final _TranslationsHomeWo home = _TranslationsHomeWo._(_root);
	@override late final _TranslationsCommonWo common = _TranslationsCommonWo._(_root);
	@override late final _TranslationsSettingsWo settings = _TranslationsSettingsWo._(_root);
	@override late final _TranslationsRecipesWo recipes = _TranslationsRecipesWo._(_root);
	@override late final _TranslationsRecipeDetailWo recipeDetail = _TranslationsRecipeDetailWo._(_root);
	@override late final _TranslationsFiltersWo filters = _TranslationsFiltersWo._(_root);
	@override late final _TranslationsShoppingListWo shoppingList = _TranslationsShoppingListWo._(_root);
	@override late final _TranslationsMealPlanWo mealPlan = _TranslationsMealPlanWo._(_root);
	@override late final _TranslationsInventoryWo inventory = _TranslationsInventoryWo._(_root);
	@override late final _TranslationsBarcodeScanWo barcodeScan = _TranslationsBarcodeScanWo._(_root);
	@override late final _TranslationsReceiptScanWo receiptScan = _TranslationsReceiptScanWo._(_root);
	@override late final _TranslationsBatchCookingWo batchCooking = _TranslationsBatchCookingWo._(_root);
	@override late final _TranslationsVisitedDomainsWo visitedDomains = _TranslationsVisitedDomainsWo._(_root);
	@override late final _TranslationsDomainDiscoveryWo domainDiscovery = _TranslationsDomainDiscoveryWo._(_root);
	@override late final _TranslationsInventorySuggestionsWo inventorySuggestions = _TranslationsInventorySuggestionsWo._(_root);
	@override late final _TranslationsUpgradeWo upgrade = _TranslationsUpgradeWo._(_root);
	@override late final _TranslationsTourWo tour = _TranslationsTourWo._(_root);
	@override late final _TranslationsManualRecipeWo manualRecipe = _TranslationsManualRecipeWo._(_root);
	@override late final _TranslationsRecipeEditWo recipeEdit = _TranslationsRecipeEditWo._(_root);
	@override late final _TranslationsErrorsWo errors = _TranslationsErrorsWo._(_root);
}

// Path: app
class _TranslationsAppWo extends TranslationsAppEn {
	_TranslationsAppWo._(TranslationsWo root) : this._root = root, super.internal(root);

	final TranslationsWo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeWo extends TranslationsHomeEn {
	_TranslationsHomeWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonWo extends TranslationsCommonEn {
	_TranslationsCommonWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsWo extends TranslationsSettingsEn {
	_TranslationsSettingsWo._(TranslationsWo root) : this._root = root, super.internal(root);

	final TranslationsWo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsWo measurements = _TranslationsSettingsMeasurementsWo._(_root);
	@override late final _TranslationsSettingsDataManagementWo dataManagement = _TranslationsSettingsDataManagementWo._(_root);
	@override late final _TranslationsSettingsVersionWo version = _TranslationsSettingsVersionWo._(_root);
}

// Path: recipes
class _TranslationsRecipesWo extends TranslationsRecipesEn {
	_TranslationsRecipesWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailWo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailWo._(TranslationsWo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionWo nutrition = _TranslationsRecipeDetailNutritionWo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadWo prepAhead = _TranslationsRecipeDetailPrepAheadWo._(_root);
...
// Path: filters
class _TranslationsFiltersWo extends TranslationsFiltersEn {
	_TranslationsFiltersWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListWo extends TranslationsShoppingListEn {
	_TranslationsShoppingListWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanWo extends TranslationsMealPlanEn {
	_TranslationsMealPlanWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryWo extends TranslationsInventoryEn {
	_TranslationsInventoryWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanWo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanWo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingWo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsWo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryWo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsWo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeWo extends TranslationsUpgradeEn {
	_TranslationsUpgradeWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourWo extends TranslationsTourEn {
	_TranslationsTourWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeWo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditWo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsWo extends TranslationsErrorsEn {
	_TranslationsErrorsWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsWo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsWo._(TranslationsWo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricWo metric = _TranslationsSettingsMeasurementsMetricWo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialWo imperial = _TranslationsSettingsMeasurementsImperialWo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementWo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionWo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionWo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadWo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricWo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialWo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialWo._(TranslationsWo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <wo>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsWo {
