...
// Path: <root>
class TranslationsMh extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMh({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <mh>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMh _root = this; // ignore: unused_field

	@override 
	TranslationsMh $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMh(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMh app = _TranslationsAppMh._(_root);
	@override late final _TranslationsHomeMh home = _TranslationsHomeMh._(_root);
	@override late final _TranslationsCommonMh common = _TranslationsCommonMh._(_root);
	@override late final _TranslationsSettingsMh settings = _TranslationsSettingsMh._(_root);
	@override late final _TranslationsRecipesMh recipes = _TranslationsRecipesMh._(_root);
	@override late final _TranslationsRecipeDetailMh recipeDetail = _TranslationsRecipeDetailMh._(_root);
	@override late final _TranslationsFiltersMh filters = _TranslationsFiltersMh._(_root);
	@override late final _TranslationsShoppingListMh shoppingList = _TranslationsShoppingListMh._(_root);
	@override late final _TranslationsMealPlanMh mealPlan = _TranslationsMealPlanMh._(_root);
	@override late final _TranslationsInventoryMh inventory = _TranslationsInventoryMh._(_root);
	@override late final _TranslationsBarcodeScanMh barcodeScan = _TranslationsBarcodeScanMh._(_root);
	@override late final _TranslationsReceiptScanMh receiptScan = _TranslationsReceiptScanMh._(_root);
	@override late final _TranslationsBatchCookingMh batchCooking = _TranslationsBatchCookingMh._(_root);
	@override late final _TranslationsVisitedDomainsMh visitedDomains = _TranslationsVisitedDomainsMh._(_root);
	@override late final _TranslationsDomainDiscoveryMh domainDiscovery = _TranslationsDomainDiscoveryMh._(_root);
	@override late final _TranslationsInventorySuggestionsMh inventorySuggestions = _TranslationsInventorySuggestionsMh._(_root);
	@override late final _TranslationsUpgradeMh upgrade = _TranslationsUpgradeMh._(_root);
	@override late final _TranslationsTourMh tour = _TranslationsTourMh._(_root);
	@override late final _TranslationsManualRecipeMh manualRecipe = _TranslationsManualRecipeMh._(_root);
	@override late final _TranslationsRecipeEditMh recipeEdit = _TranslationsRecipeEditMh._(_root);
	@override late final _TranslationsErrorsMh errors = _TranslationsErrorsMh._(_root);
}

// Path: app
class _TranslationsAppMh extends TranslationsAppEn {
	_TranslationsAppMh._(TranslationsMh root) : this._root = root, super.internal(root);

	final TranslationsMh _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMh extends TranslationsHomeEn {
	_TranslationsHomeMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMh extends TranslationsCommonEn {
	_TranslationsCommonMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMh extends TranslationsSettingsEn {
	_TranslationsSettingsMh._(TranslationsMh root) : this._root = root, super.internal(root);

	final TranslationsMh _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMh measurements = _TranslationsSettingsMeasurementsMh._(_root);
	@override late final _TranslationsSettingsDataManagementMh dataManagement = _TranslationsSettingsDataManagementMh._(_root);
	@override late final _TranslationsSettingsVersionMh version = _TranslationsSettingsVersionMh._(_root);
}

// Path: recipes
class _TranslationsRecipesMh extends TranslationsRecipesEn {
	_TranslationsRecipesMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMh extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMh._(TranslationsMh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMh nutrition = _TranslationsRecipeDetailNutritionMh._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMh prepAhead = _TranslationsRecipeDetailPrepAheadMh._(_root);
...
// Path: filters
class _TranslationsFiltersMh extends TranslationsFiltersEn {
	_TranslationsFiltersMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMh extends TranslationsShoppingListEn {
	_TranslationsShoppingListMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMh extends TranslationsMealPlanEn {
	_TranslationsMealPlanMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMh extends TranslationsInventoryEn {
	_TranslationsInventoryMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMh extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMh extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMh extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMh extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMh extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMh extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMh extends TranslationsUpgradeEn {
	_TranslationsUpgradeMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMh extends TranslationsTourEn {
	_TranslationsTourMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMh extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMh extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMh extends TranslationsErrorsEn {
	_TranslationsErrorsMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMh extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMh._(TranslationsMh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMh metric = _TranslationsSettingsMeasurementsMetricMh._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMh imperial = _TranslationsSettingsMeasurementsImperialMh._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMh extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMh extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMh extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMh extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMh extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMh extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMh._(TranslationsMh root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <mh>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMh {
