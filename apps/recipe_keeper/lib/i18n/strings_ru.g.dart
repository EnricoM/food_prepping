...
class TranslationsRu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesRu recipes = _TranslationsRecipesRu._(_root);
	@override late final _TranslationsRecipeDetailRu recipeDetail = _TranslationsRecipeDetailRu._(_root);
	@override late final _TranslationsFiltersRu filters = _TranslationsFiltersRu._(_root);
	@override late final _TranslationsShoppingListRu shoppingList = _TranslationsShoppingListRu._(_root);
	@override late final _TranslationsMealPlanRu mealPlan = _TranslationsMealPlanRu._(_root);
	@override late final _TranslationsInventoryRu inventory = _TranslationsInventoryRu._(_root);
	@override late final _TranslationsBarcodeScanRu barcodeScan = _TranslationsBarcodeScanRu._(_root);
	@override late final _TranslationsReceiptScanRu receiptScan = _TranslationsReceiptScanRu._(_root);
	@override late final _TranslationsBatchCookingRu batchCooking = _TranslationsBatchCookingRu._(_root);
	@override late final _TranslationsVisitedDomainsRu visitedDomains = _TranslationsVisitedDomainsRu._(_root);
	@override late final _TranslationsDomainDiscoveryRu domainDiscovery = _TranslationsDomainDiscoveryRu._(_root);
	@override late final _TranslationsInventorySuggestionsRu inventorySuggestions = _TranslationsInventorySuggestionsRu._(_root);
	@override late final _TranslationsUpgradeRu upgrade = _TranslationsUpgradeRu._(_root);
	@override late final _TranslationsTourRu tour = _TranslationsTourRu._(_root);
	@override late final _TranslationsManualRecipeRu manualRecipe = _TranslationsManualRecipeRu._(_root);
	@override late final _TranslationsRecipeEditRu recipeEdit = _TranslationsRecipeEditRu._(_root);
...
class _TranslationsSettingsRu extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsRu measurements = _TranslationsSettingsMeasurementsRu._(_root);
	@override late final _TranslationsSettingsDataManagementRu dataManagement = _TranslationsSettingsDataManagementRu._(_root);
	@override late final _TranslationsSettingsVersionRu version = _TranslationsSettingsVersionRu._(_root);
}

// Path: recipes
class _TranslationsRecipesRu extends TranslationsRecipesEn {
	_TranslationsRecipesRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailRu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailRu._(TranslationsRu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionRu nutrition = _TranslationsRecipeDetailNutritionRu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadRu prepAhead = _TranslationsRecipeDetailPrepAheadRu._(_root);
...
// Path: filters
class _TranslationsFiltersRu extends TranslationsFiltersEn {
	_TranslationsFiltersRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListRu extends TranslationsShoppingListEn {
	_TranslationsShoppingListRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanRu extends TranslationsMealPlanEn {
	_TranslationsMealPlanRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryRu extends TranslationsInventoryEn {
	_TranslationsInventoryRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanRu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanRu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingRu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsRu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryRu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsRu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeRu extends TranslationsUpgradeEn {
	_TranslationsUpgradeRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourRu extends TranslationsTourEn {
	_TranslationsTourRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeRu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditRu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsRu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsRu._(TranslationsRu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricRu metric = _TranslationsSettingsMeasurementsMetricRu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialRu imperial = _TranslationsSettingsMeasurementsImperialRu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementRu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionRu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionRu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadRu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricRu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricRu._(TranslationsRu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialRu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialRu._(TranslationsRu root) : this._root = root, super.internal(root);
