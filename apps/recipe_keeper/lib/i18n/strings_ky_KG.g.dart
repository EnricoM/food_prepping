...
// Path: <root>
class TranslationsKyKg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKyKg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.kyKg,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <ky-KG>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKyKg _root = this; // ignore: unused_field

	@override 
	TranslationsKyKg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKyKg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKyKg app = _TranslationsAppKyKg._(_root);
	@override late final _TranslationsHomeKyKg home = _TranslationsHomeKyKg._(_root);
	@override late final _TranslationsCommonKyKg common = _TranslationsCommonKyKg._(_root);
	@override late final _TranslationsSettingsKyKg settings = _TranslationsSettingsKyKg._(_root);
	@override late final _TranslationsRecipesKyKg recipes = _TranslationsRecipesKyKg._(_root);
	@override late final _TranslationsRecipeDetailKyKg recipeDetail = _TranslationsRecipeDetailKyKg._(_root);
	@override late final _TranslationsFiltersKyKg filters = _TranslationsFiltersKyKg._(_root);
	@override late final _TranslationsShoppingListKyKg shoppingList = _TranslationsShoppingListKyKg._(_root);
	@override late final _TranslationsMealPlanKyKg mealPlan = _TranslationsMealPlanKyKg._(_root);
	@override late final _TranslationsInventoryKyKg inventory = _TranslationsInventoryKyKg._(_root);
	@override late final _TranslationsBarcodeScanKyKg barcodeScan = _TranslationsBarcodeScanKyKg._(_root);
	@override late final _TranslationsReceiptScanKyKg receiptScan = _TranslationsReceiptScanKyKg._(_root);
	@override late final _TranslationsBatchCookingKyKg batchCooking = _TranslationsBatchCookingKyKg._(_root);
	@override late final _TranslationsVisitedDomainsKyKg visitedDomains = _TranslationsVisitedDomainsKyKg._(_root);
	@override late final _TranslationsDomainDiscoveryKyKg domainDiscovery = _TranslationsDomainDiscoveryKyKg._(_root);
	@override late final _TranslationsInventorySuggestionsKyKg inventorySuggestions = _TranslationsInventorySuggestionsKyKg._(_root);
	@override late final _TranslationsUpgradeKyKg upgrade = _TranslationsUpgradeKyKg._(_root);
	@override late final _TranslationsTourKyKg tour = _TranslationsTourKyKg._(_root);
	@override late final _TranslationsManualRecipeKyKg manualRecipe = _TranslationsManualRecipeKyKg._(_root);
	@override late final _TranslationsRecipeEditKyKg recipeEdit = _TranslationsRecipeEditKyKg._(_root);
	@override late final _TranslationsErrorsKyKg errors = _TranslationsErrorsKyKg._(_root);
}

// Path: app
class _TranslationsAppKyKg extends TranslationsAppEn {
	_TranslationsAppKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);

	final TranslationsKyKg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKyKg extends TranslationsHomeEn {
	_TranslationsHomeKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKyKg extends TranslationsCommonEn {
	_TranslationsCommonKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKyKg extends TranslationsSettingsEn {
	_TranslationsSettingsKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);

	final TranslationsKyKg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKyKg measurements = _TranslationsSettingsMeasurementsKyKg._(_root);
	@override late final _TranslationsSettingsDataManagementKyKg dataManagement = _TranslationsSettingsDataManagementKyKg._(_root);
	@override late final _TranslationsSettingsVersionKyKg version = _TranslationsSettingsVersionKyKg._(_root);
}

// Path: recipes
class _TranslationsRecipesKyKg extends TranslationsRecipesEn {
	_TranslationsRecipesKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKyKg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKyKg nutrition = _TranslationsRecipeDetailNutritionKyKg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKyKg prepAhead = _TranslationsRecipeDetailPrepAheadKyKg._(_root);
...
// Path: filters
class _TranslationsFiltersKyKg extends TranslationsFiltersEn {
	_TranslationsFiltersKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKyKg extends TranslationsShoppingListEn {
	_TranslationsShoppingListKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKyKg extends TranslationsMealPlanEn {
	_TranslationsMealPlanKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKyKg extends TranslationsInventoryEn {
	_TranslationsInventoryKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKyKg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKyKg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKyKg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKyKg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKyKg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKyKg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKyKg extends TranslationsUpgradeEn {
	_TranslationsUpgradeKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKyKg extends TranslationsTourEn {
	_TranslationsTourKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKyKg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKyKg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKyKg extends TranslationsErrorsEn {
	_TranslationsErrorsKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKyKg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKyKg metric = _TranslationsSettingsMeasurementsMetricKyKg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKyKg imperial = _TranslationsSettingsMeasurementsImperialKyKg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKyKg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKyKg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKyKg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKyKg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKyKg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKyKg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKyKg._(TranslationsKyKg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ky-KG>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKyKg {
