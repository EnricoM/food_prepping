...
class TranslationsSw extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppSw app = _TranslationsAppSw._(_root);
	@override late final _TranslationsHomeSw home = _TranslationsHomeSw._(_root);
	@override late final _TranslationsCommonSw common = _TranslationsCommonSw._(_root);
	@override late final _TranslationsSettingsSw settings = _TranslationsSettingsSw._(_root);
	@override late final _TranslationsRecipesSw recipes = _TranslationsRecipesSw._(_root);
	@override late final _TranslationsRecipeDetailSw recipeDetail = _TranslationsRecipeDetailSw._(_root);
	@override late final _TranslationsFiltersSw filters = _TranslationsFiltersSw._(_root);
	@override late final _TranslationsShoppingListSw shoppingList = _TranslationsShoppingListSw._(_root);
	@override late final _TranslationsMealPlanSw mealPlan = _TranslationsMealPlanSw._(_root);
	@override late final _TranslationsInventorySw inventory = _TranslationsInventorySw._(_root);
	@override late final _TranslationsBarcodeScanSw barcodeScan = _TranslationsBarcodeScanSw._(_root);
	@override late final _TranslationsReceiptScanSw receiptScan = _TranslationsReceiptScanSw._(_root);
	@override late final _TranslationsBatchCookingSw batchCooking = _TranslationsBatchCookingSw._(_root);
	@override late final _TranslationsVisitedDomainsSw visitedDomains = _TranslationsVisitedDomainsSw._(_root);
	@override late final _TranslationsDomainDiscoverySw domainDiscovery = _TranslationsDomainDiscoverySw._(_root);
	@override late final _TranslationsInventorySuggestionsSw inventorySuggestions = _TranslationsInventorySuggestionsSw._(_root);
	@override late final _TranslationsUpgradeSw upgrade = _TranslationsUpgradeSw._(_root);
	@override late final _TranslationsTourSw tour = _TranslationsTourSw._(_root);
	@override late final _TranslationsManualRecipeSw manualRecipe = _TranslationsManualRecipeSw._(_root);
	@override late final _TranslationsRecipeEditSw recipeEdit = _TranslationsRecipeEditSw._(_root);
	@override late final _TranslationsErrorsSw errors = _TranslationsErrorsSw._(_root);
}

// Path: app
class _TranslationsAppSw extends TranslationsAppEn {
	_TranslationsAppSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeSw extends TranslationsHomeEn {
	_TranslationsHomeSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSw extends TranslationsCommonEn {
	_TranslationsCommonSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSw extends TranslationsSettingsEn {
	_TranslationsSettingsSw._(TranslationsSw root) : this._root = root, super.internal(root);

	final TranslationsSw _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSw measurements = _TranslationsSettingsMeasurementsSw._(_root);
	@override late final _TranslationsSettingsDataManagementSw dataManagement = _TranslationsSettingsDataManagementSw._(_root);
	@override late final _TranslationsSettingsVersionSw version = _TranslationsSettingsVersionSw._(_root);
}

// Path: recipes
class _TranslationsRecipesSw extends TranslationsRecipesEn {
	_TranslationsRecipesSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSw extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSw._(TranslationsSw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSw nutrition = _TranslationsRecipeDetailNutritionSw._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSw prepAhead = _TranslationsRecipeDetailPrepAheadSw._(_root);
...
// Path: filters
class _TranslationsFiltersSw extends TranslationsFiltersEn {
	_TranslationsFiltersSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSw extends TranslationsShoppingListEn {
	_TranslationsShoppingListSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSw extends TranslationsMealPlanEn {
	_TranslationsMealPlanSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySw extends TranslationsInventoryEn {
	_TranslationsInventorySw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSw extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSw extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSw extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSw extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySw extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSw extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSw extends TranslationsUpgradeEn {
	_TranslationsUpgradeSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSw extends TranslationsTourEn {
	_TranslationsTourSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSw extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSw extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSw extends TranslationsErrorsEn {
	_TranslationsErrorsSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSw extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSw._(TranslationsSw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSw metric = _TranslationsSettingsMeasurementsMetricSw._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSw imperial = _TranslationsSettingsMeasurementsImperialSw._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSw extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSw extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSw extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSw extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSw extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSw._(TranslationsSw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSw extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSw._(TranslationsSw root) : this._root = root, super.internal(root);
