...
// Path: <root>
class TranslationsTi extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ti>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTi _root = this; // ignore: unused_field

	@override 
	TranslationsTi $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTi(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTi app = _TranslationsAppTi._(_root);
	@override late final _TranslationsHomeTi home = _TranslationsHomeTi._(_root);
	@override late final _TranslationsCommonTi common = _TranslationsCommonTi._(_root);
	@override late final _TranslationsSettingsTi settings = _TranslationsSettingsTi._(_root);
	@override late final _TranslationsRecipesTi recipes = _TranslationsRecipesTi._(_root);
	@override late final _TranslationsRecipeDetailTi recipeDetail = _TranslationsRecipeDetailTi._(_root);
	@override late final _TranslationsFiltersTi filters = _TranslationsFiltersTi._(_root);
	@override late final _TranslationsShoppingListTi shoppingList = _TranslationsShoppingListTi._(_root);
	@override late final _TranslationsMealPlanTi mealPlan = _TranslationsMealPlanTi._(_root);
	@override late final _TranslationsInventoryTi inventory = _TranslationsInventoryTi._(_root);
	@override late final _TranslationsBarcodeScanTi barcodeScan = _TranslationsBarcodeScanTi._(_root);
	@override late final _TranslationsReceiptScanTi receiptScan = _TranslationsReceiptScanTi._(_root);
	@override late final _TranslationsBatchCookingTi batchCooking = _TranslationsBatchCookingTi._(_root);
	@override late final _TranslationsVisitedDomainsTi visitedDomains = _TranslationsVisitedDomainsTi._(_root);
	@override late final _TranslationsDomainDiscoveryTi domainDiscovery = _TranslationsDomainDiscoveryTi._(_root);
	@override late final _TranslationsInventorySuggestionsTi inventorySuggestions = _TranslationsInventorySuggestionsTi._(_root);
	@override late final _TranslationsUpgradeTi upgrade = _TranslationsUpgradeTi._(_root);
	@override late final _TranslationsTourTi tour = _TranslationsTourTi._(_root);
	@override late final _TranslationsManualRecipeTi manualRecipe = _TranslationsManualRecipeTi._(_root);
	@override late final _TranslationsRecipeEditTi recipeEdit = _TranslationsRecipeEditTi._(_root);
	@override late final _TranslationsErrorsTi errors = _TranslationsErrorsTi._(_root);
}

// Path: app
class _TranslationsAppTi extends TranslationsAppEn {
	_TranslationsAppTi._(TranslationsTi root) : this._root = root, super.internal(root);

	final TranslationsTi _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTi extends TranslationsHomeEn {
	_TranslationsHomeTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTi extends TranslationsCommonEn {
	_TranslationsCommonTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTi extends TranslationsSettingsEn {
	_TranslationsSettingsTi._(TranslationsTi root) : this._root = root, super.internal(root);

	final TranslationsTi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTi measurements = _TranslationsSettingsMeasurementsTi._(_root);
	@override late final _TranslationsSettingsDataManagementTi dataManagement = _TranslationsSettingsDataManagementTi._(_root);
	@override late final _TranslationsSettingsVersionTi version = _TranslationsSettingsVersionTi._(_root);
}

// Path: recipes
class _TranslationsRecipesTi extends TranslationsRecipesEn {
	_TranslationsRecipesTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTi._(TranslationsTi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTi nutrition = _TranslationsRecipeDetailNutritionTi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTi prepAhead = _TranslationsRecipeDetailPrepAheadTi._(_root);
...
// Path: filters
class _TranslationsFiltersTi extends TranslationsFiltersEn {
	_TranslationsFiltersTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTi extends TranslationsShoppingListEn {
	_TranslationsShoppingListTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTi extends TranslationsMealPlanEn {
	_TranslationsMealPlanTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTi extends TranslationsInventoryEn {
	_TranslationsInventoryTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTi extends TranslationsUpgradeEn {
	_TranslationsUpgradeTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTi extends TranslationsTourEn {
	_TranslationsTourTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTi extends TranslationsErrorsEn {
	_TranslationsErrorsTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTi._(TranslationsTi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTi metric = _TranslationsSettingsMeasurementsMetricTi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTi imperial = _TranslationsSettingsMeasurementsImperialTi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTi._(TranslationsTi root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ti>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTi {
