...
// Path: <root>
class TranslationsTt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsTt _root = this; // ignore: unused_field

	@override 
	TranslationsTt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTt app = _TranslationsAppTt._(_root);
	@override late final _TranslationsHomeTt home = _TranslationsHomeTt._(_root);
	@override late final _TranslationsCommonTt common = _TranslationsCommonTt._(_root);
	@override late final _TranslationsSettingsTt settings = _TranslationsSettingsTt._(_root);
	@override late final _TranslationsRecipesTt recipes = _TranslationsRecipesTt._(_root);
	@override late final _TranslationsRecipeDetailTt recipeDetail = _TranslationsRecipeDetailTt._(_root);
	@override late final _TranslationsFiltersTt filters = _TranslationsFiltersTt._(_root);
	@override late final _TranslationsShoppingListTt shoppingList = _TranslationsShoppingListTt._(_root);
	@override late final _TranslationsMealPlanTt mealPlan = _TranslationsMealPlanTt._(_root);
	@override late final _TranslationsInventoryTt inventory = _TranslationsInventoryTt._(_root);
	@override late final _TranslationsBarcodeScanTt barcodeScan = _TranslationsBarcodeScanTt._(_root);
	@override late final _TranslationsReceiptScanTt receiptScan = _TranslationsReceiptScanTt._(_root);
	@override late final _TranslationsBatchCookingTt batchCooking = _TranslationsBatchCookingTt._(_root);
	@override late final _TranslationsVisitedDomainsTt visitedDomains = _TranslationsVisitedDomainsTt._(_root);
	@override late final _TranslationsDomainDiscoveryTt domainDiscovery = _TranslationsDomainDiscoveryTt._(_root);
	@override late final _TranslationsInventorySuggestionsTt inventorySuggestions = _TranslationsInventorySuggestionsTt._(_root);
	@override late final _TranslationsUpgradeTt upgrade = _TranslationsUpgradeTt._(_root);
	@override late final _TranslationsTourTt tour = _TranslationsTourTt._(_root);
	@override late final _TranslationsManualRecipeTt manualRecipe = _TranslationsManualRecipeTt._(_root);
	@override late final _TranslationsRecipeEditTt recipeEdit = _TranslationsRecipeEditTt._(_root);
	@override late final _TranslationsErrorsTt errors = _TranslationsErrorsTt._(_root);
}

// Path: app
class _TranslationsAppTt extends TranslationsAppEn {
	_TranslationsAppTt._(TranslationsTt root) : this._root = root, super.internal(root);

	final TranslationsTt _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTt extends TranslationsHomeEn {
	_TranslationsHomeTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTt extends TranslationsCommonEn {
	_TranslationsCommonTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTt extends TranslationsSettingsEn {
	_TranslationsSettingsTt._(TranslationsTt root) : this._root = root, super.internal(root);

	final TranslationsTt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTt measurements = _TranslationsSettingsMeasurementsTt._(_root);
	@override late final _TranslationsSettingsDataManagementTt dataManagement = _TranslationsSettingsDataManagementTt._(_root);
	@override late final _TranslationsSettingsVersionTt version = _TranslationsSettingsVersionTt._(_root);
}

// Path: recipes
class _TranslationsRecipesTt extends TranslationsRecipesEn {
	_TranslationsRecipesTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTt._(TranslationsTt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTt nutrition = _TranslationsRecipeDetailNutritionTt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTt prepAhead = _TranslationsRecipeDetailPrepAheadTt._(_root);
...
// Path: filters
class _TranslationsFiltersTt extends TranslationsFiltersEn {
	_TranslationsFiltersTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTt extends TranslationsShoppingListEn {
	_TranslationsShoppingListTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTt extends TranslationsMealPlanEn {
	_TranslationsMealPlanTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTt extends TranslationsInventoryEn {
	_TranslationsInventoryTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTt extends TranslationsUpgradeEn {
	_TranslationsUpgradeTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTt extends TranslationsTourEn {
	_TranslationsTourTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTt extends TranslationsErrorsEn {
	_TranslationsErrorsTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTt._(TranslationsTt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTt metric = _TranslationsSettingsMeasurementsMetricTt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTt imperial = _TranslationsSettingsMeasurementsImperialTt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTt._(TranslationsTt root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <tt>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTt {
