...
// Path: <root>
class TranslationsYi extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsYi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <yi>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsYi _root = this; // ignore: unused_field

	@override 
	TranslationsYi $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsYi(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppYi app = _TranslationsAppYi._(_root);
	@override late final _TranslationsHomeYi home = _TranslationsHomeYi._(_root);
	@override late final _TranslationsCommonYi common = _TranslationsCommonYi._(_root);
	@override late final _TranslationsSettingsYi settings = _TranslationsSettingsYi._(_root);
	@override late final _TranslationsRecipesYi recipes = _TranslationsRecipesYi._(_root);
	@override late final _TranslationsRecipeDetailYi recipeDetail = _TranslationsRecipeDetailYi._(_root);
	@override late final _TranslationsFiltersYi filters = _TranslationsFiltersYi._(_root);
	@override late final _TranslationsShoppingListYi shoppingList = _TranslationsShoppingListYi._(_root);
	@override late final _TranslationsMealPlanYi mealPlan = _TranslationsMealPlanYi._(_root);
	@override late final _TranslationsInventoryYi inventory = _TranslationsInventoryYi._(_root);
	@override late final _TranslationsBarcodeScanYi barcodeScan = _TranslationsBarcodeScanYi._(_root);
	@override late final _TranslationsReceiptScanYi receiptScan = _TranslationsReceiptScanYi._(_root);
	@override late final _TranslationsBatchCookingYi batchCooking = _TranslationsBatchCookingYi._(_root);
	@override late final _TranslationsVisitedDomainsYi visitedDomains = _TranslationsVisitedDomainsYi._(_root);
	@override late final _TranslationsDomainDiscoveryYi domainDiscovery = _TranslationsDomainDiscoveryYi._(_root);
	@override late final _TranslationsInventorySuggestionsYi inventorySuggestions = _TranslationsInventorySuggestionsYi._(_root);
	@override late final _TranslationsUpgradeYi upgrade = _TranslationsUpgradeYi._(_root);
	@override late final _TranslationsTourYi tour = _TranslationsTourYi._(_root);
	@override late final _TranslationsManualRecipeYi manualRecipe = _TranslationsManualRecipeYi._(_root);
	@override late final _TranslationsRecipeEditYi recipeEdit = _TranslationsRecipeEditYi._(_root);
	@override late final _TranslationsErrorsYi errors = _TranslationsErrorsYi._(_root);
}

// Path: app
class _TranslationsAppYi extends TranslationsAppEn {
	_TranslationsAppYi._(TranslationsYi root) : this._root = root, super.internal(root);

	final TranslationsYi _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeYi extends TranslationsHomeEn {
	_TranslationsHomeYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonYi extends TranslationsCommonEn {
	_TranslationsCommonYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsYi extends TranslationsSettingsEn {
	_TranslationsSettingsYi._(TranslationsYi root) : this._root = root, super.internal(root);

	final TranslationsYi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsYi measurements = _TranslationsSettingsMeasurementsYi._(_root);
	@override late final _TranslationsSettingsDataManagementYi dataManagement = _TranslationsSettingsDataManagementYi._(_root);
	@override late final _TranslationsSettingsVersionYi version = _TranslationsSettingsVersionYi._(_root);
}

// Path: recipes
class _TranslationsRecipesYi extends TranslationsRecipesEn {
	_TranslationsRecipesYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailYi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailYi._(TranslationsYi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionYi nutrition = _TranslationsRecipeDetailNutritionYi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadYi prepAhead = _TranslationsRecipeDetailPrepAheadYi._(_root);
...
// Path: filters
class _TranslationsFiltersYi extends TranslationsFiltersEn {
	_TranslationsFiltersYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListYi extends TranslationsShoppingListEn {
	_TranslationsShoppingListYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanYi extends TranslationsMealPlanEn {
	_TranslationsMealPlanYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryYi extends TranslationsInventoryEn {
	_TranslationsInventoryYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanYi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanYi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingYi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsYi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryYi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsYi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeYi extends TranslationsUpgradeEn {
	_TranslationsUpgradeYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourYi extends TranslationsTourEn {
	_TranslationsTourYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeYi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditYi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsYi extends TranslationsErrorsEn {
	_TranslationsErrorsYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsYi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsYi._(TranslationsYi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricYi metric = _TranslationsSettingsMeasurementsMetricYi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialYi imperial = _TranslationsSettingsMeasurementsImperialYi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementYi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionYi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionYi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadYi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricYi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialYi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialYi._(TranslationsYi root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <yi>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsYi {
