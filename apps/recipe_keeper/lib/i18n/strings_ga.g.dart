...
class TranslationsGa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	TranslationsGa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	// Translations
	@override late final _TranslationsAppGa app = _TranslationsAppGa._(_root);
	@override late final _TranslationsHomeGa home = _TranslationsHomeGa._(_root);
	@override late final _TranslationsCommonGa common = _TranslationsCommonGa._(_root);
	@override late final _TranslationsSettingsGa settings = _TranslationsSettingsGa._(_root);
	@override late final _TranslationsRecipesGa recipes = _TranslationsRecipesGa._(_root);
	@override late final _TranslationsRecipeDetailGa recipeDetail = _TranslationsRecipeDetailGa._(_root);
	@override late final _TranslationsFiltersGa filters = _TranslationsFiltersGa._(_root);
	@override late final _TranslationsShoppingListGa shoppingList = _TranslationsShoppingListGa._(_root);
	@override late final _TranslationsMealPlanGa mealPlan = _TranslationsMealPlanGa._(_root);
	@override late final _TranslationsInventoryGa inventory = _TranslationsInventoryGa._(_root);
	@override late final _TranslationsBarcodeScanGa barcodeScan = _TranslationsBarcodeScanGa._(_root);
	@override late final _TranslationsReceiptScanGa receiptScan = _TranslationsReceiptScanGa._(_root);
	@override late final _TranslationsBatchCookingGa batchCooking = _TranslationsBatchCookingGa._(_root);
	@override late final _TranslationsVisitedDomainsGa visitedDomains = _TranslationsVisitedDomainsGa._(_root);
	@override late final _TranslationsDomainDiscoveryGa domainDiscovery = _TranslationsDomainDiscoveryGa._(_root);
	@override late final _TranslationsInventorySuggestionsGa inventorySuggestions = _TranslationsInventorySuggestionsGa._(_root);
	@override late final _TranslationsUpgradeGa upgrade = _TranslationsUpgradeGa._(_root);
	@override late final _TranslationsTourGa tour = _TranslationsTourGa._(_root);
	@override late final _TranslationsManualRecipeGa manualRecipe = _TranslationsManualRecipeGa._(_root);
	@override late final _TranslationsRecipeEditGa recipeEdit = _TranslationsRecipeEditGa._(_root);
	@override late final _TranslationsErrorsGa errors = _TranslationsErrorsGa._(_root);
}

// Path: app
class _TranslationsAppGa extends TranslationsAppEn {
	_TranslationsAppGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeGa extends TranslationsHomeEn {
	_TranslationsHomeGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonGa extends TranslationsCommonEn {
	_TranslationsCommonGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsGa extends TranslationsSettingsEn {
	_TranslationsSettingsGa._(TranslationsGa root) : this._root = root, super.internal(root);

	final TranslationsGa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsGa measurements = _TranslationsSettingsMeasurementsGa._(_root);
	@override late final _TranslationsSettingsDataManagementGa dataManagement = _TranslationsSettingsDataManagementGa._(_root);
	@override late final _TranslationsSettingsVersionGa version = _TranslationsSettingsVersionGa._(_root);
}

// Path: recipes
class _TranslationsRecipesGa extends TranslationsRecipesEn {
	_TranslationsRecipesGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGa._(TranslationsGa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGa nutrition = _TranslationsRecipeDetailNutritionGa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGa prepAhead = _TranslationsRecipeDetailPrepAheadGa._(_root);
...
// Path: filters
class _TranslationsFiltersGa extends TranslationsFiltersEn {
	_TranslationsFiltersGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGa extends TranslationsShoppingListEn {
	_TranslationsShoppingListGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGa extends TranslationsMealPlanEn {
	_TranslationsMealPlanGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGa extends TranslationsInventoryEn {
	_TranslationsInventoryGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGa extends TranslationsUpgradeEn {
	_TranslationsUpgradeGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGa extends TranslationsTourEn {
	_TranslationsTourGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsGa extends TranslationsErrorsEn {
	_TranslationsErrorsGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGa._(TranslationsGa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGa metric = _TranslationsSettingsMeasurementsMetricGa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGa imperial = _TranslationsSettingsMeasurementsImperialGa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGa._(TranslationsGa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGa._(TranslationsGa root) : this._root = root, super.internal(root);
