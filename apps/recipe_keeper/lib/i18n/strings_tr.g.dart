...
class TranslationsTr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesTr recipes = _TranslationsRecipesTr._(_root);
	@override late final _TranslationsRecipeDetailTr recipeDetail = _TranslationsRecipeDetailTr._(_root);
	@override late final _TranslationsFiltersTr filters = _TranslationsFiltersTr._(_root);
	@override late final _TranslationsShoppingListTr shoppingList = _TranslationsShoppingListTr._(_root);
	@override late final _TranslationsMealPlanTr mealPlan = _TranslationsMealPlanTr._(_root);
	@override late final _TranslationsInventoryTr inventory = _TranslationsInventoryTr._(_root);
	@override late final _TranslationsBarcodeScanTr barcodeScan = _TranslationsBarcodeScanTr._(_root);
	@override late final _TranslationsReceiptScanTr receiptScan = _TranslationsReceiptScanTr._(_root);
	@override late final _TranslationsBatchCookingTr batchCooking = _TranslationsBatchCookingTr._(_root);
	@override late final _TranslationsVisitedDomainsTr visitedDomains = _TranslationsVisitedDomainsTr._(_root);
	@override late final _TranslationsDomainDiscoveryTr domainDiscovery = _TranslationsDomainDiscoveryTr._(_root);
	@override late final _TranslationsInventorySuggestionsTr inventorySuggestions = _TranslationsInventorySuggestionsTr._(_root);
	@override late final _TranslationsUpgradeTr upgrade = _TranslationsUpgradeTr._(_root);
	@override late final _TranslationsTourTr tour = _TranslationsTourTr._(_root);
	@override late final _TranslationsManualRecipeTr manualRecipe = _TranslationsManualRecipeTr._(_root);
	@override late final _TranslationsRecipeEditTr recipeEdit = _TranslationsRecipeEditTr._(_root);
...
class _TranslationsSettingsTr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsTr measurements = _TranslationsSettingsMeasurementsTr._(_root);
	@override late final _TranslationsSettingsDataManagementTr dataManagement = _TranslationsSettingsDataManagementTr._(_root);
	@override late final _TranslationsSettingsVersionTr version = _TranslationsSettingsVersionTr._(_root);
}

// Path: recipes
class _TranslationsRecipesTr extends TranslationsRecipesEn {
	_TranslationsRecipesTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTr._(TranslationsTr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTr nutrition = _TranslationsRecipeDetailNutritionTr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTr prepAhead = _TranslationsRecipeDetailPrepAheadTr._(_root);
...
// Path: filters
class _TranslationsFiltersTr extends TranslationsFiltersEn {
	_TranslationsFiltersTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTr extends TranslationsShoppingListEn {
	_TranslationsShoppingListTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTr extends TranslationsMealPlanEn {
	_TranslationsMealPlanTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTr extends TranslationsInventoryEn {
	_TranslationsInventoryTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTr extends TranslationsUpgradeEn {
	_TranslationsUpgradeTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTr extends TranslationsTourEn {
	_TranslationsTourTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTr._(TranslationsTr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTr metric = _TranslationsSettingsMeasurementsMetricTr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTr imperial = _TranslationsSettingsMeasurementsImperialTr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTr._(TranslationsTr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTr._(TranslationsTr root) : this._root = root, super.internal(root);
