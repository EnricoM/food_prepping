...
// Path: <root>
class TranslationsKj extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKj({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <kj>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKj _root = this; // ignore: unused_field

	@override 
	TranslationsKj $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKj(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKj app = _TranslationsAppKj._(_root);
	@override late final _TranslationsHomeKj home = _TranslationsHomeKj._(_root);
	@override late final _TranslationsCommonKj common = _TranslationsCommonKj._(_root);
	@override late final _TranslationsSettingsKj settings = _TranslationsSettingsKj._(_root);
	@override late final _TranslationsRecipesKj recipes = _TranslationsRecipesKj._(_root);
	@override late final _TranslationsRecipeDetailKj recipeDetail = _TranslationsRecipeDetailKj._(_root);
	@override late final _TranslationsFiltersKj filters = _TranslationsFiltersKj._(_root);
	@override late final _TranslationsShoppingListKj shoppingList = _TranslationsShoppingListKj._(_root);
	@override late final _TranslationsMealPlanKj mealPlan = _TranslationsMealPlanKj._(_root);
	@override late final _TranslationsInventoryKj inventory = _TranslationsInventoryKj._(_root);
	@override late final _TranslationsBarcodeScanKj barcodeScan = _TranslationsBarcodeScanKj._(_root);
	@override late final _TranslationsReceiptScanKj receiptScan = _TranslationsReceiptScanKj._(_root);
	@override late final _TranslationsBatchCookingKj batchCooking = _TranslationsBatchCookingKj._(_root);
	@override late final _TranslationsVisitedDomainsKj visitedDomains = _TranslationsVisitedDomainsKj._(_root);
	@override late final _TranslationsDomainDiscoveryKj domainDiscovery = _TranslationsDomainDiscoveryKj._(_root);
	@override late final _TranslationsInventorySuggestionsKj inventorySuggestions = _TranslationsInventorySuggestionsKj._(_root);
	@override late final _TranslationsUpgradeKj upgrade = _TranslationsUpgradeKj._(_root);
	@override late final _TranslationsTourKj tour = _TranslationsTourKj._(_root);
	@override late final _TranslationsManualRecipeKj manualRecipe = _TranslationsManualRecipeKj._(_root);
	@override late final _TranslationsRecipeEditKj recipeEdit = _TranslationsRecipeEditKj._(_root);
	@override late final _TranslationsErrorsKj errors = _TranslationsErrorsKj._(_root);
}

// Path: app
class _TranslationsAppKj extends TranslationsAppEn {
	_TranslationsAppKj._(TranslationsKj root) : this._root = root, super.internal(root);

	final TranslationsKj _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKj extends TranslationsHomeEn {
	_TranslationsHomeKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKj extends TranslationsCommonEn {
	_TranslationsCommonKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKj extends TranslationsSettingsEn {
	_TranslationsSettingsKj._(TranslationsKj root) : this._root = root, super.internal(root);

	final TranslationsKj _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKj measurements = _TranslationsSettingsMeasurementsKj._(_root);
	@override late final _TranslationsSettingsDataManagementKj dataManagement = _TranslationsSettingsDataManagementKj._(_root);
	@override late final _TranslationsSettingsVersionKj version = _TranslationsSettingsVersionKj._(_root);
}

// Path: recipes
class _TranslationsRecipesKj extends TranslationsRecipesEn {
	_TranslationsRecipesKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKj extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKj._(TranslationsKj root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKj nutrition = _TranslationsRecipeDetailNutritionKj._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKj prepAhead = _TranslationsRecipeDetailPrepAheadKj._(_root);
...
// Path: filters
class _TranslationsFiltersKj extends TranslationsFiltersEn {
	_TranslationsFiltersKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKj extends TranslationsShoppingListEn {
	_TranslationsShoppingListKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKj extends TranslationsMealPlanEn {
	_TranslationsMealPlanKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKj extends TranslationsInventoryEn {
	_TranslationsInventoryKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKj extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKj extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKj extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKj extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKj extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKj extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKj extends TranslationsUpgradeEn {
	_TranslationsUpgradeKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKj extends TranslationsTourEn {
	_TranslationsTourKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKj extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKj extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKj extends TranslationsErrorsEn {
	_TranslationsErrorsKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKj extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKj._(TranslationsKj root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKj metric = _TranslationsSettingsMeasurementsMetricKj._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKj imperial = _TranslationsSettingsMeasurementsImperialKj._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKj extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKj extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKj extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKj extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKj extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKj extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKj._(TranslationsKj root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kj>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKj {
