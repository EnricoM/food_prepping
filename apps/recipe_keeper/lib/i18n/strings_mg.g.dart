...
// Path: <root>
class TranslationsMg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <mg>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMg _root = this; // ignore: unused_field

	@override 
	TranslationsMg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMg app = _TranslationsAppMg._(_root);
	@override late final _TranslationsHomeMg home = _TranslationsHomeMg._(_root);
	@override late final _TranslationsCommonMg common = _TranslationsCommonMg._(_root);
	@override late final _TranslationsSettingsMg settings = _TranslationsSettingsMg._(_root);
	@override late final _TranslationsRecipesMg recipes = _TranslationsRecipesMg._(_root);
	@override late final _TranslationsRecipeDetailMg recipeDetail = _TranslationsRecipeDetailMg._(_root);
	@override late final _TranslationsFiltersMg filters = _TranslationsFiltersMg._(_root);
	@override late final _TranslationsShoppingListMg shoppingList = _TranslationsShoppingListMg._(_root);
	@override late final _TranslationsMealPlanMg mealPlan = _TranslationsMealPlanMg._(_root);
	@override late final _TranslationsInventoryMg inventory = _TranslationsInventoryMg._(_root);
	@override late final _TranslationsBarcodeScanMg barcodeScan = _TranslationsBarcodeScanMg._(_root);
	@override late final _TranslationsReceiptScanMg receiptScan = _TranslationsReceiptScanMg._(_root);
	@override late final _TranslationsBatchCookingMg batchCooking = _TranslationsBatchCookingMg._(_root);
	@override late final _TranslationsVisitedDomainsMg visitedDomains = _TranslationsVisitedDomainsMg._(_root);
	@override late final _TranslationsDomainDiscoveryMg domainDiscovery = _TranslationsDomainDiscoveryMg._(_root);
	@override late final _TranslationsInventorySuggestionsMg inventorySuggestions = _TranslationsInventorySuggestionsMg._(_root);
	@override late final _TranslationsUpgradeMg upgrade = _TranslationsUpgradeMg._(_root);
	@override late final _TranslationsTourMg tour = _TranslationsTourMg._(_root);
	@override late final _TranslationsManualRecipeMg manualRecipe = _TranslationsManualRecipeMg._(_root);
	@override late final _TranslationsRecipeEditMg recipeEdit = _TranslationsRecipeEditMg._(_root);
	@override late final _TranslationsErrorsMg errors = _TranslationsErrorsMg._(_root);
}

// Path: app
class _TranslationsAppMg extends TranslationsAppEn {
	_TranslationsAppMg._(TranslationsMg root) : this._root = root, super.internal(root);

	final TranslationsMg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMg extends TranslationsHomeEn {
	_TranslationsHomeMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMg extends TranslationsCommonEn {
	_TranslationsCommonMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMg extends TranslationsSettingsEn {
	_TranslationsSettingsMg._(TranslationsMg root) : this._root = root, super.internal(root);

	final TranslationsMg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMg measurements = _TranslationsSettingsMeasurementsMg._(_root);
	@override late final _TranslationsSettingsDataManagementMg dataManagement = _TranslationsSettingsDataManagementMg._(_root);
	@override late final _TranslationsSettingsVersionMg version = _TranslationsSettingsVersionMg._(_root);
}

// Path: recipes
class _TranslationsRecipesMg extends TranslationsRecipesEn {
	_TranslationsRecipesMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMg._(TranslationsMg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMg nutrition = _TranslationsRecipeDetailNutritionMg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMg prepAhead = _TranslationsRecipeDetailPrepAheadMg._(_root);
...
// Path: filters
class _TranslationsFiltersMg extends TranslationsFiltersEn {
	_TranslationsFiltersMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMg extends TranslationsShoppingListEn {
	_TranslationsShoppingListMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMg extends TranslationsMealPlanEn {
	_TranslationsMealPlanMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMg extends TranslationsInventoryEn {
	_TranslationsInventoryMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMg extends TranslationsUpgradeEn {
	_TranslationsUpgradeMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMg extends TranslationsTourEn {
	_TranslationsTourMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMg extends TranslationsErrorsEn {
	_TranslationsErrorsMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMg._(TranslationsMg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMg metric = _TranslationsSettingsMeasurementsMetricMg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMg imperial = _TranslationsSettingsMeasurementsImperialMg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMg._(TranslationsMg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <mg>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMg {
