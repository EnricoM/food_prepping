...
// Path: <root>
class TranslationsJv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsJv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <jv>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsJv _root = this; // ignore: unused_field

	@override 
	TranslationsJv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsJv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppJv app = _TranslationsAppJv._(_root);
	@override late final _TranslationsHomeJv home = _TranslationsHomeJv._(_root);
	@override late final _TranslationsCommonJv common = _TranslationsCommonJv._(_root);
	@override late final _TranslationsSettingsJv settings = _TranslationsSettingsJv._(_root);
	@override late final _TranslationsRecipesJv recipes = _TranslationsRecipesJv._(_root);
	@override late final _TranslationsRecipeDetailJv recipeDetail = _TranslationsRecipeDetailJv._(_root);
	@override late final _TranslationsFiltersJv filters = _TranslationsFiltersJv._(_root);
	@override late final _TranslationsShoppingListJv shoppingList = _TranslationsShoppingListJv._(_root);
	@override late final _TranslationsMealPlanJv mealPlan = _TranslationsMealPlanJv._(_root);
	@override late final _TranslationsInventoryJv inventory = _TranslationsInventoryJv._(_root);
	@override late final _TranslationsBarcodeScanJv barcodeScan = _TranslationsBarcodeScanJv._(_root);
	@override late final _TranslationsReceiptScanJv receiptScan = _TranslationsReceiptScanJv._(_root);
	@override late final _TranslationsBatchCookingJv batchCooking = _TranslationsBatchCookingJv._(_root);
	@override late final _TranslationsVisitedDomainsJv visitedDomains = _TranslationsVisitedDomainsJv._(_root);
	@override late final _TranslationsDomainDiscoveryJv domainDiscovery = _TranslationsDomainDiscoveryJv._(_root);
	@override late final _TranslationsInventorySuggestionsJv inventorySuggestions = _TranslationsInventorySuggestionsJv._(_root);
	@override late final _TranslationsUpgradeJv upgrade = _TranslationsUpgradeJv._(_root);
	@override late final _TranslationsTourJv tour = _TranslationsTourJv._(_root);
	@override late final _TranslationsManualRecipeJv manualRecipe = _TranslationsManualRecipeJv._(_root);
	@override late final _TranslationsRecipeEditJv recipeEdit = _TranslationsRecipeEditJv._(_root);
	@override late final _TranslationsErrorsJv errors = _TranslationsErrorsJv._(_root);
}

// Path: app
class _TranslationsAppJv extends TranslationsAppEn {
	_TranslationsAppJv._(TranslationsJv root) : this._root = root, super.internal(root);

	final TranslationsJv _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeJv extends TranslationsHomeEn {
	_TranslationsHomeJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonJv extends TranslationsCommonEn {
	_TranslationsCommonJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsJv extends TranslationsSettingsEn {
	_TranslationsSettingsJv._(TranslationsJv root) : this._root = root, super.internal(root);

	final TranslationsJv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsJv measurements = _TranslationsSettingsMeasurementsJv._(_root);
	@override late final _TranslationsSettingsDataManagementJv dataManagement = _TranslationsSettingsDataManagementJv._(_root);
	@override late final _TranslationsSettingsVersionJv version = _TranslationsSettingsVersionJv._(_root);
}

// Path: recipes
class _TranslationsRecipesJv extends TranslationsRecipesEn {
	_TranslationsRecipesJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailJv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailJv._(TranslationsJv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionJv nutrition = _TranslationsRecipeDetailNutritionJv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadJv prepAhead = _TranslationsRecipeDetailPrepAheadJv._(_root);
...
// Path: filters
class _TranslationsFiltersJv extends TranslationsFiltersEn {
	_TranslationsFiltersJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListJv extends TranslationsShoppingListEn {
	_TranslationsShoppingListJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanJv extends TranslationsMealPlanEn {
	_TranslationsMealPlanJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryJv extends TranslationsInventoryEn {
	_TranslationsInventoryJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanJv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanJv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingJv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsJv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryJv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsJv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeJv extends TranslationsUpgradeEn {
	_TranslationsUpgradeJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourJv extends TranslationsTourEn {
	_TranslationsTourJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeJv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditJv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsJv extends TranslationsErrorsEn {
	_TranslationsErrorsJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsJv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsJv._(TranslationsJv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricJv metric = _TranslationsSettingsMeasurementsMetricJv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialJv imperial = _TranslationsSettingsMeasurementsImperialJv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementJv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionJv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionJv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadJv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricJv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialJv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialJv._(TranslationsJv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <jv>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsJv {
