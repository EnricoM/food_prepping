...
// Path: <root>
class TranslationsNg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ng>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNg _root = this; // ignore: unused_field

	@override 
	TranslationsNg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNg app = _TranslationsAppNg._(_root);
	@override late final _TranslationsHomeNg home = _TranslationsHomeNg._(_root);
	@override late final _TranslationsCommonNg common = _TranslationsCommonNg._(_root);
	@override late final _TranslationsSettingsNg settings = _TranslationsSettingsNg._(_root);
	@override late final _TranslationsRecipesNg recipes = _TranslationsRecipesNg._(_root);
	@override late final _TranslationsRecipeDetailNg recipeDetail = _TranslationsRecipeDetailNg._(_root);
	@override late final _TranslationsFiltersNg filters = _TranslationsFiltersNg._(_root);
	@override late final _TranslationsShoppingListNg shoppingList = _TranslationsShoppingListNg._(_root);
	@override late final _TranslationsMealPlanNg mealPlan = _TranslationsMealPlanNg._(_root);
	@override late final _TranslationsInventoryNg inventory = _TranslationsInventoryNg._(_root);
	@override late final _TranslationsBarcodeScanNg barcodeScan = _TranslationsBarcodeScanNg._(_root);
	@override late final _TranslationsReceiptScanNg receiptScan = _TranslationsReceiptScanNg._(_root);
	@override late final _TranslationsBatchCookingNg batchCooking = _TranslationsBatchCookingNg._(_root);
	@override late final _TranslationsVisitedDomainsNg visitedDomains = _TranslationsVisitedDomainsNg._(_root);
	@override late final _TranslationsDomainDiscoveryNg domainDiscovery = _TranslationsDomainDiscoveryNg._(_root);
	@override late final _TranslationsInventorySuggestionsNg inventorySuggestions = _TranslationsInventorySuggestionsNg._(_root);
	@override late final _TranslationsUpgradeNg upgrade = _TranslationsUpgradeNg._(_root);
	@override late final _TranslationsTourNg tour = _TranslationsTourNg._(_root);
	@override late final _TranslationsManualRecipeNg manualRecipe = _TranslationsManualRecipeNg._(_root);
	@override late final _TranslationsRecipeEditNg recipeEdit = _TranslationsRecipeEditNg._(_root);
	@override late final _TranslationsErrorsNg errors = _TranslationsErrorsNg._(_root);
}

// Path: app
class _TranslationsAppNg extends TranslationsAppEn {
	_TranslationsAppNg._(TranslationsNg root) : this._root = root, super.internal(root);

	final TranslationsNg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNg extends TranslationsHomeEn {
	_TranslationsHomeNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNg extends TranslationsCommonEn {
	_TranslationsCommonNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNg extends TranslationsSettingsEn {
	_TranslationsSettingsNg._(TranslationsNg root) : this._root = root, super.internal(root);

	final TranslationsNg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNg measurements = _TranslationsSettingsMeasurementsNg._(_root);
	@override late final _TranslationsSettingsDataManagementNg dataManagement = _TranslationsSettingsDataManagementNg._(_root);
	@override late final _TranslationsSettingsVersionNg version = _TranslationsSettingsVersionNg._(_root);
}

// Path: recipes
class _TranslationsRecipesNg extends TranslationsRecipesEn {
	_TranslationsRecipesNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNg._(TranslationsNg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNg nutrition = _TranslationsRecipeDetailNutritionNg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNg prepAhead = _TranslationsRecipeDetailPrepAheadNg._(_root);
...
// Path: filters
class _TranslationsFiltersNg extends TranslationsFiltersEn {
	_TranslationsFiltersNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNg extends TranslationsShoppingListEn {
	_TranslationsShoppingListNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNg extends TranslationsMealPlanEn {
	_TranslationsMealPlanNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNg extends TranslationsInventoryEn {
	_TranslationsInventoryNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNg extends TranslationsUpgradeEn {
	_TranslationsUpgradeNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNg extends TranslationsTourEn {
	_TranslationsTourNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNg extends TranslationsErrorsEn {
	_TranslationsErrorsNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNg._(TranslationsNg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNg metric = _TranslationsSettingsMeasurementsMetricNg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNg imperial = _TranslationsSettingsMeasurementsImperialNg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNg._(TranslationsNg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ng>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNg {
