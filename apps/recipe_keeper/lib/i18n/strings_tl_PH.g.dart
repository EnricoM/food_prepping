...
// Path: <root>
class TranslationsTlPh extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTlPh({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.tlPh,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <tl-PH>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTlPh _root = this; // ignore: unused_field

	@override 
	TranslationsTlPh $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTlPh(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTlPh app = _TranslationsAppTlPh._(_root);
	@override late final _TranslationsHomeTlPh home = _TranslationsHomeTlPh._(_root);
	@override late final _TranslationsCommonTlPh common = _TranslationsCommonTlPh._(_root);
	@override late final _TranslationsSettingsTlPh settings = _TranslationsSettingsTlPh._(_root);
	@override late final _TranslationsRecipesTlPh recipes = _TranslationsRecipesTlPh._(_root);
	@override late final _TranslationsRecipeDetailTlPh recipeDetail = _TranslationsRecipeDetailTlPh._(_root);
	@override late final _TranslationsFiltersTlPh filters = _TranslationsFiltersTlPh._(_root);
	@override late final _TranslationsShoppingListTlPh shoppingList = _TranslationsShoppingListTlPh._(_root);
	@override late final _TranslationsMealPlanTlPh mealPlan = _TranslationsMealPlanTlPh._(_root);
	@override late final _TranslationsInventoryTlPh inventory = _TranslationsInventoryTlPh._(_root);
	@override late final _TranslationsBarcodeScanTlPh barcodeScan = _TranslationsBarcodeScanTlPh._(_root);
	@override late final _TranslationsReceiptScanTlPh receiptScan = _TranslationsReceiptScanTlPh._(_root);
	@override late final _TranslationsBatchCookingTlPh batchCooking = _TranslationsBatchCookingTlPh._(_root);
	@override late final _TranslationsVisitedDomainsTlPh visitedDomains = _TranslationsVisitedDomainsTlPh._(_root);
	@override late final _TranslationsDomainDiscoveryTlPh domainDiscovery = _TranslationsDomainDiscoveryTlPh._(_root);
	@override late final _TranslationsInventorySuggestionsTlPh inventorySuggestions = _TranslationsInventorySuggestionsTlPh._(_root);
	@override late final _TranslationsUpgradeTlPh upgrade = _TranslationsUpgradeTlPh._(_root);
	@override late final _TranslationsTourTlPh tour = _TranslationsTourTlPh._(_root);
	@override late final _TranslationsManualRecipeTlPh manualRecipe = _TranslationsManualRecipeTlPh._(_root);
	@override late final _TranslationsRecipeEditTlPh recipeEdit = _TranslationsRecipeEditTlPh._(_root);
	@override late final _TranslationsErrorsTlPh errors = _TranslationsErrorsTlPh._(_root);
}

// Path: app
class _TranslationsAppTlPh extends TranslationsAppEn {
	_TranslationsAppTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);

	final TranslationsTlPh _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTlPh extends TranslationsHomeEn {
	_TranslationsHomeTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTlPh extends TranslationsCommonEn {
	_TranslationsCommonTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTlPh extends TranslationsSettingsEn {
	_TranslationsSettingsTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);

	final TranslationsTlPh _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTlPh measurements = _TranslationsSettingsMeasurementsTlPh._(_root);
	@override late final _TranslationsSettingsDataManagementTlPh dataManagement = _TranslationsSettingsDataManagementTlPh._(_root);
	@override late final _TranslationsSettingsVersionTlPh version = _TranslationsSettingsVersionTlPh._(_root);
}

// Path: recipes
class _TranslationsRecipesTlPh extends TranslationsRecipesEn {
	_TranslationsRecipesTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTlPh extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTlPh nutrition = _TranslationsRecipeDetailNutritionTlPh._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTlPh prepAhead = _TranslationsRecipeDetailPrepAheadTlPh._(_root);
...
// Path: filters
class _TranslationsFiltersTlPh extends TranslationsFiltersEn {
	_TranslationsFiltersTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTlPh extends TranslationsShoppingListEn {
	_TranslationsShoppingListTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTlPh extends TranslationsMealPlanEn {
	_TranslationsMealPlanTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTlPh extends TranslationsInventoryEn {
	_TranslationsInventoryTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTlPh extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTlPh extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTlPh extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTlPh extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTlPh extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTlPh extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTlPh extends TranslationsUpgradeEn {
	_TranslationsUpgradeTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTlPh extends TranslationsTourEn {
	_TranslationsTourTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTlPh extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTlPh extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTlPh extends TranslationsErrorsEn {
	_TranslationsErrorsTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTlPh extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTlPh metric = _TranslationsSettingsMeasurementsMetricTlPh._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTlPh imperial = _TranslationsSettingsMeasurementsImperialTlPh._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTlPh extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTlPh extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTlPh extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTlPh extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTlPh extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTlPh extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTlPh._(TranslationsTlPh root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <tl-PH>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTlPh {
