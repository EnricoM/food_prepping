...
class TranslationsEsMx extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppEsMx app = _TranslationsAppEsMx._(_root);
	@override late final _TranslationsHomeEsMx home = _TranslationsHomeEsMx._(_root);
	@override late final _TranslationsCommonEsMx common = _TranslationsCommonEsMx._(_root);
	@override late final _TranslationsSettingsEsMx settings = _TranslationsSettingsEsMx._(_root);
	@override late final _TranslationsRecipesEsMx recipes = _TranslationsRecipesEsMx._(_root);
	@override late final _TranslationsRecipeDetailEsMx recipeDetail = _TranslationsRecipeDetailEsMx._(_root);
	@override late final _TranslationsFiltersEsMx filters = _TranslationsFiltersEsMx._(_root);
	@override late final _TranslationsShoppingListEsMx shoppingList = _TranslationsShoppingListEsMx._(_root);
	@override late final _TranslationsMealPlanEsMx mealPlan = _TranslationsMealPlanEsMx._(_root);
	@override late final _TranslationsInventoryEsMx inventory = _TranslationsInventoryEsMx._(_root);
	@override late final _TranslationsBarcodeScanEsMx barcodeScan = _TranslationsBarcodeScanEsMx._(_root);
	@override late final _TranslationsReceiptScanEsMx receiptScan = _TranslationsReceiptScanEsMx._(_root);
	@override late final _TranslationsBatchCookingEsMx batchCooking = _TranslationsBatchCookingEsMx._(_root);
	@override late final _TranslationsVisitedDomainsEsMx visitedDomains = _TranslationsVisitedDomainsEsMx._(_root);
	@override late final _TranslationsDomainDiscoveryEsMx domainDiscovery = _TranslationsDomainDiscoveryEsMx._(_root);
	@override late final _TranslationsInventorySuggestionsEsMx inventorySuggestions = _TranslationsInventorySuggestionsEsMx._(_root);
	@override late final _TranslationsUpgradeEsMx upgrade = _TranslationsUpgradeEsMx._(_root);
	@override late final _TranslationsTourEsMx tour = _TranslationsTourEsMx._(_root);
	@override late final _TranslationsManualRecipeEsMx manualRecipe = _TranslationsManualRecipeEsMx._(_root);
	@override late final _TranslationsRecipeEditEsMx recipeEdit = _TranslationsRecipeEditEsMx._(_root);
	@override late final _TranslationsErrorsEsMx errors = _TranslationsErrorsEsMx._(_root);
}

// Path: app
class _TranslationsAppEsMx extends TranslationsAppEn {
	_TranslationsAppEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeEsMx extends TranslationsHomeEn {
	_TranslationsHomeEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEsMx extends TranslationsCommonEn {
	_TranslationsCommonEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEsMx extends TranslationsSettingsEn {
	_TranslationsSettingsEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);

	final TranslationsEsMx _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEsMx measurements = _TranslationsSettingsMeasurementsEsMx._(_root);
	@override late final _TranslationsSettingsDataManagementEsMx dataManagement = _TranslationsSettingsDataManagementEsMx._(_root);
	@override late final _TranslationsSettingsVersionEsMx version = _TranslationsSettingsVersionEsMx._(_root);
}

// Path: recipes
class _TranslationsRecipesEsMx extends TranslationsRecipesEn {
	_TranslationsRecipesEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEsMx extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEsMx nutrition = _TranslationsRecipeDetailNutritionEsMx._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEsMx prepAhead = _TranslationsRecipeDetailPrepAheadEsMx._(_root);
...
// Path: filters
class _TranslationsFiltersEsMx extends TranslationsFiltersEn {
	_TranslationsFiltersEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEsMx extends TranslationsShoppingListEn {
	_TranslationsShoppingListEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEsMx extends TranslationsMealPlanEn {
	_TranslationsMealPlanEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEsMx extends TranslationsInventoryEn {
	_TranslationsInventoryEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEsMx extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEsMx extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEsMx extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEsMx extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEsMx extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEsMx extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEsMx extends TranslationsUpgradeEn {
	_TranslationsUpgradeEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEsMx extends TranslationsTourEn {
	_TranslationsTourEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEsMx extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEsMx extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEsMx extends TranslationsErrorsEn {
	_TranslationsErrorsEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEsMx extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEsMx metric = _TranslationsSettingsMeasurementsMetricEsMx._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEsMx imperial = _TranslationsSettingsMeasurementsImperialEsMx._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEsMx extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEsMx extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEsMx extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEsMx extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEsMx extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEsMx extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEsMx._(TranslationsEsMx root) : this._root = root, super.internal(root);
