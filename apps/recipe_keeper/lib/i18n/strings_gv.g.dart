...
// Path: <root>
class TranslationsGv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsGv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <gv>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsGv _root = this; // ignore: unused_field

	@override 
	TranslationsGv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsGv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppGv app = _TranslationsAppGv._(_root);
	@override late final _TranslationsHomeGv home = _TranslationsHomeGv._(_root);
	@override late final _TranslationsCommonGv common = _TranslationsCommonGv._(_root);
	@override late final _TranslationsSettingsGv settings = _TranslationsSettingsGv._(_root);
	@override late final _TranslationsRecipesGv recipes = _TranslationsRecipesGv._(_root);
	@override late final _TranslationsRecipeDetailGv recipeDetail = _TranslationsRecipeDetailGv._(_root);
	@override late final _TranslationsFiltersGv filters = _TranslationsFiltersGv._(_root);
	@override late final _TranslationsShoppingListGv shoppingList = _TranslationsShoppingListGv._(_root);
	@override late final _TranslationsMealPlanGv mealPlan = _TranslationsMealPlanGv._(_root);
	@override late final _TranslationsInventoryGv inventory = _TranslationsInventoryGv._(_root);
	@override late final _TranslationsBarcodeScanGv barcodeScan = _TranslationsBarcodeScanGv._(_root);
	@override late final _TranslationsReceiptScanGv receiptScan = _TranslationsReceiptScanGv._(_root);
	@override late final _TranslationsBatchCookingGv batchCooking = _TranslationsBatchCookingGv._(_root);
	@override late final _TranslationsVisitedDomainsGv visitedDomains = _TranslationsVisitedDomainsGv._(_root);
	@override late final _TranslationsDomainDiscoveryGv domainDiscovery = _TranslationsDomainDiscoveryGv._(_root);
	@override late final _TranslationsInventorySuggestionsGv inventorySuggestions = _TranslationsInventorySuggestionsGv._(_root);
	@override late final _TranslationsUpgradeGv upgrade = _TranslationsUpgradeGv._(_root);
	@override late final _TranslationsTourGv tour = _TranslationsTourGv._(_root);
	@override late final _TranslationsManualRecipeGv manualRecipe = _TranslationsManualRecipeGv._(_root);
	@override late final _TranslationsRecipeEditGv recipeEdit = _TranslationsRecipeEditGv._(_root);
	@override late final _TranslationsErrorsGv errors = _TranslationsErrorsGv._(_root);
}

// Path: app
class _TranslationsAppGv extends TranslationsAppEn {
	_TranslationsAppGv._(TranslationsGv root) : this._root = root, super.internal(root);

	final TranslationsGv _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeGv extends TranslationsHomeEn {
	_TranslationsHomeGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonGv extends TranslationsCommonEn {
	_TranslationsCommonGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsGv extends TranslationsSettingsEn {
	_TranslationsSettingsGv._(TranslationsGv root) : this._root = root, super.internal(root);

	final TranslationsGv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsGv measurements = _TranslationsSettingsMeasurementsGv._(_root);
	@override late final _TranslationsSettingsDataManagementGv dataManagement = _TranslationsSettingsDataManagementGv._(_root);
	@override late final _TranslationsSettingsVersionGv version = _TranslationsSettingsVersionGv._(_root);
}

// Path: recipes
class _TranslationsRecipesGv extends TranslationsRecipesEn {
	_TranslationsRecipesGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGv._(TranslationsGv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGv nutrition = _TranslationsRecipeDetailNutritionGv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGv prepAhead = _TranslationsRecipeDetailPrepAheadGv._(_root);
...
// Path: filters
class _TranslationsFiltersGv extends TranslationsFiltersEn {
	_TranslationsFiltersGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGv extends TranslationsShoppingListEn {
	_TranslationsShoppingListGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGv extends TranslationsMealPlanEn {
	_TranslationsMealPlanGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGv extends TranslationsInventoryEn {
	_TranslationsInventoryGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGv extends TranslationsUpgradeEn {
	_TranslationsUpgradeGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGv extends TranslationsTourEn {
	_TranslationsTourGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsGv extends TranslationsErrorsEn {
	_TranslationsErrorsGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGv._(TranslationsGv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGv metric = _TranslationsSettingsMeasurementsMetricGv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGv imperial = _TranslationsSettingsMeasurementsImperialGv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGv._(TranslationsGv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <gv>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsGv {
