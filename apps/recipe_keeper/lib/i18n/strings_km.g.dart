...
class TranslationsKm extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppKm app = _TranslationsAppKm._(_root);
	...
	@override late final _TranslationsSettingsKm settings = _TranslationsSettingsKm._(_root);
	@override late final _TranslationsRecipesKm recipes = _TranslationsRecipesKm._(_root);
	@override late final _TranslationsRecipeDetailKm recipeDetail = _TranslationsRecipeDetailKm._(_root);
	@override late final _TranslationsFiltersKm filters = _TranslationsFiltersKm._(_root);
	@override late final _TranslationsShoppingListKm shoppingList = _TranslationsShoppingListKm._(_root);
	@override late final _TranslationsMealPlanKm mealPlan = _TranslationsMealPlanKm._(_root);
	@override late final _TranslationsInventoryKm inventory = _TranslationsInventoryKm._(_root);
	@override late final _TranslationsBarcodeScanKm barcodeScan = _TranslationsBarcodeScanKm._(_root);
	@override late final _TranslationsReceiptScanKm receiptScan = _TranslationsReceiptScanKm._(_root);
	@override late final _TranslationsBatchCookingKm batchCooking = _TranslationsBatchCookingKm._(_root);
	@override late final _TranslationsVisitedDomainsKm visitedDomains = _TranslationsVisitedDomainsKm._(_root);
	@override late final _TranslationsDomainDiscoveryKm domainDiscovery = _TranslationsDomainDiscoveryKm._(_root);
	@override late final _TranslationsInventorySuggestionsKm inventorySuggestions = _TranslationsInventorySuggestionsKm._(_root);
	@override late final _TranslationsUpgradeKm upgrade = _TranslationsUpgradeKm._(_root);
	@override late final _TranslationsTourKm tour = _TranslationsTourKm._(_root);
	@override late final _TranslationsManualRecipeKm manualRecipe = _TranslationsManualRecipeKm._(_root);
	@override late final _TranslationsRecipeEditKm recipeEdit = _TranslationsRecipeEditKm._(_root);
	@override late final _TranslationsErrorsKm errors = _TranslationsErrorsKm._(_root);
}

// Path: app
class _TranslationsAppKm extends TranslationsAppEn {
	_TranslationsAppKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeKm extends TranslationsHomeEn {
	_TranslationsHomeKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKm extends TranslationsCommonEn {
	_TranslationsCommonKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKm extends TranslationsSettingsEn {
	_TranslationsSettingsKm._(TranslationsKm root) : this._root = root, super.internal(root);

	final TranslationsKm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKm measurements = _TranslationsSettingsMeasurementsKm._(_root);
	@override late final _TranslationsSettingsDataManagementKm dataManagement = _TranslationsSettingsDataManagementKm._(_root);
	@override late final _TranslationsSettingsVersionKm version = _TranslationsSettingsVersionKm._(_root);
}

// Path: recipes
class _TranslationsRecipesKm extends TranslationsRecipesEn {
	_TranslationsRecipesKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKm._(TranslationsKm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKm nutrition = _TranslationsRecipeDetailNutritionKm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKm prepAhead = _TranslationsRecipeDetailPrepAheadKm._(_root);
...
// Path: filters
class _TranslationsFiltersKm extends TranslationsFiltersEn {
	_TranslationsFiltersKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKm extends TranslationsShoppingListEn {
	_TranslationsShoppingListKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKm extends TranslationsMealPlanEn {
	_TranslationsMealPlanKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKm extends TranslationsInventoryEn {
	_TranslationsInventoryKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKm extends TranslationsUpgradeEn {
	_TranslationsUpgradeKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKm extends TranslationsTourEn {
	_TranslationsTourKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKm extends TranslationsErrorsEn {
	_TranslationsErrorsKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKm._(TranslationsKm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKm metric = _TranslationsSettingsMeasurementsMetricKm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKm imperial = _TranslationsSettingsMeasurementsImperialKm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKm._(TranslationsKm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKm._(TranslationsKm root) : this._root = root, super.internal(root);
