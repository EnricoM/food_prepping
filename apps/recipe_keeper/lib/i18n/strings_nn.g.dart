...
// Path: <root>
class TranslationsNn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	@override 
	TranslationsNn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNn app = _TranslationsAppNn._(_root);
	@override late final _TranslationsHomeNn home = _TranslationsHomeNn._(_root);
	@override late final _TranslationsCommonNn common = _TranslationsCommonNn._(_root);
	@override late final _TranslationsSettingsNn settings = _TranslationsSettingsNn._(_root);
	@override late final _TranslationsRecipesNn recipes = _TranslationsRecipesNn._(_root);
	@override late final _TranslationsRecipeDetailNn recipeDetail = _TranslationsRecipeDetailNn._(_root);
	@override late final _TranslationsFiltersNn filters = _TranslationsFiltersNn._(_root);
	@override late final _TranslationsShoppingListNn shoppingList = _TranslationsShoppingListNn._(_root);
	@override late final _TranslationsMealPlanNn mealPlan = _TranslationsMealPlanNn._(_root);
	@override late final _TranslationsInventoryNn inventory = _TranslationsInventoryNn._(_root);
	@override late final _TranslationsBarcodeScanNn barcodeScan = _TranslationsBarcodeScanNn._(_root);
	@override late final _TranslationsReceiptScanNn receiptScan = _TranslationsReceiptScanNn._(_root);
	@override late final _TranslationsBatchCookingNn batchCooking = _TranslationsBatchCookingNn._(_root);
	@override late final _TranslationsVisitedDomainsNn visitedDomains = _TranslationsVisitedDomainsNn._(_root);
	@override late final _TranslationsDomainDiscoveryNn domainDiscovery = _TranslationsDomainDiscoveryNn._(_root);
	@override late final _TranslationsInventorySuggestionsNn inventorySuggestions = _TranslationsInventorySuggestionsNn._(_root);
	@override late final _TranslationsUpgradeNn upgrade = _TranslationsUpgradeNn._(_root);
	@override late final _TranslationsTourNn tour = _TranslationsTourNn._(_root);
	@override late final _TranslationsManualRecipeNn manualRecipe = _TranslationsManualRecipeNn._(_root);
	@override late final _TranslationsRecipeEditNn recipeEdit = _TranslationsRecipeEditNn._(_root);
	@override late final _TranslationsErrorsNn errors = _TranslationsErrorsNn._(_root);
}

// Path: app
class _TranslationsAppNn extends TranslationsAppEn {
	_TranslationsAppNn._(TranslationsNn root) : this._root = root, super.internal(root);

	final TranslationsNn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNn extends TranslationsHomeEn {
	_TranslationsHomeNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNn extends TranslationsCommonEn {
	_TranslationsCommonNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNn extends TranslationsSettingsEn {
	_TranslationsSettingsNn._(TranslationsNn root) : this._root = root, super.internal(root);

	final TranslationsNn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNn measurements = _TranslationsSettingsMeasurementsNn._(_root);
	@override late final _TranslationsSettingsDataManagementNn dataManagement = _TranslationsSettingsDataManagementNn._(_root);
	@override late final _TranslationsSettingsVersionNn version = _TranslationsSettingsVersionNn._(_root);
}

// Path: recipes
class _TranslationsRecipesNn extends TranslationsRecipesEn {
	_TranslationsRecipesNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNn._(TranslationsNn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNn nutrition = _TranslationsRecipeDetailNutritionNn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNn prepAhead = _TranslationsRecipeDetailPrepAheadNn._(_root);
...
// Path: filters
class _TranslationsFiltersNn extends TranslationsFiltersEn {
	_TranslationsFiltersNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNn extends TranslationsShoppingListEn {
	_TranslationsShoppingListNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNn extends TranslationsMealPlanEn {
	_TranslationsMealPlanNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNn extends TranslationsInventoryEn {
	_TranslationsInventoryNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNn extends TranslationsUpgradeEn {
	_TranslationsUpgradeNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNn extends TranslationsTourEn {
	_TranslationsTourNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNn extends TranslationsErrorsEn {
	_TranslationsErrorsNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNn._(TranslationsNn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNn metric = _TranslationsSettingsMeasurementsMetricNn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNn imperial = _TranslationsSettingsMeasurementsImperialNn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNn._(TranslationsNn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <nn>.
