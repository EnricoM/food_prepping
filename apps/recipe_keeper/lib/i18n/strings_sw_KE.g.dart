...
// Path: <root>
class TranslationsSwKe extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSwKe({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.swKe,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <sw-KE>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSwKe _root = this; // ignore: unused_field

	@override 
	TranslationsSwKe $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSwKe(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSwKe app = _TranslationsAppSwKe._(_root);
	@override late final _TranslationsHomeSwKe home = _TranslationsHomeSwKe._(_root);
	@override late final _TranslationsCommonSwKe common = _TranslationsCommonSwKe._(_root);
	@override late final _TranslationsSettingsSwKe settings = _TranslationsSettingsSwKe._(_root);
	@override late final _TranslationsRecipesSwKe recipes = _TranslationsRecipesSwKe._(_root);
	@override late final _TranslationsRecipeDetailSwKe recipeDetail = _TranslationsRecipeDetailSwKe._(_root);
	@override late final _TranslationsFiltersSwKe filters = _TranslationsFiltersSwKe._(_root);
	@override late final _TranslationsShoppingListSwKe shoppingList = _TranslationsShoppingListSwKe._(_root);
	@override late final _TranslationsMealPlanSwKe mealPlan = _TranslationsMealPlanSwKe._(_root);
	@override late final _TranslationsInventorySwKe inventory = _TranslationsInventorySwKe._(_root);
	@override late final _TranslationsBarcodeScanSwKe barcodeScan = _TranslationsBarcodeScanSwKe._(_root);
	@override late final _TranslationsReceiptScanSwKe receiptScan = _TranslationsReceiptScanSwKe._(_root);
	@override late final _TranslationsBatchCookingSwKe batchCooking = _TranslationsBatchCookingSwKe._(_root);
	@override late final _TranslationsVisitedDomainsSwKe visitedDomains = _TranslationsVisitedDomainsSwKe._(_root);
	@override late final _TranslationsDomainDiscoverySwKe domainDiscovery = _TranslationsDomainDiscoverySwKe._(_root);
	@override late final _TranslationsInventorySuggestionsSwKe inventorySuggestions = _TranslationsInventorySuggestionsSwKe._(_root);
	@override late final _TranslationsUpgradeSwKe upgrade = _TranslationsUpgradeSwKe._(_root);
	@override late final _TranslationsTourSwKe tour = _TranslationsTourSwKe._(_root);
	@override late final _TranslationsManualRecipeSwKe manualRecipe = _TranslationsManualRecipeSwKe._(_root);
	@override late final _TranslationsRecipeEditSwKe recipeEdit = _TranslationsRecipeEditSwKe._(_root);
	@override late final _TranslationsErrorsSwKe errors = _TranslationsErrorsSwKe._(_root);
}

// Path: app
class _TranslationsAppSwKe extends TranslationsAppEn {
	_TranslationsAppSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);

	final TranslationsSwKe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSwKe extends TranslationsHomeEn {
	_TranslationsHomeSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSwKe extends TranslationsCommonEn {
	_TranslationsCommonSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSwKe extends TranslationsSettingsEn {
	_TranslationsSettingsSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);

	final TranslationsSwKe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSwKe measurements = _TranslationsSettingsMeasurementsSwKe._(_root);
	@override late final _TranslationsSettingsDataManagementSwKe dataManagement = _TranslationsSettingsDataManagementSwKe._(_root);
	@override late final _TranslationsSettingsVersionSwKe version = _TranslationsSettingsVersionSwKe._(_root);
}

// Path: recipes
class _TranslationsRecipesSwKe extends TranslationsRecipesEn {
	_TranslationsRecipesSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSwKe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSwKe nutrition = _TranslationsRecipeDetailNutritionSwKe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSwKe prepAhead = _TranslationsRecipeDetailPrepAheadSwKe._(_root);
...
// Path: filters
class _TranslationsFiltersSwKe extends TranslationsFiltersEn {
	_TranslationsFiltersSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSwKe extends TranslationsShoppingListEn {
	_TranslationsShoppingListSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSwKe extends TranslationsMealPlanEn {
	_TranslationsMealPlanSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySwKe extends TranslationsInventoryEn {
	_TranslationsInventorySwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSwKe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSwKe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSwKe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSwKe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySwKe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSwKe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSwKe extends TranslationsUpgradeEn {
	_TranslationsUpgradeSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSwKe extends TranslationsTourEn {
	_TranslationsTourSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSwKe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSwKe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSwKe extends TranslationsErrorsEn {
	_TranslationsErrorsSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSwKe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSwKe metric = _TranslationsSettingsMeasurementsMetricSwKe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSwKe imperial = _TranslationsSettingsMeasurementsImperialSwKe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSwKe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSwKe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSwKe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSwKe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSwKe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSwKe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSwKe._(TranslationsSwKe root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sw-KE>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSwKe {
