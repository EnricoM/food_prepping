...
// Path: <root>
class TranslationsAa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <aa>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAa _root = this; // ignore: unused_field

	@override 
	TranslationsAa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAa app = _TranslationsAppAa._(_root);
	@override late final _TranslationsHomeAa home = _TranslationsHomeAa._(_root);
	@override late final _TranslationsCommonAa common = _TranslationsCommonAa._(_root);
	@override late final _TranslationsSettingsAa settings = _TranslationsSettingsAa._(_root);
	@override late final _TranslationsRecipesAa recipes = _TranslationsRecipesAa._(_root);
	@override late final _TranslationsRecipeDetailAa recipeDetail = _TranslationsRecipeDetailAa._(_root);
	@override late final _TranslationsFiltersAa filters = _TranslationsFiltersAa._(_root);
	@override late final _TranslationsShoppingListAa shoppingList = _TranslationsShoppingListAa._(_root);
	@override late final _TranslationsMealPlanAa mealPlan = _TranslationsMealPlanAa._(_root);
	@override late final _TranslationsInventoryAa inventory = _TranslationsInventoryAa._(_root);
	@override late final _TranslationsBarcodeScanAa barcodeScan = _TranslationsBarcodeScanAa._(_root);
	@override late final _TranslationsReceiptScanAa receiptScan = _TranslationsReceiptScanAa._(_root);
	@override late final _TranslationsBatchCookingAa batchCooking = _TranslationsBatchCookingAa._(_root);
	@override late final _TranslationsVisitedDomainsAa visitedDomains = _TranslationsVisitedDomainsAa._(_root);
	@override late final _TranslationsDomainDiscoveryAa domainDiscovery = _TranslationsDomainDiscoveryAa._(_root);
	@override late final _TranslationsInventorySuggestionsAa inventorySuggestions = _TranslationsInventorySuggestionsAa._(_root);
	@override late final _TranslationsUpgradeAa upgrade = _TranslationsUpgradeAa._(_root);
	@override late final _TranslationsTourAa tour = _TranslationsTourAa._(_root);
	@override late final _TranslationsManualRecipeAa manualRecipe = _TranslationsManualRecipeAa._(_root);
	@override late final _TranslationsRecipeEditAa recipeEdit = _TranslationsRecipeEditAa._(_root);
	@override late final _TranslationsErrorsAa errors = _TranslationsErrorsAa._(_root);
}

// Path: app
class _TranslationsAppAa extends TranslationsAppEn {
	_TranslationsAppAa._(TranslationsAa root) : this._root = root, super.internal(root);

	final TranslationsAa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAa extends TranslationsHomeEn {
	_TranslationsHomeAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAa extends TranslationsCommonEn {
	_TranslationsCommonAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAa extends TranslationsSettingsEn {
	_TranslationsSettingsAa._(TranslationsAa root) : this._root = root, super.internal(root);

	final TranslationsAa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAa measurements = _TranslationsSettingsMeasurementsAa._(_root);
	@override late final _TranslationsSettingsDataManagementAa dataManagement = _TranslationsSettingsDataManagementAa._(_root);
	@override late final _TranslationsSettingsVersionAa version = _TranslationsSettingsVersionAa._(_root);
}

// Path: recipes
class _TranslationsRecipesAa extends TranslationsRecipesEn {
	_TranslationsRecipesAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAa._(TranslationsAa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAa nutrition = _TranslationsRecipeDetailNutritionAa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAa prepAhead = _TranslationsRecipeDetailPrepAheadAa._(_root);
...
// Path: filters
class _TranslationsFiltersAa extends TranslationsFiltersEn {
	_TranslationsFiltersAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAa extends TranslationsShoppingListEn {
	_TranslationsShoppingListAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAa extends TranslationsMealPlanEn {
	_TranslationsMealPlanAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAa extends TranslationsInventoryEn {
	_TranslationsInventoryAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAa extends TranslationsUpgradeEn {
	_TranslationsUpgradeAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAa extends TranslationsTourEn {
	_TranslationsTourAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAa extends TranslationsErrorsEn {
	_TranslationsErrorsAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAa._(TranslationsAa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAa metric = _TranslationsSettingsMeasurementsMetricAa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAa imperial = _TranslationsSettingsMeasurementsImperialAa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAa._(TranslationsAa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <aa>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAa {
