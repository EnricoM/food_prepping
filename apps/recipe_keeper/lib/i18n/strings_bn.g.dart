...
class TranslationsBn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesBn recipes = _TranslationsRecipesBn._(_root);
	@override late final _TranslationsRecipeDetailBn recipeDetail = _TranslationsRecipeDetailBn._(_root);
	@override late final _TranslationsFiltersBn filters = _TranslationsFiltersBn._(_root);
	@override late final _TranslationsShoppingListBn shoppingList = _TranslationsShoppingListBn._(_root);
	@override late final _TranslationsMealPlanBn mealPlan = _TranslationsMealPlanBn._(_root);
	@override late final _TranslationsInventoryBn inventory = _TranslationsInventoryBn._(_root);
	@override late final _TranslationsBarcodeScanBn barcodeScan = _TranslationsBarcodeScanBn._(_root);
	@override late final _TranslationsReceiptScanBn receiptScan = _TranslationsReceiptScanBn._(_root);
	@override late final _TranslationsBatchCookingBn batchCooking = _TranslationsBatchCookingBn._(_root);
	@override late final _TranslationsVisitedDomainsBn visitedDomains = _TranslationsVisitedDomainsBn._(_root);
	@override late final _TranslationsDomainDiscoveryBn domainDiscovery = _TranslationsDomainDiscoveryBn._(_root);
	@override late final _TranslationsInventorySuggestionsBn inventorySuggestions = _TranslationsInventorySuggestionsBn._(_root);
	@override late final _TranslationsUpgradeBn upgrade = _TranslationsUpgradeBn._(_root);
	@override late final _TranslationsTourBn tour = _TranslationsTourBn._(_root);
	@override late final _TranslationsManualRecipeBn manualRecipe = _TranslationsManualRecipeBn._(_root);
	@override late final _TranslationsRecipeEditBn recipeEdit = _TranslationsRecipeEditBn._(_root);
...
class _TranslationsSettingsBn extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsBn measurements = _TranslationsSettingsMeasurementsBn._(_root);
	@override late final _TranslationsSettingsDataManagementBn dataManagement = _TranslationsSettingsDataManagementBn._(_root);
	@override late final _TranslationsSettingsVersionBn version = _TranslationsSettingsVersionBn._(_root);
}

// Path: recipes
class _TranslationsRecipesBn extends TranslationsRecipesEn {
	_TranslationsRecipesBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBn._(TranslationsBn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBn nutrition = _TranslationsRecipeDetailNutritionBn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBn prepAhead = _TranslationsRecipeDetailPrepAheadBn._(_root);
...
// Path: filters
class _TranslationsFiltersBn extends TranslationsFiltersEn {
	_TranslationsFiltersBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBn extends TranslationsShoppingListEn {
	_TranslationsShoppingListBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBn extends TranslationsMealPlanEn {
	_TranslationsMealPlanBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBn extends TranslationsInventoryEn {
	_TranslationsInventoryBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBn extends TranslationsUpgradeEn {
	_TranslationsUpgradeBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBn extends TranslationsTourEn {
	_TranslationsTourBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBn._(TranslationsBn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBn metric = _TranslationsSettingsMeasurementsMetricBn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBn imperial = _TranslationsSettingsMeasurementsImperialBn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBn._(TranslationsBn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBn._(TranslationsBn root) : this._root = root, super.internal(root);
