...
// Path: <root>
class TranslationsUg extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppUg app = _TranslationsAppUg._(_root);
	@override late final _TranslationsHomeUg home = _TranslationsHomeUg._(_root);
	@override late final _TranslationsCommonUg common = _TranslationsCommonUg._(_root);
	@override late final _TranslationsSettingsUg settings = _TranslationsSettingsUg._(_root);
	@override late final _TranslationsRecipesUg recipes = _TranslationsRecipesUg._(_root);
	@override late final _TranslationsRecipeDetailUg recipeDetail = _TranslationsRecipeDetailUg._(_root);
	@override late final _TranslationsFiltersUg filters = _TranslationsFiltersUg._(_root);
	@override late final _TranslationsShoppingListUg shoppingList = _TranslationsShoppingListUg._(_root);
	@override late final _TranslationsMealPlanUg mealPlan = _TranslationsMealPlanUg._(_root);
	@override late final _TranslationsInventoryUg inventory = _TranslationsInventoryUg._(_root);
	@override late final _TranslationsBarcodeScanUg barcodeScan = _TranslationsBarcodeScanUg._(_root);
	@override late final _TranslationsReceiptScanUg receiptScan = _TranslationsReceiptScanUg._(_root);
	@override late final _TranslationsBatchCookingUg batchCooking = _TranslationsBatchCookingUg._(_root);
	@override late final _TranslationsVisitedDomainsUg visitedDomains = _TranslationsVisitedDomainsUg._(_root);
	@override late final _TranslationsDomainDiscoveryUg domainDiscovery = _TranslationsDomainDiscoveryUg._(_root);
	@override late final _TranslationsInventorySuggestionsUg inventorySuggestions = _TranslationsInventorySuggestionsUg._(_root);
	@override late final _TranslationsUpgradeUg upgrade = _TranslationsUpgradeUg._(_root);
	@override late final _TranslationsTourUg tour = _TranslationsTourUg._(_root);
	@override late final _TranslationsManualRecipeUg manualRecipe = _TranslationsManualRecipeUg._(_root);
	@override late final _TranslationsRecipeEditUg recipeEdit = _TranslationsRecipeEditUg._(_root);
	@override late final _TranslationsErrorsUg errors = _TranslationsErrorsUg._(_root);
}

// Path: app
class _TranslationsAppUg extends TranslationsAppEn {
	_TranslationsAppUg._(TranslationsUg root) : this._root = root, super.internal(root);

	final TranslationsUg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeUg extends TranslationsHomeEn {
	_TranslationsHomeUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonUg extends TranslationsCommonEn {
	_TranslationsCommonUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsUg extends TranslationsSettingsEn {
	_TranslationsSettingsUg._(TranslationsUg root) : this._root = root, super.internal(root);

	final TranslationsUg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsUg measurements = _TranslationsSettingsMeasurementsUg._(_root);
	@override late final _TranslationsSettingsDataManagementUg dataManagement = _TranslationsSettingsDataManagementUg._(_root);
	@override late final _TranslationsSettingsVersionUg version = _TranslationsSettingsVersionUg._(_root);
}

// Path: recipes
class _TranslationsRecipesUg extends TranslationsRecipesEn {
	_TranslationsRecipesUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUg._(TranslationsUg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionUg nutrition = _TranslationsRecipeDetailNutritionUg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadUg prepAhead = _TranslationsRecipeDetailPrepAheadUg._(_root);
...
// Path: filters
class _TranslationsFiltersUg extends TranslationsFiltersEn {
	_TranslationsFiltersUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListUg extends TranslationsShoppingListEn {
	_TranslationsShoppingListUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanUg extends TranslationsMealPlanEn {
	_TranslationsMealPlanUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryUg extends TranslationsInventoryEn {
	_TranslationsInventoryUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanUg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingUg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryUg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsUg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeUg extends TranslationsUpgradeEn {
	_TranslationsUpgradeUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourUg extends TranslationsTourEn {
	_TranslationsTourUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsUg extends TranslationsErrorsEn {
	_TranslationsErrorsUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsUg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUg._(TranslationsUg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricUg metric = _TranslationsSettingsMeasurementsMetricUg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialUg imperial = _TranslationsSettingsMeasurementsImperialUg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementUg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionUg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionUg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadUg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricUg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUg._(TranslationsUg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialUg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUg._(TranslationsUg root) : this._root = root, super.internal(root);
