...
// Path: <root>
class TranslationsIo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsIo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <io>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsIo _root = this; // ignore: unused_field

	@override 
	TranslationsIo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsIo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppIo app = _TranslationsAppIo._(_root);
	@override late final _TranslationsHomeIo home = _TranslationsHomeIo._(_root);
	@override late final _TranslationsCommonIo common = _TranslationsCommonIo._(_root);
	@override late final _TranslationsSettingsIo settings = _TranslationsSettingsIo._(_root);
	@override late final _TranslationsRecipesIo recipes = _TranslationsRecipesIo._(_root);
	@override late final _TranslationsRecipeDetailIo recipeDetail = _TranslationsRecipeDetailIo._(_root);
	@override late final _TranslationsFiltersIo filters = _TranslationsFiltersIo._(_root);
	@override late final _TranslationsShoppingListIo shoppingList = _TranslationsShoppingListIo._(_root);
	@override late final _TranslationsMealPlanIo mealPlan = _TranslationsMealPlanIo._(_root);
	@override late final _TranslationsInventoryIo inventory = _TranslationsInventoryIo._(_root);
	@override late final _TranslationsBarcodeScanIo barcodeScan = _TranslationsBarcodeScanIo._(_root);
	@override late final _TranslationsReceiptScanIo receiptScan = _TranslationsReceiptScanIo._(_root);
	@override late final _TranslationsBatchCookingIo batchCooking = _TranslationsBatchCookingIo._(_root);
	@override late final _TranslationsVisitedDomainsIo visitedDomains = _TranslationsVisitedDomainsIo._(_root);
	@override late final _TranslationsDomainDiscoveryIo domainDiscovery = _TranslationsDomainDiscoveryIo._(_root);
	@override late final _TranslationsInventorySuggestionsIo inventorySuggestions = _TranslationsInventorySuggestionsIo._(_root);
	@override late final _TranslationsUpgradeIo upgrade = _TranslationsUpgradeIo._(_root);
	@override late final _TranslationsTourIo tour = _TranslationsTourIo._(_root);
	@override late final _TranslationsManualRecipeIo manualRecipe = _TranslationsManualRecipeIo._(_root);
	@override late final _TranslationsRecipeEditIo recipeEdit = _TranslationsRecipeEditIo._(_root);
	@override late final _TranslationsErrorsIo errors = _TranslationsErrorsIo._(_root);
}

// Path: app
class _TranslationsAppIo extends TranslationsAppEn {
	_TranslationsAppIo._(TranslationsIo root) : this._root = root, super.internal(root);

	final TranslationsIo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIo extends TranslationsHomeEn {
	_TranslationsHomeIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIo extends TranslationsCommonEn {
	_TranslationsCommonIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIo extends TranslationsSettingsEn {
	_TranslationsSettingsIo._(TranslationsIo root) : this._root = root, super.internal(root);

	final TranslationsIo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIo measurements = _TranslationsSettingsMeasurementsIo._(_root);
	@override late final _TranslationsSettingsDataManagementIo dataManagement = _TranslationsSettingsDataManagementIo._(_root);
	@override late final _TranslationsSettingsVersionIo version = _TranslationsSettingsVersionIo._(_root);
}

// Path: recipes
class _TranslationsRecipesIo extends TranslationsRecipesEn {
	_TranslationsRecipesIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIo._(TranslationsIo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIo nutrition = _TranslationsRecipeDetailNutritionIo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIo prepAhead = _TranslationsRecipeDetailPrepAheadIo._(_root);
...
// Path: filters
class _TranslationsFiltersIo extends TranslationsFiltersEn {
	_TranslationsFiltersIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIo extends TranslationsShoppingListEn {
	_TranslationsShoppingListIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIo extends TranslationsMealPlanEn {
	_TranslationsMealPlanIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIo extends TranslationsInventoryEn {
	_TranslationsInventoryIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIo extends TranslationsUpgradeEn {
	_TranslationsUpgradeIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIo extends TranslationsTourEn {
	_TranslationsTourIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIo extends TranslationsErrorsEn {
	_TranslationsErrorsIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIo._(TranslationsIo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIo metric = _TranslationsSettingsMeasurementsMetricIo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIo imperial = _TranslationsSettingsMeasurementsImperialIo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIo._(TranslationsIo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <io>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsIo {
