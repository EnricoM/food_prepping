...
class TranslationsIs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppIs app = _TranslationsAppIs._(_root);
	@override late final _TranslationsHomeIs home = _TranslationsHomeIs._(_root);
	@override late final _TranslationsCommonIs common = _TranslationsCommonIs._(_root);
	@override late final _TranslationsSettingsIs settings = _TranslationsSettingsIs._(_root);
	@override late final _TranslationsRecipesIs recipes = _TranslationsRecipesIs._(_root);
	@override late final _TranslationsRecipeDetailIs recipeDetail = _TranslationsRecipeDetailIs._(_root);
	@override late final _TranslationsFiltersIs filters = _TranslationsFiltersIs._(_root);
	@override late final _TranslationsShoppingListIs shoppingList = _TranslationsShoppingListIs._(_root);
	@override late final _TranslationsMealPlanIs mealPlan = _TranslationsMealPlanIs._(_root);
	@override late final _TranslationsInventoryIs inventory = _TranslationsInventoryIs._(_root);
	@override late final _TranslationsBarcodeScanIs barcodeScan = _TranslationsBarcodeScanIs._(_root);
	@override late final _TranslationsReceiptScanIs receiptScan = _TranslationsReceiptScanIs._(_root);
	@override late final _TranslationsBatchCookingIs batchCooking = _TranslationsBatchCookingIs._(_root);
	@override late final _TranslationsVisitedDomainsIs visitedDomains = _TranslationsVisitedDomainsIs._(_root);
	@override late final _TranslationsDomainDiscoveryIs domainDiscovery = _TranslationsDomainDiscoveryIs._(_root);
	@override late final _TranslationsInventorySuggestionsIs inventorySuggestions = _TranslationsInventorySuggestionsIs._(_root);
	@override late final _TranslationsUpgradeIs upgrade = _TranslationsUpgradeIs._(_root);
	@override late final _TranslationsTourIs tour = _TranslationsTourIs._(_root);
	@override late final _TranslationsManualRecipeIs manualRecipe = _TranslationsManualRecipeIs._(_root);
	@override late final _TranslationsRecipeEditIs recipeEdit = _TranslationsRecipeEditIs._(_root);
	@override late final _TranslationsErrorsIs errors = _TranslationsErrorsIs._(_root);
}

// Path: app
class _TranslationsAppIs extends TranslationsAppEn {
	_TranslationsAppIs._(TranslationsIs root) : this._root = root, super.internal(root);

	final TranslationsIs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIs extends TranslationsHomeEn {
	_TranslationsHomeIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIs extends TranslationsCommonEn {
	_TranslationsCommonIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIs extends TranslationsSettingsEn {
	_TranslationsSettingsIs._(TranslationsIs root) : this._root = root, super.internal(root);

	final TranslationsIs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIs measurements = _TranslationsSettingsMeasurementsIs._(_root);
	@override late final _TranslationsSettingsDataManagementIs dataManagement = _TranslationsSettingsDataManagementIs._(_root);
	@override late final _TranslationsSettingsVersionIs version = _TranslationsSettingsVersionIs._(_root);
}

// Path: recipes
class _TranslationsRecipesIs extends TranslationsRecipesEn {
	_TranslationsRecipesIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIs._(TranslationsIs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIs nutrition = _TranslationsRecipeDetailNutritionIs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIs prepAhead = _TranslationsRecipeDetailPrepAheadIs._(_root);
...
// Path: filters
class _TranslationsFiltersIs extends TranslationsFiltersEn {
	_TranslationsFiltersIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIs extends TranslationsShoppingListEn {
	_TranslationsShoppingListIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIs extends TranslationsMealPlanEn {
	_TranslationsMealPlanIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIs extends TranslationsInventoryEn {
	_TranslationsInventoryIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIs extends TranslationsUpgradeEn {
	_TranslationsUpgradeIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIs extends TranslationsTourEn {
	_TranslationsTourIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIs extends TranslationsErrorsEn {
	_TranslationsErrorsIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIs._(TranslationsIs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIs metric = _TranslationsSettingsMeasurementsMetricIs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIs imperial = _TranslationsSettingsMeasurementsImperialIs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIs._(TranslationsIs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIs._(TranslationsIs root) : this._root = root, super.internal(root);
