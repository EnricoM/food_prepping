...
// Path: <root>
class TranslationsSe extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSe({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <se>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSe _root = this; // ignore: unused_field

	@override 
	TranslationsSe $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSe(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSe app = _TranslationsAppSe._(_root);
	@override late final _TranslationsHomeSe home = _TranslationsHomeSe._(_root);
	@override late final _TranslationsCommonSe common = _TranslationsCommonSe._(_root);
	@override late final _TranslationsSettingsSe settings = _TranslationsSettingsSe._(_root);
	@override late final _TranslationsRecipesSe recipes = _TranslationsRecipesSe._(_root);
	@override late final _TranslationsRecipeDetailSe recipeDetail = _TranslationsRecipeDetailSe._(_root);
	@override late final _TranslationsFiltersSe filters = _TranslationsFiltersSe._(_root);
	@override late final _TranslationsShoppingListSe shoppingList = _TranslationsShoppingListSe._(_root);
	@override late final _TranslationsMealPlanSe mealPlan = _TranslationsMealPlanSe._(_root);
	@override late final _TranslationsInventorySe inventory = _TranslationsInventorySe._(_root);
	@override late final _TranslationsBarcodeScanSe barcodeScan = _TranslationsBarcodeScanSe._(_root);
	@override late final _TranslationsReceiptScanSe receiptScan = _TranslationsReceiptScanSe._(_root);
	@override late final _TranslationsBatchCookingSe batchCooking = _TranslationsBatchCookingSe._(_root);
	@override late final _TranslationsVisitedDomainsSe visitedDomains = _TranslationsVisitedDomainsSe._(_root);
	@override late final _TranslationsDomainDiscoverySe domainDiscovery = _TranslationsDomainDiscoverySe._(_root);
	@override late final _TranslationsInventorySuggestionsSe inventorySuggestions = _TranslationsInventorySuggestionsSe._(_root);
	@override late final _TranslationsUpgradeSe upgrade = _TranslationsUpgradeSe._(_root);
	@override late final _TranslationsTourSe tour = _TranslationsTourSe._(_root);
	@override late final _TranslationsManualRecipeSe manualRecipe = _TranslationsManualRecipeSe._(_root);
	@override late final _TranslationsRecipeEditSe recipeEdit = _TranslationsRecipeEditSe._(_root);
	@override late final _TranslationsErrorsSe errors = _TranslationsErrorsSe._(_root);
}

// Path: app
class _TranslationsAppSe extends TranslationsAppEn {
	_TranslationsAppSe._(TranslationsSe root) : this._root = root, super.internal(root);

	final TranslationsSe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSe extends TranslationsHomeEn {
	_TranslationsHomeSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSe extends TranslationsCommonEn {
	_TranslationsCommonSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSe extends TranslationsSettingsEn {
	_TranslationsSettingsSe._(TranslationsSe root) : this._root = root, super.internal(root);

	final TranslationsSe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSe measurements = _TranslationsSettingsMeasurementsSe._(_root);
	@override late final _TranslationsSettingsDataManagementSe dataManagement = _TranslationsSettingsDataManagementSe._(_root);
	@override late final _TranslationsSettingsVersionSe version = _TranslationsSettingsVersionSe._(_root);
}

// Path: recipes
class _TranslationsRecipesSe extends TranslationsRecipesEn {
	_TranslationsRecipesSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSe._(TranslationsSe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSe nutrition = _TranslationsRecipeDetailNutritionSe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSe prepAhead = _TranslationsRecipeDetailPrepAheadSe._(_root);
...
// Path: filters
class _TranslationsFiltersSe extends TranslationsFiltersEn {
	_TranslationsFiltersSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSe extends TranslationsShoppingListEn {
	_TranslationsShoppingListSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSe extends TranslationsMealPlanEn {
	_TranslationsMealPlanSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySe extends TranslationsInventoryEn {
	_TranslationsInventorySe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSe extends TranslationsUpgradeEn {
	_TranslationsUpgradeSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSe extends TranslationsTourEn {
	_TranslationsTourSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSe extends TranslationsErrorsEn {
	_TranslationsErrorsSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSe._(TranslationsSe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSe metric = _TranslationsSettingsMeasurementsMetricSe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSe imperial = _TranslationsSettingsMeasurementsImperialSe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSe._(TranslationsSe root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <se>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSe {
