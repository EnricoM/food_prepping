...
// Path: <root>
class TranslationsMyMm extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMyMm({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.myMm,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <my-MM>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMyMm _root = this; // ignore: unused_field

	@override 
	TranslationsMyMm $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMyMm(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMyMm app = _TranslationsAppMyMm._(_root);
	@override late final _TranslationsHomeMyMm home = _TranslationsHomeMyMm._(_root);
	@override late final _TranslationsCommonMyMm common = _TranslationsCommonMyMm._(_root);
	@override late final _TranslationsSettingsMyMm settings = _TranslationsSettingsMyMm._(_root);
	@override late final _TranslationsRecipesMyMm recipes = _TranslationsRecipesMyMm._(_root);
	@override late final _TranslationsRecipeDetailMyMm recipeDetail = _TranslationsRecipeDetailMyMm._(_root);
	@override late final _TranslationsFiltersMyMm filters = _TranslationsFiltersMyMm._(_root);
	@override late final _TranslationsShoppingListMyMm shoppingList = _TranslationsShoppingListMyMm._(_root);
	@override late final _TranslationsMealPlanMyMm mealPlan = _TranslationsMealPlanMyMm._(_root);
	@override late final _TranslationsInventoryMyMm inventory = _TranslationsInventoryMyMm._(_root);
	@override late final _TranslationsBarcodeScanMyMm barcodeScan = _TranslationsBarcodeScanMyMm._(_root);
	@override late final _TranslationsReceiptScanMyMm receiptScan = _TranslationsReceiptScanMyMm._(_root);
	@override late final _TranslationsBatchCookingMyMm batchCooking = _TranslationsBatchCookingMyMm._(_root);
	@override late final _TranslationsVisitedDomainsMyMm visitedDomains = _TranslationsVisitedDomainsMyMm._(_root);
	@override late final _TranslationsDomainDiscoveryMyMm domainDiscovery = _TranslationsDomainDiscoveryMyMm._(_root);
	@override late final _TranslationsInventorySuggestionsMyMm inventorySuggestions = _TranslationsInventorySuggestionsMyMm._(_root);
	@override late final _TranslationsUpgradeMyMm upgrade = _TranslationsUpgradeMyMm._(_root);
	@override late final _TranslationsTourMyMm tour = _TranslationsTourMyMm._(_root);
	@override late final _TranslationsManualRecipeMyMm manualRecipe = _TranslationsManualRecipeMyMm._(_root);
	@override late final _TranslationsRecipeEditMyMm recipeEdit = _TranslationsRecipeEditMyMm._(_root);
	@override late final _TranslationsErrorsMyMm errors = _TranslationsErrorsMyMm._(_root);
}

// Path: app
class _TranslationsAppMyMm extends TranslationsAppEn {
	_TranslationsAppMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);

	final TranslationsMyMm _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMyMm extends TranslationsHomeEn {
	_TranslationsHomeMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMyMm extends TranslationsCommonEn {
	_TranslationsCommonMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMyMm extends TranslationsSettingsEn {
	_TranslationsSettingsMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);

	final TranslationsMyMm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMyMm measurements = _TranslationsSettingsMeasurementsMyMm._(_root);
	@override late final _TranslationsSettingsDataManagementMyMm dataManagement = _TranslationsSettingsDataManagementMyMm._(_root);
	@override late final _TranslationsSettingsVersionMyMm version = _TranslationsSettingsVersionMyMm._(_root);
}

// Path: recipes
class _TranslationsRecipesMyMm extends TranslationsRecipesEn {
	_TranslationsRecipesMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMyMm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMyMm nutrition = _TranslationsRecipeDetailNutritionMyMm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMyMm prepAhead = _TranslationsRecipeDetailPrepAheadMyMm._(_root);
...
// Path: filters
class _TranslationsFiltersMyMm extends TranslationsFiltersEn {
	_TranslationsFiltersMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMyMm extends TranslationsShoppingListEn {
	_TranslationsShoppingListMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMyMm extends TranslationsMealPlanEn {
	_TranslationsMealPlanMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMyMm extends TranslationsInventoryEn {
	_TranslationsInventoryMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMyMm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMyMm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMyMm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMyMm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMyMm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMyMm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMyMm extends TranslationsUpgradeEn {
	_TranslationsUpgradeMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMyMm extends TranslationsTourEn {
	_TranslationsTourMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMyMm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMyMm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMyMm extends TranslationsErrorsEn {
	_TranslationsErrorsMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMyMm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMyMm metric = _TranslationsSettingsMeasurementsMetricMyMm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMyMm imperial = _TranslationsSettingsMeasurementsImperialMyMm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMyMm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMyMm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMyMm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMyMm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMyMm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMyMm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMyMm._(TranslationsMyMm root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <my-MM>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMyMm {
