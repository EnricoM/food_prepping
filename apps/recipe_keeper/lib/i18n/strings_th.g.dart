...
class TranslationsTh extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesTh recipes = _TranslationsRecipesTh._(_root);
	@override late final _TranslationsRecipeDetailTh recipeDetail = _TranslationsRecipeDetailTh._(_root);
	@override late final _TranslationsFiltersTh filters = _TranslationsFiltersTh._(_root);
	@override late final _TranslationsShoppingListTh shoppingList = _TranslationsShoppingListTh._(_root);
	@override late final _TranslationsMealPlanTh mealPlan = _TranslationsMealPlanTh._(_root);
	@override late final _TranslationsInventoryTh inventory = _TranslationsInventoryTh._(_root);
	@override late final _TranslationsBarcodeScanTh barcodeScan = _TranslationsBarcodeScanTh._(_root);
	@override late final _TranslationsReceiptScanTh receiptScan = _TranslationsReceiptScanTh._(_root);
	@override late final _TranslationsBatchCookingTh batchCooking = _TranslationsBatchCookingTh._(_root);
	@override late final _TranslationsVisitedDomainsTh visitedDomains = _TranslationsVisitedDomainsTh._(_root);
	@override late final _TranslationsDomainDiscoveryTh domainDiscovery = _TranslationsDomainDiscoveryTh._(_root);
	@override late final _TranslationsInventorySuggestionsTh inventorySuggestions = _TranslationsInventorySuggestionsTh._(_root);
	@override late final _TranslationsUpgradeTh upgrade = _TranslationsUpgradeTh._(_root);
	@override late final _TranslationsTourTh tour = _TranslationsTourTh._(_root);
	@override late final _TranslationsManualRecipeTh manualRecipe = _TranslationsManualRecipeTh._(_root);
	@override late final _TranslationsRecipeEditTh recipeEdit = _TranslationsRecipeEditTh._(_root);
...
class _TranslationsSettingsTh extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsTh measurements = _TranslationsSettingsMeasurementsTh._(_root);
	@override late final _TranslationsSettingsDataManagementTh dataManagement = _TranslationsSettingsDataManagementTh._(_root);
	@override late final _TranslationsSettingsVersionTh version = _TranslationsSettingsVersionTh._(_root);
}

// Path: recipes
class _TranslationsRecipesTh extends TranslationsRecipesEn {
	_TranslationsRecipesTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTh extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTh._(TranslationsTh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTh nutrition = _TranslationsRecipeDetailNutritionTh._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTh prepAhead = _TranslationsRecipeDetailPrepAheadTh._(_root);
...
// Path: filters
class _TranslationsFiltersTh extends TranslationsFiltersEn {
	_TranslationsFiltersTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTh extends TranslationsShoppingListEn {
	_TranslationsShoppingListTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTh extends TranslationsMealPlanEn {
	_TranslationsMealPlanTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTh extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTh extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTh extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTh extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTh extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTh extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTh extends TranslationsUpgradeEn {
	_TranslationsUpgradeTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTh extends TranslationsTourEn {
	_TranslationsTourTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTh extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTh extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTh extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTh._(TranslationsTh root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTh metric = _TranslationsSettingsMeasurementsMetricTh._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTh imperial = _TranslationsSettingsMeasurementsImperialTh._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTh extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTh extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTh extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTh extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTh extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTh._(TranslationsTh root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTh extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTh._(TranslationsTh root) : this._root = root, super.internal(root);
