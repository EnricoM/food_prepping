...
class TranslationsPa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesPa recipes = _TranslationsRecipesPa._(_root);
	@override late final _TranslationsRecipeDetailPa recipeDetail = _TranslationsRecipeDetailPa._(_root);
	@override late final _TranslationsFiltersPa filters = _TranslationsFiltersPa._(_root);
	@override late final _TranslationsShoppingListPa shoppingList = _TranslationsShoppingListPa._(_root);
	@override late final _TranslationsMealPlanPa mealPlan = _TranslationsMealPlanPa._(_root);
	@override late final _TranslationsInventoryPa inventory = _TranslationsInventoryPa._(_root);
	@override late final _TranslationsBarcodeScanPa barcodeScan = _TranslationsBarcodeScanPa._(_root);
	@override late final _TranslationsReceiptScanPa receiptScan = _TranslationsReceiptScanPa._(_root);
	@override late final _TranslationsBatchCookingPa batchCooking = _TranslationsBatchCookingPa._(_root);
	@override late final _TranslationsVisitedDomainsPa visitedDomains = _TranslationsVisitedDomainsPa._(_root);
	@override late final _TranslationsDomainDiscoveryPa domainDiscovery = _TranslationsDomainDiscoveryPa._(_root);
	@override late final _TranslationsInventorySuggestionsPa inventorySuggestions = _TranslationsInventorySuggestionsPa._(_root);
	@override late final _TranslationsUpgradePa upgrade = _TranslationsUpgradePa._(_root);
	@override late final _TranslationsTourPa tour = _TranslationsTourPa._(_root);
	@override late final _TranslationsManualRecipePa manualRecipe = _TranslationsManualRecipePa._(_root);
	@override late final _TranslationsRecipeEditPa recipeEdit = _TranslationsRecipeEditPa._(_root);
...
class _TranslationsSettingsPa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsPa measurements = _TranslationsSettingsMeasurementsPa._(_root);
	@override late final _TranslationsSettingsDataManagementPa dataManagement = _TranslationsSettingsDataManagementPa._(_root);
	@override late final _TranslationsSettingsVersionPa version = _TranslationsSettingsVersionPa._(_root);
}

// Path: recipes
class _TranslationsRecipesPa extends TranslationsRecipesEn {
	_TranslationsRecipesPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPa._(TranslationsPa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionPa nutrition = _TranslationsRecipeDetailNutritionPa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadPa prepAhead = _TranslationsRecipeDetailPrepAheadPa._(_root);
...
// Path: filters
class _TranslationsFiltersPa extends TranslationsFiltersEn {
	_TranslationsFiltersPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListPa extends TranslationsShoppingListEn {
	_TranslationsShoppingListPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanPa extends TranslationsMealPlanEn {
	_TranslationsMealPlanPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryPa extends TranslationsInventoryEn {
	_TranslationsInventoryPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanPa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingPa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryPa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsPa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradePa extends TranslationsUpgradeEn {
	_TranslationsUpgradePa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourPa extends TranslationsTourEn {
	_TranslationsTourPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipePa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipePa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsPa extends TranslationsErrorsEn {
	_TranslationsErrorsPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsPa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPa._(TranslationsPa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricPa metric = _TranslationsSettingsMeasurementsMetricPa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialPa imperial = _TranslationsSettingsMeasurementsImperialPa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementPa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionPa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionPa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadPa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricPa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPa._(TranslationsPa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialPa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPa._(TranslationsPa root) : this._root = root, super.internal(root);
