...
// Path: <root>
class TranslationsAmEt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAmEt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.amEt,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <am-ET>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAmEt _root = this; // ignore: unused_field

	@override 
	TranslationsAmEt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAmEt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAmEt app = _TranslationsAppAmEt._(_root);
	@override late final _TranslationsHomeAmEt home = _TranslationsHomeAmEt._(_root);
	@override late final _TranslationsCommonAmEt common = _TranslationsCommonAmEt._(_root);
	@override late final _TranslationsSettingsAmEt settings = _TranslationsSettingsAmEt._(_root);
	@override late final _TranslationsRecipesAmEt recipes = _TranslationsRecipesAmEt._(_root);
	@override late final _TranslationsRecipeDetailAmEt recipeDetail = _TranslationsRecipeDetailAmEt._(_root);
	@override late final _TranslationsFiltersAmEt filters = _TranslationsFiltersAmEt._(_root);
	@override late final _TranslationsShoppingListAmEt shoppingList = _TranslationsShoppingListAmEt._(_root);
	@override late final _TranslationsMealPlanAmEt mealPlan = _TranslationsMealPlanAmEt._(_root);
	@override late final _TranslationsInventoryAmEt inventory = _TranslationsInventoryAmEt._(_root);
	@override late final _TranslationsBarcodeScanAmEt barcodeScan = _TranslationsBarcodeScanAmEt._(_root);
	@override late final _TranslationsReceiptScanAmEt receiptScan = _TranslationsReceiptScanAmEt._(_root);
	@override late final _TranslationsBatchCookingAmEt batchCooking = _TranslationsBatchCookingAmEt._(_root);
	@override late final _TranslationsVisitedDomainsAmEt visitedDomains = _TranslationsVisitedDomainsAmEt._(_root);
	@override late final _TranslationsDomainDiscoveryAmEt domainDiscovery = _TranslationsDomainDiscoveryAmEt._(_root);
	@override late final _TranslationsInventorySuggestionsAmEt inventorySuggestions = _TranslationsInventorySuggestionsAmEt._(_root);
	@override late final _TranslationsUpgradeAmEt upgrade = _TranslationsUpgradeAmEt._(_root);
	@override late final _TranslationsTourAmEt tour = _TranslationsTourAmEt._(_root);
	@override late final _TranslationsManualRecipeAmEt manualRecipe = _TranslationsManualRecipeAmEt._(_root);
	@override late final _TranslationsRecipeEditAmEt recipeEdit = _TranslationsRecipeEditAmEt._(_root);
	@override late final _TranslationsErrorsAmEt errors = _TranslationsErrorsAmEt._(_root);
}

// Path: app
class _TranslationsAppAmEt extends TranslationsAppEn {
	_TranslationsAppAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);

	final TranslationsAmEt _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAmEt extends TranslationsHomeEn {
	_TranslationsHomeAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAmEt extends TranslationsCommonEn {
	_TranslationsCommonAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAmEt extends TranslationsSettingsEn {
	_TranslationsSettingsAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);

	final TranslationsAmEt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAmEt measurements = _TranslationsSettingsMeasurementsAmEt._(_root);
	@override late final _TranslationsSettingsDataManagementAmEt dataManagement = _TranslationsSettingsDataManagementAmEt._(_root);
	@override late final _TranslationsSettingsVersionAmEt version = _TranslationsSettingsVersionAmEt._(_root);
}

// Path: recipes
class _TranslationsRecipesAmEt extends TranslationsRecipesEn {
	_TranslationsRecipesAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAmEt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAmEt nutrition = _TranslationsRecipeDetailNutritionAmEt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAmEt prepAhead = _TranslationsRecipeDetailPrepAheadAmEt._(_root);
...
// Path: filters
class _TranslationsFiltersAmEt extends TranslationsFiltersEn {
	_TranslationsFiltersAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAmEt extends TranslationsShoppingListEn {
	_TranslationsShoppingListAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAmEt extends TranslationsMealPlanEn {
	_TranslationsMealPlanAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAmEt extends TranslationsInventoryEn {
	_TranslationsInventoryAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAmEt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAmEt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAmEt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAmEt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAmEt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAmEt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAmEt extends TranslationsUpgradeEn {
	_TranslationsUpgradeAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAmEt extends TranslationsTourEn {
	_TranslationsTourAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAmEt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAmEt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAmEt extends TranslationsErrorsEn {
	_TranslationsErrorsAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAmEt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAmEt metric = _TranslationsSettingsMeasurementsMetricAmEt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAmEt imperial = _TranslationsSettingsMeasurementsImperialAmEt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAmEt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAmEt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAmEt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAmEt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAmEt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAmEt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAmEt._(TranslationsAmEt root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <am-ET>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAmEt {
