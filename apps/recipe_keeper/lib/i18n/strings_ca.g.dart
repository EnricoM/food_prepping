...
class TranslationsCa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesCa recipes = _TranslationsRecipesCa._(_root);
	@override late final _TranslationsRecipeDetailCa recipeDetail = _TranslationsRecipeDetailCa._(_root);
	@override late final _TranslationsFiltersCa filters = _TranslationsFiltersCa._(_root);
	@override late final _TranslationsShoppingListCa shoppingList = _TranslationsShoppingListCa._(_root);
	@override late final _TranslationsMealPlanCa mealPlan = _TranslationsMealPlanCa._(_root);
	@override late final _TranslationsInventoryCa inventory = _TranslationsInventoryCa._(_root);
	@override late final _TranslationsBarcodeScanCa barcodeScan = _TranslationsBarcodeScanCa._(_root);
	@override late final _TranslationsReceiptScanCa receiptScan = _TranslationsReceiptScanCa._(_root);
	@override late final _TranslationsBatchCookingCa batchCooking = _TranslationsBatchCookingCa._(_root);
	@override late final _TranslationsVisitedDomainsCa visitedDomains = _TranslationsVisitedDomainsCa._(_root);
	@override late final _TranslationsDomainDiscoveryCa domainDiscovery = _TranslationsDomainDiscoveryCa._(_root);
	@override late final _TranslationsInventorySuggestionsCa inventorySuggestions = _TranslationsInventorySuggestionsCa._(_root);
	@override late final _TranslationsUpgradeCa upgrade = _TranslationsUpgradeCa._(_root);
	@override late final _TranslationsTourCa tour = _TranslationsTourCa._(_root);
	@override late final _TranslationsManualRecipeCa manualRecipe = _TranslationsManualRecipeCa._(_root);
	@override late final _TranslationsRecipeEditCa recipeEdit = _TranslationsRecipeEditCa._(_root);
	@override late final _TranslationsErrorsCa errors = _TranslationsErrorsCa._(_root);
}

// Path: app
class _TranslationsAppCa extends TranslationsAppEn {
	_TranslationsAppCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsCa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsCa measurements = _TranslationsSettingsMeasurementsCa._(_root);
	@override late final _TranslationsSettingsDataManagementCa dataManagement = _TranslationsSettingsDataManagementCa._(_root);
	@override late final _TranslationsSettingsVersionCa version = _TranslationsSettingsVersionCa._(_root);
}

// Path: recipes
class _TranslationsRecipesCa extends TranslationsRecipesEn {
	_TranslationsRecipesCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCa._(TranslationsCa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCa nutrition = _TranslationsRecipeDetailNutritionCa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCa prepAhead = _TranslationsRecipeDetailPrepAheadCa._(_root);
...
// Path: filters
class _TranslationsFiltersCa extends TranslationsFiltersEn {
	_TranslationsFiltersCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCa extends TranslationsShoppingListEn {
	_TranslationsShoppingListCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCa extends TranslationsMealPlanEn {
	_TranslationsMealPlanCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCa extends TranslationsInventoryEn {
	_TranslationsInventoryCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCa extends TranslationsUpgradeEn {
	_TranslationsUpgradeCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCa extends TranslationsTourEn {
	_TranslationsTourCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCa._(TranslationsCa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCa metric = _TranslationsSettingsMeasurementsMetricCa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCa imperial = _TranslationsSettingsMeasurementsImperialCa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCa._(TranslationsCa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCa._(TranslationsCa root) : this._root = root, super.internal(root);
