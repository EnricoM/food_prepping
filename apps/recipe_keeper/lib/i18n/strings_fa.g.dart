...
class TranslationsFa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppFa app = _TranslationsAppFa._(_root);
	...
	@override late final _TranslationsRecipesFa recipes = _TranslationsRecipesFa._(_root);
	@override late final _TranslationsRecipeDetailFa recipeDetail = _TranslationsRecipeDetailFa._(_root);
	@override late final _TranslationsFiltersFa filters = _TranslationsFiltersFa._(_root);
	@override late final _TranslationsShoppingListFa shoppingList = _TranslationsShoppingListFa._(_root);
	@override late final _TranslationsMealPlanFa mealPlan = _TranslationsMealPlanFa._(_root);
	@override late final _TranslationsInventoryFa inventory = _TranslationsInventoryFa._(_root);
	@override late final _TranslationsBarcodeScanFa barcodeScan = _TranslationsBarcodeScanFa._(_root);
	@override late final _TranslationsReceiptScanFa receiptScan = _TranslationsReceiptScanFa._(_root);
	@override late final _TranslationsBatchCookingFa batchCooking = _TranslationsBatchCookingFa._(_root);
	@override late final _TranslationsVisitedDomainsFa visitedDomains = _TranslationsVisitedDomainsFa._(_root);
	@override late final _TranslationsDomainDiscoveryFa domainDiscovery = _TranslationsDomainDiscoveryFa._(_root);
	@override late final _TranslationsInventorySuggestionsFa inventorySuggestions = _TranslationsInventorySuggestionsFa._(_root);
	@override late final _TranslationsUpgradeFa upgrade = _TranslationsUpgradeFa._(_root);
	@override late final _TranslationsTourFa tour = _TranslationsTourFa._(_root);
	@override late final _TranslationsManualRecipeFa manualRecipe = _TranslationsManualRecipeFa._(_root);
	@override late final _TranslationsRecipeEditFa recipeEdit = _TranslationsRecipeEditFa._(_root);
	@override late final _TranslationsErrorsFa errors = _TranslationsErrorsFa._(_root);
}

// Path: app
class _TranslationsAppFa extends TranslationsAppEn {
	_TranslationsAppFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsFa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsFa measurements = _TranslationsSettingsMeasurementsFa._(_root);
	@override late final _TranslationsSettingsDataManagementFa dataManagement = _TranslationsSettingsDataManagementFa._(_root);
	@override late final _TranslationsSettingsVersionFa version = _TranslationsSettingsVersionFa._(_root);
}

// Path: recipes
class _TranslationsRecipesFa extends TranslationsRecipesEn {
	_TranslationsRecipesFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFa._(TranslationsFa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFa nutrition = _TranslationsRecipeDetailNutritionFa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFa prepAhead = _TranslationsRecipeDetailPrepAheadFa._(_root);
...
// Path: filters
class _TranslationsFiltersFa extends TranslationsFiltersEn {
	_TranslationsFiltersFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFa extends TranslationsShoppingListEn {
	_TranslationsShoppingListFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFa extends TranslationsMealPlanEn {
	_TranslationsMealPlanFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFa extends TranslationsInventoryEn {
	_TranslationsInventoryFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFa extends TranslationsUpgradeEn {
	_TranslationsUpgradeFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFa extends TranslationsTourEn {
	_TranslationsTourFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFa._(TranslationsFa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFa metric = _TranslationsSettingsMeasurementsMetricFa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFa imperial = _TranslationsSettingsMeasurementsImperialFa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFa._(TranslationsFa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFa._(TranslationsFa root) : this._root = root, super.internal(root);
