...
// Path: <root>
class TranslationsRn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsRn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <rn>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsRn _root = this; // ignore: unused_field

	@override 
	TranslationsRn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsRn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppRn app = _TranslationsAppRn._(_root);
	@override late final _TranslationsHomeRn home = _TranslationsHomeRn._(_root);
	@override late final _TranslationsCommonRn common = _TranslationsCommonRn._(_root);
	@override late final _TranslationsSettingsRn settings = _TranslationsSettingsRn._(_root);
	@override late final _TranslationsRecipesRn recipes = _TranslationsRecipesRn._(_root);
	@override late final _TranslationsRecipeDetailRn recipeDetail = _TranslationsRecipeDetailRn._(_root);
	@override late final _TranslationsFiltersRn filters = _TranslationsFiltersRn._(_root);
	@override late final _TranslationsShoppingListRn shoppingList = _TranslationsShoppingListRn._(_root);
	@override late final _TranslationsMealPlanRn mealPlan = _TranslationsMealPlanRn._(_root);
	@override late final _TranslationsInventoryRn inventory = _TranslationsInventoryRn._(_root);
	@override late final _TranslationsBarcodeScanRn barcodeScan = _TranslationsBarcodeScanRn._(_root);
	@override late final _TranslationsReceiptScanRn receiptScan = _TranslationsReceiptScanRn._(_root);
	@override late final _TranslationsBatchCookingRn batchCooking = _TranslationsBatchCookingRn._(_root);
	@override late final _TranslationsVisitedDomainsRn visitedDomains = _TranslationsVisitedDomainsRn._(_root);
	@override late final _TranslationsDomainDiscoveryRn domainDiscovery = _TranslationsDomainDiscoveryRn._(_root);
	@override late final _TranslationsInventorySuggestionsRn inventorySuggestions = _TranslationsInventorySuggestionsRn._(_root);
	@override late final _TranslationsUpgradeRn upgrade = _TranslationsUpgradeRn._(_root);
	@override late final _TranslationsTourRn tour = _TranslationsTourRn._(_root);
	@override late final _TranslationsManualRecipeRn manualRecipe = _TranslationsManualRecipeRn._(_root);
	@override late final _TranslationsRecipeEditRn recipeEdit = _TranslationsRecipeEditRn._(_root);
	@override late final _TranslationsErrorsRn errors = _TranslationsErrorsRn._(_root);
}

// Path: app
class _TranslationsAppRn extends TranslationsAppEn {
	_TranslationsAppRn._(TranslationsRn root) : this._root = root, super.internal(root);

	final TranslationsRn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeRn extends TranslationsHomeEn {
	_TranslationsHomeRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonRn extends TranslationsCommonEn {
	_TranslationsCommonRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsRn extends TranslationsSettingsEn {
	_TranslationsSettingsRn._(TranslationsRn root) : this._root = root, super.internal(root);

	final TranslationsRn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsRn measurements = _TranslationsSettingsMeasurementsRn._(_root);
	@override late final _TranslationsSettingsDataManagementRn dataManagement = _TranslationsSettingsDataManagementRn._(_root);
	@override late final _TranslationsSettingsVersionRn version = _TranslationsSettingsVersionRn._(_root);
}

// Path: recipes
class _TranslationsRecipesRn extends TranslationsRecipesEn {
	_TranslationsRecipesRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailRn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailRn._(TranslationsRn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionRn nutrition = _TranslationsRecipeDetailNutritionRn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadRn prepAhead = _TranslationsRecipeDetailPrepAheadRn._(_root);
...
// Path: filters
class _TranslationsFiltersRn extends TranslationsFiltersEn {
	_TranslationsFiltersRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListRn extends TranslationsShoppingListEn {
	_TranslationsShoppingListRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanRn extends TranslationsMealPlanEn {
	_TranslationsMealPlanRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryRn extends TranslationsInventoryEn {
	_TranslationsInventoryRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanRn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanRn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingRn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsRn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryRn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsRn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeRn extends TranslationsUpgradeEn {
	_TranslationsUpgradeRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourRn extends TranslationsTourEn {
	_TranslationsTourRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeRn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditRn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsRn extends TranslationsErrorsEn {
	_TranslationsErrorsRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsRn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsRn._(TranslationsRn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricRn metric = _TranslationsSettingsMeasurementsMetricRn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialRn imperial = _TranslationsSettingsMeasurementsImperialRn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementRn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionRn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionRn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadRn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricRn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialRn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialRn._(TranslationsRn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <rn>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsRn {
