...
class TranslationsFaIr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppFaIr app = _TranslationsAppFaIr._(_root);
	@override late final _TranslationsHomeFaIr home = _TranslationsHomeFaIr._(_root);
	@override late final _TranslationsCommonFaIr common = _TranslationsCommonFaIr._(_root);
	@override late final _TranslationsSettingsFaIr settings = _TranslationsSettingsFaIr._(_root);
	@override late final _TranslationsRecipesFaIr recipes = _TranslationsRecipesFaIr._(_root);
	@override late final _TranslationsRecipeDetailFaIr recipeDetail = _TranslationsRecipeDetailFaIr._(_root);
	@override late final _TranslationsFiltersFaIr filters = _TranslationsFiltersFaIr._(_root);
	@override late final _TranslationsShoppingListFaIr shoppingList = _TranslationsShoppingListFaIr._(_root);
	@override late final _TranslationsMealPlanFaIr mealPlan = _TranslationsMealPlanFaIr._(_root);
	@override late final _TranslationsInventoryFaIr inventory = _TranslationsInventoryFaIr._(_root);
	@override late final _TranslationsBarcodeScanFaIr barcodeScan = _TranslationsBarcodeScanFaIr._(_root);
	@override late final _TranslationsReceiptScanFaIr receiptScan = _TranslationsReceiptScanFaIr._(_root);
	@override late final _TranslationsBatchCookingFaIr batchCooking = _TranslationsBatchCookingFaIr._(_root);
	@override late final _TranslationsVisitedDomainsFaIr visitedDomains = _TranslationsVisitedDomainsFaIr._(_root);
	@override late final _TranslationsDomainDiscoveryFaIr domainDiscovery = _TranslationsDomainDiscoveryFaIr._(_root);
	@override late final _TranslationsInventorySuggestionsFaIr inventorySuggestions = _TranslationsInventorySuggestionsFaIr._(_root);
	@override late final _TranslationsUpgradeFaIr upgrade = _TranslationsUpgradeFaIr._(_root);
	@override late final _TranslationsTourFaIr tour = _TranslationsTourFaIr._(_root);
	@override late final _TranslationsManualRecipeFaIr manualRecipe = _TranslationsManualRecipeFaIr._(_root);
	@override late final _TranslationsRecipeEditFaIr recipeEdit = _TranslationsRecipeEditFaIr._(_root);
	@override late final _TranslationsErrorsFaIr errors = _TranslationsErrorsFaIr._(_root);
}

// Path: app
class _TranslationsAppFaIr extends TranslationsAppEn {
	_TranslationsAppFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);

	final TranslationsFaIr _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeFaIr extends TranslationsHomeEn {
	_TranslationsHomeFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonFaIr extends TranslationsCommonEn {
	_TranslationsCommonFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsFaIr extends TranslationsSettingsEn {
	_TranslationsSettingsFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);

	final TranslationsFaIr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsFaIr measurements = _TranslationsSettingsMeasurementsFaIr._(_root);
	@override late final _TranslationsSettingsDataManagementFaIr dataManagement = _TranslationsSettingsDataManagementFaIr._(_root);
	@override late final _TranslationsSettingsVersionFaIr version = _TranslationsSettingsVersionFaIr._(_root);
}

// Path: recipes
class _TranslationsRecipesFaIr extends TranslationsRecipesEn {
	_TranslationsRecipesFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFaIr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFaIr nutrition = _TranslationsRecipeDetailNutritionFaIr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFaIr prepAhead = _TranslationsRecipeDetailPrepAheadFaIr._(_root);
...
// Path: filters
class _TranslationsFiltersFaIr extends TranslationsFiltersEn {
	_TranslationsFiltersFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFaIr extends TranslationsShoppingListEn {
	_TranslationsShoppingListFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFaIr extends TranslationsMealPlanEn {
	_TranslationsMealPlanFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFaIr extends TranslationsInventoryEn {
	_TranslationsInventoryFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFaIr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFaIr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFaIr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFaIr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFaIr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFaIr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFaIr extends TranslationsUpgradeEn {
	_TranslationsUpgradeFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFaIr extends TranslationsTourEn {
	_TranslationsTourFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFaIr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFaIr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsFaIr extends TranslationsErrorsEn {
	_TranslationsErrorsFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFaIr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFaIr metric = _TranslationsSettingsMeasurementsMetricFaIr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFaIr imperial = _TranslationsSettingsMeasurementsImperialFaIr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFaIr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFaIr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFaIr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFaIr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFaIr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFaIr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFaIr._(TranslationsFaIr root) : this._root = root, super.internal(root);
