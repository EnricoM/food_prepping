...
class TranslationsAz extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppAz app = _TranslationsAppAz._(_root);
	@override late final _TranslationsHomeAz home = _TranslationsHomeAz._(_root);
	@override late final _TranslationsCommonAz common = _TranslationsCommonAz._(_root);
	@override late final _TranslationsSettingsAz settings = _TranslationsSettingsAz._(_root);
	@override late final _TranslationsRecipesAz recipes = _TranslationsRecipesAz._(_root);
	@override late final _TranslationsRecipeDetailAz recipeDetail = _TranslationsRecipeDetailAz._(_root);
	@override late final _TranslationsFiltersAz filters = _TranslationsFiltersAz._(_root);
	@override late final _TranslationsShoppingListAz shoppingList = _TranslationsShoppingListAz._(_root);
	@override late final _TranslationsMealPlanAz mealPlan = _TranslationsMealPlanAz._(_root);
	@override late final _TranslationsInventoryAz inventory = _TranslationsInventoryAz._(_root);
	@override late final _TranslationsBarcodeScanAz barcodeScan = _TranslationsBarcodeScanAz._(_root);
	@override late final _TranslationsReceiptScanAz receiptScan = _TranslationsReceiptScanAz._(_root);
	@override late final _TranslationsBatchCookingAz batchCooking = _TranslationsBatchCookingAz._(_root);
	@override late final _TranslationsVisitedDomainsAz visitedDomains = _TranslationsVisitedDomainsAz._(_root);
	@override late final _TranslationsDomainDiscoveryAz domainDiscovery = _TranslationsDomainDiscoveryAz._(_root);
	@override late final _TranslationsInventorySuggestionsAz inventorySuggestions = _TranslationsInventorySuggestionsAz._(_root);
	@override late final _TranslationsUpgradeAz upgrade = _TranslationsUpgradeAz._(_root);
	@override late final _TranslationsTourAz tour = _TranslationsTourAz._(_root);
	@override late final _TranslationsManualRecipeAz manualRecipe = _TranslationsManualRecipeAz._(_root);
	@override late final _TranslationsRecipeEditAz recipeEdit = _TranslationsRecipeEditAz._(_root);
	@override late final _TranslationsErrorsAz errors = _TranslationsErrorsAz._(_root);
}

// Path: app
class _TranslationsAppAz extends TranslationsAppEn {
	_TranslationsAppAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeAz extends TranslationsHomeEn {
	_TranslationsHomeAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAz extends TranslationsCommonEn {
	_TranslationsCommonAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAz extends TranslationsSettingsEn {
	_TranslationsSettingsAz._(TranslationsAz root) : this._root = root, super.internal(root);

	final TranslationsAz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAz measurements = _TranslationsSettingsMeasurementsAz._(_root);
	@override late final _TranslationsSettingsDataManagementAz dataManagement = _TranslationsSettingsDataManagementAz._(_root);
	@override late final _TranslationsSettingsVersionAz version = _TranslationsSettingsVersionAz._(_root);
}

// Path: recipes
class _TranslationsRecipesAz extends TranslationsRecipesEn {
	_TranslationsRecipesAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAz._(TranslationsAz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAz nutrition = _TranslationsRecipeDetailNutritionAz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAz prepAhead = _TranslationsRecipeDetailPrepAheadAz._(_root);
...
// Path: filters
class _TranslationsFiltersAz extends TranslationsFiltersEn {
	_TranslationsFiltersAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAz extends TranslationsShoppingListEn {
	_TranslationsShoppingListAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAz extends TranslationsMealPlanEn {
	_TranslationsMealPlanAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAz extends TranslationsInventoryEn {
	_TranslationsInventoryAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAz extends TranslationsUpgradeEn {
	_TranslationsUpgradeAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAz extends TranslationsTourEn {
	_TranslationsTourAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAz extends TranslationsErrorsEn {
	_TranslationsErrorsAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAz._(TranslationsAz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAz metric = _TranslationsSettingsMeasurementsMetricAz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAz imperial = _TranslationsSettingsMeasurementsImperialAz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAz._(TranslationsAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAz._(TranslationsAz root) : this._root = root, super.internal(root);
