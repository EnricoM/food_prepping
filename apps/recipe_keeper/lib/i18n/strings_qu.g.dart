...
// Path: <root>
class TranslationsQu extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsQu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <qu>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsQu _root = this; // ignore: unused_field

	@override 
	TranslationsQu $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsQu(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppQu app = _TranslationsAppQu._(_root);
	@override late final _TranslationsHomeQu home = _TranslationsHomeQu._(_root);
	@override late final _TranslationsCommonQu common = _TranslationsCommonQu._(_root);
	@override late final _TranslationsSettingsQu settings = _TranslationsSettingsQu._(_root);
	@override late final _TranslationsRecipesQu recipes = _TranslationsRecipesQu._(_root);
	@override late final _TranslationsRecipeDetailQu recipeDetail = _TranslationsRecipeDetailQu._(_root);
	@override late final _TranslationsFiltersQu filters = _TranslationsFiltersQu._(_root);
	@override late final _TranslationsShoppingListQu shoppingList = _TranslationsShoppingListQu._(_root);
	@override late final _TranslationsMealPlanQu mealPlan = _TranslationsMealPlanQu._(_root);
	@override late final _TranslationsInventoryQu inventory = _TranslationsInventoryQu._(_root);
	@override late final _TranslationsBarcodeScanQu barcodeScan = _TranslationsBarcodeScanQu._(_root);
	@override late final _TranslationsReceiptScanQu receiptScan = _TranslationsReceiptScanQu._(_root);
	@override late final _TranslationsBatchCookingQu batchCooking = _TranslationsBatchCookingQu._(_root);
	@override late final _TranslationsVisitedDomainsQu visitedDomains = _TranslationsVisitedDomainsQu._(_root);
	@override late final _TranslationsDomainDiscoveryQu domainDiscovery = _TranslationsDomainDiscoveryQu._(_root);
	@override late final _TranslationsInventorySuggestionsQu inventorySuggestions = _TranslationsInventorySuggestionsQu._(_root);
	@override late final _TranslationsUpgradeQu upgrade = _TranslationsUpgradeQu._(_root);
	@override late final _TranslationsTourQu tour = _TranslationsTourQu._(_root);
	@override late final _TranslationsManualRecipeQu manualRecipe = _TranslationsManualRecipeQu._(_root);
	@override late final _TranslationsRecipeEditQu recipeEdit = _TranslationsRecipeEditQu._(_root);
	@override late final _TranslationsErrorsQu errors = _TranslationsErrorsQu._(_root);
}

// Path: app
class _TranslationsAppQu extends TranslationsAppEn {
	_TranslationsAppQu._(TranslationsQu root) : this._root = root, super.internal(root);

	final TranslationsQu _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeQu extends TranslationsHomeEn {
	_TranslationsHomeQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonQu extends TranslationsCommonEn {
	_TranslationsCommonQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsQu extends TranslationsSettingsEn {
	_TranslationsSettingsQu._(TranslationsQu root) : this._root = root, super.internal(root);

	final TranslationsQu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsQu measurements = _TranslationsSettingsMeasurementsQu._(_root);
	@override late final _TranslationsSettingsDataManagementQu dataManagement = _TranslationsSettingsDataManagementQu._(_root);
	@override late final _TranslationsSettingsVersionQu version = _TranslationsSettingsVersionQu._(_root);
}

// Path: recipes
class _TranslationsRecipesQu extends TranslationsRecipesEn {
	_TranslationsRecipesQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailQu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailQu._(TranslationsQu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionQu nutrition = _TranslationsRecipeDetailNutritionQu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadQu prepAhead = _TranslationsRecipeDetailPrepAheadQu._(_root);
...
// Path: filters
class _TranslationsFiltersQu extends TranslationsFiltersEn {
	_TranslationsFiltersQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListQu extends TranslationsShoppingListEn {
	_TranslationsShoppingListQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanQu extends TranslationsMealPlanEn {
	_TranslationsMealPlanQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryQu extends TranslationsInventoryEn {
	_TranslationsInventoryQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanQu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanQu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingQu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsQu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryQu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsQu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeQu extends TranslationsUpgradeEn {
	_TranslationsUpgradeQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourQu extends TranslationsTourEn {
	_TranslationsTourQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeQu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditQu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsQu extends TranslationsErrorsEn {
	_TranslationsErrorsQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsQu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsQu._(TranslationsQu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricQu metric = _TranslationsSettingsMeasurementsMetricQu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialQu imperial = _TranslationsSettingsMeasurementsImperialQu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementQu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionQu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionQu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadQu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricQu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialQu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialQu._(TranslationsQu root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <qu>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsQu {
