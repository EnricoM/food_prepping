...
// Path: <root>
class TranslationsEnGb extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsEnGb({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	@override 
	TranslationsEnGb $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsEnGb(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppEnGb app = _TranslationsAppEnGb._(_root);
	@override late final _TranslationsHomeEnGb home = _TranslationsHomeEnGb._(_root);
	@override late final _TranslationsCommonEnGb common = _TranslationsCommonEnGb._(_root);
	@override late final _TranslationsSettingsEnGb settings = _TranslationsSettingsEnGb._(_root);
	@override late final _TranslationsRecipesEnGb recipes = _TranslationsRecipesEnGb._(_root);
	@override late final _TranslationsRecipeDetailEnGb recipeDetail = _TranslationsRecipeDetailEnGb._(_root);
	@override late final _TranslationsFiltersEnGb filters = _TranslationsFiltersEnGb._(_root);
	@override late final _TranslationsShoppingListEnGb shoppingList = _TranslationsShoppingListEnGb._(_root);
	@override late final _TranslationsMealPlanEnGb mealPlan = _TranslationsMealPlanEnGb._(_root);
	@override late final _TranslationsInventoryEnGb inventory = _TranslationsInventoryEnGb._(_root);
	@override late final _TranslationsBarcodeScanEnGb barcodeScan = _TranslationsBarcodeScanEnGb._(_root);
	@override late final _TranslationsReceiptScanEnGb receiptScan = _TranslationsReceiptScanEnGb._(_root);
	@override late final _TranslationsBatchCookingEnGb batchCooking = _TranslationsBatchCookingEnGb._(_root);
	@override late final _TranslationsVisitedDomainsEnGb visitedDomains = _TranslationsVisitedDomainsEnGb._(_root);
	@override late final _TranslationsDomainDiscoveryEnGb domainDiscovery = _TranslationsDomainDiscoveryEnGb._(_root);
	@override late final _TranslationsInventorySuggestionsEnGb inventorySuggestions = _TranslationsInventorySuggestionsEnGb._(_root);
	@override late final _TranslationsUpgradeEnGb upgrade = _TranslationsUpgradeEnGb._(_root);
	@override late final _TranslationsTourEnGb tour = _TranslationsTourEnGb._(_root);
	@override late final _TranslationsManualRecipeEnGb manualRecipe = _TranslationsManualRecipeEnGb._(_root);
	@override late final _TranslationsRecipeEditEnGb recipeEdit = _TranslationsRecipeEditEnGb._(_root);
	@override late final _TranslationsErrorsEnGb errors = _TranslationsErrorsEnGb._(_root);
}

// Path: app
class _TranslationsAppEnGb extends TranslationsAppEn {
	_TranslationsAppEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeEnGb extends TranslationsHomeEn {
	_TranslationsHomeEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEnGb extends TranslationsCommonEn {
	_TranslationsCommonEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEnGb extends TranslationsSettingsEn {
	_TranslationsSettingsEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);

	final TranslationsEnGb _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEnGb measurements = _TranslationsSettingsMeasurementsEnGb._(_root);
	@override late final _TranslationsSettingsDataManagementEnGb dataManagement = _TranslationsSettingsDataManagementEnGb._(_root);
	@override late final _TranslationsSettingsVersionEnGb version = _TranslationsSettingsVersionEnGb._(_root);
}

// Path: recipes
class _TranslationsRecipesEnGb extends TranslationsRecipesEn {
	_TranslationsRecipesEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEnGb extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEnGb nutrition = _TranslationsRecipeDetailNutritionEnGb._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEnGb prepAhead = _TranslationsRecipeDetailPrepAheadEnGb._(_root);
...
// Path: filters
class _TranslationsFiltersEnGb extends TranslationsFiltersEn {
	_TranslationsFiltersEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEnGb extends TranslationsShoppingListEn {
	_TranslationsShoppingListEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEnGb extends TranslationsMealPlanEn {
	_TranslationsMealPlanEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEnGb extends TranslationsInventoryEn {
	_TranslationsInventoryEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEnGb extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEnGb extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEnGb extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEnGb extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEnGb extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEnGb extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEnGb extends TranslationsUpgradeEn {
	_TranslationsUpgradeEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEnGb extends TranslationsTourEn {
	_TranslationsTourEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEnGb extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEnGb extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEnGb extends TranslationsErrorsEn {
	_TranslationsErrorsEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEnGb extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEnGb metric = _TranslationsSettingsMeasurementsMetricEnGb._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEnGb imperial = _TranslationsSettingsMeasurementsImperialEnGb._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEnGb extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEnGb extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEnGb extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEnGb extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEnGb extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEnGb extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEnGb._(TranslationsEnGb root) : this._root = root, super.internal(root);
