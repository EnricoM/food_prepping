...
class TranslationsEu extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	TranslationsEu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	// Translations
	@override late final _TranslationsAppEu app = _TranslationsAppEu._(_root);
	@override late final _TranslationsHomeEu home = _TranslationsHomeEu._(_root);
	@override late final _TranslationsCommonEu common = _TranslationsCommonEu._(_root);
	@override late final _TranslationsSettingsEu settings = _TranslationsSettingsEu._(_root);
	@override late final _TranslationsRecipesEu recipes = _TranslationsRecipesEu._(_root);
	@override late final _TranslationsRecipeDetailEu recipeDetail = _TranslationsRecipeDetailEu._(_root);
	@override late final _TranslationsFiltersEu filters = _TranslationsFiltersEu._(_root);
	@override late final _TranslationsShoppingListEu shoppingList = _TranslationsShoppingListEu._(_root);
	@override late final _TranslationsMealPlanEu mealPlan = _TranslationsMealPlanEu._(_root);
	@override late final _TranslationsInventoryEu inventory = _TranslationsInventoryEu._(_root);
	@override late final _TranslationsBarcodeScanEu barcodeScan = _TranslationsBarcodeScanEu._(_root);
	@override late final _TranslationsReceiptScanEu receiptScan = _TranslationsReceiptScanEu._(_root);
	@override late final _TranslationsBatchCookingEu batchCooking = _TranslationsBatchCookingEu._(_root);
	@override late final _TranslationsVisitedDomainsEu visitedDomains = _TranslationsVisitedDomainsEu._(_root);
	@override late final _TranslationsDomainDiscoveryEu domainDiscovery = _TranslationsDomainDiscoveryEu._(_root);
	@override late final _TranslationsInventorySuggestionsEu inventorySuggestions = _TranslationsInventorySuggestionsEu._(_root);
	@override late final _TranslationsUpgradeEu upgrade = _TranslationsUpgradeEu._(_root);
	@override late final _TranslationsTourEu tour = _TranslationsTourEu._(_root);
	@override late final _TranslationsManualRecipeEu manualRecipe = _TranslationsManualRecipeEu._(_root);
	@override late final _TranslationsRecipeEditEu recipeEdit = _TranslationsRecipeEditEu._(_root);
	@override late final _TranslationsErrorsEu errors = _TranslationsErrorsEu._(_root);
}

// Path: app
class _TranslationsAppEu extends TranslationsAppEn {
	_TranslationsAppEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeEu extends TranslationsHomeEn {
	_TranslationsHomeEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEu extends TranslationsCommonEn {
	_TranslationsCommonEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEu extends TranslationsSettingsEn {
	_TranslationsSettingsEu._(TranslationsEu root) : this._root = root, super.internal(root);

	final TranslationsEu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEu measurements = _TranslationsSettingsMeasurementsEu._(_root);
	@override late final _TranslationsSettingsDataManagementEu dataManagement = _TranslationsSettingsDataManagementEu._(_root);
	@override late final _TranslationsSettingsVersionEu version = _TranslationsSettingsVersionEu._(_root);
}

// Path: recipes
class _TranslationsRecipesEu extends TranslationsRecipesEn {
	_TranslationsRecipesEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEu._(TranslationsEu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEu nutrition = _TranslationsRecipeDetailNutritionEu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEu prepAhead = _TranslationsRecipeDetailPrepAheadEu._(_root);
...
// Path: filters
class _TranslationsFiltersEu extends TranslationsFiltersEn {
	_TranslationsFiltersEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEu extends TranslationsShoppingListEn {
	_TranslationsShoppingListEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEu extends TranslationsMealPlanEn {
	_TranslationsMealPlanEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEu extends TranslationsInventoryEn {
	_TranslationsInventoryEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEu extends TranslationsUpgradeEn {
	_TranslationsUpgradeEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEu extends TranslationsTourEn {
	_TranslationsTourEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEu extends TranslationsErrorsEn {
	_TranslationsErrorsEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEu._(TranslationsEu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEu metric = _TranslationsSettingsMeasurementsMetricEu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEu imperial = _TranslationsSettingsMeasurementsImperialEu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEu._(TranslationsEu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEu._(TranslationsEu root) : this._root = root, super.internal(root);
