...
class TranslationsEt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppEt app = _TranslationsAppEt._(_root);
	@override late final _TranslationsHomeEt home = _TranslationsHomeEt._(_root);
	@override late final _TranslationsCommonEt common = _TranslationsCommonEt._(_root);
	@override late final _TranslationsSettingsEt settings = _TranslationsSettingsEt._(_root);
	@override late final _TranslationsRecipesEt recipes = _TranslationsRecipesEt._(_root);
	@override late final _TranslationsRecipeDetailEt recipeDetail = _TranslationsRecipeDetailEt._(_root);
	@override late final _TranslationsFiltersEt filters = _TranslationsFiltersEt._(_root);
	@override late final _TranslationsShoppingListEt shoppingList = _TranslationsShoppingListEt._(_root);
	@override late final _TranslationsMealPlanEt mealPlan = _TranslationsMealPlanEt._(_root);
	@override late final _TranslationsInventoryEt inventory = _TranslationsInventoryEt._(_root);
	@override late final _TranslationsBarcodeScanEt barcodeScan = _TranslationsBarcodeScanEt._(_root);
	@override late final _TranslationsReceiptScanEt receiptScan = _TranslationsReceiptScanEt._(_root);
	@override late final _TranslationsBatchCookingEt batchCooking = _TranslationsBatchCookingEt._(_root);
	@override late final _TranslationsVisitedDomainsEt visitedDomains = _TranslationsVisitedDomainsEt._(_root);
	@override late final _TranslationsDomainDiscoveryEt domainDiscovery = _TranslationsDomainDiscoveryEt._(_root);
	@override late final _TranslationsInventorySuggestionsEt inventorySuggestions = _TranslationsInventorySuggestionsEt._(_root);
	@override late final _TranslationsUpgradeEt upgrade = _TranslationsUpgradeEt._(_root);
	@override late final _TranslationsTourEt tour = _TranslationsTourEt._(_root);
	@override late final _TranslationsManualRecipeEt manualRecipe = _TranslationsManualRecipeEt._(_root);
	@override late final _TranslationsRecipeEditEt recipeEdit = _TranslationsRecipeEditEt._(_root);
	@override late final _TranslationsErrorsEt errors = _TranslationsErrorsEt._(_root);
}

// Path: app
class _TranslationsAppEt extends TranslationsAppEn {
	_TranslationsAppEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeEt extends TranslationsHomeEn {
	_TranslationsHomeEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEt extends TranslationsCommonEn {
	_TranslationsCommonEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEt extends TranslationsSettingsEn {
	_TranslationsSettingsEt._(TranslationsEt root) : this._root = root, super.internal(root);

	final TranslationsEt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEt measurements = _TranslationsSettingsMeasurementsEt._(_root);
	@override late final _TranslationsSettingsDataManagementEt dataManagement = _TranslationsSettingsDataManagementEt._(_root);
	@override late final _TranslationsSettingsVersionEt version = _TranslationsSettingsVersionEt._(_root);
}

// Path: recipes
class _TranslationsRecipesEt extends TranslationsRecipesEn {
	_TranslationsRecipesEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEt._(TranslationsEt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEt nutrition = _TranslationsRecipeDetailNutritionEt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEt prepAhead = _TranslationsRecipeDetailPrepAheadEt._(_root);
...
// Path: filters
class _TranslationsFiltersEt extends TranslationsFiltersEn {
	_TranslationsFiltersEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEt extends TranslationsShoppingListEn {
	_TranslationsShoppingListEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEt extends TranslationsMealPlanEn {
	_TranslationsMealPlanEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEt extends TranslationsInventoryEn {
	_TranslationsInventoryEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEt extends TranslationsUpgradeEn {
	_TranslationsUpgradeEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEt extends TranslationsTourEn {
	_TranslationsTourEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEt._(TranslationsEt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEt metric = _TranslationsSettingsMeasurementsMetricEt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEt imperial = _TranslationsSettingsMeasurementsImperialEt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEt._(TranslationsEt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEt._(TranslationsEt root) : this._root = root, super.internal(root);
