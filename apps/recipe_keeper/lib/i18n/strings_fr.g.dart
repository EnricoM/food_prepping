...
class TranslationsFr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesFr recipes = _TranslationsRecipesFr._(_root);
	@override late final _TranslationsRecipeDetailFr recipeDetail = _TranslationsRecipeDetailFr._(_root);
	@override late final _TranslationsFiltersFr filters = _TranslationsFiltersFr._(_root);
	@override late final _TranslationsShoppingListFr shoppingList = _TranslationsShoppingListFr._(_root);
	@override late final _TranslationsMealPlanFr mealPlan = _TranslationsMealPlanFr._(_root);
	@override late final _TranslationsInventoryFr inventory = _TranslationsInventoryFr._(_root);
	@override late final _TranslationsBarcodeScanFr barcodeScan = _TranslationsBarcodeScanFr._(_root);
	@override late final _TranslationsReceiptScanFr receiptScan = _TranslationsReceiptScanFr._(_root);
	@override late final _TranslationsBatchCookingFr batchCooking = _TranslationsBatchCookingFr._(_root);
	@override late final _TranslationsVisitedDomainsFr visitedDomains = _TranslationsVisitedDomainsFr._(_root);
	@override late final _TranslationsDomainDiscoveryFr domainDiscovery = _TranslationsDomainDiscoveryFr._(_root);
	@override late final _TranslationsInventorySuggestionsFr inventorySuggestions = _TranslationsInventorySuggestionsFr._(_root);
	@override late final _TranslationsUpgradeFr upgrade = _TranslationsUpgradeFr._(_root);
	@override late final _TranslationsTourFr tour = _TranslationsTourFr._(_root);
	@override late final _TranslationsManualRecipeFr manualRecipe = _TranslationsManualRecipeFr._(_root);
	@override late final _TranslationsRecipeEditFr recipeEdit = _TranslationsRecipeEditFr._(_root);
...
class _TranslationsSettingsFr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsFr measurements = _TranslationsSettingsMeasurementsFr._(_root);
	@override late final _TranslationsSettingsDataManagementFr dataManagement = _TranslationsSettingsDataManagementFr._(_root);
	@override late final _TranslationsSettingsVersionFr version = _TranslationsSettingsVersionFr._(_root);
}

// Path: recipes
class _TranslationsRecipesFr extends TranslationsRecipesEn {
	_TranslationsRecipesFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFr._(TranslationsFr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFr nutrition = _TranslationsRecipeDetailNutritionFr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFr prepAhead = _TranslationsRecipeDetailPrepAheadFr._(_root);
...
// Path: filters
class _TranslationsFiltersFr extends TranslationsFiltersEn {
	_TranslationsFiltersFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFr extends TranslationsShoppingListEn {
	_TranslationsShoppingListFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFr extends TranslationsMealPlanEn {
	_TranslationsMealPlanFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFr extends TranslationsInventoryEn {
	_TranslationsInventoryFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFr extends TranslationsUpgradeEn {
	_TranslationsUpgradeFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFr extends TranslationsTourEn {
	_TranslationsTourFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFr._(TranslationsFr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFr metric = _TranslationsSettingsMeasurementsMetricFr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFr imperial = _TranslationsSettingsMeasurementsImperialFr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFr._(TranslationsFr root) : this._root = root, super.internal(root);
