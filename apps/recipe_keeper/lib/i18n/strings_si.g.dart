...
class TranslationsSi extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	TranslationsSi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	// Translations
	@override late final _TranslationsAppSi app = _TranslationsAppSi._(_root);
	@override late final _TranslationsHomeSi home = _TranslationsHomeSi._(_root);
	@override late final _TranslationsCommonSi common = _TranslationsCommonSi._(_root);
	@override late final _TranslationsSettingsSi settings = _TranslationsSettingsSi._(_root);
	@override late final _TranslationsRecipesSi recipes = _TranslationsRecipesSi._(_root);
	@override late final _TranslationsRecipeDetailSi recipeDetail = _TranslationsRecipeDetailSi._(_root);
	@override late final _TranslationsFiltersSi filters = _TranslationsFiltersSi._(_root);
	@override late final _TranslationsShoppingListSi shoppingList = _TranslationsShoppingListSi._(_root);
	@override late final _TranslationsMealPlanSi mealPlan = _TranslationsMealPlanSi._(_root);
	@override late final _TranslationsInventorySi inventory = _TranslationsInventorySi._(_root);
	@override late final _TranslationsBarcodeScanSi barcodeScan = _TranslationsBarcodeScanSi._(_root);
	@override late final _TranslationsReceiptScanSi receiptScan = _TranslationsReceiptScanSi._(_root);
	@override late final _TranslationsBatchCookingSi batchCooking = _TranslationsBatchCookingSi._(_root);
	@override late final _TranslationsVisitedDomainsSi visitedDomains = _TranslationsVisitedDomainsSi._(_root);
	@override late final _TranslationsDomainDiscoverySi domainDiscovery = _TranslationsDomainDiscoverySi._(_root);
	@override late final _TranslationsInventorySuggestionsSi inventorySuggestions = _TranslationsInventorySuggestionsSi._(_root);
	@override late final _TranslationsUpgradeSi upgrade = _TranslationsUpgradeSi._(_root);
	@override late final _TranslationsTourSi tour = _TranslationsTourSi._(_root);
	@override late final _TranslationsManualRecipeSi manualRecipe = _TranslationsManualRecipeSi._(_root);
	@override late final _TranslationsRecipeEditSi recipeEdit = _TranslationsRecipeEditSi._(_root);
	@override late final _TranslationsErrorsSi errors = _TranslationsErrorsSi._(_root);
}

// Path: app
class _TranslationsAppSi extends TranslationsAppEn {
	_TranslationsAppSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeSi extends TranslationsHomeEn {
	_TranslationsHomeSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSi extends TranslationsCommonEn {
	_TranslationsCommonSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSi extends TranslationsSettingsEn {
	_TranslationsSettingsSi._(TranslationsSi root) : this._root = root, super.internal(root);

	final TranslationsSi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSi measurements = _TranslationsSettingsMeasurementsSi._(_root);
	@override late final _TranslationsSettingsDataManagementSi dataManagement = _TranslationsSettingsDataManagementSi._(_root);
	@override late final _TranslationsSettingsVersionSi version = _TranslationsSettingsVersionSi._(_root);
}

// Path: recipes
class _TranslationsRecipesSi extends TranslationsRecipesEn {
	_TranslationsRecipesSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSi._(TranslationsSi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSi nutrition = _TranslationsRecipeDetailNutritionSi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSi prepAhead = _TranslationsRecipeDetailPrepAheadSi._(_root);
...
// Path: filters
class _TranslationsFiltersSi extends TranslationsFiltersEn {
	_TranslationsFiltersSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSi extends TranslationsShoppingListEn {
	_TranslationsShoppingListSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSi extends TranslationsMealPlanEn {
	_TranslationsMealPlanSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySi extends TranslationsInventoryEn {
	_TranslationsInventorySi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSi extends TranslationsUpgradeEn {
	_TranslationsUpgradeSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSi extends TranslationsTourEn {
	_TranslationsTourSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSi extends TranslationsErrorsEn {
	_TranslationsErrorsSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSi._(TranslationsSi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSi metric = _TranslationsSettingsMeasurementsMetricSi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSi imperial = _TranslationsSettingsMeasurementsImperialSi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSi._(TranslationsSi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSi._(TranslationsSi root) : this._root = root, super.internal(root);
