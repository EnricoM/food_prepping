...
// Path: <root>
class TranslationsVo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsVo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <vo>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsVo _root = this; // ignore: unused_field

	@override 
	TranslationsVo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsVo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppVo app = _TranslationsAppVo._(_root);
	@override late final _TranslationsHomeVo home = _TranslationsHomeVo._(_root);
	@override late final _TranslationsCommonVo common = _TranslationsCommonVo._(_root);
	@override late final _TranslationsSettingsVo settings = _TranslationsSettingsVo._(_root);
	@override late final _TranslationsRecipesVo recipes = _TranslationsRecipesVo._(_root);
	@override late final _TranslationsRecipeDetailVo recipeDetail = _TranslationsRecipeDetailVo._(_root);
	@override late final _TranslationsFiltersVo filters = _TranslationsFiltersVo._(_root);
	@override late final _TranslationsShoppingListVo shoppingList = _TranslationsShoppingListVo._(_root);
	@override late final _TranslationsMealPlanVo mealPlan = _TranslationsMealPlanVo._(_root);
	@override late final _TranslationsInventoryVo inventory = _TranslationsInventoryVo._(_root);
	@override late final _TranslationsBarcodeScanVo barcodeScan = _TranslationsBarcodeScanVo._(_root);
	@override late final _TranslationsReceiptScanVo receiptScan = _TranslationsReceiptScanVo._(_root);
	@override late final _TranslationsBatchCookingVo batchCooking = _TranslationsBatchCookingVo._(_root);
	@override late final _TranslationsVisitedDomainsVo visitedDomains = _TranslationsVisitedDomainsVo._(_root);
	@override late final _TranslationsDomainDiscoveryVo domainDiscovery = _TranslationsDomainDiscoveryVo._(_root);
	@override late final _TranslationsInventorySuggestionsVo inventorySuggestions = _TranslationsInventorySuggestionsVo._(_root);
	@override late final _TranslationsUpgradeVo upgrade = _TranslationsUpgradeVo._(_root);
	@override late final _TranslationsTourVo tour = _TranslationsTourVo._(_root);
	@override late final _TranslationsManualRecipeVo manualRecipe = _TranslationsManualRecipeVo._(_root);
	@override late final _TranslationsRecipeEditVo recipeEdit = _TranslationsRecipeEditVo._(_root);
	@override late final _TranslationsErrorsVo errors = _TranslationsErrorsVo._(_root);
}

// Path: app
class _TranslationsAppVo extends TranslationsAppEn {
	_TranslationsAppVo._(TranslationsVo root) : this._root = root, super.internal(root);

	final TranslationsVo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeVo extends TranslationsHomeEn {
	_TranslationsHomeVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonVo extends TranslationsCommonEn {
	_TranslationsCommonVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsVo extends TranslationsSettingsEn {
	_TranslationsSettingsVo._(TranslationsVo root) : this._root = root, super.internal(root);

	final TranslationsVo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsVo measurements = _TranslationsSettingsMeasurementsVo._(_root);
	@override late final _TranslationsSettingsDataManagementVo dataManagement = _TranslationsSettingsDataManagementVo._(_root);
	@override late final _TranslationsSettingsVersionVo version = _TranslationsSettingsVersionVo._(_root);
}

// Path: recipes
class _TranslationsRecipesVo extends TranslationsRecipesEn {
	_TranslationsRecipesVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailVo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailVo._(TranslationsVo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionVo nutrition = _TranslationsRecipeDetailNutritionVo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadVo prepAhead = _TranslationsRecipeDetailPrepAheadVo._(_root);
...
// Path: filters
class _TranslationsFiltersVo extends TranslationsFiltersEn {
	_TranslationsFiltersVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListVo extends TranslationsShoppingListEn {
	_TranslationsShoppingListVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanVo extends TranslationsMealPlanEn {
	_TranslationsMealPlanVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryVo extends TranslationsInventoryEn {
	_TranslationsInventoryVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanVo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanVo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingVo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsVo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryVo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsVo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeVo extends TranslationsUpgradeEn {
	_TranslationsUpgradeVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourVo extends TranslationsTourEn {
	_TranslationsTourVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeVo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditVo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsVo extends TranslationsErrorsEn {
	_TranslationsErrorsVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsVo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsVo._(TranslationsVo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricVo metric = _TranslationsSettingsMeasurementsMetricVo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialVo imperial = _TranslationsSettingsMeasurementsImperialVo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementVo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionVo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionVo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadVo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricVo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialVo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialVo._(TranslationsVo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <vo>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsVo {
