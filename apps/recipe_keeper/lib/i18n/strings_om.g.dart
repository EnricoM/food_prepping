...
// Path: <root>
class TranslationsOm extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsOm({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <om>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsOm _root = this; // ignore: unused_field

	@override 
	TranslationsOm $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsOm(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppOm app = _TranslationsAppOm._(_root);
	@override late final _TranslationsHomeOm home = _TranslationsHomeOm._(_root);
	@override late final _TranslationsCommonOm common = _TranslationsCommonOm._(_root);
	@override late final _TranslationsSettingsOm settings = _TranslationsSettingsOm._(_root);
	@override late final _TranslationsRecipesOm recipes = _TranslationsRecipesOm._(_root);
	@override late final _TranslationsRecipeDetailOm recipeDetail = _TranslationsRecipeDetailOm._(_root);
	@override late final _TranslationsFiltersOm filters = _TranslationsFiltersOm._(_root);
	@override late final _TranslationsShoppingListOm shoppingList = _TranslationsShoppingListOm._(_root);
	@override late final _TranslationsMealPlanOm mealPlan = _TranslationsMealPlanOm._(_root);
	@override late final _TranslationsInventoryOm inventory = _TranslationsInventoryOm._(_root);
	@override late final _TranslationsBarcodeScanOm barcodeScan = _TranslationsBarcodeScanOm._(_root);
	@override late final _TranslationsReceiptScanOm receiptScan = _TranslationsReceiptScanOm._(_root);
	@override late final _TranslationsBatchCookingOm batchCooking = _TranslationsBatchCookingOm._(_root);
	@override late final _TranslationsVisitedDomainsOm visitedDomains = _TranslationsVisitedDomainsOm._(_root);
	@override late final _TranslationsDomainDiscoveryOm domainDiscovery = _TranslationsDomainDiscoveryOm._(_root);
	@override late final _TranslationsInventorySuggestionsOm inventorySuggestions = _TranslationsInventorySuggestionsOm._(_root);
	@override late final _TranslationsUpgradeOm upgrade = _TranslationsUpgradeOm._(_root);
	@override late final _TranslationsTourOm tour = _TranslationsTourOm._(_root);
	@override late final _TranslationsManualRecipeOm manualRecipe = _TranslationsManualRecipeOm._(_root);
	@override late final _TranslationsRecipeEditOm recipeEdit = _TranslationsRecipeEditOm._(_root);
	@override late final _TranslationsErrorsOm errors = _TranslationsErrorsOm._(_root);
}

// Path: app
class _TranslationsAppOm extends TranslationsAppEn {
	_TranslationsAppOm._(TranslationsOm root) : this._root = root, super.internal(root);

	final TranslationsOm _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeOm extends TranslationsHomeEn {
	_TranslationsHomeOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonOm extends TranslationsCommonEn {
	_TranslationsCommonOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsOm extends TranslationsSettingsEn {
	_TranslationsSettingsOm._(TranslationsOm root) : this._root = root, super.internal(root);

	final TranslationsOm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsOm measurements = _TranslationsSettingsMeasurementsOm._(_root);
	@override late final _TranslationsSettingsDataManagementOm dataManagement = _TranslationsSettingsDataManagementOm._(_root);
	@override late final _TranslationsSettingsVersionOm version = _TranslationsSettingsVersionOm._(_root);
}

// Path: recipes
class _TranslationsRecipesOm extends TranslationsRecipesEn {
	_TranslationsRecipesOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailOm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailOm._(TranslationsOm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionOm nutrition = _TranslationsRecipeDetailNutritionOm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadOm prepAhead = _TranslationsRecipeDetailPrepAheadOm._(_root);
...
// Path: filters
class _TranslationsFiltersOm extends TranslationsFiltersEn {
	_TranslationsFiltersOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListOm extends TranslationsShoppingListEn {
	_TranslationsShoppingListOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanOm extends TranslationsMealPlanEn {
	_TranslationsMealPlanOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryOm extends TranslationsInventoryEn {
	_TranslationsInventoryOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanOm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanOm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingOm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsOm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryOm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsOm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeOm extends TranslationsUpgradeEn {
	_TranslationsUpgradeOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourOm extends TranslationsTourEn {
	_TranslationsTourOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeOm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditOm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsOm extends TranslationsErrorsEn {
	_TranslationsErrorsOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsOm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsOm._(TranslationsOm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricOm metric = _TranslationsSettingsMeasurementsMetricOm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialOm imperial = _TranslationsSettingsMeasurementsImperialOm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementOm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionOm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionOm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadOm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricOm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialOm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialOm._(TranslationsOm root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <om>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsOm {
