...
// Path: <root>
class TranslationsMt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <mt>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMt _root = this; // ignore: unused_field

	@override 
	TranslationsMt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMt app = _TranslationsAppMt._(_root);
	@override late final _TranslationsHomeMt home = _TranslationsHomeMt._(_root);
	@override late final _TranslationsCommonMt common = _TranslationsCommonMt._(_root);
	@override late final _TranslationsSettingsMt settings = _TranslationsSettingsMt._(_root);
	@override late final _TranslationsRecipesMt recipes = _TranslationsRecipesMt._(_root);
	@override late final _TranslationsRecipeDetailMt recipeDetail = _TranslationsRecipeDetailMt._(_root);
	@override late final _TranslationsFiltersMt filters = _TranslationsFiltersMt._(_root);
	@override late final _TranslationsShoppingListMt shoppingList = _TranslationsShoppingListMt._(_root);
	@override late final _TranslationsMealPlanMt mealPlan = _TranslationsMealPlanMt._(_root);
	@override late final _TranslationsInventoryMt inventory = _TranslationsInventoryMt._(_root);
	@override late final _TranslationsBarcodeScanMt barcodeScan = _TranslationsBarcodeScanMt._(_root);
	@override late final _TranslationsReceiptScanMt receiptScan = _TranslationsReceiptScanMt._(_root);
	@override late final _TranslationsBatchCookingMt batchCooking = _TranslationsBatchCookingMt._(_root);
	@override late final _TranslationsVisitedDomainsMt visitedDomains = _TranslationsVisitedDomainsMt._(_root);
	@override late final _TranslationsDomainDiscoveryMt domainDiscovery = _TranslationsDomainDiscoveryMt._(_root);
	@override late final _TranslationsInventorySuggestionsMt inventorySuggestions = _TranslationsInventorySuggestionsMt._(_root);
	@override late final _TranslationsUpgradeMt upgrade = _TranslationsUpgradeMt._(_root);
	@override late final _TranslationsTourMt tour = _TranslationsTourMt._(_root);
	@override late final _TranslationsManualRecipeMt manualRecipe = _TranslationsManualRecipeMt._(_root);
	@override late final _TranslationsRecipeEditMt recipeEdit = _TranslationsRecipeEditMt._(_root);
	@override late final _TranslationsErrorsMt errors = _TranslationsErrorsMt._(_root);
}

// Path: app
class _TranslationsAppMt extends TranslationsAppEn {
	_TranslationsAppMt._(TranslationsMt root) : this._root = root, super.internal(root);

	final TranslationsMt _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMt extends TranslationsHomeEn {
	_TranslationsHomeMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMt extends TranslationsCommonEn {
	_TranslationsCommonMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMt extends TranslationsSettingsEn {
	_TranslationsSettingsMt._(TranslationsMt root) : this._root = root, super.internal(root);

	final TranslationsMt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMt measurements = _TranslationsSettingsMeasurementsMt._(_root);
	@override late final _TranslationsSettingsDataManagementMt dataManagement = _TranslationsSettingsDataManagementMt._(_root);
	@override late final _TranslationsSettingsVersionMt version = _TranslationsSettingsVersionMt._(_root);
}

// Path: recipes
class _TranslationsRecipesMt extends TranslationsRecipesEn {
	_TranslationsRecipesMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMt._(TranslationsMt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMt nutrition = _TranslationsRecipeDetailNutritionMt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMt prepAhead = _TranslationsRecipeDetailPrepAheadMt._(_root);
...
// Path: filters
class _TranslationsFiltersMt extends TranslationsFiltersEn {
	_TranslationsFiltersMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMt extends TranslationsShoppingListEn {
	_TranslationsShoppingListMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMt extends TranslationsMealPlanEn {
	_TranslationsMealPlanMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMt extends TranslationsInventoryEn {
	_TranslationsInventoryMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMt extends TranslationsUpgradeEn {
	_TranslationsUpgradeMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMt extends TranslationsTourEn {
	_TranslationsTourMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMt extends TranslationsErrorsEn {
	_TranslationsErrorsMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMt._(TranslationsMt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMt metric = _TranslationsSettingsMeasurementsMetricMt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMt imperial = _TranslationsSettingsMeasurementsImperialMt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMt._(TranslationsMt root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <mt>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMt {
