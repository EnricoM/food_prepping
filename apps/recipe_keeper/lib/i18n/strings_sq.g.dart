...
// Path: <root>
class TranslationsSq extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppSq app = _TranslationsAppSq._(_root);
	@override late final _TranslationsHomeSq home = _TranslationsHomeSq._(_root);
	@override late final _TranslationsCommonSq common = _TranslationsCommonSq._(_root);
	@override late final _TranslationsSettingsSq settings = _TranslationsSettingsSq._(_root);
	@override late final _TranslationsRecipesSq recipes = _TranslationsRecipesSq._(_root);
	@override late final _TranslationsRecipeDetailSq recipeDetail = _TranslationsRecipeDetailSq._(_root);
	@override late final _TranslationsFiltersSq filters = _TranslationsFiltersSq._(_root);
	@override late final _TranslationsShoppingListSq shoppingList = _TranslationsShoppingListSq._(_root);
	@override late final _TranslationsMealPlanSq mealPlan = _TranslationsMealPlanSq._(_root);
	@override late final _TranslationsInventorySq inventory = _TranslationsInventorySq._(_root);
	@override late final _TranslationsBarcodeScanSq barcodeScan = _TranslationsBarcodeScanSq._(_root);
	@override late final _TranslationsReceiptScanSq receiptScan = _TranslationsReceiptScanSq._(_root);
	@override late final _TranslationsBatchCookingSq batchCooking = _TranslationsBatchCookingSq._(_root);
	@override late final _TranslationsVisitedDomainsSq visitedDomains = _TranslationsVisitedDomainsSq._(_root);
	@override late final _TranslationsDomainDiscoverySq domainDiscovery = _TranslationsDomainDiscoverySq._(_root);
	@override late final _TranslationsInventorySuggestionsSq inventorySuggestions = _TranslationsInventorySuggestionsSq._(_root);
	@override late final _TranslationsUpgradeSq upgrade = _TranslationsUpgradeSq._(_root);
	@override late final _TranslationsTourSq tour = _TranslationsTourSq._(_root);
	@override late final _TranslationsManualRecipeSq manualRecipe = _TranslationsManualRecipeSq._(_root);
	@override late final _TranslationsRecipeEditSq recipeEdit = _TranslationsRecipeEditSq._(_root);
	@override late final _TranslationsErrorsSq errors = _TranslationsErrorsSq._(_root);
}

// Path: app
class _TranslationsAppSq extends TranslationsAppEn {
	_TranslationsAppSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeSq extends TranslationsHomeEn {
	_TranslationsHomeSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSq extends TranslationsCommonEn {
	_TranslationsCommonSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSq extends TranslationsSettingsEn {
	_TranslationsSettingsSq._(TranslationsSq root) : this._root = root, super.internal(root);

	final TranslationsSq _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSq measurements = _TranslationsSettingsMeasurementsSq._(_root);
	@override late final _TranslationsSettingsDataManagementSq dataManagement = _TranslationsSettingsDataManagementSq._(_root);
	@override late final _TranslationsSettingsVersionSq version = _TranslationsSettingsVersionSq._(_root);
}

// Path: recipes
class _TranslationsRecipesSq extends TranslationsRecipesEn {
	_TranslationsRecipesSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSq extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSq._(TranslationsSq root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSq nutrition = _TranslationsRecipeDetailNutritionSq._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSq prepAhead = _TranslationsRecipeDetailPrepAheadSq._(_root);
...
// Path: filters
class _TranslationsFiltersSq extends TranslationsFiltersEn {
	_TranslationsFiltersSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSq extends TranslationsShoppingListEn {
	_TranslationsShoppingListSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSq extends TranslationsMealPlanEn {
	_TranslationsMealPlanSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySq extends TranslationsInventoryEn {
	_TranslationsInventorySq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSq extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSq extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSq extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSq extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySq extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSq extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSq extends TranslationsUpgradeEn {
	_TranslationsUpgradeSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSq extends TranslationsTourEn {
	_TranslationsTourSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSq extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSq extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSq extends TranslationsErrorsEn {
	_TranslationsErrorsSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSq extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSq._(TranslationsSq root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSq metric = _TranslationsSettingsMeasurementsMetricSq._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSq imperial = _TranslationsSettingsMeasurementsImperialSq._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSq extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSq extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSq extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSq extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSq extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSq._(TranslationsSq root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSq extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSq._(TranslationsSq root) : this._root = root, super.internal(root);
