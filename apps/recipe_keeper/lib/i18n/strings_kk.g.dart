...
class TranslationsKk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppKk app = _TranslationsAppKk._(_root);
	...
	@override late final _TranslationsSettingsKk settings = _TranslationsSettingsKk._(_root);
	@override late final _TranslationsRecipesKk recipes = _TranslationsRecipesKk._(_root);
	@override late final _TranslationsRecipeDetailKk recipeDetail = _TranslationsRecipeDetailKk._(_root);
	@override late final _TranslationsFiltersKk filters = _TranslationsFiltersKk._(_root);
	@override late final _TranslationsShoppingListKk shoppingList = _TranslationsShoppingListKk._(_root);
	@override late final _TranslationsMealPlanKk mealPlan = _TranslationsMealPlanKk._(_root);
	@override late final _TranslationsInventoryKk inventory = _TranslationsInventoryKk._(_root);
	@override late final _TranslationsBarcodeScanKk barcodeScan = _TranslationsBarcodeScanKk._(_root);
	@override late final _TranslationsReceiptScanKk receiptScan = _TranslationsReceiptScanKk._(_root);
	@override late final _TranslationsBatchCookingKk batchCooking = _TranslationsBatchCookingKk._(_root);
	@override late final _TranslationsVisitedDomainsKk visitedDomains = _TranslationsVisitedDomainsKk._(_root);
	@override late final _TranslationsDomainDiscoveryKk domainDiscovery = _TranslationsDomainDiscoveryKk._(_root);
	@override late final _TranslationsInventorySuggestionsKk inventorySuggestions = _TranslationsInventorySuggestionsKk._(_root);
	@override late final _TranslationsUpgradeKk upgrade = _TranslationsUpgradeKk._(_root);
	@override late final _TranslationsTourKk tour = _TranslationsTourKk._(_root);
	@override late final _TranslationsManualRecipeKk manualRecipe = _TranslationsManualRecipeKk._(_root);
	@override late final _TranslationsRecipeEditKk recipeEdit = _TranslationsRecipeEditKk._(_root);
	@override late final _TranslationsErrorsKk errors = _TranslationsErrorsKk._(_root);
}

// Path: app
class _TranslationsAppKk extends TranslationsAppEn {
	_TranslationsAppKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeKk extends TranslationsHomeEn {
...
// Path: settings
class _TranslationsSettingsKk extends TranslationsSettingsEn {
	_TranslationsSettingsKk._(TranslationsKk root) : this._root = root, super.internal(root);

	final TranslationsKk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKk measurements = _TranslationsSettingsMeasurementsKk._(_root);
	@override late final _TranslationsSettingsDataManagementKk dataManagement = _TranslationsSettingsDataManagementKk._(_root);
	@override late final _TranslationsSettingsVersionKk version = _TranslationsSettingsVersionKk._(_root);
}

// Path: recipes
class _TranslationsRecipesKk extends TranslationsRecipesEn {
	_TranslationsRecipesKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKk._(TranslationsKk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKk nutrition = _TranslationsRecipeDetailNutritionKk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKk prepAhead = _TranslationsRecipeDetailPrepAheadKk._(_root);
...
// Path: filters
class _TranslationsFiltersKk extends TranslationsFiltersEn {
	_TranslationsFiltersKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKk extends TranslationsShoppingListEn {
	_TranslationsShoppingListKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKk extends TranslationsMealPlanEn {
	_TranslationsMealPlanKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKk extends TranslationsInventoryEn {
	_TranslationsInventoryKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKk extends TranslationsUpgradeEn {
	_TranslationsUpgradeKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKk extends TranslationsTourEn {
	_TranslationsTourKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKk extends TranslationsErrorsEn {
	_TranslationsErrorsKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKk._(TranslationsKk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKk metric = _TranslationsSettingsMeasurementsMetricKk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKk imperial = _TranslationsSettingsMeasurementsImperialKk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKk._(TranslationsKk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKk._(TranslationsKk root) : this._root = root, super.internal(root);
