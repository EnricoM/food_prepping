...
class TranslationsUk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesUk recipes = _TranslationsRecipesUk._(_root);
	@override late final _TranslationsRecipeDetailUk recipeDetail = _TranslationsRecipeDetailUk._(_root);
	@override late final _TranslationsFiltersUk filters = _TranslationsFiltersUk._(_root);
	@override late final _TranslationsShoppingListUk shoppingList = _TranslationsShoppingListUk._(_root);
	@override late final _TranslationsMealPlanUk mealPlan = _TranslationsMealPlanUk._(_root);
	@override late final _TranslationsInventoryUk inventory = _TranslationsInventoryUk._(_root);
	@override late final _TranslationsBarcodeScanUk barcodeScan = _TranslationsBarcodeScanUk._(_root);
	@override late final _TranslationsReceiptScanUk receiptScan = _TranslationsReceiptScanUk._(_root);
	@override late final _TranslationsBatchCookingUk batchCooking = _TranslationsBatchCookingUk._(_root);
	@override late final _TranslationsVisitedDomainsUk visitedDomains = _TranslationsVisitedDomainsUk._(_root);
	@override late final _TranslationsDomainDiscoveryUk domainDiscovery = _TranslationsDomainDiscoveryUk._(_root);
	@override late final _TranslationsInventorySuggestionsUk inventorySuggestions = _TranslationsInventorySuggestionsUk._(_root);
	@override late final _TranslationsUpgradeUk upgrade = _TranslationsUpgradeUk._(_root);
	@override late final _TranslationsTourUk tour = _TranslationsTourUk._(_root);
	@override late final _TranslationsManualRecipeUk manualRecipe = _TranslationsManualRecipeUk._(_root);
	@override late final _TranslationsRecipeEditUk recipeEdit = _TranslationsRecipeEditUk._(_root);
...
class _TranslationsSettingsUk extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsUk measurements = _TranslationsSettingsMeasurementsUk._(_root);
	@override late final _TranslationsSettingsDataManagementUk dataManagement = _TranslationsSettingsDataManagementUk._(_root);
	@override late final _TranslationsSettingsVersionUk version = _TranslationsSettingsVersionUk._(_root);
}

// Path: recipes
class _TranslationsRecipesUk extends TranslationsRecipesEn {
	_TranslationsRecipesUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUk._(TranslationsUk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionUk nutrition = _TranslationsRecipeDetailNutritionUk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadUk prepAhead = _TranslationsRecipeDetailPrepAheadUk._(_root);
...
// Path: filters
class _TranslationsFiltersUk extends TranslationsFiltersEn {
	_TranslationsFiltersUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListUk extends TranslationsShoppingListEn {
	_TranslationsShoppingListUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanUk extends TranslationsMealPlanEn {
	_TranslationsMealPlanUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryUk extends TranslationsInventoryEn {
	_TranslationsInventoryUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanUk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingUk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryUk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsUk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeUk extends TranslationsUpgradeEn {
	_TranslationsUpgradeUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourUk extends TranslationsTourEn {
	_TranslationsTourUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsUk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUk._(TranslationsUk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricUk metric = _TranslationsSettingsMeasurementsMetricUk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialUk imperial = _TranslationsSettingsMeasurementsImperialUk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementUk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionUk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionUk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadUk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricUk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUk._(TranslationsUk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialUk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUk._(TranslationsUk root) : this._root = root, super.internal(root);
