...
// Path: <root>
class TranslationsNy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ny>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNy _root = this; // ignore: unused_field

	@override 
	TranslationsNy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNy app = _TranslationsAppNy._(_root);
	@override late final _TranslationsHomeNy home = _TranslationsHomeNy._(_root);
	@override late final _TranslationsCommonNy common = _TranslationsCommonNy._(_root);
	@override late final _TranslationsSettingsNy settings = _TranslationsSettingsNy._(_root);
	@override late final _TranslationsRecipesNy recipes = _TranslationsRecipesNy._(_root);
	@override late final _TranslationsRecipeDetailNy recipeDetail = _TranslationsRecipeDetailNy._(_root);
	@override late final _TranslationsFiltersNy filters = _TranslationsFiltersNy._(_root);
	@override late final _TranslationsShoppingListNy shoppingList = _TranslationsShoppingListNy._(_root);
	@override late final _TranslationsMealPlanNy mealPlan = _TranslationsMealPlanNy._(_root);
	@override late final _TranslationsInventoryNy inventory = _TranslationsInventoryNy._(_root);
	@override late final _TranslationsBarcodeScanNy barcodeScan = _TranslationsBarcodeScanNy._(_root);
	@override late final _TranslationsReceiptScanNy receiptScan = _TranslationsReceiptScanNy._(_root);
	@override late final _TranslationsBatchCookingNy batchCooking = _TranslationsBatchCookingNy._(_root);
	@override late final _TranslationsVisitedDomainsNy visitedDomains = _TranslationsVisitedDomainsNy._(_root);
	@override late final _TranslationsDomainDiscoveryNy domainDiscovery = _TranslationsDomainDiscoveryNy._(_root);
	@override late final _TranslationsInventorySuggestionsNy inventorySuggestions = _TranslationsInventorySuggestionsNy._(_root);
	@override late final _TranslationsUpgradeNy upgrade = _TranslationsUpgradeNy._(_root);
	@override late final _TranslationsTourNy tour = _TranslationsTourNy._(_root);
	@override late final _TranslationsManualRecipeNy manualRecipe = _TranslationsManualRecipeNy._(_root);
	@override late final _TranslationsRecipeEditNy recipeEdit = _TranslationsRecipeEditNy._(_root);
	@override late final _TranslationsErrorsNy errors = _TranslationsErrorsNy._(_root);
}

// Path: app
class _TranslationsAppNy extends TranslationsAppEn {
	_TranslationsAppNy._(TranslationsNy root) : this._root = root, super.internal(root);

	final TranslationsNy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNy extends TranslationsHomeEn {
	_TranslationsHomeNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNy extends TranslationsCommonEn {
	_TranslationsCommonNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNy extends TranslationsSettingsEn {
	_TranslationsSettingsNy._(TranslationsNy root) : this._root = root, super.internal(root);

	final TranslationsNy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNy measurements = _TranslationsSettingsMeasurementsNy._(_root);
	@override late final _TranslationsSettingsDataManagementNy dataManagement = _TranslationsSettingsDataManagementNy._(_root);
	@override late final _TranslationsSettingsVersionNy version = _TranslationsSettingsVersionNy._(_root);
}

// Path: recipes
class _TranslationsRecipesNy extends TranslationsRecipesEn {
	_TranslationsRecipesNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNy._(TranslationsNy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNy nutrition = _TranslationsRecipeDetailNutritionNy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNy prepAhead = _TranslationsRecipeDetailPrepAheadNy._(_root);
...
// Path: filters
class _TranslationsFiltersNy extends TranslationsFiltersEn {
	_TranslationsFiltersNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNy extends TranslationsShoppingListEn {
	_TranslationsShoppingListNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNy extends TranslationsMealPlanEn {
	_TranslationsMealPlanNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNy extends TranslationsInventoryEn {
	_TranslationsInventoryNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNy extends TranslationsUpgradeEn {
	_TranslationsUpgradeNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNy extends TranslationsTourEn {
	_TranslationsTourNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNy extends TranslationsErrorsEn {
	_TranslationsErrorsNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNy._(TranslationsNy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNy metric = _TranslationsSettingsMeasurementsMetricNy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNy imperial = _TranslationsSettingsMeasurementsImperialNy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNy._(TranslationsNy root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ny>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNy {
