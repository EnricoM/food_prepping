...
class TranslationsMrIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppMrIn app = _TranslationsAppMrIn._(_root);
	@override late final _TranslationsHomeMrIn home = _TranslationsHomeMrIn._(_root);
	@override late final _TranslationsCommonMrIn common = _TranslationsCommonMrIn._(_root);
	@override late final _TranslationsSettingsMrIn settings = _TranslationsSettingsMrIn._(_root);
	@override late final _TranslationsRecipesMrIn recipes = _TranslationsRecipesMrIn._(_root);
	@override late final _TranslationsRecipeDetailMrIn recipeDetail = _TranslationsRecipeDetailMrIn._(_root);
	@override late final _TranslationsFiltersMrIn filters = _TranslationsFiltersMrIn._(_root);
	@override late final _TranslationsShoppingListMrIn shoppingList = _TranslationsShoppingListMrIn._(_root);
	@override late final _TranslationsMealPlanMrIn mealPlan = _TranslationsMealPlanMrIn._(_root);
	@override late final _TranslationsInventoryMrIn inventory = _TranslationsInventoryMrIn._(_root);
	@override late final _TranslationsBarcodeScanMrIn barcodeScan = _TranslationsBarcodeScanMrIn._(_root);
	@override late final _TranslationsReceiptScanMrIn receiptScan = _TranslationsReceiptScanMrIn._(_root);
	@override late final _TranslationsBatchCookingMrIn batchCooking = _TranslationsBatchCookingMrIn._(_root);
	@override late final _TranslationsVisitedDomainsMrIn visitedDomains = _TranslationsVisitedDomainsMrIn._(_root);
	@override late final _TranslationsDomainDiscoveryMrIn domainDiscovery = _TranslationsDomainDiscoveryMrIn._(_root);
	@override late final _TranslationsInventorySuggestionsMrIn inventorySuggestions = _TranslationsInventorySuggestionsMrIn._(_root);
	@override late final _TranslationsUpgradeMrIn upgrade = _TranslationsUpgradeMrIn._(_root);
	@override late final _TranslationsTourMrIn tour = _TranslationsTourMrIn._(_root);
	@override late final _TranslationsManualRecipeMrIn manualRecipe = _TranslationsManualRecipeMrIn._(_root);
	@override late final _TranslationsRecipeEditMrIn recipeEdit = _TranslationsRecipeEditMrIn._(_root);
	@override late final _TranslationsErrorsMrIn errors = _TranslationsErrorsMrIn._(_root);
}

// Path: app
class _TranslationsAppMrIn extends TranslationsAppEn {
	_TranslationsAppMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);

	final TranslationsMrIn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMrIn extends TranslationsHomeEn {
	_TranslationsHomeMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMrIn extends TranslationsCommonEn {
	_TranslationsCommonMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMrIn extends TranslationsSettingsEn {
	_TranslationsSettingsMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);

	final TranslationsMrIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMrIn measurements = _TranslationsSettingsMeasurementsMrIn._(_root);
	@override late final _TranslationsSettingsDataManagementMrIn dataManagement = _TranslationsSettingsDataManagementMrIn._(_root);
	@override late final _TranslationsSettingsVersionMrIn version = _TranslationsSettingsVersionMrIn._(_root);
}

// Path: recipes
class _TranslationsRecipesMrIn extends TranslationsRecipesEn {
	_TranslationsRecipesMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMrIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMrIn nutrition = _TranslationsRecipeDetailNutritionMrIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMrIn prepAhead = _TranslationsRecipeDetailPrepAheadMrIn._(_root);
...
// Path: filters
class _TranslationsFiltersMrIn extends TranslationsFiltersEn {
	_TranslationsFiltersMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMrIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMrIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMrIn extends TranslationsInventoryEn {
	_TranslationsInventoryMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMrIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMrIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMrIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMrIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMrIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMrIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMrIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMrIn extends TranslationsTourEn {
	_TranslationsTourMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMrIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMrIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMrIn extends TranslationsErrorsEn {
	_TranslationsErrorsMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMrIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMrIn metric = _TranslationsSettingsMeasurementsMetricMrIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMrIn imperial = _TranslationsSettingsMeasurementsImperialMrIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMrIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMrIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMrIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMrIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMrIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMrIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMrIn._(TranslationsMrIn root) : this._root = root, super.internal(root);
