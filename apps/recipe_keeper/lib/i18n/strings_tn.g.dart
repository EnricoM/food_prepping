...
// Path: <root>
class TranslationsTn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <tn>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTn _root = this; // ignore: unused_field

	@override 
	TranslationsTn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTn app = _TranslationsAppTn._(_root);
	@override late final _TranslationsHomeTn home = _TranslationsHomeTn._(_root);
	@override late final _TranslationsCommonTn common = _TranslationsCommonTn._(_root);
	@override late final _TranslationsSettingsTn settings = _TranslationsSettingsTn._(_root);
	@override late final _TranslationsRecipesTn recipes = _TranslationsRecipesTn._(_root);
	@override late final _TranslationsRecipeDetailTn recipeDetail = _TranslationsRecipeDetailTn._(_root);
	@override late final _TranslationsFiltersTn filters = _TranslationsFiltersTn._(_root);
	@override late final _TranslationsShoppingListTn shoppingList = _TranslationsShoppingListTn._(_root);
	@override late final _TranslationsMealPlanTn mealPlan = _TranslationsMealPlanTn._(_root);
	@override late final _TranslationsInventoryTn inventory = _TranslationsInventoryTn._(_root);
	@override late final _TranslationsBarcodeScanTn barcodeScan = _TranslationsBarcodeScanTn._(_root);
	@override late final _TranslationsReceiptScanTn receiptScan = _TranslationsReceiptScanTn._(_root);
	@override late final _TranslationsBatchCookingTn batchCooking = _TranslationsBatchCookingTn._(_root);
	@override late final _TranslationsVisitedDomainsTn visitedDomains = _TranslationsVisitedDomainsTn._(_root);
	@override late final _TranslationsDomainDiscoveryTn domainDiscovery = _TranslationsDomainDiscoveryTn._(_root);
	@override late final _TranslationsInventorySuggestionsTn inventorySuggestions = _TranslationsInventorySuggestionsTn._(_root);
	@override late final _TranslationsUpgradeTn upgrade = _TranslationsUpgradeTn._(_root);
	@override late final _TranslationsTourTn tour = _TranslationsTourTn._(_root);
	@override late final _TranslationsManualRecipeTn manualRecipe = _TranslationsManualRecipeTn._(_root);
	@override late final _TranslationsRecipeEditTn recipeEdit = _TranslationsRecipeEditTn._(_root);
	@override late final _TranslationsErrorsTn errors = _TranslationsErrorsTn._(_root);
}

// Path: app
class _TranslationsAppTn extends TranslationsAppEn {
	_TranslationsAppTn._(TranslationsTn root) : this._root = root, super.internal(root);

	final TranslationsTn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTn extends TranslationsHomeEn {
	_TranslationsHomeTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTn extends TranslationsCommonEn {
	_TranslationsCommonTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTn extends TranslationsSettingsEn {
	_TranslationsSettingsTn._(TranslationsTn root) : this._root = root, super.internal(root);

	final TranslationsTn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTn measurements = _TranslationsSettingsMeasurementsTn._(_root);
	@override late final _TranslationsSettingsDataManagementTn dataManagement = _TranslationsSettingsDataManagementTn._(_root);
	@override late final _TranslationsSettingsVersionTn version = _TranslationsSettingsVersionTn._(_root);
}

// Path: recipes
class _TranslationsRecipesTn extends TranslationsRecipesEn {
	_TranslationsRecipesTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTn._(TranslationsTn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTn nutrition = _TranslationsRecipeDetailNutritionTn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTn prepAhead = _TranslationsRecipeDetailPrepAheadTn._(_root);
...
// Path: filters
class _TranslationsFiltersTn extends TranslationsFiltersEn {
	_TranslationsFiltersTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTn extends TranslationsShoppingListEn {
	_TranslationsShoppingListTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTn extends TranslationsMealPlanEn {
	_TranslationsMealPlanTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTn extends TranslationsInventoryEn {
	_TranslationsInventoryTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTn extends TranslationsUpgradeEn {
	_TranslationsUpgradeTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTn extends TranslationsTourEn {
	_TranslationsTourTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTn extends TranslationsErrorsEn {
	_TranslationsErrorsTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTn._(TranslationsTn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTn metric = _TranslationsSettingsMeasurementsMetricTn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTn imperial = _TranslationsSettingsMeasurementsImperialTn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTn._(TranslationsTn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <tn>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTn {
