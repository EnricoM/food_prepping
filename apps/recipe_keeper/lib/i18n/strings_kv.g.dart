...
// Path: <root>
class TranslationsKv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <kv>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKv _root = this; // ignore: unused_field

	@override 
	TranslationsKv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKv app = _TranslationsAppKv._(_root);
	@override late final _TranslationsHomeKv home = _TranslationsHomeKv._(_root);
	@override late final _TranslationsCommonKv common = _TranslationsCommonKv._(_root);
	@override late final _TranslationsSettingsKv settings = _TranslationsSettingsKv._(_root);
	@override late final _TranslationsRecipesKv recipes = _TranslationsRecipesKv._(_root);
	@override late final _TranslationsRecipeDetailKv recipeDetail = _TranslationsRecipeDetailKv._(_root);
	@override late final _TranslationsFiltersKv filters = _TranslationsFiltersKv._(_root);
	@override late final _TranslationsShoppingListKv shoppingList = _TranslationsShoppingListKv._(_root);
	@override late final _TranslationsMealPlanKv mealPlan = _TranslationsMealPlanKv._(_root);
	@override late final _TranslationsInventoryKv inventory = _TranslationsInventoryKv._(_root);
	@override late final _TranslationsBarcodeScanKv barcodeScan = _TranslationsBarcodeScanKv._(_root);
	@override late final _TranslationsReceiptScanKv receiptScan = _TranslationsReceiptScanKv._(_root);
	@override late final _TranslationsBatchCookingKv batchCooking = _TranslationsBatchCookingKv._(_root);
	@override late final _TranslationsVisitedDomainsKv visitedDomains = _TranslationsVisitedDomainsKv._(_root);
	@override late final _TranslationsDomainDiscoveryKv domainDiscovery = _TranslationsDomainDiscoveryKv._(_root);
	@override late final _TranslationsInventorySuggestionsKv inventorySuggestions = _TranslationsInventorySuggestionsKv._(_root);
	@override late final _TranslationsUpgradeKv upgrade = _TranslationsUpgradeKv._(_root);
	@override late final _TranslationsTourKv tour = _TranslationsTourKv._(_root);
	@override late final _TranslationsManualRecipeKv manualRecipe = _TranslationsManualRecipeKv._(_root);
	@override late final _TranslationsRecipeEditKv recipeEdit = _TranslationsRecipeEditKv._(_root);
	@override late final _TranslationsErrorsKv errors = _TranslationsErrorsKv._(_root);
}

// Path: app
class _TranslationsAppKv extends TranslationsAppEn {
	_TranslationsAppKv._(TranslationsKv root) : this._root = root, super.internal(root);

	final TranslationsKv _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKv extends TranslationsHomeEn {
	_TranslationsHomeKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKv extends TranslationsCommonEn {
	_TranslationsCommonKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKv extends TranslationsSettingsEn {
	_TranslationsSettingsKv._(TranslationsKv root) : this._root = root, super.internal(root);

	final TranslationsKv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKv measurements = _TranslationsSettingsMeasurementsKv._(_root);
	@override late final _TranslationsSettingsDataManagementKv dataManagement = _TranslationsSettingsDataManagementKv._(_root);
	@override late final _TranslationsSettingsVersionKv version = _TranslationsSettingsVersionKv._(_root);
}

// Path: recipes
class _TranslationsRecipesKv extends TranslationsRecipesEn {
	_TranslationsRecipesKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKv._(TranslationsKv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKv nutrition = _TranslationsRecipeDetailNutritionKv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKv prepAhead = _TranslationsRecipeDetailPrepAheadKv._(_root);
...
// Path: filters
class _TranslationsFiltersKv extends TranslationsFiltersEn {
	_TranslationsFiltersKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKv extends TranslationsShoppingListEn {
	_TranslationsShoppingListKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKv extends TranslationsMealPlanEn {
	_TranslationsMealPlanKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKv extends TranslationsInventoryEn {
	_TranslationsInventoryKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKv extends TranslationsUpgradeEn {
	_TranslationsUpgradeKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKv extends TranslationsTourEn {
	_TranslationsTourKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKv extends TranslationsErrorsEn {
	_TranslationsErrorsKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKv._(TranslationsKv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKv metric = _TranslationsSettingsMeasurementsMetricKv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKv imperial = _TranslationsSettingsMeasurementsImperialKv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKv._(TranslationsKv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kv>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKv {
