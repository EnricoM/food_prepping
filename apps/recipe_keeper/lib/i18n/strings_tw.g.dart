...
// Path: <root>
class TranslationsTw extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTw({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <tw>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTw _root = this; // ignore: unused_field

	@override 
	TranslationsTw $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTw(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTw app = _TranslationsAppTw._(_root);
	@override late final _TranslationsHomeTw home = _TranslationsHomeTw._(_root);
	@override late final _TranslationsCommonTw common = _TranslationsCommonTw._(_root);
	@override late final _TranslationsSettingsTw settings = _TranslationsSettingsTw._(_root);
	@override late final _TranslationsRecipesTw recipes = _TranslationsRecipesTw._(_root);
	@override late final _TranslationsRecipeDetailTw recipeDetail = _TranslationsRecipeDetailTw._(_root);
	@override late final _TranslationsFiltersTw filters = _TranslationsFiltersTw._(_root);
	@override late final _TranslationsShoppingListTw shoppingList = _TranslationsShoppingListTw._(_root);
	@override late final _TranslationsMealPlanTw mealPlan = _TranslationsMealPlanTw._(_root);
	@override late final _TranslationsInventoryTw inventory = _TranslationsInventoryTw._(_root);
	@override late final _TranslationsBarcodeScanTw barcodeScan = _TranslationsBarcodeScanTw._(_root);
	@override late final _TranslationsReceiptScanTw receiptScan = _TranslationsReceiptScanTw._(_root);
	@override late final _TranslationsBatchCookingTw batchCooking = _TranslationsBatchCookingTw._(_root);
	@override late final _TranslationsVisitedDomainsTw visitedDomains = _TranslationsVisitedDomainsTw._(_root);
	@override late final _TranslationsDomainDiscoveryTw domainDiscovery = _TranslationsDomainDiscoveryTw._(_root);
	@override late final _TranslationsInventorySuggestionsTw inventorySuggestions = _TranslationsInventorySuggestionsTw._(_root);
	@override late final _TranslationsUpgradeTw upgrade = _TranslationsUpgradeTw._(_root);
	@override late final _TranslationsTourTw tour = _TranslationsTourTw._(_root);
	@override late final _TranslationsManualRecipeTw manualRecipe = _TranslationsManualRecipeTw._(_root);
	@override late final _TranslationsRecipeEditTw recipeEdit = _TranslationsRecipeEditTw._(_root);
	@override late final _TranslationsErrorsTw errors = _TranslationsErrorsTw._(_root);
}

// Path: app
class _TranslationsAppTw extends TranslationsAppEn {
	_TranslationsAppTw._(TranslationsTw root) : this._root = root, super.internal(root);

	final TranslationsTw _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTw extends TranslationsHomeEn {
	_TranslationsHomeTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTw extends TranslationsCommonEn {
	_TranslationsCommonTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTw extends TranslationsSettingsEn {
	_TranslationsSettingsTw._(TranslationsTw root) : this._root = root, super.internal(root);

	final TranslationsTw _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTw measurements = _TranslationsSettingsMeasurementsTw._(_root);
	@override late final _TranslationsSettingsDataManagementTw dataManagement = _TranslationsSettingsDataManagementTw._(_root);
	@override late final _TranslationsSettingsVersionTw version = _TranslationsSettingsVersionTw._(_root);
}

// Path: recipes
class _TranslationsRecipesTw extends TranslationsRecipesEn {
	_TranslationsRecipesTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTw extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTw._(TranslationsTw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTw nutrition = _TranslationsRecipeDetailNutritionTw._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTw prepAhead = _TranslationsRecipeDetailPrepAheadTw._(_root);
...
// Path: filters
class _TranslationsFiltersTw extends TranslationsFiltersEn {
	_TranslationsFiltersTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTw extends TranslationsShoppingListEn {
	_TranslationsShoppingListTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTw extends TranslationsMealPlanEn {
	_TranslationsMealPlanTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTw extends TranslationsInventoryEn {
	_TranslationsInventoryTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTw extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTw extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTw extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTw extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTw extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTw extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTw extends TranslationsUpgradeEn {
	_TranslationsUpgradeTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTw extends TranslationsTourEn {
	_TranslationsTourTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTw extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTw extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTw extends TranslationsErrorsEn {
	_TranslationsErrorsTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTw extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTw._(TranslationsTw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTw metric = _TranslationsSettingsMeasurementsMetricTw._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTw imperial = _TranslationsSettingsMeasurementsImperialTw._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTw extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTw extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTw extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTw extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTw extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTw extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTw._(TranslationsTw root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <tw>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTw {
