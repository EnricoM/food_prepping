...
// Path: <root>
class TranslationsVe extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsVe({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ve>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsVe _root = this; // ignore: unused_field

	@override 
	TranslationsVe $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsVe(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppVe app = _TranslationsAppVe._(_root);
	@override late final _TranslationsHomeVe home = _TranslationsHomeVe._(_root);
	@override late final _TranslationsCommonVe common = _TranslationsCommonVe._(_root);
	@override late final _TranslationsSettingsVe settings = _TranslationsSettingsVe._(_root);
	@override late final _TranslationsRecipesVe recipes = _TranslationsRecipesVe._(_root);
	@override late final _TranslationsRecipeDetailVe recipeDetail = _TranslationsRecipeDetailVe._(_root);
	@override late final _TranslationsFiltersVe filters = _TranslationsFiltersVe._(_root);
	@override late final _TranslationsShoppingListVe shoppingList = _TranslationsShoppingListVe._(_root);
	@override late final _TranslationsMealPlanVe mealPlan = _TranslationsMealPlanVe._(_root);
	@override late final _TranslationsInventoryVe inventory = _TranslationsInventoryVe._(_root);
	@override late final _TranslationsBarcodeScanVe barcodeScan = _TranslationsBarcodeScanVe._(_root);
	@override late final _TranslationsReceiptScanVe receiptScan = _TranslationsReceiptScanVe._(_root);
	@override late final _TranslationsBatchCookingVe batchCooking = _TranslationsBatchCookingVe._(_root);
	@override late final _TranslationsVisitedDomainsVe visitedDomains = _TranslationsVisitedDomainsVe._(_root);
	@override late final _TranslationsDomainDiscoveryVe domainDiscovery = _TranslationsDomainDiscoveryVe._(_root);
	@override late final _TranslationsInventorySuggestionsVe inventorySuggestions = _TranslationsInventorySuggestionsVe._(_root);
	@override late final _TranslationsUpgradeVe upgrade = _TranslationsUpgradeVe._(_root);
	@override late final _TranslationsTourVe tour = _TranslationsTourVe._(_root);
	@override late final _TranslationsManualRecipeVe manualRecipe = _TranslationsManualRecipeVe._(_root);
	@override late final _TranslationsRecipeEditVe recipeEdit = _TranslationsRecipeEditVe._(_root);
	@override late final _TranslationsErrorsVe errors = _TranslationsErrorsVe._(_root);
}

// Path: app
class _TranslationsAppVe extends TranslationsAppEn {
	_TranslationsAppVe._(TranslationsVe root) : this._root = root, super.internal(root);

	final TranslationsVe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeVe extends TranslationsHomeEn {
	_TranslationsHomeVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonVe extends TranslationsCommonEn {
	_TranslationsCommonVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsVe extends TranslationsSettingsEn {
	_TranslationsSettingsVe._(TranslationsVe root) : this._root = root, super.internal(root);

	final TranslationsVe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsVe measurements = _TranslationsSettingsMeasurementsVe._(_root);
	@override late final _TranslationsSettingsDataManagementVe dataManagement = _TranslationsSettingsDataManagementVe._(_root);
	@override late final _TranslationsSettingsVersionVe version = _TranslationsSettingsVersionVe._(_root);
}

// Path: recipes
class _TranslationsRecipesVe extends TranslationsRecipesEn {
	_TranslationsRecipesVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailVe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailVe._(TranslationsVe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionVe nutrition = _TranslationsRecipeDetailNutritionVe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadVe prepAhead = _TranslationsRecipeDetailPrepAheadVe._(_root);
...
// Path: filters
class _TranslationsFiltersVe extends TranslationsFiltersEn {
	_TranslationsFiltersVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListVe extends TranslationsShoppingListEn {
	_TranslationsShoppingListVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanVe extends TranslationsMealPlanEn {
	_TranslationsMealPlanVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryVe extends TranslationsInventoryEn {
	_TranslationsInventoryVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanVe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanVe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingVe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsVe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryVe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsVe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeVe extends TranslationsUpgradeEn {
	_TranslationsUpgradeVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourVe extends TranslationsTourEn {
	_TranslationsTourVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeVe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditVe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsVe extends TranslationsErrorsEn {
	_TranslationsErrorsVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsVe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsVe._(TranslationsVe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricVe metric = _TranslationsSettingsMeasurementsMetricVe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialVe imperial = _TranslationsSettingsMeasurementsImperialVe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementVe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionVe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionVe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadVe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricVe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialVe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialVe._(TranslationsVe root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ve>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsVe {
