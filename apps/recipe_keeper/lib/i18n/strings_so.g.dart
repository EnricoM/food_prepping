...
// Path: <root>
class TranslationsSo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <so>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSo _root = this; // ignore: unused_field

	@override 
	TranslationsSo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSo app = _TranslationsAppSo._(_root);
	@override late final _TranslationsHomeSo home = _TranslationsHomeSo._(_root);
	@override late final _TranslationsCommonSo common = _TranslationsCommonSo._(_root);
	@override late final _TranslationsSettingsSo settings = _TranslationsSettingsSo._(_root);
	@override late final _TranslationsRecipesSo recipes = _TranslationsRecipesSo._(_root);
	@override late final _TranslationsRecipeDetailSo recipeDetail = _TranslationsRecipeDetailSo._(_root);
	@override late final _TranslationsFiltersSo filters = _TranslationsFiltersSo._(_root);
	@override late final _TranslationsShoppingListSo shoppingList = _TranslationsShoppingListSo._(_root);
	@override late final _TranslationsMealPlanSo mealPlan = _TranslationsMealPlanSo._(_root);
	@override late final _TranslationsInventorySo inventory = _TranslationsInventorySo._(_root);
	@override late final _TranslationsBarcodeScanSo barcodeScan = _TranslationsBarcodeScanSo._(_root);
	@override late final _TranslationsReceiptScanSo receiptScan = _TranslationsReceiptScanSo._(_root);
	@override late final _TranslationsBatchCookingSo batchCooking = _TranslationsBatchCookingSo._(_root);
	@override late final _TranslationsVisitedDomainsSo visitedDomains = _TranslationsVisitedDomainsSo._(_root);
	@override late final _TranslationsDomainDiscoverySo domainDiscovery = _TranslationsDomainDiscoverySo._(_root);
	@override late final _TranslationsInventorySuggestionsSo inventorySuggestions = _TranslationsInventorySuggestionsSo._(_root);
	@override late final _TranslationsUpgradeSo upgrade = _TranslationsUpgradeSo._(_root);
	@override late final _TranslationsTourSo tour = _TranslationsTourSo._(_root);
	@override late final _TranslationsManualRecipeSo manualRecipe = _TranslationsManualRecipeSo._(_root);
	@override late final _TranslationsRecipeEditSo recipeEdit = _TranslationsRecipeEditSo._(_root);
	@override late final _TranslationsErrorsSo errors = _TranslationsErrorsSo._(_root);
}

// Path: app
class _TranslationsAppSo extends TranslationsAppEn {
	_TranslationsAppSo._(TranslationsSo root) : this._root = root, super.internal(root);

	final TranslationsSo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSo extends TranslationsHomeEn {
	_TranslationsHomeSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSo extends TranslationsCommonEn {
	_TranslationsCommonSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSo extends TranslationsSettingsEn {
	_TranslationsSettingsSo._(TranslationsSo root) : this._root = root, super.internal(root);

	final TranslationsSo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSo measurements = _TranslationsSettingsMeasurementsSo._(_root);
	@override late final _TranslationsSettingsDataManagementSo dataManagement = _TranslationsSettingsDataManagementSo._(_root);
	@override late final _TranslationsSettingsVersionSo version = _TranslationsSettingsVersionSo._(_root);
}

// Path: recipes
class _TranslationsRecipesSo extends TranslationsRecipesEn {
	_TranslationsRecipesSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSo._(TranslationsSo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSo nutrition = _TranslationsRecipeDetailNutritionSo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSo prepAhead = _TranslationsRecipeDetailPrepAheadSo._(_root);
...
// Path: filters
class _TranslationsFiltersSo extends TranslationsFiltersEn {
	_TranslationsFiltersSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSo extends TranslationsShoppingListEn {
	_TranslationsShoppingListSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSo extends TranslationsMealPlanEn {
	_TranslationsMealPlanSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySo extends TranslationsInventoryEn {
	_TranslationsInventorySo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSo extends TranslationsUpgradeEn {
	_TranslationsUpgradeSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSo extends TranslationsTourEn {
	_TranslationsTourSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSo extends TranslationsErrorsEn {
	_TranslationsErrorsSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSo._(TranslationsSo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSo metric = _TranslationsSettingsMeasurementsMetricSo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSo imperial = _TranslationsSettingsMeasurementsImperialSo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSo._(TranslationsSo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <so>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSo {
