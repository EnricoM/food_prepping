...
// Path: <root>
class TranslationsFf extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsFf({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ff>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsFf _root = this; // ignore: unused_field

	@override 
	TranslationsFf $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsFf(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppFf app = _TranslationsAppFf._(_root);
	@override late final _TranslationsHomeFf home = _TranslationsHomeFf._(_root);
	@override late final _TranslationsCommonFf common = _TranslationsCommonFf._(_root);
	@override late final _TranslationsSettingsFf settings = _TranslationsSettingsFf._(_root);
	@override late final _TranslationsRecipesFf recipes = _TranslationsRecipesFf._(_root);
	@override late final _TranslationsRecipeDetailFf recipeDetail = _TranslationsRecipeDetailFf._(_root);
	@override late final _TranslationsFiltersFf filters = _TranslationsFiltersFf._(_root);
	@override late final _TranslationsShoppingListFf shoppingList = _TranslationsShoppingListFf._(_root);
	@override late final _TranslationsMealPlanFf mealPlan = _TranslationsMealPlanFf._(_root);
	@override late final _TranslationsInventoryFf inventory = _TranslationsInventoryFf._(_root);
	@override late final _TranslationsBarcodeScanFf barcodeScan = _TranslationsBarcodeScanFf._(_root);
	@override late final _TranslationsReceiptScanFf receiptScan = _TranslationsReceiptScanFf._(_root);
	@override late final _TranslationsBatchCookingFf batchCooking = _TranslationsBatchCookingFf._(_root);
	@override late final _TranslationsVisitedDomainsFf visitedDomains = _TranslationsVisitedDomainsFf._(_root);
	@override late final _TranslationsDomainDiscoveryFf domainDiscovery = _TranslationsDomainDiscoveryFf._(_root);
	@override late final _TranslationsInventorySuggestionsFf inventorySuggestions = _TranslationsInventorySuggestionsFf._(_root);
	@override late final _TranslationsUpgradeFf upgrade = _TranslationsUpgradeFf._(_root);
	@override late final _TranslationsTourFf tour = _TranslationsTourFf._(_root);
	@override late final _TranslationsManualRecipeFf manualRecipe = _TranslationsManualRecipeFf._(_root);
	@override late final _TranslationsRecipeEditFf recipeEdit = _TranslationsRecipeEditFf._(_root);
	@override late final _TranslationsErrorsFf errors = _TranslationsErrorsFf._(_root);
}

// Path: app
class _TranslationsAppFf extends TranslationsAppEn {
	_TranslationsAppFf._(TranslationsFf root) : this._root = root, super.internal(root);

	final TranslationsFf _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeFf extends TranslationsHomeEn {
	_TranslationsHomeFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonFf extends TranslationsCommonEn {
	_TranslationsCommonFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsFf extends TranslationsSettingsEn {
	_TranslationsSettingsFf._(TranslationsFf root) : this._root = root, super.internal(root);

	final TranslationsFf _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsFf measurements = _TranslationsSettingsMeasurementsFf._(_root);
	@override late final _TranslationsSettingsDataManagementFf dataManagement = _TranslationsSettingsDataManagementFf._(_root);
	@override late final _TranslationsSettingsVersionFf version = _TranslationsSettingsVersionFf._(_root);
}

// Path: recipes
class _TranslationsRecipesFf extends TranslationsRecipesEn {
	_TranslationsRecipesFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFf extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFf._(TranslationsFf root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFf nutrition = _TranslationsRecipeDetailNutritionFf._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFf prepAhead = _TranslationsRecipeDetailPrepAheadFf._(_root);
...
// Path: filters
class _TranslationsFiltersFf extends TranslationsFiltersEn {
	_TranslationsFiltersFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFf extends TranslationsShoppingListEn {
	_TranslationsShoppingListFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFf extends TranslationsMealPlanEn {
	_TranslationsMealPlanFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFf extends TranslationsInventoryEn {
	_TranslationsInventoryFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFf extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFf extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFf extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFf extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFf extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFf extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFf extends TranslationsUpgradeEn {
	_TranslationsUpgradeFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFf extends TranslationsTourEn {
	_TranslationsTourFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFf extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFf extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsFf extends TranslationsErrorsEn {
	_TranslationsErrorsFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFf extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFf._(TranslationsFf root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFf metric = _TranslationsSettingsMeasurementsMetricFf._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFf imperial = _TranslationsSettingsMeasurementsImperialFf._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFf extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFf extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFf extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFf extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFf extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFf extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFf._(TranslationsFf root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ff>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsFf {
