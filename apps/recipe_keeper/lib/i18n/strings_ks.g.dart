...
// Path: <root>
class TranslationsKs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ks>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKs _root = this; // ignore: unused_field

	@override 
	TranslationsKs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKs app = _TranslationsAppKs._(_root);
	@override late final _TranslationsHomeKs home = _TranslationsHomeKs._(_root);
	@override late final _TranslationsCommonKs common = _TranslationsCommonKs._(_root);
	@override late final _TranslationsSettingsKs settings = _TranslationsSettingsKs._(_root);
	@override late final _TranslationsRecipesKs recipes = _TranslationsRecipesKs._(_root);
	@override late final _TranslationsRecipeDetailKs recipeDetail = _TranslationsRecipeDetailKs._(_root);
	@override late final _TranslationsFiltersKs filters = _TranslationsFiltersKs._(_root);
	@override late final _TranslationsShoppingListKs shoppingList = _TranslationsShoppingListKs._(_root);
	@override late final _TranslationsMealPlanKs mealPlan = _TranslationsMealPlanKs._(_root);
	@override late final _TranslationsInventoryKs inventory = _TranslationsInventoryKs._(_root);
	@override late final _TranslationsBarcodeScanKs barcodeScan = _TranslationsBarcodeScanKs._(_root);
	@override late final _TranslationsReceiptScanKs receiptScan = _TranslationsReceiptScanKs._(_root);
	@override late final _TranslationsBatchCookingKs batchCooking = _TranslationsBatchCookingKs._(_root);
	@override late final _TranslationsVisitedDomainsKs visitedDomains = _TranslationsVisitedDomainsKs._(_root);
	@override late final _TranslationsDomainDiscoveryKs domainDiscovery = _TranslationsDomainDiscoveryKs._(_root);
	@override late final _TranslationsInventorySuggestionsKs inventorySuggestions = _TranslationsInventorySuggestionsKs._(_root);
	@override late final _TranslationsUpgradeKs upgrade = _TranslationsUpgradeKs._(_root);
	@override late final _TranslationsTourKs tour = _TranslationsTourKs._(_root);
	@override late final _TranslationsManualRecipeKs manualRecipe = _TranslationsManualRecipeKs._(_root);
	@override late final _TranslationsRecipeEditKs recipeEdit = _TranslationsRecipeEditKs._(_root);
	@override late final _TranslationsErrorsKs errors = _TranslationsErrorsKs._(_root);
}

// Path: app
class _TranslationsAppKs extends TranslationsAppEn {
	_TranslationsAppKs._(TranslationsKs root) : this._root = root, super.internal(root);

	final TranslationsKs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKs extends TranslationsHomeEn {
	_TranslationsHomeKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKs extends TranslationsCommonEn {
	_TranslationsCommonKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKs extends TranslationsSettingsEn {
	_TranslationsSettingsKs._(TranslationsKs root) : this._root = root, super.internal(root);

	final TranslationsKs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKs measurements = _TranslationsSettingsMeasurementsKs._(_root);
	@override late final _TranslationsSettingsDataManagementKs dataManagement = _TranslationsSettingsDataManagementKs._(_root);
	@override late final _TranslationsSettingsVersionKs version = _TranslationsSettingsVersionKs._(_root);
}

// Path: recipes
class _TranslationsRecipesKs extends TranslationsRecipesEn {
	_TranslationsRecipesKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKs._(TranslationsKs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKs nutrition = _TranslationsRecipeDetailNutritionKs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKs prepAhead = _TranslationsRecipeDetailPrepAheadKs._(_root);
...
// Path: filters
class _TranslationsFiltersKs extends TranslationsFiltersEn {
	_TranslationsFiltersKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKs extends TranslationsShoppingListEn {
	_TranslationsShoppingListKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKs extends TranslationsMealPlanEn {
	_TranslationsMealPlanKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKs extends TranslationsInventoryEn {
	_TranslationsInventoryKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKs extends TranslationsUpgradeEn {
	_TranslationsUpgradeKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKs extends TranslationsTourEn {
	_TranslationsTourKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKs extends TranslationsErrorsEn {
	_TranslationsErrorsKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKs._(TranslationsKs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKs metric = _TranslationsSettingsMeasurementsMetricKs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKs imperial = _TranslationsSettingsMeasurementsImperialKs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKs._(TranslationsKs root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ks>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKs {
