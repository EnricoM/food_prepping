...
class TranslationsNe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppNe app = _TranslationsAppNe._(_root);
	@override late final _TranslationsHomeNe home = _TranslationsHomeNe._(_root);
	@override late final _TranslationsCommonNe common = _TranslationsCommonNe._(_root);
	@override late final _TranslationsSettingsNe settings = _TranslationsSettingsNe._(_root);
	@override late final _TranslationsRecipesNe recipes = _TranslationsRecipesNe._(_root);
	@override late final _TranslationsRecipeDetailNe recipeDetail = _TranslationsRecipeDetailNe._(_root);
	@override late final _TranslationsFiltersNe filters = _TranslationsFiltersNe._(_root);
	@override late final _TranslationsShoppingListNe shoppingList = _TranslationsShoppingListNe._(_root);
	@override late final _TranslationsMealPlanNe mealPlan = _TranslationsMealPlanNe._(_root);
	@override late final _TranslationsInventoryNe inventory = _TranslationsInventoryNe._(_root);
	@override late final _TranslationsBarcodeScanNe barcodeScan = _TranslationsBarcodeScanNe._(_root);
	@override late final _TranslationsReceiptScanNe receiptScan = _TranslationsReceiptScanNe._(_root);
	@override late final _TranslationsBatchCookingNe batchCooking = _TranslationsBatchCookingNe._(_root);
	@override late final _TranslationsVisitedDomainsNe visitedDomains = _TranslationsVisitedDomainsNe._(_root);
	@override late final _TranslationsDomainDiscoveryNe domainDiscovery = _TranslationsDomainDiscoveryNe._(_root);
	@override late final _TranslationsInventorySuggestionsNe inventorySuggestions = _TranslationsInventorySuggestionsNe._(_root);
	@override late final _TranslationsUpgradeNe upgrade = _TranslationsUpgradeNe._(_root);
	@override late final _TranslationsTourNe tour = _TranslationsTourNe._(_root);
	@override late final _TranslationsManualRecipeNe manualRecipe = _TranslationsManualRecipeNe._(_root);
	@override late final _TranslationsRecipeEditNe recipeEdit = _TranslationsRecipeEditNe._(_root);
	@override late final _TranslationsErrorsNe errors = _TranslationsErrorsNe._(_root);
}

// Path: app
class _TranslationsAppNe extends TranslationsAppEn {
	_TranslationsAppNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeNe extends TranslationsHomeEn {
	_TranslationsHomeNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNe extends TranslationsCommonEn {
	_TranslationsCommonNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNe extends TranslationsSettingsEn {
	_TranslationsSettingsNe._(TranslationsNe root) : this._root = root, super.internal(root);

	final TranslationsNe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNe measurements = _TranslationsSettingsMeasurementsNe._(_root);
	@override late final _TranslationsSettingsDataManagementNe dataManagement = _TranslationsSettingsDataManagementNe._(_root);
	@override late final _TranslationsSettingsVersionNe version = _TranslationsSettingsVersionNe._(_root);
}

// Path: recipes
class _TranslationsRecipesNe extends TranslationsRecipesEn {
	_TranslationsRecipesNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNe._(TranslationsNe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNe nutrition = _TranslationsRecipeDetailNutritionNe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNe prepAhead = _TranslationsRecipeDetailPrepAheadNe._(_root);
...
// Path: filters
class _TranslationsFiltersNe extends TranslationsFiltersEn {
	_TranslationsFiltersNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNe extends TranslationsShoppingListEn {
	_TranslationsShoppingListNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNe extends TranslationsMealPlanEn {
	_TranslationsMealPlanNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNe extends TranslationsInventoryEn {
	_TranslationsInventoryNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNe extends TranslationsUpgradeEn {
	_TranslationsUpgradeNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNe extends TranslationsTourEn {
	_TranslationsTourNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNe extends TranslationsErrorsEn {
	_TranslationsErrorsNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNe._(TranslationsNe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNe metric = _TranslationsSettingsMeasurementsMetricNe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNe imperial = _TranslationsSettingsMeasurementsImperialNe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNe._(TranslationsNe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNe._(TranslationsNe root) : this._root = root, super.internal(root);
