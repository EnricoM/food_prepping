...
// Path: <root>
class TranslationsKa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsKa _root = this; // ignore: unused_field

	@override 
	TranslationsKa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKa app = _TranslationsAppKa._(_root);
	@override late final _TranslationsHomeKa home = _TranslationsHomeKa._(_root);
	@override late final _TranslationsCommonKa common = _TranslationsCommonKa._(_root);
	@override late final _TranslationsSettingsKa settings = _TranslationsSettingsKa._(_root);
	@override late final _TranslationsRecipesKa recipes = _TranslationsRecipesKa._(_root);
	@override late final _TranslationsRecipeDetailKa recipeDetail = _TranslationsRecipeDetailKa._(_root);
	@override late final _TranslationsFiltersKa filters = _TranslationsFiltersKa._(_root);
	@override late final _TranslationsShoppingListKa shoppingList = _TranslationsShoppingListKa._(_root);
	@override late final _TranslationsMealPlanKa mealPlan = _TranslationsMealPlanKa._(_root);
	@override late final _TranslationsInventoryKa inventory = _TranslationsInventoryKa._(_root);
	@override late final _TranslationsBarcodeScanKa barcodeScan = _TranslationsBarcodeScanKa._(_root);
	@override late final _TranslationsReceiptScanKa receiptScan = _TranslationsReceiptScanKa._(_root);
	@override late final _TranslationsBatchCookingKa batchCooking = _TranslationsBatchCookingKa._(_root);
	@override late final _TranslationsVisitedDomainsKa visitedDomains = _TranslationsVisitedDomainsKa._(_root);
	@override late final _TranslationsDomainDiscoveryKa domainDiscovery = _TranslationsDomainDiscoveryKa._(_root);
	@override late final _TranslationsInventorySuggestionsKa inventorySuggestions = _TranslationsInventorySuggestionsKa._(_root);
	@override late final _TranslationsUpgradeKa upgrade = _TranslationsUpgradeKa._(_root);
	@override late final _TranslationsTourKa tour = _TranslationsTourKa._(_root);
	@override late final _TranslationsManualRecipeKa manualRecipe = _TranslationsManualRecipeKa._(_root);
	@override late final _TranslationsRecipeEditKa recipeEdit = _TranslationsRecipeEditKa._(_root);
	@override late final _TranslationsErrorsKa errors = _TranslationsErrorsKa._(_root);
}

// Path: app
class _TranslationsAppKa extends TranslationsAppEn {
	_TranslationsAppKa._(TranslationsKa root) : this._root = root, super.internal(root);

	final TranslationsKa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKa extends TranslationsHomeEn {
	_TranslationsHomeKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKa extends TranslationsCommonEn {
	_TranslationsCommonKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKa extends TranslationsSettingsEn {
	_TranslationsSettingsKa._(TranslationsKa root) : this._root = root, super.internal(root);

	final TranslationsKa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKa measurements = _TranslationsSettingsMeasurementsKa._(_root);
	@override late final _TranslationsSettingsDataManagementKa dataManagement = _TranslationsSettingsDataManagementKa._(_root);
	@override late final _TranslationsSettingsVersionKa version = _TranslationsSettingsVersionKa._(_root);
}

// Path: recipes
class _TranslationsRecipesKa extends TranslationsRecipesEn {
	_TranslationsRecipesKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKa._(TranslationsKa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKa nutrition = _TranslationsRecipeDetailNutritionKa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKa prepAhead = _TranslationsRecipeDetailPrepAheadKa._(_root);
...
// Path: filters
class _TranslationsFiltersKa extends TranslationsFiltersEn {
	_TranslationsFiltersKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKa extends TranslationsShoppingListEn {
	_TranslationsShoppingListKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKa extends TranslationsMealPlanEn {
	_TranslationsMealPlanKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKa extends TranslationsInventoryEn {
	_TranslationsInventoryKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKa extends TranslationsUpgradeEn {
	_TranslationsUpgradeKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKa extends TranslationsTourEn {
	_TranslationsTourKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKa extends TranslationsErrorsEn {
	_TranslationsErrorsKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKa._(TranslationsKa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKa metric = _TranslationsSettingsMeasurementsMetricKa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKa imperial = _TranslationsSettingsMeasurementsImperialKa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKa._(TranslationsKa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKa._(TranslationsKa root) : this._root = root, super.internal(root);
