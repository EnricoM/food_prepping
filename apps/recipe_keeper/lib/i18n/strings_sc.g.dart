...
// Path: <root>
class TranslationsSc extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSc({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <sc>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSc _root = this; // ignore: unused_field

	@override 
	TranslationsSc $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSc(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSc app = _TranslationsAppSc._(_root);
	@override late final _TranslationsHomeSc home = _TranslationsHomeSc._(_root);
	@override late final _TranslationsCommonSc common = _TranslationsCommonSc._(_root);
	@override late final _TranslationsSettingsSc settings = _TranslationsSettingsSc._(_root);
	@override late final _TranslationsRecipesSc recipes = _TranslationsRecipesSc._(_root);
	@override late final _TranslationsRecipeDetailSc recipeDetail = _TranslationsRecipeDetailSc._(_root);
	@override late final _TranslationsFiltersSc filters = _TranslationsFiltersSc._(_root);
	@override late final _TranslationsShoppingListSc shoppingList = _TranslationsShoppingListSc._(_root);
	@override late final _TranslationsMealPlanSc mealPlan = _TranslationsMealPlanSc._(_root);
	@override late final _TranslationsInventorySc inventory = _TranslationsInventorySc._(_root);
	@override late final _TranslationsBarcodeScanSc barcodeScan = _TranslationsBarcodeScanSc._(_root);
	@override late final _TranslationsReceiptScanSc receiptScan = _TranslationsReceiptScanSc._(_root);
	@override late final _TranslationsBatchCookingSc batchCooking = _TranslationsBatchCookingSc._(_root);
	@override late final _TranslationsVisitedDomainsSc visitedDomains = _TranslationsVisitedDomainsSc._(_root);
	@override late final _TranslationsDomainDiscoverySc domainDiscovery = _TranslationsDomainDiscoverySc._(_root);
	@override late final _TranslationsInventorySuggestionsSc inventorySuggestions = _TranslationsInventorySuggestionsSc._(_root);
	@override late final _TranslationsUpgradeSc upgrade = _TranslationsUpgradeSc._(_root);
	@override late final _TranslationsTourSc tour = _TranslationsTourSc._(_root);
	@override late final _TranslationsManualRecipeSc manualRecipe = _TranslationsManualRecipeSc._(_root);
	@override late final _TranslationsRecipeEditSc recipeEdit = _TranslationsRecipeEditSc._(_root);
	@override late final _TranslationsErrorsSc errors = _TranslationsErrorsSc._(_root);
}

// Path: app
class _TranslationsAppSc extends TranslationsAppEn {
	_TranslationsAppSc._(TranslationsSc root) : this._root = root, super.internal(root);

	final TranslationsSc _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSc extends TranslationsHomeEn {
	_TranslationsHomeSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSc extends TranslationsCommonEn {
	_TranslationsCommonSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSc extends TranslationsSettingsEn {
	_TranslationsSettingsSc._(TranslationsSc root) : this._root = root, super.internal(root);

	final TranslationsSc _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSc measurements = _TranslationsSettingsMeasurementsSc._(_root);
	@override late final _TranslationsSettingsDataManagementSc dataManagement = _TranslationsSettingsDataManagementSc._(_root);
	@override late final _TranslationsSettingsVersionSc version = _TranslationsSettingsVersionSc._(_root);
}

// Path: recipes
class _TranslationsRecipesSc extends TranslationsRecipesEn {
	_TranslationsRecipesSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSc extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSc._(TranslationsSc root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSc nutrition = _TranslationsRecipeDetailNutritionSc._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSc prepAhead = _TranslationsRecipeDetailPrepAheadSc._(_root);
...
// Path: filters
class _TranslationsFiltersSc extends TranslationsFiltersEn {
	_TranslationsFiltersSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSc extends TranslationsShoppingListEn {
	_TranslationsShoppingListSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSc extends TranslationsMealPlanEn {
	_TranslationsMealPlanSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySc extends TranslationsInventoryEn {
	_TranslationsInventorySc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSc extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSc extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSc extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSc extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySc extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSc extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSc extends TranslationsUpgradeEn {
	_TranslationsUpgradeSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSc extends TranslationsTourEn {
	_TranslationsTourSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSc extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSc extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSc extends TranslationsErrorsEn {
	_TranslationsErrorsSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSc extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSc._(TranslationsSc root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSc metric = _TranslationsSettingsMeasurementsMetricSc._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSc imperial = _TranslationsSettingsMeasurementsImperialSc._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSc extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSc extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSc extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSc extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSc extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSc extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSc._(TranslationsSc root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sc>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSc {
