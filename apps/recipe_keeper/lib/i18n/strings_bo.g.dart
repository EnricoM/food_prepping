...
// Path: <root>
class TranslationsBo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsBo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	late final TranslationsBo _root = this; // ignore: unused_field

	@override 
	TranslationsBo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsBo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppBo app = _TranslationsAppBo._(_root);
	@override late final _TranslationsHomeBo home = _TranslationsHomeBo._(_root);
	@override late final _TranslationsCommonBo common = _TranslationsCommonBo._(_root);
	@override late final _TranslationsSettingsBo settings = _TranslationsSettingsBo._(_root);
	@override late final _TranslationsRecipesBo recipes = _TranslationsRecipesBo._(_root);
	@override late final _TranslationsRecipeDetailBo recipeDetail = _TranslationsRecipeDetailBo._(_root);
	@override late final _TranslationsFiltersBo filters = _TranslationsFiltersBo._(_root);
	@override late final _TranslationsShoppingListBo shoppingList = _TranslationsShoppingListBo._(_root);
	@override late final _TranslationsMealPlanBo mealPlan = _TranslationsMealPlanBo._(_root);
	@override late final _TranslationsInventoryBo inventory = _TranslationsInventoryBo._(_root);
	@override late final _TranslationsBarcodeScanBo barcodeScan = _TranslationsBarcodeScanBo._(_root);
	@override late final _TranslationsReceiptScanBo receiptScan = _TranslationsReceiptScanBo._(_root);
	@override late final _TranslationsBatchCookingBo batchCooking = _TranslationsBatchCookingBo._(_root);
	@override late final _TranslationsVisitedDomainsBo visitedDomains = _TranslationsVisitedDomainsBo._(_root);
	@override late final _TranslationsDomainDiscoveryBo domainDiscovery = _TranslationsDomainDiscoveryBo._(_root);
	@override late final _TranslationsInventorySuggestionsBo inventorySuggestions = _TranslationsInventorySuggestionsBo._(_root);
	@override late final _TranslationsUpgradeBo upgrade = _TranslationsUpgradeBo._(_root);
	@override late final _TranslationsTourBo tour = _TranslationsTourBo._(_root);
	@override late final _TranslationsManualRecipeBo manualRecipe = _TranslationsManualRecipeBo._(_root);
	@override late final _TranslationsRecipeEditBo recipeEdit = _TranslationsRecipeEditBo._(_root);
	@override late final _TranslationsErrorsBo errors = _TranslationsErrorsBo._(_root);
}

// Path: app
class _TranslationsAppBo extends TranslationsAppEn {
	_TranslationsAppBo._(TranslationsBo root) : this._root = root, super.internal(root);

	final TranslationsBo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeBo extends TranslationsHomeEn {
	_TranslationsHomeBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBo extends TranslationsCommonEn {
	_TranslationsCommonBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBo extends TranslationsSettingsEn {
	_TranslationsSettingsBo._(TranslationsBo root) : this._root = root, super.internal(root);

	final TranslationsBo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBo measurements = _TranslationsSettingsMeasurementsBo._(_root);
	@override late final _TranslationsSettingsDataManagementBo dataManagement = _TranslationsSettingsDataManagementBo._(_root);
	@override late final _TranslationsSettingsVersionBo version = _TranslationsSettingsVersionBo._(_root);
}

// Path: recipes
class _TranslationsRecipesBo extends TranslationsRecipesEn {
	_TranslationsRecipesBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBo._(TranslationsBo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBo nutrition = _TranslationsRecipeDetailNutritionBo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBo prepAhead = _TranslationsRecipeDetailPrepAheadBo._(_root);
...
// Path: filters
class _TranslationsFiltersBo extends TranslationsFiltersEn {
	_TranslationsFiltersBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBo extends TranslationsShoppingListEn {
	_TranslationsShoppingListBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBo extends TranslationsMealPlanEn {
	_TranslationsMealPlanBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBo extends TranslationsInventoryEn {
	_TranslationsInventoryBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBo extends TranslationsUpgradeEn {
	_TranslationsUpgradeBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBo extends TranslationsTourEn {
	_TranslationsTourBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBo extends TranslationsErrorsEn {
	_TranslationsErrorsBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBo._(TranslationsBo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBo metric = _TranslationsSettingsMeasurementsMetricBo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBo imperial = _TranslationsSettingsMeasurementsImperialBo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBo._(TranslationsBo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBo._(TranslationsBo root) : this._root = root, super.internal(root);
