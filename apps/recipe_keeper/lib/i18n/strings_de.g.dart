...
class TranslationsDe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesDe recipes = _TranslationsRecipesDe._(_root);
	@override late final _TranslationsRecipeDetailDe recipeDetail = _TranslationsRecipeDetailDe._(_root);
	@override late final _TranslationsFiltersDe filters = _TranslationsFiltersDe._(_root);
	@override late final _TranslationsShoppingListDe shoppingList = _TranslationsShoppingListDe._(_root);
	@override late final _TranslationsMealPlanDe mealPlan = _TranslationsMealPlanDe._(_root);
	@override late final _TranslationsInventoryDe inventory = _TranslationsInventoryDe._(_root);
	@override late final _TranslationsBarcodeScanDe barcodeScan = _TranslationsBarcodeScanDe._(_root);
	@override late final _TranslationsReceiptScanDe receiptScan = _TranslationsReceiptScanDe._(_root);
	@override late final _TranslationsBatchCookingDe batchCooking = _TranslationsBatchCookingDe._(_root);
	@override late final _TranslationsVisitedDomainsDe visitedDomains = _TranslationsVisitedDomainsDe._(_root);
	@override late final _TranslationsDomainDiscoveryDe domainDiscovery = _TranslationsDomainDiscoveryDe._(_root);
	@override late final _TranslationsInventorySuggestionsDe inventorySuggestions = _TranslationsInventorySuggestionsDe._(_root);
	@override late final _TranslationsUpgradeDe upgrade = _TranslationsUpgradeDe._(_root);
	@override late final _TranslationsTourDe tour = _TranslationsTourDe._(_root);
	@override late final _TranslationsManualRecipeDe manualRecipe = _TranslationsManualRecipeDe._(_root);
	@override late final _TranslationsRecipeEditDe recipeEdit = _TranslationsRecipeEditDe._(_root);
...
class _TranslationsSettingsDe extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsDe measurements = _TranslationsSettingsMeasurementsDe._(_root);
	@override late final _TranslationsSettingsDataManagementDe dataManagement = _TranslationsSettingsDataManagementDe._(_root);
	@override late final _TranslationsSettingsVersionDe version = _TranslationsSettingsVersionDe._(_root);
}

// Path: recipes
class _TranslationsRecipesDe extends TranslationsRecipesEn {
	_TranslationsRecipesDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailDe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailDe._(TranslationsDe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionDe nutrition = _TranslationsRecipeDetailNutritionDe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadDe prepAhead = _TranslationsRecipeDetailPrepAheadDe._(_root);
...
// Path: filters
class _TranslationsFiltersDe extends TranslationsFiltersEn {
	_TranslationsFiltersDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListDe extends TranslationsShoppingListEn {
	_TranslationsShoppingListDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanDe extends TranslationsMealPlanEn {
	_TranslationsMealPlanDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryDe extends TranslationsInventoryEn {
	_TranslationsInventoryDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanDe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanDe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingDe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsDe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryDe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsDe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeDe extends TranslationsUpgradeEn {
	_TranslationsUpgradeDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourDe extends TranslationsTourEn {
	_TranslationsTourDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeDe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditDe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsDe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsDe._(TranslationsDe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricDe metric = _TranslationsSettingsMeasurementsMetricDe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialDe imperial = _TranslationsSettingsMeasurementsImperialDe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementDe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionDe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionDe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadDe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricDe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricDe._(TranslationsDe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialDe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialDe._(TranslationsDe root) : this._root = root, super.internal(root);
