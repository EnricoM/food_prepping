...
class TranslationsJa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesJa recipes = _TranslationsRecipesJa._(_root);
	@override late final _TranslationsRecipeDetailJa recipeDetail = _TranslationsRecipeDetailJa._(_root);
	@override late final _TranslationsFiltersJa filters = _TranslationsFiltersJa._(_root);
	@override late final _TranslationsShoppingListJa shoppingList = _TranslationsShoppingListJa._(_root);
	@override late final _TranslationsMealPlanJa mealPlan = _TranslationsMealPlanJa._(_root);
	@override late final _TranslationsInventoryJa inventory = _TranslationsInventoryJa._(_root);
	@override late final _TranslationsBarcodeScanJa barcodeScan = _TranslationsBarcodeScanJa._(_root);
	@override late final _TranslationsReceiptScanJa receiptScan = _TranslationsReceiptScanJa._(_root);
	@override late final _TranslationsBatchCookingJa batchCooking = _TranslationsBatchCookingJa._(_root);
	@override late final _TranslationsVisitedDomainsJa visitedDomains = _TranslationsVisitedDomainsJa._(_root);
	@override late final _TranslationsDomainDiscoveryJa domainDiscovery = _TranslationsDomainDiscoveryJa._(_root);
	@override late final _TranslationsInventorySuggestionsJa inventorySuggestions = _TranslationsInventorySuggestionsJa._(_root);
	@override late final _TranslationsUpgradeJa upgrade = _TranslationsUpgradeJa._(_root);
	@override late final _TranslationsTourJa tour = _TranslationsTourJa._(_root);
	@override late final _TranslationsManualRecipeJa manualRecipe = _TranslationsManualRecipeJa._(_root);
	@override late final _TranslationsRecipeEditJa recipeEdit = _TranslationsRecipeEditJa._(_root);
...
class _TranslationsSettingsJa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsJa measurements = _TranslationsSettingsMeasurementsJa._(_root);
	@override late final _TranslationsSettingsDataManagementJa dataManagement = _TranslationsSettingsDataManagementJa._(_root);
	@override late final _TranslationsSettingsVersionJa version = _TranslationsSettingsVersionJa._(_root);
}

// Path: recipes
class _TranslationsRecipesJa extends TranslationsRecipesEn {
	_TranslationsRecipesJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailJa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailJa._(TranslationsJa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionJa nutrition = _TranslationsRecipeDetailNutritionJa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadJa prepAhead = _TranslationsRecipeDetailPrepAheadJa._(_root);
...
// Path: filters
class _TranslationsFiltersJa extends TranslationsFiltersEn {
	_TranslationsFiltersJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListJa extends TranslationsShoppingListEn {
	_TranslationsShoppingListJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanJa extends TranslationsMealPlanEn {
	_TranslationsMealPlanJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryJa extends TranslationsInventoryEn {
	_TranslationsInventoryJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanJa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanJa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingJa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsJa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryJa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsJa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeJa extends TranslationsUpgradeEn {
	_TranslationsUpgradeJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourJa extends TranslationsTourEn {
	_TranslationsTourJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeJa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditJa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsJa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsJa._(TranslationsJa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricJa metric = _TranslationsSettingsMeasurementsMetricJa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialJa imperial = _TranslationsSettingsMeasurementsImperialJa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementJa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionJa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionJa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadJa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricJa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricJa._(TranslationsJa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialJa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialJa._(TranslationsJa root) : this._root = root, super.internal(root);
