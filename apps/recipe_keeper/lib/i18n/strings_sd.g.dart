...
// Path: <root>
class TranslationsSd extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSd({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <sd>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSd _root = this; // ignore: unused_field

	@override 
	TranslationsSd $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSd(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSd app = _TranslationsAppSd._(_root);
	@override late final _TranslationsHomeSd home = _TranslationsHomeSd._(_root);
	@override late final _TranslationsCommonSd common = _TranslationsCommonSd._(_root);
	@override late final _TranslationsSettingsSd settings = _TranslationsSettingsSd._(_root);
	@override late final _TranslationsRecipesSd recipes = _TranslationsRecipesSd._(_root);
	@override late final _TranslationsRecipeDetailSd recipeDetail = _TranslationsRecipeDetailSd._(_root);
	@override late final _TranslationsFiltersSd filters = _TranslationsFiltersSd._(_root);
	@override late final _TranslationsShoppingListSd shoppingList = _TranslationsShoppingListSd._(_root);
	@override late final _TranslationsMealPlanSd mealPlan = _TranslationsMealPlanSd._(_root);
	@override late final _TranslationsInventorySd inventory = _TranslationsInventorySd._(_root);
	@override late final _TranslationsBarcodeScanSd barcodeScan = _TranslationsBarcodeScanSd._(_root);
	@override late final _TranslationsReceiptScanSd receiptScan = _TranslationsReceiptScanSd._(_root);
	@override late final _TranslationsBatchCookingSd batchCooking = _TranslationsBatchCookingSd._(_root);
	@override late final _TranslationsVisitedDomainsSd visitedDomains = _TranslationsVisitedDomainsSd._(_root);
	@override late final _TranslationsDomainDiscoverySd domainDiscovery = _TranslationsDomainDiscoverySd._(_root);
	@override late final _TranslationsInventorySuggestionsSd inventorySuggestions = _TranslationsInventorySuggestionsSd._(_root);
	@override late final _TranslationsUpgradeSd upgrade = _TranslationsUpgradeSd._(_root);
	@override late final _TranslationsTourSd tour = _TranslationsTourSd._(_root);
	@override late final _TranslationsManualRecipeSd manualRecipe = _TranslationsManualRecipeSd._(_root);
	@override late final _TranslationsRecipeEditSd recipeEdit = _TranslationsRecipeEditSd._(_root);
	@override late final _TranslationsErrorsSd errors = _TranslationsErrorsSd._(_root);
}

// Path: app
class _TranslationsAppSd extends TranslationsAppEn {
	_TranslationsAppSd._(TranslationsSd root) : this._root = root, super.internal(root);

	final TranslationsSd _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSd extends TranslationsHomeEn {
	_TranslationsHomeSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSd extends TranslationsCommonEn {
	_TranslationsCommonSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSd extends TranslationsSettingsEn {
	_TranslationsSettingsSd._(TranslationsSd root) : this._root = root, super.internal(root);

	final TranslationsSd _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSd measurements = _TranslationsSettingsMeasurementsSd._(_root);
	@override late final _TranslationsSettingsDataManagementSd dataManagement = _TranslationsSettingsDataManagementSd._(_root);
	@override late final _TranslationsSettingsVersionSd version = _TranslationsSettingsVersionSd._(_root);
}

// Path: recipes
class _TranslationsRecipesSd extends TranslationsRecipesEn {
	_TranslationsRecipesSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSd extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSd._(TranslationsSd root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSd nutrition = _TranslationsRecipeDetailNutritionSd._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSd prepAhead = _TranslationsRecipeDetailPrepAheadSd._(_root);
...
// Path: filters
class _TranslationsFiltersSd extends TranslationsFiltersEn {
	_TranslationsFiltersSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSd extends TranslationsShoppingListEn {
	_TranslationsShoppingListSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSd extends TranslationsMealPlanEn {
	_TranslationsMealPlanSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySd extends TranslationsInventoryEn {
	_TranslationsInventorySd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSd extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSd extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSd extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSd extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySd extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSd extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSd extends TranslationsUpgradeEn {
	_TranslationsUpgradeSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSd extends TranslationsTourEn {
	_TranslationsTourSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSd extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSd extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSd extends TranslationsErrorsEn {
	_TranslationsErrorsSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSd extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSd._(TranslationsSd root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSd metric = _TranslationsSettingsMeasurementsMetricSd._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSd imperial = _TranslationsSettingsMeasurementsImperialSd._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSd extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSd extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSd extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSd extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSd extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSd extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSd._(TranslationsSd root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sd>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSd {
