...
// Path: <root>
class TranslationsAzAz extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAzAz({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.azAz,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <az-AZ>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAzAz _root = this; // ignore: unused_field

	@override 
	TranslationsAzAz $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAzAz(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAzAz app = _TranslationsAppAzAz._(_root);
	@override late final _TranslationsHomeAzAz home = _TranslationsHomeAzAz._(_root);
	@override late final _TranslationsCommonAzAz common = _TranslationsCommonAzAz._(_root);
	@override late final _TranslationsSettingsAzAz settings = _TranslationsSettingsAzAz._(_root);
	@override late final _TranslationsRecipesAzAz recipes = _TranslationsRecipesAzAz._(_root);
	@override late final _TranslationsRecipeDetailAzAz recipeDetail = _TranslationsRecipeDetailAzAz._(_root);
	@override late final _TranslationsFiltersAzAz filters = _TranslationsFiltersAzAz._(_root);
	@override late final _TranslationsShoppingListAzAz shoppingList = _TranslationsShoppingListAzAz._(_root);
	@override late final _TranslationsMealPlanAzAz mealPlan = _TranslationsMealPlanAzAz._(_root);
	@override late final _TranslationsInventoryAzAz inventory = _TranslationsInventoryAzAz._(_root);
	@override late final _TranslationsBarcodeScanAzAz barcodeScan = _TranslationsBarcodeScanAzAz._(_root);
	@override late final _TranslationsReceiptScanAzAz receiptScan = _TranslationsReceiptScanAzAz._(_root);
	@override late final _TranslationsBatchCookingAzAz batchCooking = _TranslationsBatchCookingAzAz._(_root);
	@override late final _TranslationsVisitedDomainsAzAz visitedDomains = _TranslationsVisitedDomainsAzAz._(_root);
	@override late final _TranslationsDomainDiscoveryAzAz domainDiscovery = _TranslationsDomainDiscoveryAzAz._(_root);
	@override late final _TranslationsInventorySuggestionsAzAz inventorySuggestions = _TranslationsInventorySuggestionsAzAz._(_root);
	@override late final _TranslationsUpgradeAzAz upgrade = _TranslationsUpgradeAzAz._(_root);
	@override late final _TranslationsTourAzAz tour = _TranslationsTourAzAz._(_root);
	@override late final _TranslationsManualRecipeAzAz manualRecipe = _TranslationsManualRecipeAzAz._(_root);
	@override late final _TranslationsRecipeEditAzAz recipeEdit = _TranslationsRecipeEditAzAz._(_root);
	@override late final _TranslationsErrorsAzAz errors = _TranslationsErrorsAzAz._(_root);
}

// Path: app
class _TranslationsAppAzAz extends TranslationsAppEn {
	_TranslationsAppAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);

	final TranslationsAzAz _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAzAz extends TranslationsHomeEn {
	_TranslationsHomeAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAzAz extends TranslationsCommonEn {
	_TranslationsCommonAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAzAz extends TranslationsSettingsEn {
	_TranslationsSettingsAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);

	final TranslationsAzAz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAzAz measurements = _TranslationsSettingsMeasurementsAzAz._(_root);
	@override late final _TranslationsSettingsDataManagementAzAz dataManagement = _TranslationsSettingsDataManagementAzAz._(_root);
	@override late final _TranslationsSettingsVersionAzAz version = _TranslationsSettingsVersionAzAz._(_root);
}

// Path: recipes
class _TranslationsRecipesAzAz extends TranslationsRecipesEn {
	_TranslationsRecipesAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAzAz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAzAz nutrition = _TranslationsRecipeDetailNutritionAzAz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAzAz prepAhead = _TranslationsRecipeDetailPrepAheadAzAz._(_root);
...
// Path: filters
class _TranslationsFiltersAzAz extends TranslationsFiltersEn {
	_TranslationsFiltersAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAzAz extends TranslationsShoppingListEn {
	_TranslationsShoppingListAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAzAz extends TranslationsMealPlanEn {
	_TranslationsMealPlanAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAzAz extends TranslationsInventoryEn {
	_TranslationsInventoryAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAzAz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAzAz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAzAz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAzAz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAzAz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAzAz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAzAz extends TranslationsUpgradeEn {
	_TranslationsUpgradeAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAzAz extends TranslationsTourEn {
	_TranslationsTourAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAzAz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAzAz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAzAz extends TranslationsErrorsEn {
	_TranslationsErrorsAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAzAz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAzAz metric = _TranslationsSettingsMeasurementsMetricAzAz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAzAz imperial = _TranslationsSettingsMeasurementsImperialAzAz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAzAz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAzAz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAzAz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAzAz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAzAz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAzAz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAzAz._(TranslationsAzAz root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <az-AZ>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAzAz {
