...
class TranslationsHy extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppHy app = _TranslationsAppHy._(_root);
	@override late final _TranslationsHomeHy home = _TranslationsHomeHy._(_root);
	@override late final _TranslationsCommonHy common = _TranslationsCommonHy._(_root);
	@override late final _TranslationsSettingsHy settings = _TranslationsSettingsHy._(_root);
	@override late final _TranslationsRecipesHy recipes = _TranslationsRecipesHy._(_root);
	@override late final _TranslationsRecipeDetailHy recipeDetail = _TranslationsRecipeDetailHy._(_root);
	@override late final _TranslationsFiltersHy filters = _TranslationsFiltersHy._(_root);
	@override late final _TranslationsShoppingListHy shoppingList = _TranslationsShoppingListHy._(_root);
	@override late final _TranslationsMealPlanHy mealPlan = _TranslationsMealPlanHy._(_root);
	@override late final _TranslationsInventoryHy inventory = _TranslationsInventoryHy._(_root);
	@override late final _TranslationsBarcodeScanHy barcodeScan = _TranslationsBarcodeScanHy._(_root);
	@override late final _TranslationsReceiptScanHy receiptScan = _TranslationsReceiptScanHy._(_root);
	@override late final _TranslationsBatchCookingHy batchCooking = _TranslationsBatchCookingHy._(_root);
	@override late final _TranslationsVisitedDomainsHy visitedDomains = _TranslationsVisitedDomainsHy._(_root);
	@override late final _TranslationsDomainDiscoveryHy domainDiscovery = _TranslationsDomainDiscoveryHy._(_root);
	@override late final _TranslationsInventorySuggestionsHy inventorySuggestions = _TranslationsInventorySuggestionsHy._(_root);
	@override late final _TranslationsUpgradeHy upgrade = _TranslationsUpgradeHy._(_root);
	@override late final _TranslationsTourHy tour = _TranslationsTourHy._(_root);
	@override late final _TranslationsManualRecipeHy manualRecipe = _TranslationsManualRecipeHy._(_root);
	@override late final _TranslationsRecipeEditHy recipeEdit = _TranslationsRecipeEditHy._(_root);
	@override late final _TranslationsErrorsHy errors = _TranslationsErrorsHy._(_root);
}

// Path: app
class _TranslationsAppHy extends TranslationsAppEn {
	_TranslationsAppHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeHy extends TranslationsHomeEn {
	_TranslationsHomeHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHy extends TranslationsCommonEn {
	_TranslationsCommonHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHy extends TranslationsSettingsEn {
	_TranslationsSettingsHy._(TranslationsHy root) : this._root = root, super.internal(root);

	final TranslationsHy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHy measurements = _TranslationsSettingsMeasurementsHy._(_root);
	@override late final _TranslationsSettingsDataManagementHy dataManagement = _TranslationsSettingsDataManagementHy._(_root);
	@override late final _TranslationsSettingsVersionHy version = _TranslationsSettingsVersionHy._(_root);
}

// Path: recipes
class _TranslationsRecipesHy extends TranslationsRecipesEn {
	_TranslationsRecipesHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHy._(TranslationsHy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHy nutrition = _TranslationsRecipeDetailNutritionHy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHy prepAhead = _TranslationsRecipeDetailPrepAheadHy._(_root);
...
// Path: filters
class _TranslationsFiltersHy extends TranslationsFiltersEn {
	_TranslationsFiltersHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHy extends TranslationsShoppingListEn {
	_TranslationsShoppingListHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHy extends TranslationsMealPlanEn {
	_TranslationsMealPlanHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHy extends TranslationsInventoryEn {
	_TranslationsInventoryHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHy extends TranslationsUpgradeEn {
	_TranslationsUpgradeHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHy extends TranslationsTourEn {
	_TranslationsTourHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHy._(TranslationsHy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHy metric = _TranslationsSettingsMeasurementsMetricHy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHy imperial = _TranslationsSettingsMeasurementsImperialHy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHy._(TranslationsHy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHy._(TranslationsHy root) : this._root = root, super.internal(root);
