...
// Path: <root>
class TranslationsAb extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAb({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ab>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAb _root = this; // ignore: unused_field

	@override 
	TranslationsAb $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAb(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAb app = _TranslationsAppAb._(_root);
	@override late final _TranslationsHomeAb home = _TranslationsHomeAb._(_root);
	@override late final _TranslationsCommonAb common = _TranslationsCommonAb._(_root);
	@override late final _TranslationsSettingsAb settings = _TranslationsSettingsAb._(_root);
	@override late final _TranslationsRecipesAb recipes = _TranslationsRecipesAb._(_root);
	@override late final _TranslationsRecipeDetailAb recipeDetail = _TranslationsRecipeDetailAb._(_root);
	@override late final _TranslationsFiltersAb filters = _TranslationsFiltersAb._(_root);
	@override late final _TranslationsShoppingListAb shoppingList = _TranslationsShoppingListAb._(_root);
	@override late final _TranslationsMealPlanAb mealPlan = _TranslationsMealPlanAb._(_root);
	@override late final _TranslationsInventoryAb inventory = _TranslationsInventoryAb._(_root);
	@override late final _TranslationsBarcodeScanAb barcodeScan = _TranslationsBarcodeScanAb._(_root);
	@override late final _TranslationsReceiptScanAb receiptScan = _TranslationsReceiptScanAb._(_root);
	@override late final _TranslationsBatchCookingAb batchCooking = _TranslationsBatchCookingAb._(_root);
	@override late final _TranslationsVisitedDomainsAb visitedDomains = _TranslationsVisitedDomainsAb._(_root);
	@override late final _TranslationsDomainDiscoveryAb domainDiscovery = _TranslationsDomainDiscoveryAb._(_root);
	@override late final _TranslationsInventorySuggestionsAb inventorySuggestions = _TranslationsInventorySuggestionsAb._(_root);
	@override late final _TranslationsUpgradeAb upgrade = _TranslationsUpgradeAb._(_root);
	@override late final _TranslationsTourAb tour = _TranslationsTourAb._(_root);
	@override late final _TranslationsManualRecipeAb manualRecipe = _TranslationsManualRecipeAb._(_root);
	@override late final _TranslationsRecipeEditAb recipeEdit = _TranslationsRecipeEditAb._(_root);
	@override late final _TranslationsErrorsAb errors = _TranslationsErrorsAb._(_root);
}

// Path: app
class _TranslationsAppAb extends TranslationsAppEn {
	_TranslationsAppAb._(TranslationsAb root) : this._root = root, super.internal(root);

	final TranslationsAb _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAb extends TranslationsHomeEn {
	_TranslationsHomeAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAb extends TranslationsCommonEn {
	_TranslationsCommonAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAb extends TranslationsSettingsEn {
	_TranslationsSettingsAb._(TranslationsAb root) : this._root = root, super.internal(root);

	final TranslationsAb _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAb measurements = _TranslationsSettingsMeasurementsAb._(_root);
	@override late final _TranslationsSettingsDataManagementAb dataManagement = _TranslationsSettingsDataManagementAb._(_root);
	@override late final _TranslationsSettingsVersionAb version = _TranslationsSettingsVersionAb._(_root);
}

// Path: recipes
class _TranslationsRecipesAb extends TranslationsRecipesEn {
	_TranslationsRecipesAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAb extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAb._(TranslationsAb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAb nutrition = _TranslationsRecipeDetailNutritionAb._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAb prepAhead = _TranslationsRecipeDetailPrepAheadAb._(_root);
...
// Path: filters
class _TranslationsFiltersAb extends TranslationsFiltersEn {
	_TranslationsFiltersAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAb extends TranslationsShoppingListEn {
	_TranslationsShoppingListAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAb extends TranslationsMealPlanEn {
	_TranslationsMealPlanAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAb extends TranslationsInventoryEn {
	_TranslationsInventoryAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAb extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAb extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAb extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAb extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAb extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAb extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAb extends TranslationsUpgradeEn {
	_TranslationsUpgradeAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAb extends TranslationsTourEn {
	_TranslationsTourAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAb extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAb extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAb extends TranslationsErrorsEn {
	_TranslationsErrorsAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAb extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAb._(TranslationsAb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAb metric = _TranslationsSettingsMeasurementsMetricAb._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAb imperial = _TranslationsSettingsMeasurementsImperialAb._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAb extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAb extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAb extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAb extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAb extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAb extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAb._(TranslationsAb root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ab>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAb {
