...
// Path: <root>
class TranslationsNd extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNd({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <nd>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNd _root = this; // ignore: unused_field

	@override 
	TranslationsNd $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNd(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNd app = _TranslationsAppNd._(_root);
	@override late final _TranslationsHomeNd home = _TranslationsHomeNd._(_root);
	@override late final _TranslationsCommonNd common = _TranslationsCommonNd._(_root);
	@override late final _TranslationsSettingsNd settings = _TranslationsSettingsNd._(_root);
	@override late final _TranslationsRecipesNd recipes = _TranslationsRecipesNd._(_root);
	@override late final _TranslationsRecipeDetailNd recipeDetail = _TranslationsRecipeDetailNd._(_root);
	@override late final _TranslationsFiltersNd filters = _TranslationsFiltersNd._(_root);
	@override late final _TranslationsShoppingListNd shoppingList = _TranslationsShoppingListNd._(_root);
	@override late final _TranslationsMealPlanNd mealPlan = _TranslationsMealPlanNd._(_root);
	@override late final _TranslationsInventoryNd inventory = _TranslationsInventoryNd._(_root);
	@override late final _TranslationsBarcodeScanNd barcodeScan = _TranslationsBarcodeScanNd._(_root);
	@override late final _TranslationsReceiptScanNd receiptScan = _TranslationsReceiptScanNd._(_root);
	@override late final _TranslationsBatchCookingNd batchCooking = _TranslationsBatchCookingNd._(_root);
	@override late final _TranslationsVisitedDomainsNd visitedDomains = _TranslationsVisitedDomainsNd._(_root);
	@override late final _TranslationsDomainDiscoveryNd domainDiscovery = _TranslationsDomainDiscoveryNd._(_root);
	@override late final _TranslationsInventorySuggestionsNd inventorySuggestions = _TranslationsInventorySuggestionsNd._(_root);
	@override late final _TranslationsUpgradeNd upgrade = _TranslationsUpgradeNd._(_root);
	@override late final _TranslationsTourNd tour = _TranslationsTourNd._(_root);
	@override late final _TranslationsManualRecipeNd manualRecipe = _TranslationsManualRecipeNd._(_root);
	@override late final _TranslationsRecipeEditNd recipeEdit = _TranslationsRecipeEditNd._(_root);
	@override late final _TranslationsErrorsNd errors = _TranslationsErrorsNd._(_root);
}

// Path: app
class _TranslationsAppNd extends TranslationsAppEn {
	_TranslationsAppNd._(TranslationsNd root) : this._root = root, super.internal(root);

	final TranslationsNd _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNd extends TranslationsHomeEn {
	_TranslationsHomeNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNd extends TranslationsCommonEn {
	_TranslationsCommonNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNd extends TranslationsSettingsEn {
	_TranslationsSettingsNd._(TranslationsNd root) : this._root = root, super.internal(root);

	final TranslationsNd _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNd measurements = _TranslationsSettingsMeasurementsNd._(_root);
	@override late final _TranslationsSettingsDataManagementNd dataManagement = _TranslationsSettingsDataManagementNd._(_root);
	@override late final _TranslationsSettingsVersionNd version = _TranslationsSettingsVersionNd._(_root);
}

// Path: recipes
class _TranslationsRecipesNd extends TranslationsRecipesEn {
	_TranslationsRecipesNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNd extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNd._(TranslationsNd root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNd nutrition = _TranslationsRecipeDetailNutritionNd._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNd prepAhead = _TranslationsRecipeDetailPrepAheadNd._(_root);
...
// Path: filters
class _TranslationsFiltersNd extends TranslationsFiltersEn {
	_TranslationsFiltersNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNd extends TranslationsShoppingListEn {
	_TranslationsShoppingListNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNd extends TranslationsMealPlanEn {
	_TranslationsMealPlanNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNd extends TranslationsInventoryEn {
	_TranslationsInventoryNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNd extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNd extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNd extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNd extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNd extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNd extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNd extends TranslationsUpgradeEn {
	_TranslationsUpgradeNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNd extends TranslationsTourEn {
	_TranslationsTourNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNd extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNd extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNd extends TranslationsErrorsEn {
	_TranslationsErrorsNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNd extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNd._(TranslationsNd root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNd metric = _TranslationsSettingsMeasurementsMetricNd._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNd imperial = _TranslationsSettingsMeasurementsImperialNd._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNd extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNd extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNd extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNd extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNd extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNd extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNd._(TranslationsNd root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <nd>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNd {
