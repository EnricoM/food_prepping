...
// Path: <root>
class TranslationsLu extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <lu>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsLu _root = this; // ignore: unused_field

	@override 
	TranslationsLu $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLu(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLu app = _TranslationsAppLu._(_root);
	@override late final _TranslationsHomeLu home = _TranslationsHomeLu._(_root);
	@override late final _TranslationsCommonLu common = _TranslationsCommonLu._(_root);
	@override late final _TranslationsSettingsLu settings = _TranslationsSettingsLu._(_root);
	@override late final _TranslationsRecipesLu recipes = _TranslationsRecipesLu._(_root);
	@override late final _TranslationsRecipeDetailLu recipeDetail = _TranslationsRecipeDetailLu._(_root);
	@override late final _TranslationsFiltersLu filters = _TranslationsFiltersLu._(_root);
	@override late final _TranslationsShoppingListLu shoppingList = _TranslationsShoppingListLu._(_root);
	@override late final _TranslationsMealPlanLu mealPlan = _TranslationsMealPlanLu._(_root);
	@override late final _TranslationsInventoryLu inventory = _TranslationsInventoryLu._(_root);
	@override late final _TranslationsBarcodeScanLu barcodeScan = _TranslationsBarcodeScanLu._(_root);
	@override late final _TranslationsReceiptScanLu receiptScan = _TranslationsReceiptScanLu._(_root);
	@override late final _TranslationsBatchCookingLu batchCooking = _TranslationsBatchCookingLu._(_root);
	@override late final _TranslationsVisitedDomainsLu visitedDomains = _TranslationsVisitedDomainsLu._(_root);
	@override late final _TranslationsDomainDiscoveryLu domainDiscovery = _TranslationsDomainDiscoveryLu._(_root);
	@override late final _TranslationsInventorySuggestionsLu inventorySuggestions = _TranslationsInventorySuggestionsLu._(_root);
	@override late final _TranslationsUpgradeLu upgrade = _TranslationsUpgradeLu._(_root);
	@override late final _TranslationsTourLu tour = _TranslationsTourLu._(_root);
	@override late final _TranslationsManualRecipeLu manualRecipe = _TranslationsManualRecipeLu._(_root);
	@override late final _TranslationsRecipeEditLu recipeEdit = _TranslationsRecipeEditLu._(_root);
	@override late final _TranslationsErrorsLu errors = _TranslationsErrorsLu._(_root);
}

// Path: app
class _TranslationsAppLu extends TranslationsAppEn {
	_TranslationsAppLu._(TranslationsLu root) : this._root = root, super.internal(root);

	final TranslationsLu _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeLu extends TranslationsHomeEn {
	_TranslationsHomeLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLu extends TranslationsCommonEn {
	_TranslationsCommonLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLu extends TranslationsSettingsEn {
	_TranslationsSettingsLu._(TranslationsLu root) : this._root = root, super.internal(root);

	final TranslationsLu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLu measurements = _TranslationsSettingsMeasurementsLu._(_root);
	@override late final _TranslationsSettingsDataManagementLu dataManagement = _TranslationsSettingsDataManagementLu._(_root);
	@override late final _TranslationsSettingsVersionLu version = _TranslationsSettingsVersionLu._(_root);
}

// Path: recipes
class _TranslationsRecipesLu extends TranslationsRecipesEn {
	_TranslationsRecipesLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLu._(TranslationsLu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLu nutrition = _TranslationsRecipeDetailNutritionLu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLu prepAhead = _TranslationsRecipeDetailPrepAheadLu._(_root);
...
// Path: filters
class _TranslationsFiltersLu extends TranslationsFiltersEn {
	_TranslationsFiltersLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLu extends TranslationsShoppingListEn {
	_TranslationsShoppingListLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLu extends TranslationsMealPlanEn {
	_TranslationsMealPlanLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLu extends TranslationsInventoryEn {
	_TranslationsInventoryLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLu extends TranslationsUpgradeEn {
	_TranslationsUpgradeLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLu extends TranslationsTourEn {
	_TranslationsTourLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLu extends TranslationsErrorsEn {
	_TranslationsErrorsLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLu._(TranslationsLu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLu metric = _TranslationsSettingsMeasurementsMetricLu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLu imperial = _TranslationsSettingsMeasurementsImperialLu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLu._(TranslationsLu root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <lu>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsLu {
