...
class TranslationsFi extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppFi app = _TranslationsAppFi._(_root);
	...
	@override late final _TranslationsRecipesFi recipes = _TranslationsRecipesFi._(_root);
	@override late final _TranslationsRecipeDetailFi recipeDetail = _TranslationsRecipeDetailFi._(_root);
	@override late final _TranslationsFiltersFi filters = _TranslationsFiltersFi._(_root);
	@override late final _TranslationsShoppingListFi shoppingList = _TranslationsShoppingListFi._(_root);
	@override late final _TranslationsMealPlanFi mealPlan = _TranslationsMealPlanFi._(_root);
	@override late final _TranslationsInventoryFi inventory = _TranslationsInventoryFi._(_root);
	@override late final _TranslationsBarcodeScanFi barcodeScan = _TranslationsBarcodeScanFi._(_root);
	@override late final _TranslationsReceiptScanFi receiptScan = _TranslationsReceiptScanFi._(_root);
	@override late final _TranslationsBatchCookingFi batchCooking = _TranslationsBatchCookingFi._(_root);
	@override late final _TranslationsVisitedDomainsFi visitedDomains = _TranslationsVisitedDomainsFi._(_root);
	@override late final _TranslationsDomainDiscoveryFi domainDiscovery = _TranslationsDomainDiscoveryFi._(_root);
	@override late final _TranslationsInventorySuggestionsFi inventorySuggestions = _TranslationsInventorySuggestionsFi._(_root);
	@override late final _TranslationsUpgradeFi upgrade = _TranslationsUpgradeFi._(_root);
	@override late final _TranslationsTourFi tour = _TranslationsTourFi._(_root);
	@override late final _TranslationsManualRecipeFi manualRecipe = _TranslationsManualRecipeFi._(_root);
	@override late final _TranslationsRecipeEditFi recipeEdit = _TranslationsRecipeEditFi._(_root);
	@override late final _TranslationsErrorsFi errors = _TranslationsErrorsFi._(_root);
}

// Path: app
class _TranslationsAppFi extends TranslationsAppEn {
	_TranslationsAppFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsFi extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsFi measurements = _TranslationsSettingsMeasurementsFi._(_root);
	@override late final _TranslationsSettingsDataManagementFi dataManagement = _TranslationsSettingsDataManagementFi._(_root);
	@override late final _TranslationsSettingsVersionFi version = _TranslationsSettingsVersionFi._(_root);
}

// Path: recipes
class _TranslationsRecipesFi extends TranslationsRecipesEn {
	_TranslationsRecipesFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFi._(TranslationsFi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFi nutrition = _TranslationsRecipeDetailNutritionFi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFi prepAhead = _TranslationsRecipeDetailPrepAheadFi._(_root);
...
// Path: filters
class _TranslationsFiltersFi extends TranslationsFiltersEn {
	_TranslationsFiltersFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFi extends TranslationsShoppingListEn {
	_TranslationsShoppingListFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFi extends TranslationsMealPlanEn {
	_TranslationsMealPlanFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFi extends TranslationsInventoryEn {
	_TranslationsInventoryFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFi extends TranslationsUpgradeEn {
	_TranslationsUpgradeFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFi extends TranslationsTourEn {
	_TranslationsTourFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFi._(TranslationsFi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFi metric = _TranslationsSettingsMeasurementsMetricFi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFi imperial = _TranslationsSettingsMeasurementsImperialFi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFi._(TranslationsFi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFi._(TranslationsFi root) : this._root = root, super.internal(root);
