...
// Path: <root>
class TranslationsGa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppGa implements TranslationsAppEn {
	_TranslationsAppGa._(this._root);
...
// Path: home
class _TranslationsHomeGa implements TranslationsHomeEn {
	_TranslationsHomeGa._(this._root);
...
// Path: common
class _TranslationsCommonGa implements TranslationsCommonEn {
	_TranslationsCommonGa._(this._root);
...
// Path: settings
class _TranslationsSettingsGa implements TranslationsSettingsEn {
	_TranslationsSettingsGa._(this._root);
...
// Path: recipes
class _TranslationsRecipesGa implements TranslationsRecipesEn {
	_TranslationsRecipesGa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGa._(this._root);
...
// Path: filters
class _TranslationsFiltersGa implements TranslationsFiltersEn {
	_TranslationsFiltersGa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListGa implements TranslationsShoppingListEn {
	_TranslationsShoppingListGa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanGa implements TranslationsMealPlanEn {
	_TranslationsMealPlanGa._(this._root);
...
// Path: inventory
class _TranslationsInventoryGa implements TranslationsInventoryEn {
	_TranslationsInventoryGa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanGa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanGa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingGa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingGa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGa._(this._root);
...
class _TranslationsDomainDiscoveryGa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGa._(this._root);
...
class _TranslationsInventorySuggestionsGa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeGa implements TranslationsUpgradeEn {
	_TranslationsUpgradeGa._(this._root);
...
// Path: tour
class _TranslationsTourGa implements TranslationsTourEn {
	_TranslationsTourGa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeGa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditGa._(this._root);
...
// Path: errors
class _TranslationsErrorsGa implements TranslationsErrorsEn {
	_TranslationsErrorsGa._(this._root);
...
class _TranslationsSettingsMeasurementsGa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGa._(this._root);
...
class _TranslationsSettingsDataManagementGa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGa._(this._root);
...
class _TranslationsSettingsVersionGa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGa._(this._root);
...
class _TranslationsRecipeDetailNutritionGa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadGa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricGa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialGa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGa._(this._root);
