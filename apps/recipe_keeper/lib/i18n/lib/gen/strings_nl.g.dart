...
// Path: recipes
class _TranslationsRecipesNl implements TranslationsRecipesEn {
	_TranslationsRecipesNl._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNl implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNl._(this._root);
...
// Path: filters
class _TranslationsFiltersNl implements TranslationsFiltersEn {
	_TranslationsFiltersNl._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListNl implements TranslationsShoppingListEn {
	_TranslationsShoppingListNl._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanNl implements TranslationsMealPlanEn {
	_TranslationsMealPlanNl._(this._root);
...
// Path: inventory
class _TranslationsInventoryNl implements TranslationsInventoryEn {
	_TranslationsInventoryNl._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNl implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNl._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanNl implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanNl._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingNl implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingNl._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNl implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNl._(this._root);
...
class _TranslationsDomainDiscoveryNl implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNl._(this._root);
...
class _TranslationsInventorySuggestionsNl implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNl._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeNl implements TranslationsUpgradeEn {
	_TranslationsUpgradeNl._(this._root);
...
// Path: tour
class _TranslationsTourNl implements TranslationsTourEn {
	_TranslationsTourNl._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNl implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeNl._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNl implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditNl._(this._root);
...
class _TranslationsSettingsMeasurementsNl implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNl._(this._root);
...
class _TranslationsSettingsDataManagementNl implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNl._(this._root);
...
class _TranslationsSettingsVersionNl implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNl._(this._root);
...
class _TranslationsRecipeDetailNutritionNl implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNl._(this._root);
...
class _TranslationsRecipeDetailPrepAheadNl implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNl._(this._root);
...
class _TranslationsSettingsMeasurementsMetricNl implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNl._(this._root);
...
class _TranslationsSettingsMeasurementsImperialNl implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNl._(this._root);
