...
// Path: <root>
class TranslationsFaIr with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppFaIr implements TranslationsAppEn {
	_TranslationsAppFaIr._(this._root);
...
// Path: home
class _TranslationsHomeFaIr implements TranslationsHomeEn {
	_TranslationsHomeFaIr._(this._root);
...
// Path: common
class _TranslationsCommonFaIr implements TranslationsCommonEn {
	_TranslationsCommonFaIr._(this._root);
...
// Path: settings
class _TranslationsSettingsFaIr implements TranslationsSettingsEn {
	_TranslationsSettingsFaIr._(this._root);
...
// Path: recipes
class _TranslationsRecipesFaIr implements TranslationsRecipesEn {
	_TranslationsRecipesFaIr._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFaIr implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFaIr._(this._root);
...
// Path: filters
class _TranslationsFiltersFaIr implements TranslationsFiltersEn {
	_TranslationsFiltersFaIr._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListFaIr implements TranslationsShoppingListEn {
	_TranslationsShoppingListFaIr._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanFaIr implements TranslationsMealPlanEn {
	_TranslationsMealPlanFaIr._(this._root);
...
// Path: inventory
class _TranslationsInventoryFaIr implements TranslationsInventoryEn {
	_TranslationsInventoryFaIr._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFaIr implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFaIr._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanFaIr implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanFaIr._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingFaIr implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingFaIr._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFaIr implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFaIr._(this._root);
...
class _TranslationsDomainDiscoveryFaIr implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFaIr._(this._root);
...
class _TranslationsInventorySuggestionsFaIr implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFaIr._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeFaIr implements TranslationsUpgradeEn {
	_TranslationsUpgradeFaIr._(this._root);
...
// Path: tour
class _TranslationsTourFaIr implements TranslationsTourEn {
	_TranslationsTourFaIr._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFaIr implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeFaIr._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFaIr implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditFaIr._(this._root);
...
// Path: errors
class _TranslationsErrorsFaIr implements TranslationsErrorsEn {
	_TranslationsErrorsFaIr._(this._root);
...
class _TranslationsSettingsMeasurementsFaIr implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFaIr._(this._root);
...
class _TranslationsSettingsDataManagementFaIr implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFaIr._(this._root);
...
class _TranslationsSettingsVersionFaIr implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFaIr._(this._root);
...
class _TranslationsRecipeDetailNutritionFaIr implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFaIr._(this._root);
...
class _TranslationsRecipeDetailPrepAheadFaIr implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFaIr._(this._root);
...
class _TranslationsSettingsMeasurementsMetricFaIr implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFaIr._(this._root);
...
class _TranslationsSettingsMeasurementsImperialFaIr implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFaIr._(this._root);
