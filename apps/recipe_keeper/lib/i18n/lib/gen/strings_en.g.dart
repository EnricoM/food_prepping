...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsRecipesEn recipes = TranslationsRecipesEn._(_root);
	late final TranslationsRecipeDetailEn recipeDetail = TranslationsRecipeDetailEn._(_root);
	late final TranslationsFiltersEn filters = TranslationsFiltersEn._(_root);
	late final TranslationsShoppingListEn shoppingList = TranslationsShoppingListEn._(_root);
	late final TranslationsMealPlanEn mealPlan = TranslationsMealPlanEn._(_root);
	late final TranslationsInventoryEn inventory = TranslationsInventoryEn._(_root);
	late final TranslationsBarcodeScanEn barcodeScan = TranslationsBarcodeScanEn._(_root);
	late final TranslationsReceiptScanEn receiptScan = TranslationsReceiptScanEn._(_root);
	late final TranslationsBatchCookingEn batchCooking = TranslationsBatchCookingEn._(_root);
	late final TranslationsVisitedDomainsEn visitedDomains = TranslationsVisitedDomainsEn._(_root);
	late final TranslationsDomainDiscoveryEn domainDiscovery = TranslationsDomainDiscoveryEn._(_root);
	late final TranslationsInventorySuggestionsEn inventorySuggestions = TranslationsInventorySuggestionsEn._(_root);
	late final TranslationsUpgradeEn upgrade = TranslationsUpgradeEn._(_root);
	late final TranslationsTourEn tour = TranslationsTourEn._(_root);
	late final TranslationsManualRecipeEn manualRecipe = TranslationsManualRecipeEn._(_root);
	late final TranslationsRecipeEditEn recipeEdit = TranslationsRecipeEditEn._(_root);
...
class TranslationsSettingsEn {
	...
	late final TranslationsSettingsMeasurementsEn measurements = TranslationsSettingsMeasurementsEn._(_root);
	late final TranslationsSettingsDataManagementEn dataManagement = TranslationsSettingsDataManagementEn._(_root);
	late final TranslationsSettingsVersionEn version = TranslationsSettingsVersionEn._(_root);
}

// Path: recipes
class TranslationsRecipesEn {
	TranslationsRecipesEn._(this._root);
...
class TranslationsRecipeDetailEn {
	TranslationsRecipeDetailEn._(this._root);
	...
	late final TranslationsRecipeDetailNutritionEn nutrition = TranslationsRecipeDetailNutritionEn._(_root);

	/// en: 'Highlights'
	String get highlights => 'Highlights';

	late final TranslationsRecipeDetailPrepAheadEn prepAhead = TranslationsRecipeDetailPrepAheadEn._(_root);
...
class TranslationsShoppingListEn {
	TranslationsShoppingListEn._(this._root);
...
class TranslationsMealPlanEn {
	TranslationsMealPlanEn._(this._root);
...
class TranslationsBarcodeScanEn {
	TranslationsBarcodeScanEn._(this._root);
...
class TranslationsReceiptScanEn {
	TranslationsReceiptScanEn._(this._root);
...
class TranslationsBatchCookingEn {
	TranslationsBatchCookingEn._(this._root);
...
class TranslationsVisitedDomainsEn {
	TranslationsVisitedDomainsEn._(this._root);
...
class TranslationsDomainDiscoveryEn {
	TranslationsDomainDiscoveryEn._(this._root);
...
class TranslationsInventorySuggestionsEn {
	TranslationsInventorySuggestionsEn._(this._root);
...
class TranslationsUpgradeEn {
	TranslationsUpgradeEn._(this._root);
...
class TranslationsTourEn {
	TranslationsTourEn._(this._root);
...
class TranslationsManualRecipeEn {
	TranslationsManualRecipeEn._(this._root);
...
class TranslationsRecipeEditEn {
	TranslationsRecipeEditEn._(this._root);
...
class TranslationsSettingsMeasurementsEn {
	TranslationsSettingsMeasurementsEn._(this._root);
	...
	late final TranslationsSettingsMeasurementsMetricEn metric = TranslationsSettingsMeasurementsMetricEn._(_root);
	late final TranslationsSettingsMeasurementsImperialEn imperial = TranslationsSettingsMeasurementsImperialEn._(_root);
}

// Path: settings.dataManagement
class TranslationsSettingsDataManagementEn {
	TranslationsSettingsDataManagementEn._(this._root);
...
class TranslationsSettingsVersionEn {
	TranslationsSettingsVersionEn._(this._root);
...
class TranslationsRecipeDetailNutritionEn {
	TranslationsRecipeDetailNutritionEn._(this._root);
...
class TranslationsRecipeDetailPrepAheadEn {
	TranslationsRecipeDetailPrepAheadEn._(this._root);
...
class TranslationsSettingsMeasurementsMetricEn {
	TranslationsSettingsMeasurementsMetricEn._(this._root);
...
class TranslationsSettingsMeasurementsImperialEn {
	TranslationsSettingsMeasurementsImperialEn._(this._root);
