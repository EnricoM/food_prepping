...
// Path: <root>
class TranslationsMsMy with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppMsMy implements TranslationsAppEn {
	_TranslationsAppMsMy._(this._root);
...
// Path: home
class _TranslationsHomeMsMy implements TranslationsHomeEn {
	_TranslationsHomeMsMy._(this._root);
...
// Path: common
class _TranslationsCommonMsMy implements TranslationsCommonEn {
	_TranslationsCommonMsMy._(this._root);
...
// Path: settings
class _TranslationsSettingsMsMy implements TranslationsSettingsEn {
	_TranslationsSettingsMsMy._(this._root);
...
// Path: recipes
class _TranslationsRecipesMsMy implements TranslationsRecipesEn {
	_TranslationsRecipesMsMy._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMsMy implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMsMy._(this._root);
...
// Path: filters
class _TranslationsFiltersMsMy implements TranslationsFiltersEn {
	_TranslationsFiltersMsMy._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMsMy implements TranslationsShoppingListEn {
	_TranslationsShoppingListMsMy._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMsMy implements TranslationsMealPlanEn {
	_TranslationsMealPlanMsMy._(this._root);
...
// Path: inventory
class _TranslationsInventoryMsMy implements TranslationsInventoryEn {
	_TranslationsInventoryMsMy._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMsMy implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMsMy._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMsMy implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMsMy._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMsMy implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMsMy._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMsMy implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMsMy._(this._root);
...
class _TranslationsDomainDiscoveryMsMy implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMsMy._(this._root);
...
class _TranslationsInventorySuggestionsMsMy implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMsMy._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMsMy implements TranslationsUpgradeEn {
	_TranslationsUpgradeMsMy._(this._root);
...
// Path: tour
class _TranslationsTourMsMy implements TranslationsTourEn {
	_TranslationsTourMsMy._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMsMy implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMsMy._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMsMy implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMsMy._(this._root);
...
// Path: errors
class _TranslationsErrorsMsMy implements TranslationsErrorsEn {
	_TranslationsErrorsMsMy._(this._root);
...
class _TranslationsSettingsMeasurementsMsMy implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMsMy._(this._root);
...
class _TranslationsSettingsDataManagementMsMy implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMsMy._(this._root);
...
class _TranslationsSettingsVersionMsMy implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMsMy._(this._root);
...
class _TranslationsRecipeDetailNutritionMsMy implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMsMy._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMsMy implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMsMy._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMsMy implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMsMy._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMsMy implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMsMy._(this._root);
