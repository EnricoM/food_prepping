...
// Path: home
class _TranslationsHomeCa implements TranslationsHomeEn {
	_TranslationsHomeCa._(this._root);
...
// Path: settings
class _TranslationsSettingsCa implements TranslationsSettingsEn {
	_TranslationsSettingsCa._(this._root);
...
// Path: recipes
class _TranslationsRecipesCa implements TranslationsRecipesEn {
	_TranslationsRecipesCa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCa._(this._root);
...
// Path: filters
class _TranslationsFiltersCa implements TranslationsFiltersEn {
	_TranslationsFiltersCa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListCa implements TranslationsShoppingListEn {
	_TranslationsShoppingListCa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanCa implements TranslationsMealPlanEn {
	_TranslationsMealPlanCa._(this._root);
...
// Path: inventory
class _TranslationsInventoryCa implements TranslationsInventoryEn {
	_TranslationsInventoryCa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanCa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanCa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingCa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingCa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCa._(this._root);
...
class _TranslationsDomainDiscoveryCa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCa._(this._root);
...
class _TranslationsInventorySuggestionsCa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeCa implements TranslationsUpgradeEn {
	_TranslationsUpgradeCa._(this._root);
...
// Path: tour
class _TranslationsTourCa implements TranslationsTourEn {
	_TranslationsTourCa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeCa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditCa._(this._root);
...
// Path: errors
class _TranslationsErrorsCa implements TranslationsErrorsEn {
	_TranslationsErrorsCa._(this._root);
...
class _TranslationsSettingsMeasurementsCa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCa._(this._root);
...
class _TranslationsSettingsDataManagementCa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCa._(this._root);
...
class _TranslationsSettingsVersionCa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCa._(this._root);
...
class _TranslationsRecipeDetailNutritionCa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadCa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricCa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialCa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCa._(this._root);
