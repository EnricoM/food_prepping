...
// Path: <root>
class TranslationsKk with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKk implements TranslationsAppEn {
	_TranslationsAppKk._(this._root);
...
// Path: home
class _TranslationsHomeKk implements TranslationsHomeEn {
	_TranslationsHomeKk._(this._root);
...
// Path: common
class _TranslationsCommonKk implements TranslationsCommonEn {
	_TranslationsCommonKk._(this._root);
...
// Path: settings
class _TranslationsSettingsKk implements TranslationsSettingsEn {
	_TranslationsSettingsKk._(this._root);
...
// Path: recipes
class _TranslationsRecipesKk implements TranslationsRecipesEn {
	_TranslationsRecipesKk._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKk implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKk._(this._root);
...
// Path: filters
class _TranslationsFiltersKk implements TranslationsFiltersEn {
	_TranslationsFiltersKk._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKk implements TranslationsShoppingListEn {
	_TranslationsShoppingListKk._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKk implements TranslationsMealPlanEn {
	_TranslationsMealPlanKk._(this._root);
...
// Path: inventory
class _TranslationsInventoryKk implements TranslationsInventoryEn {
	_TranslationsInventoryKk._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKk implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKk._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKk implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKk._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKk implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKk._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKk implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKk._(this._root);
...
class _TranslationsDomainDiscoveryKk implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKk._(this._root);
...
class _TranslationsInventorySuggestionsKk implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKk._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKk implements TranslationsUpgradeEn {
	_TranslationsUpgradeKk._(this._root);
...
// Path: tour
class _TranslationsTourKk implements TranslationsTourEn {
	_TranslationsTourKk._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKk implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKk._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKk implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKk._(this._root);
...
// Path: errors
class _TranslationsErrorsKk implements TranslationsErrorsEn {
	_TranslationsErrorsKk._(this._root);
...
class _TranslationsSettingsMeasurementsKk implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKk._(this._root);
...
class _TranslationsSettingsDataManagementKk implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKk._(this._root);
...
class _TranslationsSettingsVersionKk implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKk._(this._root);
...
class _TranslationsRecipeDetailNutritionKk implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKk._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKk implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKk._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKk implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKk._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKk implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKk._(this._root);
