...
// Path: app
class _TranslationsAppVi implements TranslationsAppEn {
	_TranslationsAppVi._(this._root);
...
// Path: recipes
class _TranslationsRecipesVi implements TranslationsRecipesEn {
	_TranslationsRecipesVi._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailVi implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailVi._(this._root);
...
// Path: filters
class _TranslationsFiltersVi implements TranslationsFiltersEn {
	_TranslationsFiltersVi._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListVi implements TranslationsShoppingListEn {
	_TranslationsShoppingListVi._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanVi implements TranslationsMealPlanEn {
	_TranslationsMealPlanVi._(this._root);
...
// Path: inventory
class _TranslationsInventoryVi implements TranslationsInventoryEn {
	_TranslationsInventoryVi._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanVi implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanVi._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanVi implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanVi._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingVi implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingVi._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsVi implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsVi._(this._root);
...
class _TranslationsDomainDiscoveryVi implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryVi._(this._root);
...
class _TranslationsInventorySuggestionsVi implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsVi._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeVi implements TranslationsUpgradeEn {
	_TranslationsUpgradeVi._(this._root);
...
// Path: tour
class _TranslationsTourVi implements TranslationsTourEn {
	_TranslationsTourVi._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeVi implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeVi._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditVi implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditVi._(this._root);
...
class _TranslationsSettingsMeasurementsVi implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsVi._(this._root);
...
class _TranslationsSettingsDataManagementVi implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementVi._(this._root);
...
class _TranslationsSettingsVersionVi implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionVi._(this._root);
...
class _TranslationsRecipeDetailNutritionVi implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionVi._(this._root);
...
class _TranslationsRecipeDetailPrepAheadVi implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadVi._(this._root);
...
class _TranslationsSettingsMeasurementsMetricVi implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricVi._(this._root);
...
class _TranslationsSettingsMeasurementsImperialVi implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialVi._(this._root);
