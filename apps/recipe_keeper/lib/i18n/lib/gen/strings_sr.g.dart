...
// Path: <root>
class TranslationsSr with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppSr implements TranslationsAppEn {
	_TranslationsAppSr._(this._root);
...
// Path: home
class _TranslationsHomeSr implements TranslationsHomeEn {
	_TranslationsHomeSr._(this._root);
...
// Path: settings
class _TranslationsSettingsSr implements TranslationsSettingsEn {
	_TranslationsSettingsSr._(this._root);
...
// Path: recipes
class _TranslationsRecipesSr implements TranslationsRecipesEn {
	_TranslationsRecipesSr._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSr implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSr._(this._root);
...
// Path: filters
class _TranslationsFiltersSr implements TranslationsFiltersEn {
	_TranslationsFiltersSr._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSr implements TranslationsShoppingListEn {
	_TranslationsShoppingListSr._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSr implements TranslationsMealPlanEn {
	_TranslationsMealPlanSr._(this._root);
...
// Path: inventory
class _TranslationsInventorySr implements TranslationsInventoryEn {
	_TranslationsInventorySr._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSr implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSr._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSr implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSr._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSr implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSr._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSr implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSr._(this._root);
...
class _TranslationsDomainDiscoverySr implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySr._(this._root);
...
class _TranslationsInventorySuggestionsSr implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSr._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSr implements TranslationsUpgradeEn {
	_TranslationsUpgradeSr._(this._root);
...
// Path: tour
class _TranslationsTourSr implements TranslationsTourEn {
	_TranslationsTourSr._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSr implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSr._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSr implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSr._(this._root);
...
class _TranslationsSettingsMeasurementsSr implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSr._(this._root);
...
class _TranslationsSettingsDataManagementSr implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSr._(this._root);
...
class _TranslationsSettingsVersionSr implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSr._(this._root);
...
class _TranslationsRecipeDetailNutritionSr implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSr._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSr implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSr._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSr implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSr._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSr implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSr._(this._root);
