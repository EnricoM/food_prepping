...
// Path: recipes
class _TranslationsRecipesZh implements TranslationsRecipesEn {
	_TranslationsRecipesZh._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZh implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZh._(this._root);
...
// Path: filters
class _TranslationsFiltersZh implements TranslationsFiltersEn {
	_TranslationsFiltersZh._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListZh implements TranslationsShoppingListEn {
	_TranslationsShoppingListZh._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanZh implements TranslationsMealPlanEn {
	_TranslationsMealPlanZh._(this._root);
...
// Path: inventory
class _TranslationsInventoryZh implements TranslationsInventoryEn {
	_TranslationsInventoryZh._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZh implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZh._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanZh implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanZh._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingZh implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingZh._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZh implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZh._(this._root);
...
class _TranslationsDomainDiscoveryZh implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZh._(this._root);
...
class _TranslationsInventorySuggestionsZh implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZh._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeZh implements TranslationsUpgradeEn {
	_TranslationsUpgradeZh._(this._root);
...
// Path: tour
class _TranslationsTourZh implements TranslationsTourEn {
	_TranslationsTourZh._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZh implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeZh._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZh implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditZh._(this._root);
...
class _TranslationsSettingsMeasurementsZh implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZh._(this._root);
...
class _TranslationsSettingsDataManagementZh implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZh._(this._root);
...
class _TranslationsSettingsVersionZh implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZh._(this._root);
...
class _TranslationsRecipeDetailNutritionZh implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZh._(this._root);
...
class _TranslationsRecipeDetailPrepAheadZh implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZh._(this._root);
...
class _TranslationsSettingsMeasurementsMetricZh implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZh._(this._root);
...
class _TranslationsSettingsMeasurementsImperialZh implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZh._(this._root);
