...
// Path: app
class _TranslationsAppUz implements TranslationsAppEn {
	_TranslationsAppUz._(this._root);
...
// Path: settings
class _TranslationsSettingsUz implements TranslationsSettingsEn {
	_TranslationsSettingsUz._(this._root);
...
// Path: recipes
class _TranslationsRecipesUz implements TranslationsRecipesEn {
	_TranslationsRecipesUz._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUz implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUz._(this._root);
...
// Path: filters
class _TranslationsFiltersUz implements TranslationsFiltersEn {
	_TranslationsFiltersUz._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListUz implements TranslationsShoppingListEn {
	_TranslationsShoppingListUz._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanUz implements TranslationsMealPlanEn {
	_TranslationsMealPlanUz._(this._root);
...
// Path: inventory
class _TranslationsInventoryUz implements TranslationsInventoryEn {
	_TranslationsInventoryUz._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUz implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUz._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanUz implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanUz._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingUz implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingUz._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUz implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUz._(this._root);
...
class _TranslationsDomainDiscoveryUz implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUz._(this._root);
...
class _TranslationsInventorySuggestionsUz implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUz._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeUz implements TranslationsUpgradeEn {
	_TranslationsUpgradeUz._(this._root);
...
// Path: tour
class _TranslationsTourUz implements TranslationsTourEn {
	_TranslationsTourUz._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUz implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeUz._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUz implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditUz._(this._root);
...
class _TranslationsSettingsMeasurementsUz implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUz._(this._root);
...
class _TranslationsSettingsDataManagementUz implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUz._(this._root);
...
class _TranslationsSettingsVersionUz implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUz._(this._root);
...
class _TranslationsRecipeDetailNutritionUz implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUz._(this._root);
...
class _TranslationsRecipeDetailPrepAheadUz implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUz._(this._root);
...
class _TranslationsSettingsMeasurementsMetricUz implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUz._(this._root);
...
class _TranslationsSettingsMeasurementsImperialUz implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUz._(this._root);
