...
// Path: recipes
class _TranslationsRecipesIt implements TranslationsRecipesEn {
	_TranslationsRecipesIt._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIt implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIt._(this._root);
...
// Path: filters
class _TranslationsFiltersIt implements TranslationsFiltersEn {
	_TranslationsFiltersIt._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListIt implements TranslationsShoppingListEn {
	_TranslationsShoppingListIt._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanIt implements TranslationsMealPlanEn {
	_TranslationsMealPlanIt._(this._root);
...
// Path: inventory
class _TranslationsInventoryIt implements TranslationsInventoryEn {
	_TranslationsInventoryIt._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIt implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIt._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanIt implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanIt._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingIt implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingIt._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIt implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIt._(this._root);
...
class _TranslationsDomainDiscoveryIt implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIt._(this._root);
...
class _TranslationsInventorySuggestionsIt implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIt._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeIt implements TranslationsUpgradeEn {
	_TranslationsUpgradeIt._(this._root);
...
// Path: tour
class _TranslationsTourIt implements TranslationsTourEn {
	_TranslationsTourIt._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIt implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeIt._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIt implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditIt._(this._root);
...
class _TranslationsSettingsMeasurementsIt implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIt._(this._root);
...
class _TranslationsSettingsDataManagementIt implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIt._(this._root);
...
class _TranslationsSettingsVersionIt implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIt._(this._root);
...
class _TranslationsRecipeDetailNutritionIt implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIt._(this._root);
...
class _TranslationsRecipeDetailPrepAheadIt implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIt._(this._root);
...
class _TranslationsSettingsMeasurementsMetricIt implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIt._(this._root);
...
class _TranslationsSettingsMeasurementsImperialIt implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIt._(this._root);
