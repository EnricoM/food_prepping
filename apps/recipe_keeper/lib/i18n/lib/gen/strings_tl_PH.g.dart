...
// Path: <root>
class TranslationsTlPh with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppTlPh implements TranslationsAppEn {
	_TranslationsAppTlPh._(this._root);
...
// Path: home
class _TranslationsHomeTlPh implements TranslationsHomeEn {
	_TranslationsHomeTlPh._(this._root);
...
// Path: common
class _TranslationsCommonTlPh implements TranslationsCommonEn {
	_TranslationsCommonTlPh._(this._root);
...
// Path: settings
class _TranslationsSettingsTlPh implements TranslationsSettingsEn {
	_TranslationsSettingsTlPh._(this._root);
...
// Path: recipes
class _TranslationsRecipesTlPh implements TranslationsRecipesEn {
	_TranslationsRecipesTlPh._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTlPh implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTlPh._(this._root);
...
// Path: filters
class _TranslationsFiltersTlPh implements TranslationsFiltersEn {
	_TranslationsFiltersTlPh._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTlPh implements TranslationsShoppingListEn {
	_TranslationsShoppingListTlPh._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTlPh implements TranslationsMealPlanEn {
	_TranslationsMealPlanTlPh._(this._root);
...
// Path: inventory
class _TranslationsInventoryTlPh implements TranslationsInventoryEn {
	_TranslationsInventoryTlPh._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTlPh implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTlPh._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTlPh implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTlPh._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTlPh implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTlPh._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTlPh implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTlPh._(this._root);
...
class _TranslationsDomainDiscoveryTlPh implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTlPh._(this._root);
...
class _TranslationsInventorySuggestionsTlPh implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTlPh._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTlPh implements TranslationsUpgradeEn {
	_TranslationsUpgradeTlPh._(this._root);
...
// Path: tour
class _TranslationsTourTlPh implements TranslationsTourEn {
	_TranslationsTourTlPh._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTlPh implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTlPh._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTlPh implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTlPh._(this._root);
...
// Path: errors
class _TranslationsErrorsTlPh implements TranslationsErrorsEn {
	_TranslationsErrorsTlPh._(this._root);
...
class _TranslationsSettingsMeasurementsTlPh implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTlPh._(this._root);
...
class _TranslationsSettingsDataManagementTlPh implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTlPh._(this._root);
...
class _TranslationsSettingsVersionTlPh implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTlPh._(this._root);
...
class _TranslationsRecipeDetailNutritionTlPh implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTlPh._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTlPh implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTlPh._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTlPh implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTlPh._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTlPh implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTlPh._(this._root);
