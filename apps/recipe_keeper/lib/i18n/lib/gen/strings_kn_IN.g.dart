...
// Path: <root>
class TranslationsKnIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKnIn implements TranslationsAppEn {
	_TranslationsAppKnIn._(this._root);
...
// Path: home
class _TranslationsHomeKnIn implements TranslationsHomeEn {
	_TranslationsHomeKnIn._(this._root);
...
// Path: common
class _TranslationsCommonKnIn implements TranslationsCommonEn {
	_TranslationsCommonKnIn._(this._root);
...
// Path: settings
class _TranslationsSettingsKnIn implements TranslationsSettingsEn {
	_TranslationsSettingsKnIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesKnIn implements TranslationsRecipesEn {
	_TranslationsRecipesKnIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKnIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKnIn._(this._root);
...
// Path: filters
class _TranslationsFiltersKnIn implements TranslationsFiltersEn {
	_TranslationsFiltersKnIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKnIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListKnIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKnIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanKnIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryKnIn implements TranslationsInventoryEn {
	_TranslationsInventoryKnIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKnIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKnIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKnIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKnIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKnIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKnIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKnIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKnIn._(this._root);
...
class _TranslationsDomainDiscoveryKnIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKnIn._(this._root);
...
class _TranslationsInventorySuggestionsKnIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKnIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKnIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeKnIn._(this._root);
...
// Path: tour
class _TranslationsTourKnIn implements TranslationsTourEn {
	_TranslationsTourKnIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKnIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKnIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKnIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKnIn._(this._root);
...
// Path: errors
class _TranslationsErrorsKnIn implements TranslationsErrorsEn {
	_TranslationsErrorsKnIn._(this._root);
...
class _TranslationsSettingsMeasurementsKnIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKnIn._(this._root);
...
class _TranslationsSettingsDataManagementKnIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKnIn._(this._root);
...
class _TranslationsSettingsVersionKnIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKnIn._(this._root);
...
class _TranslationsRecipeDetailNutritionKnIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKnIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKnIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKnIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKnIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKnIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKnIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKnIn._(this._root);
