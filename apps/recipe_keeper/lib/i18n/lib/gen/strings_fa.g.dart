...
// Path: app
class _TranslationsAppFa implements TranslationsAppEn {
	_TranslationsAppFa._(this._root);
...
// Path: home
class _TranslationsHomeFa implements TranslationsHomeEn {
	_TranslationsHomeFa._(this._root);
...
// Path: settings
class _TranslationsSettingsFa implements TranslationsSettingsEn {
	_TranslationsSettingsFa._(this._root);
...
// Path: recipes
class _TranslationsRecipesFa implements TranslationsRecipesEn {
	_TranslationsRecipesFa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFa._(this._root);
...
// Path: filters
class _TranslationsFiltersFa implements TranslationsFiltersEn {
	_TranslationsFiltersFa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListFa implements TranslationsShoppingListEn {
	_TranslationsShoppingListFa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanFa implements TranslationsMealPlanEn {
	_TranslationsMealPlanFa._(this._root);
...
// Path: inventory
class _TranslationsInventoryFa implements TranslationsInventoryEn {
	_TranslationsInventoryFa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanFa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanFa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingFa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingFa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFa._(this._root);
...
class _TranslationsDomainDiscoveryFa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFa._(this._root);
...
class _TranslationsInventorySuggestionsFa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeFa implements TranslationsUpgradeEn {
	_TranslationsUpgradeFa._(this._root);
...
// Path: tour
class _TranslationsTourFa implements TranslationsTourEn {
	_TranslationsTourFa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeFa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditFa._(this._root);
...
// Path: errors
class _TranslationsErrorsFa implements TranslationsErrorsEn {
	_TranslationsErrorsFa._(this._root);
...
class _TranslationsSettingsMeasurementsFa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFa._(this._root);
...
class _TranslationsSettingsDataManagementFa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFa._(this._root);
...
class _TranslationsSettingsVersionFa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFa._(this._root);
...
class _TranslationsRecipeDetailNutritionFa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadFa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricFa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialFa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFa._(this._root);
