...
// Path: <root>
class TranslationsLb with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppLb implements TranslationsAppEn {
	_TranslationsAppLb._(this._root);
...
// Path: home
class _TranslationsHomeLb implements TranslationsHomeEn {
	_TranslationsHomeLb._(this._root);
...
// Path: common
class _TranslationsCommonLb implements TranslationsCommonEn {
	_TranslationsCommonLb._(this._root);
...
// Path: settings
class _TranslationsSettingsLb implements TranslationsSettingsEn {
	_TranslationsSettingsLb._(this._root);
...
// Path: recipes
class _TranslationsRecipesLb implements TranslationsRecipesEn {
	_TranslationsRecipesLb._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLb implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLb._(this._root);
...
// Path: filters
class _TranslationsFiltersLb implements TranslationsFiltersEn {
	_TranslationsFiltersLb._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListLb implements TranslationsShoppingListEn {
	_TranslationsShoppingListLb._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanLb implements TranslationsMealPlanEn {
	_TranslationsMealPlanLb._(this._root);
...
// Path: inventory
class _TranslationsInventoryLb implements TranslationsInventoryEn {
	_TranslationsInventoryLb._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLb implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLb._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanLb implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanLb._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingLb implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingLb._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLb implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLb._(this._root);
...
class _TranslationsDomainDiscoveryLb implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLb._(this._root);
...
class _TranslationsInventorySuggestionsLb implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLb._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeLb implements TranslationsUpgradeEn {
	_TranslationsUpgradeLb._(this._root);
...
// Path: tour
class _TranslationsTourLb implements TranslationsTourEn {
	_TranslationsTourLb._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLb implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeLb._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLb implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditLb._(this._root);
...
// Path: errors
class _TranslationsErrorsLb implements TranslationsErrorsEn {
	_TranslationsErrorsLb._(this._root);
...
class _TranslationsSettingsMeasurementsLb implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLb._(this._root);
...
class _TranslationsSettingsDataManagementLb implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLb._(this._root);
...
class _TranslationsSettingsVersionLb implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLb._(this._root);
...
class _TranslationsRecipeDetailNutritionLb implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLb._(this._root);
...
class _TranslationsRecipeDetailPrepAheadLb implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLb._(this._root);
...
class _TranslationsSettingsMeasurementsMetricLb implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLb._(this._root);
...
class _TranslationsSettingsMeasurementsImperialLb implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLb._(this._root);
