...
// Path: <root>
class TranslationsSi with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppSi implements TranslationsAppEn {
	_TranslationsAppSi._(this._root);
...
// Path: home
class _TranslationsHomeSi implements TranslationsHomeEn {
	_TranslationsHomeSi._(this._root);
...
// Path: common
class _TranslationsCommonSi implements TranslationsCommonEn {
	_TranslationsCommonSi._(this._root);
...
// Path: settings
class _TranslationsSettingsSi implements TranslationsSettingsEn {
	_TranslationsSettingsSi._(this._root);
...
// Path: recipes
class _TranslationsRecipesSi implements TranslationsRecipesEn {
	_TranslationsRecipesSi._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSi implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSi._(this._root);
...
// Path: filters
class _TranslationsFiltersSi implements TranslationsFiltersEn {
	_TranslationsFiltersSi._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSi implements TranslationsShoppingListEn {
	_TranslationsShoppingListSi._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSi implements TranslationsMealPlanEn {
	_TranslationsMealPlanSi._(this._root);
...
// Path: inventory
class _TranslationsInventorySi implements TranslationsInventoryEn {
	_TranslationsInventorySi._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSi implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSi._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSi implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSi._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSi implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSi._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSi implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSi._(this._root);
...
class _TranslationsDomainDiscoverySi implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySi._(this._root);
...
class _TranslationsInventorySuggestionsSi implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSi._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSi implements TranslationsUpgradeEn {
	_TranslationsUpgradeSi._(this._root);
...
// Path: tour
class _TranslationsTourSi implements TranslationsTourEn {
	_TranslationsTourSi._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSi implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSi._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSi implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSi._(this._root);
...
// Path: errors
class _TranslationsErrorsSi implements TranslationsErrorsEn {
	_TranslationsErrorsSi._(this._root);
...
class _TranslationsSettingsMeasurementsSi implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSi._(this._root);
...
class _TranslationsSettingsDataManagementSi implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSi._(this._root);
...
class _TranslationsSettingsVersionSi implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSi._(this._root);
...
class _TranslationsRecipeDetailNutritionSi implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSi._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSi implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSi._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSi implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSi._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSi implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSi._(this._root);
