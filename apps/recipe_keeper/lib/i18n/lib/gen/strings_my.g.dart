...
// Path: app
class _TranslationsAppMy implements TranslationsAppEn {
	_TranslationsAppMy._(this._root);
...
// Path: home
class _TranslationsHomeMy implements TranslationsHomeEn {
	_TranslationsHomeMy._(this._root);
...
// Path: common
class _TranslationsCommonMy implements TranslationsCommonEn {
	_TranslationsCommonMy._(this._root);
...
// Path: settings
class _TranslationsSettingsMy implements TranslationsSettingsEn {
	_TranslationsSettingsMy._(this._root);
...
// Path: recipes
class _TranslationsRecipesMy implements TranslationsRecipesEn {
	_TranslationsRecipesMy._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMy implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMy._(this._root);
...
// Path: filters
class _TranslationsFiltersMy implements TranslationsFiltersEn {
	_TranslationsFiltersMy._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMy implements TranslationsShoppingListEn {
	_TranslationsShoppingListMy._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMy implements TranslationsMealPlanEn {
	_TranslationsMealPlanMy._(this._root);
...
// Path: inventory
class _TranslationsInventoryMy implements TranslationsInventoryEn {
	_TranslationsInventoryMy._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMy implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMy._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMy implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMy._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMy implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMy._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMy implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMy._(this._root);
...
class _TranslationsDomainDiscoveryMy implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMy._(this._root);
...
class _TranslationsInventorySuggestionsMy implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMy._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMy implements TranslationsUpgradeEn {
	_TranslationsUpgradeMy._(this._root);
...
// Path: tour
class _TranslationsTourMy implements TranslationsTourEn {
	_TranslationsTourMy._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMy implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMy._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMy implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMy._(this._root);
...
// Path: errors
class _TranslationsErrorsMy implements TranslationsErrorsEn {
	_TranslationsErrorsMy._(this._root);
...
class _TranslationsSettingsMeasurementsMy implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMy._(this._root);
...
class _TranslationsSettingsDataManagementMy implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMy._(this._root);
...
class _TranslationsSettingsVersionMy implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMy._(this._root);
...
class _TranslationsRecipeDetailNutritionMy implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMy._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMy implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMy._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMy implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMy._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMy implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMy._(this._root);
