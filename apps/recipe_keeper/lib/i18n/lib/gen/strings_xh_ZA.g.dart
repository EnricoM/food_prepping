...
// Path: <root>
class TranslationsXhZa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppXhZa implements TranslationsAppEn {
	_TranslationsAppXhZa._(this._root);
...
// Path: home
class _TranslationsHomeXhZa implements TranslationsHomeEn {
	_TranslationsHomeXhZa._(this._root);
...
// Path: common
class _TranslationsCommonXhZa implements TranslationsCommonEn {
	_TranslationsCommonXhZa._(this._root);
...
// Path: settings
class _TranslationsSettingsXhZa implements TranslationsSettingsEn {
	_TranslationsSettingsXhZa._(this._root);
...
// Path: recipes
class _TranslationsRecipesXhZa implements TranslationsRecipesEn {
	_TranslationsRecipesXhZa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailXhZa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailXhZa._(this._root);
...
// Path: filters
class _TranslationsFiltersXhZa implements TranslationsFiltersEn {
	_TranslationsFiltersXhZa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListXhZa implements TranslationsShoppingListEn {
	_TranslationsShoppingListXhZa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanXhZa implements TranslationsMealPlanEn {
	_TranslationsMealPlanXhZa._(this._root);
...
// Path: inventory
class _TranslationsInventoryXhZa implements TranslationsInventoryEn {
	_TranslationsInventoryXhZa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanXhZa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanXhZa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanXhZa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanXhZa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingXhZa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingXhZa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsXhZa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsXhZa._(this._root);
...
class _TranslationsDomainDiscoveryXhZa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryXhZa._(this._root);
...
class _TranslationsInventorySuggestionsXhZa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsXhZa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeXhZa implements TranslationsUpgradeEn {
	_TranslationsUpgradeXhZa._(this._root);
...
// Path: tour
class _TranslationsTourXhZa implements TranslationsTourEn {
	_TranslationsTourXhZa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeXhZa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeXhZa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditXhZa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditXhZa._(this._root);
...
// Path: errors
class _TranslationsErrorsXhZa implements TranslationsErrorsEn {
	_TranslationsErrorsXhZa._(this._root);
...
class _TranslationsSettingsMeasurementsXhZa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsXhZa._(this._root);
...
class _TranslationsSettingsDataManagementXhZa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementXhZa._(this._root);
...
class _TranslationsSettingsVersionXhZa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionXhZa._(this._root);
...
class _TranslationsRecipeDetailNutritionXhZa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionXhZa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadXhZa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadXhZa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricXhZa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricXhZa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialXhZa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialXhZa._(this._root);
