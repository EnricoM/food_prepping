...
// Path: app
class _TranslationsAppSq implements TranslationsAppEn {
	_TranslationsAppSq._(this._root);
...
// Path: home
class _TranslationsHomeSq implements TranslationsHomeEn {
	_TranslationsHomeSq._(this._root);
...
// Path: settings
class _TranslationsSettingsSq implements TranslationsSettingsEn {
	_TranslationsSettingsSq._(this._root);
...
// Path: recipes
class _TranslationsRecipesSq implements TranslationsRecipesEn {
	_TranslationsRecipesSq._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSq implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSq._(this._root);
...
// Path: filters
class _TranslationsFiltersSq implements TranslationsFiltersEn {
	_TranslationsFiltersSq._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSq implements TranslationsShoppingListEn {
	_TranslationsShoppingListSq._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSq implements TranslationsMealPlanEn {
	_TranslationsMealPlanSq._(this._root);
...
// Path: inventory
class _TranslationsInventorySq implements TranslationsInventoryEn {
	_TranslationsInventorySq._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSq implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSq._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSq implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSq._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSq implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSq._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSq implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSq._(this._root);
...
class _TranslationsDomainDiscoverySq implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySq._(this._root);
...
class _TranslationsInventorySuggestionsSq implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSq._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSq implements TranslationsUpgradeEn {
	_TranslationsUpgradeSq._(this._root);
...
// Path: tour
class _TranslationsTourSq implements TranslationsTourEn {
	_TranslationsTourSq._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSq implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSq._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSq implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSq._(this._root);
...
// Path: errors
class _TranslationsErrorsSq implements TranslationsErrorsEn {
	_TranslationsErrorsSq._(this._root);
...
class _TranslationsSettingsMeasurementsSq implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSq._(this._root);
...
class _TranslationsSettingsDataManagementSq implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSq._(this._root);
...
class _TranslationsSettingsVersionSq implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSq._(this._root);
...
class _TranslationsRecipeDetailNutritionSq implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSq._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSq implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSq._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSq implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSq._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSq implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSq._(this._root);
