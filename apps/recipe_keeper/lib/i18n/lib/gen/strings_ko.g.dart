...
// Path: recipes
class _TranslationsRecipesKo implements TranslationsRecipesEn {
	_TranslationsRecipesKo._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKo implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKo._(this._root);
...
// Path: filters
class _TranslationsFiltersKo implements TranslationsFiltersEn {
	_TranslationsFiltersKo._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKo implements TranslationsShoppingListEn {
	_TranslationsShoppingListKo._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKo implements TranslationsMealPlanEn {
	_TranslationsMealPlanKo._(this._root);
...
// Path: inventory
class _TranslationsInventoryKo implements TranslationsInventoryEn {
...
// Path: barcodeScan
class _TranslationsBarcodeScanKo implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKo._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKo implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKo._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKo implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKo._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKo implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKo._(this._root);
...
class _TranslationsDomainDiscoveryKo implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKo._(this._root);
...
class _TranslationsInventorySuggestionsKo implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKo._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKo implements TranslationsUpgradeEn {
	_TranslationsUpgradeKo._(this._root);
...
// Path: tour
class _TranslationsTourKo implements TranslationsTourEn {
	_TranslationsTourKo._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKo implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKo._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKo implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKo._(this._root);
...
class _TranslationsSettingsMeasurementsKo implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKo._(this._root);
...
class _TranslationsSettingsDataManagementKo implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKo._(this._root);
...
class _TranslationsSettingsVersionKo implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKo._(this._root);
...
class _TranslationsRecipeDetailNutritionKo implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKo._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKo implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKo._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKo implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKo._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKo implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKo._(this._root);
