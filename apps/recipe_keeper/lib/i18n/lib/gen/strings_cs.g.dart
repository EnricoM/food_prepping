...
// Path: app
class _TranslationsAppCs implements TranslationsAppEn {
	_TranslationsAppCs._(this._root);
...
// Path: recipes
class _TranslationsRecipesCs implements TranslationsRecipesEn {
	_TranslationsRecipesCs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListCs implements TranslationsShoppingListEn {
	_TranslationsShoppingListCs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanCs implements TranslationsMealPlanEn {
	_TranslationsMealPlanCs._(this._root);
...
// Path: inventory
class _TranslationsInventoryCs implements TranslationsInventoryEn {
	_TranslationsInventoryCs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanCs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanCs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingCs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingCs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCs._(this._root);
...
class _TranslationsDomainDiscoveryCs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCs._(this._root);
...
class _TranslationsInventorySuggestionsCs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeCs implements TranslationsUpgradeEn {
	_TranslationsUpgradeCs._(this._root);
...
// Path: tour
class _TranslationsTourCs implements TranslationsTourEn {
	_TranslationsTourCs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeCs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditCs._(this._root);
...
class _TranslationsSettingsMeasurementsCs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCs._(this._root);
...
class _TranslationsSettingsDataManagementCs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCs._(this._root);
...
class _TranslationsSettingsVersionCs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCs._(this._root);
...
class _TranslationsRecipeDetailNutritionCs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadCs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricCs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialCs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCs._(this._root);
