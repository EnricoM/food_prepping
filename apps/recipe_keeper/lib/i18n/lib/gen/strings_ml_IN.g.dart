...
// Path: <root>
class TranslationsMlIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppMlIn implements TranslationsAppEn {
	_TranslationsAppMlIn._(this._root);
...
// Path: home
class _TranslationsHomeMlIn implements TranslationsHomeEn {
	_TranslationsHomeMlIn._(this._root);
...
// Path: common
class _TranslationsCommonMlIn implements TranslationsCommonEn {
	_TranslationsCommonMlIn._(this._root);
...
// Path: settings
class _TranslationsSettingsMlIn implements TranslationsSettingsEn {
	_TranslationsSettingsMlIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesMlIn implements TranslationsRecipesEn {
	_TranslationsRecipesMlIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMlIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMlIn._(this._root);
...
// Path: filters
class _TranslationsFiltersMlIn implements TranslationsFiltersEn {
	_TranslationsFiltersMlIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMlIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListMlIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMlIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanMlIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryMlIn implements TranslationsInventoryEn {
	_TranslationsInventoryMlIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMlIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMlIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMlIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMlIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMlIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMlIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMlIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMlIn._(this._root);
...
class _TranslationsDomainDiscoveryMlIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMlIn._(this._root);
...
class _TranslationsInventorySuggestionsMlIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMlIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMlIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeMlIn._(this._root);
...
// Path: tour
class _TranslationsTourMlIn implements TranslationsTourEn {
	_TranslationsTourMlIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMlIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMlIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMlIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMlIn._(this._root);
...
// Path: errors
class _TranslationsErrorsMlIn implements TranslationsErrorsEn {
	_TranslationsErrorsMlIn._(this._root);
...
class _TranslationsSettingsMeasurementsMlIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMlIn._(this._root);
...
class _TranslationsSettingsDataManagementMlIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMlIn._(this._root);
...
class _TranslationsSettingsVersionMlIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMlIn._(this._root);
...
class _TranslationsRecipeDetailNutritionMlIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMlIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMlIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMlIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMlIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMlIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMlIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMlIn._(this._root);
