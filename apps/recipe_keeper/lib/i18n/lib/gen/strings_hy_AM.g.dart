...
// Path: <root>
class TranslationsHyAm with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppHyAm implements TranslationsAppEn {
	_TranslationsAppHyAm._(this._root);
...
// Path: home
class _TranslationsHomeHyAm implements TranslationsHomeEn {
	_TranslationsHomeHyAm._(this._root);
...
// Path: common
class _TranslationsCommonHyAm implements TranslationsCommonEn {
	_TranslationsCommonHyAm._(this._root);
...
// Path: settings
class _TranslationsSettingsHyAm implements TranslationsSettingsEn {
	_TranslationsSettingsHyAm._(this._root);
...
// Path: recipes
class _TranslationsRecipesHyAm implements TranslationsRecipesEn {
	_TranslationsRecipesHyAm._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHyAm implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHyAm._(this._root);
...
// Path: filters
class _TranslationsFiltersHyAm implements TranslationsFiltersEn {
	_TranslationsFiltersHyAm._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListHyAm implements TranslationsShoppingListEn {
	_TranslationsShoppingListHyAm._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanHyAm implements TranslationsMealPlanEn {
	_TranslationsMealPlanHyAm._(this._root);
...
// Path: inventory
class _TranslationsInventoryHyAm implements TranslationsInventoryEn {
	_TranslationsInventoryHyAm._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHyAm implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHyAm._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanHyAm implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanHyAm._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingHyAm implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingHyAm._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHyAm implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHyAm._(this._root);
...
class _TranslationsDomainDiscoveryHyAm implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHyAm._(this._root);
...
class _TranslationsInventorySuggestionsHyAm implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHyAm._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeHyAm implements TranslationsUpgradeEn {
	_TranslationsUpgradeHyAm._(this._root);
...
// Path: tour
class _TranslationsTourHyAm implements TranslationsTourEn {
	_TranslationsTourHyAm._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHyAm implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeHyAm._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHyAm implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditHyAm._(this._root);
...
// Path: errors
class _TranslationsErrorsHyAm implements TranslationsErrorsEn {
	_TranslationsErrorsHyAm._(this._root);
...
class _TranslationsSettingsMeasurementsHyAm implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHyAm._(this._root);
...
class _TranslationsSettingsDataManagementHyAm implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHyAm._(this._root);
...
class _TranslationsSettingsVersionHyAm implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHyAm._(this._root);
...
class _TranslationsRecipeDetailNutritionHyAm implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHyAm._(this._root);
...
class _TranslationsRecipeDetailPrepAheadHyAm implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHyAm._(this._root);
...
class _TranslationsSettingsMeasurementsMetricHyAm implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHyAm._(this._root);
...
class _TranslationsSettingsMeasurementsImperialHyAm implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHyAm._(this._root);
