...
// Path: <root>
class TranslationsMk with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppMk implements TranslationsAppEn {
	_TranslationsAppMk._(this._root);
...
// Path: home
class _TranslationsHomeMk implements TranslationsHomeEn {
	_TranslationsHomeMk._(this._root);
...
// Path: common
class _TranslationsCommonMk implements TranslationsCommonEn {
	_TranslationsCommonMk._(this._root);
...
// Path: settings
class _TranslationsSettingsMk implements TranslationsSettingsEn {
	_TranslationsSettingsMk._(this._root);
...
// Path: recipes
class _TranslationsRecipesMk implements TranslationsRecipesEn {
	_TranslationsRecipesMk._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMk implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMk._(this._root);
...
// Path: filters
class _TranslationsFiltersMk implements TranslationsFiltersEn {
	_TranslationsFiltersMk._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMk implements TranslationsShoppingListEn {
	_TranslationsShoppingListMk._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMk implements TranslationsMealPlanEn {
	_TranslationsMealPlanMk._(this._root);
...
// Path: inventory
class _TranslationsInventoryMk implements TranslationsInventoryEn {
	_TranslationsInventoryMk._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMk implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMk._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMk implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMk._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMk implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMk._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMk implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMk._(this._root);
...
class _TranslationsDomainDiscoveryMk implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMk._(this._root);
...
class _TranslationsInventorySuggestionsMk implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMk._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMk implements TranslationsUpgradeEn {
	_TranslationsUpgradeMk._(this._root);
...
// Path: tour
class _TranslationsTourMk implements TranslationsTourEn {
	_TranslationsTourMk._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMk implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMk._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMk implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMk._(this._root);
...
// Path: errors
class _TranslationsErrorsMk implements TranslationsErrorsEn {
	_TranslationsErrorsMk._(this._root);
...
class _TranslationsSettingsMeasurementsMk implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMk._(this._root);
...
class _TranslationsSettingsDataManagementMk implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMk._(this._root);
...
class _TranslationsSettingsVersionMk implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMk._(this._root);
...
class _TranslationsRecipeDetailNutritionMk implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMk._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMk implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMk._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMk implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMk._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMk implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMk._(this._root);
