...
// Path: app
class _TranslationsAppTh implements TranslationsAppEn {
	_TranslationsAppTh._(this._root);
...
// Path: recipes
class _TranslationsRecipesTh implements TranslationsRecipesEn {
	_TranslationsRecipesTh._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTh implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTh._(this._root);
...
// Path: filters
class _TranslationsFiltersTh implements TranslationsFiltersEn {
	_TranslationsFiltersTh._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTh implements TranslationsShoppingListEn {
	_TranslationsShoppingListTh._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTh implements TranslationsMealPlanEn {
	_TranslationsMealPlanTh._(this._root);
...
// Path: inventory
class _TranslationsInventoryTh implements TranslationsInventoryEn {
	_TranslationsInventoryTh._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTh implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTh._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTh implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTh._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTh implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTh._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTh implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTh._(this._root);
...
class _TranslationsDomainDiscoveryTh implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTh._(this._root);
...
class _TranslationsInventorySuggestionsTh implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTh._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTh implements TranslationsUpgradeEn {
	_TranslationsUpgradeTh._(this._root);
...
// Path: tour
class _TranslationsTourTh implements TranslationsTourEn {
	_TranslationsTourTh._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTh implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTh._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTh implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTh._(this._root);
...
class _TranslationsSettingsMeasurementsTh implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTh._(this._root);
...
class _TranslationsSettingsDataManagementTh implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTh._(this._root);
...
class _TranslationsSettingsVersionTh implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTh._(this._root);
...
class _TranslationsRecipeDetailNutritionTh implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTh._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTh implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTh._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTh implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTh._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTh implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTh._(this._root);
