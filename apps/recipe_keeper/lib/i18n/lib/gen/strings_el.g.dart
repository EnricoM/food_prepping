...
// Path: recipes
class _TranslationsRecipesEl implements TranslationsRecipesEn {
	_TranslationsRecipesEl._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEl implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEl._(this._root);
...
// Path: filters
class _TranslationsFiltersEl implements TranslationsFiltersEn {
	_TranslationsFiltersEl._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListEl implements TranslationsShoppingListEn {
	_TranslationsShoppingListEl._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanEl implements TranslationsMealPlanEn {
	_TranslationsMealPlanEl._(this._root);
...
// Path: inventory
class _TranslationsInventoryEl implements TranslationsInventoryEn {
	_TranslationsInventoryEl._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEl implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEl._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanEl implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanEl._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingEl implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingEl._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEl implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEl._(this._root);
...
class _TranslationsDomainDiscoveryEl implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEl._(this._root);
...
class _TranslationsInventorySuggestionsEl implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEl._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeEl implements TranslationsUpgradeEn {
	_TranslationsUpgradeEl._(this._root);
...
// Path: tour
class _TranslationsTourEl implements TranslationsTourEn {
	_TranslationsTourEl._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEl implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeEl._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEl implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditEl._(this._root);
...
class _TranslationsSettingsMeasurementsEl implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEl._(this._root);
...
class _TranslationsSettingsDataManagementEl implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEl._(this._root);
...
class _TranslationsSettingsVersionEl implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEl._(this._root);
...
class _TranslationsRecipeDetailNutritionEl implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEl._(this._root);
...
class _TranslationsRecipeDetailPrepAheadEl implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEl._(this._root);
...
class _TranslationsSettingsMeasurementsMetricEl implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEl._(this._root);
...
class _TranslationsSettingsMeasurementsImperialEl implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEl._(this._root);
