...
// Path: <root>
class TranslationsBnBd with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppBnBd implements TranslationsAppEn {
	_TranslationsAppBnBd._(this._root);
...
// Path: home
class _TranslationsHomeBnBd implements TranslationsHomeEn {
	_TranslationsHomeBnBd._(this._root);
...
// Path: common
class _TranslationsCommonBnBd implements TranslationsCommonEn {
	_TranslationsCommonBnBd._(this._root);
...
// Path: settings
class _TranslationsSettingsBnBd implements TranslationsSettingsEn {
	_TranslationsSettingsBnBd._(this._root);
...
// Path: recipes
class _TranslationsRecipesBnBd implements TranslationsRecipesEn {
	_TranslationsRecipesBnBd._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBnBd implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBnBd._(this._root);
...
// Path: filters
class _TranslationsFiltersBnBd implements TranslationsFiltersEn {
	_TranslationsFiltersBnBd._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBnBd implements TranslationsShoppingListEn {
	_TranslationsShoppingListBnBd._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBnBd implements TranslationsMealPlanEn {
	_TranslationsMealPlanBnBd._(this._root);
...
// Path: inventory
class _TranslationsInventoryBnBd implements TranslationsInventoryEn {
	_TranslationsInventoryBnBd._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBnBd implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBnBd._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBnBd implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBnBd._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBnBd implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBnBd._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBnBd implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBnBd._(this._root);
...
class _TranslationsDomainDiscoveryBnBd implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBnBd._(this._root);
...
class _TranslationsInventorySuggestionsBnBd implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBnBd._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBnBd implements TranslationsUpgradeEn {
	_TranslationsUpgradeBnBd._(this._root);
...
// Path: tour
class _TranslationsTourBnBd implements TranslationsTourEn {
	_TranslationsTourBnBd._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBnBd implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBnBd._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBnBd implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBnBd._(this._root);
...
// Path: errors
class _TranslationsErrorsBnBd implements TranslationsErrorsEn {
	_TranslationsErrorsBnBd._(this._root);
...
class _TranslationsSettingsMeasurementsBnBd implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBnBd._(this._root);
...
class _TranslationsSettingsDataManagementBnBd implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBnBd._(this._root);
...
class _TranslationsSettingsVersionBnBd implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBnBd._(this._root);
...
class _TranslationsRecipeDetailNutritionBnBd implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBnBd._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBnBd implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBnBd._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBnBd implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBnBd._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBnBd implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBnBd._(this._root);
