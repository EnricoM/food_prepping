...
// Path: <root>
class TranslationsAmEt with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppAmEt implements TranslationsAppEn {
	_TranslationsAppAmEt._(this._root);
...
// Path: home
class _TranslationsHomeAmEt implements TranslationsHomeEn {
	_TranslationsHomeAmEt._(this._root);
...
// Path: common
class _TranslationsCommonAmEt implements TranslationsCommonEn {
	_TranslationsCommonAmEt._(this._root);
...
// Path: settings
class _TranslationsSettingsAmEt implements TranslationsSettingsEn {
	_TranslationsSettingsAmEt._(this._root);
...
// Path: recipes
class _TranslationsRecipesAmEt implements TranslationsRecipesEn {
	_TranslationsRecipesAmEt._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAmEt implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAmEt._(this._root);
...
// Path: filters
class _TranslationsFiltersAmEt implements TranslationsFiltersEn {
	_TranslationsFiltersAmEt._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListAmEt implements TranslationsShoppingListEn {
	_TranslationsShoppingListAmEt._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanAmEt implements TranslationsMealPlanEn {
	_TranslationsMealPlanAmEt._(this._root);
...
// Path: inventory
class _TranslationsInventoryAmEt implements TranslationsInventoryEn {
	_TranslationsInventoryAmEt._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAmEt implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAmEt._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanAmEt implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanAmEt._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingAmEt implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingAmEt._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAmEt implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAmEt._(this._root);
...
class _TranslationsDomainDiscoveryAmEt implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAmEt._(this._root);
...
class _TranslationsInventorySuggestionsAmEt implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAmEt._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeAmEt implements TranslationsUpgradeEn {
	_TranslationsUpgradeAmEt._(this._root);
...
// Path: tour
class _TranslationsTourAmEt implements TranslationsTourEn {
	_TranslationsTourAmEt._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAmEt implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeAmEt._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAmEt implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditAmEt._(this._root);
...
// Path: errors
class _TranslationsErrorsAmEt implements TranslationsErrorsEn {
	_TranslationsErrorsAmEt._(this._root);
...
class _TranslationsSettingsMeasurementsAmEt implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAmEt._(this._root);
...
class _TranslationsSettingsDataManagementAmEt implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAmEt._(this._root);
...
class _TranslationsSettingsVersionAmEt implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAmEt._(this._root);
...
class _TranslationsRecipeDetailNutritionAmEt implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAmEt._(this._root);
...
class _TranslationsRecipeDetailPrepAheadAmEt implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAmEt._(this._root);
...
class _TranslationsSettingsMeasurementsMetricAmEt implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAmEt._(this._root);
...
class _TranslationsSettingsMeasurementsImperialAmEt implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAmEt._(this._root);
