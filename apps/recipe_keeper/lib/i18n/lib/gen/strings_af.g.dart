...
// Path: <root>
class TranslationsAf with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppAf implements TranslationsAppEn {
	_TranslationsAppAf._(this._root);
...
// Path: home
class _TranslationsHomeAf implements TranslationsHomeEn {
	_TranslationsHomeAf._(this._root);
...
// Path: settings
class _TranslationsSettingsAf implements TranslationsSettingsEn {
	_TranslationsSettingsAf._(this._root);
...
// Path: recipes
class _TranslationsRecipesAf implements TranslationsRecipesEn {
	_TranslationsRecipesAf._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAf implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAf._(this._root);
...
// Path: filters
class _TranslationsFiltersAf implements TranslationsFiltersEn {
	_TranslationsFiltersAf._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListAf implements TranslationsShoppingListEn {
	_TranslationsShoppingListAf._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanAf implements TranslationsMealPlanEn {
	_TranslationsMealPlanAf._(this._root);
...
// Path: inventory
class _TranslationsInventoryAf implements TranslationsInventoryEn {
	_TranslationsInventoryAf._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAf implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAf._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanAf implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanAf._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingAf implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingAf._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAf implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAf._(this._root);
...
class _TranslationsDomainDiscoveryAf implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAf._(this._root);
...
class _TranslationsInventorySuggestionsAf implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAf._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeAf implements TranslationsUpgradeEn {
	_TranslationsUpgradeAf._(this._root);
...
// Path: tour
class _TranslationsTourAf implements TranslationsTourEn {
	_TranslationsTourAf._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAf implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeAf._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAf implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditAf._(this._root);
...
// Path: errors
class _TranslationsErrorsAf implements TranslationsErrorsEn {
	_TranslationsErrorsAf._(this._root);
...
class _TranslationsSettingsMeasurementsAf implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAf._(this._root);
...
class _TranslationsSettingsDataManagementAf implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAf._(this._root);
...
class _TranslationsSettingsVersionAf implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAf._(this._root);
...
class _TranslationsRecipeDetailNutritionAf implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAf._(this._root);
...
class _TranslationsRecipeDetailPrepAheadAf implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAf._(this._root);
...
class _TranslationsSettingsMeasurementsMetricAf implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAf._(this._root);
...
class _TranslationsSettingsMeasurementsImperialAf implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAf._(this._root);
