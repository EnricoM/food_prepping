...
// Path: <root>
class TranslationsAm with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppAm implements TranslationsAppEn {
	_TranslationsAppAm._(this._root);
...
// Path: home
class _TranslationsHomeAm implements TranslationsHomeEn {
	_TranslationsHomeAm._(this._root);
...
// Path: common
class _TranslationsCommonAm implements TranslationsCommonEn {
	_TranslationsCommonAm._(this._root);
...
// Path: settings
class _TranslationsSettingsAm implements TranslationsSettingsEn {
	_TranslationsSettingsAm._(this._root);
...
// Path: recipes
class _TranslationsRecipesAm implements TranslationsRecipesEn {
	_TranslationsRecipesAm._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAm implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAm._(this._root);
...
// Path: filters
class _TranslationsFiltersAm implements TranslationsFiltersEn {
	_TranslationsFiltersAm._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListAm implements TranslationsShoppingListEn {
	_TranslationsShoppingListAm._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanAm implements TranslationsMealPlanEn {
	_TranslationsMealPlanAm._(this._root);
...
// Path: inventory
class _TranslationsInventoryAm implements TranslationsInventoryEn {
	_TranslationsInventoryAm._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAm implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAm._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanAm implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanAm._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingAm implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingAm._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAm implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAm._(this._root);
...
class _TranslationsDomainDiscoveryAm implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAm._(this._root);
...
class _TranslationsInventorySuggestionsAm implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAm._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeAm implements TranslationsUpgradeEn {
	_TranslationsUpgradeAm._(this._root);
...
// Path: tour
class _TranslationsTourAm implements TranslationsTourEn {
	_TranslationsTourAm._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAm implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeAm._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAm implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditAm._(this._root);
...
// Path: errors
class _TranslationsErrorsAm implements TranslationsErrorsEn {
	_TranslationsErrorsAm._(this._root);
...
class _TranslationsSettingsMeasurementsAm implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAm._(this._root);
...
class _TranslationsSettingsDataManagementAm implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAm._(this._root);
...
class _TranslationsSettingsVersionAm implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAm._(this._root);
...
class _TranslationsRecipeDetailNutritionAm implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAm._(this._root);
...
class _TranslationsRecipeDetailPrepAheadAm implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAm._(this._root);
...
class _TranslationsSettingsMeasurementsMetricAm implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAm._(this._root);
...
class _TranslationsSettingsMeasurementsImperialAm implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAm._(this._root);
