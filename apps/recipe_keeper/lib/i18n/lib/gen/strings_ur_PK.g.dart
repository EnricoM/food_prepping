...
// Path: <root>
class TranslationsUrPk with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppUrPk implements TranslationsAppEn {
	_TranslationsAppUrPk._(this._root);
...
// Path: home
class _TranslationsHomeUrPk implements TranslationsHomeEn {
	_TranslationsHomeUrPk._(this._root);
...
// Path: common
class _TranslationsCommonUrPk implements TranslationsCommonEn {
	_TranslationsCommonUrPk._(this._root);
...
// Path: settings
class _TranslationsSettingsUrPk implements TranslationsSettingsEn {
	_TranslationsSettingsUrPk._(this._root);
...
// Path: recipes
class _TranslationsRecipesUrPk implements TranslationsRecipesEn {
	_TranslationsRecipesUrPk._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUrPk implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUrPk._(this._root);
...
// Path: filters
class _TranslationsFiltersUrPk implements TranslationsFiltersEn {
	_TranslationsFiltersUrPk._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListUrPk implements TranslationsShoppingListEn {
	_TranslationsShoppingListUrPk._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanUrPk implements TranslationsMealPlanEn {
	_TranslationsMealPlanUrPk._(this._root);
...
// Path: inventory
class _TranslationsInventoryUrPk implements TranslationsInventoryEn {
	_TranslationsInventoryUrPk._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUrPk implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUrPk._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanUrPk implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanUrPk._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingUrPk implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingUrPk._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUrPk implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUrPk._(this._root);
...
class _TranslationsDomainDiscoveryUrPk implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUrPk._(this._root);
...
class _TranslationsInventorySuggestionsUrPk implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUrPk._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeUrPk implements TranslationsUpgradeEn {
	_TranslationsUpgradeUrPk._(this._root);
...
// Path: tour
class _TranslationsTourUrPk implements TranslationsTourEn {
	_TranslationsTourUrPk._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUrPk implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeUrPk._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUrPk implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditUrPk._(this._root);
...
// Path: errors
class _TranslationsErrorsUrPk implements TranslationsErrorsEn {
	_TranslationsErrorsUrPk._(this._root);
...
class _TranslationsSettingsMeasurementsUrPk implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUrPk._(this._root);
...
class _TranslationsSettingsDataManagementUrPk implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUrPk._(this._root);
...
class _TranslationsSettingsVersionUrPk implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUrPk._(this._root);
...
class _TranslationsRecipeDetailNutritionUrPk implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUrPk._(this._root);
...
class _TranslationsRecipeDetailPrepAheadUrPk implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUrPk._(this._root);
...
class _TranslationsSettingsMeasurementsMetricUrPk implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUrPk._(this._root);
...
class _TranslationsSettingsMeasurementsImperialUrPk implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUrPk._(this._root);
