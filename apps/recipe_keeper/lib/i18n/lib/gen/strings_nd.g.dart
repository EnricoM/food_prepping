...
// Path: <root>
class TranslationsNd with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppNd implements TranslationsAppEn {
	_TranslationsAppNd._(this._root);
...
// Path: home
class _TranslationsHomeNd implements TranslationsHomeEn {
	_TranslationsHomeNd._(this._root);
...
// Path: common
class _TranslationsCommonNd implements TranslationsCommonEn {
	_TranslationsCommonNd._(this._root);
...
// Path: settings
class _TranslationsSettingsNd implements TranslationsSettingsEn {
	_TranslationsSettingsNd._(this._root);
...
// Path: recipes
class _TranslationsRecipesNd implements TranslationsRecipesEn {
	_TranslationsRecipesNd._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNd implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNd._(this._root);
...
// Path: filters
class _TranslationsFiltersNd implements TranslationsFiltersEn {
	_TranslationsFiltersNd._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListNd implements TranslationsShoppingListEn {
	_TranslationsShoppingListNd._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanNd implements TranslationsMealPlanEn {
	_TranslationsMealPlanNd._(this._root);
...
// Path: inventory
class _TranslationsInventoryNd implements TranslationsInventoryEn {
	_TranslationsInventoryNd._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNd implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNd._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanNd implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanNd._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingNd implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingNd._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNd implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNd._(this._root);
...
class _TranslationsDomainDiscoveryNd implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNd._(this._root);
...
class _TranslationsInventorySuggestionsNd implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNd._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeNd implements TranslationsUpgradeEn {
	_TranslationsUpgradeNd._(this._root);
...
// Path: tour
class _TranslationsTourNd implements TranslationsTourEn {
	_TranslationsTourNd._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNd implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeNd._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNd implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditNd._(this._root);
...
// Path: errors
class _TranslationsErrorsNd implements TranslationsErrorsEn {
	_TranslationsErrorsNd._(this._root);
...
class _TranslationsSettingsMeasurementsNd implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNd._(this._root);
...
class _TranslationsSettingsDataManagementNd implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNd._(this._root);
...
class _TranslationsSettingsVersionNd implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNd._(this._root);
...
class _TranslationsRecipeDetailNutritionNd implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNd._(this._root);
...
class _TranslationsRecipeDetailPrepAheadNd implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNd._(this._root);
...
class _TranslationsSettingsMeasurementsMetricNd implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNd._(this._root);
...
class _TranslationsSettingsMeasurementsImperialNd implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNd._(this._root);
