...
// Path: recipes
class _TranslationsRecipesSv implements TranslationsRecipesEn {
	_TranslationsRecipesSv._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSv implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSv._(this._root);
...
// Path: filters
class _TranslationsFiltersSv implements TranslationsFiltersEn {
	_TranslationsFiltersSv._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSv implements TranslationsShoppingListEn {
	_TranslationsShoppingListSv._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSv implements TranslationsMealPlanEn {
	_TranslationsMealPlanSv._(this._root);
...
// Path: inventory
class _TranslationsInventorySv implements TranslationsInventoryEn {
	_TranslationsInventorySv._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSv implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSv._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSv implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSv._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSv implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSv._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSv implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSv._(this._root);
...
class _TranslationsDomainDiscoverySv implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySv._(this._root);
...
class _TranslationsInventorySuggestionsSv implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSv._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSv implements TranslationsUpgradeEn {
	_TranslationsUpgradeSv._(this._root);
...
// Path: tour
class _TranslationsTourSv implements TranslationsTourEn {
	_TranslationsTourSv._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSv implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSv._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSv implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSv._(this._root);
...
class _TranslationsSettingsMeasurementsSv implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSv._(this._root);
...
class _TranslationsSettingsDataManagementSv implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSv._(this._root);
...
class _TranslationsSettingsVersionSv implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSv._(this._root);
...
class _TranslationsRecipeDetailNutritionSv implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSv._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSv implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSv._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSv implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSv._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSv implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSv._(this._root);
