...
// Path: <root>
class TranslationsLt with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppLt implements TranslationsAppEn {
	_TranslationsAppLt._(this._root);
...
// Path: home
class _TranslationsHomeLt implements TranslationsHomeEn {
	_TranslationsHomeLt._(this._root);
...
// Path: settings
class _TranslationsSettingsLt implements TranslationsSettingsEn {
	_TranslationsSettingsLt._(this._root);
...
// Path: recipes
class _TranslationsRecipesLt implements TranslationsRecipesEn {
	_TranslationsRecipesLt._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLt implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLt._(this._root);
...
// Path: filters
class _TranslationsFiltersLt implements TranslationsFiltersEn {
	_TranslationsFiltersLt._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListLt implements TranslationsShoppingListEn {
	_TranslationsShoppingListLt._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanLt implements TranslationsMealPlanEn {
	_TranslationsMealPlanLt._(this._root);
...
// Path: inventory
class _TranslationsInventoryLt implements TranslationsInventoryEn {
	_TranslationsInventoryLt._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLt implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLt._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanLt implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanLt._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingLt implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingLt._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLt implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLt._(this._root);
...
class _TranslationsDomainDiscoveryLt implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLt._(this._root);
...
class _TranslationsInventorySuggestionsLt implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLt._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeLt implements TranslationsUpgradeEn {
	_TranslationsUpgradeLt._(this._root);
...
// Path: tour
class _TranslationsTourLt implements TranslationsTourEn {
	_TranslationsTourLt._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLt implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeLt._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLt implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditLt._(this._root);
...
// Path: errors
class _TranslationsErrorsLt implements TranslationsErrorsEn {
	_TranslationsErrorsLt._(this._root);
...
class _TranslationsSettingsMeasurementsLt implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLt._(this._root);
...
class _TranslationsSettingsDataManagementLt implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLt._(this._root);
...
class _TranslationsSettingsVersionLt implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLt._(this._root);
...
class _TranslationsRecipeDetailNutritionLt implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLt._(this._root);
...
class _TranslationsRecipeDetailPrepAheadLt implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLt._(this._root);
...
class _TranslationsSettingsMeasurementsMetricLt implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLt._(this._root);
...
class _TranslationsSettingsMeasurementsImperialLt implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLt._(this._root);
