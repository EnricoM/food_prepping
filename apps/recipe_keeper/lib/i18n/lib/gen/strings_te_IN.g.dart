...
// Path: <root>
class TranslationsTeIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppTeIn implements TranslationsAppEn {
	_TranslationsAppTeIn._(this._root);
...
// Path: home
class _TranslationsHomeTeIn implements TranslationsHomeEn {
	_TranslationsHomeTeIn._(this._root);
...
// Path: common
class _TranslationsCommonTeIn implements TranslationsCommonEn {
	_TranslationsCommonTeIn._(this._root);
...
// Path: settings
class _TranslationsSettingsTeIn implements TranslationsSettingsEn {
	_TranslationsSettingsTeIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesTeIn implements TranslationsRecipesEn {
	_TranslationsRecipesTeIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTeIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTeIn._(this._root);
...
// Path: filters
class _TranslationsFiltersTeIn implements TranslationsFiltersEn {
	_TranslationsFiltersTeIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTeIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListTeIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTeIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanTeIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryTeIn implements TranslationsInventoryEn {
	_TranslationsInventoryTeIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTeIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTeIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTeIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTeIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTeIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTeIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTeIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTeIn._(this._root);
...
class _TranslationsDomainDiscoveryTeIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTeIn._(this._root);
...
class _TranslationsInventorySuggestionsTeIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTeIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTeIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeTeIn._(this._root);
...
// Path: tour
class _TranslationsTourTeIn implements TranslationsTourEn {
	_TranslationsTourTeIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTeIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTeIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTeIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTeIn._(this._root);
...
// Path: errors
class _TranslationsErrorsTeIn implements TranslationsErrorsEn {
	_TranslationsErrorsTeIn._(this._root);
...
class _TranslationsSettingsMeasurementsTeIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTeIn._(this._root);
...
class _TranslationsSettingsDataManagementTeIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTeIn._(this._root);
...
class _TranslationsSettingsVersionTeIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTeIn._(this._root);
...
class _TranslationsRecipeDetailNutritionTeIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTeIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTeIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTeIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTeIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTeIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTeIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTeIn._(this._root);
