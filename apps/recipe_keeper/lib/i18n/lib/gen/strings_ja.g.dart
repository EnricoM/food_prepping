...
// Path: recipes
class _TranslationsRecipesJa implements TranslationsRecipesEn {
	_TranslationsRecipesJa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailJa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailJa._(this._root);
...
// Path: filters
class _TranslationsFiltersJa implements TranslationsFiltersEn {
	_TranslationsFiltersJa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListJa implements TranslationsShoppingListEn {
	_TranslationsShoppingListJa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanJa implements TranslationsMealPlanEn {
	_TranslationsMealPlanJa._(this._root);
...
// Path: inventory
class _TranslationsInventoryJa implements TranslationsInventoryEn {
	_TranslationsInventoryJa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanJa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanJa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanJa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanJa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingJa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingJa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsJa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsJa._(this._root);
...
class _TranslationsDomainDiscoveryJa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryJa._(this._root);
...
class _TranslationsInventorySuggestionsJa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsJa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeJa implements TranslationsUpgradeEn {
	_TranslationsUpgradeJa._(this._root);
...
// Path: tour
class _TranslationsTourJa implements TranslationsTourEn {
	_TranslationsTourJa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeJa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeJa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditJa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditJa._(this._root);
...
class _TranslationsSettingsMeasurementsJa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsJa._(this._root);
...
class _TranslationsSettingsDataManagementJa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementJa._(this._root);
...
class _TranslationsSettingsVersionJa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionJa._(this._root);
...
class _TranslationsRecipeDetailNutritionJa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionJa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadJa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadJa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricJa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricJa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialJa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialJa._(this._root);
