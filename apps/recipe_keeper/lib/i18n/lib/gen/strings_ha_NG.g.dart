...
// Path: <root>
class TranslationsHaNg with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppHaNg implements TranslationsAppEn {
	_TranslationsAppHaNg._(this._root);
...
// Path: home
class _TranslationsHomeHaNg implements TranslationsHomeEn {
	_TranslationsHomeHaNg._(this._root);
...
// Path: common
class _TranslationsCommonHaNg implements TranslationsCommonEn {
	_TranslationsCommonHaNg._(this._root);
...
// Path: settings
class _TranslationsSettingsHaNg implements TranslationsSettingsEn {
	_TranslationsSettingsHaNg._(this._root);
...
// Path: recipes
class _TranslationsRecipesHaNg implements TranslationsRecipesEn {
	_TranslationsRecipesHaNg._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHaNg implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHaNg._(this._root);
...
// Path: filters
class _TranslationsFiltersHaNg implements TranslationsFiltersEn {
	_TranslationsFiltersHaNg._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListHaNg implements TranslationsShoppingListEn {
	_TranslationsShoppingListHaNg._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanHaNg implements TranslationsMealPlanEn {
	_TranslationsMealPlanHaNg._(this._root);
...
// Path: inventory
class _TranslationsInventoryHaNg implements TranslationsInventoryEn {
	_TranslationsInventoryHaNg._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHaNg implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHaNg._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanHaNg implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanHaNg._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingHaNg implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingHaNg._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHaNg implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHaNg._(this._root);
...
class _TranslationsDomainDiscoveryHaNg implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHaNg._(this._root);
...
class _TranslationsInventorySuggestionsHaNg implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHaNg._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeHaNg implements TranslationsUpgradeEn {
	_TranslationsUpgradeHaNg._(this._root);
...
// Path: tour
class _TranslationsTourHaNg implements TranslationsTourEn {
	_TranslationsTourHaNg._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHaNg implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeHaNg._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHaNg implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditHaNg._(this._root);
...
// Path: errors
class _TranslationsErrorsHaNg implements TranslationsErrorsEn {
	_TranslationsErrorsHaNg._(this._root);
...
class _TranslationsSettingsMeasurementsHaNg implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHaNg._(this._root);
...
class _TranslationsSettingsDataManagementHaNg implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHaNg._(this._root);
...
class _TranslationsSettingsVersionHaNg implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHaNg._(this._root);
...
class _TranslationsRecipeDetailNutritionHaNg implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHaNg._(this._root);
...
class _TranslationsRecipeDetailPrepAheadHaNg implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHaNg._(this._root);
...
class _TranslationsSettingsMeasurementsMetricHaNg implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHaNg._(this._root);
...
class _TranslationsSettingsMeasurementsImperialHaNg implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHaNg._(this._root);
