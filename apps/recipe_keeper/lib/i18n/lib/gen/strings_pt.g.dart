...
// Path: recipes
class _TranslationsRecipesPt implements TranslationsRecipesEn {
	_TranslationsRecipesPt._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPt implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPt._(this._root);
...
// Path: filters
class _TranslationsFiltersPt implements TranslationsFiltersEn {
	_TranslationsFiltersPt._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListPt implements TranslationsShoppingListEn {
	_TranslationsShoppingListPt._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanPt implements TranslationsMealPlanEn {
	_TranslationsMealPlanPt._(this._root);
...
// Path: inventory
class _TranslationsInventoryPt implements TranslationsInventoryEn {
	_TranslationsInventoryPt._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPt implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPt._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanPt implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanPt._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingPt implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingPt._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPt implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPt._(this._root);
...
class _TranslationsDomainDiscoveryPt implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPt._(this._root);
...
class _TranslationsInventorySuggestionsPt implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPt._(this._root);
...
// Path: upgrade
class _TranslationsUpgradePt implements TranslationsUpgradeEn {
	_TranslationsUpgradePt._(this._root);
...
// Path: tour
class _TranslationsTourPt implements TranslationsTourEn {
	_TranslationsTourPt._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipePt implements TranslationsManualRecipeEn {
	_TranslationsManualRecipePt._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPt implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditPt._(this._root);
...
class _TranslationsSettingsMeasurementsPt implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPt._(this._root);
...
class _TranslationsSettingsDataManagementPt implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPt._(this._root);
...
class _TranslationsSettingsVersionPt implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPt._(this._root);
...
class _TranslationsRecipeDetailNutritionPt implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPt._(this._root);
...
class _TranslationsRecipeDetailPrepAheadPt implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPt._(this._root);
...
class _TranslationsSettingsMeasurementsMetricPt implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPt._(this._root);
...
class _TranslationsSettingsMeasurementsImperialPt implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPt._(this._root);
