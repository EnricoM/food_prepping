...
// Path: <root>
class TranslationsAfZa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppAfZa implements TranslationsAppEn {
	_TranslationsAppAfZa._(this._root);
...
// Path: home
class _TranslationsHomeAfZa implements TranslationsHomeEn {
	_TranslationsHomeAfZa._(this._root);
...
// Path: common
class _TranslationsCommonAfZa implements TranslationsCommonEn {
	_TranslationsCommonAfZa._(this._root);
...
// Path: settings
class _TranslationsSettingsAfZa implements TranslationsSettingsEn {
	_TranslationsSettingsAfZa._(this._root);
...
// Path: recipes
class _TranslationsRecipesAfZa implements TranslationsRecipesEn {
	_TranslationsRecipesAfZa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAfZa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAfZa._(this._root);
...
// Path: filters
class _TranslationsFiltersAfZa implements TranslationsFiltersEn {
	_TranslationsFiltersAfZa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListAfZa implements TranslationsShoppingListEn {
	_TranslationsShoppingListAfZa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanAfZa implements TranslationsMealPlanEn {
	_TranslationsMealPlanAfZa._(this._root);
...
// Path: inventory
class _TranslationsInventoryAfZa implements TranslationsInventoryEn {
	_TranslationsInventoryAfZa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAfZa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAfZa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanAfZa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanAfZa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingAfZa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingAfZa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAfZa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAfZa._(this._root);
...
class _TranslationsDomainDiscoveryAfZa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAfZa._(this._root);
...
class _TranslationsInventorySuggestionsAfZa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAfZa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeAfZa implements TranslationsUpgradeEn {
	_TranslationsUpgradeAfZa._(this._root);
...
// Path: tour
class _TranslationsTourAfZa implements TranslationsTourEn {
	_TranslationsTourAfZa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAfZa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeAfZa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAfZa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditAfZa._(this._root);
...
// Path: errors
class _TranslationsErrorsAfZa implements TranslationsErrorsEn {
	_TranslationsErrorsAfZa._(this._root);
...
class _TranslationsSettingsMeasurementsAfZa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAfZa._(this._root);
...
class _TranslationsSettingsDataManagementAfZa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAfZa._(this._root);
...
class _TranslationsSettingsVersionAfZa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAfZa._(this._root);
...
class _TranslationsRecipeDetailNutritionAfZa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAfZa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadAfZa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAfZa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricAfZa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAfZa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialAfZa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAfZa._(this._root);
