...
// Path: <root>
class TranslationsAz with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppAz implements TranslationsAppEn {
	_TranslationsAppAz._(this._root);
...
// Path: home
class _TranslationsHomeAz implements TranslationsHomeEn {
	_TranslationsHomeAz._(this._root);
...
// Path: common
class _TranslationsCommonAz implements TranslationsCommonEn {
	_TranslationsCommonAz._(this._root);
...
// Path: settings
class _TranslationsSettingsAz implements TranslationsSettingsEn {
	_TranslationsSettingsAz._(this._root);
...
// Path: recipes
class _TranslationsRecipesAz implements TranslationsRecipesEn {
	_TranslationsRecipesAz._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAz implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAz._(this._root);
...
// Path: filters
class _TranslationsFiltersAz implements TranslationsFiltersEn {
	_TranslationsFiltersAz._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListAz implements TranslationsShoppingListEn {
	_TranslationsShoppingListAz._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanAz implements TranslationsMealPlanEn {
	_TranslationsMealPlanAz._(this._root);
...
// Path: inventory
class _TranslationsInventoryAz implements TranslationsInventoryEn {
	_TranslationsInventoryAz._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAz implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAz._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanAz implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanAz._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingAz implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingAz._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAz implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAz._(this._root);
...
class _TranslationsDomainDiscoveryAz implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAz._(this._root);
...
class _TranslationsInventorySuggestionsAz implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAz._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeAz implements TranslationsUpgradeEn {
	_TranslationsUpgradeAz._(this._root);
...
// Path: tour
class _TranslationsTourAz implements TranslationsTourEn {
	_TranslationsTourAz._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAz implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeAz._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAz implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditAz._(this._root);
...
// Path: errors
class _TranslationsErrorsAz implements TranslationsErrorsEn {
	_TranslationsErrorsAz._(this._root);
...
class _TranslationsSettingsMeasurementsAz implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAz._(this._root);
...
class _TranslationsSettingsDataManagementAz implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAz._(this._root);
...
class _TranslationsSettingsVersionAz implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAz._(this._root);
...
class _TranslationsRecipeDetailNutritionAz implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAz._(this._root);
...
class _TranslationsRecipeDetailPrepAheadAz implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAz._(this._root);
...
class _TranslationsSettingsMeasurementsMetricAz implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAz._(this._root);
...
class _TranslationsSettingsMeasurementsImperialAz implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAz._(this._root);
