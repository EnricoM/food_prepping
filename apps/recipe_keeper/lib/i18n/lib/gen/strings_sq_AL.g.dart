...
// Path: <root>
class TranslationsSqAl with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppSqAl implements TranslationsAppEn {
	_TranslationsAppSqAl._(this._root);
...
// Path: home
class _TranslationsHomeSqAl implements TranslationsHomeEn {
	_TranslationsHomeSqAl._(this._root);
...
// Path: common
class _TranslationsCommonSqAl implements TranslationsCommonEn {
	_TranslationsCommonSqAl._(this._root);
...
// Path: settings
class _TranslationsSettingsSqAl implements TranslationsSettingsEn {
	_TranslationsSettingsSqAl._(this._root);
...
// Path: recipes
class _TranslationsRecipesSqAl implements TranslationsRecipesEn {
	_TranslationsRecipesSqAl._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSqAl implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSqAl._(this._root);
...
// Path: filters
class _TranslationsFiltersSqAl implements TranslationsFiltersEn {
	_TranslationsFiltersSqAl._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSqAl implements TranslationsShoppingListEn {
	_TranslationsShoppingListSqAl._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSqAl implements TranslationsMealPlanEn {
	_TranslationsMealPlanSqAl._(this._root);
...
// Path: inventory
class _TranslationsInventorySqAl implements TranslationsInventoryEn {
	_TranslationsInventorySqAl._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSqAl implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSqAl._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSqAl implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSqAl._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSqAl implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSqAl._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSqAl implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSqAl._(this._root);
...
class _TranslationsDomainDiscoverySqAl implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySqAl._(this._root);
...
class _TranslationsInventorySuggestionsSqAl implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSqAl._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSqAl implements TranslationsUpgradeEn {
	_TranslationsUpgradeSqAl._(this._root);
...
// Path: tour
class _TranslationsTourSqAl implements TranslationsTourEn {
	_TranslationsTourSqAl._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSqAl implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSqAl._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSqAl implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSqAl._(this._root);
...
// Path: errors
class _TranslationsErrorsSqAl implements TranslationsErrorsEn {
	_TranslationsErrorsSqAl._(this._root);
...
class _TranslationsSettingsMeasurementsSqAl implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSqAl._(this._root);
...
class _TranslationsSettingsDataManagementSqAl implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSqAl._(this._root);
...
class _TranslationsSettingsVersionSqAl implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSqAl._(this._root);
...
class _TranslationsRecipeDetailNutritionSqAl implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSqAl._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSqAl implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSqAl._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSqAl implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSqAl._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSqAl implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSqAl._(this._root);
