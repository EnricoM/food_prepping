...
// Path: <root>
class TranslationsZuZa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppZuZa implements TranslationsAppEn {
	_TranslationsAppZuZa._(this._root);
...
// Path: home
class _TranslationsHomeZuZa implements TranslationsHomeEn {
	_TranslationsHomeZuZa._(this._root);
...
// Path: common
class _TranslationsCommonZuZa implements TranslationsCommonEn {
	_TranslationsCommonZuZa._(this._root);
...
// Path: settings
class _TranslationsSettingsZuZa implements TranslationsSettingsEn {
	_TranslationsSettingsZuZa._(this._root);
...
// Path: recipes
class _TranslationsRecipesZuZa implements TranslationsRecipesEn {
	_TranslationsRecipesZuZa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZuZa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZuZa._(this._root);
...
// Path: filters
class _TranslationsFiltersZuZa implements TranslationsFiltersEn {
	_TranslationsFiltersZuZa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListZuZa implements TranslationsShoppingListEn {
	_TranslationsShoppingListZuZa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanZuZa implements TranslationsMealPlanEn {
	_TranslationsMealPlanZuZa._(this._root);
...
// Path: inventory
class _TranslationsInventoryZuZa implements TranslationsInventoryEn {
	_TranslationsInventoryZuZa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZuZa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZuZa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanZuZa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanZuZa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingZuZa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingZuZa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZuZa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZuZa._(this._root);
...
class _TranslationsDomainDiscoveryZuZa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZuZa._(this._root);
...
class _TranslationsInventorySuggestionsZuZa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZuZa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeZuZa implements TranslationsUpgradeEn {
	_TranslationsUpgradeZuZa._(this._root);
...
// Path: tour
class _TranslationsTourZuZa implements TranslationsTourEn {
	_TranslationsTourZuZa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZuZa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeZuZa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZuZa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditZuZa._(this._root);
...
// Path: errors
class _TranslationsErrorsZuZa implements TranslationsErrorsEn {
	_TranslationsErrorsZuZa._(this._root);
...
class _TranslationsSettingsMeasurementsZuZa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZuZa._(this._root);
...
class _TranslationsSettingsDataManagementZuZa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZuZa._(this._root);
...
class _TranslationsSettingsVersionZuZa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZuZa._(this._root);
...
class _TranslationsRecipeDetailNutritionZuZa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZuZa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadZuZa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZuZa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricZuZa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZuZa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialZuZa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZuZa._(this._root);
