...
// Path: <root>
class TranslationsNeNp with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppNeNp implements TranslationsAppEn {
	_TranslationsAppNeNp._(this._root);
...
// Path: home
class _TranslationsHomeNeNp implements TranslationsHomeEn {
	_TranslationsHomeNeNp._(this._root);
...
// Path: common
class _TranslationsCommonNeNp implements TranslationsCommonEn {
	_TranslationsCommonNeNp._(this._root);
...
// Path: settings
class _TranslationsSettingsNeNp implements TranslationsSettingsEn {
	_TranslationsSettingsNeNp._(this._root);
...
// Path: recipes
class _TranslationsRecipesNeNp implements TranslationsRecipesEn {
	_TranslationsRecipesNeNp._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNeNp implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNeNp._(this._root);
...
// Path: filters
class _TranslationsFiltersNeNp implements TranslationsFiltersEn {
	_TranslationsFiltersNeNp._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListNeNp implements TranslationsShoppingListEn {
	_TranslationsShoppingListNeNp._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanNeNp implements TranslationsMealPlanEn {
	_TranslationsMealPlanNeNp._(this._root);
...
// Path: inventory
class _TranslationsInventoryNeNp implements TranslationsInventoryEn {
	_TranslationsInventoryNeNp._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNeNp implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNeNp._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanNeNp implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanNeNp._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingNeNp implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingNeNp._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNeNp implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNeNp._(this._root);
...
class _TranslationsDomainDiscoveryNeNp implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNeNp._(this._root);
...
class _TranslationsInventorySuggestionsNeNp implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNeNp._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeNeNp implements TranslationsUpgradeEn {
	_TranslationsUpgradeNeNp._(this._root);
...
// Path: tour
class _TranslationsTourNeNp implements TranslationsTourEn {
	_TranslationsTourNeNp._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNeNp implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeNeNp._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNeNp implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditNeNp._(this._root);
...
// Path: errors
class _TranslationsErrorsNeNp implements TranslationsErrorsEn {
	_TranslationsErrorsNeNp._(this._root);
...
class _TranslationsSettingsMeasurementsNeNp implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNeNp._(this._root);
...
class _TranslationsSettingsDataManagementNeNp implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNeNp._(this._root);
...
class _TranslationsSettingsVersionNeNp implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNeNp._(this._root);
...
class _TranslationsRecipeDetailNutritionNeNp implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNeNp._(this._root);
...
class _TranslationsRecipeDetailPrepAheadNeNp implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNeNp._(this._root);
...
class _TranslationsSettingsMeasurementsMetricNeNp implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNeNp._(this._root);
...
class _TranslationsSettingsMeasurementsImperialNeNp implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNeNp._(this._root);
