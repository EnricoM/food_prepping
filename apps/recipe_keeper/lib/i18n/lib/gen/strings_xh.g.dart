...
// Path: <root>
class TranslationsXh with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppXh implements TranslationsAppEn {
	_TranslationsAppXh._(this._root);
...
// Path: home
class _TranslationsHomeXh implements TranslationsHomeEn {
	_TranslationsHomeXh._(this._root);
...
// Path: common
class _TranslationsCommonXh implements TranslationsCommonEn {
	_TranslationsCommonXh._(this._root);
...
// Path: settings
class _TranslationsSettingsXh implements TranslationsSettingsEn {
	_TranslationsSettingsXh._(this._root);
...
// Path: recipes
class _TranslationsRecipesXh implements TranslationsRecipesEn {
	_TranslationsRecipesXh._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailXh implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailXh._(this._root);
...
// Path: filters
class _TranslationsFiltersXh implements TranslationsFiltersEn {
	_TranslationsFiltersXh._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListXh implements TranslationsShoppingListEn {
	_TranslationsShoppingListXh._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanXh implements TranslationsMealPlanEn {
	_TranslationsMealPlanXh._(this._root);
...
// Path: inventory
class _TranslationsInventoryXh implements TranslationsInventoryEn {
	_TranslationsInventoryXh._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanXh implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanXh._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanXh implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanXh._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingXh implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingXh._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsXh implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsXh._(this._root);
...
class _TranslationsDomainDiscoveryXh implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryXh._(this._root);
...
class _TranslationsInventorySuggestionsXh implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsXh._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeXh implements TranslationsUpgradeEn {
	_TranslationsUpgradeXh._(this._root);
...
// Path: tour
class _TranslationsTourXh implements TranslationsTourEn {
	_TranslationsTourXh._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeXh implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeXh._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditXh implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditXh._(this._root);
...
// Path: errors
class _TranslationsErrorsXh implements TranslationsErrorsEn {
	_TranslationsErrorsXh._(this._root);
...
class _TranslationsSettingsMeasurementsXh implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsXh._(this._root);
...
class _TranslationsSettingsDataManagementXh implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementXh._(this._root);
...
class _TranslationsSettingsVersionXh implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionXh._(this._root);
...
class _TranslationsRecipeDetailNutritionXh implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionXh._(this._root);
...
class _TranslationsRecipeDetailPrepAheadXh implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadXh._(this._root);
...
class _TranslationsSettingsMeasurementsMetricXh implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricXh._(this._root);
...
class _TranslationsSettingsMeasurementsImperialXh implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialXh._(this._root);
