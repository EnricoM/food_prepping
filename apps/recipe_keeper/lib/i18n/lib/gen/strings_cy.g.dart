...
// Path: <root>
class TranslationsCy with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppCy implements TranslationsAppEn {
	_TranslationsAppCy._(this._root);
...
// Path: home
class _TranslationsHomeCy implements TranslationsHomeEn {
	_TranslationsHomeCy._(this._root);
...
// Path: common
class _TranslationsCommonCy implements TranslationsCommonEn {
	_TranslationsCommonCy._(this._root);
...
// Path: settings
class _TranslationsSettingsCy implements TranslationsSettingsEn {
	_TranslationsSettingsCy._(this._root);
...
// Path: recipes
class _TranslationsRecipesCy implements TranslationsRecipesEn {
	_TranslationsRecipesCy._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCy implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCy._(this._root);
...
// Path: filters
class _TranslationsFiltersCy implements TranslationsFiltersEn {
	_TranslationsFiltersCy._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListCy implements TranslationsShoppingListEn {
	_TranslationsShoppingListCy._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanCy implements TranslationsMealPlanEn {
	_TranslationsMealPlanCy._(this._root);
...
// Path: inventory
class _TranslationsInventoryCy implements TranslationsInventoryEn {
	_TranslationsInventoryCy._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCy implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCy._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanCy implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanCy._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingCy implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingCy._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCy implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCy._(this._root);
...
class _TranslationsDomainDiscoveryCy implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCy._(this._root);
...
class _TranslationsInventorySuggestionsCy implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCy._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeCy implements TranslationsUpgradeEn {
	_TranslationsUpgradeCy._(this._root);
...
// Path: tour
class _TranslationsTourCy implements TranslationsTourEn {
	_TranslationsTourCy._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCy implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeCy._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCy implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditCy._(this._root);
...
// Path: errors
class _TranslationsErrorsCy implements TranslationsErrorsEn {
	_TranslationsErrorsCy._(this._root);
...
class _TranslationsSettingsMeasurementsCy implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCy._(this._root);
...
class _TranslationsSettingsDataManagementCy implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCy._(this._root);
...
class _TranslationsSettingsVersionCy implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCy._(this._root);
...
class _TranslationsRecipeDetailNutritionCy implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCy._(this._root);
...
class _TranslationsRecipeDetailPrepAheadCy implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCy._(this._root);
...
class _TranslationsSettingsMeasurementsMetricCy implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCy._(this._root);
...
class _TranslationsSettingsMeasurementsImperialCy implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCy._(this._root);
