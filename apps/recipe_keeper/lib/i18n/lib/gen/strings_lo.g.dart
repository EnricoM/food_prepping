...
// Path: app
class _TranslationsAppLo implements TranslationsAppEn {
	_TranslationsAppLo._(this._root);
...
// Path: home
class _TranslationsHomeLo implements TranslationsHomeEn {
	_TranslationsHomeLo._(this._root);
...
// Path: settings
class _TranslationsSettingsLo implements TranslationsSettingsEn {
	_TranslationsSettingsLo._(this._root);
...
// Path: recipes
class _TranslationsRecipesLo implements TranslationsRecipesEn {
	_TranslationsRecipesLo._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLo implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLo._(this._root);
...
// Path: filters
class _TranslationsFiltersLo implements TranslationsFiltersEn {
	_TranslationsFiltersLo._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListLo implements TranslationsShoppingListEn {
	_TranslationsShoppingListLo._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanLo implements TranslationsMealPlanEn {
	_TranslationsMealPlanLo._(this._root);
...
// Path: inventory
class _TranslationsInventoryLo implements TranslationsInventoryEn {
	_TranslationsInventoryLo._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLo implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLo._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanLo implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanLo._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingLo implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingLo._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLo implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLo._(this._root);
...
class _TranslationsDomainDiscoveryLo implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLo._(this._root);
...
class _TranslationsInventorySuggestionsLo implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLo._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeLo implements TranslationsUpgradeEn {
	_TranslationsUpgradeLo._(this._root);
...
// Path: tour
class _TranslationsTourLo implements TranslationsTourEn {
	_TranslationsTourLo._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLo implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeLo._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLo implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditLo._(this._root);
...
// Path: errors
class _TranslationsErrorsLo implements TranslationsErrorsEn {
	_TranslationsErrorsLo._(this._root);
...
class _TranslationsSettingsMeasurementsLo implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLo._(this._root);
...
class _TranslationsSettingsDataManagementLo implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLo._(this._root);
...
class _TranslationsSettingsVersionLo implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLo._(this._root);
...
class _TranslationsRecipeDetailNutritionLo implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLo._(this._root);
...
class _TranslationsRecipeDetailPrepAheadLo implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLo._(this._root);
...
class _TranslationsSettingsMeasurementsMetricLo implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLo._(this._root);
...
class _TranslationsSettingsMeasurementsImperialLo implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLo._(this._root);
