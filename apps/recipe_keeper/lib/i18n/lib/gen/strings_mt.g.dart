...
// Path: <root>
class TranslationsMt with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppMt implements TranslationsAppEn {
	_TranslationsAppMt._(this._root);
...
// Path: home
class _TranslationsHomeMt implements TranslationsHomeEn {
	_TranslationsHomeMt._(this._root);
...
// Path: common
class _TranslationsCommonMt implements TranslationsCommonEn {
	_TranslationsCommonMt._(this._root);
...
// Path: settings
class _TranslationsSettingsMt implements TranslationsSettingsEn {
	_TranslationsSettingsMt._(this._root);
...
// Path: recipes
class _TranslationsRecipesMt implements TranslationsRecipesEn {
	_TranslationsRecipesMt._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMt implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMt._(this._root);
...
// Path: filters
class _TranslationsFiltersMt implements TranslationsFiltersEn {
	_TranslationsFiltersMt._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMt implements TranslationsShoppingListEn {
	_TranslationsShoppingListMt._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMt implements TranslationsMealPlanEn {
	_TranslationsMealPlanMt._(this._root);
...
// Path: inventory
class _TranslationsInventoryMt implements TranslationsInventoryEn {
	_TranslationsInventoryMt._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMt implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMt._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMt implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMt._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMt implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMt._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMt implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMt._(this._root);
...
class _TranslationsDomainDiscoveryMt implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMt._(this._root);
...
class _TranslationsInventorySuggestionsMt implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMt._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMt implements TranslationsUpgradeEn {
	_TranslationsUpgradeMt._(this._root);
...
// Path: tour
class _TranslationsTourMt implements TranslationsTourEn {
	_TranslationsTourMt._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMt implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMt._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMt implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMt._(this._root);
...
// Path: errors
class _TranslationsErrorsMt implements TranslationsErrorsEn {
	_TranslationsErrorsMt._(this._root);
...
class _TranslationsSettingsMeasurementsMt implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMt._(this._root);
...
class _TranslationsSettingsDataManagementMt implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMt._(this._root);
...
class _TranslationsSettingsVersionMt implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMt._(this._root);
...
class _TranslationsRecipeDetailNutritionMt implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMt._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMt implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMt._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMt implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMt._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMt implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMt._(this._root);
