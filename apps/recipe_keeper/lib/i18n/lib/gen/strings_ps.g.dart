...
// Path: <root>
class TranslationsPs with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppPs implements TranslationsAppEn {
	_TranslationsAppPs._(this._root);
...
// Path: home
class _TranslationsHomePs implements TranslationsHomeEn {
	_TranslationsHomePs._(this._root);
...
// Path: common
class _TranslationsCommonPs implements TranslationsCommonEn {
	_TranslationsCommonPs._(this._root);
...
// Path: settings
class _TranslationsSettingsPs implements TranslationsSettingsEn {
	_TranslationsSettingsPs._(this._root);
...
// Path: recipes
class _TranslationsRecipesPs implements TranslationsRecipesEn {
	_TranslationsRecipesPs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPs._(this._root);
...
// Path: filters
class _TranslationsFiltersPs implements TranslationsFiltersEn {
	_TranslationsFiltersPs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListPs implements TranslationsShoppingListEn {
	_TranslationsShoppingListPs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanPs implements TranslationsMealPlanEn {
	_TranslationsMealPlanPs._(this._root);
...
// Path: inventory
class _TranslationsInventoryPs implements TranslationsInventoryEn {
	_TranslationsInventoryPs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanPs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanPs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingPs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingPs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPs._(this._root);
...
class _TranslationsDomainDiscoveryPs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPs._(this._root);
...
class _TranslationsInventorySuggestionsPs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradePs implements TranslationsUpgradeEn {
	_TranslationsUpgradePs._(this._root);
...
// Path: tour
class _TranslationsTourPs implements TranslationsTourEn {
	_TranslationsTourPs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipePs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipePs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditPs._(this._root);
...
// Path: errors
class _TranslationsErrorsPs implements TranslationsErrorsEn {
	_TranslationsErrorsPs._(this._root);
...
class _TranslationsSettingsMeasurementsPs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPs._(this._root);
...
class _TranslationsSettingsDataManagementPs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPs._(this._root);
...
class _TranslationsSettingsVersionPs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPs._(this._root);
...
class _TranslationsRecipeDetailNutritionPs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadPs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricPs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialPs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPs._(this._root);
