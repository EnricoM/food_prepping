...
// Path: <root>
class TranslationsEuEs with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppEuEs implements TranslationsAppEn {
	_TranslationsAppEuEs._(this._root);
...
// Path: home
class _TranslationsHomeEuEs implements TranslationsHomeEn {
	_TranslationsHomeEuEs._(this._root);
...
// Path: common
class _TranslationsCommonEuEs implements TranslationsCommonEn {
	_TranslationsCommonEuEs._(this._root);
...
// Path: settings
class _TranslationsSettingsEuEs implements TranslationsSettingsEn {
	_TranslationsSettingsEuEs._(this._root);
...
// Path: recipes
class _TranslationsRecipesEuEs implements TranslationsRecipesEn {
	_TranslationsRecipesEuEs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEuEs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEuEs._(this._root);
...
// Path: filters
class _TranslationsFiltersEuEs implements TranslationsFiltersEn {
	_TranslationsFiltersEuEs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListEuEs implements TranslationsShoppingListEn {
	_TranslationsShoppingListEuEs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanEuEs implements TranslationsMealPlanEn {
	_TranslationsMealPlanEuEs._(this._root);
...
// Path: inventory
class _TranslationsInventoryEuEs implements TranslationsInventoryEn {
	_TranslationsInventoryEuEs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEuEs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEuEs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanEuEs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanEuEs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingEuEs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingEuEs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEuEs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEuEs._(this._root);
...
class _TranslationsDomainDiscoveryEuEs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEuEs._(this._root);
...
class _TranslationsInventorySuggestionsEuEs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEuEs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeEuEs implements TranslationsUpgradeEn {
	_TranslationsUpgradeEuEs._(this._root);
...
// Path: tour
class _TranslationsTourEuEs implements TranslationsTourEn {
	_TranslationsTourEuEs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEuEs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeEuEs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEuEs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditEuEs._(this._root);
...
// Path: errors
class _TranslationsErrorsEuEs implements TranslationsErrorsEn {
	_TranslationsErrorsEuEs._(this._root);
...
class _TranslationsSettingsMeasurementsEuEs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEuEs._(this._root);
...
class _TranslationsSettingsDataManagementEuEs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEuEs._(this._root);
...
class _TranslationsSettingsVersionEuEs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEuEs._(this._root);
...
class _TranslationsRecipeDetailNutritionEuEs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEuEs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadEuEs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEuEs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricEuEs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEuEs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialEuEs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEuEs._(this._root);
