...
// Path: app
class _TranslationsAppBg implements TranslationsAppEn {
	_TranslationsAppBg._(this._root);
...
// Path: home
class _TranslationsHomeBg implements TranslationsHomeEn {
	_TranslationsHomeBg._(this._root);
...
// Path: settings
class _TranslationsSettingsBg implements TranslationsSettingsEn {
	_TranslationsSettingsBg._(this._root);
...
// Path: recipes
class _TranslationsRecipesBg implements TranslationsRecipesEn {
	_TranslationsRecipesBg._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBg implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBg._(this._root);
...
// Path: filters
class _TranslationsFiltersBg implements TranslationsFiltersEn {
	_TranslationsFiltersBg._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBg implements TranslationsShoppingListEn {
	_TranslationsShoppingListBg._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBg implements TranslationsMealPlanEn {
	_TranslationsMealPlanBg._(this._root);
...
// Path: inventory
class _TranslationsInventoryBg implements TranslationsInventoryEn {
	_TranslationsInventoryBg._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBg implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBg._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBg implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBg._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBg implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBg._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBg implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBg._(this._root);
...
class _TranslationsDomainDiscoveryBg implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBg._(this._root);
...
class _TranslationsInventorySuggestionsBg implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBg._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBg implements TranslationsUpgradeEn {
	_TranslationsUpgradeBg._(this._root);
...
// Path: tour
class _TranslationsTourBg implements TranslationsTourEn {
	_TranslationsTourBg._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBg implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBg._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBg implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBg._(this._root);
...
// Path: errors
class _TranslationsErrorsBg implements TranslationsErrorsEn {
	_TranslationsErrorsBg._(this._root);
...
class _TranslationsSettingsMeasurementsBg implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBg._(this._root);
...
class _TranslationsSettingsDataManagementBg implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBg._(this._root);
...
class _TranslationsSettingsVersionBg implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBg._(this._root);
...
class _TranslationsRecipeDetailNutritionBg implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBg._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBg implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBg._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBg implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBg._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBg implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBg._(this._root);
