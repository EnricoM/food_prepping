...
// Path: app
class _TranslationsAppUk implements TranslationsAppEn {
	_TranslationsAppUk._(this._root);
...
// Path: recipes
class _TranslationsRecipesUk implements TranslationsRecipesEn {
	_TranslationsRecipesUk._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUk implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUk._(this._root);
...
// Path: filters
class _TranslationsFiltersUk implements TranslationsFiltersEn {
	_TranslationsFiltersUk._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListUk implements TranslationsShoppingListEn {
	_TranslationsShoppingListUk._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanUk implements TranslationsMealPlanEn {
	_TranslationsMealPlanUk._(this._root);
...
// Path: inventory
class _TranslationsInventoryUk implements TranslationsInventoryEn {
	_TranslationsInventoryUk._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUk implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUk._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanUk implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanUk._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingUk implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingUk._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUk implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUk._(this._root);
...
class _TranslationsDomainDiscoveryUk implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUk._(this._root);
...
class _TranslationsInventorySuggestionsUk implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUk._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeUk implements TranslationsUpgradeEn {
	_TranslationsUpgradeUk._(this._root);
...
// Path: tour
class _TranslationsTourUk implements TranslationsTourEn {
	_TranslationsTourUk._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUk implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeUk._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUk implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditUk._(this._root);
...
class _TranslationsSettingsMeasurementsUk implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUk._(this._root);
...
class _TranslationsSettingsDataManagementUk implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUk._(this._root);
...
class _TranslationsSettingsVersionUk implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUk._(this._root);
...
class _TranslationsRecipeDetailNutritionUk implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUk._(this._root);
...
class _TranslationsRecipeDetailPrepAheadUk implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUk._(this._root);
...
class _TranslationsSettingsMeasurementsMetricUk implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUk._(this._root);
...
class _TranslationsSettingsMeasurementsImperialUk implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUk._(this._root);
