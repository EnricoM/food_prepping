...
// Path: recipes
class _TranslationsRecipesTa implements TranslationsRecipesEn {
	_TranslationsRecipesTa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTa._(this._root);
...
// Path: filters
class _TranslationsFiltersTa implements TranslationsFiltersEn {
	_TranslationsFiltersTa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTa implements TranslationsShoppingListEn {
	_TranslationsShoppingListTa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTa implements TranslationsMealPlanEn {
	_TranslationsMealPlanTa._(this._root);
...
// Path: inventory
class _TranslationsInventoryTa implements TranslationsInventoryEn {
	_TranslationsInventoryTa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTa._(this._root);
...
class _TranslationsDomainDiscoveryTa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTa._(this._root);
...
class _TranslationsInventorySuggestionsTa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTa implements TranslationsUpgradeEn {
	_TranslationsUpgradeTa._(this._root);
...
// Path: tour
class _TranslationsTourTa implements TranslationsTourEn {
	_TranslationsTourTa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTa._(this._root);
...
class _TranslationsSettingsMeasurementsTa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTa._(this._root);
...
class _TranslationsSettingsDataManagementTa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTa._(this._root);
...
class _TranslationsSettingsVersionTa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTa._(this._root);
...
class _TranslationsRecipeDetailNutritionTa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTa._(this._root);
