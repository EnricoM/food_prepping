...
// Path: app
class _TranslationsAppKm implements TranslationsAppEn {
	_TranslationsAppKm._(this._root);
...
// Path: home
class _TranslationsHomeKm implements TranslationsHomeEn {
	_TranslationsHomeKm._(this._root);
...
// Path: settings
class _TranslationsSettingsKm implements TranslationsSettingsEn {
	_TranslationsSettingsKm._(this._root);
...
// Path: recipes
class _TranslationsRecipesKm implements TranslationsRecipesEn {
	_TranslationsRecipesKm._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKm implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKm._(this._root);
...
// Path: filters
class _TranslationsFiltersKm implements TranslationsFiltersEn {
	_TranslationsFiltersKm._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKm implements TranslationsShoppingListEn {
	_TranslationsShoppingListKm._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKm implements TranslationsMealPlanEn {
	_TranslationsMealPlanKm._(this._root);
...
// Path: inventory
class _TranslationsInventoryKm implements TranslationsInventoryEn {
	_TranslationsInventoryKm._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKm implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKm._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKm implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKm._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKm implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKm._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKm implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKm._(this._root);
...
class _TranslationsDomainDiscoveryKm implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKm._(this._root);
...
class _TranslationsInventorySuggestionsKm implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKm._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKm implements TranslationsUpgradeEn {
	_TranslationsUpgradeKm._(this._root);
...
// Path: tour
class _TranslationsTourKm implements TranslationsTourEn {
	_TranslationsTourKm._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKm implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKm._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKm implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKm._(this._root);
...
// Path: errors
class _TranslationsErrorsKm implements TranslationsErrorsEn {
	_TranslationsErrorsKm._(this._root);
...
class _TranslationsSettingsMeasurementsKm implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKm._(this._root);
...
class _TranslationsSettingsDataManagementKm implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKm._(this._root);
...
class _TranslationsSettingsVersionKm implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKm._(this._root);
...
class _TranslationsRecipeDetailNutritionKm implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKm._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKm implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKm._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKm implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKm._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKm implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKm._(this._root);
