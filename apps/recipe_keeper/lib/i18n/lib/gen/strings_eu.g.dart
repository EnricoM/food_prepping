...
// Path: <root>
class TranslationsEu with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppEu implements TranslationsAppEn {
	_TranslationsAppEu._(this._root);
...
// Path: home
class _TranslationsHomeEu implements TranslationsHomeEn {
	_TranslationsHomeEu._(this._root);
...
// Path: common
class _TranslationsCommonEu implements TranslationsCommonEn {
	_TranslationsCommonEu._(this._root);
...
// Path: settings
class _TranslationsSettingsEu implements TranslationsSettingsEn {
	_TranslationsSettingsEu._(this._root);
...
// Path: recipes
class _TranslationsRecipesEu implements TranslationsRecipesEn {
	_TranslationsRecipesEu._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEu implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEu._(this._root);
...
// Path: filters
class _TranslationsFiltersEu implements TranslationsFiltersEn {
	_TranslationsFiltersEu._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListEu implements TranslationsShoppingListEn {
	_TranslationsShoppingListEu._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanEu implements TranslationsMealPlanEn {
	_TranslationsMealPlanEu._(this._root);
...
// Path: inventory
class _TranslationsInventoryEu implements TranslationsInventoryEn {
	_TranslationsInventoryEu._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEu implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEu._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanEu implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanEu._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingEu implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingEu._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEu implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEu._(this._root);
...
class _TranslationsDomainDiscoveryEu implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEu._(this._root);
...
class _TranslationsInventorySuggestionsEu implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEu._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeEu implements TranslationsUpgradeEn {
	_TranslationsUpgradeEu._(this._root);
...
// Path: tour
class _TranslationsTourEu implements TranslationsTourEn {
	_TranslationsTourEu._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEu implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeEu._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEu implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditEu._(this._root);
...
// Path: errors
class _TranslationsErrorsEu implements TranslationsErrorsEn {
	_TranslationsErrorsEu._(this._root);
...
class _TranslationsSettingsMeasurementsEu implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEu._(this._root);
...
class _TranslationsSettingsDataManagementEu implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEu._(this._root);
...
class _TranslationsSettingsVersionEu implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEu._(this._root);
...
class _TranslationsRecipeDetailNutritionEu implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEu._(this._root);
...
class _TranslationsRecipeDetailPrepAheadEu implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEu._(this._root);
...
class _TranslationsSettingsMeasurementsMetricEu implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEu._(this._root);
...
class _TranslationsSettingsMeasurementsImperialEu implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEu._(this._root);
