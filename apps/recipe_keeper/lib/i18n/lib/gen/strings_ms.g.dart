...
// Path: app
class _TranslationsAppMs implements TranslationsAppEn {
	_TranslationsAppMs._(this._root);
...
// Path: recipes
class _TranslationsRecipesMs implements TranslationsRecipesEn {
	_TranslationsRecipesMs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMs._(this._root);
...
// Path: filters
class _TranslationsFiltersMs implements TranslationsFiltersEn {
	_TranslationsFiltersMs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMs implements TranslationsShoppingListEn {
	_TranslationsShoppingListMs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMs implements TranslationsMealPlanEn {
	_TranslationsMealPlanMs._(this._root);
...
// Path: inventory
class _TranslationsInventoryMs implements TranslationsInventoryEn {
	_TranslationsInventoryMs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMs._(this._root);
...
class _TranslationsDomainDiscoveryMs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMs._(this._root);
...
class _TranslationsInventorySuggestionsMs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMs implements TranslationsUpgradeEn {
	_TranslationsUpgradeMs._(this._root);
...
// Path: tour
class _TranslationsTourMs implements TranslationsTourEn {
	_TranslationsTourMs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMs._(this._root);
...
class _TranslationsSettingsMeasurementsMs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMs._(this._root);
...
class _TranslationsSettingsDataManagementMs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMs._(this._root);
...
class _TranslationsSettingsVersionMs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMs._(this._root);
...
class _TranslationsRecipeDetailNutritionMs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMs._(this._root);
