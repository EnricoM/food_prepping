...
// Path: <root>
class TranslationsKaGe with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKaGe implements TranslationsAppEn {
	_TranslationsAppKaGe._(this._root);
...
// Path: home
class _TranslationsHomeKaGe implements TranslationsHomeEn {
	_TranslationsHomeKaGe._(this._root);
...
// Path: common
class _TranslationsCommonKaGe implements TranslationsCommonEn {
	_TranslationsCommonKaGe._(this._root);
...
// Path: settings
class _TranslationsSettingsKaGe implements TranslationsSettingsEn {
	_TranslationsSettingsKaGe._(this._root);
...
// Path: recipes
class _TranslationsRecipesKaGe implements TranslationsRecipesEn {
	_TranslationsRecipesKaGe._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKaGe implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKaGe._(this._root);
...
// Path: filters
class _TranslationsFiltersKaGe implements TranslationsFiltersEn {
	_TranslationsFiltersKaGe._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKaGe implements TranslationsShoppingListEn {
	_TranslationsShoppingListKaGe._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKaGe implements TranslationsMealPlanEn {
	_TranslationsMealPlanKaGe._(this._root);
...
// Path: inventory
class _TranslationsInventoryKaGe implements TranslationsInventoryEn {
	_TranslationsInventoryKaGe._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKaGe implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKaGe._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKaGe implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKaGe._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKaGe implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKaGe._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKaGe implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKaGe._(this._root);
...
class _TranslationsDomainDiscoveryKaGe implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKaGe._(this._root);
...
class _TranslationsInventorySuggestionsKaGe implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKaGe._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKaGe implements TranslationsUpgradeEn {
	_TranslationsUpgradeKaGe._(this._root);
...
// Path: tour
class _TranslationsTourKaGe implements TranslationsTourEn {
	_TranslationsTourKaGe._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKaGe implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKaGe._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKaGe implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKaGe._(this._root);
...
// Path: errors
class _TranslationsErrorsKaGe implements TranslationsErrorsEn {
	_TranslationsErrorsKaGe._(this._root);
...
class _TranslationsSettingsMeasurementsKaGe implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKaGe._(this._root);
...
class _TranslationsSettingsDataManagementKaGe implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKaGe._(this._root);
...
class _TranslationsSettingsVersionKaGe implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKaGe._(this._root);
...
class _TranslationsRecipeDetailNutritionKaGe implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKaGe._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKaGe implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKaGe._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKaGe implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKaGe._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKaGe implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKaGe._(this._root);
