...
// Path: <root>
class TranslationsZu with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppZu implements TranslationsAppEn {
	_TranslationsAppZu._(this._root);
...
// Path: home
class _TranslationsHomeZu implements TranslationsHomeEn {
	_TranslationsHomeZu._(this._root);
...
// Path: common
class _TranslationsCommonZu implements TranslationsCommonEn {
	_TranslationsCommonZu._(this._root);
...
// Path: settings
class _TranslationsSettingsZu implements TranslationsSettingsEn {
	_TranslationsSettingsZu._(this._root);
...
// Path: recipes
class _TranslationsRecipesZu implements TranslationsRecipesEn {
	_TranslationsRecipesZu._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailZu implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailZu._(this._root);
...
// Path: filters
class _TranslationsFiltersZu implements TranslationsFiltersEn {
	_TranslationsFiltersZu._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListZu implements TranslationsShoppingListEn {
	_TranslationsShoppingListZu._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanZu implements TranslationsMealPlanEn {
	_TranslationsMealPlanZu._(this._root);
...
// Path: inventory
class _TranslationsInventoryZu implements TranslationsInventoryEn {
	_TranslationsInventoryZu._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanZu implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanZu._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanZu implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanZu._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingZu implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingZu._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsZu implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsZu._(this._root);
...
class _TranslationsDomainDiscoveryZu implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryZu._(this._root);
...
class _TranslationsInventorySuggestionsZu implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsZu._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeZu implements TranslationsUpgradeEn {
	_TranslationsUpgradeZu._(this._root);
...
// Path: tour
class _TranslationsTourZu implements TranslationsTourEn {
	_TranslationsTourZu._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeZu implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeZu._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditZu implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditZu._(this._root);
...
// Path: errors
class _TranslationsErrorsZu implements TranslationsErrorsEn {
	_TranslationsErrorsZu._(this._root);
...
class _TranslationsSettingsMeasurementsZu implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsZu._(this._root);
...
class _TranslationsSettingsDataManagementZu implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementZu._(this._root);
...
class _TranslationsSettingsVersionZu implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionZu._(this._root);
...
class _TranslationsRecipeDetailNutritionZu implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionZu._(this._root);
...
class _TranslationsRecipeDetailPrepAheadZu implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadZu._(this._root);
...
class _TranslationsSettingsMeasurementsMetricZu implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricZu._(this._root);
...
class _TranslationsSettingsMeasurementsImperialZu implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialZu._(this._root);
