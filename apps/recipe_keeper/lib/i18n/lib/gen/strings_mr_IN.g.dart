...
// Path: <root>
class TranslationsMrIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppMrIn implements TranslationsAppEn {
	_TranslationsAppMrIn._(this._root);
...
// Path: home
class _TranslationsHomeMrIn implements TranslationsHomeEn {
	_TranslationsHomeMrIn._(this._root);
...
// Path: common
class _TranslationsCommonMrIn implements TranslationsCommonEn {
	_TranslationsCommonMrIn._(this._root);
...
// Path: settings
class _TranslationsSettingsMrIn implements TranslationsSettingsEn {
	_TranslationsSettingsMrIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesMrIn implements TranslationsRecipesEn {
	_TranslationsRecipesMrIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMrIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMrIn._(this._root);
...
// Path: filters
class _TranslationsFiltersMrIn implements TranslationsFiltersEn {
	_TranslationsFiltersMrIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMrIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListMrIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMrIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanMrIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryMrIn implements TranslationsInventoryEn {
	_TranslationsInventoryMrIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMrIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMrIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMrIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMrIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMrIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMrIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMrIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMrIn._(this._root);
...
class _TranslationsDomainDiscoveryMrIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMrIn._(this._root);
...
class _TranslationsInventorySuggestionsMrIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMrIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMrIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeMrIn._(this._root);
...
// Path: tour
class _TranslationsTourMrIn implements TranslationsTourEn {
	_TranslationsTourMrIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMrIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMrIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMrIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMrIn._(this._root);
...
// Path: errors
class _TranslationsErrorsMrIn implements TranslationsErrorsEn {
	_TranslationsErrorsMrIn._(this._root);
...
class _TranslationsSettingsMeasurementsMrIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMrIn._(this._root);
...
class _TranslationsSettingsDataManagementMrIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMrIn._(this._root);
...
class _TranslationsSettingsVersionMrIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMrIn._(this._root);
...
class _TranslationsRecipeDetailNutritionMrIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMrIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMrIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMrIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMrIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMrIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMrIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMrIn._(this._root);
