...
// Path: <root>
class TranslationsLa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppLa implements TranslationsAppEn {
	_TranslationsAppLa._(this._root);
...
// Path: home
class _TranslationsHomeLa implements TranslationsHomeEn {
	_TranslationsHomeLa._(this._root);
...
// Path: common
class _TranslationsCommonLa implements TranslationsCommonEn {
	_TranslationsCommonLa._(this._root);
...
// Path: settings
class _TranslationsSettingsLa implements TranslationsSettingsEn {
	_TranslationsSettingsLa._(this._root);
...
// Path: recipes
class _TranslationsRecipesLa implements TranslationsRecipesEn {
	_TranslationsRecipesLa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLa._(this._root);
...
// Path: filters
class _TranslationsFiltersLa implements TranslationsFiltersEn {
	_TranslationsFiltersLa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListLa implements TranslationsShoppingListEn {
	_TranslationsShoppingListLa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanLa implements TranslationsMealPlanEn {
	_TranslationsMealPlanLa._(this._root);
...
// Path: inventory
class _TranslationsInventoryLa implements TranslationsInventoryEn {
	_TranslationsInventoryLa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanLa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanLa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingLa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingLa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLa._(this._root);
...
class _TranslationsDomainDiscoveryLa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLa._(this._root);
...
class _TranslationsInventorySuggestionsLa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeLa implements TranslationsUpgradeEn {
	_TranslationsUpgradeLa._(this._root);
...
// Path: tour
class _TranslationsTourLa implements TranslationsTourEn {
	_TranslationsTourLa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeLa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditLa._(this._root);
...
// Path: errors
class _TranslationsErrorsLa implements TranslationsErrorsEn {
	_TranslationsErrorsLa._(this._root);
...
class _TranslationsSettingsMeasurementsLa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLa._(this._root);
...
class _TranslationsSettingsDataManagementLa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLa._(this._root);
...
class _TranslationsSettingsVersionLa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLa._(this._root);
...
class _TranslationsRecipeDetailNutritionLa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadLa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricLa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialLa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLa._(this._root);
