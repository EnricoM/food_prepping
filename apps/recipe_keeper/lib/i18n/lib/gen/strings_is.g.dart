...
// Path: <root>
class TranslationsIs with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppIs implements TranslationsAppEn {
	_TranslationsAppIs._(this._root);
...
// Path: home
class _TranslationsHomeIs implements TranslationsHomeEn {
	_TranslationsHomeIs._(this._root);
...
// Path: common
class _TranslationsCommonIs implements TranslationsCommonEn {
	_TranslationsCommonIs._(this._root);
...
// Path: settings
class _TranslationsSettingsIs implements TranslationsSettingsEn {
	_TranslationsSettingsIs._(this._root);
...
// Path: recipes
class _TranslationsRecipesIs implements TranslationsRecipesEn {
	_TranslationsRecipesIs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIs._(this._root);
...
// Path: filters
class _TranslationsFiltersIs implements TranslationsFiltersEn {
	_TranslationsFiltersIs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListIs implements TranslationsShoppingListEn {
	_TranslationsShoppingListIs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanIs implements TranslationsMealPlanEn {
	_TranslationsMealPlanIs._(this._root);
...
// Path: inventory
class _TranslationsInventoryIs implements TranslationsInventoryEn {
	_TranslationsInventoryIs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanIs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanIs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingIs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingIs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIs._(this._root);
...
class _TranslationsDomainDiscoveryIs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIs._(this._root);
...
class _TranslationsInventorySuggestionsIs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeIs implements TranslationsUpgradeEn {
	_TranslationsUpgradeIs._(this._root);
...
// Path: tour
class _TranslationsTourIs implements TranslationsTourEn {
	_TranslationsTourIs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeIs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditIs._(this._root);
...
// Path: errors
class _TranslationsErrorsIs implements TranslationsErrorsEn {
	_TranslationsErrorsIs._(this._root);
...
class _TranslationsSettingsMeasurementsIs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIs._(this._root);
...
class _TranslationsSettingsDataManagementIs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIs._(this._root);
...
class _TranslationsSettingsVersionIs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIs._(this._root);
...
class _TranslationsRecipeDetailNutritionIs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadIs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricIs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialIs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIs._(this._root);
