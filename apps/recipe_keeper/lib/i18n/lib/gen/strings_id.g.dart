...
// Path: recipes
class _TranslationsRecipesId implements TranslationsRecipesEn {
	_TranslationsRecipesId._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailId implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailId._(this._root);
...
// Path: filters
class _TranslationsFiltersId implements TranslationsFiltersEn {
	_TranslationsFiltersId._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListId implements TranslationsShoppingListEn {
	_TranslationsShoppingListId._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanId implements TranslationsMealPlanEn {
	_TranslationsMealPlanId._(this._root);
...
// Path: inventory
class _TranslationsInventoryId implements TranslationsInventoryEn {
	_TranslationsInventoryId._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanId implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanId._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanId implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanId._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingId implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingId._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsId implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsId._(this._root);
...
class _TranslationsDomainDiscoveryId implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryId._(this._root);
...
class _TranslationsInventorySuggestionsId implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsId._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeId implements TranslationsUpgradeEn {
	_TranslationsUpgradeId._(this._root);
...
// Path: tour
class _TranslationsTourId implements TranslationsTourEn {
	_TranslationsTourId._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeId implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeId._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditId implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditId._(this._root);
...
class _TranslationsSettingsMeasurementsId implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsId._(this._root);
...
class _TranslationsSettingsDataManagementId implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementId._(this._root);
...
class _TranslationsSettingsVersionId implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionId._(this._root);
...
class _TranslationsRecipeDetailNutritionId implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionId._(this._root);
...
class _TranslationsRecipeDetailPrepAheadId implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadId._(this._root);
...
class _TranslationsSettingsMeasurementsMetricId implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricId._(this._root);
...
class _TranslationsSettingsMeasurementsImperialId implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialId._(this._root);
