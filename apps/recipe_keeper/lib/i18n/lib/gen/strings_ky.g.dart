...
// Path: <root>
class TranslationsKy with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKy implements TranslationsAppEn {
	_TranslationsAppKy._(this._root);
...
// Path: home
class _TranslationsHomeKy implements TranslationsHomeEn {
	_TranslationsHomeKy._(this._root);
...
// Path: common
class _TranslationsCommonKy implements TranslationsCommonEn {
	_TranslationsCommonKy._(this._root);
...
// Path: settings
class _TranslationsSettingsKy implements TranslationsSettingsEn {
	_TranslationsSettingsKy._(this._root);
...
// Path: recipes
class _TranslationsRecipesKy implements TranslationsRecipesEn {
	_TranslationsRecipesKy._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKy implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKy._(this._root);
...
// Path: filters
class _TranslationsFiltersKy implements TranslationsFiltersEn {
	_TranslationsFiltersKy._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKy implements TranslationsShoppingListEn {
	_TranslationsShoppingListKy._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKy implements TranslationsMealPlanEn {
	_TranslationsMealPlanKy._(this._root);
...
// Path: inventory
class _TranslationsInventoryKy implements TranslationsInventoryEn {
	_TranslationsInventoryKy._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKy implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKy._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKy implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKy._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKy implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKy._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKy implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKy._(this._root);
...
class _TranslationsDomainDiscoveryKy implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKy._(this._root);
...
class _TranslationsInventorySuggestionsKy implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKy._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKy implements TranslationsUpgradeEn {
	_TranslationsUpgradeKy._(this._root);
...
// Path: tour
class _TranslationsTourKy implements TranslationsTourEn {
	_TranslationsTourKy._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKy implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKy._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKy implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKy._(this._root);
...
// Path: errors
class _TranslationsErrorsKy implements TranslationsErrorsEn {
	_TranslationsErrorsKy._(this._root);
...
class _TranslationsSettingsMeasurementsKy implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKy._(this._root);
...
class _TranslationsSettingsDataManagementKy implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKy._(this._root);
...
class _TranslationsSettingsVersionKy implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKy._(this._root);
...
class _TranslationsRecipeDetailNutritionKy implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKy._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKy implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKy._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKy implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKy._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKy implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKy._(this._root);
