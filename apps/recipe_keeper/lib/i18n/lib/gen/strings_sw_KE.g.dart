...
// Path: <root>
class TranslationsSwKe with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppSwKe implements TranslationsAppEn {
	_TranslationsAppSwKe._(this._root);
...
// Path: home
class _TranslationsHomeSwKe implements TranslationsHomeEn {
	_TranslationsHomeSwKe._(this._root);
...
// Path: common
class _TranslationsCommonSwKe implements TranslationsCommonEn {
	_TranslationsCommonSwKe._(this._root);
...
// Path: settings
class _TranslationsSettingsSwKe implements TranslationsSettingsEn {
	_TranslationsSettingsSwKe._(this._root);
...
// Path: recipes
class _TranslationsRecipesSwKe implements TranslationsRecipesEn {
	_TranslationsRecipesSwKe._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSwKe implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSwKe._(this._root);
...
// Path: filters
class _TranslationsFiltersSwKe implements TranslationsFiltersEn {
	_TranslationsFiltersSwKe._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSwKe implements TranslationsShoppingListEn {
	_TranslationsShoppingListSwKe._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSwKe implements TranslationsMealPlanEn {
	_TranslationsMealPlanSwKe._(this._root);
...
// Path: inventory
class _TranslationsInventorySwKe implements TranslationsInventoryEn {
	_TranslationsInventorySwKe._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSwKe implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSwKe._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSwKe implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSwKe._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSwKe implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSwKe._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSwKe implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSwKe._(this._root);
...
class _TranslationsDomainDiscoverySwKe implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySwKe._(this._root);
...
class _TranslationsInventorySuggestionsSwKe implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSwKe._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSwKe implements TranslationsUpgradeEn {
	_TranslationsUpgradeSwKe._(this._root);
...
// Path: tour
class _TranslationsTourSwKe implements TranslationsTourEn {
	_TranslationsTourSwKe._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSwKe implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSwKe._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSwKe implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSwKe._(this._root);
...
// Path: errors
class _TranslationsErrorsSwKe implements TranslationsErrorsEn {
	_TranslationsErrorsSwKe._(this._root);
...
class _TranslationsSettingsMeasurementsSwKe implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSwKe._(this._root);
...
class _TranslationsSettingsDataManagementSwKe implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSwKe._(this._root);
...
class _TranslationsSettingsVersionSwKe implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSwKe._(this._root);
...
class _TranslationsRecipeDetailNutritionSwKe implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSwKe._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSwKe implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSwKe._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSwKe implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSwKe._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSwKe implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSwKe._(this._root);
