...
// Path: app
class _TranslationsAppLv implements TranslationsAppEn {
	_TranslationsAppLv._(this._root);
...
// Path: home
class _TranslationsHomeLv implements TranslationsHomeEn {
	_TranslationsHomeLv._(this._root);
...
// Path: settings
class _TranslationsSettingsLv implements TranslationsSettingsEn {
	_TranslationsSettingsLv._(this._root);
...
// Path: recipes
class _TranslationsRecipesLv implements TranslationsRecipesEn {
	_TranslationsRecipesLv._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLv implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLv._(this._root);
...
// Path: filters
class _TranslationsFiltersLv implements TranslationsFiltersEn {
	_TranslationsFiltersLv._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListLv implements TranslationsShoppingListEn {
	_TranslationsShoppingListLv._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanLv implements TranslationsMealPlanEn {
	_TranslationsMealPlanLv._(this._root);
...
// Path: inventory
class _TranslationsInventoryLv implements TranslationsInventoryEn {
	_TranslationsInventoryLv._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLv implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLv._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanLv implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanLv._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingLv implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingLv._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLv implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLv._(this._root);
...
class _TranslationsDomainDiscoveryLv implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLv._(this._root);
...
class _TranslationsInventorySuggestionsLv implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLv._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeLv implements TranslationsUpgradeEn {
	_TranslationsUpgradeLv._(this._root);
...
// Path: tour
class _TranslationsTourLv implements TranslationsTourEn {
	_TranslationsTourLv._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLv implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeLv._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLv implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditLv._(this._root);
...
// Path: errors
class _TranslationsErrorsLv implements TranslationsErrorsEn {
	_TranslationsErrorsLv._(this._root);
...
class _TranslationsSettingsMeasurementsLv implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLv._(this._root);
...
class _TranslationsSettingsDataManagementLv implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLv._(this._root);
...
class _TranslationsSettingsVersionLv implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLv._(this._root);
...
class _TranslationsRecipeDetailNutritionLv implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLv._(this._root);
...
class _TranslationsRecipeDetailPrepAheadLv implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLv._(this._root);
...
class _TranslationsSettingsMeasurementsMetricLv implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLv._(this._root);
...
class _TranslationsSettingsMeasurementsImperialLv implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLv._(this._root);
