...
// Path: app
class _TranslationsAppUr implements TranslationsAppEn {
	_TranslationsAppUr._(this._root);
...
// Path: recipes
class _TranslationsRecipesUr implements TranslationsRecipesEn {
	_TranslationsRecipesUr._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUr implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUr._(this._root);
...
// Path: filters
class _TranslationsFiltersUr implements TranslationsFiltersEn {
	_TranslationsFiltersUr._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListUr implements TranslationsShoppingListEn {
	_TranslationsShoppingListUr._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanUr implements TranslationsMealPlanEn {
	_TranslationsMealPlanUr._(this._root);
...
// Path: inventory
class _TranslationsInventoryUr implements TranslationsInventoryEn {
	_TranslationsInventoryUr._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUr implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUr._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanUr implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanUr._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingUr implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingUr._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUr implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUr._(this._root);
...
class _TranslationsDomainDiscoveryUr implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUr._(this._root);
...
class _TranslationsInventorySuggestionsUr implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUr._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeUr implements TranslationsUpgradeEn {
	_TranslationsUpgradeUr._(this._root);
...
// Path: tour
class _TranslationsTourUr implements TranslationsTourEn {
	_TranslationsTourUr._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUr implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeUr._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUr implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditUr._(this._root);
...
class _TranslationsSettingsMeasurementsUr implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUr._(this._root);
...
class _TranslationsSettingsDataManagementUr implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUr._(this._root);
...
class _TranslationsSettingsVersionUr implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUr._(this._root);
...
class _TranslationsRecipeDetailNutritionUr implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUr._(this._root);
...
class _TranslationsRecipeDetailPrepAheadUr implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUr._(this._root);
...
class _TranslationsSettingsMeasurementsMetricUr implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUr._(this._root);
...
class _TranslationsSettingsMeasurementsImperialUr implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUr._(this._root);
