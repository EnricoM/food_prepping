...
// Path: <root>
class TranslationsMyMm with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppMyMm implements TranslationsAppEn {
	_TranslationsAppMyMm._(this._root);
...
// Path: home
class _TranslationsHomeMyMm implements TranslationsHomeEn {
	_TranslationsHomeMyMm._(this._root);
...
// Path: common
class _TranslationsCommonMyMm implements TranslationsCommonEn {
	_TranslationsCommonMyMm._(this._root);
...
// Path: settings
class _TranslationsSettingsMyMm implements TranslationsSettingsEn {
	_TranslationsSettingsMyMm._(this._root);
...
// Path: recipes
class _TranslationsRecipesMyMm implements TranslationsRecipesEn {
	_TranslationsRecipesMyMm._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMyMm implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMyMm._(this._root);
...
// Path: filters
class _TranslationsFiltersMyMm implements TranslationsFiltersEn {
	_TranslationsFiltersMyMm._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListMyMm implements TranslationsShoppingListEn {
	_TranslationsShoppingListMyMm._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanMyMm implements TranslationsMealPlanEn {
	_TranslationsMealPlanMyMm._(this._root);
...
// Path: inventory
class _TranslationsInventoryMyMm implements TranslationsInventoryEn {
	_TranslationsInventoryMyMm._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMyMm implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMyMm._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanMyMm implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanMyMm._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingMyMm implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingMyMm._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMyMm implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMyMm._(this._root);
...
class _TranslationsDomainDiscoveryMyMm implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMyMm._(this._root);
...
class _TranslationsInventorySuggestionsMyMm implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMyMm._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeMyMm implements TranslationsUpgradeEn {
	_TranslationsUpgradeMyMm._(this._root);
...
// Path: tour
class _TranslationsTourMyMm implements TranslationsTourEn {
	_TranslationsTourMyMm._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMyMm implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeMyMm._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMyMm implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditMyMm._(this._root);
...
// Path: errors
class _TranslationsErrorsMyMm implements TranslationsErrorsEn {
	_TranslationsErrorsMyMm._(this._root);
...
class _TranslationsSettingsMeasurementsMyMm implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMyMm._(this._root);
...
class _TranslationsSettingsDataManagementMyMm implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMyMm._(this._root);
...
class _TranslationsSettingsVersionMyMm implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMyMm._(this._root);
...
class _TranslationsRecipeDetailNutritionMyMm implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMyMm._(this._root);
...
class _TranslationsRecipeDetailPrepAheadMyMm implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMyMm._(this._root);
...
class _TranslationsSettingsMeasurementsMetricMyMm implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMyMm._(this._root);
...
class _TranslationsSettingsMeasurementsImperialMyMm implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMyMm._(this._root);
