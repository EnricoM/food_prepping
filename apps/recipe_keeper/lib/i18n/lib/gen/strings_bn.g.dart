...
// Path: app
class _TranslationsAppBn implements TranslationsAppEn {
	_TranslationsAppBn._(this._root);
...
// Path: recipes
class _TranslationsRecipesBn implements TranslationsRecipesEn {
	_TranslationsRecipesBn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBn._(this._root);
...
// Path: filters
class _TranslationsFiltersBn implements TranslationsFiltersEn {
	_TranslationsFiltersBn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBn implements TranslationsShoppingListEn {
	_TranslationsShoppingListBn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBn implements TranslationsMealPlanEn {
	_TranslationsMealPlanBn._(this._root);
...
// Path: inventory
class _TranslationsInventoryBn implements TranslationsInventoryEn {
	_TranslationsInventoryBn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBn._(this._root);
...
class _TranslationsDomainDiscoveryBn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBn._(this._root);
...
class _TranslationsInventorySuggestionsBn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBn implements TranslationsUpgradeEn {
	_TranslationsUpgradeBn._(this._root);
...
// Path: tour
class _TranslationsTourBn implements TranslationsTourEn {
	_TranslationsTourBn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBn._(this._root);
...
class _TranslationsSettingsMeasurementsBn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBn._(this._root);
...
class _TranslationsSettingsDataManagementBn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBn._(this._root);
...
class _TranslationsSettingsVersionBn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBn._(this._root);
...
class _TranslationsRecipeDetailNutritionBn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBn._(this._root);
