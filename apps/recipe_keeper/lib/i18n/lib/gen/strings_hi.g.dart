...
// Path: recipes
class _TranslationsRecipesHi implements TranslationsRecipesEn {
	_TranslationsRecipesHi._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHi implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHi._(this._root);
...
// Path: filters
class _TranslationsFiltersHi implements TranslationsFiltersEn {
	_TranslationsFiltersHi._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListHi implements TranslationsShoppingListEn {
	_TranslationsShoppingListHi._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanHi implements TranslationsMealPlanEn {
	_TranslationsMealPlanHi._(this._root);
...
// Path: inventory
class _TranslationsInventoryHi implements TranslationsInventoryEn {
	_TranslationsInventoryHi._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHi implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHi._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanHi implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanHi._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingHi implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingHi._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHi implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHi._(this._root);
...
class _TranslationsDomainDiscoveryHi implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHi._(this._root);
...
class _TranslationsInventorySuggestionsHi implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHi._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeHi implements TranslationsUpgradeEn {
	_TranslationsUpgradeHi._(this._root);
...
// Path: tour
class _TranslationsTourHi implements TranslationsTourEn {
	_TranslationsTourHi._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHi implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeHi._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHi implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditHi._(this._root);
...
class _TranslationsSettingsMeasurementsHi implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHi._(this._root);
...
class _TranslationsSettingsDataManagementHi implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHi._(this._root);
...
class _TranslationsSettingsVersionHi implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHi._(this._root);
...
class _TranslationsRecipeDetailNutritionHi implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHi._(this._root);
...
class _TranslationsRecipeDetailPrepAheadHi implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHi._(this._root);
...
class _TranslationsSettingsMeasurementsMetricHi implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHi._(this._root);
...
class _TranslationsSettingsMeasurementsImperialHi implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHi._(this._root);
