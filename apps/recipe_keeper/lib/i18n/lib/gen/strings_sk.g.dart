...
// Path: app
class _TranslationsAppSk implements TranslationsAppEn {
	_TranslationsAppSk._(this._root);
...
// Path: home
class _TranslationsHomeSk implements TranslationsHomeEn {
	_TranslationsHomeSk._(this._root);
...
// Path: settings
class _TranslationsSettingsSk implements TranslationsSettingsEn {
	_TranslationsSettingsSk._(this._root);
...
// Path: recipes
class _TranslationsRecipesSk implements TranslationsRecipesEn {
	_TranslationsRecipesSk._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSk implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSk._(this._root);
...
// Path: filters
class _TranslationsFiltersSk implements TranslationsFiltersEn {
	_TranslationsFiltersSk._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSk implements TranslationsShoppingListEn {
	_TranslationsShoppingListSk._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSk implements TranslationsMealPlanEn {
	_TranslationsMealPlanSk._(this._root);
...
// Path: inventory
class _TranslationsInventorySk implements TranslationsInventoryEn {
	_TranslationsInventorySk._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSk implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSk._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSk implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSk._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSk implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSk._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSk implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSk._(this._root);
...
class _TranslationsDomainDiscoverySk implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySk._(this._root);
...
class _TranslationsInventorySuggestionsSk implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSk._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSk implements TranslationsUpgradeEn {
	_TranslationsUpgradeSk._(this._root);
...
// Path: tour
class _TranslationsTourSk implements TranslationsTourEn {
	_TranslationsTourSk._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSk implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSk._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSk implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSk._(this._root);
...
// Path: errors
class _TranslationsErrorsSk implements TranslationsErrorsEn {
	_TranslationsErrorsSk._(this._root);
...
class _TranslationsSettingsMeasurementsSk implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSk._(this._root);
...
class _TranslationsSettingsDataManagementSk implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSk._(this._root);
...
class _TranslationsSettingsVersionSk implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSk._(this._root);
...
class _TranslationsRecipeDetailNutritionSk implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSk._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSk implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSk._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSk implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSk._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSk implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSk._(this._root);
