...
// Path: <root>
class TranslationsPsAf with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppPsAf implements TranslationsAppEn {
	_TranslationsAppPsAf._(this._root);
...
// Path: home
class _TranslationsHomePsAf implements TranslationsHomeEn {
	_TranslationsHomePsAf._(this._root);
...
// Path: common
class _TranslationsCommonPsAf implements TranslationsCommonEn {
	_TranslationsCommonPsAf._(this._root);
...
// Path: settings
class _TranslationsSettingsPsAf implements TranslationsSettingsEn {
	_TranslationsSettingsPsAf._(this._root);
...
// Path: recipes
class _TranslationsRecipesPsAf implements TranslationsRecipesEn {
	_TranslationsRecipesPsAf._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailPsAf implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailPsAf._(this._root);
...
// Path: filters
class _TranslationsFiltersPsAf implements TranslationsFiltersEn {
	_TranslationsFiltersPsAf._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListPsAf implements TranslationsShoppingListEn {
	_TranslationsShoppingListPsAf._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanPsAf implements TranslationsMealPlanEn {
	_TranslationsMealPlanPsAf._(this._root);
...
// Path: inventory
class _TranslationsInventoryPsAf implements TranslationsInventoryEn {
	_TranslationsInventoryPsAf._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanPsAf implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanPsAf._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanPsAf implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanPsAf._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingPsAf implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingPsAf._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsPsAf implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsPsAf._(this._root);
...
class _TranslationsDomainDiscoveryPsAf implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryPsAf._(this._root);
...
class _TranslationsInventorySuggestionsPsAf implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsPsAf._(this._root);
...
// Path: upgrade
class _TranslationsUpgradePsAf implements TranslationsUpgradeEn {
	_TranslationsUpgradePsAf._(this._root);
...
// Path: tour
class _TranslationsTourPsAf implements TranslationsTourEn {
	_TranslationsTourPsAf._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipePsAf implements TranslationsManualRecipeEn {
	_TranslationsManualRecipePsAf._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditPsAf implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditPsAf._(this._root);
...
// Path: errors
class _TranslationsErrorsPsAf implements TranslationsErrorsEn {
	_TranslationsErrorsPsAf._(this._root);
...
class _TranslationsSettingsMeasurementsPsAf implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsPsAf._(this._root);
...
class _TranslationsSettingsDataManagementPsAf implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementPsAf._(this._root);
...
class _TranslationsSettingsVersionPsAf implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionPsAf._(this._root);
...
class _TranslationsRecipeDetailNutritionPsAf implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionPsAf._(this._root);
...
class _TranslationsRecipeDetailPrepAheadPsAf implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadPsAf._(this._root);
...
class _TranslationsSettingsMeasurementsMetricPsAf implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricPsAf._(this._root);
...
class _TranslationsSettingsMeasurementsImperialPsAf implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialPsAf._(this._root);
