...
// Path: <root>
class TranslationsLoLa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppLoLa implements TranslationsAppEn {
	_TranslationsAppLoLa._(this._root);
...
// Path: home
class _TranslationsHomeLoLa implements TranslationsHomeEn {
	_TranslationsHomeLoLa._(this._root);
...
// Path: common
class _TranslationsCommonLoLa implements TranslationsCommonEn {
	_TranslationsCommonLoLa._(this._root);
...
// Path: settings
class _TranslationsSettingsLoLa implements TranslationsSettingsEn {
	_TranslationsSettingsLoLa._(this._root);
...
// Path: recipes
class _TranslationsRecipesLoLa implements TranslationsRecipesEn {
	_TranslationsRecipesLoLa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLoLa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLoLa._(this._root);
...
// Path: filters
class _TranslationsFiltersLoLa implements TranslationsFiltersEn {
	_TranslationsFiltersLoLa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListLoLa implements TranslationsShoppingListEn {
	_TranslationsShoppingListLoLa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanLoLa implements TranslationsMealPlanEn {
	_TranslationsMealPlanLoLa._(this._root);
...
// Path: inventory
class _TranslationsInventoryLoLa implements TranslationsInventoryEn {
	_TranslationsInventoryLoLa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLoLa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLoLa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanLoLa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanLoLa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingLoLa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingLoLa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLoLa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLoLa._(this._root);
...
class _TranslationsDomainDiscoveryLoLa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLoLa._(this._root);
...
class _TranslationsInventorySuggestionsLoLa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLoLa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeLoLa implements TranslationsUpgradeEn {
	_TranslationsUpgradeLoLa._(this._root);
...
// Path: tour
class _TranslationsTourLoLa implements TranslationsTourEn {
	_TranslationsTourLoLa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLoLa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeLoLa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLoLa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditLoLa._(this._root);
...
// Path: errors
class _TranslationsErrorsLoLa implements TranslationsErrorsEn {
	_TranslationsErrorsLoLa._(this._root);
...
class _TranslationsSettingsMeasurementsLoLa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLoLa._(this._root);
...
class _TranslationsSettingsDataManagementLoLa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLoLa._(this._root);
...
class _TranslationsSettingsVersionLoLa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLoLa._(this._root);
...
class _TranslationsRecipeDetailNutritionLoLa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLoLa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadLoLa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLoLa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricLoLa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLoLa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialLoLa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLoLa._(this._root);
