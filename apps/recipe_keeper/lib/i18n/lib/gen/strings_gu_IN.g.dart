...
// Path: <root>
class TranslationsGuIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppGuIn implements TranslationsAppEn {
	_TranslationsAppGuIn._(this._root);
...
// Path: home
class _TranslationsHomeGuIn implements TranslationsHomeEn {
	_TranslationsHomeGuIn._(this._root);
...
// Path: common
class _TranslationsCommonGuIn implements TranslationsCommonEn {
	_TranslationsCommonGuIn._(this._root);
...
// Path: settings
class _TranslationsSettingsGuIn implements TranslationsSettingsEn {
	_TranslationsSettingsGuIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesGuIn implements TranslationsRecipesEn {
	_TranslationsRecipesGuIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGuIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGuIn._(this._root);
...
// Path: filters
class _TranslationsFiltersGuIn implements TranslationsFiltersEn {
	_TranslationsFiltersGuIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListGuIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListGuIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanGuIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanGuIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryGuIn implements TranslationsInventoryEn {
	_TranslationsInventoryGuIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGuIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGuIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanGuIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanGuIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingGuIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingGuIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGuIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGuIn._(this._root);
...
class _TranslationsDomainDiscoveryGuIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGuIn._(this._root);
...
class _TranslationsInventorySuggestionsGuIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGuIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeGuIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeGuIn._(this._root);
...
// Path: tour
class _TranslationsTourGuIn implements TranslationsTourEn {
	_TranslationsTourGuIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGuIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeGuIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGuIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditGuIn._(this._root);
...
// Path: errors
class _TranslationsErrorsGuIn implements TranslationsErrorsEn {
	_TranslationsErrorsGuIn._(this._root);
...
class _TranslationsSettingsMeasurementsGuIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGuIn._(this._root);
...
class _TranslationsSettingsDataManagementGuIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGuIn._(this._root);
...
class _TranslationsSettingsVersionGuIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGuIn._(this._root);
...
class _TranslationsRecipeDetailNutritionGuIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGuIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadGuIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGuIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricGuIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGuIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialGuIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGuIn._(this._root);
