...
// Path: app
class _TranslationsAppKn implements TranslationsAppEn {
	_TranslationsAppKn._(this._root);
...
// Path: recipes
class _TranslationsRecipesKn implements TranslationsRecipesEn {
	_TranslationsRecipesKn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKn._(this._root);
...
// Path: filters
class _TranslationsFiltersKn implements TranslationsFiltersEn {
	_TranslationsFiltersKn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKn implements TranslationsShoppingListEn {
	_TranslationsShoppingListKn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKn implements TranslationsMealPlanEn {
	_TranslationsMealPlanKn._(this._root);
...
// Path: inventory
class _TranslationsInventoryKn implements TranslationsInventoryEn {
	_TranslationsInventoryKn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKn._(this._root);
...
class _TranslationsDomainDiscoveryKn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKn._(this._root);
...
class _TranslationsInventorySuggestionsKn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKn implements TranslationsUpgradeEn {
	_TranslationsUpgradeKn._(this._root);
...
// Path: tour
class _TranslationsTourKn implements TranslationsTourEn {
	_TranslationsTourKn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKn._(this._root);
...
class _TranslationsSettingsMeasurementsKn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKn._(this._root);
...
class _TranslationsSettingsDataManagementKn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKn._(this._root);
...
class _TranslationsSettingsVersionKn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKn._(this._root);
...
class _TranslationsRecipeDetailNutritionKn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKn._(this._root);
