...
// Path: <root>
class TranslationsKa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKa implements TranslationsAppEn {
	_TranslationsAppKa._(this._root);
...
// Path: home
class _TranslationsHomeKa implements TranslationsHomeEn {
	_TranslationsHomeKa._(this._root);
...
// Path: common
class _TranslationsCommonKa implements TranslationsCommonEn {
	_TranslationsCommonKa._(this._root);
...
// Path: settings
class _TranslationsSettingsKa implements TranslationsSettingsEn {
	_TranslationsSettingsKa._(this._root);
...
// Path: recipes
class _TranslationsRecipesKa implements TranslationsRecipesEn {
	_TranslationsRecipesKa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKa._(this._root);
...
// Path: filters
class _TranslationsFiltersKa implements TranslationsFiltersEn {
	_TranslationsFiltersKa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKa implements TranslationsShoppingListEn {
	_TranslationsShoppingListKa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKa implements TranslationsMealPlanEn {
	_TranslationsMealPlanKa._(this._root);
...
// Path: inventory
class _TranslationsInventoryKa implements TranslationsInventoryEn {
	_TranslationsInventoryKa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKa._(this._root);
...
class _TranslationsDomainDiscoveryKa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKa._(this._root);
...
class _TranslationsInventorySuggestionsKa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKa implements TranslationsUpgradeEn {
	_TranslationsUpgradeKa._(this._root);
...
// Path: tour
class _TranslationsTourKa implements TranslationsTourEn {
	_TranslationsTourKa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKa._(this._root);
...
// Path: errors
class _TranslationsErrorsKa implements TranslationsErrorsEn {
	_TranslationsErrorsKa._(this._root);
...
class _TranslationsSettingsMeasurementsKa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKa._(this._root);
...
class _TranslationsSettingsDataManagementKa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKa._(this._root);
...
class _TranslationsSettingsVersionKa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKa._(this._root);
...
class _TranslationsRecipeDetailNutritionKa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKa._(this._root);
