...
// Path: <root>
class TranslationsTaIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppTaIn implements TranslationsAppEn {
	_TranslationsAppTaIn._(this._root);
...
// Path: home
class _TranslationsHomeTaIn implements TranslationsHomeEn {
	_TranslationsHomeTaIn._(this._root);
...
// Path: common
class _TranslationsCommonTaIn implements TranslationsCommonEn {
	_TranslationsCommonTaIn._(this._root);
...
// Path: settings
class _TranslationsSettingsTaIn implements TranslationsSettingsEn {
	_TranslationsSettingsTaIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesTaIn implements TranslationsRecipesEn {
	_TranslationsRecipesTaIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTaIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTaIn._(this._root);
...
// Path: filters
class _TranslationsFiltersTaIn implements TranslationsFiltersEn {
	_TranslationsFiltersTaIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTaIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListTaIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTaIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanTaIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryTaIn implements TranslationsInventoryEn {
	_TranslationsInventoryTaIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTaIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTaIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTaIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTaIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTaIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTaIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTaIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTaIn._(this._root);
...
class _TranslationsDomainDiscoveryTaIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTaIn._(this._root);
...
class _TranslationsInventorySuggestionsTaIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTaIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTaIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeTaIn._(this._root);
...
// Path: tour
class _TranslationsTourTaIn implements TranslationsTourEn {
	_TranslationsTourTaIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTaIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTaIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTaIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTaIn._(this._root);
...
// Path: errors
class _TranslationsErrorsTaIn implements TranslationsErrorsEn {
	_TranslationsErrorsTaIn._(this._root);
...
class _TranslationsSettingsMeasurementsTaIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTaIn._(this._root);
...
class _TranslationsSettingsDataManagementTaIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTaIn._(this._root);
...
class _TranslationsSettingsVersionTaIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTaIn._(this._root);
...
class _TranslationsRecipeDetailNutritionTaIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTaIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTaIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTaIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTaIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTaIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTaIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTaIn._(this._root);
