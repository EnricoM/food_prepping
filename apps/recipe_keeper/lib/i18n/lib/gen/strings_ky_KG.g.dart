...
// Path: <root>
class TranslationsKyKg with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKyKg implements TranslationsAppEn {
	_TranslationsAppKyKg._(this._root);
...
// Path: home
class _TranslationsHomeKyKg implements TranslationsHomeEn {
	_TranslationsHomeKyKg._(this._root);
...
// Path: common
class _TranslationsCommonKyKg implements TranslationsCommonEn {
	_TranslationsCommonKyKg._(this._root);
...
// Path: settings
class _TranslationsSettingsKyKg implements TranslationsSettingsEn {
	_TranslationsSettingsKyKg._(this._root);
...
// Path: recipes
class _TranslationsRecipesKyKg implements TranslationsRecipesEn {
	_TranslationsRecipesKyKg._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKyKg implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKyKg._(this._root);
...
// Path: filters
class _TranslationsFiltersKyKg implements TranslationsFiltersEn {
	_TranslationsFiltersKyKg._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKyKg implements TranslationsShoppingListEn {
	_TranslationsShoppingListKyKg._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKyKg implements TranslationsMealPlanEn {
	_TranslationsMealPlanKyKg._(this._root);
...
// Path: inventory
class _TranslationsInventoryKyKg implements TranslationsInventoryEn {
	_TranslationsInventoryKyKg._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKyKg implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKyKg._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKyKg implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKyKg._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKyKg implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKyKg._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKyKg implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKyKg._(this._root);
...
class _TranslationsDomainDiscoveryKyKg implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKyKg._(this._root);
...
class _TranslationsInventorySuggestionsKyKg implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKyKg._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKyKg implements TranslationsUpgradeEn {
	_TranslationsUpgradeKyKg._(this._root);
...
// Path: tour
class _TranslationsTourKyKg implements TranslationsTourEn {
	_TranslationsTourKyKg._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKyKg implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKyKg._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKyKg implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKyKg._(this._root);
...
// Path: errors
class _TranslationsErrorsKyKg implements TranslationsErrorsEn {
	_TranslationsErrorsKyKg._(this._root);
...
class _TranslationsSettingsMeasurementsKyKg implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKyKg._(this._root);
...
class _TranslationsSettingsDataManagementKyKg implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKyKg._(this._root);
...
class _TranslationsSettingsVersionKyKg implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKyKg._(this._root);
...
class _TranslationsRecipeDetailNutritionKyKg implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKyKg._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKyKg implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKyKg._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKyKg implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKyKg._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKyKg implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKyKg._(this._root);
