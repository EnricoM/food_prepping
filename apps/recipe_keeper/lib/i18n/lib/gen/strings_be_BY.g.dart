...
// Path: <root>
class TranslationsBeBy with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppBeBy implements TranslationsAppEn {
	_TranslationsAppBeBy._(this._root);
...
// Path: home
class _TranslationsHomeBeBy implements TranslationsHomeEn {
	_TranslationsHomeBeBy._(this._root);
...
// Path: common
class _TranslationsCommonBeBy implements TranslationsCommonEn {
	_TranslationsCommonBeBy._(this._root);
...
// Path: settings
class _TranslationsSettingsBeBy implements TranslationsSettingsEn {
	_TranslationsSettingsBeBy._(this._root);
...
// Path: recipes
class _TranslationsRecipesBeBy implements TranslationsRecipesEn {
	_TranslationsRecipesBeBy._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBeBy implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBeBy._(this._root);
...
// Path: filters
class _TranslationsFiltersBeBy implements TranslationsFiltersEn {
	_TranslationsFiltersBeBy._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBeBy implements TranslationsShoppingListEn {
	_TranslationsShoppingListBeBy._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBeBy implements TranslationsMealPlanEn {
	_TranslationsMealPlanBeBy._(this._root);
...
// Path: inventory
class _TranslationsInventoryBeBy implements TranslationsInventoryEn {
	_TranslationsInventoryBeBy._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBeBy implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBeBy._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBeBy implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBeBy._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBeBy implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBeBy._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBeBy implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBeBy._(this._root);
...
class _TranslationsDomainDiscoveryBeBy implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBeBy._(this._root);
...
class _TranslationsInventorySuggestionsBeBy implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBeBy._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBeBy implements TranslationsUpgradeEn {
	_TranslationsUpgradeBeBy._(this._root);
...
// Path: tour
class _TranslationsTourBeBy implements TranslationsTourEn {
	_TranslationsTourBeBy._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBeBy implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBeBy._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBeBy implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBeBy._(this._root);
...
// Path: errors
class _TranslationsErrorsBeBy implements TranslationsErrorsEn {
	_TranslationsErrorsBeBy._(this._root);
...
class _TranslationsSettingsMeasurementsBeBy implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBeBy._(this._root);
...
class _TranslationsSettingsDataManagementBeBy implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBeBy._(this._root);
...
class _TranslationsSettingsVersionBeBy implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBeBy._(this._root);
...
class _TranslationsRecipeDetailNutritionBeBy implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBeBy._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBeBy implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBeBy._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBeBy implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBeBy._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBeBy implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBeBy._(this._root);
