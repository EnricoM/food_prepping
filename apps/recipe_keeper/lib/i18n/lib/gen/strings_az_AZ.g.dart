...
// Path: <root>
class TranslationsAzAz with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppAzAz implements TranslationsAppEn {
	_TranslationsAppAzAz._(this._root);
...
// Path: home
class _TranslationsHomeAzAz implements TranslationsHomeEn {
	_TranslationsHomeAzAz._(this._root);
...
// Path: common
class _TranslationsCommonAzAz implements TranslationsCommonEn {
	_TranslationsCommonAzAz._(this._root);
...
// Path: settings
class _TranslationsSettingsAzAz implements TranslationsSettingsEn {
	_TranslationsSettingsAzAz._(this._root);
...
// Path: recipes
class _TranslationsRecipesAzAz implements TranslationsRecipesEn {
	_TranslationsRecipesAzAz._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAzAz implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAzAz._(this._root);
...
// Path: filters
class _TranslationsFiltersAzAz implements TranslationsFiltersEn {
	_TranslationsFiltersAzAz._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListAzAz implements TranslationsShoppingListEn {
	_TranslationsShoppingListAzAz._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanAzAz implements TranslationsMealPlanEn {
	_TranslationsMealPlanAzAz._(this._root);
...
// Path: inventory
class _TranslationsInventoryAzAz implements TranslationsInventoryEn {
	_TranslationsInventoryAzAz._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAzAz implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAzAz._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanAzAz implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanAzAz._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingAzAz implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingAzAz._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAzAz implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAzAz._(this._root);
...
class _TranslationsDomainDiscoveryAzAz implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAzAz._(this._root);
...
class _TranslationsInventorySuggestionsAzAz implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAzAz._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeAzAz implements TranslationsUpgradeEn {
	_TranslationsUpgradeAzAz._(this._root);
...
// Path: tour
class _TranslationsTourAzAz implements TranslationsTourEn {
	_TranslationsTourAzAz._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAzAz implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeAzAz._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAzAz implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditAzAz._(this._root);
...
// Path: errors
class _TranslationsErrorsAzAz implements TranslationsErrorsEn {
	_TranslationsErrorsAzAz._(this._root);
...
class _TranslationsSettingsMeasurementsAzAz implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAzAz._(this._root);
...
class _TranslationsSettingsDataManagementAzAz implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAzAz._(this._root);
...
class _TranslationsSettingsVersionAzAz implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAzAz._(this._root);
...
class _TranslationsRecipeDetailNutritionAzAz implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAzAz._(this._root);
...
class _TranslationsRecipeDetailPrepAheadAzAz implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAzAz._(this._root);
...
class _TranslationsSettingsMeasurementsMetricAzAz implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAzAz._(this._root);
...
class _TranslationsSettingsMeasurementsImperialAzAz implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAzAz._(this._root);
