...
// Path: <root>
class TranslationsBe with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppBe implements TranslationsAppEn {
	_TranslationsAppBe._(this._root);
...
// Path: home
class _TranslationsHomeBe implements TranslationsHomeEn {
	_TranslationsHomeBe._(this._root);
...
// Path: common
class _TranslationsCommonBe implements TranslationsCommonEn {
	_TranslationsCommonBe._(this._root);
...
// Path: settings
class _TranslationsSettingsBe implements TranslationsSettingsEn {
	_TranslationsSettingsBe._(this._root);
...
// Path: recipes
class _TranslationsRecipesBe implements TranslationsRecipesEn {
	_TranslationsRecipesBe._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBe implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBe._(this._root);
...
// Path: filters
class _TranslationsFiltersBe implements TranslationsFiltersEn {
	_TranslationsFiltersBe._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBe implements TranslationsShoppingListEn {
	_TranslationsShoppingListBe._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBe implements TranslationsMealPlanEn {
	_TranslationsMealPlanBe._(this._root);
...
// Path: inventory
class _TranslationsInventoryBe implements TranslationsInventoryEn {
	_TranslationsInventoryBe._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBe implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBe._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBe implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBe._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBe implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBe._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBe implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBe._(this._root);
...
class _TranslationsDomainDiscoveryBe implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBe._(this._root);
...
class _TranslationsInventorySuggestionsBe implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBe._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBe implements TranslationsUpgradeEn {
	_TranslationsUpgradeBe._(this._root);
...
// Path: tour
class _TranslationsTourBe implements TranslationsTourEn {
	_TranslationsTourBe._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBe implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBe._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBe implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBe._(this._root);
...
// Path: errors
class _TranslationsErrorsBe implements TranslationsErrorsEn {
	_TranslationsErrorsBe._(this._root);
...
class _TranslationsSettingsMeasurementsBe implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBe._(this._root);
...
class _TranslationsSettingsDataManagementBe implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBe._(this._root);
...
class _TranslationsSettingsVersionBe implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBe._(this._root);
...
class _TranslationsRecipeDetailNutritionBe implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBe._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBe implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBe._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBe implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBe._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBe implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBe._(this._root);
