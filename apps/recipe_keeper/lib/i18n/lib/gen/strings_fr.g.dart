...
// Path: recipes
class _TranslationsRecipesFr implements TranslationsRecipesEn {
	_TranslationsRecipesFr._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFr implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFr._(this._root);
...
// Path: filters
class _TranslationsFiltersFr implements TranslationsFiltersEn {
	_TranslationsFiltersFr._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListFr implements TranslationsShoppingListEn {
	_TranslationsShoppingListFr._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanFr implements TranslationsMealPlanEn {
	_TranslationsMealPlanFr._(this._root);
...
// Path: inventory
class _TranslationsInventoryFr implements TranslationsInventoryEn {
	_TranslationsInventoryFr._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFr implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFr._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanFr implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanFr._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingFr implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingFr._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFr implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFr._(this._root);
...
class _TranslationsDomainDiscoveryFr implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFr._(this._root);
...
class _TranslationsInventorySuggestionsFr implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFr._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeFr implements TranslationsUpgradeEn {
	_TranslationsUpgradeFr._(this._root);
...
// Path: tour
class _TranslationsTourFr implements TranslationsTourEn {
	_TranslationsTourFr._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFr implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeFr._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFr implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditFr._(this._root);
...
class _TranslationsSettingsMeasurementsFr implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFr._(this._root);
...
class _TranslationsSettingsDataManagementFr implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFr._(this._root);
...
class _TranslationsSettingsVersionFr implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFr._(this._root);
...
class _TranslationsRecipeDetailNutritionFr implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFr._(this._root);
...
class _TranslationsRecipeDetailPrepAheadFr implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFr._(this._root);
...
class _TranslationsSettingsMeasurementsMetricFr implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFr._(this._root);
...
class _TranslationsSettingsMeasurementsImperialFr implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFr._(this._root);
