...
// Path: recipes
class _TranslationsRecipesDa implements TranslationsRecipesEn {
	_TranslationsRecipesDa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailDa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailDa._(this._root);
...
// Path: filters
class _TranslationsFiltersDa implements TranslationsFiltersEn {
	_TranslationsFiltersDa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListDa implements TranslationsShoppingListEn {
	_TranslationsShoppingListDa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanDa implements TranslationsMealPlanEn {
	_TranslationsMealPlanDa._(this._root);
...
// Path: inventory
class _TranslationsInventoryDa implements TranslationsInventoryEn {
	_TranslationsInventoryDa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanDa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanDa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanDa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanDa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingDa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingDa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsDa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsDa._(this._root);
...
class _TranslationsDomainDiscoveryDa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryDa._(this._root);
...
class _TranslationsInventorySuggestionsDa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsDa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeDa implements TranslationsUpgradeEn {
	_TranslationsUpgradeDa._(this._root);
...
// Path: tour
class _TranslationsTourDa implements TranslationsTourEn {
	_TranslationsTourDa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeDa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeDa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditDa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditDa._(this._root);
...
class _TranslationsSettingsMeasurementsDa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsDa._(this._root);
...
class _TranslationsSettingsDataManagementDa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementDa._(this._root);
...
class _TranslationsSettingsVersionDa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionDa._(this._root);
...
class _TranslationsRecipeDetailNutritionDa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionDa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadDa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadDa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricDa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricDa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialDa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialDa._(this._root);
