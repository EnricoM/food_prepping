...
// Path: <root>
class TranslationsBo with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppBo implements TranslationsAppEn {
	_TranslationsAppBo._(this._root);
...
// Path: home
class _TranslationsHomeBo implements TranslationsHomeEn {
	_TranslationsHomeBo._(this._root);
...
// Path: common
class _TranslationsCommonBo implements TranslationsCommonEn {
	_TranslationsCommonBo._(this._root);
...
// Path: settings
class _TranslationsSettingsBo implements TranslationsSettingsEn {
	_TranslationsSettingsBo._(this._root);
...
// Path: recipes
class _TranslationsRecipesBo implements TranslationsRecipesEn {
	_TranslationsRecipesBo._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBo implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBo._(this._root);
...
// Path: filters
class _TranslationsFiltersBo implements TranslationsFiltersEn {
	_TranslationsFiltersBo._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBo implements TranslationsShoppingListEn {
	_TranslationsShoppingListBo._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBo implements TranslationsMealPlanEn {
	_TranslationsMealPlanBo._(this._root);
...
// Path: inventory
class _TranslationsInventoryBo implements TranslationsInventoryEn {
	_TranslationsInventoryBo._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBo implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBo._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBo implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBo._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBo implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBo._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBo implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBo._(this._root);
...
class _TranslationsDomainDiscoveryBo implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBo._(this._root);
...
class _TranslationsInventorySuggestionsBo implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBo._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBo implements TranslationsUpgradeEn {
	_TranslationsUpgradeBo._(this._root);
...
// Path: tour
class _TranslationsTourBo implements TranslationsTourEn {
	_TranslationsTourBo._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBo implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBo._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBo implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBo._(this._root);
...
// Path: errors
class _TranslationsErrorsBo implements TranslationsErrorsEn {
	_TranslationsErrorsBo._(this._root);
...
class _TranslationsSettingsMeasurementsBo implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBo._(this._root);
...
class _TranslationsSettingsDataManagementBo implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBo._(this._root);
...
class _TranslationsSettingsVersionBo implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBo._(this._root);
...
class _TranslationsRecipeDetailNutritionBo implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBo._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBo implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBo._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBo implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBo._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBo implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBo._(this._root);
