...
// Path: recipes
class _TranslationsRecipesEs implements TranslationsRecipesEn {
	_TranslationsRecipesEs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListEs implements TranslationsShoppingListEn {
	_TranslationsShoppingListEs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanEs implements TranslationsMealPlanEn {
	_TranslationsMealPlanEs._(this._root);
...
// Path: inventory
class _TranslationsInventoryEs implements TranslationsInventoryEn {
...
// Path: barcodeScan
class _TranslationsBarcodeScanEs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanEs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanEs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingEs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingEs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEs._(this._root);
...
class _TranslationsDomainDiscoveryEs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEs._(this._root);
...
class _TranslationsInventorySuggestionsEs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeEs implements TranslationsUpgradeEn {
	_TranslationsUpgradeEs._(this._root);
...
// Path: tour
class _TranslationsTourEs implements TranslationsTourEn {
	_TranslationsTourEs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeEs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditEs._(this._root);
...
class _TranslationsSettingsMeasurementsEs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEs._(this._root);
...
class _TranslationsSettingsDataManagementEs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEs._(this._root);
...
class _TranslationsSettingsVersionEs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEs._(this._root);
...
class _TranslationsRecipeDetailNutritionEs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadEs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricEs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialEs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEs._(this._root);
