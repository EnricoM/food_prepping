...
// Path: <root>
class TranslationsCyGb with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppCyGb implements TranslationsAppEn {
	_TranslationsAppCyGb._(this._root);
...
// Path: home
class _TranslationsHomeCyGb implements TranslationsHomeEn {
	_TranslationsHomeCyGb._(this._root);
...
// Path: common
class _TranslationsCommonCyGb implements TranslationsCommonEn {
	_TranslationsCommonCyGb._(this._root);
...
// Path: settings
class _TranslationsSettingsCyGb implements TranslationsSettingsEn {
	_TranslationsSettingsCyGb._(this._root);
...
// Path: recipes
class _TranslationsRecipesCyGb implements TranslationsRecipesEn {
	_TranslationsRecipesCyGb._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCyGb implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCyGb._(this._root);
...
// Path: filters
class _TranslationsFiltersCyGb implements TranslationsFiltersEn {
	_TranslationsFiltersCyGb._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListCyGb implements TranslationsShoppingListEn {
	_TranslationsShoppingListCyGb._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanCyGb implements TranslationsMealPlanEn {
	_TranslationsMealPlanCyGb._(this._root);
...
// Path: inventory
class _TranslationsInventoryCyGb implements TranslationsInventoryEn {
	_TranslationsInventoryCyGb._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCyGb implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCyGb._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanCyGb implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanCyGb._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingCyGb implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingCyGb._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCyGb implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCyGb._(this._root);
...
class _TranslationsDomainDiscoveryCyGb implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCyGb._(this._root);
...
class _TranslationsInventorySuggestionsCyGb implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCyGb._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeCyGb implements TranslationsUpgradeEn {
	_TranslationsUpgradeCyGb._(this._root);
...
// Path: tour
class _TranslationsTourCyGb implements TranslationsTourEn {
	_TranslationsTourCyGb._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCyGb implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeCyGb._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCyGb implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditCyGb._(this._root);
...
// Path: errors
class _TranslationsErrorsCyGb implements TranslationsErrorsEn {
	_TranslationsErrorsCyGb._(this._root);
...
class _TranslationsSettingsMeasurementsCyGb implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCyGb._(this._root);
...
class _TranslationsSettingsDataManagementCyGb implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCyGb._(this._root);
...
class _TranslationsSettingsVersionCyGb implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCyGb._(this._root);
...
class _TranslationsRecipeDetailNutritionCyGb implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCyGb._(this._root);
...
class _TranslationsRecipeDetailPrepAheadCyGb implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCyGb._(this._root);
...
class _TranslationsSettingsMeasurementsMetricCyGb implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCyGb._(this._root);
...
class _TranslationsSettingsMeasurementsImperialCyGb implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCyGb._(this._root);
