...
// Path: <root>
class TranslationsSiLk with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppSiLk implements TranslationsAppEn {
	_TranslationsAppSiLk._(this._root);
...
// Path: home
class _TranslationsHomeSiLk implements TranslationsHomeEn {
	_TranslationsHomeSiLk._(this._root);
...
// Path: common
class _TranslationsCommonSiLk implements TranslationsCommonEn {
	_TranslationsCommonSiLk._(this._root);
...
// Path: settings
class _TranslationsSettingsSiLk implements TranslationsSettingsEn {
	_TranslationsSettingsSiLk._(this._root);
...
// Path: recipes
class _TranslationsRecipesSiLk implements TranslationsRecipesEn {
	_TranslationsRecipesSiLk._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSiLk implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSiLk._(this._root);
...
// Path: filters
class _TranslationsFiltersSiLk implements TranslationsFiltersEn {
	_TranslationsFiltersSiLk._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSiLk implements TranslationsShoppingListEn {
	_TranslationsShoppingListSiLk._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSiLk implements TranslationsMealPlanEn {
	_TranslationsMealPlanSiLk._(this._root);
...
// Path: inventory
class _TranslationsInventorySiLk implements TranslationsInventoryEn {
	_TranslationsInventorySiLk._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSiLk implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSiLk._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSiLk implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSiLk._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSiLk implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSiLk._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSiLk implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSiLk._(this._root);
...
class _TranslationsDomainDiscoverySiLk implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySiLk._(this._root);
...
class _TranslationsInventorySuggestionsSiLk implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSiLk._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSiLk implements TranslationsUpgradeEn {
	_TranslationsUpgradeSiLk._(this._root);
...
// Path: tour
class _TranslationsTourSiLk implements TranslationsTourEn {
	_TranslationsTourSiLk._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSiLk implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSiLk._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSiLk implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSiLk._(this._root);
...
// Path: errors
class _TranslationsErrorsSiLk implements TranslationsErrorsEn {
	_TranslationsErrorsSiLk._(this._root);
...
class _TranslationsSettingsMeasurementsSiLk implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSiLk._(this._root);
...
class _TranslationsSettingsDataManagementSiLk implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSiLk._(this._root);
...
class _TranslationsSettingsVersionSiLk implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSiLk._(this._root);
...
class _TranslationsRecipeDetailNutritionSiLk implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSiLk._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSiLk implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSiLk._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSiLk implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSiLk._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSiLk implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSiLk._(this._root);
