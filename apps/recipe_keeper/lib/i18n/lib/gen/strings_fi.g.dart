...
// Path: app
class _TranslationsAppFi implements TranslationsAppEn {
	_TranslationsAppFi._(this._root);
...
// Path: recipes
class _TranslationsRecipesFi implements TranslationsRecipesEn {
	_TranslationsRecipesFi._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFi implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFi._(this._root);
...
// Path: filters
class _TranslationsFiltersFi implements TranslationsFiltersEn {
	_TranslationsFiltersFi._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListFi implements TranslationsShoppingListEn {
	_TranslationsShoppingListFi._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanFi implements TranslationsMealPlanEn {
	_TranslationsMealPlanFi._(this._root);
...
// Path: inventory
class _TranslationsInventoryFi implements TranslationsInventoryEn {
	_TranslationsInventoryFi._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFi implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFi._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanFi implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanFi._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingFi implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingFi._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFi implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFi._(this._root);
...
class _TranslationsDomainDiscoveryFi implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFi._(this._root);
...
class _TranslationsInventorySuggestionsFi implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFi._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeFi implements TranslationsUpgradeEn {
	_TranslationsUpgradeFi._(this._root);
...
// Path: tour
class _TranslationsTourFi implements TranslationsTourEn {
	_TranslationsTourFi._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFi implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeFi._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFi implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditFi._(this._root);
...
class _TranslationsSettingsMeasurementsFi implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFi._(this._root);
...
class _TranslationsSettingsDataManagementFi implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFi._(this._root);
...
class _TranslationsSettingsVersionFi implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFi._(this._root);
...
class _TranslationsRecipeDetailNutritionFi implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFi._(this._root);
...
class _TranslationsRecipeDetailPrepAheadFi implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFi._(this._root);
...
class _TranslationsSettingsMeasurementsMetricFi implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFi._(this._root);
...
class _TranslationsSettingsMeasurementsImperialFi implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFi._(this._root);
