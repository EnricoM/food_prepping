...
// Path: <root>
class TranslationsTi with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppTi implements TranslationsAppEn {
	_TranslationsAppTi._(this._root);
...
// Path: home
class _TranslationsHomeTi implements TranslationsHomeEn {
	_TranslationsHomeTi._(this._root);
...
// Path: common
class _TranslationsCommonTi implements TranslationsCommonEn {
	_TranslationsCommonTi._(this._root);
...
// Path: settings
class _TranslationsSettingsTi implements TranslationsSettingsEn {
	_TranslationsSettingsTi._(this._root);
...
// Path: recipes
class _TranslationsRecipesTi implements TranslationsRecipesEn {
	_TranslationsRecipesTi._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTi implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTi._(this._root);
...
// Path: filters
class _TranslationsFiltersTi implements TranslationsFiltersEn {
	_TranslationsFiltersTi._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTi implements TranslationsShoppingListEn {
	_TranslationsShoppingListTi._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTi implements TranslationsMealPlanEn {
	_TranslationsMealPlanTi._(this._root);
...
// Path: inventory
class _TranslationsInventoryTi implements TranslationsInventoryEn {
	_TranslationsInventoryTi._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTi implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTi._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTi implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTi._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTi implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTi._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTi implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTi._(this._root);
...
class _TranslationsDomainDiscoveryTi implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTi._(this._root);
...
class _TranslationsInventorySuggestionsTi implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTi._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTi implements TranslationsUpgradeEn {
	_TranslationsUpgradeTi._(this._root);
...
// Path: tour
class _TranslationsTourTi implements TranslationsTourEn {
	_TranslationsTourTi._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTi implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTi._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTi implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTi._(this._root);
...
// Path: errors
class _TranslationsErrorsTi implements TranslationsErrorsEn {
	_TranslationsErrorsTi._(this._root);
...
class _TranslationsSettingsMeasurementsTi implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTi._(this._root);
...
class _TranslationsSettingsDataManagementTi implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTi._(this._root);
...
class _TranslationsSettingsVersionTi implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTi._(this._root);
...
class _TranslationsRecipeDetailNutritionTi implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTi._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTi implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTi._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTi implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTi._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTi implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTi._(this._root);
