...
// Path: <root>
class TranslationsUzUz with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppUzUz implements TranslationsAppEn {
	_TranslationsAppUzUz._(this._root);
...
// Path: home
class _TranslationsHomeUzUz implements TranslationsHomeEn {
	_TranslationsHomeUzUz._(this._root);
...
// Path: common
class _TranslationsCommonUzUz implements TranslationsCommonEn {
	_TranslationsCommonUzUz._(this._root);
...
// Path: settings
class _TranslationsSettingsUzUz implements TranslationsSettingsEn {
	_TranslationsSettingsUzUz._(this._root);
...
// Path: recipes
class _TranslationsRecipesUzUz implements TranslationsRecipesEn {
	_TranslationsRecipesUzUz._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUzUz implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUzUz._(this._root);
...
// Path: filters
class _TranslationsFiltersUzUz implements TranslationsFiltersEn {
	_TranslationsFiltersUzUz._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListUzUz implements TranslationsShoppingListEn {
	_TranslationsShoppingListUzUz._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanUzUz implements TranslationsMealPlanEn {
	_TranslationsMealPlanUzUz._(this._root);
...
// Path: inventory
class _TranslationsInventoryUzUz implements TranslationsInventoryEn {
	_TranslationsInventoryUzUz._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUzUz implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUzUz._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanUzUz implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanUzUz._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingUzUz implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingUzUz._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUzUz implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUzUz._(this._root);
...
class _TranslationsDomainDiscoveryUzUz implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUzUz._(this._root);
...
class _TranslationsInventorySuggestionsUzUz implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUzUz._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeUzUz implements TranslationsUpgradeEn {
	_TranslationsUpgradeUzUz._(this._root);
...
// Path: tour
class _TranslationsTourUzUz implements TranslationsTourEn {
	_TranslationsTourUzUz._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUzUz implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeUzUz._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUzUz implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditUzUz._(this._root);
...
// Path: errors
class _TranslationsErrorsUzUz implements TranslationsErrorsEn {
	_TranslationsErrorsUzUz._(this._root);
...
class _TranslationsSettingsMeasurementsUzUz implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUzUz._(this._root);
...
class _TranslationsSettingsDataManagementUzUz implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUzUz._(this._root);
...
class _TranslationsSettingsVersionUzUz implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUzUz._(this._root);
...
class _TranslationsRecipeDetailNutritionUzUz implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUzUz._(this._root);
...
class _TranslationsRecipeDetailPrepAheadUzUz implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUzUz._(this._root);
...
class _TranslationsSettingsMeasurementsMetricUzUz implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUzUz._(this._root);
...
class _TranslationsSettingsMeasurementsImperialUzUz implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUzUz._(this._root);
