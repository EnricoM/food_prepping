...
// Path: <root>
class TranslationsGlEs with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppGlEs implements TranslationsAppEn {
	_TranslationsAppGlEs._(this._root);
...
// Path: home
class _TranslationsHomeGlEs implements TranslationsHomeEn {
	_TranslationsHomeGlEs._(this._root);
...
// Path: common
class _TranslationsCommonGlEs implements TranslationsCommonEn {
	_TranslationsCommonGlEs._(this._root);
...
// Path: settings
class _TranslationsSettingsGlEs implements TranslationsSettingsEn {
	_TranslationsSettingsGlEs._(this._root);
...
// Path: recipes
class _TranslationsRecipesGlEs implements TranslationsRecipesEn {
	_TranslationsRecipesGlEs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGlEs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGlEs._(this._root);
...
// Path: filters
class _TranslationsFiltersGlEs implements TranslationsFiltersEn {
	_TranslationsFiltersGlEs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListGlEs implements TranslationsShoppingListEn {
	_TranslationsShoppingListGlEs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanGlEs implements TranslationsMealPlanEn {
	_TranslationsMealPlanGlEs._(this._root);
...
// Path: inventory
class _TranslationsInventoryGlEs implements TranslationsInventoryEn {
	_TranslationsInventoryGlEs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGlEs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGlEs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanGlEs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanGlEs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingGlEs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingGlEs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGlEs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGlEs._(this._root);
...
class _TranslationsDomainDiscoveryGlEs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGlEs._(this._root);
...
class _TranslationsInventorySuggestionsGlEs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGlEs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeGlEs implements TranslationsUpgradeEn {
	_TranslationsUpgradeGlEs._(this._root);
...
// Path: tour
class _TranslationsTourGlEs implements TranslationsTourEn {
	_TranslationsTourGlEs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGlEs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeGlEs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGlEs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditGlEs._(this._root);
...
// Path: errors
class _TranslationsErrorsGlEs implements TranslationsErrorsEn {
	_TranslationsErrorsGlEs._(this._root);
...
class _TranslationsSettingsMeasurementsGlEs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGlEs._(this._root);
...
class _TranslationsSettingsDataManagementGlEs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGlEs._(this._root);
...
class _TranslationsSettingsVersionGlEs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGlEs._(this._root);
...
class _TranslationsRecipeDetailNutritionGlEs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGlEs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadGlEs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGlEs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricGlEs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGlEs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialGlEs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGlEs._(this._root);
