...
// Path: <root>
class TranslationsBnIn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppBnIn implements TranslationsAppEn {
	_TranslationsAppBnIn._(this._root);
...
// Path: home
class _TranslationsHomeBnIn implements TranslationsHomeEn {
	_TranslationsHomeBnIn._(this._root);
...
// Path: common
class _TranslationsCommonBnIn implements TranslationsCommonEn {
	_TranslationsCommonBnIn._(this._root);
...
// Path: settings
class _TranslationsSettingsBnIn implements TranslationsSettingsEn {
	_TranslationsSettingsBnIn._(this._root);
...
// Path: recipes
class _TranslationsRecipesBnIn implements TranslationsRecipesEn {
	_TranslationsRecipesBnIn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBnIn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBnIn._(this._root);
...
// Path: filters
class _TranslationsFiltersBnIn implements TranslationsFiltersEn {
	_TranslationsFiltersBnIn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBnIn implements TranslationsShoppingListEn {
	_TranslationsShoppingListBnIn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBnIn implements TranslationsMealPlanEn {
	_TranslationsMealPlanBnIn._(this._root);
...
// Path: inventory
class _TranslationsInventoryBnIn implements TranslationsInventoryEn {
	_TranslationsInventoryBnIn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBnIn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBnIn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBnIn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBnIn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBnIn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBnIn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBnIn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBnIn._(this._root);
...
class _TranslationsDomainDiscoveryBnIn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBnIn._(this._root);
...
class _TranslationsInventorySuggestionsBnIn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBnIn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBnIn implements TranslationsUpgradeEn {
	_TranslationsUpgradeBnIn._(this._root);
...
// Path: tour
class _TranslationsTourBnIn implements TranslationsTourEn {
	_TranslationsTourBnIn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBnIn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBnIn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBnIn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBnIn._(this._root);
...
// Path: errors
class _TranslationsErrorsBnIn implements TranslationsErrorsEn {
	_TranslationsErrorsBnIn._(this._root);
...
class _TranslationsSettingsMeasurementsBnIn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBnIn._(this._root);
...
class _TranslationsSettingsDataManagementBnIn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBnIn._(this._root);
...
class _TranslationsSettingsVersionBnIn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBnIn._(this._root);
...
class _TranslationsRecipeDetailNutritionBnIn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBnIn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBnIn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBnIn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBnIn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBnIn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBnIn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBnIn._(this._root);
