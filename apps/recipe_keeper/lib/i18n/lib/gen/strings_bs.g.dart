...
// Path: app
class _TranslationsAppBs implements TranslationsAppEn {
	_TranslationsAppBs._(this._root);
...
// Path: home
class _TranslationsHomeBs implements TranslationsHomeEn {
	_TranslationsHomeBs._(this._root);
...
// Path: settings
class _TranslationsSettingsBs implements TranslationsSettingsEn {
	_TranslationsSettingsBs._(this._root);
...
// Path: recipes
class _TranslationsRecipesBs implements TranslationsRecipesEn {
	_TranslationsRecipesBs._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBs implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBs._(this._root);
...
// Path: filters
class _TranslationsFiltersBs implements TranslationsFiltersEn {
	_TranslationsFiltersBs._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBs implements TranslationsShoppingListEn {
	_TranslationsShoppingListBs._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBs implements TranslationsMealPlanEn {
	_TranslationsMealPlanBs._(this._root);
...
// Path: inventory
class _TranslationsInventoryBs implements TranslationsInventoryEn {
	_TranslationsInventoryBs._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBs implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBs._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBs implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBs._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBs implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBs._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBs implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBs._(this._root);
...
class _TranslationsDomainDiscoveryBs implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBs._(this._root);
...
class _TranslationsInventorySuggestionsBs implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBs._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBs implements TranslationsUpgradeEn {
	_TranslationsUpgradeBs._(this._root);
...
// Path: tour
class _TranslationsTourBs implements TranslationsTourEn {
	_TranslationsTourBs._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBs implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBs._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBs implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBs._(this._root);
...
// Path: errors
class _TranslationsErrorsBs implements TranslationsErrorsEn {
	_TranslationsErrorsBs._(this._root);
...
class _TranslationsSettingsMeasurementsBs implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBs._(this._root);
...
class _TranslationsSettingsDataManagementBs implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBs._(this._root);
...
class _TranslationsSettingsVersionBs implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBs._(this._root);
...
class _TranslationsRecipeDetailNutritionBs implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBs._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBs implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBs._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBs implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBs._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBs implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBs._(this._root);
