...
// Path: <root>
class TranslationsKmKh with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKmKh implements TranslationsAppEn {
	_TranslationsAppKmKh._(this._root);
...
// Path: home
class _TranslationsHomeKmKh implements TranslationsHomeEn {
	_TranslationsHomeKmKh._(this._root);
...
// Path: common
class _TranslationsCommonKmKh implements TranslationsCommonEn {
	_TranslationsCommonKmKh._(this._root);
...
// Path: settings
class _TranslationsSettingsKmKh implements TranslationsSettingsEn {
	_TranslationsSettingsKmKh._(this._root);
...
// Path: recipes
class _TranslationsRecipesKmKh implements TranslationsRecipesEn {
	_TranslationsRecipesKmKh._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKmKh implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKmKh._(this._root);
...
// Path: filters
class _TranslationsFiltersKmKh implements TranslationsFiltersEn {
	_TranslationsFiltersKmKh._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKmKh implements TranslationsShoppingListEn {
	_TranslationsShoppingListKmKh._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKmKh implements TranslationsMealPlanEn {
	_TranslationsMealPlanKmKh._(this._root);
...
// Path: inventory
class _TranslationsInventoryKmKh implements TranslationsInventoryEn {
	_TranslationsInventoryKmKh._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKmKh implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKmKh._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKmKh implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKmKh._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKmKh implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKmKh._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKmKh implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKmKh._(this._root);
...
class _TranslationsDomainDiscoveryKmKh implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKmKh._(this._root);
...
class _TranslationsInventorySuggestionsKmKh implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKmKh._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKmKh implements TranslationsUpgradeEn {
	_TranslationsUpgradeKmKh._(this._root);
...
// Path: tour
class _TranslationsTourKmKh implements TranslationsTourEn {
	_TranslationsTourKmKh._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKmKh implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKmKh._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKmKh implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKmKh._(this._root);
...
// Path: errors
class _TranslationsErrorsKmKh implements TranslationsErrorsEn {
	_TranslationsErrorsKmKh._(this._root);
...
class _TranslationsSettingsMeasurementsKmKh implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKmKh._(this._root);
...
class _TranslationsSettingsDataManagementKmKh implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKmKh._(this._root);
...
class _TranslationsSettingsVersionKmKh implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKmKh._(this._root);
...
class _TranslationsRecipeDetailNutritionKmKh implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKmKh._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKmKh implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKmKh._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKmKh implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKmKh._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKmKh implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKmKh._(this._root);
