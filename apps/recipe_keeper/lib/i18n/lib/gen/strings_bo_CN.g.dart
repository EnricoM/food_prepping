...
// Path: <root>
class TranslationsBoCn with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppBoCn implements TranslationsAppEn {
	_TranslationsAppBoCn._(this._root);
...
// Path: home
class _TranslationsHomeBoCn implements TranslationsHomeEn {
	_TranslationsHomeBoCn._(this._root);
...
// Path: common
class _TranslationsCommonBoCn implements TranslationsCommonEn {
	_TranslationsCommonBoCn._(this._root);
...
// Path: settings
class _TranslationsSettingsBoCn implements TranslationsSettingsEn {
	_TranslationsSettingsBoCn._(this._root);
...
// Path: recipes
class _TranslationsRecipesBoCn implements TranslationsRecipesEn {
	_TranslationsRecipesBoCn._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBoCn implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBoCn._(this._root);
...
// Path: filters
class _TranslationsFiltersBoCn implements TranslationsFiltersEn {
	_TranslationsFiltersBoCn._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListBoCn implements TranslationsShoppingListEn {
	_TranslationsShoppingListBoCn._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanBoCn implements TranslationsMealPlanEn {
	_TranslationsMealPlanBoCn._(this._root);
...
// Path: inventory
class _TranslationsInventoryBoCn implements TranslationsInventoryEn {
	_TranslationsInventoryBoCn._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBoCn implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBoCn._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanBoCn implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanBoCn._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingBoCn implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingBoCn._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBoCn implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBoCn._(this._root);
...
class _TranslationsDomainDiscoveryBoCn implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBoCn._(this._root);
...
class _TranslationsInventorySuggestionsBoCn implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBoCn._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeBoCn implements TranslationsUpgradeEn {
	_TranslationsUpgradeBoCn._(this._root);
...
// Path: tour
class _TranslationsTourBoCn implements TranslationsTourEn {
	_TranslationsTourBoCn._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBoCn implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeBoCn._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBoCn implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditBoCn._(this._root);
...
// Path: errors
class _TranslationsErrorsBoCn implements TranslationsErrorsEn {
	_TranslationsErrorsBoCn._(this._root);
...
class _TranslationsSettingsMeasurementsBoCn implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBoCn._(this._root);
...
class _TranslationsSettingsDataManagementBoCn implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBoCn._(this._root);
...
class _TranslationsSettingsVersionBoCn implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBoCn._(this._root);
...
class _TranslationsRecipeDetailNutritionBoCn implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBoCn._(this._root);
...
class _TranslationsRecipeDetailPrepAheadBoCn implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBoCn._(this._root);
...
class _TranslationsSettingsMeasurementsMetricBoCn implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBoCn._(this._root);
...
class _TranslationsSettingsMeasurementsImperialBoCn implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBoCn._(this._root);
