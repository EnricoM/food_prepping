...
// Path: <root>
class TranslationsTiEt with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppTiEt implements TranslationsAppEn {
	_TranslationsAppTiEt._(this._root);
...
// Path: home
class _TranslationsHomeTiEt implements TranslationsHomeEn {
	_TranslationsHomeTiEt._(this._root);
...
// Path: common
class _TranslationsCommonTiEt implements TranslationsCommonEn {
	_TranslationsCommonTiEt._(this._root);
...
// Path: settings
class _TranslationsSettingsTiEt implements TranslationsSettingsEn {
	_TranslationsSettingsTiEt._(this._root);
...
// Path: recipes
class _TranslationsRecipesTiEt implements TranslationsRecipesEn {
	_TranslationsRecipesTiEt._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTiEt implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTiEt._(this._root);
...
// Path: filters
class _TranslationsFiltersTiEt implements TranslationsFiltersEn {
	_TranslationsFiltersTiEt._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTiEt implements TranslationsShoppingListEn {
	_TranslationsShoppingListTiEt._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTiEt implements TranslationsMealPlanEn {
	_TranslationsMealPlanTiEt._(this._root);
...
// Path: inventory
class _TranslationsInventoryTiEt implements TranslationsInventoryEn {
	_TranslationsInventoryTiEt._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTiEt implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTiEt._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTiEt implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTiEt._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTiEt implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTiEt._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTiEt implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTiEt._(this._root);
...
class _TranslationsDomainDiscoveryTiEt implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTiEt._(this._root);
...
class _TranslationsInventorySuggestionsTiEt implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTiEt._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTiEt implements TranslationsUpgradeEn {
	_TranslationsUpgradeTiEt._(this._root);
...
// Path: tour
class _TranslationsTourTiEt implements TranslationsTourEn {
	_TranslationsTourTiEt._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTiEt implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTiEt._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTiEt implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTiEt._(this._root);
...
// Path: errors
class _TranslationsErrorsTiEt implements TranslationsErrorsEn {
	_TranslationsErrorsTiEt._(this._root);
...
class _TranslationsSettingsMeasurementsTiEt implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTiEt._(this._root);
...
class _TranslationsSettingsDataManagementTiEt implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTiEt._(this._root);
...
class _TranslationsSettingsVersionTiEt implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTiEt._(this._root);
...
class _TranslationsRecipeDetailNutritionTiEt implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTiEt._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTiEt implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTiEt._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTiEt implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTiEt._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTiEt implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTiEt._(this._root);
