...
// Path: recipes
class _TranslationsRecipesDe implements TranslationsRecipesEn {
	_TranslationsRecipesDe._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailDe implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailDe._(this._root);
...
// Path: filters
class _TranslationsFiltersDe implements TranslationsFiltersEn {
	_TranslationsFiltersDe._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListDe implements TranslationsShoppingListEn {
	_TranslationsShoppingListDe._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanDe implements TranslationsMealPlanEn {
	_TranslationsMealPlanDe._(this._root);
...
// Path: inventory
class _TranslationsInventoryDe implements TranslationsInventoryEn {
	_TranslationsInventoryDe._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanDe implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanDe._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanDe implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanDe._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingDe implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingDe._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsDe implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsDe._(this._root);
...
class _TranslationsDomainDiscoveryDe implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryDe._(this._root);
...
class _TranslationsInventorySuggestionsDe implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsDe._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeDe implements TranslationsUpgradeEn {
	_TranslationsUpgradeDe._(this._root);
...
// Path: tour
class _TranslationsTourDe implements TranslationsTourEn {
	_TranslationsTourDe._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeDe implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeDe._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditDe implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditDe._(this._root);
...
class _TranslationsSettingsMeasurementsDe implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsDe._(this._root);
...
class _TranslationsSettingsDataManagementDe implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementDe._(this._root);
...
class _TranslationsSettingsVersionDe implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionDe._(this._root);
...
class _TranslationsRecipeDetailNutritionDe implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionDe._(this._root);
...
class _TranslationsRecipeDetailPrepAheadDe implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadDe._(this._root);
...
class _TranslationsSettingsMeasurementsMetricDe implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricDe._(this._root);
...
class _TranslationsSettingsMeasurementsImperialDe implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialDe._(this._root);
