...
// Path: <root>
class TranslationsKkKz with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppKkKz implements TranslationsAppEn {
	_TranslationsAppKkKz._(this._root);
...
// Path: home
class _TranslationsHomeKkKz implements TranslationsHomeEn {
	_TranslationsHomeKkKz._(this._root);
...
// Path: common
class _TranslationsCommonKkKz implements TranslationsCommonEn {
	_TranslationsCommonKkKz._(this._root);
...
// Path: settings
class _TranslationsSettingsKkKz implements TranslationsSettingsEn {
	_TranslationsSettingsKkKz._(this._root);
...
// Path: recipes
class _TranslationsRecipesKkKz implements TranslationsRecipesEn {
	_TranslationsRecipesKkKz._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKkKz implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKkKz._(this._root);
...
// Path: filters
class _TranslationsFiltersKkKz implements TranslationsFiltersEn {
	_TranslationsFiltersKkKz._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListKkKz implements TranslationsShoppingListEn {
	_TranslationsShoppingListKkKz._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanKkKz implements TranslationsMealPlanEn {
	_TranslationsMealPlanKkKz._(this._root);
...
// Path: inventory
class _TranslationsInventoryKkKz implements TranslationsInventoryEn {
	_TranslationsInventoryKkKz._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKkKz implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKkKz._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanKkKz implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanKkKz._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingKkKz implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingKkKz._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKkKz implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKkKz._(this._root);
...
class _TranslationsDomainDiscoveryKkKz implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKkKz._(this._root);
...
class _TranslationsInventorySuggestionsKkKz implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKkKz._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeKkKz implements TranslationsUpgradeEn {
	_TranslationsUpgradeKkKz._(this._root);
...
// Path: tour
class _TranslationsTourKkKz implements TranslationsTourEn {
	_TranslationsTourKkKz._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKkKz implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeKkKz._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKkKz implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditKkKz._(this._root);
...
// Path: errors
class _TranslationsErrorsKkKz implements TranslationsErrorsEn {
	_TranslationsErrorsKkKz._(this._root);
...
class _TranslationsSettingsMeasurementsKkKz implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKkKz._(this._root);
...
class _TranslationsSettingsDataManagementKkKz implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKkKz._(this._root);
...
class _TranslationsSettingsVersionKkKz implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKkKz._(this._root);
...
class _TranslationsRecipeDetailNutritionKkKz implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKkKz._(this._root);
...
class _TranslationsRecipeDetailPrepAheadKkKz implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKkKz._(this._root);
...
class _TranslationsSettingsMeasurementsMetricKkKz implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKkKz._(this._root);
...
class _TranslationsSettingsMeasurementsImperialKkKz implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKkKz._(this._root);
