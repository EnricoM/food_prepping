...
// Path: recipes
class _TranslationsRecipesTr implements TranslationsRecipesEn {
	_TranslationsRecipesTr._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTr implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTr._(this._root);
...
// Path: filters
class _TranslationsFiltersTr implements TranslationsFiltersEn {
	_TranslationsFiltersTr._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListTr implements TranslationsShoppingListEn {
	_TranslationsShoppingListTr._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanTr implements TranslationsMealPlanEn {
	_TranslationsMealPlanTr._(this._root);
...
// Path: inventory
class _TranslationsInventoryTr implements TranslationsInventoryEn {
	_TranslationsInventoryTr._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTr implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTr._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanTr implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanTr._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingTr implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingTr._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTr implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTr._(this._root);
...
class _TranslationsDomainDiscoveryTr implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTr._(this._root);
...
class _TranslationsInventorySuggestionsTr implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTr._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeTr implements TranslationsUpgradeEn {
	_TranslationsUpgradeTr._(this._root);
...
// Path: tour
class _TranslationsTourTr implements TranslationsTourEn {
	_TranslationsTourTr._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTr implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeTr._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTr implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditTr._(this._root);
...
class _TranslationsSettingsMeasurementsTr implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTr._(this._root);
...
class _TranslationsSettingsDataManagementTr implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTr._(this._root);
...
class _TranslationsSettingsVersionTr implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTr._(this._root);
...
class _TranslationsRecipeDetailNutritionTr implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTr._(this._root);
...
class _TranslationsRecipeDetailPrepAheadTr implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTr._(this._root);
...
class _TranslationsSettingsMeasurementsMetricTr implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTr._(this._root);
...
class _TranslationsSettingsMeasurementsImperialTr implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTr._(this._root);
