...
// Path: recipes
class _TranslationsRecipesHe implements TranslationsRecipesEn {
	_TranslationsRecipesHe._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHe implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHe._(this._root);
...
// Path: filters
class _TranslationsFiltersHe implements TranslationsFiltersEn {
	_TranslationsFiltersHe._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListHe implements TranslationsShoppingListEn {
	_TranslationsShoppingListHe._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanHe implements TranslationsMealPlanEn {
	_TranslationsMealPlanHe._(this._root);
...
// Path: inventory
class _TranslationsInventoryHe implements TranslationsInventoryEn {
	_TranslationsInventoryHe._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHe implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHe._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanHe implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanHe._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingHe implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingHe._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHe implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHe._(this._root);
...
class _TranslationsDomainDiscoveryHe implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHe._(this._root);
...
class _TranslationsInventorySuggestionsHe implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHe._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeHe implements TranslationsUpgradeEn {
	_TranslationsUpgradeHe._(this._root);
...
// Path: tour
class _TranslationsTourHe implements TranslationsTourEn {
	_TranslationsTourHe._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHe implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeHe._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHe implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditHe._(this._root);
...
class _TranslationsSettingsMeasurementsHe implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHe._(this._root);
...
class _TranslationsSettingsDataManagementHe implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHe._(this._root);
...
class _TranslationsSettingsVersionHe implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHe._(this._root);
...
class _TranslationsRecipeDetailNutritionHe implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHe._(this._root);
...
class _TranslationsRecipeDetailPrepAheadHe implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHe._(this._root);
...
class _TranslationsSettingsMeasurementsMetricHe implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHe._(this._root);
...
class _TranslationsSettingsMeasurementsImperialHe implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHe._(this._root);
