...
// Path: <root>
class TranslationsHa with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppHa implements TranslationsAppEn {
	_TranslationsAppHa._(this._root);
...
// Path: home
class _TranslationsHomeHa implements TranslationsHomeEn {
	_TranslationsHomeHa._(this._root);
...
// Path: common
class _TranslationsCommonHa implements TranslationsCommonEn {
	_TranslationsCommonHa._(this._root);
...
// Path: settings
class _TranslationsSettingsHa implements TranslationsSettingsEn {
	_TranslationsSettingsHa._(this._root);
...
// Path: recipes
class _TranslationsRecipesHa implements TranslationsRecipesEn {
	_TranslationsRecipesHa._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHa implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHa._(this._root);
...
// Path: filters
class _TranslationsFiltersHa implements TranslationsFiltersEn {
	_TranslationsFiltersHa._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListHa implements TranslationsShoppingListEn {
	_TranslationsShoppingListHa._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanHa implements TranslationsMealPlanEn {
	_TranslationsMealPlanHa._(this._root);
...
// Path: inventory
class _TranslationsInventoryHa implements TranslationsInventoryEn {
	_TranslationsInventoryHa._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHa implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHa._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanHa implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanHa._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingHa implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingHa._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHa implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHa._(this._root);
...
class _TranslationsDomainDiscoveryHa implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHa._(this._root);
...
class _TranslationsInventorySuggestionsHa implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHa._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeHa implements TranslationsUpgradeEn {
	_TranslationsUpgradeHa._(this._root);
...
// Path: tour
class _TranslationsTourHa implements TranslationsTourEn {
	_TranslationsTourHa._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHa implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeHa._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHa implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditHa._(this._root);
...
// Path: errors
class _TranslationsErrorsHa implements TranslationsErrorsEn {
	_TranslationsErrorsHa._(this._root);
...
class _TranslationsSettingsMeasurementsHa implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHa._(this._root);
...
class _TranslationsSettingsDataManagementHa implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHa._(this._root);
...
class _TranslationsSettingsVersionHa implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHa._(this._root);
...
class _TranslationsRecipeDetailNutritionHa implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHa._(this._root);
...
class _TranslationsRecipeDetailPrepAheadHa implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHa._(this._root);
...
class _TranslationsSettingsMeasurementsMetricHa implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHa._(this._root);
...
class _TranslationsSettingsMeasurementsImperialHa implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHa._(this._root);
