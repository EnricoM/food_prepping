...
// Path: <root>
class TranslationsSwTz with BaseTranslations<AppLocale, Translations> implements Translations {
...
// Path: app
class _TranslationsAppSwTz implements TranslationsAppEn {
	_TranslationsAppSwTz._(this._root);
...
// Path: home
class _TranslationsHomeSwTz implements TranslationsHomeEn {
	_TranslationsHomeSwTz._(this._root);
...
// Path: common
class _TranslationsCommonSwTz implements TranslationsCommonEn {
	_TranslationsCommonSwTz._(this._root);
...
// Path: settings
class _TranslationsSettingsSwTz implements TranslationsSettingsEn {
	_TranslationsSettingsSwTz._(this._root);
...
// Path: recipes
class _TranslationsRecipesSwTz implements TranslationsRecipesEn {
	_TranslationsRecipesSwTz._(this._root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSwTz implements TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSwTz._(this._root);
...
// Path: filters
class _TranslationsFiltersSwTz implements TranslationsFiltersEn {
	_TranslationsFiltersSwTz._(this._root);
...
// Path: shoppingList
class _TranslationsShoppingListSwTz implements TranslationsShoppingListEn {
	_TranslationsShoppingListSwTz._(this._root);
...
// Path: mealPlan
class _TranslationsMealPlanSwTz implements TranslationsMealPlanEn {
	_TranslationsMealPlanSwTz._(this._root);
...
// Path: inventory
class _TranslationsInventorySwTz implements TranslationsInventoryEn {
	_TranslationsInventorySwTz._(this._root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSwTz implements TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSwTz._(this._root);
...
// Path: receiptScan
class _TranslationsReceiptScanSwTz implements TranslationsReceiptScanEn {
	_TranslationsReceiptScanSwTz._(this._root);
...
// Path: batchCooking
class _TranslationsBatchCookingSwTz implements TranslationsBatchCookingEn {
	_TranslationsBatchCookingSwTz._(this._root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSwTz implements TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSwTz._(this._root);
...
class _TranslationsDomainDiscoverySwTz implements TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySwTz._(this._root);
...
class _TranslationsInventorySuggestionsSwTz implements TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSwTz._(this._root);
...
// Path: upgrade
class _TranslationsUpgradeSwTz implements TranslationsUpgradeEn {
	_TranslationsUpgradeSwTz._(this._root);
...
// Path: tour
class _TranslationsTourSwTz implements TranslationsTourEn {
	_TranslationsTourSwTz._(this._root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSwTz implements TranslationsManualRecipeEn {
	_TranslationsManualRecipeSwTz._(this._root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSwTz implements TranslationsRecipeEditEn {
	_TranslationsRecipeEditSwTz._(this._root);
...
// Path: errors
class _TranslationsErrorsSwTz implements TranslationsErrorsEn {
	_TranslationsErrorsSwTz._(this._root);
...
class _TranslationsSettingsMeasurementsSwTz implements TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSwTz._(this._root);
...
class _TranslationsSettingsDataManagementSwTz implements TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSwTz._(this._root);
...
class _TranslationsSettingsVersionSwTz implements TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSwTz._(this._root);
...
class _TranslationsRecipeDetailNutritionSwTz implements TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSwTz._(this._root);
...
class _TranslationsRecipeDetailPrepAheadSwTz implements TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSwTz._(this._root);
...
class _TranslationsSettingsMeasurementsMetricSwTz implements TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSwTz._(this._root);
...
class _TranslationsSettingsMeasurementsImperialSwTz implements TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSwTz._(this._root);
