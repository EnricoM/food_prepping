...
class TranslationsBnIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppBnIn app = _TranslationsAppBnIn._(_root);
	@override late final _TranslationsHomeBnIn home = _TranslationsHomeBnIn._(_root);
	@override late final _TranslationsCommonBnIn common = _TranslationsCommonBnIn._(_root);
	@override late final _TranslationsSettingsBnIn settings = _TranslationsSettingsBnIn._(_root);
	@override late final _TranslationsRecipesBnIn recipes = _TranslationsRecipesBnIn._(_root);
	@override late final _TranslationsRecipeDetailBnIn recipeDetail = _TranslationsRecipeDetailBnIn._(_root);
	@override late final _TranslationsFiltersBnIn filters = _TranslationsFiltersBnIn._(_root);
	@override late final _TranslationsShoppingListBnIn shoppingList = _TranslationsShoppingListBnIn._(_root);
	@override late final _TranslationsMealPlanBnIn mealPlan = _TranslationsMealPlanBnIn._(_root);
	@override late final _TranslationsInventoryBnIn inventory = _TranslationsInventoryBnIn._(_root);
	@override late final _TranslationsBarcodeScanBnIn barcodeScan = _TranslationsBarcodeScanBnIn._(_root);
	@override late final _TranslationsReceiptScanBnIn receiptScan = _TranslationsReceiptScanBnIn._(_root);
	@override late final _TranslationsBatchCookingBnIn batchCooking = _TranslationsBatchCookingBnIn._(_root);
	@override late final _TranslationsVisitedDomainsBnIn visitedDomains = _TranslationsVisitedDomainsBnIn._(_root);
	@override late final _TranslationsDomainDiscoveryBnIn domainDiscovery = _TranslationsDomainDiscoveryBnIn._(_root);
	@override late final _TranslationsInventorySuggestionsBnIn inventorySuggestions = _TranslationsInventorySuggestionsBnIn._(_root);
	@override late final _TranslationsUpgradeBnIn upgrade = _TranslationsUpgradeBnIn._(_root);
	@override late final _TranslationsTourBnIn tour = _TranslationsTourBnIn._(_root);
	@override late final _TranslationsManualRecipeBnIn manualRecipe = _TranslationsManualRecipeBnIn._(_root);
	@override late final _TranslationsRecipeEditBnIn recipeEdit = _TranslationsRecipeEditBnIn._(_root);
	@override late final _TranslationsErrorsBnIn errors = _TranslationsErrorsBnIn._(_root);
}

// Path: app
class _TranslationsAppBnIn extends TranslationsAppEn {
	_TranslationsAppBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);

	final TranslationsBnIn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeBnIn extends TranslationsHomeEn {
	_TranslationsHomeBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBnIn extends TranslationsCommonEn {
	_TranslationsCommonBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBnIn extends TranslationsSettingsEn {
	_TranslationsSettingsBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);

	final TranslationsBnIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBnIn measurements = _TranslationsSettingsMeasurementsBnIn._(_root);
	@override late final _TranslationsSettingsDataManagementBnIn dataManagement = _TranslationsSettingsDataManagementBnIn._(_root);
	@override late final _TranslationsSettingsVersionBnIn version = _TranslationsSettingsVersionBnIn._(_root);
}

// Path: recipes
class _TranslationsRecipesBnIn extends TranslationsRecipesEn {
	_TranslationsRecipesBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBnIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBnIn nutrition = _TranslationsRecipeDetailNutritionBnIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBnIn prepAhead = _TranslationsRecipeDetailPrepAheadBnIn._(_root);
...
// Path: filters
class _TranslationsFiltersBnIn extends TranslationsFiltersEn {
	_TranslationsFiltersBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBnIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBnIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBnIn extends TranslationsInventoryEn {
	_TranslationsInventoryBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBnIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBnIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBnIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBnIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBnIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBnIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBnIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBnIn extends TranslationsTourEn {
	_TranslationsTourBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBnIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBnIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBnIn extends TranslationsErrorsEn {
	_TranslationsErrorsBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBnIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBnIn metric = _TranslationsSettingsMeasurementsMetricBnIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBnIn imperial = _TranslationsSettingsMeasurementsImperialBnIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBnIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBnIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBnIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBnIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBnIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBnIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBnIn._(TranslationsBnIn root) : this._root = root, super.internal(root);
