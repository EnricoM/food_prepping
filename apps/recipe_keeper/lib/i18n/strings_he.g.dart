...
class TranslationsHe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesHe recipes = _TranslationsRecipesHe._(_root);
	@override late final _TranslationsRecipeDetailHe recipeDetail = _TranslationsRecipeDetailHe._(_root);
	@override late final _TranslationsFiltersHe filters = _TranslationsFiltersHe._(_root);
	@override late final _TranslationsShoppingListHe shoppingList = _TranslationsShoppingListHe._(_root);
	@override late final _TranslationsMealPlanHe mealPlan = _TranslationsMealPlanHe._(_root);
	@override late final _TranslationsInventoryHe inventory = _TranslationsInventoryHe._(_root);
	@override late final _TranslationsBarcodeScanHe barcodeScan = _TranslationsBarcodeScanHe._(_root);
	@override late final _TranslationsReceiptScanHe receiptScan = _TranslationsReceiptScanHe._(_root);
	@override late final _TranslationsBatchCookingHe batchCooking = _TranslationsBatchCookingHe._(_root);
	@override late final _TranslationsVisitedDomainsHe visitedDomains = _TranslationsVisitedDomainsHe._(_root);
	@override late final _TranslationsDomainDiscoveryHe domainDiscovery = _TranslationsDomainDiscoveryHe._(_root);
	@override late final _TranslationsInventorySuggestionsHe inventorySuggestions = _TranslationsInventorySuggestionsHe._(_root);
	@override late final _TranslationsUpgradeHe upgrade = _TranslationsUpgradeHe._(_root);
	@override late final _TranslationsTourHe tour = _TranslationsTourHe._(_root);
	@override late final _TranslationsManualRecipeHe manualRecipe = _TranslationsManualRecipeHe._(_root);
	@override late final _TranslationsRecipeEditHe recipeEdit = _TranslationsRecipeEditHe._(_root);
	@override late final _TranslationsErrorsHe errors = _TranslationsErrorsHe._(_root);
}

// Path: app
class _TranslationsAppHe extends TranslationsAppEn {
	_TranslationsAppHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsHe extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsHe measurements = _TranslationsSettingsMeasurementsHe._(_root);
	@override late final _TranslationsSettingsDataManagementHe dataManagement = _TranslationsSettingsDataManagementHe._(_root);
	@override late final _TranslationsSettingsVersionHe version = _TranslationsSettingsVersionHe._(_root);
}

// Path: recipes
class _TranslationsRecipesHe extends TranslationsRecipesEn {
	_TranslationsRecipesHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHe._(TranslationsHe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHe nutrition = _TranslationsRecipeDetailNutritionHe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHe prepAhead = _TranslationsRecipeDetailPrepAheadHe._(_root);
...
// Path: filters
class _TranslationsFiltersHe extends TranslationsFiltersEn {
	_TranslationsFiltersHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHe extends TranslationsShoppingListEn {
	_TranslationsShoppingListHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHe extends TranslationsMealPlanEn {
	_TranslationsMealPlanHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHe extends TranslationsInventoryEn {
	_TranslationsInventoryHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHe extends TranslationsUpgradeEn {
	_TranslationsUpgradeHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHe extends TranslationsTourEn {
	_TranslationsTourHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHe._(TranslationsHe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHe metric = _TranslationsSettingsMeasurementsMetricHe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHe imperial = _TranslationsSettingsMeasurementsImperialHe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHe._(TranslationsHe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHe._(TranslationsHe root) : this._root = root, super.internal(root);
