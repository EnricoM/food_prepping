...
class TranslationsUr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesUr recipes = _TranslationsRecipesUr._(_root);
	@override late final _TranslationsRecipeDetailUr recipeDetail = _TranslationsRecipeDetailUr._(_root);
	@override late final _TranslationsFiltersUr filters = _TranslationsFiltersUr._(_root);
	@override late final _TranslationsShoppingListUr shoppingList = _TranslationsShoppingListUr._(_root);
	@override late final _TranslationsMealPlanUr mealPlan = _TranslationsMealPlanUr._(_root);
	@override late final _TranslationsInventoryUr inventory = _TranslationsInventoryUr._(_root);
	@override late final _TranslationsBarcodeScanUr barcodeScan = _TranslationsBarcodeScanUr._(_root);
	@override late final _TranslationsReceiptScanUr receiptScan = _TranslationsReceiptScanUr._(_root);
	@override late final _TranslationsBatchCookingUr batchCooking = _TranslationsBatchCookingUr._(_root);
	@override late final _TranslationsVisitedDomainsUr visitedDomains = _TranslationsVisitedDomainsUr._(_root);
	@override late final _TranslationsDomainDiscoveryUr domainDiscovery = _TranslationsDomainDiscoveryUr._(_root);
	@override late final _TranslationsInventorySuggestionsUr inventorySuggestions = _TranslationsInventorySuggestionsUr._(_root);
	@override late final _TranslationsUpgradeUr upgrade = _TranslationsUpgradeUr._(_root);
	@override late final _TranslationsTourUr tour = _TranslationsTourUr._(_root);
	@override late final _TranslationsManualRecipeUr manualRecipe = _TranslationsManualRecipeUr._(_root);
	@override late final _TranslationsRecipeEditUr recipeEdit = _TranslationsRecipeEditUr._(_root);
...
class _TranslationsSettingsUr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsUr measurements = _TranslationsSettingsMeasurementsUr._(_root);
	@override late final _TranslationsSettingsDataManagementUr dataManagement = _TranslationsSettingsDataManagementUr._(_root);
	@override late final _TranslationsSettingsVersionUr version = _TranslationsSettingsVersionUr._(_root);
}

// Path: recipes
class _TranslationsRecipesUr extends TranslationsRecipesEn {
	_TranslationsRecipesUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUr._(TranslationsUr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionUr nutrition = _TranslationsRecipeDetailNutritionUr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadUr prepAhead = _TranslationsRecipeDetailPrepAheadUr._(_root);
...
// Path: filters
class _TranslationsFiltersUr extends TranslationsFiltersEn {
	_TranslationsFiltersUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListUr extends TranslationsShoppingListEn {
	_TranslationsShoppingListUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanUr extends TranslationsMealPlanEn {
	_TranslationsMealPlanUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryUr extends TranslationsInventoryEn {
	_TranslationsInventoryUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanUr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingUr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryUr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsUr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeUr extends TranslationsUpgradeEn {
	_TranslationsUpgradeUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourUr extends TranslationsTourEn {
	_TranslationsTourUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsUr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUr._(TranslationsUr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricUr metric = _TranslationsSettingsMeasurementsMetricUr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialUr imperial = _TranslationsSettingsMeasurementsImperialUr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementUr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionUr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionUr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadUr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricUr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUr._(TranslationsUr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialUr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUr._(TranslationsUr root) : this._root = root, super.internal(root);
