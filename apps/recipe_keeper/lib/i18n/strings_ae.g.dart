...
// Path: <root>
class TranslationsAe extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAe({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ae>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAe _root = this; // ignore: unused_field

	@override 
	TranslationsAe $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAe(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAe app = _TranslationsAppAe._(_root);
	@override late final _TranslationsHomeAe home = _TranslationsHomeAe._(_root);
	@override late final _TranslationsCommonAe common = _TranslationsCommonAe._(_root);
	@override late final _TranslationsSettingsAe settings = _TranslationsSettingsAe._(_root);
	@override late final _TranslationsRecipesAe recipes = _TranslationsRecipesAe._(_root);
	@override late final _TranslationsRecipeDetailAe recipeDetail = _TranslationsRecipeDetailAe._(_root);
	@override late final _TranslationsFiltersAe filters = _TranslationsFiltersAe._(_root);
	@override late final _TranslationsShoppingListAe shoppingList = _TranslationsShoppingListAe._(_root);
	@override late final _TranslationsMealPlanAe mealPlan = _TranslationsMealPlanAe._(_root);
	@override late final _TranslationsInventoryAe inventory = _TranslationsInventoryAe._(_root);
	@override late final _TranslationsBarcodeScanAe barcodeScan = _TranslationsBarcodeScanAe._(_root);
	@override late final _TranslationsReceiptScanAe receiptScan = _TranslationsReceiptScanAe._(_root);
	@override late final _TranslationsBatchCookingAe batchCooking = _TranslationsBatchCookingAe._(_root);
	@override late final _TranslationsVisitedDomainsAe visitedDomains = _TranslationsVisitedDomainsAe._(_root);
	@override late final _TranslationsDomainDiscoveryAe domainDiscovery = _TranslationsDomainDiscoveryAe._(_root);
	@override late final _TranslationsInventorySuggestionsAe inventorySuggestions = _TranslationsInventorySuggestionsAe._(_root);
	@override late final _TranslationsUpgradeAe upgrade = _TranslationsUpgradeAe._(_root);
	@override late final _TranslationsTourAe tour = _TranslationsTourAe._(_root);
	@override late final _TranslationsManualRecipeAe manualRecipe = _TranslationsManualRecipeAe._(_root);
	@override late final _TranslationsRecipeEditAe recipeEdit = _TranslationsRecipeEditAe._(_root);
	@override late final _TranslationsErrorsAe errors = _TranslationsErrorsAe._(_root);
}

// Path: app
class _TranslationsAppAe extends TranslationsAppEn {
	_TranslationsAppAe._(TranslationsAe root) : this._root = root, super.internal(root);

	final TranslationsAe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAe extends TranslationsHomeEn {
	_TranslationsHomeAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAe extends TranslationsCommonEn {
	_TranslationsCommonAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAe extends TranslationsSettingsEn {
	_TranslationsSettingsAe._(TranslationsAe root) : this._root = root, super.internal(root);

	final TranslationsAe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAe measurements = _TranslationsSettingsMeasurementsAe._(_root);
	@override late final _TranslationsSettingsDataManagementAe dataManagement = _TranslationsSettingsDataManagementAe._(_root);
	@override late final _TranslationsSettingsVersionAe version = _TranslationsSettingsVersionAe._(_root);
}

// Path: recipes
class _TranslationsRecipesAe extends TranslationsRecipesEn {
	_TranslationsRecipesAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAe._(TranslationsAe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAe nutrition = _TranslationsRecipeDetailNutritionAe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAe prepAhead = _TranslationsRecipeDetailPrepAheadAe._(_root);
...
// Path: filters
class _TranslationsFiltersAe extends TranslationsFiltersEn {
	_TranslationsFiltersAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAe extends TranslationsShoppingListEn {
	_TranslationsShoppingListAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAe extends TranslationsMealPlanEn {
	_TranslationsMealPlanAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAe extends TranslationsInventoryEn {
	_TranslationsInventoryAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAe extends TranslationsUpgradeEn {
	_TranslationsUpgradeAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAe extends TranslationsTourEn {
	_TranslationsTourAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAe extends TranslationsErrorsEn {
	_TranslationsErrorsAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAe._(TranslationsAe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAe metric = _TranslationsSettingsMeasurementsMetricAe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAe imperial = _TranslationsSettingsMeasurementsImperialAe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAe._(TranslationsAe root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ae>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAe {
