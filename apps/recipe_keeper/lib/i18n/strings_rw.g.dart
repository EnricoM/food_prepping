...
// Path: <root>
class TranslationsRw extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsRw({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <rw>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsRw _root = this; // ignore: unused_field

	@override 
	TranslationsRw $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsRw(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppRw app = _TranslationsAppRw._(_root);
	@override late final _TranslationsHomeRw home = _TranslationsHomeRw._(_root);
	@override late final _TranslationsCommonRw common = _TranslationsCommonRw._(_root);
	@override late final _TranslationsSettingsRw settings = _TranslationsSettingsRw._(_root);
	@override late final _TranslationsRecipesRw recipes = _TranslationsRecipesRw._(_root);
	@override late final _TranslationsRecipeDetailRw recipeDetail = _TranslationsRecipeDetailRw._(_root);
	@override late final _TranslationsFiltersRw filters = _TranslationsFiltersRw._(_root);
	@override late final _TranslationsShoppingListRw shoppingList = _TranslationsShoppingListRw._(_root);
	@override late final _TranslationsMealPlanRw mealPlan = _TranslationsMealPlanRw._(_root);
	@override late final _TranslationsInventoryRw inventory = _TranslationsInventoryRw._(_root);
	@override late final _TranslationsBarcodeScanRw barcodeScan = _TranslationsBarcodeScanRw._(_root);
	@override late final _TranslationsReceiptScanRw receiptScan = _TranslationsReceiptScanRw._(_root);
	@override late final _TranslationsBatchCookingRw batchCooking = _TranslationsBatchCookingRw._(_root);
	@override late final _TranslationsVisitedDomainsRw visitedDomains = _TranslationsVisitedDomainsRw._(_root);
	@override late final _TranslationsDomainDiscoveryRw domainDiscovery = _TranslationsDomainDiscoveryRw._(_root);
	@override late final _TranslationsInventorySuggestionsRw inventorySuggestions = _TranslationsInventorySuggestionsRw._(_root);
	@override late final _TranslationsUpgradeRw upgrade = _TranslationsUpgradeRw._(_root);
	@override late final _TranslationsTourRw tour = _TranslationsTourRw._(_root);
	@override late final _TranslationsManualRecipeRw manualRecipe = _TranslationsManualRecipeRw._(_root);
	@override late final _TranslationsRecipeEditRw recipeEdit = _TranslationsRecipeEditRw._(_root);
	@override late final _TranslationsErrorsRw errors = _TranslationsErrorsRw._(_root);
}

// Path: app
class _TranslationsAppRw extends TranslationsAppEn {
	_TranslationsAppRw._(TranslationsRw root) : this._root = root, super.internal(root);

	final TranslationsRw _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeRw extends TranslationsHomeEn {
	_TranslationsHomeRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonRw extends TranslationsCommonEn {
	_TranslationsCommonRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsRw extends TranslationsSettingsEn {
	_TranslationsSettingsRw._(TranslationsRw root) : this._root = root, super.internal(root);

	final TranslationsRw _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsRw measurements = _TranslationsSettingsMeasurementsRw._(_root);
	@override late final _TranslationsSettingsDataManagementRw dataManagement = _TranslationsSettingsDataManagementRw._(_root);
	@override late final _TranslationsSettingsVersionRw version = _TranslationsSettingsVersionRw._(_root);
}

// Path: recipes
class _TranslationsRecipesRw extends TranslationsRecipesEn {
	_TranslationsRecipesRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailRw extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailRw._(TranslationsRw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionRw nutrition = _TranslationsRecipeDetailNutritionRw._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadRw prepAhead = _TranslationsRecipeDetailPrepAheadRw._(_root);
...
// Path: filters
class _TranslationsFiltersRw extends TranslationsFiltersEn {
	_TranslationsFiltersRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListRw extends TranslationsShoppingListEn {
	_TranslationsShoppingListRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanRw extends TranslationsMealPlanEn {
	_TranslationsMealPlanRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryRw extends TranslationsInventoryEn {
	_TranslationsInventoryRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanRw extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanRw extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingRw extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsRw extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryRw extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsRw extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeRw extends TranslationsUpgradeEn {
	_TranslationsUpgradeRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourRw extends TranslationsTourEn {
	_TranslationsTourRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeRw extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditRw extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsRw extends TranslationsErrorsEn {
	_TranslationsErrorsRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsRw extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsRw._(TranslationsRw root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricRw metric = _TranslationsSettingsMeasurementsMetricRw._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialRw imperial = _TranslationsSettingsMeasurementsImperialRw._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementRw extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionRw extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionRw extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadRw extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricRw extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialRw extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialRw._(TranslationsRw root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <rw>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsRw {
