...
class TranslationsTeIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppTeIn app = _TranslationsAppTeIn._(_root);
	@override late final _TranslationsHomeTeIn home = _TranslationsHomeTeIn._(_root);
	@override late final _TranslationsCommonTeIn common = _TranslationsCommonTeIn._(_root);
	@override late final _TranslationsSettingsTeIn settings = _TranslationsSettingsTeIn._(_root);
	@override late final _TranslationsRecipesTeIn recipes = _TranslationsRecipesTeIn._(_root);
	@override late final _TranslationsRecipeDetailTeIn recipeDetail = _TranslationsRecipeDetailTeIn._(_root);
	@override late final _TranslationsFiltersTeIn filters = _TranslationsFiltersTeIn._(_root);
	@override late final _TranslationsShoppingListTeIn shoppingList = _TranslationsShoppingListTeIn._(_root);
	@override late final _TranslationsMealPlanTeIn mealPlan = _TranslationsMealPlanTeIn._(_root);
	@override late final _TranslationsInventoryTeIn inventory = _TranslationsInventoryTeIn._(_root);
	@override late final _TranslationsBarcodeScanTeIn barcodeScan = _TranslationsBarcodeScanTeIn._(_root);
	@override late final _TranslationsReceiptScanTeIn receiptScan = _TranslationsReceiptScanTeIn._(_root);
	@override late final _TranslationsBatchCookingTeIn batchCooking = _TranslationsBatchCookingTeIn._(_root);
	@override late final _TranslationsVisitedDomainsTeIn visitedDomains = _TranslationsVisitedDomainsTeIn._(_root);
	@override late final _TranslationsDomainDiscoveryTeIn domainDiscovery = _TranslationsDomainDiscoveryTeIn._(_root);
	@override late final _TranslationsInventorySuggestionsTeIn inventorySuggestions = _TranslationsInventorySuggestionsTeIn._(_root);
	@override late final _TranslationsUpgradeTeIn upgrade = _TranslationsUpgradeTeIn._(_root);
	@override late final _TranslationsTourTeIn tour = _TranslationsTourTeIn._(_root);
	@override late final _TranslationsManualRecipeTeIn manualRecipe = _TranslationsManualRecipeTeIn._(_root);
	@override late final _TranslationsRecipeEditTeIn recipeEdit = _TranslationsRecipeEditTeIn._(_root);
	@override late final _TranslationsErrorsTeIn errors = _TranslationsErrorsTeIn._(_root);
}

// Path: app
class _TranslationsAppTeIn extends TranslationsAppEn {
	_TranslationsAppTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);

	final TranslationsTeIn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTeIn extends TranslationsHomeEn {
	_TranslationsHomeTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTeIn extends TranslationsCommonEn {
	_TranslationsCommonTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTeIn extends TranslationsSettingsEn {
	_TranslationsSettingsTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);

	final TranslationsTeIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTeIn measurements = _TranslationsSettingsMeasurementsTeIn._(_root);
	@override late final _TranslationsSettingsDataManagementTeIn dataManagement = _TranslationsSettingsDataManagementTeIn._(_root);
	@override late final _TranslationsSettingsVersionTeIn version = _TranslationsSettingsVersionTeIn._(_root);
}

// Path: recipes
class _TranslationsRecipesTeIn extends TranslationsRecipesEn {
	_TranslationsRecipesTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTeIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTeIn nutrition = _TranslationsRecipeDetailNutritionTeIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTeIn prepAhead = _TranslationsRecipeDetailPrepAheadTeIn._(_root);
...
// Path: filters
class _TranslationsFiltersTeIn extends TranslationsFiltersEn {
	_TranslationsFiltersTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTeIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTeIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTeIn extends TranslationsInventoryEn {
	_TranslationsInventoryTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTeIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTeIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTeIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTeIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTeIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTeIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTeIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTeIn extends TranslationsTourEn {
	_TranslationsTourTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTeIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTeIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTeIn extends TranslationsErrorsEn {
	_TranslationsErrorsTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTeIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTeIn metric = _TranslationsSettingsMeasurementsMetricTeIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTeIn imperial = _TranslationsSettingsMeasurementsImperialTeIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTeIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTeIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTeIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTeIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTeIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTeIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTeIn._(TranslationsTeIn root) : this._root = root, super.internal(root);
