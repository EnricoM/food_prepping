...
// Path: <root>
class TranslationsAfZa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAfZa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.afZa,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <af-ZA>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAfZa _root = this; // ignore: unused_field

	@override 
	TranslationsAfZa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAfZa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAfZa app = _TranslationsAppAfZa._(_root);
	@override late final _TranslationsHomeAfZa home = _TranslationsHomeAfZa._(_root);
	@override late final _TranslationsCommonAfZa common = _TranslationsCommonAfZa._(_root);
	@override late final _TranslationsSettingsAfZa settings = _TranslationsSettingsAfZa._(_root);
	@override late final _TranslationsRecipesAfZa recipes = _TranslationsRecipesAfZa._(_root);
	@override late final _TranslationsRecipeDetailAfZa recipeDetail = _TranslationsRecipeDetailAfZa._(_root);
	@override late final _TranslationsFiltersAfZa filters = _TranslationsFiltersAfZa._(_root);
	@override late final _TranslationsShoppingListAfZa shoppingList = _TranslationsShoppingListAfZa._(_root);
	@override late final _TranslationsMealPlanAfZa mealPlan = _TranslationsMealPlanAfZa._(_root);
	@override late final _TranslationsInventoryAfZa inventory = _TranslationsInventoryAfZa._(_root);
	@override late final _TranslationsBarcodeScanAfZa barcodeScan = _TranslationsBarcodeScanAfZa._(_root);
	@override late final _TranslationsReceiptScanAfZa receiptScan = _TranslationsReceiptScanAfZa._(_root);
	@override late final _TranslationsBatchCookingAfZa batchCooking = _TranslationsBatchCookingAfZa._(_root);
	@override late final _TranslationsVisitedDomainsAfZa visitedDomains = _TranslationsVisitedDomainsAfZa._(_root);
	@override late final _TranslationsDomainDiscoveryAfZa domainDiscovery = _TranslationsDomainDiscoveryAfZa._(_root);
	@override late final _TranslationsInventorySuggestionsAfZa inventorySuggestions = _TranslationsInventorySuggestionsAfZa._(_root);
	@override late final _TranslationsUpgradeAfZa upgrade = _TranslationsUpgradeAfZa._(_root);
	@override late final _TranslationsTourAfZa tour = _TranslationsTourAfZa._(_root);
	@override late final _TranslationsManualRecipeAfZa manualRecipe = _TranslationsManualRecipeAfZa._(_root);
	@override late final _TranslationsRecipeEditAfZa recipeEdit = _TranslationsRecipeEditAfZa._(_root);
	@override late final _TranslationsErrorsAfZa errors = _TranslationsErrorsAfZa._(_root);
}

// Path: app
class _TranslationsAppAfZa extends TranslationsAppEn {
	_TranslationsAppAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);

	final TranslationsAfZa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAfZa extends TranslationsHomeEn {
	_TranslationsHomeAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAfZa extends TranslationsCommonEn {
	_TranslationsCommonAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAfZa extends TranslationsSettingsEn {
	_TranslationsSettingsAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);

	final TranslationsAfZa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAfZa measurements = _TranslationsSettingsMeasurementsAfZa._(_root);
	@override late final _TranslationsSettingsDataManagementAfZa dataManagement = _TranslationsSettingsDataManagementAfZa._(_root);
	@override late final _TranslationsSettingsVersionAfZa version = _TranslationsSettingsVersionAfZa._(_root);
}

// Path: recipes
class _TranslationsRecipesAfZa extends TranslationsRecipesEn {
	_TranslationsRecipesAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAfZa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAfZa nutrition = _TranslationsRecipeDetailNutritionAfZa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAfZa prepAhead = _TranslationsRecipeDetailPrepAheadAfZa._(_root);
...
// Path: filters
class _TranslationsFiltersAfZa extends TranslationsFiltersEn {
	_TranslationsFiltersAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAfZa extends TranslationsShoppingListEn {
	_TranslationsShoppingListAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAfZa extends TranslationsMealPlanEn {
	_TranslationsMealPlanAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAfZa extends TranslationsInventoryEn {
	_TranslationsInventoryAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAfZa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAfZa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAfZa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAfZa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAfZa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAfZa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAfZa extends TranslationsUpgradeEn {
	_TranslationsUpgradeAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAfZa extends TranslationsTourEn {
	_TranslationsTourAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAfZa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAfZa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAfZa extends TranslationsErrorsEn {
	_TranslationsErrorsAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAfZa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAfZa metric = _TranslationsSettingsMeasurementsMetricAfZa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAfZa imperial = _TranslationsSettingsMeasurementsImperialAfZa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAfZa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAfZa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAfZa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAfZa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAfZa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAfZa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAfZa._(TranslationsAfZa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <af-ZA>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAfZa {
