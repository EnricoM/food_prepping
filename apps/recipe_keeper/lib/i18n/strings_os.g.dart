...
// Path: <root>
class TranslationsOs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsOs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <os>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsOs _root = this; // ignore: unused_field

	@override 
	TranslationsOs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsOs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppOs app = _TranslationsAppOs._(_root);
	@override late final _TranslationsHomeOs home = _TranslationsHomeOs._(_root);
	@override late final _TranslationsCommonOs common = _TranslationsCommonOs._(_root);
	@override late final _TranslationsSettingsOs settings = _TranslationsSettingsOs._(_root);
	@override late final _TranslationsRecipesOs recipes = _TranslationsRecipesOs._(_root);
	@override late final _TranslationsRecipeDetailOs recipeDetail = _TranslationsRecipeDetailOs._(_root);
	@override late final _TranslationsFiltersOs filters = _TranslationsFiltersOs._(_root);
	@override late final _TranslationsShoppingListOs shoppingList = _TranslationsShoppingListOs._(_root);
	@override late final _TranslationsMealPlanOs mealPlan = _TranslationsMealPlanOs._(_root);
	@override late final _TranslationsInventoryOs inventory = _TranslationsInventoryOs._(_root);
	@override late final _TranslationsBarcodeScanOs barcodeScan = _TranslationsBarcodeScanOs._(_root);
	@override late final _TranslationsReceiptScanOs receiptScan = _TranslationsReceiptScanOs._(_root);
	@override late final _TranslationsBatchCookingOs batchCooking = _TranslationsBatchCookingOs._(_root);
	@override late final _TranslationsVisitedDomainsOs visitedDomains = _TranslationsVisitedDomainsOs._(_root);
	@override late final _TranslationsDomainDiscoveryOs domainDiscovery = _TranslationsDomainDiscoveryOs._(_root);
	@override late final _TranslationsInventorySuggestionsOs inventorySuggestions = _TranslationsInventorySuggestionsOs._(_root);
	@override late final _TranslationsUpgradeOs upgrade = _TranslationsUpgradeOs._(_root);
	@override late final _TranslationsTourOs tour = _TranslationsTourOs._(_root);
	@override late final _TranslationsManualRecipeOs manualRecipe = _TranslationsManualRecipeOs._(_root);
	@override late final _TranslationsRecipeEditOs recipeEdit = _TranslationsRecipeEditOs._(_root);
	@override late final _TranslationsErrorsOs errors = _TranslationsErrorsOs._(_root);
}

// Path: app
class _TranslationsAppOs extends TranslationsAppEn {
	_TranslationsAppOs._(TranslationsOs root) : this._root = root, super.internal(root);

	final TranslationsOs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeOs extends TranslationsHomeEn {
	_TranslationsHomeOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonOs extends TranslationsCommonEn {
	_TranslationsCommonOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsOs extends TranslationsSettingsEn {
	_TranslationsSettingsOs._(TranslationsOs root) : this._root = root, super.internal(root);

	final TranslationsOs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsOs measurements = _TranslationsSettingsMeasurementsOs._(_root);
	@override late final _TranslationsSettingsDataManagementOs dataManagement = _TranslationsSettingsDataManagementOs._(_root);
	@override late final _TranslationsSettingsVersionOs version = _TranslationsSettingsVersionOs._(_root);
}

// Path: recipes
class _TranslationsRecipesOs extends TranslationsRecipesEn {
	_TranslationsRecipesOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailOs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailOs._(TranslationsOs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionOs nutrition = _TranslationsRecipeDetailNutritionOs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadOs prepAhead = _TranslationsRecipeDetailPrepAheadOs._(_root);
...
// Path: filters
class _TranslationsFiltersOs extends TranslationsFiltersEn {
	_TranslationsFiltersOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListOs extends TranslationsShoppingListEn {
	_TranslationsShoppingListOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanOs extends TranslationsMealPlanEn {
	_TranslationsMealPlanOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryOs extends TranslationsInventoryEn {
	_TranslationsInventoryOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanOs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanOs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingOs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsOs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryOs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsOs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeOs extends TranslationsUpgradeEn {
	_TranslationsUpgradeOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourOs extends TranslationsTourEn {
	_TranslationsTourOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeOs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditOs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsOs extends TranslationsErrorsEn {
	_TranslationsErrorsOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsOs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsOs._(TranslationsOs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricOs metric = _TranslationsSettingsMeasurementsMetricOs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialOs imperial = _TranslationsSettingsMeasurementsImperialOs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementOs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionOs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionOs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadOs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricOs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialOs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialOs._(TranslationsOs root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <os>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsOs {
