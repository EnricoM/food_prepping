...
// Path: <root>
class TranslationsIk extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsIk({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ik>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsIk _root = this; // ignore: unused_field

	@override 
	TranslationsIk $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsIk(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppIk app = _TranslationsAppIk._(_root);
	@override late final _TranslationsHomeIk home = _TranslationsHomeIk._(_root);
	@override late final _TranslationsCommonIk common = _TranslationsCommonIk._(_root);
	@override late final _TranslationsSettingsIk settings = _TranslationsSettingsIk._(_root);
	@override late final _TranslationsRecipesIk recipes = _TranslationsRecipesIk._(_root);
	@override late final _TranslationsRecipeDetailIk recipeDetail = _TranslationsRecipeDetailIk._(_root);
	@override late final _TranslationsFiltersIk filters = _TranslationsFiltersIk._(_root);
	@override late final _TranslationsShoppingListIk shoppingList = _TranslationsShoppingListIk._(_root);
	@override late final _TranslationsMealPlanIk mealPlan = _TranslationsMealPlanIk._(_root);
	@override late final _TranslationsInventoryIk inventory = _TranslationsInventoryIk._(_root);
	@override late final _TranslationsBarcodeScanIk barcodeScan = _TranslationsBarcodeScanIk._(_root);
	@override late final _TranslationsReceiptScanIk receiptScan = _TranslationsReceiptScanIk._(_root);
	@override late final _TranslationsBatchCookingIk batchCooking = _TranslationsBatchCookingIk._(_root);
	@override late final _TranslationsVisitedDomainsIk visitedDomains = _TranslationsVisitedDomainsIk._(_root);
	@override late final _TranslationsDomainDiscoveryIk domainDiscovery = _TranslationsDomainDiscoveryIk._(_root);
	@override late final _TranslationsInventorySuggestionsIk inventorySuggestions = _TranslationsInventorySuggestionsIk._(_root);
	@override late final _TranslationsUpgradeIk upgrade = _TranslationsUpgradeIk._(_root);
	@override late final _TranslationsTourIk tour = _TranslationsTourIk._(_root);
	@override late final _TranslationsManualRecipeIk manualRecipe = _TranslationsManualRecipeIk._(_root);
	@override late final _TranslationsRecipeEditIk recipeEdit = _TranslationsRecipeEditIk._(_root);
	@override late final _TranslationsErrorsIk errors = _TranslationsErrorsIk._(_root);
}

// Path: app
class _TranslationsAppIk extends TranslationsAppEn {
	_TranslationsAppIk._(TranslationsIk root) : this._root = root, super.internal(root);

	final TranslationsIk _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIk extends TranslationsHomeEn {
	_TranslationsHomeIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIk extends TranslationsCommonEn {
	_TranslationsCommonIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIk extends TranslationsSettingsEn {
	_TranslationsSettingsIk._(TranslationsIk root) : this._root = root, super.internal(root);

	final TranslationsIk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIk measurements = _TranslationsSettingsMeasurementsIk._(_root);
	@override late final _TranslationsSettingsDataManagementIk dataManagement = _TranslationsSettingsDataManagementIk._(_root);
	@override late final _TranslationsSettingsVersionIk version = _TranslationsSettingsVersionIk._(_root);
}

// Path: recipes
class _TranslationsRecipesIk extends TranslationsRecipesEn {
	_TranslationsRecipesIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIk._(TranslationsIk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIk nutrition = _TranslationsRecipeDetailNutritionIk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIk prepAhead = _TranslationsRecipeDetailPrepAheadIk._(_root);
...
// Path: filters
class _TranslationsFiltersIk extends TranslationsFiltersEn {
	_TranslationsFiltersIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIk extends TranslationsShoppingListEn {
	_TranslationsShoppingListIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIk extends TranslationsMealPlanEn {
	_TranslationsMealPlanIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIk extends TranslationsInventoryEn {
	_TranslationsInventoryIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIk extends TranslationsUpgradeEn {
	_TranslationsUpgradeIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIk extends TranslationsTourEn {
	_TranslationsTourIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIk extends TranslationsErrorsEn {
	_TranslationsErrorsIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIk._(TranslationsIk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIk metric = _TranslationsSettingsMeasurementsMetricIk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIk imperial = _TranslationsSettingsMeasurementsImperialIk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIk._(TranslationsIk root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ik>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsIk {
