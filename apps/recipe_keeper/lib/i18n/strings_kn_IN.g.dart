...
class TranslationsKnIn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppKnIn app = _TranslationsAppKnIn._(_root);
	@override late final _TranslationsHomeKnIn home = _TranslationsHomeKnIn._(_root);
	@override late final _TranslationsCommonKnIn common = _TranslationsCommonKnIn._(_root);
	@override late final _TranslationsSettingsKnIn settings = _TranslationsSettingsKnIn._(_root);
	@override late final _TranslationsRecipesKnIn recipes = _TranslationsRecipesKnIn._(_root);
	@override late final _TranslationsRecipeDetailKnIn recipeDetail = _TranslationsRecipeDetailKnIn._(_root);
	@override late final _TranslationsFiltersKnIn filters = _TranslationsFiltersKnIn._(_root);
	@override late final _TranslationsShoppingListKnIn shoppingList = _TranslationsShoppingListKnIn._(_root);
	@override late final _TranslationsMealPlanKnIn mealPlan = _TranslationsMealPlanKnIn._(_root);
	@override late final _TranslationsInventoryKnIn inventory = _TranslationsInventoryKnIn._(_root);
	@override late final _TranslationsBarcodeScanKnIn barcodeScan = _TranslationsBarcodeScanKnIn._(_root);
	@override late final _TranslationsReceiptScanKnIn receiptScan = _TranslationsReceiptScanKnIn._(_root);
	@override late final _TranslationsBatchCookingKnIn batchCooking = _TranslationsBatchCookingKnIn._(_root);
	@override late final _TranslationsVisitedDomainsKnIn visitedDomains = _TranslationsVisitedDomainsKnIn._(_root);
	@override late final _TranslationsDomainDiscoveryKnIn domainDiscovery = _TranslationsDomainDiscoveryKnIn._(_root);
	@override late final _TranslationsInventorySuggestionsKnIn inventorySuggestions = _TranslationsInventorySuggestionsKnIn._(_root);
	@override late final _TranslationsUpgradeKnIn upgrade = _TranslationsUpgradeKnIn._(_root);
	@override late final _TranslationsTourKnIn tour = _TranslationsTourKnIn._(_root);
	@override late final _TranslationsManualRecipeKnIn manualRecipe = _TranslationsManualRecipeKnIn._(_root);
	@override late final _TranslationsRecipeEditKnIn recipeEdit = _TranslationsRecipeEditKnIn._(_root);
	@override late final _TranslationsErrorsKnIn errors = _TranslationsErrorsKnIn._(_root);
}

// Path: app
class _TranslationsAppKnIn extends TranslationsAppEn {
	_TranslationsAppKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);

	final TranslationsKnIn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKnIn extends TranslationsHomeEn {
	_TranslationsHomeKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKnIn extends TranslationsCommonEn {
	_TranslationsCommonKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKnIn extends TranslationsSettingsEn {
	_TranslationsSettingsKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);

	final TranslationsKnIn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKnIn measurements = _TranslationsSettingsMeasurementsKnIn._(_root);
	@override late final _TranslationsSettingsDataManagementKnIn dataManagement = _TranslationsSettingsDataManagementKnIn._(_root);
	@override late final _TranslationsSettingsVersionKnIn version = _TranslationsSettingsVersionKnIn._(_root);
}

// Path: recipes
class _TranslationsRecipesKnIn extends TranslationsRecipesEn {
	_TranslationsRecipesKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKnIn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKnIn nutrition = _TranslationsRecipeDetailNutritionKnIn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKnIn prepAhead = _TranslationsRecipeDetailPrepAheadKnIn._(_root);
...
// Path: filters
class _TranslationsFiltersKnIn extends TranslationsFiltersEn {
	_TranslationsFiltersKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKnIn extends TranslationsShoppingListEn {
	_TranslationsShoppingListKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKnIn extends TranslationsMealPlanEn {
	_TranslationsMealPlanKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKnIn extends TranslationsInventoryEn {
	_TranslationsInventoryKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKnIn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKnIn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKnIn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKnIn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKnIn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKnIn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKnIn extends TranslationsUpgradeEn {
	_TranslationsUpgradeKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKnIn extends TranslationsTourEn {
	_TranslationsTourKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKnIn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKnIn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKnIn extends TranslationsErrorsEn {
	_TranslationsErrorsKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKnIn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKnIn metric = _TranslationsSettingsMeasurementsMetricKnIn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKnIn imperial = _TranslationsSettingsMeasurementsImperialKnIn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKnIn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKnIn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKnIn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKnIn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKnIn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKnIn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKnIn._(TranslationsKnIn root) : this._root = root, super.internal(root);
