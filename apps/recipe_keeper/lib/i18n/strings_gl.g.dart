...
class TranslationsGl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppGl app = _TranslationsAppGl._(_root);
	@override late final _TranslationsHomeGl home = _TranslationsHomeGl._(_root);
	@override late final _TranslationsCommonGl common = _TranslationsCommonGl._(_root);
	@override late final _TranslationsSettingsGl settings = _TranslationsSettingsGl._(_root);
	@override late final _TranslationsRecipesGl recipes = _TranslationsRecipesGl._(_root);
	@override late final _TranslationsRecipeDetailGl recipeDetail = _TranslationsRecipeDetailGl._(_root);
	@override late final _TranslationsFiltersGl filters = _TranslationsFiltersGl._(_root);
	@override late final _TranslationsShoppingListGl shoppingList = _TranslationsShoppingListGl._(_root);
	@override late final _TranslationsMealPlanGl mealPlan = _TranslationsMealPlanGl._(_root);
	@override late final _TranslationsInventoryGl inventory = _TranslationsInventoryGl._(_root);
	@override late final _TranslationsBarcodeScanGl barcodeScan = _TranslationsBarcodeScanGl._(_root);
	@override late final _TranslationsReceiptScanGl receiptScan = _TranslationsReceiptScanGl._(_root);
	@override late final _TranslationsBatchCookingGl batchCooking = _TranslationsBatchCookingGl._(_root);
	@override late final _TranslationsVisitedDomainsGl visitedDomains = _TranslationsVisitedDomainsGl._(_root);
	@override late final _TranslationsDomainDiscoveryGl domainDiscovery = _TranslationsDomainDiscoveryGl._(_root);
	@override late final _TranslationsInventorySuggestionsGl inventorySuggestions = _TranslationsInventorySuggestionsGl._(_root);
	@override late final _TranslationsUpgradeGl upgrade = _TranslationsUpgradeGl._(_root);
	@override late final _TranslationsTourGl tour = _TranslationsTourGl._(_root);
	@override late final _TranslationsManualRecipeGl manualRecipe = _TranslationsManualRecipeGl._(_root);
	@override late final _TranslationsRecipeEditGl recipeEdit = _TranslationsRecipeEditGl._(_root);
	@override late final _TranslationsErrorsGl errors = _TranslationsErrorsGl._(_root);
}

// Path: app
class _TranslationsAppGl extends TranslationsAppEn {
	_TranslationsAppGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeGl extends TranslationsHomeEn {
	_TranslationsHomeGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonGl extends TranslationsCommonEn {
	_TranslationsCommonGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsGl extends TranslationsSettingsEn {
	_TranslationsSettingsGl._(TranslationsGl root) : this._root = root, super.internal(root);

	final TranslationsGl _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsGl measurements = _TranslationsSettingsMeasurementsGl._(_root);
	@override late final _TranslationsSettingsDataManagementGl dataManagement = _TranslationsSettingsDataManagementGl._(_root);
	@override late final _TranslationsSettingsVersionGl version = _TranslationsSettingsVersionGl._(_root);
}

// Path: recipes
class _TranslationsRecipesGl extends TranslationsRecipesEn {
	_TranslationsRecipesGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGl._(TranslationsGl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGl nutrition = _TranslationsRecipeDetailNutritionGl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGl prepAhead = _TranslationsRecipeDetailPrepAheadGl._(_root);
...
// Path: filters
class _TranslationsFiltersGl extends TranslationsFiltersEn {
	_TranslationsFiltersGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGl extends TranslationsShoppingListEn {
	_TranslationsShoppingListGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGl extends TranslationsMealPlanEn {
	_TranslationsMealPlanGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGl extends TranslationsInventoryEn {
	_TranslationsInventoryGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGl extends TranslationsUpgradeEn {
	_TranslationsUpgradeGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGl extends TranslationsTourEn {
	_TranslationsTourGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsGl extends TranslationsErrorsEn {
	_TranslationsErrorsGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGl._(TranslationsGl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGl metric = _TranslationsSettingsMeasurementsMetricGl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGl imperial = _TranslationsSettingsMeasurementsImperialGl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGl._(TranslationsGl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGl._(TranslationsGl root) : this._root = root, super.internal(root);
