...
class TranslationsKn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesKn recipes = _TranslationsRecipesKn._(_root);
	@override late final _TranslationsRecipeDetailKn recipeDetail = _TranslationsRecipeDetailKn._(_root);
	@override late final _TranslationsFiltersKn filters = _TranslationsFiltersKn._(_root);
	@override late final _TranslationsShoppingListKn shoppingList = _TranslationsShoppingListKn._(_root);
	@override late final _TranslationsMealPlanKn mealPlan = _TranslationsMealPlanKn._(_root);
	@override late final _TranslationsInventoryKn inventory = _TranslationsInventoryKn._(_root);
	@override late final _TranslationsBarcodeScanKn barcodeScan = _TranslationsBarcodeScanKn._(_root);
	@override late final _TranslationsReceiptScanKn receiptScan = _TranslationsReceiptScanKn._(_root);
	@override late final _TranslationsBatchCookingKn batchCooking = _TranslationsBatchCookingKn._(_root);
	@override late final _TranslationsVisitedDomainsKn visitedDomains = _TranslationsVisitedDomainsKn._(_root);
	@override late final _TranslationsDomainDiscoveryKn domainDiscovery = _TranslationsDomainDiscoveryKn._(_root);
	@override late final _TranslationsInventorySuggestionsKn inventorySuggestions = _TranslationsInventorySuggestionsKn._(_root);
	@override late final _TranslationsUpgradeKn upgrade = _TranslationsUpgradeKn._(_root);
	@override late final _TranslationsTourKn tour = _TranslationsTourKn._(_root);
	@override late final _TranslationsManualRecipeKn manualRecipe = _TranslationsManualRecipeKn._(_root);
	@override late final _TranslationsRecipeEditKn recipeEdit = _TranslationsRecipeEditKn._(_root);
...
class _TranslationsSettingsKn extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsKn measurements = _TranslationsSettingsMeasurementsKn._(_root);
	@override late final _TranslationsSettingsDataManagementKn dataManagement = _TranslationsSettingsDataManagementKn._(_root);
	@override late final _TranslationsSettingsVersionKn version = _TranslationsSettingsVersionKn._(_root);
}

// Path: recipes
class _TranslationsRecipesKn extends TranslationsRecipesEn {
	_TranslationsRecipesKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKn._(TranslationsKn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKn nutrition = _TranslationsRecipeDetailNutritionKn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKn prepAhead = _TranslationsRecipeDetailPrepAheadKn._(_root);
...
// Path: filters
class _TranslationsFiltersKn extends TranslationsFiltersEn {
	_TranslationsFiltersKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKn extends TranslationsShoppingListEn {
	_TranslationsShoppingListKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKn extends TranslationsMealPlanEn {
	_TranslationsMealPlanKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKn extends TranslationsInventoryEn {
	_TranslationsInventoryKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKn extends TranslationsUpgradeEn {
	_TranslationsUpgradeKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKn extends TranslationsTourEn {
	_TranslationsTourKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKn extends TranslationsErrorsEn {
	_TranslationsErrorsKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKn._(TranslationsKn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKn metric = _TranslationsSettingsMeasurementsMetricKn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKn imperial = _TranslationsSettingsMeasurementsImperialKn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKn._(TranslationsKn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKn._(TranslationsKn root) : this._root = root, super.internal(root);
