...
// Path: <root>
class TranslationsNv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsNv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <nv>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsNv _root = this; // ignore: unused_field

	@override 
	TranslationsNv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsNv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppNv app = _TranslationsAppNv._(_root);
	@override late final _TranslationsHomeNv home = _TranslationsHomeNv._(_root);
	@override late final _TranslationsCommonNv common = _TranslationsCommonNv._(_root);
	@override late final _TranslationsSettingsNv settings = _TranslationsSettingsNv._(_root);
	@override late final _TranslationsRecipesNv recipes = _TranslationsRecipesNv._(_root);
	@override late final _TranslationsRecipeDetailNv recipeDetail = _TranslationsRecipeDetailNv._(_root);
	@override late final _TranslationsFiltersNv filters = _TranslationsFiltersNv._(_root);
	@override late final _TranslationsShoppingListNv shoppingList = _TranslationsShoppingListNv._(_root);
	@override late final _TranslationsMealPlanNv mealPlan = _TranslationsMealPlanNv._(_root);
	@override late final _TranslationsInventoryNv inventory = _TranslationsInventoryNv._(_root);
	@override late final _TranslationsBarcodeScanNv barcodeScan = _TranslationsBarcodeScanNv._(_root);
	@override late final _TranslationsReceiptScanNv receiptScan = _TranslationsReceiptScanNv._(_root);
	@override late final _TranslationsBatchCookingNv batchCooking = _TranslationsBatchCookingNv._(_root);
	@override late final _TranslationsVisitedDomainsNv visitedDomains = _TranslationsVisitedDomainsNv._(_root);
	@override late final _TranslationsDomainDiscoveryNv domainDiscovery = _TranslationsDomainDiscoveryNv._(_root);
	@override late final _TranslationsInventorySuggestionsNv inventorySuggestions = _TranslationsInventorySuggestionsNv._(_root);
	@override late final _TranslationsUpgradeNv upgrade = _TranslationsUpgradeNv._(_root);
	@override late final _TranslationsTourNv tour = _TranslationsTourNv._(_root);
	@override late final _TranslationsManualRecipeNv manualRecipe = _TranslationsManualRecipeNv._(_root);
	@override late final _TranslationsRecipeEditNv recipeEdit = _TranslationsRecipeEditNv._(_root);
	@override late final _TranslationsErrorsNv errors = _TranslationsErrorsNv._(_root);
}

// Path: app
class _TranslationsAppNv extends TranslationsAppEn {
	_TranslationsAppNv._(TranslationsNv root) : this._root = root, super.internal(root);

	final TranslationsNv _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeNv extends TranslationsHomeEn {
	_TranslationsHomeNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonNv extends TranslationsCommonEn {
	_TranslationsCommonNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsNv extends TranslationsSettingsEn {
	_TranslationsSettingsNv._(TranslationsNv root) : this._root = root, super.internal(root);

	final TranslationsNv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsNv measurements = _TranslationsSettingsMeasurementsNv._(_root);
	@override late final _TranslationsSettingsDataManagementNv dataManagement = _TranslationsSettingsDataManagementNv._(_root);
	@override late final _TranslationsSettingsVersionNv version = _TranslationsSettingsVersionNv._(_root);
}

// Path: recipes
class _TranslationsRecipesNv extends TranslationsRecipesEn {
	_TranslationsRecipesNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNv._(TranslationsNv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNv nutrition = _TranslationsRecipeDetailNutritionNv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNv prepAhead = _TranslationsRecipeDetailPrepAheadNv._(_root);
...
// Path: filters
class _TranslationsFiltersNv extends TranslationsFiltersEn {
	_TranslationsFiltersNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNv extends TranslationsShoppingListEn {
	_TranslationsShoppingListNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNv extends TranslationsMealPlanEn {
	_TranslationsMealPlanNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNv extends TranslationsInventoryEn {
	_TranslationsInventoryNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNv extends TranslationsUpgradeEn {
	_TranslationsUpgradeNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNv extends TranslationsTourEn {
	_TranslationsTourNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsNv extends TranslationsErrorsEn {
	_TranslationsErrorsNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNv._(TranslationsNv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNv metric = _TranslationsSettingsMeasurementsMetricNv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNv imperial = _TranslationsSettingsMeasurementsImperialNv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNv._(TranslationsNv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <nv>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsNv {
