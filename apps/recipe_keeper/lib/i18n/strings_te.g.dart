...
class TranslationsTe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesTe recipes = _TranslationsRecipesTe._(_root);
	@override late final _TranslationsRecipeDetailTe recipeDetail = _TranslationsRecipeDetailTe._(_root);
	@override late final _TranslationsFiltersTe filters = _TranslationsFiltersTe._(_root);
	@override late final _TranslationsShoppingListTe shoppingList = _TranslationsShoppingListTe._(_root);
	@override late final _TranslationsMealPlanTe mealPlan = _TranslationsMealPlanTe._(_root);
	@override late final _TranslationsInventoryTe inventory = _TranslationsInventoryTe._(_root);
	@override late final _TranslationsBarcodeScanTe barcodeScan = _TranslationsBarcodeScanTe._(_root);
	@override late final _TranslationsReceiptScanTe receiptScan = _TranslationsReceiptScanTe._(_root);
	@override late final _TranslationsBatchCookingTe batchCooking = _TranslationsBatchCookingTe._(_root);
	@override late final _TranslationsVisitedDomainsTe visitedDomains = _TranslationsVisitedDomainsTe._(_root);
	@override late final _TranslationsDomainDiscoveryTe domainDiscovery = _TranslationsDomainDiscoveryTe._(_root);
	@override late final _TranslationsInventorySuggestionsTe inventorySuggestions = _TranslationsInventorySuggestionsTe._(_root);
	@override late final _TranslationsUpgradeTe upgrade = _TranslationsUpgradeTe._(_root);
	@override late final _TranslationsTourTe tour = _TranslationsTourTe._(_root);
	@override late final _TranslationsManualRecipeTe manualRecipe = _TranslationsManualRecipeTe._(_root);
	@override late final _TranslationsRecipeEditTe recipeEdit = _TranslationsRecipeEditTe._(_root);
...
class _TranslationsSettingsTe extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsTe measurements = _TranslationsSettingsMeasurementsTe._(_root);
	@override late final _TranslationsSettingsDataManagementTe dataManagement = _TranslationsSettingsDataManagementTe._(_root);
	@override late final _TranslationsSettingsVersionTe version = _TranslationsSettingsVersionTe._(_root);
}

// Path: recipes
class _TranslationsRecipesTe extends TranslationsRecipesEn {
	_TranslationsRecipesTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTe._(TranslationsTe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTe nutrition = _TranslationsRecipeDetailNutritionTe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTe prepAhead = _TranslationsRecipeDetailPrepAheadTe._(_root);
...
// Path: filters
class _TranslationsFiltersTe extends TranslationsFiltersEn {
	_TranslationsFiltersTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTe extends TranslationsShoppingListEn {
	_TranslationsShoppingListTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTe extends TranslationsMealPlanEn {
	_TranslationsMealPlanTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTe extends TranslationsInventoryEn {
	_TranslationsInventoryTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTe extends TranslationsUpgradeEn {
	_TranslationsUpgradeTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTe extends TranslationsTourEn {
	_TranslationsTourTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTe._(TranslationsTe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTe metric = _TranslationsSettingsMeasurementsMetricTe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTe imperial = _TranslationsSettingsMeasurementsImperialTe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTe._(TranslationsTe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTe._(TranslationsTe root) : this._root = root, super.internal(root);
