...
// Path: <root>
class TranslationsMi extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <mi>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMi _root = this; // ignore: unused_field

	@override 
	TranslationsMi $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMi(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMi app = _TranslationsAppMi._(_root);
	@override late final _TranslationsHomeMi home = _TranslationsHomeMi._(_root);
	@override late final _TranslationsCommonMi common = _TranslationsCommonMi._(_root);
	@override late final _TranslationsSettingsMi settings = _TranslationsSettingsMi._(_root);
	@override late final _TranslationsRecipesMi recipes = _TranslationsRecipesMi._(_root);
	@override late final _TranslationsRecipeDetailMi recipeDetail = _TranslationsRecipeDetailMi._(_root);
	@override late final _TranslationsFiltersMi filters = _TranslationsFiltersMi._(_root);
	@override late final _TranslationsShoppingListMi shoppingList = _TranslationsShoppingListMi._(_root);
	@override late final _TranslationsMealPlanMi mealPlan = _TranslationsMealPlanMi._(_root);
	@override late final _TranslationsInventoryMi inventory = _TranslationsInventoryMi._(_root);
	@override late final _TranslationsBarcodeScanMi barcodeScan = _TranslationsBarcodeScanMi._(_root);
	@override late final _TranslationsReceiptScanMi receiptScan = _TranslationsReceiptScanMi._(_root);
	@override late final _TranslationsBatchCookingMi batchCooking = _TranslationsBatchCookingMi._(_root);
	@override late final _TranslationsVisitedDomainsMi visitedDomains = _TranslationsVisitedDomainsMi._(_root);
	@override late final _TranslationsDomainDiscoveryMi domainDiscovery = _TranslationsDomainDiscoveryMi._(_root);
	@override late final _TranslationsInventorySuggestionsMi inventorySuggestions = _TranslationsInventorySuggestionsMi._(_root);
	@override late final _TranslationsUpgradeMi upgrade = _TranslationsUpgradeMi._(_root);
	@override late final _TranslationsTourMi tour = _TranslationsTourMi._(_root);
	@override late final _TranslationsManualRecipeMi manualRecipe = _TranslationsManualRecipeMi._(_root);
	@override late final _TranslationsRecipeEditMi recipeEdit = _TranslationsRecipeEditMi._(_root);
	@override late final _TranslationsErrorsMi errors = _TranslationsErrorsMi._(_root);
}

// Path: app
class _TranslationsAppMi extends TranslationsAppEn {
	_TranslationsAppMi._(TranslationsMi root) : this._root = root, super.internal(root);

	final TranslationsMi _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMi extends TranslationsHomeEn {
	_TranslationsHomeMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMi extends TranslationsCommonEn {
	_TranslationsCommonMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMi extends TranslationsSettingsEn {
	_TranslationsSettingsMi._(TranslationsMi root) : this._root = root, super.internal(root);

	final TranslationsMi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMi measurements = _TranslationsSettingsMeasurementsMi._(_root);
	@override late final _TranslationsSettingsDataManagementMi dataManagement = _TranslationsSettingsDataManagementMi._(_root);
	@override late final _TranslationsSettingsVersionMi version = _TranslationsSettingsVersionMi._(_root);
}

// Path: recipes
class _TranslationsRecipesMi extends TranslationsRecipesEn {
	_TranslationsRecipesMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMi._(TranslationsMi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMi nutrition = _TranslationsRecipeDetailNutritionMi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMi prepAhead = _TranslationsRecipeDetailPrepAheadMi._(_root);
...
// Path: filters
class _TranslationsFiltersMi extends TranslationsFiltersEn {
	_TranslationsFiltersMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMi extends TranslationsShoppingListEn {
	_TranslationsShoppingListMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMi extends TranslationsMealPlanEn {
	_TranslationsMealPlanMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMi extends TranslationsInventoryEn {
	_TranslationsInventoryMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMi extends TranslationsUpgradeEn {
	_TranslationsUpgradeMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMi extends TranslationsTourEn {
	_TranslationsTourMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMi extends TranslationsErrorsEn {
	_TranslationsErrorsMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMi._(TranslationsMi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMi metric = _TranslationsSettingsMeasurementsMetricMi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMi imperial = _TranslationsSettingsMeasurementsImperialMi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMi._(TranslationsMi root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <mi>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMi {
