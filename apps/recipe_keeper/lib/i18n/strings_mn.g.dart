...
class TranslationsMn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppMn app = _TranslationsAppMn._(_root);
	@override late final _TranslationsHomeMn home = _TranslationsHomeMn._(_root);
	@override late final _TranslationsCommonMn common = _TranslationsCommonMn._(_root);
	@override late final _TranslationsSettingsMn settings = _TranslationsSettingsMn._(_root);
	@override late final _TranslationsRecipesMn recipes = _TranslationsRecipesMn._(_root);
	@override late final _TranslationsRecipeDetailMn recipeDetail = _TranslationsRecipeDetailMn._(_root);
	@override late final _TranslationsFiltersMn filters = _TranslationsFiltersMn._(_root);
	@override late final _TranslationsShoppingListMn shoppingList = _TranslationsShoppingListMn._(_root);
	@override late final _TranslationsMealPlanMn mealPlan = _TranslationsMealPlanMn._(_root);
	@override late final _TranslationsInventoryMn inventory = _TranslationsInventoryMn._(_root);
	@override late final _TranslationsBarcodeScanMn barcodeScan = _TranslationsBarcodeScanMn._(_root);
	@override late final _TranslationsReceiptScanMn receiptScan = _TranslationsReceiptScanMn._(_root);
	@override late final _TranslationsBatchCookingMn batchCooking = _TranslationsBatchCookingMn._(_root);
	@override late final _TranslationsVisitedDomainsMn visitedDomains = _TranslationsVisitedDomainsMn._(_root);
	@override late final _TranslationsDomainDiscoveryMn domainDiscovery = _TranslationsDomainDiscoveryMn._(_root);
	@override late final _TranslationsInventorySuggestionsMn inventorySuggestions = _TranslationsInventorySuggestionsMn._(_root);
	@override late final _TranslationsUpgradeMn upgrade = _TranslationsUpgradeMn._(_root);
	@override late final _TranslationsTourMn tour = _TranslationsTourMn._(_root);
	@override late final _TranslationsManualRecipeMn manualRecipe = _TranslationsManualRecipeMn._(_root);
	@override late final _TranslationsRecipeEditMn recipeEdit = _TranslationsRecipeEditMn._(_root);
	@override late final _TranslationsErrorsMn errors = _TranslationsErrorsMn._(_root);
}

// Path: app
class _TranslationsAppMn extends TranslationsAppEn {
	_TranslationsAppMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeMn extends TranslationsHomeEn {
	_TranslationsHomeMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMn extends TranslationsCommonEn {
	_TranslationsCommonMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMn extends TranslationsSettingsEn {
	_TranslationsSettingsMn._(TranslationsMn root) : this._root = root, super.internal(root);

	final TranslationsMn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMn measurements = _TranslationsSettingsMeasurementsMn._(_root);
	@override late final _TranslationsSettingsDataManagementMn dataManagement = _TranslationsSettingsDataManagementMn._(_root);
	@override late final _TranslationsSettingsVersionMn version = _TranslationsSettingsVersionMn._(_root);
}

// Path: recipes
class _TranslationsRecipesMn extends TranslationsRecipesEn {
	_TranslationsRecipesMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMn._(TranslationsMn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMn nutrition = _TranslationsRecipeDetailNutritionMn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMn prepAhead = _TranslationsRecipeDetailPrepAheadMn._(_root);
...
// Path: filters
class _TranslationsFiltersMn extends TranslationsFiltersEn {
	_TranslationsFiltersMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMn extends TranslationsShoppingListEn {
	_TranslationsShoppingListMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMn extends TranslationsMealPlanEn {
	_TranslationsMealPlanMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMn extends TranslationsInventoryEn {
	_TranslationsInventoryMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMn extends TranslationsUpgradeEn {
	_TranslationsUpgradeMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMn extends TranslationsTourEn {
	_TranslationsTourMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMn._(TranslationsMn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMn metric = _TranslationsSettingsMeasurementsMetricMn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMn imperial = _TranslationsSettingsMeasurementsImperialMn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMn._(TranslationsMn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMn._(TranslationsMn root) : this._root = root, super.internal(root);
