...
// Path: <root>
class TranslationsKr extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKr({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	@override 
	TranslationsKr $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKr(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKr app = _TranslationsAppKr._(_root);
	@override late final _TranslationsHomeKr home = _TranslationsHomeKr._(_root);
	@override late final _TranslationsCommonKr common = _TranslationsCommonKr._(_root);
	@override late final _TranslationsSettingsKr settings = _TranslationsSettingsKr._(_root);
	@override late final _TranslationsRecipesKr recipes = _TranslationsRecipesKr._(_root);
	@override late final _TranslationsRecipeDetailKr recipeDetail = _TranslationsRecipeDetailKr._(_root);
	@override late final _TranslationsFiltersKr filters = _TranslationsFiltersKr._(_root);
	@override late final _TranslationsShoppingListKr shoppingList = _TranslationsShoppingListKr._(_root);
	@override late final _TranslationsMealPlanKr mealPlan = _TranslationsMealPlanKr._(_root);
	@override late final _TranslationsInventoryKr inventory = _TranslationsInventoryKr._(_root);
	@override late final _TranslationsBarcodeScanKr barcodeScan = _TranslationsBarcodeScanKr._(_root);
	@override late final _TranslationsReceiptScanKr receiptScan = _TranslationsReceiptScanKr._(_root);
	@override late final _TranslationsBatchCookingKr batchCooking = _TranslationsBatchCookingKr._(_root);
	@override late final _TranslationsVisitedDomainsKr visitedDomains = _TranslationsVisitedDomainsKr._(_root);
	@override late final _TranslationsDomainDiscoveryKr domainDiscovery = _TranslationsDomainDiscoveryKr._(_root);
	@override late final _TranslationsInventorySuggestionsKr inventorySuggestions = _TranslationsInventorySuggestionsKr._(_root);
	@override late final _TranslationsUpgradeKr upgrade = _TranslationsUpgradeKr._(_root);
	@override late final _TranslationsTourKr tour = _TranslationsTourKr._(_root);
	@override late final _TranslationsManualRecipeKr manualRecipe = _TranslationsManualRecipeKr._(_root);
	@override late final _TranslationsRecipeEditKr recipeEdit = _TranslationsRecipeEditKr._(_root);
	@override late final _TranslationsErrorsKr errors = _TranslationsErrorsKr._(_root);
}

// Path: app
class _TranslationsAppKr extends TranslationsAppEn {
	_TranslationsAppKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeKr extends TranslationsHomeEn {
	_TranslationsHomeKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKr extends TranslationsCommonEn {
	_TranslationsCommonKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKr extends TranslationsSettingsEn {
	_TranslationsSettingsKr._(TranslationsKr root) : this._root = root, super.internal(root);

	final TranslationsKr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKr measurements = _TranslationsSettingsMeasurementsKr._(_root);
	@override late final _TranslationsSettingsDataManagementKr dataManagement = _TranslationsSettingsDataManagementKr._(_root);
	@override late final _TranslationsSettingsVersionKr version = _TranslationsSettingsVersionKr._(_root);
}

// Path: recipes
class _TranslationsRecipesKr extends TranslationsRecipesEn {
	_TranslationsRecipesKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKr._(TranslationsKr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKr nutrition = _TranslationsRecipeDetailNutritionKr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKr prepAhead = _TranslationsRecipeDetailPrepAheadKr._(_root);
...
// Path: filters
class _TranslationsFiltersKr extends TranslationsFiltersEn {
	_TranslationsFiltersKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKr extends TranslationsShoppingListEn {
	_TranslationsShoppingListKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKr extends TranslationsMealPlanEn {
	_TranslationsMealPlanKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKr extends TranslationsInventoryEn {
	_TranslationsInventoryKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKr extends TranslationsUpgradeEn {
	_TranslationsUpgradeKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKr extends TranslationsTourEn {
	_TranslationsTourKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKr extends TranslationsErrorsEn {
	_TranslationsErrorsKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKr._(TranslationsKr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKr metric = _TranslationsSettingsMeasurementsMetricKr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKr imperial = _TranslationsSettingsMeasurementsImperialKr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKr._(TranslationsKr root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kr>.
