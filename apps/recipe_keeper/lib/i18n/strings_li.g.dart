...
// Path: <root>
class TranslationsLi extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLi({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <li>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsLi _root = this; // ignore: unused_field

	@override 
	TranslationsLi $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLi(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLi app = _TranslationsAppLi._(_root);
	@override late final _TranslationsHomeLi home = _TranslationsHomeLi._(_root);
	@override late final _TranslationsCommonLi common = _TranslationsCommonLi._(_root);
	@override late final _TranslationsSettingsLi settings = _TranslationsSettingsLi._(_root);
	@override late final _TranslationsRecipesLi recipes = _TranslationsRecipesLi._(_root);
	@override late final _TranslationsRecipeDetailLi recipeDetail = _TranslationsRecipeDetailLi._(_root);
	@override late final _TranslationsFiltersLi filters = _TranslationsFiltersLi._(_root);
	@override late final _TranslationsShoppingListLi shoppingList = _TranslationsShoppingListLi._(_root);
	@override late final _TranslationsMealPlanLi mealPlan = _TranslationsMealPlanLi._(_root);
	@override late final _TranslationsInventoryLi inventory = _TranslationsInventoryLi._(_root);
	@override late final _TranslationsBarcodeScanLi barcodeScan = _TranslationsBarcodeScanLi._(_root);
	@override late final _TranslationsReceiptScanLi receiptScan = _TranslationsReceiptScanLi._(_root);
	@override late final _TranslationsBatchCookingLi batchCooking = _TranslationsBatchCookingLi._(_root);
	@override late final _TranslationsVisitedDomainsLi visitedDomains = _TranslationsVisitedDomainsLi._(_root);
	@override late final _TranslationsDomainDiscoveryLi domainDiscovery = _TranslationsDomainDiscoveryLi._(_root);
	@override late final _TranslationsInventorySuggestionsLi inventorySuggestions = _TranslationsInventorySuggestionsLi._(_root);
	@override late final _TranslationsUpgradeLi upgrade = _TranslationsUpgradeLi._(_root);
	@override late final _TranslationsTourLi tour = _TranslationsTourLi._(_root);
	@override late final _TranslationsManualRecipeLi manualRecipe = _TranslationsManualRecipeLi._(_root);
	@override late final _TranslationsRecipeEditLi recipeEdit = _TranslationsRecipeEditLi._(_root);
	@override late final _TranslationsErrorsLi errors = _TranslationsErrorsLi._(_root);
}

// Path: app
class _TranslationsAppLi extends TranslationsAppEn {
	_TranslationsAppLi._(TranslationsLi root) : this._root = root, super.internal(root);

	final TranslationsLi _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeLi extends TranslationsHomeEn {
	_TranslationsHomeLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLi extends TranslationsCommonEn {
	_TranslationsCommonLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLi extends TranslationsSettingsEn {
	_TranslationsSettingsLi._(TranslationsLi root) : this._root = root, super.internal(root);

	final TranslationsLi _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLi measurements = _TranslationsSettingsMeasurementsLi._(_root);
	@override late final _TranslationsSettingsDataManagementLi dataManagement = _TranslationsSettingsDataManagementLi._(_root);
	@override late final _TranslationsSettingsVersionLi version = _TranslationsSettingsVersionLi._(_root);
}

// Path: recipes
class _TranslationsRecipesLi extends TranslationsRecipesEn {
	_TranslationsRecipesLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLi._(TranslationsLi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLi nutrition = _TranslationsRecipeDetailNutritionLi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLi prepAhead = _TranslationsRecipeDetailPrepAheadLi._(_root);
...
// Path: filters
class _TranslationsFiltersLi extends TranslationsFiltersEn {
	_TranslationsFiltersLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLi extends TranslationsShoppingListEn {
	_TranslationsShoppingListLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLi extends TranslationsMealPlanEn {
	_TranslationsMealPlanLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLi extends TranslationsInventoryEn {
	_TranslationsInventoryLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLi extends TranslationsUpgradeEn {
	_TranslationsUpgradeLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLi extends TranslationsTourEn {
	_TranslationsTourLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLi extends TranslationsErrorsEn {
	_TranslationsErrorsLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLi._(TranslationsLi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLi metric = _TranslationsSettingsMeasurementsMetricLi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLi imperial = _TranslationsSettingsMeasurementsImperialLi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLi._(TranslationsLi root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <li>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsLi {
