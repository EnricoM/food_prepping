...
// Path: <root>
class TranslationsSu extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSu({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <su>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSu _root = this; // ignore: unused_field

	@override 
	TranslationsSu $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSu(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSu app = _TranslationsAppSu._(_root);
	@override late final _TranslationsHomeSu home = _TranslationsHomeSu._(_root);
	@override late final _TranslationsCommonSu common = _TranslationsCommonSu._(_root);
	@override late final _TranslationsSettingsSu settings = _TranslationsSettingsSu._(_root);
	@override late final _TranslationsRecipesSu recipes = _TranslationsRecipesSu._(_root);
	@override late final _TranslationsRecipeDetailSu recipeDetail = _TranslationsRecipeDetailSu._(_root);
	@override late final _TranslationsFiltersSu filters = _TranslationsFiltersSu._(_root);
	@override late final _TranslationsShoppingListSu shoppingList = _TranslationsShoppingListSu._(_root);
	@override late final _TranslationsMealPlanSu mealPlan = _TranslationsMealPlanSu._(_root);
	@override late final _TranslationsInventorySu inventory = _TranslationsInventorySu._(_root);
	@override late final _TranslationsBarcodeScanSu barcodeScan = _TranslationsBarcodeScanSu._(_root);
	@override late final _TranslationsReceiptScanSu receiptScan = _TranslationsReceiptScanSu._(_root);
	@override late final _TranslationsBatchCookingSu batchCooking = _TranslationsBatchCookingSu._(_root);
	@override late final _TranslationsVisitedDomainsSu visitedDomains = _TranslationsVisitedDomainsSu._(_root);
	@override late final _TranslationsDomainDiscoverySu domainDiscovery = _TranslationsDomainDiscoverySu._(_root);
	@override late final _TranslationsInventorySuggestionsSu inventorySuggestions = _TranslationsInventorySuggestionsSu._(_root);
	@override late final _TranslationsUpgradeSu upgrade = _TranslationsUpgradeSu._(_root);
	@override late final _TranslationsTourSu tour = _TranslationsTourSu._(_root);
	@override late final _TranslationsManualRecipeSu manualRecipe = _TranslationsManualRecipeSu._(_root);
	@override late final _TranslationsRecipeEditSu recipeEdit = _TranslationsRecipeEditSu._(_root);
	@override late final _TranslationsErrorsSu errors = _TranslationsErrorsSu._(_root);
}

// Path: app
class _TranslationsAppSu extends TranslationsAppEn {
	_TranslationsAppSu._(TranslationsSu root) : this._root = root, super.internal(root);

	final TranslationsSu _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSu extends TranslationsHomeEn {
	_TranslationsHomeSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSu extends TranslationsCommonEn {
	_TranslationsCommonSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSu extends TranslationsSettingsEn {
	_TranslationsSettingsSu._(TranslationsSu root) : this._root = root, super.internal(root);

	final TranslationsSu _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSu measurements = _TranslationsSettingsMeasurementsSu._(_root);
	@override late final _TranslationsSettingsDataManagementSu dataManagement = _TranslationsSettingsDataManagementSu._(_root);
	@override late final _TranslationsSettingsVersionSu version = _TranslationsSettingsVersionSu._(_root);
}

// Path: recipes
class _TranslationsRecipesSu extends TranslationsRecipesEn {
	_TranslationsRecipesSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSu extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSu._(TranslationsSu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSu nutrition = _TranslationsRecipeDetailNutritionSu._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSu prepAhead = _TranslationsRecipeDetailPrepAheadSu._(_root);
...
// Path: filters
class _TranslationsFiltersSu extends TranslationsFiltersEn {
	_TranslationsFiltersSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSu extends TranslationsShoppingListEn {
	_TranslationsShoppingListSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSu extends TranslationsMealPlanEn {
	_TranslationsMealPlanSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySu extends TranslationsInventoryEn {
	_TranslationsInventorySu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSu extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSu extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSu extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSu extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySu extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSu extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSu extends TranslationsUpgradeEn {
	_TranslationsUpgradeSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSu extends TranslationsTourEn {
	_TranslationsTourSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSu extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSu extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSu extends TranslationsErrorsEn {
	_TranslationsErrorsSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSu extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSu._(TranslationsSu root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSu metric = _TranslationsSettingsMeasurementsMetricSu._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSu imperial = _TranslationsSettingsMeasurementsImperialSu._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSu extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSu extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSu extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSu extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSu extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSu extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSu._(TranslationsSu root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <su>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSu {
