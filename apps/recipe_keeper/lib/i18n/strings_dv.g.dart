...
// Path: <root>
class TranslationsDv extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsDv({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <dv>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsDv _root = this; // ignore: unused_field

	@override 
	TranslationsDv $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsDv(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppDv app = _TranslationsAppDv._(_root);
	@override late final _TranslationsHomeDv home = _TranslationsHomeDv._(_root);
	@override late final _TranslationsCommonDv common = _TranslationsCommonDv._(_root);
	@override late final _TranslationsSettingsDv settings = _TranslationsSettingsDv._(_root);
	@override late final _TranslationsRecipesDv recipes = _TranslationsRecipesDv._(_root);
	@override late final _TranslationsRecipeDetailDv recipeDetail = _TranslationsRecipeDetailDv._(_root);
	@override late final _TranslationsFiltersDv filters = _TranslationsFiltersDv._(_root);
	@override late final _TranslationsShoppingListDv shoppingList = _TranslationsShoppingListDv._(_root);
	@override late final _TranslationsMealPlanDv mealPlan = _TranslationsMealPlanDv._(_root);
	@override late final _TranslationsInventoryDv inventory = _TranslationsInventoryDv._(_root);
	@override late final _TranslationsBarcodeScanDv barcodeScan = _TranslationsBarcodeScanDv._(_root);
	@override late final _TranslationsReceiptScanDv receiptScan = _TranslationsReceiptScanDv._(_root);
	@override late final _TranslationsBatchCookingDv batchCooking = _TranslationsBatchCookingDv._(_root);
	@override late final _TranslationsVisitedDomainsDv visitedDomains = _TranslationsVisitedDomainsDv._(_root);
	@override late final _TranslationsDomainDiscoveryDv domainDiscovery = _TranslationsDomainDiscoveryDv._(_root);
	@override late final _TranslationsInventorySuggestionsDv inventorySuggestions = _TranslationsInventorySuggestionsDv._(_root);
	@override late final _TranslationsUpgradeDv upgrade = _TranslationsUpgradeDv._(_root);
	@override late final _TranslationsTourDv tour = _TranslationsTourDv._(_root);
	@override late final _TranslationsManualRecipeDv manualRecipe = _TranslationsManualRecipeDv._(_root);
	@override late final _TranslationsRecipeEditDv recipeEdit = _TranslationsRecipeEditDv._(_root);
	@override late final _TranslationsErrorsDv errors = _TranslationsErrorsDv._(_root);
}

// Path: app
class _TranslationsAppDv extends TranslationsAppEn {
	_TranslationsAppDv._(TranslationsDv root) : this._root = root, super.internal(root);

	final TranslationsDv _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeDv extends TranslationsHomeEn {
	_TranslationsHomeDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonDv extends TranslationsCommonEn {
	_TranslationsCommonDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsDv extends TranslationsSettingsEn {
	_TranslationsSettingsDv._(TranslationsDv root) : this._root = root, super.internal(root);

	final TranslationsDv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsDv measurements = _TranslationsSettingsMeasurementsDv._(_root);
	@override late final _TranslationsSettingsDataManagementDv dataManagement = _TranslationsSettingsDataManagementDv._(_root);
	@override late final _TranslationsSettingsVersionDv version = _TranslationsSettingsVersionDv._(_root);
}

// Path: recipes
class _TranslationsRecipesDv extends TranslationsRecipesEn {
	_TranslationsRecipesDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailDv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailDv._(TranslationsDv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionDv nutrition = _TranslationsRecipeDetailNutritionDv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadDv prepAhead = _TranslationsRecipeDetailPrepAheadDv._(_root);
...
// Path: filters
class _TranslationsFiltersDv extends TranslationsFiltersEn {
	_TranslationsFiltersDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListDv extends TranslationsShoppingListEn {
	_TranslationsShoppingListDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanDv extends TranslationsMealPlanEn {
	_TranslationsMealPlanDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryDv extends TranslationsInventoryEn {
	_TranslationsInventoryDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanDv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanDv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingDv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsDv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryDv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsDv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeDv extends TranslationsUpgradeEn {
	_TranslationsUpgradeDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourDv extends TranslationsTourEn {
	_TranslationsTourDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeDv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditDv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsDv extends TranslationsErrorsEn {
	_TranslationsErrorsDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsDv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsDv._(TranslationsDv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricDv metric = _TranslationsSettingsMeasurementsMetricDv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialDv imperial = _TranslationsSettingsMeasurementsImperialDv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementDv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionDv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionDv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadDv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricDv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialDv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialDv._(TranslationsDv root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <dv>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsDv {
