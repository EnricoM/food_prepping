...
class TranslationsNo extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppNo app = _TranslationsAppNo._(_root);
	...
	@override late final _TranslationsRecipesNo recipes = _TranslationsRecipesNo._(_root);
	@override late final _TranslationsRecipeDetailNo recipeDetail = _TranslationsRecipeDetailNo._(_root);
	@override late final _TranslationsFiltersNo filters = _TranslationsFiltersNo._(_root);
	@override late final _TranslationsShoppingListNo shoppingList = _TranslationsShoppingListNo._(_root);
	@override late final _TranslationsMealPlanNo mealPlan = _TranslationsMealPlanNo._(_root);
	@override late final _TranslationsInventoryNo inventory = _TranslationsInventoryNo._(_root);
	@override late final _TranslationsBarcodeScanNo barcodeScan = _TranslationsBarcodeScanNo._(_root);
	@override late final _TranslationsReceiptScanNo receiptScan = _TranslationsReceiptScanNo._(_root);
	@override late final _TranslationsBatchCookingNo batchCooking = _TranslationsBatchCookingNo._(_root);
	@override late final _TranslationsVisitedDomainsNo visitedDomains = _TranslationsVisitedDomainsNo._(_root);
	@override late final _TranslationsDomainDiscoveryNo domainDiscovery = _TranslationsDomainDiscoveryNo._(_root);
	@override late final _TranslationsInventorySuggestionsNo inventorySuggestions = _TranslationsInventorySuggestionsNo._(_root);
	@override late final _TranslationsUpgradeNo upgrade = _TranslationsUpgradeNo._(_root);
	@override late final _TranslationsTourNo tour = _TranslationsTourNo._(_root);
	@override late final _TranslationsManualRecipeNo manualRecipe = _TranslationsManualRecipeNo._(_root);
	@override late final _TranslationsRecipeEditNo recipeEdit = _TranslationsRecipeEditNo._(_root);
	@override late final _TranslationsErrorsNo errors = _TranslationsErrorsNo._(_root);
}

// Path: app
class _TranslationsAppNo extends TranslationsAppEn {
	_TranslationsAppNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsNo extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsNo measurements = _TranslationsSettingsMeasurementsNo._(_root);
	@override late final _TranslationsSettingsDataManagementNo dataManagement = _TranslationsSettingsDataManagementNo._(_root);
	@override late final _TranslationsSettingsVersionNo version = _TranslationsSettingsVersionNo._(_root);
}

// Path: recipes
class _TranslationsRecipesNo extends TranslationsRecipesEn {
	_TranslationsRecipesNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailNo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailNo._(TranslationsNo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionNo nutrition = _TranslationsRecipeDetailNutritionNo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadNo prepAhead = _TranslationsRecipeDetailPrepAheadNo._(_root);
...
// Path: filters
class _TranslationsFiltersNo extends TranslationsFiltersEn {
	_TranslationsFiltersNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListNo extends TranslationsShoppingListEn {
	_TranslationsShoppingListNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanNo extends TranslationsMealPlanEn {
	_TranslationsMealPlanNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryNo extends TranslationsInventoryEn {
	_TranslationsInventoryNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanNo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanNo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingNo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsNo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryNo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsNo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeNo extends TranslationsUpgradeEn {
	_TranslationsUpgradeNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourNo extends TranslationsTourEn {
	_TranslationsTourNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeNo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditNo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsNo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsNo._(TranslationsNo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricNo metric = _TranslationsSettingsMeasurementsMetricNo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialNo imperial = _TranslationsSettingsMeasurementsImperialNo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementNo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionNo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionNo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadNo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricNo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialNo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialNo._(TranslationsNo root) : this._root = root, super.internal(root);
