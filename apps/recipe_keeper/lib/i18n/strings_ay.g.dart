...
// Path: <root>
class TranslationsAy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsAy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ay>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsAy _root = this; // ignore: unused_field

	@override 
	TranslationsAy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsAy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppAy app = _TranslationsAppAy._(_root);
	@override late final _TranslationsHomeAy home = _TranslationsHomeAy._(_root);
	@override late final _TranslationsCommonAy common = _TranslationsCommonAy._(_root);
	@override late final _TranslationsSettingsAy settings = _TranslationsSettingsAy._(_root);
	@override late final _TranslationsRecipesAy recipes = _TranslationsRecipesAy._(_root);
	@override late final _TranslationsRecipeDetailAy recipeDetail = _TranslationsRecipeDetailAy._(_root);
	@override late final _TranslationsFiltersAy filters = _TranslationsFiltersAy._(_root);
	@override late final _TranslationsShoppingListAy shoppingList = _TranslationsShoppingListAy._(_root);
	@override late final _TranslationsMealPlanAy mealPlan = _TranslationsMealPlanAy._(_root);
	@override late final _TranslationsInventoryAy inventory = _TranslationsInventoryAy._(_root);
	@override late final _TranslationsBarcodeScanAy barcodeScan = _TranslationsBarcodeScanAy._(_root);
	@override late final _TranslationsReceiptScanAy receiptScan = _TranslationsReceiptScanAy._(_root);
	@override late final _TranslationsBatchCookingAy batchCooking = _TranslationsBatchCookingAy._(_root);
	@override late final _TranslationsVisitedDomainsAy visitedDomains = _TranslationsVisitedDomainsAy._(_root);
	@override late final _TranslationsDomainDiscoveryAy domainDiscovery = _TranslationsDomainDiscoveryAy._(_root);
	@override late final _TranslationsInventorySuggestionsAy inventorySuggestions = _TranslationsInventorySuggestionsAy._(_root);
	@override late final _TranslationsUpgradeAy upgrade = _TranslationsUpgradeAy._(_root);
	@override late final _TranslationsTourAy tour = _TranslationsTourAy._(_root);
	@override late final _TranslationsManualRecipeAy manualRecipe = _TranslationsManualRecipeAy._(_root);
	@override late final _TranslationsRecipeEditAy recipeEdit = _TranslationsRecipeEditAy._(_root);
	@override late final _TranslationsErrorsAy errors = _TranslationsErrorsAy._(_root);
}

// Path: app
class _TranslationsAppAy extends TranslationsAppEn {
	_TranslationsAppAy._(TranslationsAy root) : this._root = root, super.internal(root);

	final TranslationsAy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeAy extends TranslationsHomeEn {
	_TranslationsHomeAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonAy extends TranslationsCommonEn {
	_TranslationsCommonAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsAy extends TranslationsSettingsEn {
	_TranslationsSettingsAy._(TranslationsAy root) : this._root = root, super.internal(root);

	final TranslationsAy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsAy measurements = _TranslationsSettingsMeasurementsAy._(_root);
	@override late final _TranslationsSettingsDataManagementAy dataManagement = _TranslationsSettingsDataManagementAy._(_root);
	@override late final _TranslationsSettingsVersionAy version = _TranslationsSettingsVersionAy._(_root);
}

// Path: recipes
class _TranslationsRecipesAy extends TranslationsRecipesEn {
	_TranslationsRecipesAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAy._(TranslationsAy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAy nutrition = _TranslationsRecipeDetailNutritionAy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAy prepAhead = _TranslationsRecipeDetailPrepAheadAy._(_root);
...
// Path: filters
class _TranslationsFiltersAy extends TranslationsFiltersEn {
	_TranslationsFiltersAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAy extends TranslationsShoppingListEn {
	_TranslationsShoppingListAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAy extends TranslationsMealPlanEn {
	_TranslationsMealPlanAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAy extends TranslationsInventoryEn {
	_TranslationsInventoryAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAy extends TranslationsUpgradeEn {
	_TranslationsUpgradeAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAy extends TranslationsTourEn {
	_TranslationsTourAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAy extends TranslationsErrorsEn {
	_TranslationsErrorsAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAy._(TranslationsAy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAy metric = _TranslationsSettingsMeasurementsMetricAy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAy imperial = _TranslationsSettingsMeasurementsImperialAy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAy._(TranslationsAy root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ay>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsAy {
