...
class TranslationsTl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppTl app = _TranslationsAppTl._(_root);
	...
	@override late final _TranslationsRecipesTl recipes = _TranslationsRecipesTl._(_root);
	@override late final _TranslationsRecipeDetailTl recipeDetail = _TranslationsRecipeDetailTl._(_root);
	@override late final _TranslationsFiltersTl filters = _TranslationsFiltersTl._(_root);
	@override late final _TranslationsShoppingListTl shoppingList = _TranslationsShoppingListTl._(_root);
	@override late final _TranslationsMealPlanTl mealPlan = _TranslationsMealPlanTl._(_root);
	@override late final _TranslationsInventoryTl inventory = _TranslationsInventoryTl._(_root);
	@override late final _TranslationsBarcodeScanTl barcodeScan = _TranslationsBarcodeScanTl._(_root);
	@override late final _TranslationsReceiptScanTl receiptScan = _TranslationsReceiptScanTl._(_root);
	@override late final _TranslationsBatchCookingTl batchCooking = _TranslationsBatchCookingTl._(_root);
	@override late final _TranslationsVisitedDomainsTl visitedDomains = _TranslationsVisitedDomainsTl._(_root);
	@override late final _TranslationsDomainDiscoveryTl domainDiscovery = _TranslationsDomainDiscoveryTl._(_root);
	@override late final _TranslationsInventorySuggestionsTl inventorySuggestions = _TranslationsInventorySuggestionsTl._(_root);
	@override late final _TranslationsUpgradeTl upgrade = _TranslationsUpgradeTl._(_root);
	@override late final _TranslationsTourTl tour = _TranslationsTourTl._(_root);
	@override late final _TranslationsManualRecipeTl manualRecipe = _TranslationsManualRecipeTl._(_root);
	@override late final _TranslationsRecipeEditTl recipeEdit = _TranslationsRecipeEditTl._(_root);
	@override late final _TranslationsErrorsTl errors = _TranslationsErrorsTl._(_root);
}

// Path: app
class _TranslationsAppTl extends TranslationsAppEn {
	_TranslationsAppTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsTl extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsTl measurements = _TranslationsSettingsMeasurementsTl._(_root);
	@override late final _TranslationsSettingsDataManagementTl dataManagement = _TranslationsSettingsDataManagementTl._(_root);
	@override late final _TranslationsSettingsVersionTl version = _TranslationsSettingsVersionTl._(_root);
}

// Path: recipes
class _TranslationsRecipesTl extends TranslationsRecipesEn {
	_TranslationsRecipesTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTl._(TranslationsTl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTl nutrition = _TranslationsRecipeDetailNutritionTl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTl prepAhead = _TranslationsRecipeDetailPrepAheadTl._(_root);
...
// Path: filters
class _TranslationsFiltersTl extends TranslationsFiltersEn {
	_TranslationsFiltersTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTl extends TranslationsShoppingListEn {
	_TranslationsShoppingListTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTl extends TranslationsMealPlanEn {
	_TranslationsMealPlanTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTl extends TranslationsInventoryEn {
	_TranslationsInventoryTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTl extends TranslationsUpgradeEn {
	_TranslationsUpgradeTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTl extends TranslationsTourEn {
	_TranslationsTourTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTl._(TranslationsTl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTl metric = _TranslationsSettingsMeasurementsMetricTl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTl imperial = _TranslationsSettingsMeasurementsImperialTl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTl._(TranslationsTl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTl._(TranslationsTl root) : this._root = root, super.internal(root);
