...
// Path: <root>
class TranslationsSg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <sg>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSg _root = this; // ignore: unused_field

	@override 
	TranslationsSg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSg app = _TranslationsAppSg._(_root);
	@override late final _TranslationsHomeSg home = _TranslationsHomeSg._(_root);
	@override late final _TranslationsCommonSg common = _TranslationsCommonSg._(_root);
	@override late final _TranslationsSettingsSg settings = _TranslationsSettingsSg._(_root);
	@override late final _TranslationsRecipesSg recipes = _TranslationsRecipesSg._(_root);
	@override late final _TranslationsRecipeDetailSg recipeDetail = _TranslationsRecipeDetailSg._(_root);
	@override late final _TranslationsFiltersSg filters = _TranslationsFiltersSg._(_root);
	@override late final _TranslationsShoppingListSg shoppingList = _TranslationsShoppingListSg._(_root);
	@override late final _TranslationsMealPlanSg mealPlan = _TranslationsMealPlanSg._(_root);
	@override late final _TranslationsInventorySg inventory = _TranslationsInventorySg._(_root);
	@override late final _TranslationsBarcodeScanSg barcodeScan = _TranslationsBarcodeScanSg._(_root);
	@override late final _TranslationsReceiptScanSg receiptScan = _TranslationsReceiptScanSg._(_root);
	@override late final _TranslationsBatchCookingSg batchCooking = _TranslationsBatchCookingSg._(_root);
	@override late final _TranslationsVisitedDomainsSg visitedDomains = _TranslationsVisitedDomainsSg._(_root);
	@override late final _TranslationsDomainDiscoverySg domainDiscovery = _TranslationsDomainDiscoverySg._(_root);
	@override late final _TranslationsInventorySuggestionsSg inventorySuggestions = _TranslationsInventorySuggestionsSg._(_root);
	@override late final _TranslationsUpgradeSg upgrade = _TranslationsUpgradeSg._(_root);
	@override late final _TranslationsTourSg tour = _TranslationsTourSg._(_root);
	@override late final _TranslationsManualRecipeSg manualRecipe = _TranslationsManualRecipeSg._(_root);
	@override late final _TranslationsRecipeEditSg recipeEdit = _TranslationsRecipeEditSg._(_root);
	@override late final _TranslationsErrorsSg errors = _TranslationsErrorsSg._(_root);
}

// Path: app
class _TranslationsAppSg extends TranslationsAppEn {
	_TranslationsAppSg._(TranslationsSg root) : this._root = root, super.internal(root);

	final TranslationsSg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSg extends TranslationsHomeEn {
	_TranslationsHomeSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSg extends TranslationsCommonEn {
	_TranslationsCommonSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSg extends TranslationsSettingsEn {
	_TranslationsSettingsSg._(TranslationsSg root) : this._root = root, super.internal(root);

	final TranslationsSg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSg measurements = _TranslationsSettingsMeasurementsSg._(_root);
	@override late final _TranslationsSettingsDataManagementSg dataManagement = _TranslationsSettingsDataManagementSg._(_root);
	@override late final _TranslationsSettingsVersionSg version = _TranslationsSettingsVersionSg._(_root);
}

// Path: recipes
class _TranslationsRecipesSg extends TranslationsRecipesEn {
	_TranslationsRecipesSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSg._(TranslationsSg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSg nutrition = _TranslationsRecipeDetailNutritionSg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSg prepAhead = _TranslationsRecipeDetailPrepAheadSg._(_root);
...
// Path: filters
class _TranslationsFiltersSg extends TranslationsFiltersEn {
	_TranslationsFiltersSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSg extends TranslationsShoppingListEn {
	_TranslationsShoppingListSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSg extends TranslationsMealPlanEn {
	_TranslationsMealPlanSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySg extends TranslationsInventoryEn {
	_TranslationsInventorySg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSg extends TranslationsUpgradeEn {
	_TranslationsUpgradeSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSg extends TranslationsTourEn {
	_TranslationsTourSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSg extends TranslationsErrorsEn {
	_TranslationsErrorsSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSg._(TranslationsSg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSg metric = _TranslationsSettingsMeasurementsMetricSg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSg imperial = _TranslationsSettingsMeasurementsImperialSg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSg._(TranslationsSg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sg>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSg {
