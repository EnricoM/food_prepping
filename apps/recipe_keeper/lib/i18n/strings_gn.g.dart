...
// Path: <root>
class TranslationsGn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsGn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <gn>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsGn _root = this; // ignore: unused_field

	@override 
	TranslationsGn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsGn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppGn app = _TranslationsAppGn._(_root);
	@override late final _TranslationsHomeGn home = _TranslationsHomeGn._(_root);
	@override late final _TranslationsCommonGn common = _TranslationsCommonGn._(_root);
	@override late final _TranslationsSettingsGn settings = _TranslationsSettingsGn._(_root);
	@override late final _TranslationsRecipesGn recipes = _TranslationsRecipesGn._(_root);
	@override late final _TranslationsRecipeDetailGn recipeDetail = _TranslationsRecipeDetailGn._(_root);
	@override late final _TranslationsFiltersGn filters = _TranslationsFiltersGn._(_root);
	@override late final _TranslationsShoppingListGn shoppingList = _TranslationsShoppingListGn._(_root);
	@override late final _TranslationsMealPlanGn mealPlan = _TranslationsMealPlanGn._(_root);
	@override late final _TranslationsInventoryGn inventory = _TranslationsInventoryGn._(_root);
	@override late final _TranslationsBarcodeScanGn barcodeScan = _TranslationsBarcodeScanGn._(_root);
	@override late final _TranslationsReceiptScanGn receiptScan = _TranslationsReceiptScanGn._(_root);
	@override late final _TranslationsBatchCookingGn batchCooking = _TranslationsBatchCookingGn._(_root);
	@override late final _TranslationsVisitedDomainsGn visitedDomains = _TranslationsVisitedDomainsGn._(_root);
	@override late final _TranslationsDomainDiscoveryGn domainDiscovery = _TranslationsDomainDiscoveryGn._(_root);
	@override late final _TranslationsInventorySuggestionsGn inventorySuggestions = _TranslationsInventorySuggestionsGn._(_root);
	@override late final _TranslationsUpgradeGn upgrade = _TranslationsUpgradeGn._(_root);
	@override late final _TranslationsTourGn tour = _TranslationsTourGn._(_root);
	@override late final _TranslationsManualRecipeGn manualRecipe = _TranslationsManualRecipeGn._(_root);
	@override late final _TranslationsRecipeEditGn recipeEdit = _TranslationsRecipeEditGn._(_root);
	@override late final _TranslationsErrorsGn errors = _TranslationsErrorsGn._(_root);
}

// Path: app
class _TranslationsAppGn extends TranslationsAppEn {
	_TranslationsAppGn._(TranslationsGn root) : this._root = root, super.internal(root);

	final TranslationsGn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeGn extends TranslationsHomeEn {
	_TranslationsHomeGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonGn extends TranslationsCommonEn {
	_TranslationsCommonGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsGn extends TranslationsSettingsEn {
	_TranslationsSettingsGn._(TranslationsGn root) : this._root = root, super.internal(root);

	final TranslationsGn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsGn measurements = _TranslationsSettingsMeasurementsGn._(_root);
	@override late final _TranslationsSettingsDataManagementGn dataManagement = _TranslationsSettingsDataManagementGn._(_root);
	@override late final _TranslationsSettingsVersionGn version = _TranslationsSettingsVersionGn._(_root);
}

// Path: recipes
class _TranslationsRecipesGn extends TranslationsRecipesEn {
	_TranslationsRecipesGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGn._(TranslationsGn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGn nutrition = _TranslationsRecipeDetailNutritionGn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGn prepAhead = _TranslationsRecipeDetailPrepAheadGn._(_root);
...
// Path: filters
class _TranslationsFiltersGn extends TranslationsFiltersEn {
	_TranslationsFiltersGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGn extends TranslationsShoppingListEn {
	_TranslationsShoppingListGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGn extends TranslationsMealPlanEn {
	_TranslationsMealPlanGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGn extends TranslationsInventoryEn {
	_TranslationsInventoryGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGn extends TranslationsUpgradeEn {
	_TranslationsUpgradeGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGn extends TranslationsTourEn {
	_TranslationsTourGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsGn extends TranslationsErrorsEn {
	_TranslationsErrorsGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGn._(TranslationsGn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGn metric = _TranslationsSettingsMeasurementsMetricGn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGn imperial = _TranslationsSettingsMeasurementsImperialGn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGn._(TranslationsGn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <gn>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsGn {
