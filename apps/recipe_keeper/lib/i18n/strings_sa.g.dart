...
class TranslationsSa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesSa recipes = _TranslationsRecipesSa._(_root);
	@override late final _TranslationsRecipeDetailSa recipeDetail = _TranslationsRecipeDetailSa._(_root);
	@override late final _TranslationsFiltersSa filters = _TranslationsFiltersSa._(_root);
	@override late final _TranslationsShoppingListSa shoppingList = _TranslationsShoppingListSa._(_root);
	@override late final _TranslationsMealPlanSa mealPlan = _TranslationsMealPlanSa._(_root);
	@override late final _TranslationsInventorySa inventory = _TranslationsInventorySa._(_root);
	@override late final _TranslationsBarcodeScanSa barcodeScan = _TranslationsBarcodeScanSa._(_root);
	@override late final _TranslationsReceiptScanSa receiptScan = _TranslationsReceiptScanSa._(_root);
	@override late final _TranslationsBatchCookingSa batchCooking = _TranslationsBatchCookingSa._(_root);
	@override late final _TranslationsVisitedDomainsSa visitedDomains = _TranslationsVisitedDomainsSa._(_root);
	@override late final _TranslationsDomainDiscoverySa domainDiscovery = _TranslationsDomainDiscoverySa._(_root);
	@override late final _TranslationsInventorySuggestionsSa inventorySuggestions = _TranslationsInventorySuggestionsSa._(_root);
	@override late final _TranslationsUpgradeSa upgrade = _TranslationsUpgradeSa._(_root);
	@override late final _TranslationsTourSa tour = _TranslationsTourSa._(_root);
	@override late final _TranslationsManualRecipeSa manualRecipe = _TranslationsManualRecipeSa._(_root);
	@override late final _TranslationsRecipeEditSa recipeEdit = _TranslationsRecipeEditSa._(_root);
	@override late final _TranslationsErrorsSa errors = _TranslationsErrorsSa._(_root);
}
...
class _TranslationsSettingsSa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsSa measurements = _TranslationsSettingsMeasurementsSa._(_root);
	@override late final _TranslationsSettingsDataManagementSa dataManagement = _TranslationsSettingsDataManagementSa._(_root);
	@override late final _TranslationsSettingsVersionSa version = _TranslationsSettingsVersionSa._(_root);
}

// Path: recipes
class _TranslationsRecipesSa extends TranslationsRecipesEn {
	_TranslationsRecipesSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSa._(TranslationsSa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSa nutrition = _TranslationsRecipeDetailNutritionSa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSa prepAhead = _TranslationsRecipeDetailPrepAheadSa._(_root);
...
// Path: filters
class _TranslationsFiltersSa extends TranslationsFiltersEn {
	_TranslationsFiltersSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSa extends TranslationsShoppingListEn {
	_TranslationsShoppingListSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSa extends TranslationsMealPlanEn {
	_TranslationsMealPlanSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySa extends TranslationsInventoryEn {
	_TranslationsInventorySa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSa extends TranslationsUpgradeEn {
	_TranslationsUpgradeSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSa extends TranslationsTourEn {
	_TranslationsTourSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSa extends TranslationsErrorsEn {
	_TranslationsErrorsSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSa._(TranslationsSa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSa metric = _TranslationsSettingsMeasurementsMetricSa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSa imperial = _TranslationsSettingsMeasurementsImperialSa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSa._(TranslationsSa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sa>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSa {
