...
// Path: <root>
class TranslationsGlEs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsGlEs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.glEs,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <gl-ES>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsGlEs _root = this; // ignore: unused_field

	@override 
	TranslationsGlEs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsGlEs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppGlEs app = _TranslationsAppGlEs._(_root);
	@override late final _TranslationsHomeGlEs home = _TranslationsHomeGlEs._(_root);
	@override late final _TranslationsCommonGlEs common = _TranslationsCommonGlEs._(_root);
	@override late final _TranslationsSettingsGlEs settings = _TranslationsSettingsGlEs._(_root);
	@override late final _TranslationsRecipesGlEs recipes = _TranslationsRecipesGlEs._(_root);
	@override late final _TranslationsRecipeDetailGlEs recipeDetail = _TranslationsRecipeDetailGlEs._(_root);
	@override late final _TranslationsFiltersGlEs filters = _TranslationsFiltersGlEs._(_root);
	@override late final _TranslationsShoppingListGlEs shoppingList = _TranslationsShoppingListGlEs._(_root);
	@override late final _TranslationsMealPlanGlEs mealPlan = _TranslationsMealPlanGlEs._(_root);
	@override late final _TranslationsInventoryGlEs inventory = _TranslationsInventoryGlEs._(_root);
	@override late final _TranslationsBarcodeScanGlEs barcodeScan = _TranslationsBarcodeScanGlEs._(_root);
	@override late final _TranslationsReceiptScanGlEs receiptScan = _TranslationsReceiptScanGlEs._(_root);
	@override late final _TranslationsBatchCookingGlEs batchCooking = _TranslationsBatchCookingGlEs._(_root);
	@override late final _TranslationsVisitedDomainsGlEs visitedDomains = _TranslationsVisitedDomainsGlEs._(_root);
	@override late final _TranslationsDomainDiscoveryGlEs domainDiscovery = _TranslationsDomainDiscoveryGlEs._(_root);
	@override late final _TranslationsInventorySuggestionsGlEs inventorySuggestions = _TranslationsInventorySuggestionsGlEs._(_root);
	@override late final _TranslationsUpgradeGlEs upgrade = _TranslationsUpgradeGlEs._(_root);
	@override late final _TranslationsTourGlEs tour = _TranslationsTourGlEs._(_root);
	@override late final _TranslationsManualRecipeGlEs manualRecipe = _TranslationsManualRecipeGlEs._(_root);
	@override late final _TranslationsRecipeEditGlEs recipeEdit = _TranslationsRecipeEditGlEs._(_root);
	@override late final _TranslationsErrorsGlEs errors = _TranslationsErrorsGlEs._(_root);
}

// Path: app
class _TranslationsAppGlEs extends TranslationsAppEn {
	_TranslationsAppGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);

	final TranslationsGlEs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeGlEs extends TranslationsHomeEn {
	_TranslationsHomeGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonGlEs extends TranslationsCommonEn {
	_TranslationsCommonGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsGlEs extends TranslationsSettingsEn {
	_TranslationsSettingsGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);

	final TranslationsGlEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsGlEs measurements = _TranslationsSettingsMeasurementsGlEs._(_root);
	@override late final _TranslationsSettingsDataManagementGlEs dataManagement = _TranslationsSettingsDataManagementGlEs._(_root);
	@override late final _TranslationsSettingsVersionGlEs version = _TranslationsSettingsVersionGlEs._(_root);
}

// Path: recipes
class _TranslationsRecipesGlEs extends TranslationsRecipesEn {
	_TranslationsRecipesGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailGlEs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionGlEs nutrition = _TranslationsRecipeDetailNutritionGlEs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadGlEs prepAhead = _TranslationsRecipeDetailPrepAheadGlEs._(_root);
...
// Path: filters
class _TranslationsFiltersGlEs extends TranslationsFiltersEn {
	_TranslationsFiltersGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListGlEs extends TranslationsShoppingListEn {
	_TranslationsShoppingListGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanGlEs extends TranslationsMealPlanEn {
	_TranslationsMealPlanGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryGlEs extends TranslationsInventoryEn {
	_TranslationsInventoryGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanGlEs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanGlEs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingGlEs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsGlEs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryGlEs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsGlEs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeGlEs extends TranslationsUpgradeEn {
	_TranslationsUpgradeGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourGlEs extends TranslationsTourEn {
	_TranslationsTourGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeGlEs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditGlEs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsGlEs extends TranslationsErrorsEn {
	_TranslationsErrorsGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsGlEs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricGlEs metric = _TranslationsSettingsMeasurementsMetricGlEs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialGlEs imperial = _TranslationsSettingsMeasurementsImperialGlEs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementGlEs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionGlEs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionGlEs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadGlEs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricGlEs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialGlEs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialGlEs._(TranslationsGlEs root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <gl-ES>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsGlEs {
