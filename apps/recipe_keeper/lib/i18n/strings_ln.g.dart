...
// Path: <root>
class TranslationsLn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ln>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsLn _root = this; // ignore: unused_field

	@override 
	TranslationsLn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLn app = _TranslationsAppLn._(_root);
	@override late final _TranslationsHomeLn home = _TranslationsHomeLn._(_root);
	@override late final _TranslationsCommonLn common = _TranslationsCommonLn._(_root);
	@override late final _TranslationsSettingsLn settings = _TranslationsSettingsLn._(_root);
	@override late final _TranslationsRecipesLn recipes = _TranslationsRecipesLn._(_root);
	@override late final _TranslationsRecipeDetailLn recipeDetail = _TranslationsRecipeDetailLn._(_root);
	@override late final _TranslationsFiltersLn filters = _TranslationsFiltersLn._(_root);
	@override late final _TranslationsShoppingListLn shoppingList = _TranslationsShoppingListLn._(_root);
	@override late final _TranslationsMealPlanLn mealPlan = _TranslationsMealPlanLn._(_root);
	@override late final _TranslationsInventoryLn inventory = _TranslationsInventoryLn._(_root);
	@override late final _TranslationsBarcodeScanLn barcodeScan = _TranslationsBarcodeScanLn._(_root);
	@override late final _TranslationsReceiptScanLn receiptScan = _TranslationsReceiptScanLn._(_root);
	@override late final _TranslationsBatchCookingLn batchCooking = _TranslationsBatchCookingLn._(_root);
	@override late final _TranslationsVisitedDomainsLn visitedDomains = _TranslationsVisitedDomainsLn._(_root);
	@override late final _TranslationsDomainDiscoveryLn domainDiscovery = _TranslationsDomainDiscoveryLn._(_root);
	@override late final _TranslationsInventorySuggestionsLn inventorySuggestions = _TranslationsInventorySuggestionsLn._(_root);
	@override late final _TranslationsUpgradeLn upgrade = _TranslationsUpgradeLn._(_root);
	@override late final _TranslationsTourLn tour = _TranslationsTourLn._(_root);
	@override late final _TranslationsManualRecipeLn manualRecipe = _TranslationsManualRecipeLn._(_root);
	@override late final _TranslationsRecipeEditLn recipeEdit = _TranslationsRecipeEditLn._(_root);
	@override late final _TranslationsErrorsLn errors = _TranslationsErrorsLn._(_root);
}

// Path: app
class _TranslationsAppLn extends TranslationsAppEn {
	_TranslationsAppLn._(TranslationsLn root) : this._root = root, super.internal(root);

	final TranslationsLn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeLn extends TranslationsHomeEn {
	_TranslationsHomeLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLn extends TranslationsCommonEn {
	_TranslationsCommonLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLn extends TranslationsSettingsEn {
	_TranslationsSettingsLn._(TranslationsLn root) : this._root = root, super.internal(root);

	final TranslationsLn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLn measurements = _TranslationsSettingsMeasurementsLn._(_root);
	@override late final _TranslationsSettingsDataManagementLn dataManagement = _TranslationsSettingsDataManagementLn._(_root);
	@override late final _TranslationsSettingsVersionLn version = _TranslationsSettingsVersionLn._(_root);
}

// Path: recipes
class _TranslationsRecipesLn extends TranslationsRecipesEn {
	_TranslationsRecipesLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLn._(TranslationsLn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLn nutrition = _TranslationsRecipeDetailNutritionLn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLn prepAhead = _TranslationsRecipeDetailPrepAheadLn._(_root);
...
// Path: filters
class _TranslationsFiltersLn extends TranslationsFiltersEn {
	_TranslationsFiltersLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLn extends TranslationsShoppingListEn {
	_TranslationsShoppingListLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLn extends TranslationsMealPlanEn {
	_TranslationsMealPlanLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLn extends TranslationsInventoryEn {
	_TranslationsInventoryLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLn extends TranslationsUpgradeEn {
	_TranslationsUpgradeLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLn extends TranslationsTourEn {
	_TranslationsTourLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLn extends TranslationsErrorsEn {
	_TranslationsErrorsLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLn._(TranslationsLn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLn metric = _TranslationsSettingsMeasurementsMetricLn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLn imperial = _TranslationsSettingsMeasurementsImperialLn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLn._(TranslationsLn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ln>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsLn {
