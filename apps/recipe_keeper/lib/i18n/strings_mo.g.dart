...
// Path: <root>
class TranslationsMo extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsMo({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <mo>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsMo _root = this; // ignore: unused_field

	@override 
	TranslationsMo $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsMo(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppMo app = _TranslationsAppMo._(_root);
	@override late final _TranslationsHomeMo home = _TranslationsHomeMo._(_root);
	@override late final _TranslationsCommonMo common = _TranslationsCommonMo._(_root);
	@override late final _TranslationsSettingsMo settings = _TranslationsSettingsMo._(_root);
	@override late final _TranslationsRecipesMo recipes = _TranslationsRecipesMo._(_root);
	@override late final _TranslationsRecipeDetailMo recipeDetail = _TranslationsRecipeDetailMo._(_root);
	@override late final _TranslationsFiltersMo filters = _TranslationsFiltersMo._(_root);
	@override late final _TranslationsShoppingListMo shoppingList = _TranslationsShoppingListMo._(_root);
	@override late final _TranslationsMealPlanMo mealPlan = _TranslationsMealPlanMo._(_root);
	@override late final _TranslationsInventoryMo inventory = _TranslationsInventoryMo._(_root);
	@override late final _TranslationsBarcodeScanMo barcodeScan = _TranslationsBarcodeScanMo._(_root);
	@override late final _TranslationsReceiptScanMo receiptScan = _TranslationsReceiptScanMo._(_root);
	@override late final _TranslationsBatchCookingMo batchCooking = _TranslationsBatchCookingMo._(_root);
	@override late final _TranslationsVisitedDomainsMo visitedDomains = _TranslationsVisitedDomainsMo._(_root);
	@override late final _TranslationsDomainDiscoveryMo domainDiscovery = _TranslationsDomainDiscoveryMo._(_root);
	@override late final _TranslationsInventorySuggestionsMo inventorySuggestions = _TranslationsInventorySuggestionsMo._(_root);
	@override late final _TranslationsUpgradeMo upgrade = _TranslationsUpgradeMo._(_root);
	@override late final _TranslationsTourMo tour = _TranslationsTourMo._(_root);
	@override late final _TranslationsManualRecipeMo manualRecipe = _TranslationsManualRecipeMo._(_root);
	@override late final _TranslationsRecipeEditMo recipeEdit = _TranslationsRecipeEditMo._(_root);
	@override late final _TranslationsErrorsMo errors = _TranslationsErrorsMo._(_root);
}

// Path: app
class _TranslationsAppMo extends TranslationsAppEn {
	_TranslationsAppMo._(TranslationsMo root) : this._root = root, super.internal(root);

	final TranslationsMo _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeMo extends TranslationsHomeEn {
	_TranslationsHomeMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonMo extends TranslationsCommonEn {
	_TranslationsCommonMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsMo extends TranslationsSettingsEn {
	_TranslationsSettingsMo._(TranslationsMo root) : this._root = root, super.internal(root);

	final TranslationsMo _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsMo measurements = _TranslationsSettingsMeasurementsMo._(_root);
	@override late final _TranslationsSettingsDataManagementMo dataManagement = _TranslationsSettingsDataManagementMo._(_root);
	@override late final _TranslationsSettingsVersionMo version = _TranslationsSettingsVersionMo._(_root);
}

// Path: recipes
class _TranslationsRecipesMo extends TranslationsRecipesEn {
	_TranslationsRecipesMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMo._(TranslationsMo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMo nutrition = _TranslationsRecipeDetailNutritionMo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMo prepAhead = _TranslationsRecipeDetailPrepAheadMo._(_root);
...
// Path: filters
class _TranslationsFiltersMo extends TranslationsFiltersEn {
	_TranslationsFiltersMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMo extends TranslationsShoppingListEn {
	_TranslationsShoppingListMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMo extends TranslationsMealPlanEn {
	_TranslationsMealPlanMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMo extends TranslationsInventoryEn {
	_TranslationsInventoryMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMo extends TranslationsUpgradeEn {
	_TranslationsUpgradeMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMo extends TranslationsTourEn {
	_TranslationsTourMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsMo extends TranslationsErrorsEn {
	_TranslationsErrorsMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMo._(TranslationsMo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMo metric = _TranslationsSettingsMeasurementsMetricMo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMo imperial = _TranslationsSettingsMeasurementsImperialMo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMo._(TranslationsMo root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <mo>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsMo {
