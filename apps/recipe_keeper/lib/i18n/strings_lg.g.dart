...
// Path: <root>
class TranslationsLg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsLg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <lg>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsLg _root = this; // ignore: unused_field

	@override 
	TranslationsLg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsLg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppLg app = _TranslationsAppLg._(_root);
	@override late final _TranslationsHomeLg home = _TranslationsHomeLg._(_root);
	@override late final _TranslationsCommonLg common = _TranslationsCommonLg._(_root);
	@override late final _TranslationsSettingsLg settings = _TranslationsSettingsLg._(_root);
	@override late final _TranslationsRecipesLg recipes = _TranslationsRecipesLg._(_root);
	@override late final _TranslationsRecipeDetailLg recipeDetail = _TranslationsRecipeDetailLg._(_root);
	@override late final _TranslationsFiltersLg filters = _TranslationsFiltersLg._(_root);
	@override late final _TranslationsShoppingListLg shoppingList = _TranslationsShoppingListLg._(_root);
	@override late final _TranslationsMealPlanLg mealPlan = _TranslationsMealPlanLg._(_root);
	@override late final _TranslationsInventoryLg inventory = _TranslationsInventoryLg._(_root);
	@override late final _TranslationsBarcodeScanLg barcodeScan = _TranslationsBarcodeScanLg._(_root);
	@override late final _TranslationsReceiptScanLg receiptScan = _TranslationsReceiptScanLg._(_root);
	@override late final _TranslationsBatchCookingLg batchCooking = _TranslationsBatchCookingLg._(_root);
	@override late final _TranslationsVisitedDomainsLg visitedDomains = _TranslationsVisitedDomainsLg._(_root);
	@override late final _TranslationsDomainDiscoveryLg domainDiscovery = _TranslationsDomainDiscoveryLg._(_root);
	@override late final _TranslationsInventorySuggestionsLg inventorySuggestions = _TranslationsInventorySuggestionsLg._(_root);
	@override late final _TranslationsUpgradeLg upgrade = _TranslationsUpgradeLg._(_root);
	@override late final _TranslationsTourLg tour = _TranslationsTourLg._(_root);
	@override late final _TranslationsManualRecipeLg manualRecipe = _TranslationsManualRecipeLg._(_root);
	@override late final _TranslationsRecipeEditLg recipeEdit = _TranslationsRecipeEditLg._(_root);
	@override late final _TranslationsErrorsLg errors = _TranslationsErrorsLg._(_root);
}

// Path: app
class _TranslationsAppLg extends TranslationsAppEn {
	_TranslationsAppLg._(TranslationsLg root) : this._root = root, super.internal(root);

	final TranslationsLg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeLg extends TranslationsHomeEn {
	_TranslationsHomeLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLg extends TranslationsCommonEn {
	_TranslationsCommonLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLg extends TranslationsSettingsEn {
	_TranslationsSettingsLg._(TranslationsLg root) : this._root = root, super.internal(root);

	final TranslationsLg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLg measurements = _TranslationsSettingsMeasurementsLg._(_root);
	@override late final _TranslationsSettingsDataManagementLg dataManagement = _TranslationsSettingsDataManagementLg._(_root);
	@override late final _TranslationsSettingsVersionLg version = _TranslationsSettingsVersionLg._(_root);
}

// Path: recipes
class _TranslationsRecipesLg extends TranslationsRecipesEn {
	_TranslationsRecipesLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLg._(TranslationsLg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLg nutrition = _TranslationsRecipeDetailNutritionLg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLg prepAhead = _TranslationsRecipeDetailPrepAheadLg._(_root);
...
// Path: filters
class _TranslationsFiltersLg extends TranslationsFiltersEn {
	_TranslationsFiltersLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLg extends TranslationsShoppingListEn {
	_TranslationsShoppingListLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLg extends TranslationsMealPlanEn {
	_TranslationsMealPlanLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLg extends TranslationsInventoryEn {
	_TranslationsInventoryLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLg extends TranslationsUpgradeEn {
	_TranslationsUpgradeLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLg extends TranslationsTourEn {
	_TranslationsTourLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLg extends TranslationsErrorsEn {
	_TranslationsErrorsLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLg._(TranslationsLg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLg metric = _TranslationsSettingsMeasurementsMetricLg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLg imperial = _TranslationsSettingsMeasurementsImperialLg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLg._(TranslationsLg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <lg>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsLg {
