...
class TranslationsHi extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesHi recipes = _TranslationsRecipesHi._(_root);
	@override late final _TranslationsRecipeDetailHi recipeDetail = _TranslationsRecipeDetailHi._(_root);
	@override late final _TranslationsFiltersHi filters = _TranslationsFiltersHi._(_root);
	@override late final _TranslationsShoppingListHi shoppingList = _TranslationsShoppingListHi._(_root);
	@override late final _TranslationsMealPlanHi mealPlan = _TranslationsMealPlanHi._(_root);
	@override late final _TranslationsInventoryHi inventory = _TranslationsInventoryHi._(_root);
	@override late final _TranslationsBarcodeScanHi barcodeScan = _TranslationsBarcodeScanHi._(_root);
	@override late final _TranslationsReceiptScanHi receiptScan = _TranslationsReceiptScanHi._(_root);
	@override late final _TranslationsBatchCookingHi batchCooking = _TranslationsBatchCookingHi._(_root);
	@override late final _TranslationsVisitedDomainsHi visitedDomains = _TranslationsVisitedDomainsHi._(_root);
	@override late final _TranslationsDomainDiscoveryHi domainDiscovery = _TranslationsDomainDiscoveryHi._(_root);
	@override late final _TranslationsInventorySuggestionsHi inventorySuggestions = _TranslationsInventorySuggestionsHi._(_root);
	@override late final _TranslationsUpgradeHi upgrade = _TranslationsUpgradeHi._(_root);
	@override late final _TranslationsTourHi tour = _TranslationsTourHi._(_root);
	@override late final _TranslationsManualRecipeHi manualRecipe = _TranslationsManualRecipeHi._(_root);
	@override late final _TranslationsRecipeEditHi recipeEdit = _TranslationsRecipeEditHi._(_root);
...
class _TranslationsSettingsHi extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsHi measurements = _TranslationsSettingsMeasurementsHi._(_root);
	@override late final _TranslationsSettingsDataManagementHi dataManagement = _TranslationsSettingsDataManagementHi._(_root);
	@override late final _TranslationsSettingsVersionHi version = _TranslationsSettingsVersionHi._(_root);
}

// Path: recipes
class _TranslationsRecipesHi extends TranslationsRecipesEn {
	_TranslationsRecipesHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHi._(TranslationsHi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHi nutrition = _TranslationsRecipeDetailNutritionHi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHi prepAhead = _TranslationsRecipeDetailPrepAheadHi._(_root);
...
// Path: filters
class _TranslationsFiltersHi extends TranslationsFiltersEn {
	_TranslationsFiltersHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHi extends TranslationsShoppingListEn {
	_TranslationsShoppingListHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHi extends TranslationsMealPlanEn {
	_TranslationsMealPlanHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHi extends TranslationsInventoryEn {
	_TranslationsInventoryHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHi extends TranslationsUpgradeEn {
	_TranslationsUpgradeHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHi extends TranslationsTourEn {
	_TranslationsTourHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHi._(TranslationsHi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHi metric = _TranslationsSettingsMeasurementsMetricHi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHi imperial = _TranslationsSettingsMeasurementsImperialHi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHi._(TranslationsHi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHi._(TranslationsHi root) : this._root = root, super.internal(root);
