...
// Path: <root>
class TranslationsDz extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsDz({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <dz>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsDz _root = this; // ignore: unused_field

	@override 
	TranslationsDz $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsDz(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppDz app = _TranslationsAppDz._(_root);
	@override late final _TranslationsHomeDz home = _TranslationsHomeDz._(_root);
	@override late final _TranslationsCommonDz common = _TranslationsCommonDz._(_root);
	@override late final _TranslationsSettingsDz settings = _TranslationsSettingsDz._(_root);
	@override late final _TranslationsRecipesDz recipes = _TranslationsRecipesDz._(_root);
	@override late final _TranslationsRecipeDetailDz recipeDetail = _TranslationsRecipeDetailDz._(_root);
	@override late final _TranslationsFiltersDz filters = _TranslationsFiltersDz._(_root);
	@override late final _TranslationsShoppingListDz shoppingList = _TranslationsShoppingListDz._(_root);
	@override late final _TranslationsMealPlanDz mealPlan = _TranslationsMealPlanDz._(_root);
	@override late final _TranslationsInventoryDz inventory = _TranslationsInventoryDz._(_root);
	@override late final _TranslationsBarcodeScanDz barcodeScan = _TranslationsBarcodeScanDz._(_root);
	@override late final _TranslationsReceiptScanDz receiptScan = _TranslationsReceiptScanDz._(_root);
	@override late final _TranslationsBatchCookingDz batchCooking = _TranslationsBatchCookingDz._(_root);
	@override late final _TranslationsVisitedDomainsDz visitedDomains = _TranslationsVisitedDomainsDz._(_root);
	@override late final _TranslationsDomainDiscoveryDz domainDiscovery = _TranslationsDomainDiscoveryDz._(_root);
	@override late final _TranslationsInventorySuggestionsDz inventorySuggestions = _TranslationsInventorySuggestionsDz._(_root);
	@override late final _TranslationsUpgradeDz upgrade = _TranslationsUpgradeDz._(_root);
	@override late final _TranslationsTourDz tour = _TranslationsTourDz._(_root);
	@override late final _TranslationsManualRecipeDz manualRecipe = _TranslationsManualRecipeDz._(_root);
	@override late final _TranslationsRecipeEditDz recipeEdit = _TranslationsRecipeEditDz._(_root);
	@override late final _TranslationsErrorsDz errors = _TranslationsErrorsDz._(_root);
}

// Path: app
class _TranslationsAppDz extends TranslationsAppEn {
	_TranslationsAppDz._(TranslationsDz root) : this._root = root, super.internal(root);

	final TranslationsDz _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeDz extends TranslationsHomeEn {
	_TranslationsHomeDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonDz extends TranslationsCommonEn {
	_TranslationsCommonDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsDz extends TranslationsSettingsEn {
	_TranslationsSettingsDz._(TranslationsDz root) : this._root = root, super.internal(root);

	final TranslationsDz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsDz measurements = _TranslationsSettingsMeasurementsDz._(_root);
	@override late final _TranslationsSettingsDataManagementDz dataManagement = _TranslationsSettingsDataManagementDz._(_root);
	@override late final _TranslationsSettingsVersionDz version = _TranslationsSettingsVersionDz._(_root);
}

// Path: recipes
class _TranslationsRecipesDz extends TranslationsRecipesEn {
	_TranslationsRecipesDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailDz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailDz._(TranslationsDz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionDz nutrition = _TranslationsRecipeDetailNutritionDz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadDz prepAhead = _TranslationsRecipeDetailPrepAheadDz._(_root);
...
// Path: filters
class _TranslationsFiltersDz extends TranslationsFiltersEn {
	_TranslationsFiltersDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListDz extends TranslationsShoppingListEn {
	_TranslationsShoppingListDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanDz extends TranslationsMealPlanEn {
	_TranslationsMealPlanDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryDz extends TranslationsInventoryEn {
	_TranslationsInventoryDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanDz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanDz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingDz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsDz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryDz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsDz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeDz extends TranslationsUpgradeEn {
	_TranslationsUpgradeDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourDz extends TranslationsTourEn {
	_TranslationsTourDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeDz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditDz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsDz extends TranslationsErrorsEn {
	_TranslationsErrorsDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsDz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsDz._(TranslationsDz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricDz metric = _TranslationsSettingsMeasurementsMetricDz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialDz imperial = _TranslationsSettingsMeasurementsImperialDz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementDz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionDz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionDz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadDz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricDz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialDz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialDz._(TranslationsDz root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <dz>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsDz {
