...
// Path: <root>
class TranslationsBm extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsBm({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <bm>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsBm _root = this; // ignore: unused_field

	@override 
	TranslationsBm $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsBm(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppBm app = _TranslationsAppBm._(_root);
	@override late final _TranslationsHomeBm home = _TranslationsHomeBm._(_root);
	@override late final _TranslationsCommonBm common = _TranslationsCommonBm._(_root);
	@override late final _TranslationsSettingsBm settings = _TranslationsSettingsBm._(_root);
	@override late final _TranslationsRecipesBm recipes = _TranslationsRecipesBm._(_root);
	@override late final _TranslationsRecipeDetailBm recipeDetail = _TranslationsRecipeDetailBm._(_root);
	@override late final _TranslationsFiltersBm filters = _TranslationsFiltersBm._(_root);
	@override late final _TranslationsShoppingListBm shoppingList = _TranslationsShoppingListBm._(_root);
	@override late final _TranslationsMealPlanBm mealPlan = _TranslationsMealPlanBm._(_root);
	@override late final _TranslationsInventoryBm inventory = _TranslationsInventoryBm._(_root);
	@override late final _TranslationsBarcodeScanBm barcodeScan = _TranslationsBarcodeScanBm._(_root);
	@override late final _TranslationsReceiptScanBm receiptScan = _TranslationsReceiptScanBm._(_root);
	@override late final _TranslationsBatchCookingBm batchCooking = _TranslationsBatchCookingBm._(_root);
	@override late final _TranslationsVisitedDomainsBm visitedDomains = _TranslationsVisitedDomainsBm._(_root);
	@override late final _TranslationsDomainDiscoveryBm domainDiscovery = _TranslationsDomainDiscoveryBm._(_root);
	@override late final _TranslationsInventorySuggestionsBm inventorySuggestions = _TranslationsInventorySuggestionsBm._(_root);
	@override late final _TranslationsUpgradeBm upgrade = _TranslationsUpgradeBm._(_root);
	@override late final _TranslationsTourBm tour = _TranslationsTourBm._(_root);
	@override late final _TranslationsManualRecipeBm manualRecipe = _TranslationsManualRecipeBm._(_root);
	@override late final _TranslationsRecipeEditBm recipeEdit = _TranslationsRecipeEditBm._(_root);
	@override late final _TranslationsErrorsBm errors = _TranslationsErrorsBm._(_root);
}

// Path: app
class _TranslationsAppBm extends TranslationsAppEn {
	_TranslationsAppBm._(TranslationsBm root) : this._root = root, super.internal(root);

	final TranslationsBm _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeBm extends TranslationsHomeEn {
	_TranslationsHomeBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBm extends TranslationsCommonEn {
	_TranslationsCommonBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsBm extends TranslationsSettingsEn {
	_TranslationsSettingsBm._(TranslationsBm root) : this._root = root, super.internal(root);

	final TranslationsBm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBm measurements = _TranslationsSettingsMeasurementsBm._(_root);
	@override late final _TranslationsSettingsDataManagementBm dataManagement = _TranslationsSettingsDataManagementBm._(_root);
	@override late final _TranslationsSettingsVersionBm version = _TranslationsSettingsVersionBm._(_root);
}

// Path: recipes
class _TranslationsRecipesBm extends TranslationsRecipesEn {
	_TranslationsRecipesBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBm._(TranslationsBm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBm nutrition = _TranslationsRecipeDetailNutritionBm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBm prepAhead = _TranslationsRecipeDetailPrepAheadBm._(_root);
...
// Path: filters
class _TranslationsFiltersBm extends TranslationsFiltersEn {
	_TranslationsFiltersBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBm extends TranslationsShoppingListEn {
	_TranslationsShoppingListBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBm extends TranslationsMealPlanEn {
	_TranslationsMealPlanBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBm extends TranslationsInventoryEn {
	_TranslationsInventoryBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBm extends TranslationsUpgradeEn {
	_TranslationsUpgradeBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBm extends TranslationsTourEn {
	_TranslationsTourBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBm extends TranslationsErrorsEn {
	_TranslationsErrorsBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBm._(TranslationsBm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBm metric = _TranslationsSettingsMeasurementsMetricBm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBm imperial = _TranslationsSettingsMeasurementsImperialBm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBm._(TranslationsBm root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <bm>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsBm {
