...
class TranslationsTk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppTk app = _TranslationsAppTk._(_root);
	...
	@override late final _TranslationsSettingsTk settings = _TranslationsSettingsTk._(_root);
	@override late final _TranslationsRecipesTk recipes = _TranslationsRecipesTk._(_root);
	@override late final _TranslationsRecipeDetailTk recipeDetail = _TranslationsRecipeDetailTk._(_root);
	@override late final _TranslationsFiltersTk filters = _TranslationsFiltersTk._(_root);
	@override late final _TranslationsShoppingListTk shoppingList = _TranslationsShoppingListTk._(_root);
	@override late final _TranslationsMealPlanTk mealPlan = _TranslationsMealPlanTk._(_root);
	@override late final _TranslationsInventoryTk inventory = _TranslationsInventoryTk._(_root);
	@override late final _TranslationsBarcodeScanTk barcodeScan = _TranslationsBarcodeScanTk._(_root);
	@override late final _TranslationsReceiptScanTk receiptScan = _TranslationsReceiptScanTk._(_root);
	@override late final _TranslationsBatchCookingTk batchCooking = _TranslationsBatchCookingTk._(_root);
	@override late final _TranslationsVisitedDomainsTk visitedDomains = _TranslationsVisitedDomainsTk._(_root);
	@override late final _TranslationsDomainDiscoveryTk domainDiscovery = _TranslationsDomainDiscoveryTk._(_root);
	@override late final _TranslationsInventorySuggestionsTk inventorySuggestions = _TranslationsInventorySuggestionsTk._(_root);
	@override late final _TranslationsUpgradeTk upgrade = _TranslationsUpgradeTk._(_root);
	@override late final _TranslationsTourTk tour = _TranslationsTourTk._(_root);
	@override late final _TranslationsManualRecipeTk manualRecipe = _TranslationsManualRecipeTk._(_root);
	@override late final _TranslationsRecipeEditTk recipeEdit = _TranslationsRecipeEditTk._(_root);
	@override late final _TranslationsErrorsTk errors = _TranslationsErrorsTk._(_root);
}

// Path: app
class _TranslationsAppTk extends TranslationsAppEn {
	_TranslationsAppTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeTk extends TranslationsHomeEn {
...
// Path: common
class _TranslationsCommonTk extends TranslationsCommonEn {
...
// Path: settings
class _TranslationsSettingsTk extends TranslationsSettingsEn {
	_TranslationsSettingsTk._(TranslationsTk root) : this._root = root, super.internal(root);

	final TranslationsTk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTk measurements = _TranslationsSettingsMeasurementsTk._(_root);
	@override late final _TranslationsSettingsDataManagementTk dataManagement = _TranslationsSettingsDataManagementTk._(_root);
	@override late final _TranslationsSettingsVersionTk version = _TranslationsSettingsVersionTk._(_root);
}

// Path: recipes
class _TranslationsRecipesTk extends TranslationsRecipesEn {
	_TranslationsRecipesTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTk._(TranslationsTk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTk nutrition = _TranslationsRecipeDetailNutritionTk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTk prepAhead = _TranslationsRecipeDetailPrepAheadTk._(_root);
...
// Path: filters
class _TranslationsFiltersTk extends TranslationsFiltersEn {
	_TranslationsFiltersTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTk extends TranslationsShoppingListEn {
	_TranslationsShoppingListTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTk extends TranslationsMealPlanEn {
	_TranslationsMealPlanTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTk extends TranslationsInventoryEn {
	_TranslationsInventoryTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTk extends TranslationsUpgradeEn {
	_TranslationsUpgradeTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTk extends TranslationsTourEn {
	_TranslationsTourTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTk extends TranslationsErrorsEn {
	_TranslationsErrorsTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTk._(TranslationsTk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTk metric = _TranslationsSettingsMeasurementsMetricTk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTk imperial = _TranslationsSettingsMeasurementsImperialTk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTk._(TranslationsTk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTk._(TranslationsTk root) : this._root = root, super.internal(root);
