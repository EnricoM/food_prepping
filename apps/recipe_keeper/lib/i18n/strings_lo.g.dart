...
class TranslationsLo extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsHomeLo home = _TranslationsHomeLo._(_root);
	...
	@override late final _TranslationsRecipesLo recipes = _TranslationsRecipesLo._(_root);
	@override late final _TranslationsRecipeDetailLo recipeDetail = _TranslationsRecipeDetailLo._(_root);
	@override late final _TranslationsFiltersLo filters = _TranslationsFiltersLo._(_root);
	@override late final _TranslationsShoppingListLo shoppingList = _TranslationsShoppingListLo._(_root);
	@override late final _TranslationsMealPlanLo mealPlan = _TranslationsMealPlanLo._(_root);
	@override late final _TranslationsInventoryLo inventory = _TranslationsInventoryLo._(_root);
	@override late final _TranslationsBarcodeScanLo barcodeScan = _TranslationsBarcodeScanLo._(_root);
	@override late final _TranslationsReceiptScanLo receiptScan = _TranslationsReceiptScanLo._(_root);
	@override late final _TranslationsBatchCookingLo batchCooking = _TranslationsBatchCookingLo._(_root);
	@override late final _TranslationsVisitedDomainsLo visitedDomains = _TranslationsVisitedDomainsLo._(_root);
	@override late final _TranslationsDomainDiscoveryLo domainDiscovery = _TranslationsDomainDiscoveryLo._(_root);
	@override late final _TranslationsInventorySuggestionsLo inventorySuggestions = _TranslationsInventorySuggestionsLo._(_root);
	@override late final _TranslationsUpgradeLo upgrade = _TranslationsUpgradeLo._(_root);
	@override late final _TranslationsTourLo tour = _TranslationsTourLo._(_root);
	@override late final _TranslationsManualRecipeLo manualRecipe = _TranslationsManualRecipeLo._(_root);
	@override late final _TranslationsRecipeEditLo recipeEdit = _TranslationsRecipeEditLo._(_root);
	@override late final _TranslationsErrorsLo errors = _TranslationsErrorsLo._(_root);
}
...
// Path: home
class _TranslationsHomeLo extends TranslationsHomeEn {
	_TranslationsHomeLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsLo extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsLo measurements = _TranslationsSettingsMeasurementsLo._(_root);
	@override late final _TranslationsSettingsDataManagementLo dataManagement = _TranslationsSettingsDataManagementLo._(_root);
	@override late final _TranslationsSettingsVersionLo version = _TranslationsSettingsVersionLo._(_root);
}

// Path: recipes
class _TranslationsRecipesLo extends TranslationsRecipesEn {
	_TranslationsRecipesLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLo._(TranslationsLo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLo nutrition = _TranslationsRecipeDetailNutritionLo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLo prepAhead = _TranslationsRecipeDetailPrepAheadLo._(_root);
...
// Path: filters
class _TranslationsFiltersLo extends TranslationsFiltersEn {
	_TranslationsFiltersLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLo extends TranslationsShoppingListEn {
	_TranslationsShoppingListLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLo extends TranslationsMealPlanEn {
	_TranslationsMealPlanLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLo extends TranslationsUpgradeEn {
	_TranslationsUpgradeLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLo extends TranslationsTourEn {
	_TranslationsTourLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLo extends TranslationsErrorsEn {
	_TranslationsErrorsLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLo._(TranslationsLo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLo metric = _TranslationsSettingsMeasurementsMetricLo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLo imperial = _TranslationsSettingsMeasurementsImperialLo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLo._(TranslationsLo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLo._(TranslationsLo root) : this._root = root, super.internal(root);
