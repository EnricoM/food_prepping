...
class TranslationsSr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppSr app = _TranslationsAppSr._(_root);
	@override late final _TranslationsHomeSr home = _TranslationsHomeSr._(_root);
	...
	@override late final _TranslationsRecipesSr recipes = _TranslationsRecipesSr._(_root);
	@override late final _TranslationsRecipeDetailSr recipeDetail = _TranslationsRecipeDetailSr._(_root);
	@override late final _TranslationsFiltersSr filters = _TranslationsFiltersSr._(_root);
	@override late final _TranslationsShoppingListSr shoppingList = _TranslationsShoppingListSr._(_root);
	@override late final _TranslationsMealPlanSr mealPlan = _TranslationsMealPlanSr._(_root);
	@override late final _TranslationsInventorySr inventory = _TranslationsInventorySr._(_root);
	@override late final _TranslationsBarcodeScanSr barcodeScan = _TranslationsBarcodeScanSr._(_root);
	@override late final _TranslationsReceiptScanSr receiptScan = _TranslationsReceiptScanSr._(_root);
	@override late final _TranslationsBatchCookingSr batchCooking = _TranslationsBatchCookingSr._(_root);
	@override late final _TranslationsVisitedDomainsSr visitedDomains = _TranslationsVisitedDomainsSr._(_root);
	@override late final _TranslationsDomainDiscoverySr domainDiscovery = _TranslationsDomainDiscoverySr._(_root);
	@override late final _TranslationsInventorySuggestionsSr inventorySuggestions = _TranslationsInventorySuggestionsSr._(_root);
	@override late final _TranslationsUpgradeSr upgrade = _TranslationsUpgradeSr._(_root);
	@override late final _TranslationsTourSr tour = _TranslationsTourSr._(_root);
	@override late final _TranslationsManualRecipeSr manualRecipe = _TranslationsManualRecipeSr._(_root);
	@override late final _TranslationsRecipeEditSr recipeEdit = _TranslationsRecipeEditSr._(_root);
	@override late final _TranslationsErrorsSr errors = _TranslationsErrorsSr._(_root);
}

// Path: app
class _TranslationsAppSr extends TranslationsAppEn {
	_TranslationsAppSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeSr extends TranslationsHomeEn {
	_TranslationsHomeSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSr extends TranslationsCommonEn {
	_TranslationsCommonSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsSr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsSr measurements = _TranslationsSettingsMeasurementsSr._(_root);
	@override late final _TranslationsSettingsDataManagementSr dataManagement = _TranslationsSettingsDataManagementSr._(_root);
	@override late final _TranslationsSettingsVersionSr version = _TranslationsSettingsVersionSr._(_root);
}

// Path: recipes
class _TranslationsRecipesSr extends TranslationsRecipesEn {
	_TranslationsRecipesSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSr._(TranslationsSr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSr nutrition = _TranslationsRecipeDetailNutritionSr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSr prepAhead = _TranslationsRecipeDetailPrepAheadSr._(_root);
...
// Path: filters
class _TranslationsFiltersSr extends TranslationsFiltersEn {
	_TranslationsFiltersSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSr extends TranslationsShoppingListEn {
	_TranslationsShoppingListSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSr extends TranslationsMealPlanEn {
	_TranslationsMealPlanSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySr extends TranslationsInventoryEn {
	_TranslationsInventorySr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSr extends TranslationsUpgradeEn {
	_TranslationsUpgradeSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSr extends TranslationsTourEn {
	_TranslationsTourSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSr extends TranslationsErrorsEn {
	_TranslationsErrorsSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSr._(TranslationsSr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSr metric = _TranslationsSettingsMeasurementsMetricSr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSr imperial = _TranslationsSettingsMeasurementsImperialSr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSr._(TranslationsSr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSr._(TranslationsSr root) : this._root = root, super.internal(root);
