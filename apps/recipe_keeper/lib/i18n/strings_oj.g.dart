...
// Path: <root>
class TranslationsOj extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsOj({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <oj>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsOj _root = this; // ignore: unused_field

	@override 
	TranslationsOj $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsOj(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppOj app = _TranslationsAppOj._(_root);
	@override late final _TranslationsHomeOj home = _TranslationsHomeOj._(_root);
	@override late final _TranslationsCommonOj common = _TranslationsCommonOj._(_root);
	@override late final _TranslationsSettingsOj settings = _TranslationsSettingsOj._(_root);
	@override late final _TranslationsRecipesOj recipes = _TranslationsRecipesOj._(_root);
	@override late final _TranslationsRecipeDetailOj recipeDetail = _TranslationsRecipeDetailOj._(_root);
	@override late final _TranslationsFiltersOj filters = _TranslationsFiltersOj._(_root);
	@override late final _TranslationsShoppingListOj shoppingList = _TranslationsShoppingListOj._(_root);
	@override late final _TranslationsMealPlanOj mealPlan = _TranslationsMealPlanOj._(_root);
	@override late final _TranslationsInventoryOj inventory = _TranslationsInventoryOj._(_root);
	@override late final _TranslationsBarcodeScanOj barcodeScan = _TranslationsBarcodeScanOj._(_root);
	@override late final _TranslationsReceiptScanOj receiptScan = _TranslationsReceiptScanOj._(_root);
	@override late final _TranslationsBatchCookingOj batchCooking = _TranslationsBatchCookingOj._(_root);
	@override late final _TranslationsVisitedDomainsOj visitedDomains = _TranslationsVisitedDomainsOj._(_root);
	@override late final _TranslationsDomainDiscoveryOj domainDiscovery = _TranslationsDomainDiscoveryOj._(_root);
	@override late final _TranslationsInventorySuggestionsOj inventorySuggestions = _TranslationsInventorySuggestionsOj._(_root);
	@override late final _TranslationsUpgradeOj upgrade = _TranslationsUpgradeOj._(_root);
	@override late final _TranslationsTourOj tour = _TranslationsTourOj._(_root);
	@override late final _TranslationsManualRecipeOj manualRecipe = _TranslationsManualRecipeOj._(_root);
	@override late final _TranslationsRecipeEditOj recipeEdit = _TranslationsRecipeEditOj._(_root);
	@override late final _TranslationsErrorsOj errors = _TranslationsErrorsOj._(_root);
}

// Path: app
class _TranslationsAppOj extends TranslationsAppEn {
	_TranslationsAppOj._(TranslationsOj root) : this._root = root, super.internal(root);

	final TranslationsOj _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeOj extends TranslationsHomeEn {
	_TranslationsHomeOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonOj extends TranslationsCommonEn {
	_TranslationsCommonOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsOj extends TranslationsSettingsEn {
	_TranslationsSettingsOj._(TranslationsOj root) : this._root = root, super.internal(root);

	final TranslationsOj _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsOj measurements = _TranslationsSettingsMeasurementsOj._(_root);
	@override late final _TranslationsSettingsDataManagementOj dataManagement = _TranslationsSettingsDataManagementOj._(_root);
	@override late final _TranslationsSettingsVersionOj version = _TranslationsSettingsVersionOj._(_root);
}

// Path: recipes
class _TranslationsRecipesOj extends TranslationsRecipesEn {
	_TranslationsRecipesOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailOj extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailOj._(TranslationsOj root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionOj nutrition = _TranslationsRecipeDetailNutritionOj._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadOj prepAhead = _TranslationsRecipeDetailPrepAheadOj._(_root);
...
// Path: filters
class _TranslationsFiltersOj extends TranslationsFiltersEn {
	_TranslationsFiltersOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListOj extends TranslationsShoppingListEn {
	_TranslationsShoppingListOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanOj extends TranslationsMealPlanEn {
	_TranslationsMealPlanOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryOj extends TranslationsInventoryEn {
	_TranslationsInventoryOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanOj extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanOj extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingOj extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsOj extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryOj extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsOj extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeOj extends TranslationsUpgradeEn {
	_TranslationsUpgradeOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourOj extends TranslationsTourEn {
	_TranslationsTourOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeOj extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditOj extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsOj extends TranslationsErrorsEn {
	_TranslationsErrorsOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsOj extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsOj._(TranslationsOj root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricOj metric = _TranslationsSettingsMeasurementsMetricOj._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialOj imperial = _TranslationsSettingsMeasurementsImperialOj._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementOj extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionOj extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionOj extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadOj extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricOj extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialOj extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialOj._(TranslationsOj root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <oj>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsOj {
