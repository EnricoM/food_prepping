...
// Path: <root>
class TranslationsXhZa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsXhZa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.xhZa,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <xh-ZA>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsXhZa _root = this; // ignore: unused_field

	@override 
	TranslationsXhZa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsXhZa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppXhZa app = _TranslationsAppXhZa._(_root);
	@override late final _TranslationsHomeXhZa home = _TranslationsHomeXhZa._(_root);
	@override late final _TranslationsCommonXhZa common = _TranslationsCommonXhZa._(_root);
	@override late final _TranslationsSettingsXhZa settings = _TranslationsSettingsXhZa._(_root);
	@override late final _TranslationsRecipesXhZa recipes = _TranslationsRecipesXhZa._(_root);
	@override late final _TranslationsRecipeDetailXhZa recipeDetail = _TranslationsRecipeDetailXhZa._(_root);
	@override late final _TranslationsFiltersXhZa filters = _TranslationsFiltersXhZa._(_root);
	@override late final _TranslationsShoppingListXhZa shoppingList = _TranslationsShoppingListXhZa._(_root);
	@override late final _TranslationsMealPlanXhZa mealPlan = _TranslationsMealPlanXhZa._(_root);
	@override late final _TranslationsInventoryXhZa inventory = _TranslationsInventoryXhZa._(_root);
	@override late final _TranslationsBarcodeScanXhZa barcodeScan = _TranslationsBarcodeScanXhZa._(_root);
	@override late final _TranslationsReceiptScanXhZa receiptScan = _TranslationsReceiptScanXhZa._(_root);
	@override late final _TranslationsBatchCookingXhZa batchCooking = _TranslationsBatchCookingXhZa._(_root);
	@override late final _TranslationsVisitedDomainsXhZa visitedDomains = _TranslationsVisitedDomainsXhZa._(_root);
	@override late final _TranslationsDomainDiscoveryXhZa domainDiscovery = _TranslationsDomainDiscoveryXhZa._(_root);
	@override late final _TranslationsInventorySuggestionsXhZa inventorySuggestions = _TranslationsInventorySuggestionsXhZa._(_root);
	@override late final _TranslationsUpgradeXhZa upgrade = _TranslationsUpgradeXhZa._(_root);
	@override late final _TranslationsTourXhZa tour = _TranslationsTourXhZa._(_root);
	@override late final _TranslationsManualRecipeXhZa manualRecipe = _TranslationsManualRecipeXhZa._(_root);
	@override late final _TranslationsRecipeEditXhZa recipeEdit = _TranslationsRecipeEditXhZa._(_root);
	@override late final _TranslationsErrorsXhZa errors = _TranslationsErrorsXhZa._(_root);
}

// Path: app
class _TranslationsAppXhZa extends TranslationsAppEn {
	_TranslationsAppXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);

	final TranslationsXhZa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeXhZa extends TranslationsHomeEn {
	_TranslationsHomeXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonXhZa extends TranslationsCommonEn {
	_TranslationsCommonXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsXhZa extends TranslationsSettingsEn {
	_TranslationsSettingsXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);

	final TranslationsXhZa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsXhZa measurements = _TranslationsSettingsMeasurementsXhZa._(_root);
	@override late final _TranslationsSettingsDataManagementXhZa dataManagement = _TranslationsSettingsDataManagementXhZa._(_root);
	@override late final _TranslationsSettingsVersionXhZa version = _TranslationsSettingsVersionXhZa._(_root);
}

// Path: recipes
class _TranslationsRecipesXhZa extends TranslationsRecipesEn {
	_TranslationsRecipesXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailXhZa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionXhZa nutrition = _TranslationsRecipeDetailNutritionXhZa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadXhZa prepAhead = _TranslationsRecipeDetailPrepAheadXhZa._(_root);
...
// Path: filters
class _TranslationsFiltersXhZa extends TranslationsFiltersEn {
	_TranslationsFiltersXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListXhZa extends TranslationsShoppingListEn {
	_TranslationsShoppingListXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanXhZa extends TranslationsMealPlanEn {
	_TranslationsMealPlanXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryXhZa extends TranslationsInventoryEn {
	_TranslationsInventoryXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanXhZa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanXhZa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingXhZa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsXhZa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryXhZa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsXhZa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeXhZa extends TranslationsUpgradeEn {
	_TranslationsUpgradeXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourXhZa extends TranslationsTourEn {
	_TranslationsTourXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeXhZa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditXhZa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsXhZa extends TranslationsErrorsEn {
	_TranslationsErrorsXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsXhZa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricXhZa metric = _TranslationsSettingsMeasurementsMetricXhZa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialXhZa imperial = _TranslationsSettingsMeasurementsImperialXhZa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementXhZa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionXhZa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionXhZa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadXhZa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricXhZa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialXhZa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialXhZa._(TranslationsXhZa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <xh-ZA>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsXhZa {
