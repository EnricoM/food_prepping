...
// Path: <root>
class TranslationsKl extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKl({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <kl>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKl _root = this; // ignore: unused_field

	@override 
	TranslationsKl $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKl(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKl app = _TranslationsAppKl._(_root);
	@override late final _TranslationsHomeKl home = _TranslationsHomeKl._(_root);
	@override late final _TranslationsCommonKl common = _TranslationsCommonKl._(_root);
	@override late final _TranslationsSettingsKl settings = _TranslationsSettingsKl._(_root);
	@override late final _TranslationsRecipesKl recipes = _TranslationsRecipesKl._(_root);
	@override late final _TranslationsRecipeDetailKl recipeDetail = _TranslationsRecipeDetailKl._(_root);
	@override late final _TranslationsFiltersKl filters = _TranslationsFiltersKl._(_root);
	@override late final _TranslationsShoppingListKl shoppingList = _TranslationsShoppingListKl._(_root);
	@override late final _TranslationsMealPlanKl mealPlan = _TranslationsMealPlanKl._(_root);
	@override late final _TranslationsInventoryKl inventory = _TranslationsInventoryKl._(_root);
	@override late final _TranslationsBarcodeScanKl barcodeScan = _TranslationsBarcodeScanKl._(_root);
	@override late final _TranslationsReceiptScanKl receiptScan = _TranslationsReceiptScanKl._(_root);
	@override late final _TranslationsBatchCookingKl batchCooking = _TranslationsBatchCookingKl._(_root);
	@override late final _TranslationsVisitedDomainsKl visitedDomains = _TranslationsVisitedDomainsKl._(_root);
	@override late final _TranslationsDomainDiscoveryKl domainDiscovery = _TranslationsDomainDiscoveryKl._(_root);
	@override late final _TranslationsInventorySuggestionsKl inventorySuggestions = _TranslationsInventorySuggestionsKl._(_root);
	@override late final _TranslationsUpgradeKl upgrade = _TranslationsUpgradeKl._(_root);
	@override late final _TranslationsTourKl tour = _TranslationsTourKl._(_root);
	@override late final _TranslationsManualRecipeKl manualRecipe = _TranslationsManualRecipeKl._(_root);
	@override late final _TranslationsRecipeEditKl recipeEdit = _TranslationsRecipeEditKl._(_root);
	@override late final _TranslationsErrorsKl errors = _TranslationsErrorsKl._(_root);
}

// Path: app
class _TranslationsAppKl extends TranslationsAppEn {
	_TranslationsAppKl._(TranslationsKl root) : this._root = root, super.internal(root);

	final TranslationsKl _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKl extends TranslationsHomeEn {
	_TranslationsHomeKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKl extends TranslationsCommonEn {
	_TranslationsCommonKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKl extends TranslationsSettingsEn {
	_TranslationsSettingsKl._(TranslationsKl root) : this._root = root, super.internal(root);

	final TranslationsKl _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKl measurements = _TranslationsSettingsMeasurementsKl._(_root);
	@override late final _TranslationsSettingsDataManagementKl dataManagement = _TranslationsSettingsDataManagementKl._(_root);
	@override late final _TranslationsSettingsVersionKl version = _TranslationsSettingsVersionKl._(_root);
}

// Path: recipes
class _TranslationsRecipesKl extends TranslationsRecipesEn {
	_TranslationsRecipesKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKl._(TranslationsKl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKl nutrition = _TranslationsRecipeDetailNutritionKl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKl prepAhead = _TranslationsRecipeDetailPrepAheadKl._(_root);
...
// Path: filters
class _TranslationsFiltersKl extends TranslationsFiltersEn {
	_TranslationsFiltersKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKl extends TranslationsShoppingListEn {
	_TranslationsShoppingListKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKl extends TranslationsMealPlanEn {
	_TranslationsMealPlanKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKl extends TranslationsInventoryEn {
	_TranslationsInventoryKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKl extends TranslationsUpgradeEn {
	_TranslationsUpgradeKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKl extends TranslationsTourEn {
	_TranslationsTourKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKl extends TranslationsErrorsEn {
	_TranslationsErrorsKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKl._(TranslationsKl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKl metric = _TranslationsSettingsMeasurementsMetricKl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKl imperial = _TranslationsSettingsMeasurementsImperialKl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKl._(TranslationsKl root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kl>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKl {
