...
// Path: <root>
class TranslationsSn extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSn({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <sn>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSn _root = this; // ignore: unused_field

	@override 
	TranslationsSn $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSn(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSn app = _TranslationsAppSn._(_root);
	@override late final _TranslationsHomeSn home = _TranslationsHomeSn._(_root);
	@override late final _TranslationsCommonSn common = _TranslationsCommonSn._(_root);
	@override late final _TranslationsSettingsSn settings = _TranslationsSettingsSn._(_root);
	@override late final _TranslationsRecipesSn recipes = _TranslationsRecipesSn._(_root);
	@override late final _TranslationsRecipeDetailSn recipeDetail = _TranslationsRecipeDetailSn._(_root);
	@override late final _TranslationsFiltersSn filters = _TranslationsFiltersSn._(_root);
	@override late final _TranslationsShoppingListSn shoppingList = _TranslationsShoppingListSn._(_root);
	@override late final _TranslationsMealPlanSn mealPlan = _TranslationsMealPlanSn._(_root);
	@override late final _TranslationsInventorySn inventory = _TranslationsInventorySn._(_root);
	@override late final _TranslationsBarcodeScanSn barcodeScan = _TranslationsBarcodeScanSn._(_root);
	@override late final _TranslationsReceiptScanSn receiptScan = _TranslationsReceiptScanSn._(_root);
	@override late final _TranslationsBatchCookingSn batchCooking = _TranslationsBatchCookingSn._(_root);
	@override late final _TranslationsVisitedDomainsSn visitedDomains = _TranslationsVisitedDomainsSn._(_root);
	@override late final _TranslationsDomainDiscoverySn domainDiscovery = _TranslationsDomainDiscoverySn._(_root);
	@override late final _TranslationsInventorySuggestionsSn inventorySuggestions = _TranslationsInventorySuggestionsSn._(_root);
	@override late final _TranslationsUpgradeSn upgrade = _TranslationsUpgradeSn._(_root);
	@override late final _TranslationsTourSn tour = _TranslationsTourSn._(_root);
	@override late final _TranslationsManualRecipeSn manualRecipe = _TranslationsManualRecipeSn._(_root);
	@override late final _TranslationsRecipeEditSn recipeEdit = _TranslationsRecipeEditSn._(_root);
	@override late final _TranslationsErrorsSn errors = _TranslationsErrorsSn._(_root);
}

// Path: app
class _TranslationsAppSn extends TranslationsAppEn {
	_TranslationsAppSn._(TranslationsSn root) : this._root = root, super.internal(root);

	final TranslationsSn _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSn extends TranslationsHomeEn {
	_TranslationsHomeSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSn extends TranslationsCommonEn {
	_TranslationsCommonSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSn extends TranslationsSettingsEn {
	_TranslationsSettingsSn._(TranslationsSn root) : this._root = root, super.internal(root);

	final TranslationsSn _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSn measurements = _TranslationsSettingsMeasurementsSn._(_root);
	@override late final _TranslationsSettingsDataManagementSn dataManagement = _TranslationsSettingsDataManagementSn._(_root);
	@override late final _TranslationsSettingsVersionSn version = _TranslationsSettingsVersionSn._(_root);
}

// Path: recipes
class _TranslationsRecipesSn extends TranslationsRecipesEn {
	_TranslationsRecipesSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSn extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSn._(TranslationsSn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSn nutrition = _TranslationsRecipeDetailNutritionSn._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSn prepAhead = _TranslationsRecipeDetailPrepAheadSn._(_root);
...
// Path: filters
class _TranslationsFiltersSn extends TranslationsFiltersEn {
	_TranslationsFiltersSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSn extends TranslationsShoppingListEn {
	_TranslationsShoppingListSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSn extends TranslationsMealPlanEn {
	_TranslationsMealPlanSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySn extends TranslationsInventoryEn {
	_TranslationsInventorySn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSn extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSn extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSn extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSn extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySn extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSn extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSn extends TranslationsUpgradeEn {
	_TranslationsUpgradeSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSn extends TranslationsTourEn {
	_TranslationsTourSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSn extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSn extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSn extends TranslationsErrorsEn {
	_TranslationsErrorsSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSn extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSn._(TranslationsSn root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSn metric = _TranslationsSettingsMeasurementsMetricSn._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSn imperial = _TranslationsSettingsMeasurementsImperialSn._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSn extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSn extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSn extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSn extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSn extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSn extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSn._(TranslationsSn root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sn>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSn {
