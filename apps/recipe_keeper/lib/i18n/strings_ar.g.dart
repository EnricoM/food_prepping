...
class TranslationsAr extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesAr recipes = _TranslationsRecipesAr._(_root);
	@override late final _TranslationsRecipeDetailAr recipeDetail = _TranslationsRecipeDetailAr._(_root);
	@override late final _TranslationsFiltersAr filters = _TranslationsFiltersAr._(_root);
	@override late final _TranslationsShoppingListAr shoppingList = _TranslationsShoppingListAr._(_root);
	@override late final _TranslationsMealPlanAr mealPlan = _TranslationsMealPlanAr._(_root);
	@override late final _TranslationsInventoryAr inventory = _TranslationsInventoryAr._(_root);
	@override late final _TranslationsBarcodeScanAr barcodeScan = _TranslationsBarcodeScanAr._(_root);
	@override late final _TranslationsReceiptScanAr receiptScan = _TranslationsReceiptScanAr._(_root);
	@override late final _TranslationsBatchCookingAr batchCooking = _TranslationsBatchCookingAr._(_root);
	@override late final _TranslationsVisitedDomainsAr visitedDomains = _TranslationsVisitedDomainsAr._(_root);
	@override late final _TranslationsDomainDiscoveryAr domainDiscovery = _TranslationsDomainDiscoveryAr._(_root);
	@override late final _TranslationsInventorySuggestionsAr inventorySuggestions = _TranslationsInventorySuggestionsAr._(_root);
	@override late final _TranslationsUpgradeAr upgrade = _TranslationsUpgradeAr._(_root);
	@override late final _TranslationsTourAr tour = _TranslationsTourAr._(_root);
	@override late final _TranslationsManualRecipeAr manualRecipe = _TranslationsManualRecipeAr._(_root);
	@override late final _TranslationsRecipeEditAr recipeEdit = _TranslationsRecipeEditAr._(_root);
...
class _TranslationsSettingsAr extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsAr measurements = _TranslationsSettingsMeasurementsAr._(_root);
	@override late final _TranslationsSettingsDataManagementAr dataManagement = _TranslationsSettingsDataManagementAr._(_root);
	@override late final _TranslationsSettingsVersionAr version = _TranslationsSettingsVersionAr._(_root);
}

// Path: recipes
class _TranslationsRecipesAr extends TranslationsRecipesEn {
	_TranslationsRecipesAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAr extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAr._(TranslationsAr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAr nutrition = _TranslationsRecipeDetailNutritionAr._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAr prepAhead = _TranslationsRecipeDetailPrepAheadAr._(_root);
...
// Path: filters
class _TranslationsFiltersAr extends TranslationsFiltersEn {
	_TranslationsFiltersAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAr extends TranslationsShoppingListEn {
	_TranslationsShoppingListAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAr extends TranslationsMealPlanEn {
	_TranslationsMealPlanAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAr extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAr extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAr extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAr extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAr extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAr extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAr extends TranslationsUpgradeEn {
	_TranslationsUpgradeAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAr extends TranslationsTourEn {
	_TranslationsTourAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAr extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAr extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAr extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAr._(TranslationsAr root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAr metric = _TranslationsSettingsMeasurementsMetricAr._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAr imperial = _TranslationsSettingsMeasurementsImperialAr._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAr extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAr extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAr extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAr extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAr extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAr._(TranslationsAr root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAr extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAr._(TranslationsAr root) : this._root = root, super.internal(root);
