...
// Path: <root>
class TranslationsFy extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsFy({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <fy>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsFy _root = this; // ignore: unused_field

	@override 
	TranslationsFy $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsFy(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppFy app = _TranslationsAppFy._(_root);
	@override late final _TranslationsHomeFy home = _TranslationsHomeFy._(_root);
	@override late final _TranslationsCommonFy common = _TranslationsCommonFy._(_root);
	@override late final _TranslationsSettingsFy settings = _TranslationsSettingsFy._(_root);
	@override late final _TranslationsRecipesFy recipes = _TranslationsRecipesFy._(_root);
	@override late final _TranslationsRecipeDetailFy recipeDetail = _TranslationsRecipeDetailFy._(_root);
	@override late final _TranslationsFiltersFy filters = _TranslationsFiltersFy._(_root);
	@override late final _TranslationsShoppingListFy shoppingList = _TranslationsShoppingListFy._(_root);
	@override late final _TranslationsMealPlanFy mealPlan = _TranslationsMealPlanFy._(_root);
	@override late final _TranslationsInventoryFy inventory = _TranslationsInventoryFy._(_root);
	@override late final _TranslationsBarcodeScanFy barcodeScan = _TranslationsBarcodeScanFy._(_root);
	@override late final _TranslationsReceiptScanFy receiptScan = _TranslationsReceiptScanFy._(_root);
	@override late final _TranslationsBatchCookingFy batchCooking = _TranslationsBatchCookingFy._(_root);
	@override late final _TranslationsVisitedDomainsFy visitedDomains = _TranslationsVisitedDomainsFy._(_root);
	@override late final _TranslationsDomainDiscoveryFy domainDiscovery = _TranslationsDomainDiscoveryFy._(_root);
	@override late final _TranslationsInventorySuggestionsFy inventorySuggestions = _TranslationsInventorySuggestionsFy._(_root);
	@override late final _TranslationsUpgradeFy upgrade = _TranslationsUpgradeFy._(_root);
	@override late final _TranslationsTourFy tour = _TranslationsTourFy._(_root);
	@override late final _TranslationsManualRecipeFy manualRecipe = _TranslationsManualRecipeFy._(_root);
	@override late final _TranslationsRecipeEditFy recipeEdit = _TranslationsRecipeEditFy._(_root);
	@override late final _TranslationsErrorsFy errors = _TranslationsErrorsFy._(_root);
}

// Path: app
class _TranslationsAppFy extends TranslationsAppEn {
	_TranslationsAppFy._(TranslationsFy root) : this._root = root, super.internal(root);

	final TranslationsFy _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeFy extends TranslationsHomeEn {
	_TranslationsHomeFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonFy extends TranslationsCommonEn {
	_TranslationsCommonFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsFy extends TranslationsSettingsEn {
	_TranslationsSettingsFy._(TranslationsFy root) : this._root = root, super.internal(root);

	final TranslationsFy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsFy measurements = _TranslationsSettingsMeasurementsFy._(_root);
	@override late final _TranslationsSettingsDataManagementFy dataManagement = _TranslationsSettingsDataManagementFy._(_root);
	@override late final _TranslationsSettingsVersionFy version = _TranslationsSettingsVersionFy._(_root);
}

// Path: recipes
class _TranslationsRecipesFy extends TranslationsRecipesEn {
	_TranslationsRecipesFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailFy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailFy._(TranslationsFy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionFy nutrition = _TranslationsRecipeDetailNutritionFy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadFy prepAhead = _TranslationsRecipeDetailPrepAheadFy._(_root);
...
// Path: filters
class _TranslationsFiltersFy extends TranslationsFiltersEn {
	_TranslationsFiltersFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListFy extends TranslationsShoppingListEn {
	_TranslationsShoppingListFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanFy extends TranslationsMealPlanEn {
	_TranslationsMealPlanFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryFy extends TranslationsInventoryEn {
	_TranslationsInventoryFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanFy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanFy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingFy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsFy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryFy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsFy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeFy extends TranslationsUpgradeEn {
	_TranslationsUpgradeFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourFy extends TranslationsTourEn {
	_TranslationsTourFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeFy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditFy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsFy extends TranslationsErrorsEn {
	_TranslationsErrorsFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsFy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsFy._(TranslationsFy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricFy metric = _TranslationsSettingsMeasurementsMetricFy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialFy imperial = _TranslationsSettingsMeasurementsImperialFy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementFy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionFy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionFy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadFy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricFy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialFy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialFy._(TranslationsFy root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <fy>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsFy {
