...
class TranslationsKo extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesKo recipes = _TranslationsRecipesKo._(_root);
	@override late final _TranslationsRecipeDetailKo recipeDetail = _TranslationsRecipeDetailKo._(_root);
	@override late final _TranslationsFiltersKo filters = _TranslationsFiltersKo._(_root);
	@override late final _TranslationsShoppingListKo shoppingList = _TranslationsShoppingListKo._(_root);
	@override late final _TranslationsMealPlanKo mealPlan = _TranslationsMealPlanKo._(_root);
	@override late final _TranslationsInventoryKo inventory = _TranslationsInventoryKo._(_root);
	@override late final _TranslationsBarcodeScanKo barcodeScan = _TranslationsBarcodeScanKo._(_root);
	@override late final _TranslationsReceiptScanKo receiptScan = _TranslationsReceiptScanKo._(_root);
	@override late final _TranslationsBatchCookingKo batchCooking = _TranslationsBatchCookingKo._(_root);
	@override late final _TranslationsVisitedDomainsKo visitedDomains = _TranslationsVisitedDomainsKo._(_root);
	@override late final _TranslationsDomainDiscoveryKo domainDiscovery = _TranslationsDomainDiscoveryKo._(_root);
	@override late final _TranslationsInventorySuggestionsKo inventorySuggestions = _TranslationsInventorySuggestionsKo._(_root);
	@override late final _TranslationsUpgradeKo upgrade = _TranslationsUpgradeKo._(_root);
	@override late final _TranslationsTourKo tour = _TranslationsTourKo._(_root);
	@override late final _TranslationsManualRecipeKo manualRecipe = _TranslationsManualRecipeKo._(_root);
	@override late final _TranslationsRecipeEditKo recipeEdit = _TranslationsRecipeEditKo._(_root);
...
class _TranslationsSettingsKo extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsKo measurements = _TranslationsSettingsMeasurementsKo._(_root);
	@override late final _TranslationsSettingsDataManagementKo dataManagement = _TranslationsSettingsDataManagementKo._(_root);
	@override late final _TranslationsSettingsVersionKo version = _TranslationsSettingsVersionKo._(_root);
}

// Path: recipes
class _TranslationsRecipesKo extends TranslationsRecipesEn {
	_TranslationsRecipesKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKo extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKo._(TranslationsKo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKo nutrition = _TranslationsRecipeDetailNutritionKo._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKo prepAhead = _TranslationsRecipeDetailPrepAheadKo._(_root);
...
// Path: filters
class _TranslationsFiltersKo extends TranslationsFiltersEn {
	_TranslationsFiltersKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKo extends TranslationsShoppingListEn {
	_TranslationsShoppingListKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKo extends TranslationsMealPlanEn {
	_TranslationsMealPlanKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKo extends TranslationsInventoryEn {
	_TranslationsInventoryKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKo extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKo extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKo extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKo extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKo extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKo extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKo extends TranslationsUpgradeEn {
	_TranslationsUpgradeKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKo extends TranslationsTourEn {
	_TranslationsTourKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKo extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKo extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKo extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKo._(TranslationsKo root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKo metric = _TranslationsSettingsMeasurementsMetricKo._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKo imperial = _TranslationsSettingsMeasurementsImperialKo._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKo extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKo extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKo extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKo extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKo extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKo._(TranslationsKo root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKo extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKo._(TranslationsKo root) : this._root = root, super.internal(root);
