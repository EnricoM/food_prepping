...
// Path: <root>
class TranslationsTs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsTs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ts>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsTs _root = this; // ignore: unused_field

	@override 
	TranslationsTs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsTs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppTs app = _TranslationsAppTs._(_root);
	@override late final _TranslationsHomeTs home = _TranslationsHomeTs._(_root);
	@override late final _TranslationsCommonTs common = _TranslationsCommonTs._(_root);
	@override late final _TranslationsSettingsTs settings = _TranslationsSettingsTs._(_root);
	@override late final _TranslationsRecipesTs recipes = _TranslationsRecipesTs._(_root);
	@override late final _TranslationsRecipeDetailTs recipeDetail = _TranslationsRecipeDetailTs._(_root);
	@override late final _TranslationsFiltersTs filters = _TranslationsFiltersTs._(_root);
	@override late final _TranslationsShoppingListTs shoppingList = _TranslationsShoppingListTs._(_root);
	@override late final _TranslationsMealPlanTs mealPlan = _TranslationsMealPlanTs._(_root);
	@override late final _TranslationsInventoryTs inventory = _TranslationsInventoryTs._(_root);
	@override late final _TranslationsBarcodeScanTs barcodeScan = _TranslationsBarcodeScanTs._(_root);
	@override late final _TranslationsReceiptScanTs receiptScan = _TranslationsReceiptScanTs._(_root);
	@override late final _TranslationsBatchCookingTs batchCooking = _TranslationsBatchCookingTs._(_root);
	@override late final _TranslationsVisitedDomainsTs visitedDomains = _TranslationsVisitedDomainsTs._(_root);
	@override late final _TranslationsDomainDiscoveryTs domainDiscovery = _TranslationsDomainDiscoveryTs._(_root);
	@override late final _TranslationsInventorySuggestionsTs inventorySuggestions = _TranslationsInventorySuggestionsTs._(_root);
	@override late final _TranslationsUpgradeTs upgrade = _TranslationsUpgradeTs._(_root);
	@override late final _TranslationsTourTs tour = _TranslationsTourTs._(_root);
	@override late final _TranslationsManualRecipeTs manualRecipe = _TranslationsManualRecipeTs._(_root);
	@override late final _TranslationsRecipeEditTs recipeEdit = _TranslationsRecipeEditTs._(_root);
	@override late final _TranslationsErrorsTs errors = _TranslationsErrorsTs._(_root);
}

// Path: app
class _TranslationsAppTs extends TranslationsAppEn {
	_TranslationsAppTs._(TranslationsTs root) : this._root = root, super.internal(root);

	final TranslationsTs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeTs extends TranslationsHomeEn {
	_TranslationsHomeTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonTs extends TranslationsCommonEn {
	_TranslationsCommonTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsTs extends TranslationsSettingsEn {
	_TranslationsSettingsTs._(TranslationsTs root) : this._root = root, super.internal(root);

	final TranslationsTs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsTs measurements = _TranslationsSettingsMeasurementsTs._(_root);
	@override late final _TranslationsSettingsDataManagementTs dataManagement = _TranslationsSettingsDataManagementTs._(_root);
	@override late final _TranslationsSettingsVersionTs version = _TranslationsSettingsVersionTs._(_root);
}

// Path: recipes
class _TranslationsRecipesTs extends TranslationsRecipesEn {
	_TranslationsRecipesTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTs._(TranslationsTs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTs nutrition = _TranslationsRecipeDetailNutritionTs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTs prepAhead = _TranslationsRecipeDetailPrepAheadTs._(_root);
...
// Path: filters
class _TranslationsFiltersTs extends TranslationsFiltersEn {
	_TranslationsFiltersTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTs extends TranslationsShoppingListEn {
	_TranslationsShoppingListTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTs extends TranslationsMealPlanEn {
	_TranslationsMealPlanTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTs extends TranslationsInventoryEn {
	_TranslationsInventoryTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTs extends TranslationsUpgradeEn {
	_TranslationsUpgradeTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTs extends TranslationsTourEn {
	_TranslationsTourTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsTs extends TranslationsErrorsEn {
	_TranslationsErrorsTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTs._(TranslationsTs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTs metric = _TranslationsSettingsMeasurementsMetricTs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTs imperial = _TranslationsSettingsMeasurementsImperialTs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTs._(TranslationsTs root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ts>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsTs {
