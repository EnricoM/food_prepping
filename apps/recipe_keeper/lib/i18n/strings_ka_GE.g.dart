...
class TranslationsKaGe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppKaGe app = _TranslationsAppKaGe._(_root);
	@override late final _TranslationsHomeKaGe home = _TranslationsHomeKaGe._(_root);
	@override late final _TranslationsCommonKaGe common = _TranslationsCommonKaGe._(_root);
	@override late final _TranslationsSettingsKaGe settings = _TranslationsSettingsKaGe._(_root);
	@override late final _TranslationsRecipesKaGe recipes = _TranslationsRecipesKaGe._(_root);
	@override late final _TranslationsRecipeDetailKaGe recipeDetail = _TranslationsRecipeDetailKaGe._(_root);
	@override late final _TranslationsFiltersKaGe filters = _TranslationsFiltersKaGe._(_root);
	@override late final _TranslationsShoppingListKaGe shoppingList = _TranslationsShoppingListKaGe._(_root);
	@override late final _TranslationsMealPlanKaGe mealPlan = _TranslationsMealPlanKaGe._(_root);
	@override late final _TranslationsInventoryKaGe inventory = _TranslationsInventoryKaGe._(_root);
	@override late final _TranslationsBarcodeScanKaGe barcodeScan = _TranslationsBarcodeScanKaGe._(_root);
	@override late final _TranslationsReceiptScanKaGe receiptScan = _TranslationsReceiptScanKaGe._(_root);
	@override late final _TranslationsBatchCookingKaGe batchCooking = _TranslationsBatchCookingKaGe._(_root);
	@override late final _TranslationsVisitedDomainsKaGe visitedDomains = _TranslationsVisitedDomainsKaGe._(_root);
	@override late final _TranslationsDomainDiscoveryKaGe domainDiscovery = _TranslationsDomainDiscoveryKaGe._(_root);
	@override late final _TranslationsInventorySuggestionsKaGe inventorySuggestions = _TranslationsInventorySuggestionsKaGe._(_root);
	@override late final _TranslationsUpgradeKaGe upgrade = _TranslationsUpgradeKaGe._(_root);
	@override late final _TranslationsTourKaGe tour = _TranslationsTourKaGe._(_root);
	@override late final _TranslationsManualRecipeKaGe manualRecipe = _TranslationsManualRecipeKaGe._(_root);
	@override late final _TranslationsRecipeEditKaGe recipeEdit = _TranslationsRecipeEditKaGe._(_root);
	@override late final _TranslationsErrorsKaGe errors = _TranslationsErrorsKaGe._(_root);
}

// Path: app
class _TranslationsAppKaGe extends TranslationsAppEn {
	_TranslationsAppKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);

	final TranslationsKaGe _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKaGe extends TranslationsHomeEn {
	_TranslationsHomeKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKaGe extends TranslationsCommonEn {
	_TranslationsCommonKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKaGe extends TranslationsSettingsEn {
	_TranslationsSettingsKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);

	final TranslationsKaGe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKaGe measurements = _TranslationsSettingsMeasurementsKaGe._(_root);
	@override late final _TranslationsSettingsDataManagementKaGe dataManagement = _TranslationsSettingsDataManagementKaGe._(_root);
	@override late final _TranslationsSettingsVersionKaGe version = _TranslationsSettingsVersionKaGe._(_root);
}

// Path: recipes
class _TranslationsRecipesKaGe extends TranslationsRecipesEn {
	_TranslationsRecipesKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKaGe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKaGe nutrition = _TranslationsRecipeDetailNutritionKaGe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKaGe prepAhead = _TranslationsRecipeDetailPrepAheadKaGe._(_root);
...
// Path: filters
class _TranslationsFiltersKaGe extends TranslationsFiltersEn {
	_TranslationsFiltersKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKaGe extends TranslationsShoppingListEn {
	_TranslationsShoppingListKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKaGe extends TranslationsMealPlanEn {
	_TranslationsMealPlanKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKaGe extends TranslationsInventoryEn {
	_TranslationsInventoryKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKaGe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKaGe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKaGe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKaGe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKaGe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKaGe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKaGe extends TranslationsUpgradeEn {
	_TranslationsUpgradeKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKaGe extends TranslationsTourEn {
	_TranslationsTourKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKaGe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKaGe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKaGe extends TranslationsErrorsEn {
	_TranslationsErrorsKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKaGe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKaGe metric = _TranslationsSettingsMeasurementsMetricKaGe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKaGe imperial = _TranslationsSettingsMeasurementsImperialKaGe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKaGe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKaGe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKaGe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKaGe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKaGe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKaGe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKaGe._(TranslationsKaGe root) : this._root = root, super.internal(root);
