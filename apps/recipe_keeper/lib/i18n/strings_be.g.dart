...
class TranslationsBe extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsHomeBe home = _TranslationsHomeBe._(_root);
	@override late final _TranslationsCommonBe common = _TranslationsCommonBe._(_root);
	@override late final _TranslationsSettingsBe settings = _TranslationsSettingsBe._(_root);
	@override late final _TranslationsRecipesBe recipes = _TranslationsRecipesBe._(_root);
	@override late final _TranslationsRecipeDetailBe recipeDetail = _TranslationsRecipeDetailBe._(_root);
	@override late final _TranslationsFiltersBe filters = _TranslationsFiltersBe._(_root);
	@override late final _TranslationsShoppingListBe shoppingList = _TranslationsShoppingListBe._(_root);
	@override late final _TranslationsMealPlanBe mealPlan = _TranslationsMealPlanBe._(_root);
	@override late final _TranslationsInventoryBe inventory = _TranslationsInventoryBe._(_root);
	@override late final _TranslationsBarcodeScanBe barcodeScan = _TranslationsBarcodeScanBe._(_root);
	@override late final _TranslationsReceiptScanBe receiptScan = _TranslationsReceiptScanBe._(_root);
	@override late final _TranslationsBatchCookingBe batchCooking = _TranslationsBatchCookingBe._(_root);
	@override late final _TranslationsVisitedDomainsBe visitedDomains = _TranslationsVisitedDomainsBe._(_root);
	@override late final _TranslationsDomainDiscoveryBe domainDiscovery = _TranslationsDomainDiscoveryBe._(_root);
	@override late final _TranslationsInventorySuggestionsBe inventorySuggestions = _TranslationsInventorySuggestionsBe._(_root);
	@override late final _TranslationsUpgradeBe upgrade = _TranslationsUpgradeBe._(_root);
	@override late final _TranslationsTourBe tour = _TranslationsTourBe._(_root);
	@override late final _TranslationsManualRecipeBe manualRecipe = _TranslationsManualRecipeBe._(_root);
	@override late final _TranslationsRecipeEditBe recipeEdit = _TranslationsRecipeEditBe._(_root);
	@override late final _TranslationsErrorsBe errors = _TranslationsErrorsBe._(_root);
}

// Path: app
class _TranslationsAppBe extends TranslationsAppEn {
...
// Path: home
class _TranslationsHomeBe extends TranslationsHomeEn {
	_TranslationsHomeBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonBe extends TranslationsCommonEn {
...
// Path: settings
class _TranslationsSettingsBe extends TranslationsSettingsEn {
	_TranslationsSettingsBe._(TranslationsBe root) : this._root = root, super.internal(root);

	final TranslationsBe _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsBe measurements = _TranslationsSettingsMeasurementsBe._(_root);
	@override late final _TranslationsSettingsDataManagementBe dataManagement = _TranslationsSettingsDataManagementBe._(_root);
	@override late final _TranslationsSettingsVersionBe version = _TranslationsSettingsVersionBe._(_root);
}

// Path: recipes
class _TranslationsRecipesBe extends TranslationsRecipesEn {
	_TranslationsRecipesBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailBe extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailBe._(TranslationsBe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionBe nutrition = _TranslationsRecipeDetailNutritionBe._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadBe prepAhead = _TranslationsRecipeDetailPrepAheadBe._(_root);
...
// Path: filters
class _TranslationsFiltersBe extends TranslationsFiltersEn {
	_TranslationsFiltersBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListBe extends TranslationsShoppingListEn {
	_TranslationsShoppingListBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanBe extends TranslationsMealPlanEn {
	_TranslationsMealPlanBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryBe extends TranslationsInventoryEn {
	_TranslationsInventoryBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanBe extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanBe extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingBe extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsBe extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryBe extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsBe extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeBe extends TranslationsUpgradeEn {
	_TranslationsUpgradeBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourBe extends TranslationsTourEn {
	_TranslationsTourBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeBe extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditBe extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsBe extends TranslationsErrorsEn {
	_TranslationsErrorsBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsBe extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsBe._(TranslationsBe root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricBe metric = _TranslationsSettingsMeasurementsMetricBe._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialBe imperial = _TranslationsSettingsMeasurementsImperialBe._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementBe extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionBe extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionBe extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadBe extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricBe extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricBe._(TranslationsBe root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialBe extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialBe._(TranslationsBe root) : this._root = root, super.internal(root);
