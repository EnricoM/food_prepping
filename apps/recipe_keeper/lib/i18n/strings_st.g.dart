...
// Path: <root>
class TranslationsSt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <st>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSt _root = this; // ignore: unused_field

	@override 
	TranslationsSt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSt app = _TranslationsAppSt._(_root);
	@override late final _TranslationsHomeSt home = _TranslationsHomeSt._(_root);
	@override late final _TranslationsCommonSt common = _TranslationsCommonSt._(_root);
	@override late final _TranslationsSettingsSt settings = _TranslationsSettingsSt._(_root);
	@override late final _TranslationsRecipesSt recipes = _TranslationsRecipesSt._(_root);
	@override late final _TranslationsRecipeDetailSt recipeDetail = _TranslationsRecipeDetailSt._(_root);
	@override late final _TranslationsFiltersSt filters = _TranslationsFiltersSt._(_root);
	@override late final _TranslationsShoppingListSt shoppingList = _TranslationsShoppingListSt._(_root);
	@override late final _TranslationsMealPlanSt mealPlan = _TranslationsMealPlanSt._(_root);
	@override late final _TranslationsInventorySt inventory = _TranslationsInventorySt._(_root);
	@override late final _TranslationsBarcodeScanSt barcodeScan = _TranslationsBarcodeScanSt._(_root);
	@override late final _TranslationsReceiptScanSt receiptScan = _TranslationsReceiptScanSt._(_root);
	@override late final _TranslationsBatchCookingSt batchCooking = _TranslationsBatchCookingSt._(_root);
	@override late final _TranslationsVisitedDomainsSt visitedDomains = _TranslationsVisitedDomainsSt._(_root);
	@override late final _TranslationsDomainDiscoverySt domainDiscovery = _TranslationsDomainDiscoverySt._(_root);
	@override late final _TranslationsInventorySuggestionsSt inventorySuggestions = _TranslationsInventorySuggestionsSt._(_root);
	@override late final _TranslationsUpgradeSt upgrade = _TranslationsUpgradeSt._(_root);
	@override late final _TranslationsTourSt tour = _TranslationsTourSt._(_root);
	@override late final _TranslationsManualRecipeSt manualRecipe = _TranslationsManualRecipeSt._(_root);
	@override late final _TranslationsRecipeEditSt recipeEdit = _TranslationsRecipeEditSt._(_root);
	@override late final _TranslationsErrorsSt errors = _TranslationsErrorsSt._(_root);
}

// Path: app
class _TranslationsAppSt extends TranslationsAppEn {
	_TranslationsAppSt._(TranslationsSt root) : this._root = root, super.internal(root);

	final TranslationsSt _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSt extends TranslationsHomeEn {
	_TranslationsHomeSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSt extends TranslationsCommonEn {
	_TranslationsCommonSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSt extends TranslationsSettingsEn {
	_TranslationsSettingsSt._(TranslationsSt root) : this._root = root, super.internal(root);

	final TranslationsSt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSt measurements = _TranslationsSettingsMeasurementsSt._(_root);
	@override late final _TranslationsSettingsDataManagementSt dataManagement = _TranslationsSettingsDataManagementSt._(_root);
	@override late final _TranslationsSettingsVersionSt version = _TranslationsSettingsVersionSt._(_root);
}

// Path: recipes
class _TranslationsRecipesSt extends TranslationsRecipesEn {
	_TranslationsRecipesSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSt._(TranslationsSt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSt nutrition = _TranslationsRecipeDetailNutritionSt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSt prepAhead = _TranslationsRecipeDetailPrepAheadSt._(_root);
...
// Path: filters
class _TranslationsFiltersSt extends TranslationsFiltersEn {
	_TranslationsFiltersSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSt extends TranslationsShoppingListEn {
	_TranslationsShoppingListSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSt extends TranslationsMealPlanEn {
	_TranslationsMealPlanSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySt extends TranslationsInventoryEn {
	_TranslationsInventorySt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSt extends TranslationsUpgradeEn {
	_TranslationsUpgradeSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSt extends TranslationsTourEn {
	_TranslationsTourSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSt extends TranslationsErrorsEn {
	_TranslationsErrorsSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSt._(TranslationsSt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSt metric = _TranslationsSettingsMeasurementsMetricSt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSt imperial = _TranslationsSettingsMeasurementsImperialSt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSt._(TranslationsSt root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <st>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSt {
