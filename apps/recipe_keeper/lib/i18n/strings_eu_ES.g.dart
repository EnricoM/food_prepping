...
// Path: <root>
class TranslationsEuEs extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsEuEs({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.euEs,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <eu-ES>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsEuEs _root = this; // ignore: unused_field

	@override 
	TranslationsEuEs $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsEuEs(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppEuEs app = _TranslationsAppEuEs._(_root);
	@override late final _TranslationsHomeEuEs home = _TranslationsHomeEuEs._(_root);
	@override late final _TranslationsCommonEuEs common = _TranslationsCommonEuEs._(_root);
	@override late final _TranslationsSettingsEuEs settings = _TranslationsSettingsEuEs._(_root);
	@override late final _TranslationsRecipesEuEs recipes = _TranslationsRecipesEuEs._(_root);
	@override late final _TranslationsRecipeDetailEuEs recipeDetail = _TranslationsRecipeDetailEuEs._(_root);
	@override late final _TranslationsFiltersEuEs filters = _TranslationsFiltersEuEs._(_root);
	@override late final _TranslationsShoppingListEuEs shoppingList = _TranslationsShoppingListEuEs._(_root);
	@override late final _TranslationsMealPlanEuEs mealPlan = _TranslationsMealPlanEuEs._(_root);
	@override late final _TranslationsInventoryEuEs inventory = _TranslationsInventoryEuEs._(_root);
	@override late final _TranslationsBarcodeScanEuEs barcodeScan = _TranslationsBarcodeScanEuEs._(_root);
	@override late final _TranslationsReceiptScanEuEs receiptScan = _TranslationsReceiptScanEuEs._(_root);
	@override late final _TranslationsBatchCookingEuEs batchCooking = _TranslationsBatchCookingEuEs._(_root);
	@override late final _TranslationsVisitedDomainsEuEs visitedDomains = _TranslationsVisitedDomainsEuEs._(_root);
	@override late final _TranslationsDomainDiscoveryEuEs domainDiscovery = _TranslationsDomainDiscoveryEuEs._(_root);
	@override late final _TranslationsInventorySuggestionsEuEs inventorySuggestions = _TranslationsInventorySuggestionsEuEs._(_root);
	@override late final _TranslationsUpgradeEuEs upgrade = _TranslationsUpgradeEuEs._(_root);
	@override late final _TranslationsTourEuEs tour = _TranslationsTourEuEs._(_root);
	@override late final _TranslationsManualRecipeEuEs manualRecipe = _TranslationsManualRecipeEuEs._(_root);
	@override late final _TranslationsRecipeEditEuEs recipeEdit = _TranslationsRecipeEditEuEs._(_root);
	@override late final _TranslationsErrorsEuEs errors = _TranslationsErrorsEuEs._(_root);
}

// Path: app
class _TranslationsAppEuEs extends TranslationsAppEn {
	_TranslationsAppEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);

	final TranslationsEuEs _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeEuEs extends TranslationsHomeEn {
	_TranslationsHomeEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonEuEs extends TranslationsCommonEn {
	_TranslationsCommonEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsEuEs extends TranslationsSettingsEn {
	_TranslationsSettingsEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);

	final TranslationsEuEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsEuEs measurements = _TranslationsSettingsMeasurementsEuEs._(_root);
	@override late final _TranslationsSettingsDataManagementEuEs dataManagement = _TranslationsSettingsDataManagementEuEs._(_root);
	@override late final _TranslationsSettingsVersionEuEs version = _TranslationsSettingsVersionEuEs._(_root);
}

// Path: recipes
class _TranslationsRecipesEuEs extends TranslationsRecipesEn {
	_TranslationsRecipesEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEuEs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEuEs nutrition = _TranslationsRecipeDetailNutritionEuEs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEuEs prepAhead = _TranslationsRecipeDetailPrepAheadEuEs._(_root);
...
// Path: filters
class _TranslationsFiltersEuEs extends TranslationsFiltersEn {
	_TranslationsFiltersEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEuEs extends TranslationsShoppingListEn {
	_TranslationsShoppingListEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEuEs extends TranslationsMealPlanEn {
	_TranslationsMealPlanEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEuEs extends TranslationsInventoryEn {
	_TranslationsInventoryEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEuEs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEuEs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEuEs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEuEs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEuEs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEuEs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEuEs extends TranslationsUpgradeEn {
	_TranslationsUpgradeEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEuEs extends TranslationsTourEn {
	_TranslationsTourEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEuEs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEuEs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsEuEs extends TranslationsErrorsEn {
	_TranslationsErrorsEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEuEs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEuEs metric = _TranslationsSettingsMeasurementsMetricEuEs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEuEs imperial = _TranslationsSettingsMeasurementsImperialEuEs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEuEs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEuEs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEuEs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEuEs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEuEs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEuEs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEuEs._(TranslationsEuEs root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <eu-ES>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsEuEs {
