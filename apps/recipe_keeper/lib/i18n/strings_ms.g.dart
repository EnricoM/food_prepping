...
class TranslationsMs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppMs app = _TranslationsAppMs._(_root);
	...
	@override late final _TranslationsRecipesMs recipes = _TranslationsRecipesMs._(_root);
	@override late final _TranslationsRecipeDetailMs recipeDetail = _TranslationsRecipeDetailMs._(_root);
	@override late final _TranslationsFiltersMs filters = _TranslationsFiltersMs._(_root);
	@override late final _TranslationsShoppingListMs shoppingList = _TranslationsShoppingListMs._(_root);
	@override late final _TranslationsMealPlanMs mealPlan = _TranslationsMealPlanMs._(_root);
	@override late final _TranslationsInventoryMs inventory = _TranslationsInventoryMs._(_root);
	@override late final _TranslationsBarcodeScanMs barcodeScan = _TranslationsBarcodeScanMs._(_root);
	@override late final _TranslationsReceiptScanMs receiptScan = _TranslationsReceiptScanMs._(_root);
	@override late final _TranslationsBatchCookingMs batchCooking = _TranslationsBatchCookingMs._(_root);
	@override late final _TranslationsVisitedDomainsMs visitedDomains = _TranslationsVisitedDomainsMs._(_root);
	@override late final _TranslationsDomainDiscoveryMs domainDiscovery = _TranslationsDomainDiscoveryMs._(_root);
	@override late final _TranslationsInventorySuggestionsMs inventorySuggestions = _TranslationsInventorySuggestionsMs._(_root);
	@override late final _TranslationsUpgradeMs upgrade = _TranslationsUpgradeMs._(_root);
	@override late final _TranslationsTourMs tour = _TranslationsTourMs._(_root);
	@override late final _TranslationsManualRecipeMs manualRecipe = _TranslationsManualRecipeMs._(_root);
	@override late final _TranslationsRecipeEditMs recipeEdit = _TranslationsRecipeEditMs._(_root);
	@override late final _TranslationsErrorsMs errors = _TranslationsErrorsMs._(_root);
}

// Path: app
class _TranslationsAppMs extends TranslationsAppEn {
	_TranslationsAppMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMs extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsMs measurements = _TranslationsSettingsMeasurementsMs._(_root);
	@override late final _TranslationsSettingsDataManagementMs dataManagement = _TranslationsSettingsDataManagementMs._(_root);
	@override late final _TranslationsSettingsVersionMs version = _TranslationsSettingsVersionMs._(_root);
}

// Path: recipes
class _TranslationsRecipesMs extends TranslationsRecipesEn {
	_TranslationsRecipesMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailMs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailMs._(TranslationsMs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionMs nutrition = _TranslationsRecipeDetailNutritionMs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadMs prepAhead = _TranslationsRecipeDetailPrepAheadMs._(_root);
...
// Path: filters
class _TranslationsFiltersMs extends TranslationsFiltersEn {
	_TranslationsFiltersMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListMs extends TranslationsShoppingListEn {
	_TranslationsShoppingListMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanMs extends TranslationsMealPlanEn {
	_TranslationsMealPlanMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryMs extends TranslationsInventoryEn {
	_TranslationsInventoryMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanMs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanMs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingMs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsMs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryMs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsMs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeMs extends TranslationsUpgradeEn {
	_TranslationsUpgradeMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourMs extends TranslationsTourEn {
	_TranslationsTourMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeMs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditMs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsMs._(TranslationsMs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricMs metric = _TranslationsSettingsMeasurementsMetricMs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialMs imperial = _TranslationsSettingsMeasurementsImperialMs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementMs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionMs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionMs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadMs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricMs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricMs._(TranslationsMs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialMs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialMs._(TranslationsMs root) : this._root = root, super.internal(root);
