...
class TranslationsVi extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesVi recipes = _TranslationsRecipesVi._(_root);
	@override late final _TranslationsRecipeDetailVi recipeDetail = _TranslationsRecipeDetailVi._(_root);
	@override late final _TranslationsFiltersVi filters = _TranslationsFiltersVi._(_root);
	@override late final _TranslationsShoppingListVi shoppingList = _TranslationsShoppingListVi._(_root);
	@override late final _TranslationsMealPlanVi mealPlan = _TranslationsMealPlanVi._(_root);
	@override late final _TranslationsInventoryVi inventory = _TranslationsInventoryVi._(_root);
	@override late final _TranslationsBarcodeScanVi barcodeScan = _TranslationsBarcodeScanVi._(_root);
	@override late final _TranslationsReceiptScanVi receiptScan = _TranslationsReceiptScanVi._(_root);
	@override late final _TranslationsBatchCookingVi batchCooking = _TranslationsBatchCookingVi._(_root);
	@override late final _TranslationsVisitedDomainsVi visitedDomains = _TranslationsVisitedDomainsVi._(_root);
	@override late final _TranslationsDomainDiscoveryVi domainDiscovery = _TranslationsDomainDiscoveryVi._(_root);
	@override late final _TranslationsInventorySuggestionsVi inventorySuggestions = _TranslationsInventorySuggestionsVi._(_root);
	@override late final _TranslationsUpgradeVi upgrade = _TranslationsUpgradeVi._(_root);
	@override late final _TranslationsTourVi tour = _TranslationsTourVi._(_root);
	@override late final _TranslationsManualRecipeVi manualRecipe = _TranslationsManualRecipeVi._(_root);
	@override late final _TranslationsRecipeEditVi recipeEdit = _TranslationsRecipeEditVi._(_root);
...
class _TranslationsSettingsVi extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsVi measurements = _TranslationsSettingsMeasurementsVi._(_root);
	@override late final _TranslationsSettingsDataManagementVi dataManagement = _TranslationsSettingsDataManagementVi._(_root);
	@override late final _TranslationsSettingsVersionVi version = _TranslationsSettingsVersionVi._(_root);
}

// Path: recipes
class _TranslationsRecipesVi extends TranslationsRecipesEn {
	_TranslationsRecipesVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailVi extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailVi._(TranslationsVi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionVi nutrition = _TranslationsRecipeDetailNutritionVi._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadVi prepAhead = _TranslationsRecipeDetailPrepAheadVi._(_root);
...
// Path: filters
class _TranslationsFiltersVi extends TranslationsFiltersEn {
	_TranslationsFiltersVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListVi extends TranslationsShoppingListEn {
	_TranslationsShoppingListVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanVi extends TranslationsMealPlanEn {
	_TranslationsMealPlanVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryVi extends TranslationsInventoryEn {
	_TranslationsInventoryVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanVi extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanVi extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingVi extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsVi extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryVi extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsVi extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeVi extends TranslationsUpgradeEn {
	_TranslationsUpgradeVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourVi extends TranslationsTourEn {
	_TranslationsTourVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeVi extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditVi extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsVi extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsVi._(TranslationsVi root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricVi metric = _TranslationsSettingsMeasurementsMetricVi._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialVi imperial = _TranslationsSettingsMeasurementsImperialVi._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementVi extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionVi extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionVi extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadVi extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricVi extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricVi._(TranslationsVi root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialVi extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialVi._(TranslationsVi root) : this._root = root, super.internal(root);
