...
class TranslationsUrPk extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppUrPk app = _TranslationsAppUrPk._(_root);
	@override late final _TranslationsHomeUrPk home = _TranslationsHomeUrPk._(_root);
	@override late final _TranslationsCommonUrPk common = _TranslationsCommonUrPk._(_root);
	@override late final _TranslationsSettingsUrPk settings = _TranslationsSettingsUrPk._(_root);
	@override late final _TranslationsRecipesUrPk recipes = _TranslationsRecipesUrPk._(_root);
	@override late final _TranslationsRecipeDetailUrPk recipeDetail = _TranslationsRecipeDetailUrPk._(_root);
	@override late final _TranslationsFiltersUrPk filters = _TranslationsFiltersUrPk._(_root);
	@override late final _TranslationsShoppingListUrPk shoppingList = _TranslationsShoppingListUrPk._(_root);
	@override late final _TranslationsMealPlanUrPk mealPlan = _TranslationsMealPlanUrPk._(_root);
	@override late final _TranslationsInventoryUrPk inventory = _TranslationsInventoryUrPk._(_root);
	@override late final _TranslationsBarcodeScanUrPk barcodeScan = _TranslationsBarcodeScanUrPk._(_root);
	@override late final _TranslationsReceiptScanUrPk receiptScan = _TranslationsReceiptScanUrPk._(_root);
	@override late final _TranslationsBatchCookingUrPk batchCooking = _TranslationsBatchCookingUrPk._(_root);
	@override late final _TranslationsVisitedDomainsUrPk visitedDomains = _TranslationsVisitedDomainsUrPk._(_root);
	@override late final _TranslationsDomainDiscoveryUrPk domainDiscovery = _TranslationsDomainDiscoveryUrPk._(_root);
	@override late final _TranslationsInventorySuggestionsUrPk inventorySuggestions = _TranslationsInventorySuggestionsUrPk._(_root);
	@override late final _TranslationsUpgradeUrPk upgrade = _TranslationsUpgradeUrPk._(_root);
	@override late final _TranslationsTourUrPk tour = _TranslationsTourUrPk._(_root);
	@override late final _TranslationsManualRecipeUrPk manualRecipe = _TranslationsManualRecipeUrPk._(_root);
	@override late final _TranslationsRecipeEditUrPk recipeEdit = _TranslationsRecipeEditUrPk._(_root);
	@override late final _TranslationsErrorsUrPk errors = _TranslationsErrorsUrPk._(_root);
}

// Path: app
class _TranslationsAppUrPk extends TranslationsAppEn {
	_TranslationsAppUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);

	final TranslationsUrPk _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeUrPk extends TranslationsHomeEn {
	_TranslationsHomeUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonUrPk extends TranslationsCommonEn {
	_TranslationsCommonUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsUrPk extends TranslationsSettingsEn {
	_TranslationsSettingsUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);

	final TranslationsUrPk _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsUrPk measurements = _TranslationsSettingsMeasurementsUrPk._(_root);
	@override late final _TranslationsSettingsDataManagementUrPk dataManagement = _TranslationsSettingsDataManagementUrPk._(_root);
	@override late final _TranslationsSettingsVersionUrPk version = _TranslationsSettingsVersionUrPk._(_root);
}

// Path: recipes
class _TranslationsRecipesUrPk extends TranslationsRecipesEn {
	_TranslationsRecipesUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUrPk extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionUrPk nutrition = _TranslationsRecipeDetailNutritionUrPk._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadUrPk prepAhead = _TranslationsRecipeDetailPrepAheadUrPk._(_root);
...
// Path: filters
class _TranslationsFiltersUrPk extends TranslationsFiltersEn {
	_TranslationsFiltersUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListUrPk extends TranslationsShoppingListEn {
	_TranslationsShoppingListUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanUrPk extends TranslationsMealPlanEn {
	_TranslationsMealPlanUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryUrPk extends TranslationsInventoryEn {
	_TranslationsInventoryUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUrPk extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanUrPk extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingUrPk extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUrPk extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryUrPk extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsUrPk extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeUrPk extends TranslationsUpgradeEn {
	_TranslationsUpgradeUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourUrPk extends TranslationsTourEn {
	_TranslationsTourUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUrPk extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUrPk extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsUrPk extends TranslationsErrorsEn {
	_TranslationsErrorsUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsUrPk extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricUrPk metric = _TranslationsSettingsMeasurementsMetricUrPk._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialUrPk imperial = _TranslationsSettingsMeasurementsImperialUrPk._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementUrPk extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionUrPk extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionUrPk extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadUrPk extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricUrPk extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialUrPk extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUrPk._(TranslationsUrPk root) : this._root = root, super.internal(root);
