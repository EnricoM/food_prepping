...
// Path: <root>
class TranslationsSm extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsSm({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <sm>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsSm _root = this; // ignore: unused_field

	@override 
	TranslationsSm $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsSm(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppSm app = _TranslationsAppSm._(_root);
	@override late final _TranslationsHomeSm home = _TranslationsHomeSm._(_root);
	@override late final _TranslationsCommonSm common = _TranslationsCommonSm._(_root);
	@override late final _TranslationsSettingsSm settings = _TranslationsSettingsSm._(_root);
	@override late final _TranslationsRecipesSm recipes = _TranslationsRecipesSm._(_root);
	@override late final _TranslationsRecipeDetailSm recipeDetail = _TranslationsRecipeDetailSm._(_root);
	@override late final _TranslationsFiltersSm filters = _TranslationsFiltersSm._(_root);
	@override late final _TranslationsShoppingListSm shoppingList = _TranslationsShoppingListSm._(_root);
	@override late final _TranslationsMealPlanSm mealPlan = _TranslationsMealPlanSm._(_root);
	@override late final _TranslationsInventorySm inventory = _TranslationsInventorySm._(_root);
	@override late final _TranslationsBarcodeScanSm barcodeScan = _TranslationsBarcodeScanSm._(_root);
	@override late final _TranslationsReceiptScanSm receiptScan = _TranslationsReceiptScanSm._(_root);
	@override late final _TranslationsBatchCookingSm batchCooking = _TranslationsBatchCookingSm._(_root);
	@override late final _TranslationsVisitedDomainsSm visitedDomains = _TranslationsVisitedDomainsSm._(_root);
	@override late final _TranslationsDomainDiscoverySm domainDiscovery = _TranslationsDomainDiscoverySm._(_root);
	@override late final _TranslationsInventorySuggestionsSm inventorySuggestions = _TranslationsInventorySuggestionsSm._(_root);
	@override late final _TranslationsUpgradeSm upgrade = _TranslationsUpgradeSm._(_root);
	@override late final _TranslationsTourSm tour = _TranslationsTourSm._(_root);
	@override late final _TranslationsManualRecipeSm manualRecipe = _TranslationsManualRecipeSm._(_root);
	@override late final _TranslationsRecipeEditSm recipeEdit = _TranslationsRecipeEditSm._(_root);
	@override late final _TranslationsErrorsSm errors = _TranslationsErrorsSm._(_root);
}

// Path: app
class _TranslationsAppSm extends TranslationsAppEn {
	_TranslationsAppSm._(TranslationsSm root) : this._root = root, super.internal(root);

	final TranslationsSm _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeSm extends TranslationsHomeEn {
	_TranslationsHomeSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonSm extends TranslationsCommonEn {
	_TranslationsCommonSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsSm extends TranslationsSettingsEn {
	_TranslationsSettingsSm._(TranslationsSm root) : this._root = root, super.internal(root);

	final TranslationsSm _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsSm measurements = _TranslationsSettingsMeasurementsSm._(_root);
	@override late final _TranslationsSettingsDataManagementSm dataManagement = _TranslationsSettingsDataManagementSm._(_root);
	@override late final _TranslationsSettingsVersionSm version = _TranslationsSettingsVersionSm._(_root);
}

// Path: recipes
class _TranslationsRecipesSm extends TranslationsRecipesEn {
	_TranslationsRecipesSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailSm extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailSm._(TranslationsSm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionSm nutrition = _TranslationsRecipeDetailNutritionSm._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadSm prepAhead = _TranslationsRecipeDetailPrepAheadSm._(_root);
...
// Path: filters
class _TranslationsFiltersSm extends TranslationsFiltersEn {
	_TranslationsFiltersSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListSm extends TranslationsShoppingListEn {
	_TranslationsShoppingListSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanSm extends TranslationsMealPlanEn {
	_TranslationsMealPlanSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventorySm extends TranslationsInventoryEn {
	_TranslationsInventorySm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanSm extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanSm extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingSm extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsSm extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoverySm extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoverySm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsSm extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeSm extends TranslationsUpgradeEn {
	_TranslationsUpgradeSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourSm extends TranslationsTourEn {
	_TranslationsTourSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeSm extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditSm extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsSm extends TranslationsErrorsEn {
	_TranslationsErrorsSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsSm extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsSm._(TranslationsSm root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricSm metric = _TranslationsSettingsMeasurementsMetricSm._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialSm imperial = _TranslationsSettingsMeasurementsImperialSm._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementSm extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionSm extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionSm extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadSm extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricSm extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialSm extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialSm._(TranslationsSm root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <sm>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsSm {
