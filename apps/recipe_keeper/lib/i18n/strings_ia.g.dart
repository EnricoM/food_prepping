...
// Path: <root>
class TranslationsIa extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsIa({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ia>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsIa _root = this; // ignore: unused_field

	@override 
	TranslationsIa $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsIa(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppIa app = _TranslationsAppIa._(_root);
	@override late final _TranslationsHomeIa home = _TranslationsHomeIa._(_root);
	@override late final _TranslationsCommonIa common = _TranslationsCommonIa._(_root);
	@override late final _TranslationsSettingsIa settings = _TranslationsSettingsIa._(_root);
	@override late final _TranslationsRecipesIa recipes = _TranslationsRecipesIa._(_root);
	@override late final _TranslationsRecipeDetailIa recipeDetail = _TranslationsRecipeDetailIa._(_root);
	@override late final _TranslationsFiltersIa filters = _TranslationsFiltersIa._(_root);
	@override late final _TranslationsShoppingListIa shoppingList = _TranslationsShoppingListIa._(_root);
	@override late final _TranslationsMealPlanIa mealPlan = _TranslationsMealPlanIa._(_root);
	@override late final _TranslationsInventoryIa inventory = _TranslationsInventoryIa._(_root);
	@override late final _TranslationsBarcodeScanIa barcodeScan = _TranslationsBarcodeScanIa._(_root);
	@override late final _TranslationsReceiptScanIa receiptScan = _TranslationsReceiptScanIa._(_root);
	@override late final _TranslationsBatchCookingIa batchCooking = _TranslationsBatchCookingIa._(_root);
	@override late final _TranslationsVisitedDomainsIa visitedDomains = _TranslationsVisitedDomainsIa._(_root);
	@override late final _TranslationsDomainDiscoveryIa domainDiscovery = _TranslationsDomainDiscoveryIa._(_root);
	@override late final _TranslationsInventorySuggestionsIa inventorySuggestions = _TranslationsInventorySuggestionsIa._(_root);
	@override late final _TranslationsUpgradeIa upgrade = _TranslationsUpgradeIa._(_root);
	@override late final _TranslationsTourIa tour = _TranslationsTourIa._(_root);
	@override late final _TranslationsManualRecipeIa manualRecipe = _TranslationsManualRecipeIa._(_root);
	@override late final _TranslationsRecipeEditIa recipeEdit = _TranslationsRecipeEditIa._(_root);
	@override late final _TranslationsErrorsIa errors = _TranslationsErrorsIa._(_root);
}

// Path: app
class _TranslationsAppIa extends TranslationsAppEn {
	_TranslationsAppIa._(TranslationsIa root) : this._root = root, super.internal(root);

	final TranslationsIa _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIa extends TranslationsHomeEn {
	_TranslationsHomeIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIa extends TranslationsCommonEn {
	_TranslationsCommonIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIa extends TranslationsSettingsEn {
	_TranslationsSettingsIa._(TranslationsIa root) : this._root = root, super.internal(root);

	final TranslationsIa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIa measurements = _TranslationsSettingsMeasurementsIa._(_root);
	@override late final _TranslationsSettingsDataManagementIa dataManagement = _TranslationsSettingsDataManagementIa._(_root);
	@override late final _TranslationsSettingsVersionIa version = _TranslationsSettingsVersionIa._(_root);
}

// Path: recipes
class _TranslationsRecipesIa extends TranslationsRecipesEn {
	_TranslationsRecipesIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIa._(TranslationsIa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIa nutrition = _TranslationsRecipeDetailNutritionIa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIa prepAhead = _TranslationsRecipeDetailPrepAheadIa._(_root);
...
// Path: filters
class _TranslationsFiltersIa extends TranslationsFiltersEn {
	_TranslationsFiltersIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIa extends TranslationsShoppingListEn {
	_TranslationsShoppingListIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIa extends TranslationsMealPlanEn {
	_TranslationsMealPlanIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIa extends TranslationsInventoryEn {
	_TranslationsInventoryIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIa extends TranslationsUpgradeEn {
	_TranslationsUpgradeIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIa extends TranslationsTourEn {
	_TranslationsTourIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIa extends TranslationsErrorsEn {
	_TranslationsErrorsIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIa._(TranslationsIa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIa metric = _TranslationsSettingsMeasurementsMetricIa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIa imperial = _TranslationsSettingsMeasurementsImperialIa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIa._(TranslationsIa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ia>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsIa {
