...
// Path: <root>
class TranslationsIg extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsIg({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ig>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsIg _root = this; // ignore: unused_field

	@override 
	TranslationsIg $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsIg(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppIg app = _TranslationsAppIg._(_root);
	@override late final _TranslationsHomeIg home = _TranslationsHomeIg._(_root);
	@override late final _TranslationsCommonIg common = _TranslationsCommonIg._(_root);
	@override late final _TranslationsSettingsIg settings = _TranslationsSettingsIg._(_root);
	@override late final _TranslationsRecipesIg recipes = _TranslationsRecipesIg._(_root);
	@override late final _TranslationsRecipeDetailIg recipeDetail = _TranslationsRecipeDetailIg._(_root);
	@override late final _TranslationsFiltersIg filters = _TranslationsFiltersIg._(_root);
	@override late final _TranslationsShoppingListIg shoppingList = _TranslationsShoppingListIg._(_root);
	@override late final _TranslationsMealPlanIg mealPlan = _TranslationsMealPlanIg._(_root);
	@override late final _TranslationsInventoryIg inventory = _TranslationsInventoryIg._(_root);
	@override late final _TranslationsBarcodeScanIg barcodeScan = _TranslationsBarcodeScanIg._(_root);
	@override late final _TranslationsReceiptScanIg receiptScan = _TranslationsReceiptScanIg._(_root);
	@override late final _TranslationsBatchCookingIg batchCooking = _TranslationsBatchCookingIg._(_root);
	@override late final _TranslationsVisitedDomainsIg visitedDomains = _TranslationsVisitedDomainsIg._(_root);
	@override late final _TranslationsDomainDiscoveryIg domainDiscovery = _TranslationsDomainDiscoveryIg._(_root);
	@override late final _TranslationsInventorySuggestionsIg inventorySuggestions = _TranslationsInventorySuggestionsIg._(_root);
	@override late final _TranslationsUpgradeIg upgrade = _TranslationsUpgradeIg._(_root);
	@override late final _TranslationsTourIg tour = _TranslationsTourIg._(_root);
	@override late final _TranslationsManualRecipeIg manualRecipe = _TranslationsManualRecipeIg._(_root);
	@override late final _TranslationsRecipeEditIg recipeEdit = _TranslationsRecipeEditIg._(_root);
	@override late final _TranslationsErrorsIg errors = _TranslationsErrorsIg._(_root);
}

// Path: app
class _TranslationsAppIg extends TranslationsAppEn {
	_TranslationsAppIg._(TranslationsIg root) : this._root = root, super.internal(root);

	final TranslationsIg _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeIg extends TranslationsHomeEn {
	_TranslationsHomeIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonIg extends TranslationsCommonEn {
	_TranslationsCommonIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsIg extends TranslationsSettingsEn {
	_TranslationsSettingsIg._(TranslationsIg root) : this._root = root, super.internal(root);

	final TranslationsIg _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsIg measurements = _TranslationsSettingsMeasurementsIg._(_root);
	@override late final _TranslationsSettingsDataManagementIg dataManagement = _TranslationsSettingsDataManagementIg._(_root);
	@override late final _TranslationsSettingsVersionIg version = _TranslationsSettingsVersionIg._(_root);
}

// Path: recipes
class _TranslationsRecipesIg extends TranslationsRecipesEn {
	_TranslationsRecipesIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIg extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIg._(TranslationsIg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIg nutrition = _TranslationsRecipeDetailNutritionIg._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIg prepAhead = _TranslationsRecipeDetailPrepAheadIg._(_root);
...
// Path: filters
class _TranslationsFiltersIg extends TranslationsFiltersEn {
	_TranslationsFiltersIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIg extends TranslationsShoppingListEn {
	_TranslationsShoppingListIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIg extends TranslationsMealPlanEn {
	_TranslationsMealPlanIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIg extends TranslationsInventoryEn {
	_TranslationsInventoryIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIg extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIg extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIg extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIg extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIg extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIg extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIg extends TranslationsUpgradeEn {
	_TranslationsUpgradeIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIg extends TranslationsTourEn {
	_TranslationsTourIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIg extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIg extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsIg extends TranslationsErrorsEn {
	_TranslationsErrorsIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIg extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIg._(TranslationsIg root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIg metric = _TranslationsSettingsMeasurementsMetricIg._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIg imperial = _TranslationsSettingsMeasurementsImperialIg._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIg extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIg extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIg extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIg extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIg extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIg extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIg._(TranslationsIg root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ig>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsIg {
