...
class TranslationsLoLa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppLoLa app = _TranslationsAppLoLa._(_root);
	@override late final _TranslationsHomeLoLa home = _TranslationsHomeLoLa._(_root);
	@override late final _TranslationsCommonLoLa common = _TranslationsCommonLoLa._(_root);
	@override late final _TranslationsSettingsLoLa settings = _TranslationsSettingsLoLa._(_root);
	@override late final _TranslationsRecipesLoLa recipes = _TranslationsRecipesLoLa._(_root);
	@override late final _TranslationsRecipeDetailLoLa recipeDetail = _TranslationsRecipeDetailLoLa._(_root);
	@override late final _TranslationsFiltersLoLa filters = _TranslationsFiltersLoLa._(_root);
	@override late final _TranslationsShoppingListLoLa shoppingList = _TranslationsShoppingListLoLa._(_root);
	@override late final _TranslationsMealPlanLoLa mealPlan = _TranslationsMealPlanLoLa._(_root);
	@override late final _TranslationsInventoryLoLa inventory = _TranslationsInventoryLoLa._(_root);
	@override late final _TranslationsBarcodeScanLoLa barcodeScan = _TranslationsBarcodeScanLoLa._(_root);
	@override late final _TranslationsReceiptScanLoLa receiptScan = _TranslationsReceiptScanLoLa._(_root);
	@override late final _TranslationsBatchCookingLoLa batchCooking = _TranslationsBatchCookingLoLa._(_root);
	@override late final _TranslationsVisitedDomainsLoLa visitedDomains = _TranslationsVisitedDomainsLoLa._(_root);
	@override late final _TranslationsDomainDiscoveryLoLa domainDiscovery = _TranslationsDomainDiscoveryLoLa._(_root);
	@override late final _TranslationsInventorySuggestionsLoLa inventorySuggestions = _TranslationsInventorySuggestionsLoLa._(_root);
	@override late final _TranslationsUpgradeLoLa upgrade = _TranslationsUpgradeLoLa._(_root);
	@override late final _TranslationsTourLoLa tour = _TranslationsTourLoLa._(_root);
	@override late final _TranslationsManualRecipeLoLa manualRecipe = _TranslationsManualRecipeLoLa._(_root);
	@override late final _TranslationsRecipeEditLoLa recipeEdit = _TranslationsRecipeEditLoLa._(_root);
	@override late final _TranslationsErrorsLoLa errors = _TranslationsErrorsLoLa._(_root);
}

// Path: app
class _TranslationsAppLoLa extends TranslationsAppEn {
	_TranslationsAppLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeLoLa extends TranslationsHomeEn {
	_TranslationsHomeLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLoLa extends TranslationsCommonEn {
	_TranslationsCommonLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLoLa extends TranslationsSettingsEn {
	_TranslationsSettingsLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);

	final TranslationsLoLa _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLoLa measurements = _TranslationsSettingsMeasurementsLoLa._(_root);
	@override late final _TranslationsSettingsDataManagementLoLa dataManagement = _TranslationsSettingsDataManagementLoLa._(_root);
	@override late final _TranslationsSettingsVersionLoLa version = _TranslationsSettingsVersionLoLa._(_root);
}

// Path: recipes
class _TranslationsRecipesLoLa extends TranslationsRecipesEn {
	_TranslationsRecipesLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLoLa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLoLa nutrition = _TranslationsRecipeDetailNutritionLoLa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLoLa prepAhead = _TranslationsRecipeDetailPrepAheadLoLa._(_root);
...
// Path: filters
class _TranslationsFiltersLoLa extends TranslationsFiltersEn {
	_TranslationsFiltersLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLoLa extends TranslationsShoppingListEn {
	_TranslationsShoppingListLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLoLa extends TranslationsMealPlanEn {
	_TranslationsMealPlanLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLoLa extends TranslationsInventoryEn {
	_TranslationsInventoryLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLoLa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLoLa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLoLa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLoLa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLoLa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLoLa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLoLa extends TranslationsUpgradeEn {
	_TranslationsUpgradeLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLoLa extends TranslationsTourEn {
	_TranslationsTourLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLoLa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLoLa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsLoLa extends TranslationsErrorsEn {
	_TranslationsErrorsLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLoLa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLoLa metric = _TranslationsSettingsMeasurementsMetricLoLa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLoLa imperial = _TranslationsSettingsMeasurementsImperialLoLa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLoLa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLoLa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLoLa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLoLa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLoLa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLoLa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLoLa._(TranslationsLoLa root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <lo-LA>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsLoLa {
