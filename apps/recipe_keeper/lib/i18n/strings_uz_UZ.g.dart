...
class TranslationsUzUz extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppUzUz app = _TranslationsAppUzUz._(_root);
	@override late final _TranslationsHomeUzUz home = _TranslationsHomeUzUz._(_root);
	@override late final _TranslationsCommonUzUz common = _TranslationsCommonUzUz._(_root);
	@override late final _TranslationsSettingsUzUz settings = _TranslationsSettingsUzUz._(_root);
	@override late final _TranslationsRecipesUzUz recipes = _TranslationsRecipesUzUz._(_root);
	@override late final _TranslationsRecipeDetailUzUz recipeDetail = _TranslationsRecipeDetailUzUz._(_root);
	@override late final _TranslationsFiltersUzUz filters = _TranslationsFiltersUzUz._(_root);
	@override late final _TranslationsShoppingListUzUz shoppingList = _TranslationsShoppingListUzUz._(_root);
	@override late final _TranslationsMealPlanUzUz mealPlan = _TranslationsMealPlanUzUz._(_root);
	@override late final _TranslationsInventoryUzUz inventory = _TranslationsInventoryUzUz._(_root);
	@override late final _TranslationsBarcodeScanUzUz barcodeScan = _TranslationsBarcodeScanUzUz._(_root);
	@override late final _TranslationsReceiptScanUzUz receiptScan = _TranslationsReceiptScanUzUz._(_root);
	@override late final _TranslationsBatchCookingUzUz batchCooking = _TranslationsBatchCookingUzUz._(_root);
	@override late final _TranslationsVisitedDomainsUzUz visitedDomains = _TranslationsVisitedDomainsUzUz._(_root);
	@override late final _TranslationsDomainDiscoveryUzUz domainDiscovery = _TranslationsDomainDiscoveryUzUz._(_root);
	@override late final _TranslationsInventorySuggestionsUzUz inventorySuggestions = _TranslationsInventorySuggestionsUzUz._(_root);
	@override late final _TranslationsUpgradeUzUz upgrade = _TranslationsUpgradeUzUz._(_root);
	@override late final _TranslationsTourUzUz tour = _TranslationsTourUzUz._(_root);
	@override late final _TranslationsManualRecipeUzUz manualRecipe = _TranslationsManualRecipeUzUz._(_root);
	@override late final _TranslationsRecipeEditUzUz recipeEdit = _TranslationsRecipeEditUzUz._(_root);
	@override late final _TranslationsErrorsUzUz errors = _TranslationsErrorsUzUz._(_root);
}

// Path: app
class _TranslationsAppUzUz extends TranslationsAppEn {
	_TranslationsAppUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeUzUz extends TranslationsHomeEn {
	_TranslationsHomeUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonUzUz extends TranslationsCommonEn {
	_TranslationsCommonUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsUzUz extends TranslationsSettingsEn {
	_TranslationsSettingsUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);

	final TranslationsUzUz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsUzUz measurements = _TranslationsSettingsMeasurementsUzUz._(_root);
	@override late final _TranslationsSettingsDataManagementUzUz dataManagement = _TranslationsSettingsDataManagementUzUz._(_root);
	@override late final _TranslationsSettingsVersionUzUz version = _TranslationsSettingsVersionUzUz._(_root);
}

// Path: recipes
class _TranslationsRecipesUzUz extends TranslationsRecipesEn {
	_TranslationsRecipesUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailUzUz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionUzUz nutrition = _TranslationsRecipeDetailNutritionUzUz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadUzUz prepAhead = _TranslationsRecipeDetailPrepAheadUzUz._(_root);
...
// Path: filters
class _TranslationsFiltersUzUz extends TranslationsFiltersEn {
	_TranslationsFiltersUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListUzUz extends TranslationsShoppingListEn {
	_TranslationsShoppingListUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanUzUz extends TranslationsMealPlanEn {
	_TranslationsMealPlanUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryUzUz extends TranslationsInventoryEn {
	_TranslationsInventoryUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanUzUz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanUzUz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingUzUz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsUzUz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryUzUz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsUzUz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeUzUz extends TranslationsUpgradeEn {
	_TranslationsUpgradeUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourUzUz extends TranslationsTourEn {
	_TranslationsTourUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeUzUz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditUzUz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsUzUz extends TranslationsErrorsEn {
	_TranslationsErrorsUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsUzUz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricUzUz metric = _TranslationsSettingsMeasurementsMetricUzUz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialUzUz imperial = _TranslationsSettingsMeasurementsImperialUzUz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementUzUz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionUzUz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionUzUz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadUzUz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricUzUz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialUzUz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialUzUz._(TranslationsUzUz root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <uz-UZ>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsUzUz {
