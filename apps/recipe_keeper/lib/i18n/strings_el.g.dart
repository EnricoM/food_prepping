...
class TranslationsEl extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesEl recipes = _TranslationsRecipesEl._(_root);
	@override late final _TranslationsRecipeDetailEl recipeDetail = _TranslationsRecipeDetailEl._(_root);
	@override late final _TranslationsFiltersEl filters = _TranslationsFiltersEl._(_root);
	@override late final _TranslationsShoppingListEl shoppingList = _TranslationsShoppingListEl._(_root);
	@override late final _TranslationsMealPlanEl mealPlan = _TranslationsMealPlanEl._(_root);
	@override late final _TranslationsInventoryEl inventory = _TranslationsInventoryEl._(_root);
	@override late final _TranslationsBarcodeScanEl barcodeScan = _TranslationsBarcodeScanEl._(_root);
	@override late final _TranslationsReceiptScanEl receiptScan = _TranslationsReceiptScanEl._(_root);
	@override late final _TranslationsBatchCookingEl batchCooking = _TranslationsBatchCookingEl._(_root);
	@override late final _TranslationsVisitedDomainsEl visitedDomains = _TranslationsVisitedDomainsEl._(_root);
	@override late final _TranslationsDomainDiscoveryEl domainDiscovery = _TranslationsDomainDiscoveryEl._(_root);
	@override late final _TranslationsInventorySuggestionsEl inventorySuggestions = _TranslationsInventorySuggestionsEl._(_root);
	@override late final _TranslationsUpgradeEl upgrade = _TranslationsUpgradeEl._(_root);
	@override late final _TranslationsTourEl tour = _TranslationsTourEl._(_root);
	@override late final _TranslationsManualRecipeEl manualRecipe = _TranslationsManualRecipeEl._(_root);
	@override late final _TranslationsRecipeEditEl recipeEdit = _TranslationsRecipeEditEl._(_root);
	@override late final _TranslationsErrorsEl errors = _TranslationsErrorsEl._(_root);
}

// Path: app
class _TranslationsAppEl extends TranslationsAppEn {
	_TranslationsAppEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsEl extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsEl measurements = _TranslationsSettingsMeasurementsEl._(_root);
	@override late final _TranslationsSettingsDataManagementEl dataManagement = _TranslationsSettingsDataManagementEl._(_root);
	@override late final _TranslationsSettingsVersionEl version = _TranslationsSettingsVersionEl._(_root);
}

// Path: recipes
class _TranslationsRecipesEl extends TranslationsRecipesEn {
	_TranslationsRecipesEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailEl extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailEl._(TranslationsEl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionEl nutrition = _TranslationsRecipeDetailNutritionEl._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadEl prepAhead = _TranslationsRecipeDetailPrepAheadEl._(_root);
...
// Path: filters
class _TranslationsFiltersEl extends TranslationsFiltersEn {
	_TranslationsFiltersEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListEl extends TranslationsShoppingListEn {
	_TranslationsShoppingListEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanEl extends TranslationsMealPlanEn {
	_TranslationsMealPlanEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryEl extends TranslationsInventoryEn {
	_TranslationsInventoryEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanEl extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanEl extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingEl extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsEl extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryEl extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsEl extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeEl extends TranslationsUpgradeEn {
	_TranslationsUpgradeEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourEl extends TranslationsTourEn {
	_TranslationsTourEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeEl extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditEl extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsEl extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsEl._(TranslationsEl root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricEl metric = _TranslationsSettingsMeasurementsMetricEl._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialEl imperial = _TranslationsSettingsMeasurementsImperialEl._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementEl extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionEl extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionEl extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadEl extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricEl extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricEl._(TranslationsEl root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialEl extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialEl._(TranslationsEl root) : this._root = root, super.internal(root);
