...
// Path: <root>
class TranslationsKkKz extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsKkKz({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.kkKz,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <kk-KZ>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsKkKz _root = this; // ignore: unused_field

	@override 
	TranslationsKkKz $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsKkKz(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppKkKz app = _TranslationsAppKkKz._(_root);
	@override late final _TranslationsHomeKkKz home = _TranslationsHomeKkKz._(_root);
	@override late final _TranslationsCommonKkKz common = _TranslationsCommonKkKz._(_root);
	@override late final _TranslationsSettingsKkKz settings = _TranslationsSettingsKkKz._(_root);
	@override late final _TranslationsRecipesKkKz recipes = _TranslationsRecipesKkKz._(_root);
	@override late final _TranslationsRecipeDetailKkKz recipeDetail = _TranslationsRecipeDetailKkKz._(_root);
	@override late final _TranslationsFiltersKkKz filters = _TranslationsFiltersKkKz._(_root);
	@override late final _TranslationsShoppingListKkKz shoppingList = _TranslationsShoppingListKkKz._(_root);
	@override late final _TranslationsMealPlanKkKz mealPlan = _TranslationsMealPlanKkKz._(_root);
	@override late final _TranslationsInventoryKkKz inventory = _TranslationsInventoryKkKz._(_root);
	@override late final _TranslationsBarcodeScanKkKz barcodeScan = _TranslationsBarcodeScanKkKz._(_root);
	@override late final _TranslationsReceiptScanKkKz receiptScan = _TranslationsReceiptScanKkKz._(_root);
	@override late final _TranslationsBatchCookingKkKz batchCooking = _TranslationsBatchCookingKkKz._(_root);
	@override late final _TranslationsVisitedDomainsKkKz visitedDomains = _TranslationsVisitedDomainsKkKz._(_root);
	@override late final _TranslationsDomainDiscoveryKkKz domainDiscovery = _TranslationsDomainDiscoveryKkKz._(_root);
	@override late final _TranslationsInventorySuggestionsKkKz inventorySuggestions = _TranslationsInventorySuggestionsKkKz._(_root);
	@override late final _TranslationsUpgradeKkKz upgrade = _TranslationsUpgradeKkKz._(_root);
	@override late final _TranslationsTourKkKz tour = _TranslationsTourKkKz._(_root);
	@override late final _TranslationsManualRecipeKkKz manualRecipe = _TranslationsManualRecipeKkKz._(_root);
	@override late final _TranslationsRecipeEditKkKz recipeEdit = _TranslationsRecipeEditKkKz._(_root);
	@override late final _TranslationsErrorsKkKz errors = _TranslationsErrorsKkKz._(_root);
}

// Path: app
class _TranslationsAppKkKz extends TranslationsAppEn {
	_TranslationsAppKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);

	final TranslationsKkKz _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeKkKz extends TranslationsHomeEn {
	_TranslationsHomeKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKkKz extends TranslationsCommonEn {
	_TranslationsCommonKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsKkKz extends TranslationsSettingsEn {
	_TranslationsSettingsKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);

	final TranslationsKkKz _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKkKz measurements = _TranslationsSettingsMeasurementsKkKz._(_root);
	@override late final _TranslationsSettingsDataManagementKkKz dataManagement = _TranslationsSettingsDataManagementKkKz._(_root);
	@override late final _TranslationsSettingsVersionKkKz version = _TranslationsSettingsVersionKkKz._(_root);
}

// Path: recipes
class _TranslationsRecipesKkKz extends TranslationsRecipesEn {
	_TranslationsRecipesKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKkKz extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKkKz nutrition = _TranslationsRecipeDetailNutritionKkKz._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKkKz prepAhead = _TranslationsRecipeDetailPrepAheadKkKz._(_root);
...
// Path: filters
class _TranslationsFiltersKkKz extends TranslationsFiltersEn {
	_TranslationsFiltersKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKkKz extends TranslationsShoppingListEn {
	_TranslationsShoppingListKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKkKz extends TranslationsMealPlanEn {
	_TranslationsMealPlanKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKkKz extends TranslationsInventoryEn {
	_TranslationsInventoryKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKkKz extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKkKz extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKkKz extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKkKz extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKkKz extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKkKz extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKkKz extends TranslationsUpgradeEn {
	_TranslationsUpgradeKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKkKz extends TranslationsTourEn {
	_TranslationsTourKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKkKz extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKkKz extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKkKz extends TranslationsErrorsEn {
	_TranslationsErrorsKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKkKz extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKkKz metric = _TranslationsSettingsMeasurementsMetricKkKz._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKkKz imperial = _TranslationsSettingsMeasurementsImperialKkKz._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKkKz extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKkKz extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKkKz extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKkKz extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKkKz extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKkKz extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKkKz._(TranslationsKkKz root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <kk-KZ>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsKkKz {
