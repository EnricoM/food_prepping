...
class TranslationsTa extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesTa recipes = _TranslationsRecipesTa._(_root);
	@override late final _TranslationsRecipeDetailTa recipeDetail = _TranslationsRecipeDetailTa._(_root);
	@override late final _TranslationsFiltersTa filters = _TranslationsFiltersTa._(_root);
	@override late final _TranslationsShoppingListTa shoppingList = _TranslationsShoppingListTa._(_root);
	@override late final _TranslationsMealPlanTa mealPlan = _TranslationsMealPlanTa._(_root);
	@override late final _TranslationsInventoryTa inventory = _TranslationsInventoryTa._(_root);
	@override late final _TranslationsBarcodeScanTa barcodeScan = _TranslationsBarcodeScanTa._(_root);
	@override late final _TranslationsReceiptScanTa receiptScan = _TranslationsReceiptScanTa._(_root);
	@override late final _TranslationsBatchCookingTa batchCooking = _TranslationsBatchCookingTa._(_root);
	@override late final _TranslationsVisitedDomainsTa visitedDomains = _TranslationsVisitedDomainsTa._(_root);
	@override late final _TranslationsDomainDiscoveryTa domainDiscovery = _TranslationsDomainDiscoveryTa._(_root);
	@override late final _TranslationsInventorySuggestionsTa inventorySuggestions = _TranslationsInventorySuggestionsTa._(_root);
	@override late final _TranslationsUpgradeTa upgrade = _TranslationsUpgradeTa._(_root);
	@override late final _TranslationsTourTa tour = _TranslationsTourTa._(_root);
	@override late final _TranslationsManualRecipeTa manualRecipe = _TranslationsManualRecipeTa._(_root);
	@override late final _TranslationsRecipeEditTa recipeEdit = _TranslationsRecipeEditTa._(_root);
...
class _TranslationsSettingsTa extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsTa measurements = _TranslationsSettingsMeasurementsTa._(_root);
	@override late final _TranslationsSettingsDataManagementTa dataManagement = _TranslationsSettingsDataManagementTa._(_root);
	@override late final _TranslationsSettingsVersionTa version = _TranslationsSettingsVersionTa._(_root);
}

// Path: recipes
class _TranslationsRecipesTa extends TranslationsRecipesEn {
	_TranslationsRecipesTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailTa extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailTa._(TranslationsTa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionTa nutrition = _TranslationsRecipeDetailNutritionTa._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadTa prepAhead = _TranslationsRecipeDetailPrepAheadTa._(_root);
...
// Path: filters
class _TranslationsFiltersTa extends TranslationsFiltersEn {
	_TranslationsFiltersTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListTa extends TranslationsShoppingListEn {
	_TranslationsShoppingListTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanTa extends TranslationsMealPlanEn {
	_TranslationsMealPlanTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryTa extends TranslationsInventoryEn {
	_TranslationsInventoryTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanTa extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanTa extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingTa extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsTa extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryTa extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsTa extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeTa extends TranslationsUpgradeEn {
	_TranslationsUpgradeTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourTa extends TranslationsTourEn {
	_TranslationsTourTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeTa extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditTa extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsTa extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsTa._(TranslationsTa root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricTa metric = _TranslationsSettingsMeasurementsMetricTa._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialTa imperial = _TranslationsSettingsMeasurementsImperialTa._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementTa extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionTa extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionTa extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadTa extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricTa extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricTa._(TranslationsTa root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialTa extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialTa._(TranslationsTa root) : this._root = root, super.internal(root);
