...
// Path: <root>
class TranslationsCyGb extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsCyGb({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = meta ?? TranslationMetadata(
		    locale: AppLocale.cyGb,
		    overrides: overrides ?? {},
	...
	/// Metadata for the translations of <cy-GB>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsCyGb _root = this; // ignore: unused_field

	@override 
	TranslationsCyGb $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsCyGb(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppCyGb app = _TranslationsAppCyGb._(_root);
	@override late final _TranslationsHomeCyGb home = _TranslationsHomeCyGb._(_root);
	@override late final _TranslationsCommonCyGb common = _TranslationsCommonCyGb._(_root);
	@override late final _TranslationsSettingsCyGb settings = _TranslationsSettingsCyGb._(_root);
	@override late final _TranslationsRecipesCyGb recipes = _TranslationsRecipesCyGb._(_root);
	@override late final _TranslationsRecipeDetailCyGb recipeDetail = _TranslationsRecipeDetailCyGb._(_root);
	@override late final _TranslationsFiltersCyGb filters = _TranslationsFiltersCyGb._(_root);
	@override late final _TranslationsShoppingListCyGb shoppingList = _TranslationsShoppingListCyGb._(_root);
	@override late final _TranslationsMealPlanCyGb mealPlan = _TranslationsMealPlanCyGb._(_root);
	@override late final _TranslationsInventoryCyGb inventory = _TranslationsInventoryCyGb._(_root);
	@override late final _TranslationsBarcodeScanCyGb barcodeScan = _TranslationsBarcodeScanCyGb._(_root);
	@override late final _TranslationsReceiptScanCyGb receiptScan = _TranslationsReceiptScanCyGb._(_root);
	@override late final _TranslationsBatchCookingCyGb batchCooking = _TranslationsBatchCookingCyGb._(_root);
	@override late final _TranslationsVisitedDomainsCyGb visitedDomains = _TranslationsVisitedDomainsCyGb._(_root);
	@override late final _TranslationsDomainDiscoveryCyGb domainDiscovery = _TranslationsDomainDiscoveryCyGb._(_root);
	@override late final _TranslationsInventorySuggestionsCyGb inventorySuggestions = _TranslationsInventorySuggestionsCyGb._(_root);
	@override late final _TranslationsUpgradeCyGb upgrade = _TranslationsUpgradeCyGb._(_root);
	@override late final _TranslationsTourCyGb tour = _TranslationsTourCyGb._(_root);
	@override late final _TranslationsManualRecipeCyGb manualRecipe = _TranslationsManualRecipeCyGb._(_root);
	@override late final _TranslationsRecipeEditCyGb recipeEdit = _TranslationsRecipeEditCyGb._(_root);
	@override late final _TranslationsErrorsCyGb errors = _TranslationsErrorsCyGb._(_root);
}

// Path: app
class _TranslationsAppCyGb extends TranslationsAppEn {
	_TranslationsAppCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);

	final TranslationsCyGb _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeCyGb extends TranslationsHomeEn {
	_TranslationsHomeCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonCyGb extends TranslationsCommonEn {
	_TranslationsCommonCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsCyGb extends TranslationsSettingsEn {
	_TranslationsSettingsCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);

	final TranslationsCyGb _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsCyGb measurements = _TranslationsSettingsMeasurementsCyGb._(_root);
	@override late final _TranslationsSettingsDataManagementCyGb dataManagement = _TranslationsSettingsDataManagementCyGb._(_root);
	@override late final _TranslationsSettingsVersionCyGb version = _TranslationsSettingsVersionCyGb._(_root);
}

// Path: recipes
class _TranslationsRecipesCyGb extends TranslationsRecipesEn {
	_TranslationsRecipesCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailCyGb extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionCyGb nutrition = _TranslationsRecipeDetailNutritionCyGb._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadCyGb prepAhead = _TranslationsRecipeDetailPrepAheadCyGb._(_root);
...
// Path: filters
class _TranslationsFiltersCyGb extends TranslationsFiltersEn {
	_TranslationsFiltersCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListCyGb extends TranslationsShoppingListEn {
	_TranslationsShoppingListCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanCyGb extends TranslationsMealPlanEn {
	_TranslationsMealPlanCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryCyGb extends TranslationsInventoryEn {
	_TranslationsInventoryCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanCyGb extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanCyGb extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingCyGb extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsCyGb extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryCyGb extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsCyGb extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeCyGb extends TranslationsUpgradeEn {
	_TranslationsUpgradeCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourCyGb extends TranslationsTourEn {
	_TranslationsTourCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeCyGb extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditCyGb extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsCyGb extends TranslationsErrorsEn {
	_TranslationsErrorsCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsCyGb extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricCyGb metric = _TranslationsSettingsMeasurementsMetricCyGb._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialCyGb imperial = _TranslationsSettingsMeasurementsImperialCyGb._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementCyGb extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionCyGb extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionCyGb extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadCyGb extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricCyGb extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialCyGb extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialCyGb._(TranslationsCyGb root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <cy-GB>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsCyGb {
