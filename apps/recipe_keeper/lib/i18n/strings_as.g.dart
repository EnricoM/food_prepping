...
class TranslationsAs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesAs recipes = _TranslationsRecipesAs._(_root);
	@override late final _TranslationsRecipeDetailAs recipeDetail = _TranslationsRecipeDetailAs._(_root);
	@override late final _TranslationsFiltersAs filters = _TranslationsFiltersAs._(_root);
	@override late final _TranslationsShoppingListAs shoppingList = _TranslationsShoppingListAs._(_root);
	@override late final _TranslationsMealPlanAs mealPlan = _TranslationsMealPlanAs._(_root);
	@override late final _TranslationsInventoryAs inventory = _TranslationsInventoryAs._(_root);
	@override late final _TranslationsBarcodeScanAs barcodeScan = _TranslationsBarcodeScanAs._(_root);
	@override late final _TranslationsReceiptScanAs receiptScan = _TranslationsReceiptScanAs._(_root);
	@override late final _TranslationsBatchCookingAs batchCooking = _TranslationsBatchCookingAs._(_root);
	@override late final _TranslationsVisitedDomainsAs visitedDomains = _TranslationsVisitedDomainsAs._(_root);
	@override late final _TranslationsDomainDiscoveryAs domainDiscovery = _TranslationsDomainDiscoveryAs._(_root);
	@override late final _TranslationsInventorySuggestionsAs inventorySuggestions = _TranslationsInventorySuggestionsAs._(_root);
	@override late final _TranslationsUpgradeAs upgrade = _TranslationsUpgradeAs._(_root);
	@override late final _TranslationsTourAs tour = _TranslationsTourAs._(_root);
	@override late final _TranslationsManualRecipeAs manualRecipe = _TranslationsManualRecipeAs._(_root);
	@override late final _TranslationsRecipeEditAs recipeEdit = _TranslationsRecipeEditAs._(_root);
	@override late final _TranslationsErrorsAs errors = _TranslationsErrorsAs._(_root);
}
...
class _TranslationsSettingsAs extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsAs measurements = _TranslationsSettingsMeasurementsAs._(_root);
	@override late final _TranslationsSettingsDataManagementAs dataManagement = _TranslationsSettingsDataManagementAs._(_root);
	@override late final _TranslationsSettingsVersionAs version = _TranslationsSettingsVersionAs._(_root);
}

// Path: recipes
class _TranslationsRecipesAs extends TranslationsRecipesEn {
	_TranslationsRecipesAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailAs extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailAs._(TranslationsAs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionAs nutrition = _TranslationsRecipeDetailNutritionAs._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadAs prepAhead = _TranslationsRecipeDetailPrepAheadAs._(_root);
...
// Path: filters
class _TranslationsFiltersAs extends TranslationsFiltersEn {
	_TranslationsFiltersAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListAs extends TranslationsShoppingListEn {
	_TranslationsShoppingListAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanAs extends TranslationsMealPlanEn {
	_TranslationsMealPlanAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryAs extends TranslationsInventoryEn {
	_TranslationsInventoryAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanAs extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanAs extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingAs extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsAs extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryAs extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsAs extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeAs extends TranslationsUpgradeEn {
	_TranslationsUpgradeAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourAs extends TranslationsTourEn {
	_TranslationsTourAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeAs extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditAs extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsAs extends TranslationsErrorsEn {
	_TranslationsErrorsAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsAs extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsAs._(TranslationsAs root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricAs metric = _TranslationsSettingsMeasurementsMetricAs._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialAs imperial = _TranslationsSettingsMeasurementsImperialAs._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementAs extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionAs extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionAs extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadAs extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricAs extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricAs._(TranslationsAs root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialAs extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialAs._(TranslationsAs root) : this._root = root, super.internal(root);
