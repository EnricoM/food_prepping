...
// Path: <root>
class TranslationsLv extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppLv app = _TranslationsAppLv._(_root);
	@override late final _TranslationsHomeLv home = _TranslationsHomeLv._(_root);
	@override late final _TranslationsCommonLv common = _TranslationsCommonLv._(_root);
	@override late final _TranslationsSettingsLv settings = _TranslationsSettingsLv._(_root);
	@override late final _TranslationsRecipesLv recipes = _TranslationsRecipesLv._(_root);
	@override late final _TranslationsRecipeDetailLv recipeDetail = _TranslationsRecipeDetailLv._(_root);
	@override late final _TranslationsFiltersLv filters = _TranslationsFiltersLv._(_root);
	@override late final _TranslationsShoppingListLv shoppingList = _TranslationsShoppingListLv._(_root);
	@override late final _TranslationsMealPlanLv mealPlan = _TranslationsMealPlanLv._(_root);
	@override late final _TranslationsInventoryLv inventory = _TranslationsInventoryLv._(_root);
	@override late final _TranslationsBarcodeScanLv barcodeScan = _TranslationsBarcodeScanLv._(_root);
	@override late final _TranslationsReceiptScanLv receiptScan = _TranslationsReceiptScanLv._(_root);
	@override late final _TranslationsBatchCookingLv batchCooking = _TranslationsBatchCookingLv._(_root);
	@override late final _TranslationsVisitedDomainsLv visitedDomains = _TranslationsVisitedDomainsLv._(_root);
	@override late final _TranslationsDomainDiscoveryLv domainDiscovery = _TranslationsDomainDiscoveryLv._(_root);
	@override late final _TranslationsInventorySuggestionsLv inventorySuggestions = _TranslationsInventorySuggestionsLv._(_root);
	@override late final _TranslationsUpgradeLv upgrade = _TranslationsUpgradeLv._(_root);
	@override late final _TranslationsTourLv tour = _TranslationsTourLv._(_root);
	@override late final _TranslationsManualRecipeLv manualRecipe = _TranslationsManualRecipeLv._(_root);
	@override late final _TranslationsRecipeEditLv recipeEdit = _TranslationsRecipeEditLv._(_root);
	@override late final _TranslationsErrorsLv errors = _TranslationsErrorsLv._(_root);
}

// Path: app
class _TranslationsAppLv extends TranslationsAppEn {
	_TranslationsAppLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: home
class _TranslationsHomeLv extends TranslationsHomeEn {
	_TranslationsHomeLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonLv extends TranslationsCommonEn {
	_TranslationsCommonLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsLv extends TranslationsSettingsEn {
	_TranslationsSettingsLv._(TranslationsLv root) : this._root = root, super.internal(root);

	final TranslationsLv _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsLv measurements = _TranslationsSettingsMeasurementsLv._(_root);
	@override late final _TranslationsSettingsDataManagementLv dataManagement = _TranslationsSettingsDataManagementLv._(_root);
	@override late final _TranslationsSettingsVersionLv version = _TranslationsSettingsVersionLv._(_root);
}

// Path: recipes
class _TranslationsRecipesLv extends TranslationsRecipesEn {
	_TranslationsRecipesLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailLv extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailLv._(TranslationsLv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionLv nutrition = _TranslationsRecipeDetailNutritionLv._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadLv prepAhead = _TranslationsRecipeDetailPrepAheadLv._(_root);
...
// Path: filters
class _TranslationsFiltersLv extends TranslationsFiltersEn {
	_TranslationsFiltersLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListLv extends TranslationsShoppingListEn {
	_TranslationsShoppingListLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanLv extends TranslationsMealPlanEn {
	_TranslationsMealPlanLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryLv extends TranslationsInventoryEn {
	_TranslationsInventoryLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanLv extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanLv extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingLv extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsLv extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryLv extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsLv extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeLv extends TranslationsUpgradeEn {
	_TranslationsUpgradeLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourLv extends TranslationsTourEn {
	_TranslationsTourLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeLv extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditLv extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsLv extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsLv._(TranslationsLv root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricLv metric = _TranslationsSettingsMeasurementsMetricLv._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialLv imperial = _TranslationsSettingsMeasurementsImperialLv._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementLv extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionLv extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionLv extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadLv extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricLv extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricLv._(TranslationsLv root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialLv extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialLv._(TranslationsLv root) : this._root = root, super.internal(root);
