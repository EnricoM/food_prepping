...
class TranslationsId extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesId recipes = _TranslationsRecipesId._(_root);
	@override late final _TranslationsRecipeDetailId recipeDetail = _TranslationsRecipeDetailId._(_root);
	@override late final _TranslationsFiltersId filters = _TranslationsFiltersId._(_root);
	@override late final _TranslationsShoppingListId shoppingList = _TranslationsShoppingListId._(_root);
	@override late final _TranslationsMealPlanId mealPlan = _TranslationsMealPlanId._(_root);
	@override late final _TranslationsInventoryId inventory = _TranslationsInventoryId._(_root);
	@override late final _TranslationsBarcodeScanId barcodeScan = _TranslationsBarcodeScanId._(_root);
	@override late final _TranslationsReceiptScanId receiptScan = _TranslationsReceiptScanId._(_root);
	@override late final _TranslationsBatchCookingId batchCooking = _TranslationsBatchCookingId._(_root);
	@override late final _TranslationsVisitedDomainsId visitedDomains = _TranslationsVisitedDomainsId._(_root);
	@override late final _TranslationsDomainDiscoveryId domainDiscovery = _TranslationsDomainDiscoveryId._(_root);
	@override late final _TranslationsInventorySuggestionsId inventorySuggestions = _TranslationsInventorySuggestionsId._(_root);
	@override late final _TranslationsUpgradeId upgrade = _TranslationsUpgradeId._(_root);
	@override late final _TranslationsTourId tour = _TranslationsTourId._(_root);
	@override late final _TranslationsManualRecipeId manualRecipe = _TranslationsManualRecipeId._(_root);
	@override late final _TranslationsRecipeEditId recipeEdit = _TranslationsRecipeEditId._(_root);
...
class _TranslationsSettingsId extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsId measurements = _TranslationsSettingsMeasurementsId._(_root);
	@override late final _TranslationsSettingsDataManagementId dataManagement = _TranslationsSettingsDataManagementId._(_root);
	@override late final _TranslationsSettingsVersionId version = _TranslationsSettingsVersionId._(_root);
}

// Path: recipes
class _TranslationsRecipesId extends TranslationsRecipesEn {
	_TranslationsRecipesId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailId extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailId._(TranslationsId root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionId nutrition = _TranslationsRecipeDetailNutritionId._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadId prepAhead = _TranslationsRecipeDetailPrepAheadId._(_root);
...
// Path: filters
class _TranslationsFiltersId extends TranslationsFiltersEn {
	_TranslationsFiltersId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListId extends TranslationsShoppingListEn {
	_TranslationsShoppingListId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanId extends TranslationsMealPlanEn {
	_TranslationsMealPlanId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryId extends TranslationsInventoryEn {
	_TranslationsInventoryId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanId extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanId extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingId extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsId extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryId extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsId extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeId extends TranslationsUpgradeEn {
	_TranslationsUpgradeId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourId extends TranslationsTourEn {
	_TranslationsTourId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeId extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeId._(TranslationsId root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditId extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsId extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsId._(TranslationsId root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricId metric = _TranslationsSettingsMeasurementsMetricId._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialId imperial = _TranslationsSettingsMeasurementsImperialId._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementId extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionId extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionId extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadId extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricId extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricId._(TranslationsId root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialId extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialId._(TranslationsId root) : this._root = root, super.internal(root);
