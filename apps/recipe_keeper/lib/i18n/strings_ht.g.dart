...
// Path: <root>
class TranslationsHt extends Translations with BaseTranslations<AppLocale, Translations> {
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	TranslationsHt({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver, TranslationMetadata<AppLocale, Translations>? meta})
	...
	/// Metadata for the translations of <ht>.
	@override final TranslationMetadata<AppLocale, Translations> $meta;

	/// Access flat map
	@override dynamic operator[](String key) => $meta.getTranslation(key) ?? super.$meta.getTranslation(key);

	late final TranslationsHt _root = this; // ignore: unused_field

	@override 
	TranslationsHt $copyWith({TranslationMetadata<AppLocale, Translations>? meta}) => TranslationsHt(meta: meta ?? this.$meta);

	// Translations
	@override late final _TranslationsAppHt app = _TranslationsAppHt._(_root);
	@override late final _TranslationsHomeHt home = _TranslationsHomeHt._(_root);
	@override late final _TranslationsCommonHt common = _TranslationsCommonHt._(_root);
	@override late final _TranslationsSettingsHt settings = _TranslationsSettingsHt._(_root);
	@override late final _TranslationsRecipesHt recipes = _TranslationsRecipesHt._(_root);
	@override late final _TranslationsRecipeDetailHt recipeDetail = _TranslationsRecipeDetailHt._(_root);
	@override late final _TranslationsFiltersHt filters = _TranslationsFiltersHt._(_root);
	@override late final _TranslationsShoppingListHt shoppingList = _TranslationsShoppingListHt._(_root);
	@override late final _TranslationsMealPlanHt mealPlan = _TranslationsMealPlanHt._(_root);
	@override late final _TranslationsInventoryHt inventory = _TranslationsInventoryHt._(_root);
	@override late final _TranslationsBarcodeScanHt barcodeScan = _TranslationsBarcodeScanHt._(_root);
	@override late final _TranslationsReceiptScanHt receiptScan = _TranslationsReceiptScanHt._(_root);
	@override late final _TranslationsBatchCookingHt batchCooking = _TranslationsBatchCookingHt._(_root);
	@override late final _TranslationsVisitedDomainsHt visitedDomains = _TranslationsVisitedDomainsHt._(_root);
	@override late final _TranslationsDomainDiscoveryHt domainDiscovery = _TranslationsDomainDiscoveryHt._(_root);
	@override late final _TranslationsInventorySuggestionsHt inventorySuggestions = _TranslationsInventorySuggestionsHt._(_root);
	@override late final _TranslationsUpgradeHt upgrade = _TranslationsUpgradeHt._(_root);
	@override late final _TranslationsTourHt tour = _TranslationsTourHt._(_root);
	@override late final _TranslationsManualRecipeHt manualRecipe = _TranslationsManualRecipeHt._(_root);
	@override late final _TranslationsRecipeEditHt recipeEdit = _TranslationsRecipeEditHt._(_root);
	@override late final _TranslationsErrorsHt errors = _TranslationsErrorsHt._(_root);
}

// Path: app
class _TranslationsAppHt extends TranslationsAppEn {
	_TranslationsAppHt._(TranslationsHt root) : this._root = root, super.internal(root);

	final TranslationsHt _root; // ignore: unused_field
...
// Path: home
class _TranslationsHomeHt extends TranslationsHomeEn {
	_TranslationsHomeHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonHt extends TranslationsCommonEn {
	_TranslationsCommonHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: settings
class _TranslationsSettingsHt extends TranslationsSettingsEn {
	_TranslationsSettingsHt._(TranslationsHt root) : this._root = root, super.internal(root);

	final TranslationsHt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsHt measurements = _TranslationsSettingsMeasurementsHt._(_root);
	@override late final _TranslationsSettingsDataManagementHt dataManagement = _TranslationsSettingsDataManagementHt._(_root);
	@override late final _TranslationsSettingsVersionHt version = _TranslationsSettingsVersionHt._(_root);
}

// Path: recipes
class _TranslationsRecipesHt extends TranslationsRecipesEn {
	_TranslationsRecipesHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailHt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailHt._(TranslationsHt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionHt nutrition = _TranslationsRecipeDetailNutritionHt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadHt prepAhead = _TranslationsRecipeDetailPrepAheadHt._(_root);
...
// Path: filters
class _TranslationsFiltersHt extends TranslationsFiltersEn {
	_TranslationsFiltersHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListHt extends TranslationsShoppingListEn {
	_TranslationsShoppingListHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanHt extends TranslationsMealPlanEn {
	_TranslationsMealPlanHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryHt extends TranslationsInventoryEn {
	_TranslationsInventoryHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanHt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanHt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingHt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsHt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryHt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsHt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeHt extends TranslationsUpgradeEn {
	_TranslationsUpgradeHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourHt extends TranslationsTourEn {
	_TranslationsTourHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeHt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditHt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsHt extends TranslationsErrorsEn {
	_TranslationsErrorsHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsHt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsHt._(TranslationsHt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricHt metric = _TranslationsSettingsMeasurementsMetricHt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialHt imperial = _TranslationsSettingsMeasurementsImperialHt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementHt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionHt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionHt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadHt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricHt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialHt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialHt._(TranslationsHt root) : this._root = root, super.internal(root);
...
/// The flat map containing all translations for locale <ht>.
/// Only for edge cases! For simple maps, use the map function of this library.
///
/// The Dart AOT compiler has issues with very large switch statements,
/// so the map is split into smaller functions (512 entries each).
extension on TranslationsHt {
