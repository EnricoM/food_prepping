...
class TranslationsIt extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsRecipesIt recipes = _TranslationsRecipesIt._(_root);
	@override late final _TranslationsRecipeDetailIt recipeDetail = _TranslationsRecipeDetailIt._(_root);
	@override late final _TranslationsFiltersIt filters = _TranslationsFiltersIt._(_root);
	@override late final _TranslationsShoppingListIt shoppingList = _TranslationsShoppingListIt._(_root);
	@override late final _TranslationsMealPlanIt mealPlan = _TranslationsMealPlanIt._(_root);
	@override late final _TranslationsInventoryIt inventory = _TranslationsInventoryIt._(_root);
	@override late final _TranslationsBarcodeScanIt barcodeScan = _TranslationsBarcodeScanIt._(_root);
	@override late final _TranslationsReceiptScanIt receiptScan = _TranslationsReceiptScanIt._(_root);
	@override late final _TranslationsBatchCookingIt batchCooking = _TranslationsBatchCookingIt._(_root);
	@override late final _TranslationsVisitedDomainsIt visitedDomains = _TranslationsVisitedDomainsIt._(_root);
	@override late final _TranslationsDomainDiscoveryIt domainDiscovery = _TranslationsDomainDiscoveryIt._(_root);
	@override late final _TranslationsInventorySuggestionsIt inventorySuggestions = _TranslationsInventorySuggestionsIt._(_root);
	@override late final _TranslationsUpgradeIt upgrade = _TranslationsUpgradeIt._(_root);
	@override late final _TranslationsTourIt tour = _TranslationsTourIt._(_root);
	@override late final _TranslationsManualRecipeIt manualRecipe = _TranslationsManualRecipeIt._(_root);
	@override late final _TranslationsRecipeEditIt recipeEdit = _TranslationsRecipeEditIt._(_root);
...
class _TranslationsSettingsIt extends TranslationsSettingsEn {
	...
	@override late final _TranslationsSettingsMeasurementsIt measurements = _TranslationsSettingsMeasurementsIt._(_root);
	@override late final _TranslationsSettingsDataManagementIt dataManagement = _TranslationsSettingsDataManagementIt._(_root);
	@override late final _TranslationsSettingsVersionIt version = _TranslationsSettingsVersionIt._(_root);
}

// Path: recipes
class _TranslationsRecipesIt extends TranslationsRecipesEn {
	_TranslationsRecipesIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailIt extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailIt._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionIt nutrition = _TranslationsRecipeDetailNutritionIt._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadIt prepAhead = _TranslationsRecipeDetailPrepAheadIt._(_root);
...
// Path: filters
class _TranslationsFiltersIt extends TranslationsFiltersEn {
	_TranslationsFiltersIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListIt extends TranslationsShoppingListEn {
	_TranslationsShoppingListIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanIt extends TranslationsMealPlanEn {
	_TranslationsMealPlanIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryIt extends TranslationsInventoryEn {
	_TranslationsInventoryIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanIt extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanIt extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingIt extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsIt extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryIt extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsIt extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeIt extends TranslationsUpgradeEn {
	_TranslationsUpgradeIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourIt extends TranslationsTourEn {
	_TranslationsTourIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeIt extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditIt extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsIt extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsIt._(TranslationsIt root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricIt metric = _TranslationsSettingsMeasurementsMetricIt._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialIt imperial = _TranslationsSettingsMeasurementsImperialIt._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementIt extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionIt extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionIt extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadIt extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricIt extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricIt._(TranslationsIt root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialIt extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialIt._(TranslationsIt root) : this._root = root, super.internal(root);
