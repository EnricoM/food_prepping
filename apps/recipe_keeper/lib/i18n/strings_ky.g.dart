...
class TranslationsKy extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	@override late final _TranslationsAppKy app = _TranslationsAppKy._(_root);
	...
	@override late final _TranslationsSettingsKy settings = _TranslationsSettingsKy._(_root);
	@override late final _TranslationsRecipesKy recipes = _TranslationsRecipesKy._(_root);
	@override late final _TranslationsRecipeDetailKy recipeDetail = _TranslationsRecipeDetailKy._(_root);
	@override late final _TranslationsFiltersKy filters = _TranslationsFiltersKy._(_root);
	@override late final _TranslationsShoppingListKy shoppingList = _TranslationsShoppingListKy._(_root);
	@override late final _TranslationsMealPlanKy mealPlan = _TranslationsMealPlanKy._(_root);
	@override late final _TranslationsInventoryKy inventory = _TranslationsInventoryKy._(_root);
	@override late final _TranslationsBarcodeScanKy barcodeScan = _TranslationsBarcodeScanKy._(_root);
	@override late final _TranslationsReceiptScanKy receiptScan = _TranslationsReceiptScanKy._(_root);
	@override late final _TranslationsBatchCookingKy batchCooking = _TranslationsBatchCookingKy._(_root);
	@override late final _TranslationsVisitedDomainsKy visitedDomains = _TranslationsVisitedDomainsKy._(_root);
	@override late final _TranslationsDomainDiscoveryKy domainDiscovery = _TranslationsDomainDiscoveryKy._(_root);
	@override late final _TranslationsInventorySuggestionsKy inventorySuggestions = _TranslationsInventorySuggestionsKy._(_root);
	@override late final _TranslationsUpgradeKy upgrade = _TranslationsUpgradeKy._(_root);
	@override late final _TranslationsTourKy tour = _TranslationsTourKy._(_root);
	@override late final _TranslationsManualRecipeKy manualRecipe = _TranslationsManualRecipeKy._(_root);
	@override late final _TranslationsRecipeEditKy recipeEdit = _TranslationsRecipeEditKy._(_root);
	@override late final _TranslationsErrorsKy errors = _TranslationsErrorsKy._(_root);
}

// Path: app
class _TranslationsAppKy extends TranslationsAppEn {
	_TranslationsAppKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: common
class _TranslationsCommonKy extends TranslationsCommonEn {
...
// Path: settings
class _TranslationsSettingsKy extends TranslationsSettingsEn {
	_TranslationsSettingsKy._(TranslationsKy root) : this._root = root, super.internal(root);

	final TranslationsKy _root; // ignore: unused_field

	// Translations
	@override String get title => 'Settings';
	@override late final _TranslationsSettingsMeasurementsKy measurements = _TranslationsSettingsMeasurementsKy._(_root);
	@override late final _TranslationsSettingsDataManagementKy dataManagement = _TranslationsSettingsDataManagementKy._(_root);
	@override late final _TranslationsSettingsVersionKy version = _TranslationsSettingsVersionKy._(_root);
}

// Path: recipes
class _TranslationsRecipesKy extends TranslationsRecipesEn {
	_TranslationsRecipesKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: recipeDetail
class _TranslationsRecipeDetailKy extends TranslationsRecipeDetailEn {
	_TranslationsRecipeDetailKy._(TranslationsKy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsRecipeDetailNutritionKy nutrition = _TranslationsRecipeDetailNutritionKy._(_root);
	@override String get highlights => 'Highlights';
	@override late final _TranslationsRecipeDetailPrepAheadKy prepAhead = _TranslationsRecipeDetailPrepAheadKy._(_root);
...
// Path: filters
class _TranslationsFiltersKy extends TranslationsFiltersEn {
	_TranslationsFiltersKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: shoppingList
class _TranslationsShoppingListKy extends TranslationsShoppingListEn {
	_TranslationsShoppingListKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: mealPlan
class _TranslationsMealPlanKy extends TranslationsMealPlanEn {
	_TranslationsMealPlanKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: inventory
class _TranslationsInventoryKy extends TranslationsInventoryEn {
	_TranslationsInventoryKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: barcodeScan
class _TranslationsBarcodeScanKy extends TranslationsBarcodeScanEn {
	_TranslationsBarcodeScanKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: receiptScan
class _TranslationsReceiptScanKy extends TranslationsReceiptScanEn {
	_TranslationsReceiptScanKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: batchCooking
class _TranslationsBatchCookingKy extends TranslationsBatchCookingEn {
	_TranslationsBatchCookingKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: visitedDomains
class _TranslationsVisitedDomainsKy extends TranslationsVisitedDomainsEn {
	_TranslationsVisitedDomainsKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsDomainDiscoveryKy extends TranslationsDomainDiscoveryEn {
	_TranslationsDomainDiscoveryKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsInventorySuggestionsKy extends TranslationsInventorySuggestionsEn {
	_TranslationsInventorySuggestionsKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: upgrade
class _TranslationsUpgradeKy extends TranslationsUpgradeEn {
	_TranslationsUpgradeKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: tour
class _TranslationsTourKy extends TranslationsTourEn {
	_TranslationsTourKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: manualRecipe
class _TranslationsManualRecipeKy extends TranslationsManualRecipeEn {
	_TranslationsManualRecipeKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: recipeEdit
class _TranslationsRecipeEditKy extends TranslationsRecipeEditEn {
	_TranslationsRecipeEditKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
// Path: errors
class _TranslationsErrorsKy extends TranslationsErrorsEn {
	_TranslationsErrorsKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsKy extends TranslationsSettingsMeasurementsEn {
	_TranslationsSettingsMeasurementsKy._(TranslationsKy root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsSettingsMeasurementsMetricKy metric = _TranslationsSettingsMeasurementsMetricKy._(_root);
	@override late final _TranslationsSettingsMeasurementsImperialKy imperial = _TranslationsSettingsMeasurementsImperialKy._(_root);
}

// Path: settings.dataManagement
class _TranslationsSettingsDataManagementKy extends TranslationsSettingsDataManagementEn {
	_TranslationsSettingsDataManagementKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsVersionKy extends TranslationsSettingsVersionEn {
	_TranslationsSettingsVersionKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailNutritionKy extends TranslationsRecipeDetailNutritionEn {
	_TranslationsRecipeDetailNutritionKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsRecipeDetailPrepAheadKy extends TranslationsRecipeDetailPrepAheadEn {
	_TranslationsRecipeDetailPrepAheadKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsMetricKy extends TranslationsSettingsMeasurementsMetricEn {
	_TranslationsSettingsMeasurementsMetricKy._(TranslationsKy root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsMeasurementsImperialKy extends TranslationsSettingsMeasurementsImperialEn {
	_TranslationsSettingsMeasurementsImperialKy._(TranslationsKy root) : this._root = root, super.internal(root);
